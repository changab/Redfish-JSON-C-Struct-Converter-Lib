...
//
#include <RedfishInterpreter/ServiceRoot/v1_0_6/EfiServiceRootV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_0_6 
...
{
  EFI_REDFISH_SERVICEROOT_V1_0_6 *ServiceRootV1_0_6;
  EFI_REDFISH_SERVICEROOT_V1_0_6_CS *ServiceRootV1_0_6Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ServiceRoot") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_ServiceRoot_V1_0_6_To_CS (ResoruceRaw, &ServiceRootV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_0_6 = (EFI_REDFISH_SERVICEROOT_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_0_6));
  if (ServiceRootV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_0_6;
  ServiceRootV1_0_6->ServiceRoot = ServiceRootV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_0_6_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ServiceRoot"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "ServiceRoot");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ServiceRoot"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "ServiceRoot");
...
)
{
  ...
  return CS_To_ServiceRoot_V1_0_6_JSON (*((EFI_REDFISH_SERVICEROOT_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ServiceRootToStruct.
...
)
{
  ...
  ServiceRootV1_0_6 = (EFI_REDFISH_SERVICEROOT_V1_0_6 *)InterpProp;
  DestroyServiceRoot_V1_0_6_CS (ServiceRootV1_0_6->ServiceRoot); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ServiceRootFromEfiStruct
...
)
{
  ...
  return DestroyServiceRoot_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
