...
#include"Redfish_MetricReportCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishMetricReportCollection_MetricReportCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for MetricReportCollection.MetricReportCollection
//
RedfishCS_status CS_To_MetricReportCollection_JSON(RedfishMetricReportCollection_MetricReportCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MetricReportCollection.MetricReportCollection
//
RedfishCS_status DestroyMetricReportCollection_CS(RedfishMetricReportCollection_MetricReportCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MetricReportCollection.MetricReportCollection
//
RedfishCS_status DestroyMetricReportCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MetricReportCollection.NOVERSIONED.MetricReportCollection
//
RedfishCS_status
Json_MetricReportCollection_To_CS(RedfishCS_char *JsonRawText, RedfishMetricReportCollection_MetricReportCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMetricReportCollection_MetricReportCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MetricReportCollection", "noversioned", "MetricReportCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMetricReportCollection_MetricReportCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMetricReportCollection_CS (Cs);
  return Status;
}
