...
//
#include <RedfishInterpreter/Role/v1_0_4/EfiRoleV1_0_4.h>
...
{
  EFI_REDFISH_ROLE_V1_0_4 *RoleV1_0_4;
  EFI_REDFISH_ROLE_V1_0_4_CS *RoleV1_0_4Cs;
  ...
  Status = Json_Role_V1_0_4_To_CS (ResoruceRaw, &RoleV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_0_4 = (EFI_REDFISH_ROLE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_0_4));
  if (RoleV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)RoleV1_0_4;
  RoleV1_0_4->Role = RoleV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_ROLE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Role_V1_0_4_JSON (*((EFI_REDFISH_ROLE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  RoleV1_0_4 = (EFI_REDFISH_ROLE_V1_0_4 *)InterpProp;
  DestroyRole_V1_0_4_CS (RoleV1_0_4->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyRole_V1_0_4_Json (ResoruceRaw);
}
