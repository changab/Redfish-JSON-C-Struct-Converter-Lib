# Definition of Drive.V1_1_3 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Drive_SecureErase**|RedfishDrive_V1_1_3_SecureErase_CS| Structure points to **#Drive.SecureErase** property.| No| No
|**Oem**|RedfishDrive_V1_1_3_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Drive
    typedef struct _RedfishDrive_V1_1_3_Drive_CS {
        ...
        RedfishDrive_V1_1_3_Actions_CS *Actions;
        ...
        RedfishDrive_V1_1_3_Links_CS *Links;
        ...
        RedfishResource_Oem_CS *Oem;
        RedfishDrive_V1_1_3_Operations_CS *Operations;
...
|**Actions**|RedfishDrive_V1_1_3_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishDrive_V1_1_3_Links_CS| Structure points to **Links** property.| No| No
...
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Operations**|RedfishDrive_V1_1_3_Operations_CS| Structure points to **Operations** property.| No| No
...
## Redfish Drive V1_1_3 to C Structure Function
    RedfishCS_status
    Json_Drive_V1_1_3_To_CS (RedfishCS_char *JsonRawText, RedfishDrive_V1_1_3_Drive_CS **ReturnedCS);

## C Structure to Redfish Drive V1_1_3 JSON Function
    RedfishCS_status
    CS_To_Drive_V1_1_3_JSON (RedfishDrive_V1_1_3_Drive_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Drive V1_1_3 C Structure Function
    RedfishCS_status
