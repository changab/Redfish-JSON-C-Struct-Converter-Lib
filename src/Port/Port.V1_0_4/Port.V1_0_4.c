...
#include"Redfish_Port_v1_0_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPort_V1_0_4_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Port.Reset
//
static RedfishCS_status GenResetCs(RedfishPort_V1_0_4_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_0_4_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_0_4_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPort_V1_0_4_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_0_4_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_0_4_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPort_V1_0_4_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_0_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_0_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Port.Reset
...
//
static RedfishCS_status GenLinksCs(RedfishPort_V1_0_4_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_0_4_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_0_4_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AssociatedEndpoints
...
//
static RedfishCS_status GenStatusCs(RedfishPort_V1_0_4_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPort_V1_0_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsPort_Reset(json_t *CsJson, char *Key, RedfishPort_V1_0_4_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPort_V1_0_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPort_V1_0_4_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Port.V1_0_4.Port
//
RedfishCS_status CS_To_Port_V1_0_4_JSON(RedfishPort_V1_0_4_Port_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Port.V1_0_4.Port
//
RedfishCS_status DestroyPort_V1_0_4_CS(RedfishPort_V1_0_4_Port_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Port.V1_0_4.Port
//
RedfishCS_status DestroyPort_V1_0_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Port.V1_0_4.Port
//
RedfishCS_status
Json_Port_V1_0_4_To_CS(RedfishCS_char *JsonRawText, RedfishPort_V1_0_4_Port_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPort_V1_0_4_Port_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Port", "v1_0_4", "Port", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPort_V1_0_4_Port_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
