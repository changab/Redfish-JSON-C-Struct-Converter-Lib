...
//
#include <RedfishInterpreter/Zone/v1_2_0/EfiZoneV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#Zone";
...
{
  EFI_REDFISH_ZONE_V1_2_0 *ZoneV1_2_0;
  EFI_REDFISH_ZONE_V1_2_0_CS *ZoneV1_2_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Zone") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Zone_V1_2_0_To_CS (ResoruceRaw, &ZoneV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_2_0 = (EFI_REDFISH_ZONE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_2_0));
  if (ZoneV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ZoneV1_2_0;
  ZoneV1_2_0->Zone = ZoneV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ZONE_V1_2_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Zone"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Zone");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Zone"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Zone");
...
)
{
  ...
  return CS_To_Zone_V1_2_0_JSON (*((EFI_REDFISH_ZONE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ZoneToStruct.
...
)
{
  ...
  ZoneV1_2_0 = (EFI_REDFISH_ZONE_V1_2_0 *)InterpProp;
  DestroyZone_V1_2_0_CS (ZoneV1_2_0->Zone); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ZoneFromEfiStruct
...
)
{
  ...
  return DestroyZone_V1_2_0_Json (ResoruceRaw);
}
