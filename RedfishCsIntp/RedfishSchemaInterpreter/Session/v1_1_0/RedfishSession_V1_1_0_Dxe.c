...
//
#include <RedfishInterpreter/Session/v1_1_0/EfiSessionV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_1_0 
...
{
  EFI_REDFISH_SESSION_V1_1_0 *SessionV1_1_0;
  EFI_REDFISH_SESSION_V1_1_0_CS *SessionV1_1_0Cs;
  ...
  Status = Json_Session_V1_1_0_To_CS (ResoruceRaw, &SessionV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_1_0 = (EFI_REDFISH_SESSION_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_1_0));
  if (SessionV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionV1_1_0;
  SessionV1_1_0->Session = SessionV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SESSION_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Session_V1_1_0_JSON (*((EFI_REDFISH_SESSION_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionV1_1_0 = (EFI_REDFISH_SESSION_V1_1_0 *)InterpProp;
  DestroySession_V1_1_0_CS (SessionV1_1_0->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySession_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_1_0EntryPoint (
