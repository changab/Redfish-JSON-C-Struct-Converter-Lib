...
//
#include <RedfishInterpreter/HostInterface/v1_0_3/EfiHostInterfaceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_0_3 
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_0_3 *HostInterfaceV1_0_3;
  EFI_REDFISH_HOSTINTERFACE_V1_0_3_CS *HostInterfaceV1_0_3Cs;
  ...
  Status = Json_HostInterface_V1_0_3_To_CS (ResoruceRaw, &HostInterfaceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_0_3 = (EFI_REDFISH_HOSTINTERFACE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_0_3));
  if (HostInterfaceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)HostInterfaceV1_0_3;
  HostInterfaceV1_0_3->HostInterface = HostInterfaceV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_HOSTINTERFACE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_HostInterface_V1_0_3_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  HostInterfaceV1_0_3 = (EFI_REDFISH_HOSTINTERFACE_V1_0_3 *)InterpProp;
  DestroyHostInterface_V1_0_3_CS (HostInterfaceV1_0_3->HostInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyHostInterface_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
