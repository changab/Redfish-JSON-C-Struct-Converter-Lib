...
//
#include <RedfishInterpreter/ServiceRoot/v1_0_3/EfiServiceRootV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_0_3 
...
{
  EFI_REDFISH_SERVICEROOT_V1_0_3 *ServiceRootV1_0_3;
  EFI_REDFISH_SERVICEROOT_V1_0_3_CS *ServiceRootV1_0_3Cs;
  ...
  Status = Json_ServiceRoot_V1_0_3_To_CS (ResoruceRaw, &ServiceRootV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_0_3 = (EFI_REDFISH_SERVICEROOT_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_0_3));
  if (ServiceRootV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_0_3;
  ServiceRootV1_0_3->ServiceRoot = ServiceRootV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ServiceRoot_V1_0_3_JSON (*((EFI_REDFISH_SERVICEROOT_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ServiceRootV1_0_3 = (EFI_REDFISH_SERVICEROOT_V1_0_3 *)InterpProp;
  DestroyServiceRoot_V1_0_3_CS (ServiceRootV1_0_3->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyServiceRoot_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
