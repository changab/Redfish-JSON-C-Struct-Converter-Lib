...
//
#include <RedfishInterpreter/JsonSchemaFile/v1_0_4/EfiJsonSchemaFileV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_0_4 
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_4 *JsonSchemaFileV1_0_4;
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_4_CS *JsonSchemaFileV1_0_4Cs;
  ...
  Status = Json_JsonSchemaFile_V1_0_4_To_CS (ResoruceRaw, &JsonSchemaFileV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_0_4 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_4));
  if (JsonSchemaFileV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)JsonSchemaFileV1_0_4;
  JsonSchemaFileV1_0_4->JsonSchemaFile = JsonSchemaFileV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_JsonSchemaFile_V1_0_4_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  JsonSchemaFileV1_0_4 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_4 *)InterpProp;
  DestroyJsonSchemaFile_V1_0_4_CS (JsonSchemaFileV1_0_4->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyJsonSchemaFile_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
