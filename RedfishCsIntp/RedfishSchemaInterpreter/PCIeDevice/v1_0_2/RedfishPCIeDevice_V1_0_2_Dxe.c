...
//
#include <RedfishInterpreter/PCIeDevice/v1_0_2/EfiPCIeDeviceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_0_2 
...
{
  EFI_REDFISH_PCIEDEVICE_V1_0_2 *PCIeDeviceV1_0_2;
  EFI_REDFISH_PCIEDEVICE_V1_0_2_CS *PCIeDeviceV1_0_2Cs;
  ...
  Status = Json_PCIeDevice_V1_0_2_To_CS (ResoruceRaw, &PCIeDeviceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_0_2 = (EFI_REDFISH_PCIEDEVICE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_0_2));
  if (PCIeDeviceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeDeviceV1_0_2;
  PCIeDeviceV1_0_2->PCIeDevice = PCIeDeviceV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_PCIEDEVICE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeDevice_V1_0_2_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  return DestroyPCIeDevice_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
