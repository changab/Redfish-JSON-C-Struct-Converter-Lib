...
#include"Redfish_MetricDefinition_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricDefinition_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricDefinition_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricDefinition_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricDefinition_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenCalculationParamsType_Array_ElementCs(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMetricDefinition_V1_0_0_CalculationParamsType_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMetricDefinition_V1_0_0_CalculationParamsType_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ResultMetric
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "ResultMetric", &(*Dst)->ResultMetric);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SourceMetric
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "SourceMetric", &(*Dst)->SourceMetric);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishMetricDefinition_V1_0_0_CalculationParamsType_Array_CS
//
static RedfishCS_status GenCalculationParamsType_ArrayCs(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricDefinition_V1_0_0_CalculationParamsType_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMetricDefinition_V1_0_0_CalculationParamsType_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMetricDefinition_V1_0_0_CalculationParamsType_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenCalculationParamsType_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status GenWildcard_Array_ElementCs(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMetricDefinition_V1_0_0_Wildcard_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMetricDefinition_V1_0_0_Wildcard_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Name
  ...
  // Values
  Status = GenRedfishCS_char_ArrayCs (Cs, TempJsonObj, "Values", &(*Dst)->Values);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishMetricDefinition_V1_0_0_Wildcard_Array_CS
//
static RedfishCS_status GenWildcard_ArrayCs(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricDefinition_V1_0_0_Wildcard_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMetricDefinition_V1_0_0_Wildcard_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMetricDefinition_V1_0_0_Wildcard_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMetricDefinition_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMetricDefinition_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_CalculationParameters(json_t *CsJson, char *Key, RedfishMetricDefinition_V1_0_0_CalculationParamsType_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMetricDefinition_V1_0_0_CalculationParamsType_Array_CS *NextArray;
  RedfishMetricDefinition_V1_0_0_CalculationParamsType_CS *NextArrayItem;
  ...
  do {
    ...
    // ResultMetric 
    if (InsertJsonStringObj (ArrayMember, "ResultMetric", NextArrayItem->ResultMetric) != RedfishCS_status_success) {goto Error;}

    // SourceMetric 
    if (InsertJsonStringObj (ArrayMember, "SourceMetric", NextArrayItem->SourceMetric) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Wildcards(json_t *CsJson, char *Key, RedfishMetricDefinition_V1_0_0_Wildcard_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMetricDefinition_V1_0_0_Wildcard_Array_CS *NextArray;
  RedfishMetricDefinition_V1_0_0_Wildcard_CS *NextArrayItem;
  ...
  do {
    ...
    // Values 
    if (InsertJsonStringArrayObj (ArrayMember, "Values", NextArrayItem->Values) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for MetricDefinition.V1_0_0.MetricDefinition
//
RedfishCS_status CS_To_MetricDefinition_V1_0_0_JSON(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Calculable 
  if (InsertJsonStringObj (CsJson, "Calculable", CSPtr->Calculable) != RedfishCS_status_success) {goto Error;}

  // CalculationAlgorithm 
  if (InsertJsonStringObj (CsJson, "CalculationAlgorithm", CSPtr->CalculationAlgorithm) != RedfishCS_status_success) {goto Error;}

  // CalculationParameters
  if (CS_To_JSON_CalculationParameters(CsJson, "CalculationParameters", CSPtr->CalculationParameters) != RedfishCS_status_success) {goto Error;}

  // CalculationTimeInterval 
  if (InsertJsonStringObj (CsJson, "CalculationTimeInterval", CSPtr->CalculationTimeInterval) != RedfishCS_status_success) {goto Error;}

  // Calibration 
  if (InsertJsonInt64Obj (CsJson, "Calibration", CSPtr->Calibration) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // DiscreteValues 
  if (InsertJsonStringArrayObj (CsJson, "DiscreteValues", CSPtr->DiscreteValues) != RedfishCS_status_success) {goto Error;}

  // Id 
  if (InsertJsonStringObj (CsJson, "Id", CSPtr->Id) != RedfishCS_status_success) {goto Error;}

  // Implementation 
  if (InsertJsonStringObj (CsJson, "Implementation", CSPtr->Implementation) != RedfishCS_status_success) {goto Error;}

  // IsLinear 
  if (InsertJsonBoolObj (CsJson, "IsLinear", CSPtr->IsLinear) != RedfishCS_status_success) {goto Error;}

  // MaxReadingRange 
  if (InsertJsonInt64Obj (CsJson, "MaxReadingRange", CSPtr->MaxReadingRange) != RedfishCS_status_success) {goto Error;}

  // MetricDataType 
  if (InsertJsonStringObj (CsJson, "MetricDataType", CSPtr->MetricDataType) != RedfishCS_status_success) {goto Error;}

  // MetricProperties 
  if (InsertJsonStringArrayObj (CsJson, "MetricProperties", CSPtr->MetricProperties) != RedfishCS_status_success) {goto Error;}

  // MetricType 
  if (InsertJsonStringObj (CsJson, "MetricType", CSPtr->MetricType) != RedfishCS_status_success) {goto Error;}

  // MinReadingRange 
  if (InsertJsonInt64Obj (CsJson, "MinReadingRange", CSPtr->MinReadingRange) != RedfishCS_status_success) {goto Error;}
  ...
  // SensingInterval 
  if (InsertJsonStringObj (CsJson, "SensingInterval", CSPtr->SensingInterval) != RedfishCS_status_success) {goto Error;}

  // TimestampAccuracy 
  if (InsertJsonStringObj (CsJson, "TimestampAccuracy", CSPtr->TimestampAccuracy) != RedfishCS_status_success) {goto Error;}

  // Units 
  if (InsertJsonStringObj (CsJson, "Units", CSPtr->Units) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for MetricDefinition.V1_0_0.MetricDefinition
//
RedfishCS_status DestroyMetricDefinition_V1_0_0_CS(RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MetricDefinition.V1_0_0.MetricDefinition
//
RedfishCS_status DestroyMetricDefinition_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MetricDefinition.V1_0_0.MetricDefinition
//
RedfishCS_status
Json_MetricDefinition_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishMetricDefinition_V1_0_0_MetricDefinition_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMetricDefinition_V1_0_0_MetricDefinition_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MetricDefinition", "v1_0_0", "MetricDefinition", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMetricDefinition_V1_0_0_MetricDefinition_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Calculable
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Calculable", &Cs->Calculable);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // CalculationAlgorithm
  Status = GetRedfishPropertyStr (Cs, JsonObj, "CalculationAlgorithm", &Cs->CalculationAlgorithm);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // CalculationParameters
  Status = GenCalculationParamsType_ArrayCs (Cs, JsonObj, "CalculationParameters", &Cs->CalculationParameters);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // CalculationTimeInterval
  Status = GetRedfishPropertyStr (Cs, JsonObj, "CalculationTimeInterval", &Cs->CalculationTimeInterval);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Calibration
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "Calibration", &Cs->Calibration);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // DiscreteValues
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "DiscreteValues", &Cs->DiscreteValues);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Implementation
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Implementation", &Cs->Implementation);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // IsLinear
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "IsLinear", &Cs->IsLinear);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MaxReadingRange
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "MaxReadingRange", &Cs->MaxReadingRange);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MetricDataType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "MetricDataType", &Cs->MetricDataType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MetricType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "MetricType", &Cs->MetricType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MinReadingRange
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "MinReadingRange", &Cs->MinReadingRange);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SensingInterval
  Status = GetRedfishPropertyStr (Cs, JsonObj, "SensingInterval", &Cs->SensingInterval);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TimestampAccuracy
  Status = GetRedfishPropertyStr (Cs, JsonObj, "TimestampAccuracy", &Cs->TimestampAccuracy);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Units
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Units", &Cs->Units);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyMetricDefinition_V1_0_0_CS (Cs);
  return Status;
}
