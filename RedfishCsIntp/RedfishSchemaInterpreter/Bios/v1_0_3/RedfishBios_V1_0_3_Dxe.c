...
//
#include <RedfishInterpreter/Bios/v1_0_3/EfiBiosV1_0_3.h>
...
{
  EFI_REDFISH_BIOS_V1_0_3 *BiosV1_0_3;
  EFI_REDFISH_BIOS_V1_0_3_CS *BiosV1_0_3Cs;
  ...
  Status = Json_Bios_V1_0_3_To_CS (ResoruceRaw, &BiosV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_0_3 = (EFI_REDFISH_BIOS_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_0_3));
  if (BiosV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)BiosV1_0_3;
  BiosV1_0_3->Bios = BiosV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_BIOS_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Bios_V1_0_3_JSON (*((EFI_REDFISH_BIOS_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  BiosV1_0_3 = (EFI_REDFISH_BIOS_V1_0_3 *)InterpProp;
  DestroyBios_V1_0_3_CS (BiosV1_0_3->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyBios_V1_0_3_Json (ResoruceRaw);
}
