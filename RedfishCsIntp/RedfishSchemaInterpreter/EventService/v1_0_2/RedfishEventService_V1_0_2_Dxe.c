...
//
#include <RedfishInterpreter/EventService/v1_0_2/EfiEventServiceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_2 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_2 *EventServiceV1_0_2;
  EFI_REDFISH_EVENTSERVICE_V1_0_2_CS *EventServiceV1_0_2Cs;
  ...
  Status = Json_EventService_V1_0_2_To_CS (ResoruceRaw, &EventServiceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_2 = (EFI_REDFISH_EVENTSERVICE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_2));
  if (EventServiceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_0_2;
  EventServiceV1_0_2->EventService = EventServiceV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventService_V1_0_2_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventServiceV1_0_2 = (EFI_REDFISH_EVENTSERVICE_V1_0_2 *)InterpProp;
  DestroyEventService_V1_0_2_CS (EventServiceV1_0_2->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventService_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_2EntryPoint (
