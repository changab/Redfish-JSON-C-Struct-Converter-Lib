...
#include"Redfish_AccountService_v1_2_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAccountService_V1_2_2_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishAccountService_V1_2_2_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_2_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccountService_V1_2_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAccountService_V1_2_2_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_2_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccountService_V1_2_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenStatusCs(RedfishAccountService_V1_2_2_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAccountService_V1_2_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAccountService_V1_2_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for AccountService.V1_2_2.AccountService
//
RedfishCS_status CS_To_AccountService_V1_2_2_JSON(RedfishAccountService_V1_2_2_AccountService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AccountService.V1_2_2.AccountService
//
RedfishCS_status DestroyAccountService_V1_2_2_CS(RedfishAccountService_V1_2_2_AccountService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AccountService.V1_2_2.AccountService
//
RedfishCS_status DestroyAccountService_V1_2_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AccountService.V1_2_2.AccountService
//
RedfishCS_status
Json_AccountService_V1_2_2_To_CS(RedfishCS_char *JsonRawText, RedfishAccountService_V1_2_2_AccountService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAccountService_V1_2_2_AccountService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AccountService", "v1_2_2", "AccountService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAccountService_V1_2_2_AccountService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAccountService_V1_2_2_CS (Cs);
  return Status;
}
