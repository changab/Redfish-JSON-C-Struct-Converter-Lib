...
//
#include <RedfishInterpreter/NetworkPort/v1_0_1/EfiNetworkPortV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_0_1 
...
{
  EFI_REDFISH_NETWORKPORT_V1_0_1 *NetworkPortV1_0_1;
  ...
  Status = Json_NetworkPort_V1_0_1_To_CS (ResoruceRaw, &NetworkPortV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_0_1 = (EFI_REDFISH_NETWORKPORT_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_0_1));
  if (NetworkPortV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkPortV1_0_1;
  NetworkPortV1_0_1->NetworkPort = NetworkPortV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_NETWORKPORT_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkPort_V1_0_1_JSON (*((EFI_REDFISH_NETWORKPORT_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DestroyNetworkPort_V1_0_1_CS (NetworkPortV1_0_1->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkPort_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
