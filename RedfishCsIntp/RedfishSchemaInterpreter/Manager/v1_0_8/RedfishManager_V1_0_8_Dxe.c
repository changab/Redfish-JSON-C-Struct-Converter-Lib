...
//
#include <RedfishInterpreter/Manager/v1_0_8/EfiManagerV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_0_8 
...
{
  EFI_REDFISH_MANAGER_V1_0_8 *ManagerV1_0_8;
  EFI_REDFISH_MANAGER_V1_0_8_CS *ManagerV1_0_8Cs;
  ...
  Status = Json_Manager_V1_0_8_To_CS (ResoruceRaw, &ManagerV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_0_8 = (EFI_REDFISH_MANAGER_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_0_8));
  if (ManagerV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_0_8;
  ManagerV1_0_8->Manager = ManagerV1_0_8Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "8";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_0_8_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_0_8_JSON (*((EFI_REDFISH_MANAGER_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_0_8 = (EFI_REDFISH_MANAGER_V1_0_8 *)InterpProp;
  DestroyManager_V1_0_8_CS (ManagerV1_0_8->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_0_8EntryPoint (
