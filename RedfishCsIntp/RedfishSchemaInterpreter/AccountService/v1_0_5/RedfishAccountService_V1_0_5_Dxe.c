...
//
#include <RedfishInterpreter/AccountService/v1_0_5/EfiAccountServiceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_0_5 
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_5 *AccountServiceV1_0_5;
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_5_CS *AccountServiceV1_0_5Cs;
  ...
  Status = Json_AccountService_V1_0_5_To_CS (ResoruceRaw, &AccountServiceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_0_5 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_5));
  if (AccountServiceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AccountServiceV1_0_5;
  AccountServiceV1_0_5->AccountService = AccountServiceV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("AccountService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "AccountService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("AccountService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "AccountService");
...
)
{
  ...
  return CS_To_AccountService_V1_0_5_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
EFI_STATUS
EFIAPI
AccountServiceDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  AccountServiceV1_0_5 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_5 *)InterpProp;
  DestroyAccountService_V1_0_5_CS (AccountServiceV1_0_5->AccountService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from AccountServiceFromEfiStruct
...
)
{
  ...
  return DestroyAccountService_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
