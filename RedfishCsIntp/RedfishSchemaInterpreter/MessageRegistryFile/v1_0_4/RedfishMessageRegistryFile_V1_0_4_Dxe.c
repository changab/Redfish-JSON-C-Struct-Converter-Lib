...
//
#include <RedfishInterpreter/MessageRegistryFile/v1_0_4/EfiMessageRegistryFileV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_0_4 
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_4 *MessageRegistryFileV1_0_4;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_4_CS *MessageRegistryFileV1_0_4Cs;
  ...
  Status = Json_MessageRegistryFile_V1_0_4_To_CS (ResoruceRaw, &MessageRegistryFileV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_0_4 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_4));
  if (MessageRegistryFileV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryFileV1_0_4;
  MessageRegistryFileV1_0_4->MessageRegistryFile = MessageRegistryFileV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistryFile_V1_0_4_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryFileV1_0_4 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_4 *)InterpProp;
  DestroyMessageRegistryFile_V1_0_4_CS (MessageRegistryFileV1_0_4->MessageRegistryFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistryFile_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
