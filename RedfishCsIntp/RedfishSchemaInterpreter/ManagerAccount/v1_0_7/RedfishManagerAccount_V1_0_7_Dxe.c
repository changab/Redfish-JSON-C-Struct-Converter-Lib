...
//
#include <RedfishInterpreter/ManagerAccount/v1_0_7/EfiManagerAccountV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_7 
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_7 *ManagerAccountV1_0_7;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_7_CS *ManagerAccountV1_0_7Cs;
  ...
  Status = Json_ManagerAccount_V1_0_7_To_CS (ResoruceRaw, &ManagerAccountV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_7 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_7));
  if (ManagerAccountV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerAccountV1_0_7;
  ManagerAccountV1_0_7->ManagerAccount = ManagerAccountV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerAccount_V1_0_7_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerAccountV1_0_7 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_7 *)InterpProp;
  DestroyManagerAccount_V1_0_7_CS (ManagerAccountV1_0_7->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerAccount_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
