...
//
#include <RedfishInterpreter/Role/v1_0_3/EfiRoleV1_0_3.h>
...
{
  EFI_REDFISH_ROLE_V1_0_3 *RoleV1_0_3;
  EFI_REDFISH_ROLE_V1_0_3_CS *RoleV1_0_3Cs;
  ...
  Status = Json_Role_V1_0_3_To_CS (ResoruceRaw, &RoleV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_0_3 = (EFI_REDFISH_ROLE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_0_3));
  if (RoleV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)RoleV1_0_3;
  RoleV1_0_3->Role = RoleV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_ROLE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Role_V1_0_3_JSON (*((EFI_REDFISH_ROLE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  RoleV1_0_3 = (EFI_REDFISH_ROLE_V1_0_3 *)InterpProp;
  DestroyRole_V1_0_3_CS (RoleV1_0_3->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyRole_V1_0_3_Json (ResoruceRaw);
}
