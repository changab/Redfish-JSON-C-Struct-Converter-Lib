...
#ifndef _RedfishNetworkinterface_V1_1_1_CSTRUCT_H_
#define _RedfishNetworkinterface_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishNetworkInterface_V1_1_1_Actions_CS RedfishNetworkInterface_V1_1_1_Actions_CS;
typedef struct _RedfishNetworkInterface_V1_1_1_Links_CS RedfishNetworkInterface_V1_1_1_Links_CS;
typedef struct _RedfishNetworkInterface_V1_1_1_NetworkInterface_CS RedfishNetworkInterface_V1_1_1_NetworkInterface_CS;
typedef struct _RedfishNetworkInterface_V1_1_1_OemActions_CS RedfishNetworkInterface_V1_1_1_OemActions_CS;
...
typedef struct _RedfishNetworkInterface_V1_1_1_Actions_CS {
    RedfishNetworkInterface_V1_1_1_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishNetworkInterface_V1_1_1_NetworkInterface_CS {
    ...
    RedfishNetworkInterface_V1_1_1_Actions_CS    *Actions;                 // The available actions for this
                                                                           // resource.
    RedfishCS_char                               *Description;         
    RedfishCS_char                               *Id;                  
    RedfishNetworkInterface_V1_1_1_Links_CS      *Links;                   // Links.
    RedfishCS_char                               *Name;                
...
RedfishCS_status
Json_NetworkInterface_V1_1_1_To_CS (char *JsonRawText, RedfishNetworkInterface_V1_1_1_NetworkInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkInterface_V1_1_1_JSON (RedfishNetworkInterface_V1_1_1_NetworkInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkInterface_V1_1_1_CS (RedfishNetworkInterface_V1_1_1_NetworkInterface_CS *CSPtr);

RedfishCS_status
DestroyNetworkInterface_V1_1_1_Json (RedfishCS_char *JsonText);
