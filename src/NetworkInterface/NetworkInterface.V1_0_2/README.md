# Definition of NetworkInterface.V1_0_2 and functions<br><br>
...
## NetworkInterface
    typedef struct _RedfishNetworkInterface_V1_0_2_NetworkInterface_CS {
        ...
        RedfishCS_char *Id;
        RedfishNetworkInterface_V1_0_2_Links_CS *Links;
        RedfishCS_char *Name;
...
|**Links**|RedfishNetworkInterface_V1_0_2_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish NetworkInterface V1_0_2 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish NetworkInterface V1_0_2 JSON Function
    RedfishCS_status
    CS_To_NetworkInterface_V1_0_2_JSON (RedfishNetworkInterface_V1_0_2_NetworkInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish NetworkInterface V1_0_2 C Structure Function
    RedfishCS_status
