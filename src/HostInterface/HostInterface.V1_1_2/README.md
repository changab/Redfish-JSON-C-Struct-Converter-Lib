# Definition of HostInterface.V1_1_2 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Oem**|RedfishHostInterface_V1_1_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## HostInterface
    typedef struct _RedfishHostInterface_V1_1_2_HostInterface_CS {
        ...
        RedfishHostInterface_V1_1_2_Actions_CS *Actions;
        ...
        RedfishHostInterface_V1_1_2_Links_CS *Links;
...
|**Actions**|RedfishHostInterface_V1_1_2_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishHostInterface_V1_1_2_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish HostInterface V1_1_2 to C Structure Function
    RedfishCS_status
    Json_HostInterface_V1_1_2_To_CS (RedfishCS_char *JsonRawText, RedfishHostInterface_V1_1_2_HostInterface_CS **ReturnedCS);

## C Structure to Redfish HostInterface V1_1_2 JSON Function
    RedfishCS_status
    CS_To_HostInterface_V1_1_2_JSON (RedfishHostInterface_V1_1_2_HostInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish HostInterface V1_1_2 C Structure Function
    RedfishCS_status
