# Definition of Memory.V1_4_0 and functions<br><br>
...
|**SecurityCapabilities**|RedfishMemory_V1_4_0_SecurityCapabilities_CS| Structure points to **SecurityCapabilities** property.| No| No
