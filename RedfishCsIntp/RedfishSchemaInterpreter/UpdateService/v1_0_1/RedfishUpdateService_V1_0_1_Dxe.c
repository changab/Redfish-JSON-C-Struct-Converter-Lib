...
//
#include <RedfishInterpreter/UpdateService/v1_0_1/EfiUpdateServiceV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_0_1 
...
{
  EFI_REDFISH_UPDATESERVICE_V1_0_1 *UpdateServiceV1_0_1;
  EFI_REDFISH_UPDATESERVICE_V1_0_1_CS *UpdateServiceV1_0_1Cs;
  ...
  Status = Json_UpdateService_V1_0_1_To_CS (ResoruceRaw, &UpdateServiceV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_0_1 = (EFI_REDFISH_UPDATESERVICE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_0_1));
  if (UpdateServiceV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)UpdateServiceV1_0_1;
  UpdateServiceV1_0_1->UpdateService = UpdateServiceV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_UPDATESERVICE_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_UpdateService_V1_0_1_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  UpdateServiceV1_0_1 = (EFI_REDFISH_UPDATESERVICE_V1_0_1 *)InterpProp;
  DestroyUpdateService_V1_0_1_CS (UpdateServiceV1_0_1->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyUpdateService_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
