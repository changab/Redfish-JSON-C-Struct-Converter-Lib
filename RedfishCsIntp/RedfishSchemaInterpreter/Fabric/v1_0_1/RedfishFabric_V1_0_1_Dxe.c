...
//
#include <RedfishInterpreter/Fabric/v1_0_1/EfiFabricV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_0_1 
...
{
  EFI_REDFISH_FABRIC_V1_0_1 *FabricV1_0_1;
  EFI_REDFISH_FABRIC_V1_0_1_CS *FabricV1_0_1Cs;
  ...
  Status = Json_Fabric_V1_0_1_To_CS (ResoruceRaw, &FabricV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_0_1 = (EFI_REDFISH_FABRIC_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_0_1));
  if (FabricV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)FabricV1_0_1;
  FabricV1_0_1->Fabric = FabricV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_FABRIC_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Fabric_V1_0_1_JSON (*((EFI_REDFISH_FABRIC_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  FabricV1_0_1 = (EFI_REDFISH_FABRIC_V1_0_1 *)InterpProp;
  DestroyFabric_V1_0_1_CS (FabricV1_0_1->Fabric); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyFabric_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_0_1EntryPoint (
