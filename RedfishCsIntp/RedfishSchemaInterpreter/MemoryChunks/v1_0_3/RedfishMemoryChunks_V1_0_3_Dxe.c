...
//
#include <RedfishInterpreter/MemoryChunks/v1_0_3/EfiMemoryChunksV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#MemoryChunks";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryChunks V1_0_3 
...
{
  EFI_REDFISH_MEMORYCHUNKS_V1_0_3 *MemoryChunksV1_0_3;
  EFI_REDFISH_MEMORYCHUNKS_V1_0_3_CS *MemoryChunksV1_0_3Cs;
  ...
  Status = Json_MemoryChunks_V1_0_3_To_CS (ResoruceRaw, &MemoryChunksV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryChunksV1_0_3 = (EFI_REDFISH_MEMORYCHUNKS_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_0_3));
  if (MemoryChunksV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryChunksV1_0_3;
  MemoryChunksV1_0_3->MemoryChunks = MemoryChunksV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryChunks_V1_0_3_JSON (*((EFI_REDFISH_MEMORYCHUNKS_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryChunksV1_0_3 = (EFI_REDFISH_MEMORYCHUNKS_V1_0_3 *)InterpProp;
  DestroyMemoryChunks_V1_0_3_CS (MemoryChunksV1_0_3->MemoryChunks); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryChunks_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
