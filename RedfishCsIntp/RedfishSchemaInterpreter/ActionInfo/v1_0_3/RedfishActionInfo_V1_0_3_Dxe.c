...
//
#include <RedfishInterpreter/ActionInfo/v1_0_3/EfiActionInfoV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_0_3 
...
{
  EFI_REDFISH_ACTIONINFO_V1_0_3 *ActionInfoV1_0_3;
  EFI_REDFISH_ACTIONINFO_V1_0_3_CS *ActionInfoV1_0_3Cs;
  ...
  Status = Json_ActionInfo_V1_0_3_To_CS (ResoruceRaw, &ActionInfoV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_0_3 = (EFI_REDFISH_ACTIONINFO_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_0_3));
  if (ActionInfoV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ActionInfoV1_0_3;
  ActionInfoV1_0_3->ActionInfo = ActionInfoV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_ACTIONINFO_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ActionInfo_V1_0_3_JSON (*((EFI_REDFISH_ACTIONINFO_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ActionInfoV1_0_3 = (EFI_REDFISH_ACTIONINFO_V1_0_3 *)InterpProp;
  DestroyActionInfo_V1_0_3_CS (ActionInfoV1_0_3->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyActionInfo_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
