...
//
#include <RedfishInterpreter/Session/v1_0_4/EfiSessionV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_0_4 
...
{
  EFI_REDFISH_SESSION_V1_0_4 *SessionV1_0_4;
  EFI_REDFISH_SESSION_V1_0_4_CS *SessionV1_0_4Cs;
  ...
  Status = Json_Session_V1_0_4_To_CS (ResoruceRaw, &SessionV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_0_4 = (EFI_REDFISH_SESSION_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_0_4));
  if (SessionV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionV1_0_4;
  SessionV1_0_4->Session = SessionV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_SESSION_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Session_V1_0_4_JSON (*((EFI_REDFISH_SESSION_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionV1_0_4 = (EFI_REDFISH_SESSION_V1_0_4 *)InterpProp;
  DestroySession_V1_0_4_CS (SessionV1_0_4->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySession_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_0_4EntryPoint (
