...
//
#include <RedfishInterpreter/Drive/v1_0_0/EfiDriveV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_0 
...
{
  EFI_REDFISH_DRIVE_V1_0_0 *DriveV1_0_0;
  EFI_REDFISH_DRIVE_V1_0_0_CS *DriveV1_0_0Cs;
  ...
  Status = Json_Drive_V1_0_0_To_CS (ResoruceRaw, &DriveV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_0 = (EFI_REDFISH_DRIVE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_0));
  if (DriveV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_0_0;
  DriveV1_0_0->Drive = DriveV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_0_0_JSON (*((EFI_REDFISH_DRIVE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_0_0 = (EFI_REDFISH_DRIVE_V1_0_0 *)InterpProp;
  DestroyDrive_V1_0_0_CS (DriveV1_0_0->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_0_0_Json (ResoruceRaw);
}
