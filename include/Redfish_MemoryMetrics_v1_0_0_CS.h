...
#ifndef _RedfishMemorymetrics_V1_0_0_CSTRUCT_H_
#define _RedfishMemorymetrics_V1_0_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemoryMetrics_V1_0_0_AlarmTrips_CS RedfishMemoryMetrics_V1_0_0_AlarmTrips_CS;
typedef struct _RedfishMemoryMetrics_V1_0_0_ClearCurrentPeriod_CS RedfishMemoryMetrics_V1_0_0_ClearCurrentPeriod_CS;
typedef struct _RedfishMemoryMetrics_V1_0_0_CurrentPeriod_CS RedfishMemoryMetrics_V1_0_0_CurrentPeriod_CS;
typedef struct _RedfishMemoryMetrics_V1_0_0_HealthData_CS RedfishMemoryMetrics_V1_0_0_HealthData_CS;
typedef struct _RedfishMemoryMetrics_V1_0_0_LifeTime_CS RedfishMemoryMetrics_V1_0_0_LifeTime_CS;
typedef struct _RedfishMemoryMetrics_V1_0_0_MemoryMetrics_CS RedfishMemoryMetrics_V1_0_0_MemoryMetrics_CS;
typedef struct _RedfishMemoryMetrics_V1_0_0_MemoryMetrics_Actions_CS RedfishMemoryMetrics_V1_0_0_MemoryMetrics_Actions_CS;
typedef struct _RedfishMemoryMetrics_V1_0_0_MemoryMetrics_Actions_Oem_CS RedfishMemoryMetrics_V1_0_0_MemoryMetrics_Actions_Oem_CS;
...
typedef struct _RedfishMemoryMetrics_V1_0_0_HealthData_CS {
    RedfishMemoryMetrics_V1_0_0_AlarmTrips_CS    *AlarmTrips;                      // Alarm trip information about
                                                                                   // the memory
...
typedef struct _RedfishMemoryMetrics_V1_0_0_MemoryMetrics_CS {
    ...
    RedfishMemoryMetrics_V1_0_0_MemoryMetrics_Actions_CS    *Actions;          // The available actions for this
                                                                               // resource.
    RedfishCS_int64                                         *BlockSizeBytes;    // Block size in bytes
    RedfishMemoryMetrics_V1_0_0_CurrentPeriod_CS            *CurrentPeriod;    // This object describes the
                                                                               // central memory of the system
                                                                               // in general detail.
    RedfishCS_char                                          *Description;  
    RedfishMemoryMetrics_V1_0_0_HealthData_CS               *HealthData;       // This object describes the
                                                                               // central memory of the system
                                                                               // in general detail.
    RedfishCS_char                                          *Id;           
    RedfishMemoryMetrics_V1_0_0_LifeTime_CS                 *LifeTime;         // This object describes the
                                                                               // central memory of the system
                                                                               // in general detail.
    RedfishCS_char                                          *Name;         
...
RedfishCS_status
Json_MemoryMetrics_V1_0_0_To_CS (char *JsonRawText, RedfishMemoryMetrics_V1_0_0_MemoryMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryMetrics_V1_0_0_JSON (RedfishMemoryMetrics_V1_0_0_MemoryMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryMetrics_V1_0_0_CS (RedfishMemoryMetrics_V1_0_0_MemoryMetrics_CS *CSPtr);

RedfishCS_status
DestroyMemoryMetrics_V1_0_0_Json (RedfishCS_char *JsonText);
