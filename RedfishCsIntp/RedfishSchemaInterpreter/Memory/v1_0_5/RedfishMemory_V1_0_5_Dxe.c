...
//
#include <RedfishInterpreter/Memory/v1_0_5/EfiMemoryV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_0_5 
...
{
  EFI_REDFISH_MEMORY_V1_0_5 *MemoryV1_0_5;
  EFI_REDFISH_MEMORY_V1_0_5_CS *MemoryV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Memory") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Memory_V1_0_5_To_CS (ResoruceRaw, &MemoryV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_0_5 = (EFI_REDFISH_MEMORY_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_0_5));
  if (MemoryV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryV1_0_5;
  MemoryV1_0_5->Memory = MemoryV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_MEMORY_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Memory"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Memory");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Memory"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Memory");
...
)
{
  ...
  return CS_To_Memory_V1_0_5_JSON (*((EFI_REDFISH_MEMORY_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in MemoryToStruct.
...
)
{
  ...
  MemoryV1_0_5 = (EFI_REDFISH_MEMORY_V1_0_5 *)InterpProp;
  DestroyMemory_V1_0_5_CS (MemoryV1_0_5->Memory); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MemoryFromEfiStruct
...
)
{
  ...
  return DestroyMemory_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_0_5EntryPoint (
