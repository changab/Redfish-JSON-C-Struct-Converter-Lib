...
//
#include <RedfishInterpreter/ComputerSystem/v1_1_7/EfiComputerSystemV1_1_7.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_1_7 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_7 *ComputerSystemV1_1_7;
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_7_CS *ComputerSystemV1_1_7Cs;
  ...
  Status = Json_ComputerSystem_V1_1_7_To_CS (ResoruceRaw, &ComputerSystemV1_1_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_1_7 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_1_7));
  if (ComputerSystemV1_1_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_1_7;
  ComputerSystemV1_1_7->ComputerSystem = ComputerSystemV1_1_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_1_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_1_7_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_1_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DestroyComputerSystem_V1_1_7_CS (ComputerSystemV1_1_7->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_1_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
