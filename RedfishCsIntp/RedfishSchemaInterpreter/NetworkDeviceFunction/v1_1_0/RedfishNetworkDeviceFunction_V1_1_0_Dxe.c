...
//
#include <RedfishInterpreter/NetworkDeviceFunction/v1_1_0/EfiNetworkDeviceFunctionV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_1_0 
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_0 *NetworkDeviceFunctionV1_1_0;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_0_CS *NetworkDeviceFunctionV1_1_0Cs;
  ...
  Status = Json_NetworkDeviceFunction_V1_1_0_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_1_0 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_0));
  if (NetworkDeviceFunctionV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkDeviceFunctionV1_1_0;
  NetworkDeviceFunctionV1_1_0->NetworkDeviceFunction = NetworkDeviceFunctionV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkDeviceFunction_V1_1_0_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkDeviceFunctionV1_1_0 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_0 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_1_0_CS (NetworkDeviceFunctionV1_1_0->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkDeviceFunction_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
