...
//
#include <RedfishInterpreter/UpdateService/v1_1_3/EfiUpdateServiceV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_1_3 
...
{
  EFI_REDFISH_UPDATESERVICE_V1_1_3 *UpdateServiceV1_1_3;
  EFI_REDFISH_UPDATESERVICE_V1_1_3_CS *UpdateServiceV1_1_3Cs;
  ...
  Status = Json_UpdateService_V1_1_3_To_CS (ResoruceRaw, &UpdateServiceV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_1_3 = (EFI_REDFISH_UPDATESERVICE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_1_3));
  if (UpdateServiceV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)UpdateServiceV1_1_3;
  UpdateServiceV1_1_3->UpdateService = UpdateServiceV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_UPDATESERVICE_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_UpdateService_V1_1_3_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  UpdateServiceV1_1_3 = (EFI_REDFISH_UPDATESERVICE_V1_1_3 *)InterpProp;
  DestroyUpdateService_V1_1_3_CS (UpdateServiceV1_1_3->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyUpdateService_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
