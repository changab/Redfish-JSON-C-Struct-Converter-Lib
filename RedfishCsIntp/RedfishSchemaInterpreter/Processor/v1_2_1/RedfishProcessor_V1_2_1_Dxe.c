...
//
#include <RedfishInterpreter/Processor/v1_2_1/EfiProcessorV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_2_1 
...
{
  EFI_REDFISH_PROCESSOR_V1_2_1 *ProcessorV1_2_1;
  EFI_REDFISH_PROCESSOR_V1_2_1_CS *ProcessorV1_2_1Cs;
  ...
  Status = Json_Processor_V1_2_1_To_CS (ResoruceRaw, &ProcessorV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_2_1 = (EFI_REDFISH_PROCESSOR_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_2_1));
  if (ProcessorV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ProcessorV1_2_1;
  ProcessorV1_2_1->Processor = ProcessorV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_PROCESSOR_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Processor_V1_2_1_JSON (*((EFI_REDFISH_PROCESSOR_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ProcessorV1_2_1 = (EFI_REDFISH_PROCESSOR_V1_2_1 *)InterpProp;
  DestroyProcessor_V1_2_1_CS (ProcessorV1_2_1->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyProcessor_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_2_1EntryPoint (
