...
//
#include <RedfishInterpreter/Drive/v1_1_2/EfiDriveV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_1_2 
...
{
  EFI_REDFISH_DRIVE_V1_1_2 *DriveV1_1_2;
  EFI_REDFISH_DRIVE_V1_1_2_CS *DriveV1_1_2Cs;
  ...
  Status = Json_Drive_V1_1_2_To_CS (ResoruceRaw, &DriveV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_1_2 = (EFI_REDFISH_DRIVE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_1_2));
  if (DriveV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_1_2;
  DriveV1_1_2->Drive = DriveV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_1_2_JSON (*((EFI_REDFISH_DRIVE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_1_2 = (EFI_REDFISH_DRIVE_V1_1_2 *)InterpProp;
  DestroyDrive_V1_1_2_CS (DriveV1_1_2->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_1_2_Json (ResoruceRaw);
}
