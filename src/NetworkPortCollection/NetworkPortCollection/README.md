# Definition of NetworkPortCollection and functions<br><br>
...
## Redfish NetworkPortCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish NetworkPortCollection  JSON Function
    RedfishCS_status
    CS_To_NetworkPortCollection_JSON (RedfishNetworkPortCollection_NetworkPortCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish NetworkPortCollection  C Structure Function
    RedfishCS_status
