...
//
#include <RedfishInterpreter/Power/v1_3_1/EfiPowerV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_3_1 
...
{
  EFI_REDFISH_POWER_V1_3_1 *PowerV1_3_1;
  EFI_REDFISH_POWER_V1_3_1_CS *PowerV1_3_1Cs;
  ...
  Status = Json_Power_V1_3_1_To_CS (ResoruceRaw, &PowerV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_3_1 = (EFI_REDFISH_POWER_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_3_1));
  if (PowerV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_3_1;
  PowerV1_3_1->Power = PowerV1_3_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_POWER_V1_3_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_3_1_JSON (*((EFI_REDFISH_POWER_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DestroyPower_V1_3_1_CS (PowerV1_3_1->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_3_1_Json (ResoruceRaw);
}
