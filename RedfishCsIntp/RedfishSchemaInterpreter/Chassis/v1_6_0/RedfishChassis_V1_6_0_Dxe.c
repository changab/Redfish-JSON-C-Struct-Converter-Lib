...
//
#include <RedfishInterpreter/Chassis/v1_6_0/EfiChassisV1_6_0.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_6_0 
...
{
  EFI_REDFISH_CHASSIS_V1_6_0 *ChassisV1_6_0;
  EFI_REDFISH_CHASSIS_V1_6_0_CS *ChassisV1_6_0Cs;
  ...
  Status = Json_Chassis_V1_6_0_To_CS (ResoruceRaw, &ChassisV1_6_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_6_0 = (EFI_REDFISH_CHASSIS_V1_6_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_6_0));
  if (ChassisV1_6_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_6_0;
  ChassisV1_6_0->Chassis = ChassisV1_6_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "6";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_6_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_6_0_JSON (*((EFI_REDFISH_CHASSIS_V1_6_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_6_0 = (EFI_REDFISH_CHASSIS_V1_6_0 *)InterpProp;
  DestroyChassis_V1_6_0_CS (ChassisV1_6_0->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_6_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_6_0EntryPoint (
