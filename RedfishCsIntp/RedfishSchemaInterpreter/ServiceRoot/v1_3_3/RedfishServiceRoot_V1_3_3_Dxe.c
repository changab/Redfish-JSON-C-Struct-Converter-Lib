...
//
#include <RedfishInterpreter/ServiceRoot/v1_3_3/EfiServiceRootV1_3_3.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_3_3 
...
{
  EFI_REDFISH_SERVICEROOT_V1_3_3 *ServiceRootV1_3_3;
  EFI_REDFISH_SERVICEROOT_V1_3_3_CS *ServiceRootV1_3_3Cs;
  ...
  Status = Json_ServiceRoot_V1_3_3_To_CS (ResoruceRaw, &ServiceRootV1_3_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_3_3 = (EFI_REDFISH_SERVICEROOT_V1_3_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_3_3));
  if (ServiceRootV1_3_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_3_3;
  ServiceRootV1_3_3->ServiceRoot = ServiceRootV1_3_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_3_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ServiceRoot_V1_3_3_JSON (*((EFI_REDFISH_SERVICEROOT_V1_3_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ServiceRootV1_3_3 = (EFI_REDFISH_SERVICEROOT_V1_3_3 *)InterpProp;
  DestroyServiceRoot_V1_3_3_CS (ServiceRootV1_3_3->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyServiceRoot_V1_3_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_3_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_3_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
