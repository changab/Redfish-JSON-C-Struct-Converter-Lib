...
#include"Redfish_ComputerSystemCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishComputerSystemCollection_ComputerSystemCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ComputerSystemCollection.ComputerSystemCollection
//
RedfishCS_status CS_To_ComputerSystemCollection_JSON(RedfishComputerSystemCollection_ComputerSystemCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ComputerSystemCollection.ComputerSystemCollection
//
RedfishCS_status DestroyComputerSystemCollection_CS(RedfishComputerSystemCollection_ComputerSystemCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ComputerSystemCollection.ComputerSystemCollection
//
RedfishCS_status DestroyComputerSystemCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ComputerSystemCollection.NOVERSIONED.ComputerSystemCollection
//
RedfishCS_status
Json_ComputerSystemCollection_To_CS(RedfishCS_char *JsonRawText, RedfishComputerSystemCollection_ComputerSystemCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishComputerSystemCollection_ComputerSystemCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ComputerSystemCollection", "noversioned", "ComputerSystemCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishComputerSystemCollection_ComputerSystemCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyComputerSystemCollection_CS (Cs);
  return Status;
}
