...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Volume_Initialize**|RedfishVolume_V1_0_1_Initialize_CS| Structure points to **#Volume.Initialize** property.| No| No
|**Oem**|RedfishVolume_V1_0_1_Volume_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## Volume
    typedef struct _RedfishVolume_V1_0_1_Volume_CS {
        ...
        RedfishVolume_V1_0_1_Volume_Actions_CS *Actions;
        ...
        RedfishVolume_V1_0_1_Volume_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishVolume_V1_0_1_Operations_CS *Operations;
...
|**Actions**|RedfishVolume_V1_0_1_Volume_Actions_CS| Structure points to **Actions** property.| No| Yes
...
|**Links**|RedfishVolume_V1_0_1_Volume_Links_CS| Structure points to **Links** property.| No| Yes
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| No
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Operations**|RedfishVolume_V1_0_1_Operations_CS| Structure points to **Operations** property.| No| Yes
