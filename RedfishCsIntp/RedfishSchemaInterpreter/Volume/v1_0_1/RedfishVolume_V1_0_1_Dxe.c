...
//
#include <RedfishInterpreter/Volume/v1_0_1/EfiVolumeV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Volume";
BOOLEAN IsRevisonController = TRUE;

// Support Volume V1_0_1 
...
{
  EFI_REDFISH_VOLUME_V1_0_1 *VolumeV1_0_1;
  EFI_REDFISH_VOLUME_V1_0_1_CS *VolumeV1_0_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Volume") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Volume_V1_0_1_To_CS (ResoruceRaw, &VolumeV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VolumeV1_0_1 = (EFI_REDFISH_VOLUME_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VOLUME_V1_0_1));
  if (VolumeV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VolumeV1_0_1;
  VolumeV1_0_1->Volume = VolumeV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_VOLUME_V1_0_1_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Volume"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Volume");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Volume"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Volume");
...
)
{
  ...
  return CS_To_Volume_V1_0_1_JSON (*((EFI_REDFISH_VOLUME_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in VolumeToStruct.
...
)
{
  ...
  VolumeV1_0_1 = (EFI_REDFISH_VOLUME_V1_0_1 *)InterpProp;
  DestroyVolume_V1_0_1_CS (VolumeV1_0_1->Volume); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from VolumeFromEfiStruct
...
)
{
  ...
  return DestroyVolume_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVolume_V1_0_1EntryPoint (
