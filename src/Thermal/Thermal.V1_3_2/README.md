# Definition of Thermal.V1_3_2 and functions<br><br>
...
## Fan
    typedef struct _RedfishThermal_V1_3_2_Fan_CS {
        RedfishThermal_V1_3_2_FanActions_CS *Actions;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Actions**|RedfishThermal_V1_3_2_FanActions_CS| Structure points to **Actions** property.| No| No
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_3_2_FanOemActions_CS| Structure points to **Oem** property.| No| No
...
## Temperature
    typedef struct _RedfishThermal_V1_3_2_Temperature_CS {
        RedfishThermal_V1_3_2_TemperatureActions_CS *Actions;
        RedfishCS_int64 *LowerThresholdCritical;
        RedfishCS_int64 *LowerThresholdFatal;
        RedfishCS_int64 *LowerThresholdNonCritical;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Actions**|RedfishThermal_V1_3_2_TemperatureActions_CS| Structure points to **Actions** property.| No| No
|**LowerThresholdCritical**|RedfishCS_int64| 64-bit long long interger pointer to **LowerThresholdCritical** property.| No| Yes
|**LowerThresholdFatal**|RedfishCS_int64| 64-bit long long interger pointer to **LowerThresholdFatal** property.| No| Yes
|**LowerThresholdNonCritical**|RedfishCS_int64| 64-bit long long interger pointer to **LowerThresholdNonCritical** property.| No| Yes
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_3_2_TemperatureOemActions_CS| Structure points to **Oem** property.| No| No
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_3_2_ThermalOemActions_CS| Structure points to **Oem** property.| No| No
...
## Thermal
    typedef struct _RedfishThermal_V1_3_2_Thermal_CS {
        ...
        RedfishThermal_V1_3_2_ThermalActions_CS *Actions;
        RedfishCS_char *Description;
        RedfishThermal_V1_3_2_Fan_CS *Fans;
        ...
        RedfishCS_int64 *Redundancyodata_count;
        RedfishResource_Status_CS *Status;
        RedfishThermal_V1_3_2_Temperature_CS *Temperatures;
...
|**Actions**|RedfishThermal_V1_3_2_ThermalActions_CS| Structure points to **Actions** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Fans**|RedfishThermal_V1_3_2_Fan_CS| Structure points to **Fans** property.| No| No
...
|**Redundancyodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Redundancy@odata.count** property.| No| No
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**Temperatures**|RedfishThermal_V1_3_2_Temperature_CS| Structure points to **Temperatures** property.| No| No
|**Temperaturesodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Temperatures@odata.count** property.| No| No
## Redfish Thermal V1_3_2 to C Structure Function
    RedfishCS_status
    Json_Thermal_V1_3_2_To_CS (RedfishCS_char *JsonRawText, RedfishThermal_V1_3_2_Thermal_CS **ReturnedCS);

## C Structure to Redfish Thermal V1_3_2 JSON Function
    RedfishCS_status
    CS_To_Thermal_V1_3_2_JSON (RedfishThermal_V1_3_2_Thermal_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Thermal V1_3_2 C Structure Function
    RedfishCS_status
