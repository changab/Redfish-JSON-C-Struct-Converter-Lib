...
#ifndef _RedfishSecureboot_V1_0_4_CSTRUCT_H_
#define _RedfishSecureboot_V1_0_4_CSTRUCT_H_
...
typedef struct _RedfishSecureBoot_V1_0_4_Actions_CS RedfishSecureBoot_V1_0_4_Actions_CS;
typedef struct _RedfishSecureBoot_V1_0_4_OemActions_CS RedfishSecureBoot_V1_0_4_OemActions_CS;
typedef struct _RedfishSecureBoot_V1_0_4_ResetKeys_CS RedfishSecureBoot_V1_0_4_ResetKeys_CS;
typedef struct _RedfishSecureBoot_V1_0_4_SecureBoot_CS RedfishSecureBoot_V1_0_4_SecureBoot_CS;
//
...
typedef struct _RedfishSecureBoot_V1_0_4_Actions_CS {
    ...
    RedfishSecureBoot_V1_0_4_OemActions_CS    *Oem;                    // This property contains the
...
typedef struct _RedfishSecureBoot_V1_0_4_SecureBoot_CS {
    ...
    RedfishSecureBoot_V1_0_4_Actions_CS    *Actions;                 // The available actions for this
                                                                     // resource.
...
RedfishCS_status
Json_SecureBoot_V1_0_4_To_CS (char *JsonRawText, RedfishSecureBoot_V1_0_4_SecureBoot_CS **ReturnedCS);

RedfishCS_status
CS_To_SecureBoot_V1_0_4_JSON (RedfishSecureBoot_V1_0_4_SecureBoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySecureBoot_V1_0_4_CS (RedfishSecureBoot_V1_0_4_SecureBoot_CS *CSPtr);

RedfishCS_status
DestroySecureBoot_V1_0_4_Json (RedfishCS_char *JsonText);
