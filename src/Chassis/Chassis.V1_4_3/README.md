# Definition of Chassis.V1_4_3 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Chassis_Reset**|RedfishChassis_V1_4_3_Reset_CS| Structure points to **#Chassis.Reset** property.| No| No
|**Oem**|RedfishChassis_V1_4_3_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Chassis
    typedef struct _RedfishChassis_V1_4_3_Chassis_CS {
        ...
        RedfishChassis_V1_4_3_Actions_CS *Actions;
        ...
        RedfishChassis_V1_4_3_Links_CS *Links;
        ...
        RedfishChassis_V1_4_3_PhysicalSecurity_CS *PhysicalSecurity;
...
|**Actions**|RedfishChassis_V1_4_3_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishChassis_V1_4_3_Links_CS| Structure points to **Links** property.| No| No
...
|**PhysicalSecurity**|RedfishChassis_V1_4_3_PhysicalSecurity_CS| Structure points to **PhysicalSecurity** property.| No| No
...
## Redfish Chassis V1_4_3 to C Structure Function
    RedfishCS_status
    Json_Chassis_V1_4_3_To_CS (RedfishCS_char *JsonRawText, RedfishChassis_V1_4_3_Chassis_CS **ReturnedCS);

## C Structure to Redfish Chassis V1_4_3 JSON Function
    RedfishCS_status
    CS_To_Chassis_V1_4_3_JSON (RedfishChassis_V1_4_3_Chassis_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Chassis V1_4_3 C Structure Function
    RedfishCS_status
