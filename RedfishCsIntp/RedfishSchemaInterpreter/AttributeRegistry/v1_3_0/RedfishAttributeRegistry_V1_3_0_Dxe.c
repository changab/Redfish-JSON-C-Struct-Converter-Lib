...
//
#include <RedfishInterpreter/AttributeRegistry/v1_3_0/EfiAttributeRegistryV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_3_0 
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_0 *AttributeRegistryV1_3_0;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_0_CS *AttributeRegistryV1_3_0Cs;
  ...
  Status = Json_AttributeRegistry_V1_3_0_To_CS (ResoruceRaw, &AttributeRegistryV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_3_0 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_0));
  if (AttributeRegistryV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AttributeRegistryV1_3_0;
  AttributeRegistryV1_3_0->AttributeRegistry = AttributeRegistryV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AttributeRegistry_V1_3_0_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AttributeRegistryV1_3_0 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_0 *)InterpProp;
  DestroyAttributeRegistry_V1_3_0_CS (AttributeRegistryV1_3_0->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAttributeRegistry_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
