...
#ifndef _RedfishHostinterface_V1_1_1_CSTRUCT_H_
#define _RedfishHostinterface_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishHostInterface_V1_1_1_Actions_CS RedfishHostInterface_V1_1_1_Actions_CS;
typedef struct _RedfishHostInterface_V1_1_1_HostInterface_CS RedfishHostInterface_V1_1_1_HostInterface_CS;
typedef struct _RedfishHostInterface_V1_1_1_Links_CS RedfishHostInterface_V1_1_1_Links_CS;
typedef struct _RedfishHostInterface_V1_1_1_OemActions_CS RedfishHostInterface_V1_1_1_OemActions_CS;
...
//
typedef struct _RedfishHostInterface_V1_1_1_Actions_CS {
    RedfishHostInterface_V1_1_1_OemActions_CS    *Oem;
} RedfishHostInterface_V1_1_1_Actions_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishHostInterface_V1_1_1_Links_CS {
...
} RedfishHostInterface_V1_1_1_Links_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishHostInterface_V1_1_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishHostInterface_V1_1_1_OemActions_CS;
...
//
// The HostInterface schema represetns a single host interface.
//
typedef struct _RedfishHostInterface_V1_1_1_HostInterface_CS {
    RedfishCS_Header                          Header;
    RedfishCS_char                            *odata_context;         
    RedfishCS_char                            *odata_id;              
    RedfishCS_char                            *odata_type;            
    RedfishHostInterface_V1_1_1_Actions_CS    *Actions;                   // The available actions for this
                                                                          // resource.
    ...
    RedfishCS_char                            *KernelAuthRoleId;          // This property contains the
                                                                          ...
                                                                          // on this interface.
    RedfishHostInterface_V1_1_1_Links_CS      *Links;                     // Contains references to other
...
} RedfishHostInterface_V1_1_1_HostInterface_CS;

RedfishCS_status
Json_HostInterface_V1_1_1_To_CS (char *JsonRawText, RedfishHostInterface_V1_1_1_HostInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_HostInterface_V1_1_1_JSON (RedfishHostInterface_V1_1_1_HostInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyHostInterface_V1_1_1_CS (RedfishHostInterface_V1_1_1_HostInterface_CS *CSPtr);

RedfishCS_status
DestroyHostInterface_V1_1_1_Json (RedfishCS_char *JsonText);
