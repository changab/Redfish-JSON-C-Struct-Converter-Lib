...
#include"Redfish_MemoryDomain_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenActions_OemCs(RedfishMemoryDomain_V1_2_0_MemoryDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryDomain_V1_2_0_MemoryDomain_Actions_Oem_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryDomain_V1_2_0_MemoryDomain_Actions_Oem_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishMemoryDomain_V1_2_0_MemoryDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryDomain_V1_2_0_MemoryDomain_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryDomain_V1_2_0_MemoryDomain_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenMemorySet_Array_ElementCs(RedfishMemoryDomain_V1_2_0_MemoryDomain_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMemoryDomain_V1_2_0_MemorySet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMemoryDomain_V1_2_0_MemorySet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MemorySet
  InitializeLinkHead (&(*Dst)->MemorySet);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "MemorySet", Cs->Header.ThisUri, &(*Dst)->MemorySet);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MemorySet@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "MemorySet@odata.count", &(*Dst)->MemorySetodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MemorySet@odata.navigationLink
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "MemorySet@odata.navigationLink", &(*Dst)->MemorySetodata_navigationLink);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishMemoryDomain_V1_2_0_MemorySet_Array_CS
//
static RedfishCS_status GenMemorySet_ArrayCs(RedfishMemoryDomain_V1_2_0_MemoryDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryDomain_V1_2_0_MemorySet_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMemoryDomain_V1_2_0_MemorySet_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMemoryDomain_V1_2_0_MemorySet_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenMemorySet_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishMemoryDomain_V1_2_0_MemoryDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMemoryDomain_V1_2_0_MemoryDomain_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMemoryDomain_V1_2_0_MemoryDomain_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_InterleavableMemorySets(json_t *CsJson, char *Key, RedfishMemoryDomain_V1_2_0_MemorySet_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMemoryDomain_V1_2_0_MemorySet_Array_CS *NextArray;
  RedfishMemoryDomain_V1_2_0_MemorySet_CS *NextArrayItem;
  ...
  do {
    ...
    // MemorySet 
    if (InsertJsonLinkArrayObj (ArrayMember, "MemorySet", &NextArrayItem->MemorySet) != RedfishCS_status_success) {goto Error;}

    // MemorySet@odata.count 
    if (InsertJsonInt64Obj (ArrayMember, "MemorySet@odata.count", NextArrayItem->MemorySetodata_count) != RedfishCS_status_success) {goto Error;}

    // MemorySet@odata.navigationLink 
    if (InsertJsonStringObj (ArrayMember, "MemorySet@odata.navigationLink", NextArrayItem->MemorySetodata_navigationLink) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for MemoryDomain.V1_2_0.MemoryDomain
//
RedfishCS_status CS_To_MemoryDomain_V1_2_0_JSON(RedfishMemoryDomain_V1_2_0_MemoryDomain_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonBoolObj (CsJson, "AllowsBlockProvisioning", CSPtr->AllowsBlockProvisioning) != RedfishCS_status_success) {goto Error;}

  // AllowsMemoryChunkCreation 
  if (InsertJsonBoolObj (CsJson, "AllowsMemoryChunkCreation", CSPtr->AllowsMemoryChunkCreation) != RedfishCS_status_success) {goto Error;}

  // AllowsMirroring 
  if (InsertJsonBoolObj (CsJson, "AllowsMirroring", CSPtr->AllowsMirroring) != RedfishCS_status_success) {goto Error;}

  // AllowsSparing 
  if (InsertJsonBoolObj (CsJson, "AllowsSparing", CSPtr->AllowsSparing) != RedfishCS_status_success) {goto Error;}
  ...
  if (CS_To_JSON_InterleavableMemorySets(CsJson, "InterleavableMemorySets", CSPtr->InterleavableMemorySets) != RedfishCS_status_success) {goto Error;}

  // MemoryChunks 
  if (InsertJsonLinkObj (CsJson, "MemoryChunks", &CSPtr->MemoryChunks) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for MemoryDomain.V1_2_0.MemoryDomain
//
RedfishCS_status DestroyMemoryDomain_V1_2_0_CS(RedfishMemoryDomain_V1_2_0_MemoryDomain_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MemoryDomain.V1_2_0.MemoryDomain
//
RedfishCS_status DestroyMemoryDomain_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MemoryDomain.V1_2_0.MemoryDomain
//
RedfishCS_status
Json_MemoryDomain_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishMemoryDomain_V1_2_0_MemoryDomain_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemoryDomain_V1_2_0_MemoryDomain_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MemoryDomain", "v1_2_0", "MemoryDomain", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemoryDomain_V1_2_0_MemoryDomain_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AllowsBlockProvisioning
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "AllowsBlockProvisioning", &Cs->AllowsBlockProvisioning);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AllowsMemoryChunkCreation
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "AllowsMemoryChunkCreation", &Cs->AllowsMemoryChunkCreation);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AllowsMirroring
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "AllowsMirroring", &Cs->AllowsMirroring);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AllowsSparing
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "AllowsSparing", &Cs->AllowsSparing);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // InterleavableMemorySets
  Status = GenMemorySet_ArrayCs (Cs, JsonObj, "InterleavableMemorySets", &Cs->InterleavableMemorySets);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MemoryChunks
  InitializeLinkHead (&Cs->MemoryChunks);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "MemoryChunks", Cs->Header.ThisUri, &Cs->MemoryChunks);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyMemoryDomain_V1_2_0_CS (Cs);
  return Status;
}
