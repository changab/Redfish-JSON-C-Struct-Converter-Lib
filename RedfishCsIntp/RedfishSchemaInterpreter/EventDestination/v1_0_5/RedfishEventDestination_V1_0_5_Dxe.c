...
//
#include <RedfishInterpreter/EventDestination/v1_0_5/EfiEventDestinationV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_0_5 
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_0_5 *EventDestinationV1_0_5;
  EFI_REDFISH_EVENTDESTINATION_V1_0_5_CS *EventDestinationV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "EventDestination") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_EventDestination_V1_0_5_To_CS (ResoruceRaw, &EventDestinationV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_0_5 = (EFI_REDFISH_EVENTDESTINATION_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_0_5));
  if (EventDestinationV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventDestinationV1_0_5;
  EventDestinationV1_0_5->EventDestination = EventDestinationV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_EVENTDESTINATION_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("EventDestination"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "EventDestination");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("EventDestination"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "EventDestination");
...
)
{
  ...
  return CS_To_EventDestination_V1_0_5_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in EventDestinationToStruct.
...
EFI_STATUS
EFIAPI
EventDestinationDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  EventDestinationV1_0_5 = (EFI_REDFISH_EVENTDESTINATION_V1_0_5 *)InterpProp;
  DestroyEventDestination_V1_0_5_CS (EventDestinationV1_0_5->EventDestination); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EventDestinationFromEfiStruct
...
)
{
  ...
  return DestroyEventDestination_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
