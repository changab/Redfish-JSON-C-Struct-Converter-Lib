...
//
#include <RedfishInterpreter/AttributeRegistry/v1_0_4/EfiAttributeRegistryV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_0_4 
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_4 *AttributeRegistryV1_0_4;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_4_CS *AttributeRegistryV1_0_4Cs;
  ...
  Status = Json_AttributeRegistry_V1_0_4_To_CS (ResoruceRaw, &AttributeRegistryV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_0_4 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_4));
  if (AttributeRegistryV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AttributeRegistryV1_0_4;
  AttributeRegistryV1_0_4->AttributeRegistry = AttributeRegistryV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AttributeRegistry_V1_0_4_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AttributeRegistryV1_0_4 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_4 *)InterpProp;
  DestroyAttributeRegistry_V1_0_4_CS (AttributeRegistryV1_0_4->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAttributeRegistry_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
