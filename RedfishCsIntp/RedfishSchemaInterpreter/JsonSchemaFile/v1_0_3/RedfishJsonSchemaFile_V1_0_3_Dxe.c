...
//
#include <RedfishInterpreter/JsonSchemaFile/v1_0_3/EfiJsonSchemaFileV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_0_3 
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_3 *JsonSchemaFileV1_0_3;
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_3_CS *JsonSchemaFileV1_0_3Cs;
  ...
  Status = Json_JsonSchemaFile_V1_0_3_To_CS (ResoruceRaw, &JsonSchemaFileV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_0_3 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_3));
  if (JsonSchemaFileV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)JsonSchemaFileV1_0_3;
  JsonSchemaFileV1_0_3->JsonSchemaFile = JsonSchemaFileV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_JsonSchemaFile_V1_0_3_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  JsonSchemaFileV1_0_3 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_3 *)InterpProp;
  DestroyJsonSchemaFile_V1_0_3_CS (JsonSchemaFileV1_0_3->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyJsonSchemaFile_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
