...
//
#include <RedfishInterpreter/ResourceBlock/v1_1_2/EfiResourceBlockV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_1_2 
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_1_2 *ResourceBlockV1_1_2;
  EFI_REDFISH_RESOURCEBLOCK_V1_1_2_CS *ResourceBlockV1_1_2Cs;
  ...
  Status = Json_ResourceBlock_V1_1_2_To_CS (ResoruceRaw, &ResourceBlockV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_1_2 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_1_2));
  if (ResourceBlockV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ResourceBlockV1_1_2;
  ResourceBlockV1_1_2->ResourceBlock = ResourceBlockV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ResourceBlock_V1_1_2_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ResourceBlockV1_1_2 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_2 *)InterpProp;
  DestroyResourceBlock_V1_1_2_CS (ResourceBlockV1_1_2->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyResourceBlock_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
