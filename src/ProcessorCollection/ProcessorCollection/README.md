# Definition of ProcessorCollection and functions<br><br>
...
## Redfish ProcessorCollection  to C Structure Function
    RedfishCS_status
    Json_ProcessorCollection_To_CS (RedfishCS_char *JsonRawText, RedfishProcessorCollection_ProcessorCollection_CS **ReturnedCS);

## C Structure to Redfish ProcessorCollection  JSON Function
    RedfishCS_status
    CS_To_ProcessorCollection_JSON (RedfishProcessorCollection_ProcessorCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ProcessorCollection  C Structure Function
    RedfishCS_status
