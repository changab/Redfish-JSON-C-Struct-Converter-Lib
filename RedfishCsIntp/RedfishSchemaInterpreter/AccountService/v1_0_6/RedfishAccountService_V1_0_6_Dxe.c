...
//
#include <RedfishInterpreter/AccountService/v1_0_6/EfiAccountServiceV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_0_6 
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_6 *AccountServiceV1_0_6;
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_6_CS *AccountServiceV1_0_6Cs;
  ...
  Status = Json_AccountService_V1_0_6_To_CS (ResoruceRaw, &AccountServiceV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_0_6 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_6));
  if (AccountServiceV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AccountServiceV1_0_6;
  AccountServiceV1_0_6->AccountService = AccountServiceV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AccountService_V1_0_6_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AccountServiceV1_0_6 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_6 *)InterpProp;
  DestroyAccountService_V1_0_6_CS (AccountServiceV1_0_6->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAccountService_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
