...
#include"Redfish_MessageRegistry_v1_0_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenMessagePropertyCs(RedfishMessageRegistry_V1_0_4_MessageRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishMessageRegistry_V1_0_4_MessageProperty_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMessageRegistry_V1_0_4_MessageProperty_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemCs(RedfishMessageRegistry_V1_0_4_MessageRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_Messages(json_t *CsJson, char *Key, RedfishMessageRegistry_V1_0_4_MessageProperty_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
//
// C structure to JSON for MessageRegistry.V1_0_4.MessageRegistry
//
RedfishCS_status CS_To_MessageRegistry_V1_0_4_JSON(RedfishMessageRegistry_V1_0_4_MessageRegistry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MessageRegistry.V1_0_4.MessageRegistry
//
RedfishCS_status DestroyMessageRegistry_V1_0_4_CS(RedfishMessageRegistry_V1_0_4_MessageRegistry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MessageRegistry.V1_0_4.MessageRegistry
//
RedfishCS_status DestroyMessageRegistry_V1_0_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MessageRegistry.V1_0_4.MessageRegistry
//
RedfishCS_status
Json_MessageRegistry_V1_0_4_To_CS(RedfishCS_char *JsonRawText, RedfishMessageRegistry_V1_0_4_MessageRegistry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMessageRegistry_V1_0_4_MessageRegistry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MessageRegistry", "v1_0_4", "MessageRegistry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMessageRegistry_V1_0_4_MessageRegistry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMessageRegistry_V1_0_4_CS (Cs);
  return Status;
}
