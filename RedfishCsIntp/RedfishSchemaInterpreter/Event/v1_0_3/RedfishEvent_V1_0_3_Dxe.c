...
//
#include <RedfishInterpreter/Event/v1_0_3/EfiEventV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_3 
...
{
  EFI_REDFISH_EVENT_V1_0_3 *EventV1_0_3;
  EFI_REDFISH_EVENT_V1_0_3_CS *EventV1_0_3Cs;
  ...
  Status = Json_Event_V1_0_3_To_CS (ResoruceRaw, &EventV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_3 = (EFI_REDFISH_EVENT_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_3));
  if (EventV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_0_3;
  EventV1_0_3->Event = EventV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_EVENT_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_0_3_JSON (*((EFI_REDFISH_EVENT_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_0_3 = (EFI_REDFISH_EVENT_V1_0_3 *)InterpProp;
  DestroyEvent_V1_0_3_CS (EventV1_0_3->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_0_3_Json (ResoruceRaw);
}
