...
//
#include <RedfishInterpreter/TaskService/v1_1_2/EfiTaskServiceV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_1_2 
...
{
  EFI_REDFISH_TASKSERVICE_V1_1_2 *TaskServiceV1_1_2;
  EFI_REDFISH_TASKSERVICE_V1_1_2_CS *TaskServiceV1_1_2Cs;
  ...
  Status = Json_TaskService_V1_1_2_To_CS (ResoruceRaw, &TaskServiceV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_1_2 = (EFI_REDFISH_TASKSERVICE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_1_2));
  if (TaskServiceV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskServiceV1_1_2;
  TaskServiceV1_1_2->TaskService = TaskServiceV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_TASKSERVICE_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_TaskService_V1_1_2_JSON (*((EFI_REDFISH_TASKSERVICE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskServiceV1_1_2 = (EFI_REDFISH_TASKSERVICE_V1_1_2 *)InterpProp;
  DestroyTaskService_V1_1_2_CS (TaskServiceV1_1_2->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTaskService_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
