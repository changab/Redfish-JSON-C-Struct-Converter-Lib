...
//
#include <RedfishInterpreter/Chassis/v1_3_4/EfiChassisV1_3_4.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_3_4 
...
{
  EFI_REDFISH_CHASSIS_V1_3_4 *ChassisV1_3_4;
  EFI_REDFISH_CHASSIS_V1_3_4_CS *ChassisV1_3_4Cs;
  ...
  Status = Json_Chassis_V1_3_4_To_CS (ResoruceRaw, &ChassisV1_3_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_3_4 = (EFI_REDFISH_CHASSIS_V1_3_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_3_4));
  if (ChassisV1_3_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_3_4;
  ChassisV1_3_4->Chassis = ChassisV1_3_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_3_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_3_4_JSON (*((EFI_REDFISH_CHASSIS_V1_3_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_3_4 = (EFI_REDFISH_CHASSIS_V1_3_4 *)InterpProp;
  DestroyChassis_V1_3_4_CS (ChassisV1_3_4->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_3_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_3_4EntryPoint (
