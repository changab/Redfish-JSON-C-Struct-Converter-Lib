...
//
#include <RedfishInterpreter/TaskService/v1_0_4/EfiTaskServiceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_0_4 
...
{
  EFI_REDFISH_TASKSERVICE_V1_0_4 *TaskServiceV1_0_4;
  EFI_REDFISH_TASKSERVICE_V1_0_4_CS *TaskServiceV1_0_4Cs;
  ...
  Status = Json_TaskService_V1_0_4_To_CS (ResoruceRaw, &TaskServiceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_0_4 = (EFI_REDFISH_TASKSERVICE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_0_4));
  if (TaskServiceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskServiceV1_0_4;
  TaskServiceV1_0_4->TaskService = TaskServiceV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_TASKSERVICE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_TaskService_V1_0_4_JSON (*((EFI_REDFISH_TASKSERVICE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskServiceV1_0_4 = (EFI_REDFISH_TASKSERVICE_V1_0_4 *)InterpProp;
  DestroyTaskService_V1_0_4_CS (TaskServiceV1_0_4->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTaskService_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
