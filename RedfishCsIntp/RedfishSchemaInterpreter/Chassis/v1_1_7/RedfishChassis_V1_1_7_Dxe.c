...
//
#include <RedfishInterpreter/Chassis/v1_1_7/EfiChassisV1_1_7.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_1_7 
...
{
  EFI_REDFISH_CHASSIS_V1_1_7 *ChassisV1_1_7;
  EFI_REDFISH_CHASSIS_V1_1_7_CS *ChassisV1_1_7Cs;
  ...
  Status = Json_Chassis_V1_1_7_To_CS (ResoruceRaw, &ChassisV1_1_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_1_7 = (EFI_REDFISH_CHASSIS_V1_1_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_1_7));
  if (ChassisV1_1_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_1_7;
  ChassisV1_1_7->Chassis = ChassisV1_1_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_1_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_1_7_JSON (*((EFI_REDFISH_CHASSIS_V1_1_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_1_7 = (EFI_REDFISH_CHASSIS_V1_1_7 *)InterpProp;
  DestroyChassis_V1_1_7_CS (ChassisV1_1_7->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_1_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_1_7EntryPoint (
