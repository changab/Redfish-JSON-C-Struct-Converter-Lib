...
//
#include <RedfishInterpreter/MessageRegistryFile/v1_1_1/EfiMessageRegistryFileV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_1_1 
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_1 *MessageRegistryFileV1_1_1;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_1_CS *MessageRegistryFileV1_1_1Cs;
  ...
  Status = Json_MessageRegistryFile_V1_1_1_To_CS (ResoruceRaw, &MessageRegistryFileV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_1_1 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_1));
  if (MessageRegistryFileV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryFileV1_1_1;
  MessageRegistryFileV1_1_1->MessageRegistryFile = MessageRegistryFileV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistryFile_V1_1_1_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryFileV1_1_1 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_1 *)InterpProp;
  DestroyMessageRegistryFile_V1_1_1_CS (MessageRegistryFileV1_1_1->MessageRegistryFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistryFile_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
