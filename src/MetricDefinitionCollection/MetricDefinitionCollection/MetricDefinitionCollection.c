...
#include"Redfish_MetricDefinitionCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishMetricDefinitionCollection_MetricDefinitionCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for MetricDefinitionCollection.MetricDefinitionCollection
//
RedfishCS_status CS_To_MetricDefinitionCollection_JSON(RedfishMetricDefinitionCollection_MetricDefinitionCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MetricDefinitionCollection.MetricDefinitionCollection
//
RedfishCS_status DestroyMetricDefinitionCollection_CS(RedfishMetricDefinitionCollection_MetricDefinitionCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MetricDefinitionCollection.MetricDefinitionCollection
//
RedfishCS_status DestroyMetricDefinitionCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MetricDefinitionCollection.NOVERSIONED.MetricDefinitionCollection
//
RedfishCS_status
Json_MetricDefinitionCollection_To_CS(RedfishCS_char *JsonRawText, RedfishMetricDefinitionCollection_MetricDefinitionCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMetricDefinitionCollection_MetricDefinitionCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MetricDefinitionCollection", "noversioned", "MetricDefinitionCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMetricDefinitionCollection_MetricDefinitionCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMetricDefinitionCollection_CS (Cs);
  return Status;
}
