...
#include"Redfish_SerialInterfaceCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishSerialInterfaceCollection_SerialInterfaceCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for SerialInterfaceCollection.SerialInterfaceCollection
//
RedfishCS_status CS_To_SerialInterfaceCollection_JSON(RedfishSerialInterfaceCollection_SerialInterfaceCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SerialInterfaceCollection.SerialInterfaceCollection
//
RedfishCS_status DestroySerialInterfaceCollection_CS(RedfishSerialInterfaceCollection_SerialInterfaceCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SerialInterfaceCollection.SerialInterfaceCollection
//
RedfishCS_status DestroySerialInterfaceCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SerialInterfaceCollection.NOVERSIONED.SerialInterfaceCollection
//
RedfishCS_status
Json_SerialInterfaceCollection_To_CS(RedfishCS_char *JsonRawText, RedfishSerialInterfaceCollection_SerialInterfaceCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSerialInterfaceCollection_SerialInterfaceCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SerialInterfaceCollection", "noversioned", "SerialInterfaceCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSerialInterfaceCollection_SerialInterfaceCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySerialInterfaceCollection_CS (Cs);
  return Status;
}
