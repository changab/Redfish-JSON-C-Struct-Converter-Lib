...
#include"Redfish_MessageRegistryCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishMessageRegistryCollection_MessageRegistryCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for MessageRegistryCollection.MessageRegistryCollection
//
RedfishCS_status CS_To_MessageRegistryCollection_JSON(RedfishMessageRegistryCollection_MessageRegistryCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MessageRegistryCollection.MessageRegistryCollection
//
RedfishCS_status DestroyMessageRegistryCollection_CS(RedfishMessageRegistryCollection_MessageRegistryCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MessageRegistryCollection.MessageRegistryCollection
//
RedfishCS_status DestroyMessageRegistryCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MessageRegistryCollection.NOVERSIONED.MessageRegistryCollection
//
RedfishCS_status
Json_MessageRegistryCollection_To_CS(RedfishCS_char *JsonRawText, RedfishMessageRegistryCollection_MessageRegistryCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMessageRegistryCollection_MessageRegistryCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MessageRegistryCollection", "noversioned", "MessageRegistryCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMessageRegistryCollection_MessageRegistryCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMessageRegistryCollection_CS (Cs);
  return Status;
}
