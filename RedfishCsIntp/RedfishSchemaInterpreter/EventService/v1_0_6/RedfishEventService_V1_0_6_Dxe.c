...
//
#include <RedfishInterpreter/EventService/v1_0_6/EfiEventServiceV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_6 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_6 *EventServiceV1_0_6;
  EFI_REDFISH_EVENTSERVICE_V1_0_6_CS *EventServiceV1_0_6Cs;
  ...
  Status = Json_EventService_V1_0_6_To_CS (ResoruceRaw, &EventServiceV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_6 = (EFI_REDFISH_EVENTSERVICE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_6));
  if (EventServiceV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_0_6;
  EventServiceV1_0_6->EventService = EventServiceV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventService_V1_0_6_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventServiceV1_0_6 = (EFI_REDFISH_EVENTSERVICE_V1_0_6 *)InterpProp;
  DestroyEventService_V1_0_6_CS (EventServiceV1_0_6->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventService_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
