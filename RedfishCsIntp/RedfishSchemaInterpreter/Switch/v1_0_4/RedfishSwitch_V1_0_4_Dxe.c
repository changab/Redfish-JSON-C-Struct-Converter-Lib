...
//
#include <RedfishInterpreter/Switch/v1_0_4/EfiSwitchV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_0_4 
...
{
  EFI_REDFISH_SWITCH_V1_0_4 *SwitchV1_0_4;
  EFI_REDFISH_SWITCH_V1_0_4_CS *SwitchV1_0_4Cs;
  ...
  Status = Json_Switch_V1_0_4_To_CS (ResoruceRaw, &SwitchV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_0_4 = (EFI_REDFISH_SWITCH_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_0_4));
  if (SwitchV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SwitchV1_0_4;
  SwitchV1_0_4->Switch = SwitchV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_SWITCH_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Switch_V1_0_4_JSON (*((EFI_REDFISH_SWITCH_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SwitchV1_0_4 = (EFI_REDFISH_SWITCH_V1_0_4 *)InterpProp;
  DestroySwitch_V1_0_4_CS (SwitchV1_0_4->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySwitch_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_0_4EntryPoint (
