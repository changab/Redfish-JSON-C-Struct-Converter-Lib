...
//
#include <RedfishInterpreter/Session/v1_0_2/EfiSessionV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_0_2 
...
{
  EFI_REDFISH_SESSION_V1_0_2 *SessionV1_0_2;
  EFI_REDFISH_SESSION_V1_0_2_CS *SessionV1_0_2Cs;
  ...
  Status = Json_Session_V1_0_2_To_CS (ResoruceRaw, &SessionV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_0_2 = (EFI_REDFISH_SESSION_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_0_2));
  if (SessionV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionV1_0_2;
  SessionV1_0_2->Session = SessionV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SESSION_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Session_V1_0_2_JSON (*((EFI_REDFISH_SESSION_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionV1_0_2 = (EFI_REDFISH_SESSION_V1_0_2 *)InterpProp;
  DestroySession_V1_0_2_CS (SessionV1_0_2->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySession_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_0_2EntryPoint (
