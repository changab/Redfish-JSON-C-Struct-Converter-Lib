...
#ifndef _RedfishSerialinterface_V1_1_0_CSTRUCT_H_
#define _RedfishSerialinterface_V1_1_0_CSTRUCT_H_
...
typedef struct _RedfishSerialInterface_V1_1_0_SerialInterface_CS RedfishSerialInterface_V1_1_0_SerialInterface_CS;
typedef struct _RedfishSerialInterface_V1_1_0_SerialInterface_Actions_CS RedfishSerialInterface_V1_1_0_SerialInterface_Actions_CS;
typedef struct _RedfishSerialInterface_V1_1_0_SerialInterface_Actions_Oem_CS RedfishSerialInterface_V1_1_0_SerialInterface_Actions_Oem_CS;
//
...
typedef struct _RedfishSerialInterface_V1_1_0_SerialInterface_Actions_CS {
    RedfishSerialInterface_V1_1_0_SerialInterface_Actions_Oem_CS    *Oem;    // The available OEM specific
...
typedef struct _RedfishSerialInterface_V1_1_0_SerialInterface_CS {
    ...
    RedfishSerialInterface_V1_1_0_SerialInterface_Actions_CS    *Actions;            // The available actions for this
                                                                                     // resource.
...
RedfishCS_status
Json_SerialInterface_V1_1_0_To_CS (char *JsonRawText, RedfishSerialInterface_V1_1_0_SerialInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_SerialInterface_V1_1_0_JSON (RedfishSerialInterface_V1_1_0_SerialInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySerialInterface_V1_1_0_CS (RedfishSerialInterface_V1_1_0_SerialInterface_CS *CSPtr);

RedfishCS_status
DestroySerialInterface_V1_1_0_Json (RedfishCS_char *JsonText);
