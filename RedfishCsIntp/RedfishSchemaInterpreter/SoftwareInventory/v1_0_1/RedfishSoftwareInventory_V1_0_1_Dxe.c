...
//
#include <RedfishInterpreter/SoftwareInventory/v1_0_1/EfiSoftwareInventoryV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_0_1 
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_0_1 *SoftwareInventoryV1_0_1;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_0_1_CS *SoftwareInventoryV1_0_1Cs;
  ...
  Status = Json_SoftwareInventory_V1_0_1_To_CS (ResoruceRaw, &SoftwareInventoryV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_0_1 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_1));
  if (SoftwareInventoryV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SoftwareInventoryV1_0_1;
  SoftwareInventoryV1_0_1->SoftwareInventory = SoftwareInventoryV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SoftwareInventory_V1_0_1_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SoftwareInventoryV1_0_1 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_1 *)InterpProp;
  DestroySoftwareInventory_V1_0_1_CS (SoftwareInventoryV1_0_1->SoftwareInventory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySoftwareInventory_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
