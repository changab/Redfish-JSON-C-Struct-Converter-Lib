...
//
#include <RedfishInterpreter/EthernetInterface/v1_1_1/EfiEthernetInterfaceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_1_1 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_1_1 *EthernetInterfaceV1_1_1;
  EFI_REDFISH_ETHERNETINTERFACE_V1_1_1_CS *EthernetInterfaceV1_1_1Cs;
  ...
  Status = Json_EthernetInterface_V1_1_1_To_CS (ResoruceRaw, &EthernetInterfaceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_1_1 = (EFI_REDFISH_ETHERNETINTERFACE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_1_1));
  if (EthernetInterfaceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_1_1;
  EthernetInterfaceV1_1_1->EthernetInterface = EthernetInterfaceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EthernetInterface_V1_1_1_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EthernetInterfaceV1_1_1 = (EFI_REDFISH_ETHERNETINTERFACE_V1_1_1 *)InterpProp;
  DestroyEthernetInterface_V1_1_1_CS (EthernetInterfaceV1_1_1->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEthernetInterface_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
