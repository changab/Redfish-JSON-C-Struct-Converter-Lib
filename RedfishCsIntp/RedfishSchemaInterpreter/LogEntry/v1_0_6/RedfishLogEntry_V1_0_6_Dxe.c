...
//
#include <RedfishInterpreter/LogEntry/v1_0_6/EfiLogEntryV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_0_6 
...
{
  EFI_REDFISH_LOGENTRY_V1_0_6 *LogEntryV1_0_6;
  EFI_REDFISH_LOGENTRY_V1_0_6_CS *LogEntryV1_0_6Cs;
  ...
  Status = Json_LogEntry_V1_0_6_To_CS (ResoruceRaw, &LogEntryV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_0_6 = (EFI_REDFISH_LOGENTRY_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_0_6));
  if (LogEntryV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_0_6;
  LogEntryV1_0_6->LogEntry = LogEntryV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_0_6_JSON (*((EFI_REDFISH_LOGENTRY_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_0_6 = (EFI_REDFISH_LOGENTRY_V1_0_6 *)InterpProp;
  DestroyLogEntry_V1_0_6_CS (LogEntryV1_0_6->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_0_6EntryPoint (
