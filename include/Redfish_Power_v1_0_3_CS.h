...
#define _RedfishPower_V1_0_3_CSTRUCT_H_
...
typedef struct _RedfishPower_V1_0_3_PowerMetric_CS RedfishPower_V1_0_3_PowerMetric_CS;
typedef struct _RedfishPower_V1_0_3_PowerSupply_CS RedfishPower_V1_0_3_PowerSupply_CS;
typedef struct _RedfishPower_V1_0_3_Voltage_CS RedfishPower_V1_0_3_Voltage_CS;
...
typedef struct _RedfishPower_V1_0_3_PowerControl_CS {
    ...
    RedfishPower_V1_0_3_PowerLimit_CS     *PowerLimit;                        // Power limit status and
                                                                              // configuration information for
                                                                              // this chassis.
    RedfishPower_V1_0_3_PowerMetric_CS    *PowerMetrics;                      // Power readings for this
                                                                              // chassis.
...
typedef struct _RedfishPower_V1_0_3_Power_CS {
    ...
    RedfishResource_Oem_CS                       *Oem;                                 // This is the
                                                                                       ...
                                                                                       // divide the Oem object into
                                                                                       // sections.
    RedfishPower_V1_0_3_PowerControl_Array_CS    *PowerControl;                        // This is the definition for
                                                                                       // power control function (power
                                                                                       // reading/limiting).
    RedfishCS_int64                              *PowerControlodata_count;         
    RedfishCS_char                               *PowerControlodata_navigationLink;
    RedfishPower_V1_0_3_PowerSupply_Array_CS     *PowerSupplies;                       // Details of the power supplies
    ...
    RedfishCS_int64                              *Redundancyodata_count;           
    RedfishCS_char                               *Redundancyodata_navigationLink;  
    RedfishPower_V1_0_3_Voltage_Array_CS         *Voltages;                            // This is the definition for
                                                                                       // voltage sensors.
...
RedfishCS_status
CS_To_Power_V1_0_3_JSON (RedfishPower_V1_0_3_Power_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPower_V1_0_3_CS (RedfishPower_V1_0_3_Power_CS *CSPtr);

RedfishCS_status
DestroyPower_V1_0_3_Json (RedfishCS_char *JsonText);
