...
//
#include <RedfishInterpreter/PCIeFunction/v1_0_4/EfiPCIeFunctionV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_0_4 
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_0_4 *PCIeFunctionV1_0_4;
  EFI_REDFISH_PCIEFUNCTION_V1_0_4_CS *PCIeFunctionV1_0_4Cs;
  ...
  Status = Json_PCIeFunction_V1_0_4_To_CS (ResoruceRaw, &PCIeFunctionV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_0_4 = (EFI_REDFISH_PCIEFUNCTION_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_0_4));
  if (PCIeFunctionV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeFunctionV1_0_4;
  PCIeFunctionV1_0_4->PCIeFunction = PCIeFunctionV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_PCIEFUNCTION_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeFunction_V1_0_4_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeFunctionV1_0_4 = (EFI_REDFISH_PCIEFUNCTION_V1_0_4 *)InterpProp;
  DestroyPCIeFunction_V1_0_4_CS (PCIeFunctionV1_0_4->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeFunction_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
