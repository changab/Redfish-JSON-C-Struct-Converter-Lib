...
//
#include <RedfishInterpreter/NetworkDeviceFunction/v1_1_3/EfiNetworkDeviceFunctionV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_1_3 
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_3 *NetworkDeviceFunctionV1_1_3;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_3_CS *NetworkDeviceFunctionV1_1_3Cs;
  ...
  Status = Json_NetworkDeviceFunction_V1_1_3_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_1_3 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_3));
  if (NetworkDeviceFunctionV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkDeviceFunctionV1_1_3;
  NetworkDeviceFunctionV1_1_3->NetworkDeviceFunction = NetworkDeviceFunctionV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkDeviceFunction_V1_1_3_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkDeviceFunctionV1_1_3 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_3 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_1_3_CS (NetworkDeviceFunctionV1_1_3->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkDeviceFunction_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
