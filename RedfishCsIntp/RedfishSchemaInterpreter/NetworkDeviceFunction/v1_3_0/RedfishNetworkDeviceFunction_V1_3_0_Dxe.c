...
//
#include <RedfishInterpreter/NetworkDeviceFunction/v1_3_0/EfiNetworkDeviceFunctionV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_3_0 
...
EFI_STATUS
EFIAPI
NetworkDeviceFunctionToEfiStruct (
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_0 *NetworkDeviceFunctionV1_3_0;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_0_CS *NetworkDeviceFunctionV1_3_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "NetworkDeviceFunction") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_NetworkDeviceFunction_V1_3_0_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_3_0 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_0));
  if (NetworkDeviceFunctionV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkDeviceFunctionV1_3_0;
  NetworkDeviceFunctionV1_3_0->NetworkDeviceFunction = NetworkDeviceFunctionV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkDeviceFunction"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "NetworkDeviceFunction");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkDeviceFunction"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "NetworkDeviceFunction");
...
EFI_STATUS
EFIAPI
NetworkDeviceFunctionFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_NetworkDeviceFunction_V1_3_0_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in NetworkDeviceFunctionToStruct.
...
EFI_STATUS
EFIAPI
NetworkDeviceFunctionDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  NetworkDeviceFunctionV1_3_0 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_0 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_3_0_CS (NetworkDeviceFunctionV1_3_0->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from NetworkDeviceFunctionFromEfiStruct
...
EFI_STATUS
EFIAPI
NetworkDeviceFunctionDestoryJson(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
  IN EFI_REST_RESOURCE_TYPE_IDENTIFIER *RsrcIdentifier,  
  IN CHAR8 *ResoruceRaw
)
{
  ...
  return DestroyNetworkDeviceFunction_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
