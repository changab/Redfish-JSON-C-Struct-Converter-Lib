...
#include"Redfish_MemoryCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishMemoryCollection_MemoryCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for MemoryCollection.MemoryCollection
//
RedfishCS_status CS_To_MemoryCollection_JSON(RedfishMemoryCollection_MemoryCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MemoryCollection.MemoryCollection
//
RedfishCS_status DestroyMemoryCollection_CS(RedfishMemoryCollection_MemoryCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MemoryCollection.MemoryCollection
//
RedfishCS_status DestroyMemoryCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MemoryCollection.NOVERSIONED.MemoryCollection
//
RedfishCS_status
Json_MemoryCollection_To_CS(RedfishCS_char *JsonRawText, RedfishMemoryCollection_MemoryCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemoryCollection_MemoryCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MemoryCollection", "noversioned", "MemoryCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemoryCollection_MemoryCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
