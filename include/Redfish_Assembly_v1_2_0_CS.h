...
#ifndef _RedfishAssembly_V1_2_0_CSTRUCT_H_
#define _RedfishAssembly_V1_2_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAssembly_V1_2_0_AssemblyData_Array_CS RedfishAssembly_V1_2_0_AssemblyData_Array_CS;
typedef struct _RedfishAssembly_V1_2_0_Actions_CS RedfishAssembly_V1_2_0_Actions_CS;
typedef struct _RedfishAssembly_V1_2_0_Assembly_CS RedfishAssembly_V1_2_0_Assembly_CS;
typedef struct _RedfishAssembly_V1_2_0_AssemblyData_CS RedfishAssembly_V1_2_0_AssemblyData_CS;
typedef struct _RedfishAssembly_V1_2_0_AssemblyDataActions_CS RedfishAssembly_V1_2_0_AssemblyDataActions_CS;
typedef struct _RedfishAssembly_V1_2_0_AssemblyDataOemActions_CS RedfishAssembly_V1_2_0_AssemblyDataOemActions_CS;
typedef struct _RedfishAssembly_V1_2_0_OemActions_CS RedfishAssembly_V1_2_0_OemActions_CS;
...
typedef struct _RedfishAssembly_V1_2_0_Actions_CS {
    RedfishAssembly_V1_2_0_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishAssembly_V1_2_0_AssemblyData_CS {
    ...
    RedfishAssembly_V1_2_0_AssemblyDataActions_CS    *Actions;                  // The available actions for this
                                                                                // resource.
...
typedef struct _RedfishAssembly_V1_2_0_AssemblyDataActions_CS {
    RedfishAssembly_V1_2_0_AssemblyDataOemActions_CS    *Oem;    // This property contains the
                                                                // available OEM specific actions
                                                                // for this resource.
...
typedef struct _RedfishAssembly_V1_2_0_Assembly_CS {
    ...
    RedfishAssembly_V1_2_0_Actions_CS               *Actions;                 // The available actions for this
                                                                              // resource.
    RedfishAssembly_V1_2_0_AssemblyData_Array_CS    *Assemblies;              // This is the definition for an
...
typedef struct _RedfishAssembly_V1_2_0_AssemblyData_Array_CS  {
    RedfishAssembly_V1_2_0_AssemblyData_Array_CS    *Next;
    RedfishAssembly_V1_2_0_AssemblyData_CS    *ArrayValue;
} RedfishAssembly_V1_2_0_AssemblyData_Array_CS;

RedfishCS_status
Json_Assembly_V1_2_0_To_CS (char *JsonRawText, RedfishAssembly_V1_2_0_Assembly_CS **ReturnedCS);

RedfishCS_status
CS_To_Assembly_V1_2_0_JSON (RedfishAssembly_V1_2_0_Assembly_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAssembly_V1_2_0_CS (RedfishAssembly_V1_2_0_Assembly_CS *CSPtr);

RedfishCS_status
DestroyAssembly_V1_2_0_Json (RedfishCS_char *JsonText);
