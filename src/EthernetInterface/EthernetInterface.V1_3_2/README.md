# Definition of EthernetInterface.V1_3_2 and functions<br><br>

## Actions
    typedef struct _RedfishEthernetInterface_V1_3_2_Actions_CS {
        RedfishEthernetInterface_V1_3_2_OemActions_CS *Oem;
    } RedfishEthernetInterface_V1_3_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEthernetInterface_V1_3_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## EthernetInterface
    typedef struct _RedfishEthernetInterface_V1_3_2_EthernetInterface_CS {
        ...
        RedfishEthernetInterface_V1_3_2_Actions_CS *Actions;
        ...
        RedfishEthernetInterface_V1_3_2_IPv6AddressPolicyEntry_CS *IPv6AddressPolicyTable;
        ...
        RedfishEthernetInterface_V1_3_2_Links_CS *Links;
...
|**Actions**|RedfishEthernetInterface_V1_3_2_Actions_CS| Structure points to **Actions** property.| No| No
...
|**IPv6AddressPolicyTable**|RedfishEthernetInterface_V1_3_2_IPv6AddressPolicyEntry_CS| Structure points to **IPv6AddressPolicyTable** property.| No| No
...
|**Links**|RedfishEthernetInterface_V1_3_2_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish EthernetInterface V1_3_2 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EthernetInterface V1_3_2 JSON Function
    RedfishCS_status
    CS_To_EthernetInterface_V1_3_2_JSON (RedfishEthernetInterface_V1_3_2_EthernetInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EthernetInterface V1_3_2 C Structure Function
    RedfishCS_status
