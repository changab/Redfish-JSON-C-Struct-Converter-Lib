# Definition of ManagerNetworkProtocol.V1_0_2 and functions<br><br>
...
|**SSH**|RedfishManagerNetworkProtocol_V1_0_2_Protocol_CS| Structure points to **SSH** property.| No| No
