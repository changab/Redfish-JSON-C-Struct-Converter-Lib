...
#ifndef _RedfishPower_V1_3_0_CSTRUCT_H_
#define _RedfishPower_V1_3_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishPower_V1_3_0_InputRange_Array_CS RedfishPower_V1_3_0_InputRange_Array_CS;
typedef struct _RedfishPower_V1_3_0_PowerControl_Array_CS RedfishPower_V1_3_0_PowerControl_Array_CS;
typedef struct _RedfishPower_V1_3_0_PowerSupply_Array_CS RedfishPower_V1_3_0_PowerSupply_Array_CS;
typedef struct _RedfishPower_V1_3_0_Voltage_Array_CS RedfishPower_V1_3_0_Voltage_Array_CS;
typedef struct _RedfishPower_V1_3_0_InputRange_CS RedfishPower_V1_3_0_InputRange_CS;
typedef struct _RedfishPower_V1_3_0_Power_CS RedfishPower_V1_3_0_Power_CS;
typedef struct _RedfishPower_V1_3_0_PowerControl_CS RedfishPower_V1_3_0_PowerControl_CS;
typedef struct _RedfishPower_V1_3_0_PowerControlActions_CS RedfishPower_V1_3_0_PowerControlActions_CS;
typedef struct _RedfishPower_V1_3_0_PowerControlOemActions_CS RedfishPower_V1_3_0_PowerControlOemActions_CS;
typedef struct _RedfishPower_V1_3_0_PowerLimit_CS RedfishPower_V1_3_0_PowerLimit_CS;
typedef struct _RedfishPower_V1_3_0_PowerMetric_CS RedfishPower_V1_3_0_PowerMetric_CS;
typedef struct _RedfishPower_V1_3_0_PowerSupply_CS RedfishPower_V1_3_0_PowerSupply_CS;
typedef struct _RedfishPower_V1_3_0_PowerSupplyActions_CS RedfishPower_V1_3_0_PowerSupplyActions_CS;
typedef struct _RedfishPower_V1_3_0_PowerSupplyOemActions_CS RedfishPower_V1_3_0_PowerSupplyOemActions_CS;
typedef struct _RedfishPower_V1_3_0_Power_Actions_CS RedfishPower_V1_3_0_Power_Actions_CS;
typedef struct _RedfishPower_V1_3_0_Power_Actions_Oem_CS RedfishPower_V1_3_0_Power_Actions_Oem_CS;
typedef struct _RedfishPower_V1_3_0_Voltage_CS RedfishPower_V1_3_0_Voltage_CS;
typedef struct _RedfishPower_V1_3_0_VoltageActions_CS RedfishPower_V1_3_0_VoltageActions_CS;
typedef struct _RedfishPower_V1_3_0_VoltageOemActions_CS RedfishPower_V1_3_0_VoltageOemActions_CS;
...
typedef struct _RedfishPower_V1_3_0_PowerControl_CS {
    RedfishPower_V1_3_0_PowerControlActions_CS    *Actions;                           // The available actions for this
                                                                                      // resource.
    ...
    RedfishPower_V1_3_0_PowerLimit_CS             *PowerLimit;                        // Power limit status and
                                                                                      // configuration information for
                                                                                      // this chassis.
    RedfishPower_V1_3_0_PowerMetric_CS            *PowerMetrics;                      // Power readings for this
                                                                                      // chassis.
...
typedef struct _RedfishPower_V1_3_0_PowerSupply_CS {
    RedfishPower_V1_3_0_PowerSupplyActions_CS    *Actions;                           // The available actions for this
                                                                                     // resource.
    ...
    RedfishCS_char                               *IndicatorLED;                      // The state of the indicator
                                                                                     ...
                                                                                     // power supply.
    RedfishPower_V1_3_0_InputRange_Array_CS      *InputRanges;                       // This is the input ranges that
...
typedef struct _RedfishPower_V1_3_0_Power_Actions_CS {
    RedfishPower_V1_3_0_Power_Actions_Oem_CS    *Oem;    // The available OEM specific
...
typedef struct _RedfishPower_V1_3_0_Voltage_CS {
    RedfishPower_V1_3_0_VoltageActions_CS    *Actions;                           // The available actions for this
                                                                                 // resource.
...
typedef struct _RedfishPower_V1_3_0_Power_CS {
    ...
    RedfishPower_V1_3_0_Power_Actions_CS         *Actions;                             // The available actions for this
                                                                                       // resource.
    ...
    RedfishResource_Oem_CS                       *Oem;                                 // This is the
                                                                                       ...
                                                                                       // divide the Oem object into
                                                                                       // sections.
    RedfishPower_V1_3_0_PowerControl_Array_CS    *PowerControl;                        // This is the definition for
                                                                                       // power control function (power
                                                                                       // reading/limiting).
    RedfishCS_int64                              *PowerControlodata_count;         
    RedfishCS_char                               *PowerControlodata_navigationLink;
    RedfishPower_V1_3_0_PowerSupply_Array_CS     *PowerSupplies;                       // Details of the power supplies
    ...
    RedfishCS_int64                              *Redundancyodata_count;           
    RedfishCS_char                               *Redundancyodata_navigationLink;  
    RedfishPower_V1_3_0_Voltage_Array_CS         *Voltages;                            // This is the definition for
                                                                                       // voltage sensors.
...
typedef struct _RedfishPower_V1_3_0_InputRange_Array_CS  {
    RedfishPower_V1_3_0_InputRange_Array_CS    *Next;
    RedfishPower_V1_3_0_InputRange_CS    *ArrayValue;
} RedfishPower_V1_3_0_InputRange_Array_CS;

typedef struct _RedfishPower_V1_3_0_PowerControl_Array_CS  {
    RedfishPower_V1_3_0_PowerControl_Array_CS    *Next;
    RedfishPower_V1_3_0_PowerControl_CS    *ArrayValue;
} RedfishPower_V1_3_0_PowerControl_Array_CS;

typedef struct _RedfishPower_V1_3_0_PowerSupply_Array_CS  {
    RedfishPower_V1_3_0_PowerSupply_Array_CS    *Next;
    RedfishPower_V1_3_0_PowerSupply_CS    *ArrayValue;
} RedfishPower_V1_3_0_PowerSupply_Array_CS;

typedef struct _RedfishPower_V1_3_0_Voltage_Array_CS  {
    RedfishPower_V1_3_0_Voltage_Array_CS    *Next;
    RedfishPower_V1_3_0_Voltage_CS    *ArrayValue;
} RedfishPower_V1_3_0_Voltage_Array_CS;

RedfishCS_status
Json_Power_V1_3_0_To_CS (char *JsonRawText, RedfishPower_V1_3_0_Power_CS **ReturnedCS);

RedfishCS_status
CS_To_Power_V1_3_0_JSON (RedfishPower_V1_3_0_Power_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPower_V1_3_0_CS (RedfishPower_V1_3_0_Power_CS *CSPtr);

RedfishCS_status
DestroyPower_V1_3_0_Json (RedfishCS_char *JsonText);
