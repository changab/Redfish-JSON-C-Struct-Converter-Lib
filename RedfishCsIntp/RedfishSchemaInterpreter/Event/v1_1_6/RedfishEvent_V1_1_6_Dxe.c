...
//
#include <RedfishInterpreter/Event/v1_1_6/EfiEventV1_1_6.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_1_6 
...
{
  EFI_REDFISH_EVENT_V1_1_6 *EventV1_1_6;
  EFI_REDFISH_EVENT_V1_1_6_CS *EventV1_1_6Cs;
  ...
  Status = Json_Event_V1_1_6_To_CS (ResoruceRaw, &EventV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_1_6 = (EFI_REDFISH_EVENT_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_1_6));
  if (EventV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_1_6;
  EventV1_1_6->Event = EventV1_1_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_EVENT_V1_1_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_1_6_JSON (*((EFI_REDFISH_EVENT_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_1_6 = (EFI_REDFISH_EVENT_V1_1_6 *)InterpProp;
  DestroyEvent_V1_1_6_CS (EventV1_1_6->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_1_6_Json (ResoruceRaw);
}
