...
//
#include <RedfishInterpreter/EventService/v1_0_5/EfiEventServiceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_5 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_5 *EventServiceV1_0_5;
  EFI_REDFISH_EVENTSERVICE_V1_0_5_CS *EventServiceV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "EventService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_EventService_V1_0_5_To_CS (ResoruceRaw, &EventServiceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_5 = (EFI_REDFISH_EVENTSERVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_5));
  if (EventServiceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_0_5;
  EventServiceV1_0_5->EventService = EventServiceV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("EventService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "EventService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("EventService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "EventService");
...
)
{
  ...
  return CS_To_EventService_V1_0_5_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in EventServiceToStruct.
...
)
{
  ...
  EventServiceV1_0_5 = (EFI_REDFISH_EVENTSERVICE_V1_0_5 *)InterpProp;
  DestroyEventService_V1_0_5_CS (EventServiceV1_0_5->EventService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EventServiceFromEfiStruct
...
)
{
  ...
  return DestroyEventService_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
