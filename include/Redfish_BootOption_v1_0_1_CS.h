...
#ifndef _RedfishBootoption_V1_0_1_CSTRUCT_H_
#define _RedfishBootoption_V1_0_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishBootOption_V1_0_1_Actions_CS RedfishBootOption_V1_0_1_Actions_CS;
typedef struct _RedfishBootOption_V1_0_1_BootOption_CS RedfishBootOption_V1_0_1_BootOption_CS;
typedef struct _RedfishBootOption_V1_0_1_OemActions_CS RedfishBootOption_V1_0_1_OemActions_CS;
...
//
typedef struct _RedfishBootOption_V1_0_1_Actions_CS {
    RedfishBootOption_V1_0_1_OemActions_CS    *Oem;    // This property contains the
                                                      // available OEM specific actions
                                                      // for this resource.
} RedfishBootOption_V1_0_1_Actions_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishBootOption_V1_0_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishBootOption_V1_0_1_OemActions_CS;
...
//
typedef struct _RedfishBootOption_V1_0_1_BootOption_CS {
    RedfishCS_Header                       Header;
    RedfishCS_char                         *odata_context;        
    RedfishCS_char                         *odata_etag;           
    RedfishCS_char                         *odata_id;             
    RedfishCS_char                         *odata_type;           
    RedfishBootOption_V1_0_1_Actions_CS    *Actions;                  // The available actions for this
                                                                      // resource.
...
} RedfishBootOption_V1_0_1_BootOption_CS;
...
RedfishCS_status
Json_BootOption_V1_0_1_To_CS (char *JsonRawText, RedfishBootOption_V1_0_1_BootOption_CS **ReturnedCS);

RedfishCS_status
CS_To_BootOption_V1_0_1_JSON (RedfishBootOption_V1_0_1_BootOption_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyBootOption_V1_0_1_CS (RedfishBootOption_V1_0_1_BootOption_CS *CSPtr);
