...
//
#include <RedfishInterpreter/PCIeFunction/v1_2_1/EfiPCIeFunctionV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_2_1 
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_2_1 *PCIeFunctionV1_2_1;
  EFI_REDFISH_PCIEFUNCTION_V1_2_1_CS *PCIeFunctionV1_2_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "PCIeFunction") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_PCIeFunction_V1_2_1_To_CS (ResoruceRaw, &PCIeFunctionV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_2_1 = (EFI_REDFISH_PCIEFUNCTION_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_2_1));
  if (PCIeFunctionV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeFunctionV1_2_1;
  PCIeFunctionV1_2_1->PCIeFunction = PCIeFunctionV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_PCIEFUNCTION_V1_2_1_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeFunction"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "PCIeFunction");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeFunction"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "PCIeFunction");
...
)
{
  ...
  return CS_To_PCIeFunction_V1_2_1_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in PCIeFunctionToStruct.
...
)
{
  ...
  PCIeFunctionV1_2_1 = (EFI_REDFISH_PCIEFUNCTION_V1_2_1 *)InterpProp;
  DestroyPCIeFunction_V1_2_1_CS (PCIeFunctionV1_2_1->PCIeFunction); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PCIeFunctionFromEfiStruct
...
)
{
  ...
  return DestroyPCIeFunction_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
