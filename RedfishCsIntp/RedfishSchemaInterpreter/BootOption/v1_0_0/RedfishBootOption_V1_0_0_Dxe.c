...
//
#include <RedfishInterpreter/BootOption/v1_0_0/EfiBootOptionV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#BootOption";
BOOLEAN IsRevisonController = TRUE;

// Support BootOption V1_0_0 
...
{
  EFI_REDFISH_BOOTOPTION_V1_0_0 *BootOptionV1_0_0;
  EFI_REDFISH_BOOTOPTION_V1_0_0_CS *BootOptionV1_0_0Cs;
  ...
  Status = Json_BootOption_V1_0_0_To_CS (ResoruceRaw, &BootOptionV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BootOptionV1_0_0 = (EFI_REDFISH_BOOTOPTION_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BOOTOPTION_V1_0_0));
  if (BootOptionV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)BootOptionV1_0_0;
  BootOptionV1_0_0->BootOption = BootOptionV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_BOOTOPTION_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_BootOption_V1_0_0_JSON (*((EFI_REDFISH_BOOTOPTION_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  BootOptionV1_0_0 = (EFI_REDFISH_BOOTOPTION_V1_0_0 *)InterpProp;
  DestroyBootOption_V1_0_0_CS (BootOptionV1_0_0->BootOption); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyBootOption_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishBootOption_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishBootOption_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
