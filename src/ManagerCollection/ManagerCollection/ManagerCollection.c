...
#include"Redfish_ManagerCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishManagerCollection_ManagerCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ManagerCollection.ManagerCollection
//
RedfishCS_status CS_To_ManagerCollection_JSON(RedfishManagerCollection_ManagerCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ManagerCollection.ManagerCollection
//
RedfishCS_status DestroyManagerCollection_CS(RedfishManagerCollection_ManagerCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ManagerCollection.ManagerCollection
//
RedfishCS_status DestroyManagerCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ManagerCollection.NOVERSIONED.ManagerCollection
//
RedfishCS_status
Json_ManagerCollection_To_CS(RedfishCS_char *JsonRawText, RedfishManagerCollection_ManagerCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManagerCollection_ManagerCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ManagerCollection", "noversioned", "ManagerCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManagerCollection_ManagerCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyManagerCollection_CS (Cs);
  return Status;
}
