...
//
#include <RedfishInterpreter/Manager/v1_1_6/EfiManagerV1_1_6.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_1_6 
...
{
  EFI_REDFISH_MANAGER_V1_1_6 *ManagerV1_1_6;
  EFI_REDFISH_MANAGER_V1_1_6_CS *ManagerV1_1_6Cs;
  ...
  Status = Json_Manager_V1_1_6_To_CS (ResoruceRaw, &ManagerV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_1_6 = (EFI_REDFISH_MANAGER_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_1_6));
  if (ManagerV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_1_6;
  ManagerV1_1_6->Manager = ManagerV1_1_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_1_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_1_6_JSON (*((EFI_REDFISH_MANAGER_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_1_6 = (EFI_REDFISH_MANAGER_V1_1_6 *)InterpProp;
  DestroyManager_V1_1_6_CS (ManagerV1_1_6->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_1_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_1_6EntryPoint (
