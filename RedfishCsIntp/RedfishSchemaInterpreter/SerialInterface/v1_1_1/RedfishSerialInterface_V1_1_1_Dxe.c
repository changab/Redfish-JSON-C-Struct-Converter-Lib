...
//
#include <RedfishInterpreter/SerialInterface/v1_1_1/EfiSerialInterfaceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_1_1 
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_1_1 *SerialInterfaceV1_1_1;
  EFI_REDFISH_SERIALINTERFACE_V1_1_1_CS *SerialInterfaceV1_1_1Cs;
  ...
  Status = Json_SerialInterface_V1_1_1_To_CS (ResoruceRaw, &SerialInterfaceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_1_1 = (EFI_REDFISH_SERIALINTERFACE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_1));
  if (SerialInterfaceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SerialInterfaceV1_1_1;
  SerialInterfaceV1_1_1->SerialInterface = SerialInterfaceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SerialInterface_V1_1_1_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SerialInterfaceV1_1_1 = (EFI_REDFISH_SERIALINTERFACE_V1_1_1 *)InterpProp;
  DestroySerialInterface_V1_1_1_CS (SerialInterfaceV1_1_1->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySerialInterface_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
