...
//
#include <RedfishInterpreter/EthernetInterface/v1_4_1/EfiEthernetInterfaceV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_4_1 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_1 *EthernetInterfaceV1_4_1;
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_1_CS *EthernetInterfaceV1_4_1Cs;
  ...
  Status = Json_EthernetInterface_V1_4_1_To_CS (ResoruceRaw, &EthernetInterfaceV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_4_1 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_4_1));
  if (EthernetInterfaceV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_4_1;
  EthernetInterfaceV1_4_1->EthernetInterface = EthernetInterfaceV1_4_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_4_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EthernetInterface_V1_4_1_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EthernetInterfaceV1_4_1 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_1 *)InterpProp;
  DestroyEthernetInterface_V1_4_1_CS (EthernetInterfaceV1_4_1->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEthernetInterface_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
