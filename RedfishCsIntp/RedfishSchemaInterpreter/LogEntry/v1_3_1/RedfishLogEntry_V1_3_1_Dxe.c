...
//
#include <RedfishInterpreter/LogEntry/v1_3_1/EfiLogEntryV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_3_1 
...
{
  EFI_REDFISH_LOGENTRY_V1_3_1 *LogEntryV1_3_1;
  EFI_REDFISH_LOGENTRY_V1_3_1_CS *LogEntryV1_3_1Cs;
  ...
  Status = Json_LogEntry_V1_3_1_To_CS (ResoruceRaw, &LogEntryV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_3_1 = (EFI_REDFISH_LOGENTRY_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_3_1));
  if (LogEntryV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_3_1;
  LogEntryV1_3_1->LogEntry = LogEntryV1_3_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_3_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_3_1_JSON (*((EFI_REDFISH_LOGENTRY_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_3_1 = (EFI_REDFISH_LOGENTRY_V1_3_1 *)InterpProp;
  DestroyLogEntry_V1_3_1_CS (LogEntryV1_3_1->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_3_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_3_1EntryPoint (
