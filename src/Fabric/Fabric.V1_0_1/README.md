# Definition of Fabric.V1_0_1 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Oem**|RedfishFabric_V1_0_1_Fabric_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## Fabric
    typedef struct _RedfishFabric_V1_0_1_Fabric_CS {
        ...
        RedfishFabric_V1_0_1_Fabric_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_Link Endpoints;
        RedfishCS_char *FabricType;
        RedfishCS_char *Id;
        RedfishFabric_V1_0_1_Fabric_Links_CS *Links;
...
|**Actions**|RedfishFabric_V1_0_1_Fabric_Actions_CS| Structure points to **Actions** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Endpoints**|RedfishCS_Link| Structure link list to **Endpoints** property.| No| Yes
|**FabricType**|RedfishCS_char| String pointer to **FabricType** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Links**|RedfishFabric_V1_0_1_Fabric_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Fabric V1_0_1 to C Structure Function
    RedfishCS_status
    Json_Fabric_V1_0_1_To_CS (RedfishCS_char *JsonRawText, RedfishFabric_V1_0_1_Fabric_CS **ReturnedCS);

## C Structure to Redfish Fabric V1_0_1 JSON Function
    RedfishCS_status
    CS_To_Fabric_V1_0_1_JSON (RedfishFabric_V1_0_1_Fabric_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Fabric V1_0_1 C Structure Function
    RedfishCS_status
