...
//
#include <RedfishInterpreter/PCIeFunction/v1_0_1/EfiPCIeFunctionV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_0_1 
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_0_1 *PCIeFunctionV1_0_1;
  EFI_REDFISH_PCIEFUNCTION_V1_0_1_CS *PCIeFunctionV1_0_1Cs;
  ...
  Status = Json_PCIeFunction_V1_0_1_To_CS (ResoruceRaw, &PCIeFunctionV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_0_1 = (EFI_REDFISH_PCIEFUNCTION_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_0_1));
  if (PCIeFunctionV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeFunctionV1_0_1;
  PCIeFunctionV1_0_1->PCIeFunction = PCIeFunctionV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_PCIEFUNCTION_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeFunction_V1_0_1_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeFunctionV1_0_1 = (EFI_REDFISH_PCIEFUNCTION_V1_0_1 *)InterpProp;
  DestroyPCIeFunction_V1_0_1_CS (PCIeFunctionV1_0_1->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeFunction_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
