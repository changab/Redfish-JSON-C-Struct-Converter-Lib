...
//
#include <RedfishInterpreter/ComputerSystem/v1_0_9/EfiComputerSystemV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_0_9 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_9 *ComputerSystemV1_0_9;
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_9_CS *ComputerSystemV1_0_9Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "9") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ComputerSystem") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_ComputerSystem_V1_0_9_To_CS (ResoruceRaw, &ComputerSystemV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_0_9 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_9));
  if (ComputerSystemV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_0_9;
  ComputerSystemV1_0_9->ComputerSystem = ComputerSystemV1_0_9Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "9";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_9_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_0_9_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_0_9 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_9 *)InterpProp;
  DestroyComputerSystem_V1_0_9_CS (ComputerSystemV1_0_9->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
