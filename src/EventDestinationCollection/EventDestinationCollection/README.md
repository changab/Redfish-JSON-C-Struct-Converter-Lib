# Definition of EventDestinationCollection and functions<br><br>
...
## Redfish EventDestinationCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EventDestinationCollection  JSON Function
    RedfishCS_status
    CS_To_EventDestinationCollection_JSON (RedfishEventDestinationCollection_EventDestinationCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EventDestinationCollection  C Structure Function
    RedfishCS_status
