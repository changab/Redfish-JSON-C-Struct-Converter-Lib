...
//
#include <RedfishInterpreter/Fabric/v1_0_4/EfiFabricV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_0_4 
...
{
  EFI_REDFISH_FABRIC_V1_0_4 *FabricV1_0_4;
  EFI_REDFISH_FABRIC_V1_0_4_CS *FabricV1_0_4Cs;
  ...
  Status = Json_Fabric_V1_0_4_To_CS (ResoruceRaw, &FabricV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_0_4 = (EFI_REDFISH_FABRIC_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_0_4));
  if (FabricV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)FabricV1_0_4;
  FabricV1_0_4->Fabric = FabricV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_FABRIC_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Fabric_V1_0_4_JSON (*((EFI_REDFISH_FABRIC_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  FabricV1_0_4 = (EFI_REDFISH_FABRIC_V1_0_4 *)InterpProp;
  DestroyFabric_V1_0_4_CS (FabricV1_0_4->Fabric); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyFabric_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_0_4EntryPoint (
