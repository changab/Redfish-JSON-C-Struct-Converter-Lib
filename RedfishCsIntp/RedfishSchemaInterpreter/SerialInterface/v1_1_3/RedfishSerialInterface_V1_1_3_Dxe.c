...
//
#include <RedfishInterpreter/SerialInterface/v1_1_3/EfiSerialInterfaceV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_1_3 
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_1_3 *SerialInterfaceV1_1_3;
  EFI_REDFISH_SERIALINTERFACE_V1_1_3_CS *SerialInterfaceV1_1_3Cs;
  ...
  Status = Json_SerialInterface_V1_1_3_To_CS (ResoruceRaw, &SerialInterfaceV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_1_3 = (EFI_REDFISH_SERIALINTERFACE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_3));
  if (SerialInterfaceV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SerialInterfaceV1_1_3;
  SerialInterfaceV1_1_3->SerialInterface = SerialInterfaceV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SerialInterface_V1_1_3_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SerialInterfaceV1_1_3 = (EFI_REDFISH_SERIALINTERFACE_V1_1_3 *)InterpProp;
  DestroySerialInterface_V1_1_3_CS (SerialInterfaceV1_1_3->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySerialInterface_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
