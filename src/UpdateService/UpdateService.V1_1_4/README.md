# Definition of UpdateService.V1_1_4 and functions<br><br>
...
## Actions
    typedef struct _RedfishUpdateService_V1_1_4_Actions_CS {
        ...
        RedfishUpdateService_V1_1_4_OemActions_CS *Oem;
    } RedfishUpdateService_V1_1_4_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**UpdateService_SimpleUpdate**|RedfishUpdateService_V1_1_4_SimpleUpdate_CS| Structure points to **#UpdateService.SimpleUpdate** property.| No| No
|**Oem**|RedfishUpdateService_V1_1_4_OemActions_CS| Structure points to **Oem** property.| No| No
...
## UpdateService
    typedef struct _RedfishUpdateService_V1_1_4_UpdateService_CS {
        ...
        RedfishUpdateService_V1_1_4_Actions_CS *Actions;
...
|**Actions**|RedfishUpdateService_V1_1_4_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish UpdateService V1_1_4 to C Structure Function
    RedfishCS_status
    Json_UpdateService_V1_1_4_To_CS (RedfishCS_char *JsonRawText, RedfishUpdateService_V1_1_4_UpdateService_CS **ReturnedCS);

## C Structure to Redfish UpdateService V1_1_4 JSON Function
    RedfishCS_status
    CS_To_UpdateService_V1_1_4_JSON (RedfishUpdateService_V1_1_4_UpdateService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish UpdateService V1_1_4 C Structure Function
    RedfishCS_status
