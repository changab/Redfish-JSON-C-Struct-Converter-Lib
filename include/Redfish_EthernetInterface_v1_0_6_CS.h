...
#ifndef _RedfishEthernetinterface_V1_0_6_CSTRUCT_H_
#define _RedfishEthernetinterface_V1_0_6_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_Array_CS;
typedef struct _RedfishEthernetInterface_V1_0_6_EthernetInterface_CS RedfishEthernetInterface_V1_0_6_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_CS {
    ...
    RedfishCS_char     *Prefix;       // The IPv6 Address Prefix (as
                                      // defined in RFC 6724 section
                                      // 2.1).
} RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_0_6_EthernetInterface_CS {
    ...
    RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_Array_CS    *IPv6AddressPolicyTable;    // An array representing the RFC
...
} RedfishEthernetInterface_V1_0_6_EthernetInterface_CS;

typedef struct _RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_0_6_IPv6AddressPolicyEntry_Array_CS;

RedfishCS_status
Json_EthernetInterface_V1_0_6_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_0_6_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_0_6_JSON (RedfishEthernetInterface_V1_0_6_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_0_6_CS (RedfishEthernetInterface_V1_0_6_EthernetInterface_CS *CSPtr);
