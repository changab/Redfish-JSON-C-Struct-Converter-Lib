...
#include"Redfish_Event_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenActions_OemCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishEvent_V1_2_0_Event_Actions_Oem_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEvent_V1_2_0_Event_Actions_Oem_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishEvent_V1_2_0_Event_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEvent_V1_2_0_Event_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenEventRecordOemActionsCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishEvent_V1_2_0_EventRecordOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEvent_V1_2_0_EventRecordOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenEventRecordActionsCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishEvent_V1_2_0_EventRecordActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEvent_V1_2_0_EventRecordActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
  Status = GenEventRecordOemActionsCs (Cs, TempJsonObj, "Oem", &(*Dst)->Oem);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, char *Key, Redfishodata_V4_0_0_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(Redfishodata_V4_0_0_idRef_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
static RedfishCS_status GenEventRecord_Array_ElementCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEvent_V1_2_0_EventRecord_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEvent_V1_2_0_EventRecord_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Actions
  Status = GenEventRecordActionsCs (Cs, TempJsonObj, "Actions", &(*Dst)->Actions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Context
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "Context", &(*Dst)->Context);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EventId
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "EventId", &(*Dst)->EventId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EventTimestamp
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "EventTimestamp", &(*Dst)->EventTimestamp);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EventType
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "EventType", &(*Dst)->EventType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishEvent_V1_2_0_EventRecord_Array_CS
//
static RedfishCS_status GenEventRecord_ArrayCs(RedfishEvent_V1_2_0_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishEvent_V1_2_0_EventRecord_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEvent_V1_2_0_EventRecord_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEvent_V1_2_0_EventRecord_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenEventRecord_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEvent_V1_2_0_Event_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEvent_V1_2_0_Event_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_EventsActionsOem(json_t *CsJson, char *Key, RedfishEvent_V1_2_0_EventRecordOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_EventsActions(json_t *CsJson, char *Key, RedfishEvent_V1_2_0_EventRecordActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Oem
  if (CS_To_JSON_EventsActionsOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_EventsOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_EventsOriginOfCondition(json_t *CsJson, char *Key, Redfishodata_V4_0_0_idRef_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Events(json_t *CsJson, char *Key, RedfishEvent_V1_2_0_EventRecord_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEvent_V1_2_0_EventRecord_Array_CS *NextArray;
  RedfishEvent_V1_2_0_EventRecord_CS *NextArrayItem;
  ...
  do {
    ...
    // Actions
    if (CS_To_JSON_EventsActions(ArrayMember, "Actions", NextArrayItem->Actions) != RedfishCS_status_success) {goto Error;}

    // Context 
    if (InsertJsonStringObj (ArrayMember, "Context", NextArrayItem->Context) != RedfishCS_status_success) {goto Error;}

    // EventId 
    if (InsertJsonStringObj (ArrayMember, "EventId", NextArrayItem->EventId) != RedfishCS_status_success) {goto Error;}

    // EventTimestamp 
    if (InsertJsonStringObj (ArrayMember, "EventTimestamp", NextArrayItem->EventTimestamp) != RedfishCS_status_success) {goto Error;}

    // EventType 
    if (InsertJsonStringObj (ArrayMember, "EventType", NextArrayItem->EventType) != RedfishCS_status_success) {goto Error;}
    ...
    // Oem
    if (CS_To_JSON_EventsOem(ArrayMember, "Oem", NextArrayItem->Oem) != RedfishCS_status_success) {goto Error;}

    // OriginOfCondition
    if (CS_To_JSON_EventsOriginOfCondition(ArrayMember, "OriginOfCondition", NextArrayItem->OriginOfCondition) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Event.V1_2_0.Event
//
RedfishCS_status CS_To_Event_V1_2_0_JSON(RedfishEvent_V1_2_0_Event_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Events
  if (CS_To_JSON_Events(CsJson, "Events", CSPtr->Events) != RedfishCS_status_success) {goto Error;}

  // Events@odata.count 
  if (InsertJsonInt64Obj (CsJson, "Events@odata.count", CSPtr->Eventsodata_count) != RedfishCS_status_success) {goto Error;}

  // Events@odata.navigationLink 
  if (InsertJsonStringObj (CsJson, "Events@odata.navigationLink", CSPtr->Eventsodata_navigationLink) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Event.V1_2_0.Event
//
RedfishCS_status DestroyEvent_V1_2_0_CS(RedfishEvent_V1_2_0_Event_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Event.V1_2_0.Event
//
RedfishCS_status DestroyEvent_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Event.V1_2_0.Event
//
RedfishCS_status
Json_Event_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishEvent_V1_2_0_Event_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEvent_V1_2_0_Event_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Event", "v1_2_0", "Event", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEvent_V1_2_0_Event_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Events
  Status = GenEventRecord_ArrayCs (Cs, JsonObj, "Events", &Cs->Events);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){goto Error;}}

  // Events@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "Events@odata.count", &Cs->Eventsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Events@odata.navigationLink
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Events@odata.navigationLink", &Cs->Eventsodata_navigationLink);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
