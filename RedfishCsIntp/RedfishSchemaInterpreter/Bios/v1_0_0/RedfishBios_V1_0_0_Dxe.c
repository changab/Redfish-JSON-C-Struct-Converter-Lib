...
//
#include <RedfishInterpreter/Bios/v1_0_0/EfiBiosV1_0_0.h>
...
{
  EFI_REDFISH_BIOS_V1_0_0 *BiosV1_0_0;
  EFI_REDFISH_BIOS_V1_0_0_CS *BiosV1_0_0Cs;
  ...
  Status = Json_Bios_V1_0_0_To_CS (ResoruceRaw, &BiosV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_0_0 = (EFI_REDFISH_BIOS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_0_0));
  if (BiosV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)BiosV1_0_0;
  BiosV1_0_0->Bios = BiosV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_BIOS_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Bios_V1_0_0_JSON (*((EFI_REDFISH_BIOS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  BiosV1_0_0 = (EFI_REDFISH_BIOS_V1_0_0 *)InterpProp;
  DestroyBios_V1_0_0_CS (BiosV1_0_0->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyBios_V1_0_0_Json (ResoruceRaw);
}
