# Definition of Drive.V1_0_1 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Drive_SecureErase**|RedfishDrive_V1_0_1_SecureErase_CS| Structure points to **#Drive.SecureErase** property.| No| No
|**Oem**|RedfishDrive_V1_0_1_Drive_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## Drive
    typedef struct _RedfishDrive_V1_0_1_Drive_CS {
        ...
        RedfishDrive_V1_0_1_Drive_Actions_CS *Actions;
        ...
        RedfishDrive_V1_0_1_Drive_Links_CS *Links;
...
|**Actions**|RedfishDrive_V1_0_1_Drive_Actions_CS| Structure points to **Actions** property.| No| Yes
...
|**Links**|RedfishDrive_V1_0_1_Drive_Links_CS| Structure points to **Links** property.| No| Yes
...
## Redfish Drive V1_0_1 to C Structure Function
    RedfishCS_status
    Json_Drive_V1_0_1_To_CS (RedfishCS_char *JsonRawText, RedfishDrive_V1_0_1_Drive_CS **ReturnedCS);

## C Structure to Redfish Drive V1_0_1 JSON Function
    RedfishCS_status
    CS_To_Drive_V1_0_1_JSON (RedfishDrive_V1_0_1_Drive_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Drive V1_0_1 C Structure Function
    RedfishCS_status
