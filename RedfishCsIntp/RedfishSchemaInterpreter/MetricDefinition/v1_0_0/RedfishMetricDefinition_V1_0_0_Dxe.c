...
//
#include <RedfishInterpreter/MetricDefinition/v1_0_0/EfiMetricDefinitionV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#MetricDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricDefinition V1_0_0 
...
{
  EFI_REDFISH_METRICDEFINITION_V1_0_0 *MetricDefinitionV1_0_0;
  EFI_REDFISH_METRICDEFINITION_V1_0_0_CS *MetricDefinitionV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "MetricDefinition") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_MetricDefinition_V1_0_0_To_CS (ResoruceRaw, &MetricDefinitionV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricDefinitionV1_0_0 = (EFI_REDFISH_METRICDEFINITION_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICDEFINITION_V1_0_0));
  if (MetricDefinitionV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MetricDefinitionV1_0_0;
  MetricDefinitionV1_0_0->MetricDefinition = MetricDefinitionV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_METRICDEFINITION_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricDefinition"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "MetricDefinition");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricDefinition"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "MetricDefinition");
...
)
{
  ...
  return CS_To_MetricDefinition_V1_0_0_JSON (*((EFI_REDFISH_METRICDEFINITION_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in MetricDefinitionToStruct.
...
EFI_STATUS
EFIAPI
MetricDefinitionDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  MetricDefinitionV1_0_0 = (EFI_REDFISH_METRICDEFINITION_V1_0_0 *)InterpProp;
  DestroyMetricDefinition_V1_0_0_CS (MetricDefinitionV1_0_0->MetricDefinition); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MetricDefinitionFromEfiStruct
...
)
{
  ...
  return DestroyMetricDefinition_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
