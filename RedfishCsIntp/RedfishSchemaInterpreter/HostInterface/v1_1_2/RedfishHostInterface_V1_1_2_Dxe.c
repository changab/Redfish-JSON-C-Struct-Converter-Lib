...
//
#include <RedfishInterpreter/HostInterface/v1_1_2/EfiHostInterfaceV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_1_2 
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_1_2 *HostInterfaceV1_1_2;
  EFI_REDFISH_HOSTINTERFACE_V1_1_2_CS *HostInterfaceV1_1_2Cs;
  ...
  Status = Json_HostInterface_V1_1_2_To_CS (ResoruceRaw, &HostInterfaceV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_1_2 = (EFI_REDFISH_HOSTINTERFACE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_1_2));
  if (HostInterfaceV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)HostInterfaceV1_1_2;
  HostInterfaceV1_1_2->HostInterface = HostInterfaceV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_HOSTINTERFACE_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_HostInterface_V1_1_2_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  HostInterfaceV1_1_2 = (EFI_REDFISH_HOSTINTERFACE_V1_1_2 *)InterpProp;
  DestroyHostInterface_V1_1_2_CS (HostInterfaceV1_1_2->HostInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyHostInterface_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
