...
//
#include <RedfishInterpreter/ComputerSystem/v1_5_1/EfiComputerSystemV1_5_1.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_5_1 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_5_1 *ComputerSystemV1_5_1;
  EFI_REDFISH_COMPUTERSYSTEM_V1_5_1_CS *ComputerSystemV1_5_1Cs;
  ...
  Status = Json_ComputerSystem_V1_5_1_To_CS (ResoruceRaw, &ComputerSystemV1_5_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_5_1 = (EFI_REDFISH_COMPUTERSYSTEM_V1_5_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_5_1));
  if (ComputerSystemV1_5_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_5_1;
  ComputerSystemV1_5_1->ComputerSystem = ComputerSystemV1_5_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "5";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_5_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_5_1_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_5_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_5_1 = (EFI_REDFISH_COMPUTERSYSTEM_V1_5_1 *)InterpProp;
  DestroyComputerSystem_V1_5_1_CS (ComputerSystemV1_5_1->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_5_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_5_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_5_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
