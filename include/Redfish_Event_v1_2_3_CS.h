...
#ifndef _RedfishEvent_V1_2_3_CSTRUCT_H_
#define _RedfishEvent_V1_2_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEvent_V1_2_3_EventRecord_Array_CS RedfishEvent_V1_2_3_EventRecord_Array_CS;
typedef struct _RedfishEvent_V1_2_3_Actions_CS RedfishEvent_V1_2_3_Actions_CS;
typedef struct _RedfishEvent_V1_2_3_Event_CS RedfishEvent_V1_2_3_Event_CS;
typedef struct _RedfishEvent_V1_2_3_EventRecord_CS RedfishEvent_V1_2_3_EventRecord_CS;
typedef struct _RedfishEvent_V1_2_3_EventRecordActions_CS RedfishEvent_V1_2_3_EventRecordActions_CS;
typedef struct _RedfishEvent_V1_2_3_EventRecordOemActions_CS RedfishEvent_V1_2_3_EventRecordOemActions_CS;
typedef struct _RedfishEvent_V1_2_3_OemActions_CS RedfishEvent_V1_2_3_OemActions_CS;
...
typedef struct _RedfishEvent_V1_2_3_Actions_CS {
    RedfishEvent_V1_2_3_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishEvent_V1_2_3_EventRecord_CS {
    ...
    RedfishEvent_V1_2_3_EventRecordActions_CS    *Actions;             // The available actions for this
                                                                       // resource.
...
typedef struct _RedfishEvent_V1_2_3_EventRecordActions_CS {
    RedfishEvent_V1_2_3_EventRecordOemActions_CS    *Oem;    // This property contains the
                                                            // available OEM specific actions
                                                            // for this resource.
...
typedef struct _RedfishEvent_V1_2_3_Event_CS {
    ...
    RedfishEvent_V1_2_3_Actions_CS              *Actions;             // The available actions for this
                                                                      // resource.
    RedfishCS_char                              *Context;             // A context can be supplied at
                                                                      // subscription time.  This
                                                                      // property is the context value
    ...
    RedfishEvent_V1_2_3_EventRecord_Array_CS    *Events;              // Each event in this array has a
...
typedef struct _RedfishEvent_V1_2_3_EventRecord_Array_CS  {
    RedfishEvent_V1_2_3_EventRecord_Array_CS    *Next;
    RedfishEvent_V1_2_3_EventRecord_CS    *ArrayValue;
} RedfishEvent_V1_2_3_EventRecord_Array_CS;

RedfishCS_status
Json_Event_V1_2_3_To_CS (char *JsonRawText, RedfishEvent_V1_2_3_Event_CS **ReturnedCS);

RedfishCS_status
CS_To_Event_V1_2_3_JSON (RedfishEvent_V1_2_3_Event_CS *CSPtr, char **JsonText);
