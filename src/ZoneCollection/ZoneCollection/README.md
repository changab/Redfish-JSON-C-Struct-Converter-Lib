# Definition of ZoneCollection and functions<br><br>
...
## Redfish ZoneCollection  to C Structure Function
    RedfishCS_status
    Json_ZoneCollection_To_CS (RedfishCS_char *JsonRawText, RedfishZoneCollection_ZoneCollection_CS **ReturnedCS);

## C Structure to Redfish ZoneCollection  JSON Function
    RedfishCS_status
    CS_To_ZoneCollection_JSON (RedfishZoneCollection_ZoneCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ZoneCollection  C Structure Function
    RedfishCS_status
