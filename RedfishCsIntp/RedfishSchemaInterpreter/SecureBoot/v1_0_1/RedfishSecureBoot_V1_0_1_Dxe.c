...
//
#include <RedfishInterpreter/SecureBoot/v1_0_1/EfiSecureBootV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#SecureBoot";
BOOLEAN IsRevisonController = TRUE;

// Support SecureBoot V1_0_1 
...
{
  EFI_REDFISH_SECUREBOOT_V1_0_1 *SecureBootV1_0_1;
  EFI_REDFISH_SECUREBOOT_V1_0_1_CS *SecureBootV1_0_1Cs;
  ...
  Status = Json_SecureBoot_V1_0_1_To_CS (ResoruceRaw, &SecureBootV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootV1_0_1 = (EFI_REDFISH_SECUREBOOT_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOT_V1_0_1));
  if (SecureBootV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SecureBootV1_0_1;
  SecureBootV1_0_1->SecureBoot = SecureBootV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SECUREBOOT_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SecureBoot_V1_0_1_JSON (*((EFI_REDFISH_SECUREBOOT_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SecureBootV1_0_1 = (EFI_REDFISH_SECUREBOOT_V1_0_1 *)InterpProp;
  DestroySecureBoot_V1_0_1_CS (SecureBootV1_0_1->SecureBoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySecureBoot_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
