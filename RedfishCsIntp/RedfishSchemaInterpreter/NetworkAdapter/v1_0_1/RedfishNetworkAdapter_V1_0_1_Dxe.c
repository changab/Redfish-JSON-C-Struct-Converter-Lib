...
//
#include <RedfishInterpreter/NetworkAdapter/v1_0_1/EfiNetworkAdapterV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_0_1 
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_0_1 *NetworkAdapterV1_0_1;
  EFI_REDFISH_NETWORKADAPTER_V1_0_1_CS *NetworkAdapterV1_0_1Cs;
  ...
  Status = Json_NetworkAdapter_V1_0_1_To_CS (ResoruceRaw, &NetworkAdapterV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_0_1 = (EFI_REDFISH_NETWORKADAPTER_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_0_1));
  if (NetworkAdapterV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkAdapterV1_0_1;
  NetworkAdapterV1_0_1->NetworkAdapter = NetworkAdapterV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_NETWORKADAPTER_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkAdapter_V1_0_1_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkAdapterV1_0_1 = (EFI_REDFISH_NETWORKADAPTER_V1_0_1 *)InterpProp;
  DestroyNetworkAdapter_V1_0_1_CS (NetworkAdapterV1_0_1->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkAdapter_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
