...
//
#include <RedfishInterpreter/MessageRegistry/v1_0_2/EfiMessageRegistryV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_0_2 
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_2 *MessageRegistryV1_0_2;
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_2_CS *MessageRegistryV1_0_2Cs;
  ...
  Status = Json_MessageRegistry_V1_0_2_To_CS (ResoruceRaw, &MessageRegistryV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_0_2 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_2));
  if (MessageRegistryV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryV1_0_2;
  MessageRegistryV1_0_2->MessageRegistry = MessageRegistryV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistry_V1_0_2_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryV1_0_2 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_2 *)InterpProp;
  DestroyMessageRegistry_V1_0_2_CS (MessageRegistryV1_0_2->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistry_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
