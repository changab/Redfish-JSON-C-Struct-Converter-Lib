...
#include"Redfish_ManagerNetworkProtocol_v1_1_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenProtocolCs(RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS **Dst);
static RedfishCS_status GenOemCs(RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
static RedfishCS_status GenProtocolCs(RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenSSDProtocolCs(RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_1_2_SSDProtocol_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_1_2_SSDProtocol_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // NotifyIPv6Scope
...
//
static RedfishCS_status GenStatusCs(RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_DHCP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_HTTP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HTTPS(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_IPMI(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_KVMIP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SNMP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SSDP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_SSDProtocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SSH(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Telnet(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_VirtualMedia(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_1_2_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for ManagerNetworkProtocol.V1_1_2.ManagerNetworkProtocol
//
RedfishCS_status CS_To_ManagerNetworkProtocol_V1_1_2_JSON(RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ManagerNetworkProtocol.V1_1_2.ManagerNetworkProtocol
//
RedfishCS_status DestroyManagerNetworkProtocol_V1_1_2_CS(RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ManagerNetworkProtocol.V1_1_2.ManagerNetworkProtocol
//
RedfishCS_status DestroyManagerNetworkProtocol_V1_1_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ManagerNetworkProtocol.V1_1_2.ManagerNetworkProtocol
//
RedfishCS_status
Json_ManagerNetworkProtocol_V1_1_2_To_CS(RedfishCS_char *JsonRawText, RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ManagerNetworkProtocol", "v1_1_2", "ManagerNetworkProtocol", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManagerNetworkProtocol_V1_1_2_ManagerNetworkProtocol_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyManagerNetworkProtocol_V1_1_2_CS (Cs);
  return Status;
}
