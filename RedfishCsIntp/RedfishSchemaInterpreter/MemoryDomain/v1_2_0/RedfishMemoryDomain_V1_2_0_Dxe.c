...
//
#include <RedfishInterpreter/MemoryDomain/v1_2_0/EfiMemoryDomainV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_2_0 
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_2_0 *MemoryDomainV1_2_0;
  EFI_REDFISH_MEMORYDOMAIN_V1_2_0_CS *MemoryDomainV1_2_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "MemoryDomain") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_MemoryDomain_V1_2_0_To_CS (ResoruceRaw, &MemoryDomainV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_2_0 = (EFI_REDFISH_MEMORYDOMAIN_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_2_0));
  if (MemoryDomainV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryDomainV1_2_0;
  MemoryDomainV1_2_0->MemoryDomain = MemoryDomainV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_2_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MemoryDomain"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "MemoryDomain");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MemoryDomain"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "MemoryDomain");
...
)
{
  ...
  return CS_To_MemoryDomain_V1_2_0_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in MemoryDomainToStruct.
...
)
{
  ...
  MemoryDomainV1_2_0 = (EFI_REDFISH_MEMORYDOMAIN_V1_2_0 *)InterpProp;
  DestroyMemoryDomain_V1_2_0_CS (MemoryDomainV1_2_0->MemoryDomain); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MemoryDomainFromEfiStruct
...
)
{
  ...
  return DestroyMemoryDomain_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
