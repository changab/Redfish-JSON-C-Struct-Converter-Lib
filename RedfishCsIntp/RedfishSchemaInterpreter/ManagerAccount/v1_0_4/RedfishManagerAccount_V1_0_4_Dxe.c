...
//
#include <RedfishInterpreter/ManagerAccount/v1_0_4/EfiManagerAccountV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_4 
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_4 *ManagerAccountV1_0_4;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_4_CS *ManagerAccountV1_0_4Cs;
  ...
  Status = Json_ManagerAccount_V1_0_4_To_CS (ResoruceRaw, &ManagerAccountV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_4 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_4));
  if (ManagerAccountV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerAccountV1_0_4;
  ManagerAccountV1_0_4->ManagerAccount = ManagerAccountV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerAccount_V1_0_4_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerAccountV1_0_4 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_4 *)InterpProp;
  DestroyManagerAccount_V1_0_4_CS (ManagerAccountV1_0_4->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerAccount_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
