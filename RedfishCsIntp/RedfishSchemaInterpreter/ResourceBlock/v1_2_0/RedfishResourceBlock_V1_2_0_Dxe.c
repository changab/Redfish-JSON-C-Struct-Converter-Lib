...
//
#include <RedfishInterpreter/ResourceBlock/v1_2_0/EfiResourceBlockV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_2_0 
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_2_0 *ResourceBlockV1_2_0;
  EFI_REDFISH_RESOURCEBLOCK_V1_2_0_CS *ResourceBlockV1_2_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ResourceBlock") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_ResourceBlock_V1_2_0_To_CS (ResoruceRaw, &ResourceBlockV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_2_0 = (EFI_REDFISH_RESOURCEBLOCK_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_2_0));
  if (ResourceBlockV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ResourceBlockV1_2_0;
  ResourceBlockV1_2_0->ResourceBlock = ResourceBlockV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_2_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ResourceBlock"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "ResourceBlock");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ResourceBlock"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "ResourceBlock");
...
)
{
  ...
  return CS_To_ResourceBlock_V1_2_0_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ResourceBlockToStruct.
...
)
{
  ...
  ResourceBlockV1_2_0 = (EFI_REDFISH_RESOURCEBLOCK_V1_2_0 *)InterpProp;
  DestroyResourceBlock_V1_2_0_CS (ResourceBlockV1_2_0->ResourceBlock); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ResourceBlockFromEfiStruct
...
)
{
  ...
  return DestroyResourceBlock_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
