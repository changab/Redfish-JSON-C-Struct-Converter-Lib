...
#ifndef _RedfishSwitch_V1_0_2_CSTRUCT_H_
#define _RedfishSwitch_V1_0_2_CSTRUCT_H_
...
typedef struct _RedfishSwitch_V1_0_2_Reset_CS RedfishSwitch_V1_0_2_Reset_CS;
typedef struct _RedfishSwitch_V1_0_2_Switch_CS RedfishSwitch_V1_0_2_Switch_CS;
typedef struct _RedfishSwitch_V1_0_2_Switch_Actions_CS RedfishSwitch_V1_0_2_Switch_Actions_CS;
typedef struct _RedfishSwitch_V1_0_2_Switch_Actions_Oem_CS RedfishSwitch_V1_0_2_Switch_Actions_Oem_CS;
typedef struct _RedfishSwitch_V1_0_2_Switch_Links_CS RedfishSwitch_V1_0_2_Switch_Links_CS;
//
...
typedef struct _RedfishSwitch_V1_0_2_Switch_Actions_CS {
    ...
    RedfishSwitch_V1_0_2_Switch_Actions_Oem_CS    *Oem;            // The available OEM specific
...
typedef struct _RedfishSwitch_V1_0_2_Switch_CS {
    ...
    RedfishSwitch_V1_0_2_Switch_Actions_CS    *Actions;                          // The available actions for this
                                                                                 // resource.
    ...
    RedfishCS_bool                            *IsManaged;                        // This indicates whether the
                                                                                 ...
                                                                                 // unmanaged state.
    RedfishSwitch_V1_0_2_Switch_Links_CS      *Links;                            // Contains references to other
...
RedfishCS_status
Json_Switch_V1_0_2_To_CS (char *JsonRawText, RedfishSwitch_V1_0_2_Switch_CS **ReturnedCS);

RedfishCS_status
CS_To_Switch_V1_0_2_JSON (RedfishSwitch_V1_0_2_Switch_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySwitch_V1_0_2_CS (RedfishSwitch_V1_0_2_Switch_CS *CSPtr);

RedfishCS_status
DestroySwitch_V1_0_2_Json (RedfishCS_char *JsonText);
