...
//
#include <RedfishInterpreter/UpdateService/v1_3_1/EfiUpdateServiceV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_3_1 
...
{
  EFI_REDFISH_UPDATESERVICE_V1_3_1 *UpdateServiceV1_3_1;
  EFI_REDFISH_UPDATESERVICE_V1_3_1_CS *UpdateServiceV1_3_1Cs;
  ...
  Status = Json_UpdateService_V1_3_1_To_CS (ResoruceRaw, &UpdateServiceV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_3_1 = (EFI_REDFISH_UPDATESERVICE_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_3_1));
  if (UpdateServiceV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)UpdateServiceV1_3_1;
  UpdateServiceV1_3_1->UpdateService = UpdateServiceV1_3_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_UPDATESERVICE_V1_3_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_UpdateService_V1_3_1_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  UpdateServiceV1_3_1 = (EFI_REDFISH_UPDATESERVICE_V1_3_1 *)InterpProp;
  DestroyUpdateService_V1_3_1_CS (UpdateServiceV1_3_1->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyUpdateService_V1_3_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_3_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_3_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
