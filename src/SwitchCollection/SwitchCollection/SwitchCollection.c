...
#include"Redfish_SwitchCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishSwitchCollection_SwitchCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for SwitchCollection.SwitchCollection
//
RedfishCS_status CS_To_SwitchCollection_JSON(RedfishSwitchCollection_SwitchCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SwitchCollection.SwitchCollection
//
RedfishCS_status DestroySwitchCollection_CS(RedfishSwitchCollection_SwitchCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SwitchCollection.SwitchCollection
//
RedfishCS_status DestroySwitchCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SwitchCollection.NOVERSIONED.SwitchCollection
//
RedfishCS_status
Json_SwitchCollection_To_CS(RedfishCS_char *JsonRawText, RedfishSwitchCollection_SwitchCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSwitchCollection_SwitchCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SwitchCollection", "noversioned", "SwitchCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSwitchCollection_SwitchCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
