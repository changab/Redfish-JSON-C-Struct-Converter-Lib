...
//
#include <RedfishInterpreter/Assembly/v1_1_1/EfiAssemblyV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#Assembly";
BOOLEAN IsRevisonController = TRUE;

// Support Assembly V1_1_1 
...
{
  EFI_REDFISH_ASSEMBLY_V1_1_1 *AssemblyV1_1_1;
  EFI_REDFISH_ASSEMBLY_V1_1_1_CS *AssemblyV1_1_1Cs;
  ...
  Status = Json_Assembly_V1_1_1_To_CS (ResoruceRaw, &AssemblyV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AssemblyV1_1_1 = (EFI_REDFISH_ASSEMBLY_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ASSEMBLY_V1_1_1));
  if (AssemblyV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AssemblyV1_1_1;
  AssemblyV1_1_1->Assembly = AssemblyV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ASSEMBLY_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Assembly_V1_1_1_JSON (*((EFI_REDFISH_ASSEMBLY_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AssemblyV1_1_1 = (EFI_REDFISH_ASSEMBLY_V1_1_1 *)InterpProp;
  DestroyAssembly_V1_1_1_CS (AssemblyV1_1_1->Assembly); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAssembly_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAssembly_V1_1_1EntryPoint (
