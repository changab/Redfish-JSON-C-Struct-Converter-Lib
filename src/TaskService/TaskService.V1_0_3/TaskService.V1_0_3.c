...
#include"Redfish_TaskService_v1_0_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishTaskService_V1_0_3_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenStatusCs(RedfishTaskService_V1_0_3_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
// C structure to JSON for TaskService.V1_0_3.TaskService
//
RedfishCS_status CS_To_TaskService_V1_0_3_JSON(RedfishTaskService_V1_0_3_TaskService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for TaskService.V1_0_3.TaskService
//
RedfishCS_status DestroyTaskService_V1_0_3_CS(RedfishTaskService_V1_0_3_TaskService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for TaskService.V1_0_3.TaskService
//
RedfishCS_status DestroyTaskService_V1_0_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for TaskService.V1_0_3.TaskService
//
RedfishCS_status
Json_TaskService_V1_0_3_To_CS(RedfishCS_char *JsonRawText, RedfishTaskService_V1_0_3_TaskService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTaskService_V1_0_3_TaskService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "TaskService", "v1_0_3", "TaskService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTaskService_V1_0_3_TaskService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyTaskService_V1_0_3_CS (Cs);
  return Status;
}
