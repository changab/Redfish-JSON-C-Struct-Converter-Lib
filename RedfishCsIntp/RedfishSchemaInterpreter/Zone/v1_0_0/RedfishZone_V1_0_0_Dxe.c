...
//
#include <RedfishInterpreter/Zone/v1_0_0/EfiZoneV1_0_0.h>
...
{
  EFI_REDFISH_ZONE_V1_0_0 *ZoneV1_0_0;
  EFI_REDFISH_ZONE_V1_0_0_CS *ZoneV1_0_0Cs;
  ...
  Status = Json_Zone_V1_0_0_To_CS (ResoruceRaw, &ZoneV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_0_0 = (EFI_REDFISH_ZONE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_0_0));
  if (ZoneV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ZoneV1_0_0;
  ZoneV1_0_0->Zone = ZoneV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ZONE_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Zone_V1_0_0_JSON (*((EFI_REDFISH_ZONE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ZoneV1_0_0 = (EFI_REDFISH_ZONE_V1_0_0 *)InterpProp;
  DestroyZone_V1_0_0_CS (ZoneV1_0_0->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyZone_V1_0_0_Json (ResoruceRaw);
}
