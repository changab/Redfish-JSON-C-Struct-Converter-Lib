...
//
#include <RedfishInterpreter/Zone/v1_0_1/EfiZoneV1_0_1.h>
...
{
  EFI_REDFISH_ZONE_V1_0_1 *ZoneV1_0_1;
  EFI_REDFISH_ZONE_V1_0_1_CS *ZoneV1_0_1Cs;
  ...
  Status = Json_Zone_V1_0_1_To_CS (ResoruceRaw, &ZoneV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_0_1 = (EFI_REDFISH_ZONE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_0_1));
  if (ZoneV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ZoneV1_0_1;
  ZoneV1_0_1->Zone = ZoneV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ZONE_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Zone_V1_0_1_JSON (*((EFI_REDFISH_ZONE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ZoneV1_0_1 = (EFI_REDFISH_ZONE_V1_0_1 *)InterpProp;
  DestroyZone_V1_0_1_CS (ZoneV1_0_1->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyZone_V1_0_1_Json (ResoruceRaw);
}
