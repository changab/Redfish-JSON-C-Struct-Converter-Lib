...
//
#include <RedfishInterpreter/LogEntry/v1_1_4/EfiLogEntryV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_1_4 
...
{
  EFI_REDFISH_LOGENTRY_V1_1_4 *LogEntryV1_1_4;
  EFI_REDFISH_LOGENTRY_V1_1_4_CS *LogEntryV1_1_4Cs;
  ...
  Status = Json_LogEntry_V1_1_4_To_CS (ResoruceRaw, &LogEntryV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_1_4 = (EFI_REDFISH_LOGENTRY_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_1_4));
  if (LogEntryV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_1_4;
  LogEntryV1_1_4->LogEntry = LogEntryV1_1_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_1_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_1_4_JSON (*((EFI_REDFISH_LOGENTRY_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_1_4 = (EFI_REDFISH_LOGENTRY_V1_1_4 *)InterpProp;
  DestroyLogEntry_V1_1_4_CS (LogEntryV1_1_4->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_1_4EntryPoint (
