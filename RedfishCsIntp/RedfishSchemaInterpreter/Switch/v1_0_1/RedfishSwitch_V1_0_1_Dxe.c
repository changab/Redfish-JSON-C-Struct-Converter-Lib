...
//
#include <RedfishInterpreter/Switch/v1_0_1/EfiSwitchV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_0_1 
...
{
  EFI_REDFISH_SWITCH_V1_0_1 *SwitchV1_0_1;
  EFI_REDFISH_SWITCH_V1_0_1_CS *SwitchV1_0_1Cs;
  ...
  Status = Json_Switch_V1_0_1_To_CS (ResoruceRaw, &SwitchV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_0_1 = (EFI_REDFISH_SWITCH_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_0_1));
  if (SwitchV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SwitchV1_0_1;
  SwitchV1_0_1->Switch = SwitchV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SWITCH_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Switch_V1_0_1_JSON (*((EFI_REDFISH_SWITCH_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SwitchV1_0_1 = (EFI_REDFISH_SWITCH_V1_0_1 *)InterpProp;
  DestroySwitch_V1_0_1_CS (SwitchV1_0_1->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySwitch_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_0_1EntryPoint (
