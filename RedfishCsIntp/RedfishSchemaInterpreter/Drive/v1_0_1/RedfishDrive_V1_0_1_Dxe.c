...
//
#include <RedfishInterpreter/Drive/v1_0_1/EfiDriveV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_1 
...
{
  EFI_REDFISH_DRIVE_V1_0_1 *DriveV1_0_1;
  EFI_REDFISH_DRIVE_V1_0_1_CS *DriveV1_0_1Cs;
  ...
  Status = Json_Drive_V1_0_1_To_CS (ResoruceRaw, &DriveV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_1 = (EFI_REDFISH_DRIVE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_1));
  if (DriveV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_0_1;
  DriveV1_0_1->Drive = DriveV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_0_1_JSON (*((EFI_REDFISH_DRIVE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_0_1 = (EFI_REDFISH_DRIVE_V1_0_1 *)InterpProp;
  DestroyDrive_V1_0_1_CS (DriveV1_0_1->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_0_1_Json (ResoruceRaw);
}
