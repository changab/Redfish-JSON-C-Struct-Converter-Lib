...
//
#include <RedfishInterpreter/Drive/v1_0_3/EfiDriveV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_3 
...
{
  EFI_REDFISH_DRIVE_V1_0_3 *DriveV1_0_3;
  EFI_REDFISH_DRIVE_V1_0_3_CS *DriveV1_0_3Cs;
  ...
  Status = Json_Drive_V1_0_3_To_CS (ResoruceRaw, &DriveV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_3 = (EFI_REDFISH_DRIVE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_3));
  if (DriveV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_0_3;
  DriveV1_0_3->Drive = DriveV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_0_3_JSON (*((EFI_REDFISH_DRIVE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_0_3 = (EFI_REDFISH_DRIVE_V1_0_3 *)InterpProp;
  DestroyDrive_V1_0_3_CS (DriveV1_0_3->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_0_3_Json (ResoruceRaw);
}
