...
//
#include <RedfishInterpreter/Manager/v1_0_7/EfiManagerV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_0_7 
...
{
  EFI_REDFISH_MANAGER_V1_0_7 *ManagerV1_0_7;
  EFI_REDFISH_MANAGER_V1_0_7_CS *ManagerV1_0_7Cs;
  ...
  Status = Json_Manager_V1_0_7_To_CS (ResoruceRaw, &ManagerV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_0_7 = (EFI_REDFISH_MANAGER_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_0_7));
  if (ManagerV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_0_7;
  ManagerV1_0_7->Manager = ManagerV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_0_7_JSON (*((EFI_REDFISH_MANAGER_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_0_7 = (EFI_REDFISH_MANAGER_V1_0_7 *)InterpProp;
  DestroyManager_V1_0_7_CS (ManagerV1_0_7->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_0_7EntryPoint (
