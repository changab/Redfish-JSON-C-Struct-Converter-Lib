...
//
#include <RedfishInterpreter/Task/v1_1_0/EfiTaskV1_1_0.h>
...
{
  EFI_REDFISH_TASK_V1_1_0 *TaskV1_1_0;
  EFI_REDFISH_TASK_V1_1_0_CS *TaskV1_1_0Cs;
  ...
  Status = Json_Task_V1_1_0_To_CS (ResoruceRaw, &TaskV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_1_0 = (EFI_REDFISH_TASK_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_1_0));
  if (TaskV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskV1_1_0;
  TaskV1_1_0->Task = TaskV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_TASK_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Task_V1_1_0_JSON (*((EFI_REDFISH_TASK_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskV1_1_0 = (EFI_REDFISH_TASK_V1_1_0 *)InterpProp;
  DestroyTask_V1_1_0_CS (TaskV1_1_0->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTask_V1_1_0_Json (ResoruceRaw);
}
