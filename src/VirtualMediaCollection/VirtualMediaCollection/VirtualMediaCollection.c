...
#include"Redfish_VirtualMediaCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishVirtualMediaCollection_VirtualMediaCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for VirtualMediaCollection.VirtualMediaCollection
//
RedfishCS_status CS_To_VirtualMediaCollection_JSON(RedfishVirtualMediaCollection_VirtualMediaCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for VirtualMediaCollection.VirtualMediaCollection
//
RedfishCS_status DestroyVirtualMediaCollection_CS(RedfishVirtualMediaCollection_VirtualMediaCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VirtualMediaCollection.VirtualMediaCollection
//
RedfishCS_status DestroyVirtualMediaCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VirtualMediaCollection.NOVERSIONED.VirtualMediaCollection
//
RedfishCS_status
Json_VirtualMediaCollection_To_CS(RedfishCS_char *JsonRawText, RedfishVirtualMediaCollection_VirtualMediaCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVirtualMediaCollection_VirtualMediaCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VirtualMediaCollection", "noversioned", "VirtualMediaCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVirtualMediaCollection_VirtualMediaCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyVirtualMediaCollection_CS (Cs);
  return Status;
}
