...
//
#include <RedfishInterpreter/Storage/v1_0_5/EfiStorageV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_0_5 
...
{
  EFI_REDFISH_STORAGE_V1_0_5 *StorageV1_0_5;
  EFI_REDFISH_STORAGE_V1_0_5_CS *StorageV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Storage") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Storage_V1_0_5_To_CS (ResoruceRaw, &StorageV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_0_5 = (EFI_REDFISH_STORAGE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_0_5));
  if (StorageV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_0_5;
  StorageV1_0_5->Storage = StorageV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Storage"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Storage");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Storage"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Storage");
...
)
{
  ...
  return CS_To_Storage_V1_0_5_JSON (*((EFI_REDFISH_STORAGE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in StorageToStruct.
...
)
{
  ...
  StorageV1_0_5 = (EFI_REDFISH_STORAGE_V1_0_5 *)InterpProp;
  DestroyStorage_V1_0_5_CS (StorageV1_0_5->Storage); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from StorageFromEfiStruct
...
)
{
  ...
  return DestroyStorage_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_0_5EntryPoint (
