...
//
#include <RedfishInterpreter/EventDestination/v1_0_4/EfiEventDestinationV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_0_4 
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_0_4 *EventDestinationV1_0_4;
  EFI_REDFISH_EVENTDESTINATION_V1_0_4_CS *EventDestinationV1_0_4Cs;
  ...
  Status = Json_EventDestination_V1_0_4_To_CS (ResoruceRaw, &EventDestinationV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_0_4 = (EFI_REDFISH_EVENTDESTINATION_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_0_4));
  if (EventDestinationV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventDestinationV1_0_4;
  EventDestinationV1_0_4->EventDestination = EventDestinationV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_EVENTDESTINATION_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventDestination_V1_0_4_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventDestinationV1_0_4 = (EFI_REDFISH_EVENTDESTINATION_V1_0_4 *)InterpProp;
  DestroyEventDestination_V1_0_4_CS (EventDestinationV1_0_4->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventDestination_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
