...
//
#include <RedfishInterpreter/PCIeFunction/v1_1_0/EfiPCIeFunctionV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_1_0 
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_1_0 *PCIeFunctionV1_1_0;
  EFI_REDFISH_PCIEFUNCTION_V1_1_0_CS *PCIeFunctionV1_1_0Cs;
  ...
  Status = Json_PCIeFunction_V1_1_0_To_CS (ResoruceRaw, &PCIeFunctionV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_1_0 = (EFI_REDFISH_PCIEFUNCTION_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_1_0));
  if (PCIeFunctionV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeFunctionV1_1_0;
  PCIeFunctionV1_1_0->PCIeFunction = PCIeFunctionV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_PCIEFUNCTION_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeFunction_V1_1_0_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeFunctionV1_1_0 = (EFI_REDFISH_PCIEFUNCTION_V1_1_0 *)InterpProp;
  DestroyPCIeFunction_V1_1_0_CS (PCIeFunctionV1_1_0->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeFunction_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
