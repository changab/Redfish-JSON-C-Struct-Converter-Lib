...
#include"Redfish_AccountService_v1_0_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAccountService_V1_0_3_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenStatusCs(RedfishAccountService_V1_0_3_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
// C structure to JSON for AccountService.V1_0_3.AccountService
//
RedfishCS_status CS_To_AccountService_V1_0_3_JSON(RedfishAccountService_V1_0_3_AccountService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AccountService.V1_0_3.AccountService
//
RedfishCS_status DestroyAccountService_V1_0_3_CS(RedfishAccountService_V1_0_3_AccountService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AccountService.V1_0_3.AccountService
//
RedfishCS_status DestroyAccountService_V1_0_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AccountService.V1_0_3.AccountService
//
RedfishCS_status
Json_AccountService_V1_0_3_To_CS(RedfishCS_char *JsonRawText, RedfishAccountService_V1_0_3_AccountService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAccountService_V1_0_3_AccountService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AccountService", "v1_0_3", "AccountService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAccountService_V1_0_3_AccountService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAccountService_V1_0_3_CS (Cs);
  return Status;
}
