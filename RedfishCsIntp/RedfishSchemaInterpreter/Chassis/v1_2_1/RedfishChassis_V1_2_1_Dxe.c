...
//
#include <RedfishInterpreter/Chassis/v1_2_1/EfiChassisV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_2_1 
...
{
  EFI_REDFISH_CHASSIS_V1_2_1 *ChassisV1_2_1;
  EFI_REDFISH_CHASSIS_V1_2_1_CS *ChassisV1_2_1Cs;
  ...
  Status = Json_Chassis_V1_2_1_To_CS (ResoruceRaw, &ChassisV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_2_1 = (EFI_REDFISH_CHASSIS_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_2_1));
  if (ChassisV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_2_1;
  ChassisV1_2_1->Chassis = ChassisV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_2_1_JSON (*((EFI_REDFISH_CHASSIS_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_2_1 = (EFI_REDFISH_CHASSIS_V1_2_1 *)InterpProp;
  DestroyChassis_V1_2_1_CS (ChassisV1_2_1->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_2_1EntryPoint (
