...
//
#include <RedfishInterpreter/EthernetInterface/v1_0_5/EfiEthernetInterfaceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_5 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_5 *EthernetInterfaceV1_0_5;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_5_CS *EthernetInterfaceV1_0_5Cs;
  ...
  Status = Json_EthernetInterface_V1_0_5_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_5 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_5));
  if (EthernetInterfaceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_0_5;
  ...
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EthernetInterface_V1_0_5_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EthernetInterfaceV1_0_5 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_5 *)InterpProp;
  DestroyEthernetInterface_V1_0_5_CS (EthernetInterfaceV1_0_5->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEthernetInterface_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
