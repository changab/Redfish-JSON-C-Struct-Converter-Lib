...
//
#include <RedfishInterpreter/Manager/v1_2_5/EfiManagerV1_2_5.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_2_5 
...
{
  EFI_REDFISH_MANAGER_V1_2_5 *ManagerV1_2_5;
  EFI_REDFISH_MANAGER_V1_2_5_CS *ManagerV1_2_5Cs;
  ...
  Status = Json_Manager_V1_2_5_To_CS (ResoruceRaw, &ManagerV1_2_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_2_5 = (EFI_REDFISH_MANAGER_V1_2_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_2_5));
  if (ManagerV1_2_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_2_5;
  ManagerV1_2_5->Manager = ManagerV1_2_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_2_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_2_5_JSON (*((EFI_REDFISH_MANAGER_V1_2_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_2_5 = (EFI_REDFISH_MANAGER_V1_2_5 *)InterpProp;
  DestroyManager_V1_2_5_CS (ManagerV1_2_5->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_2_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_2_5EntryPoint (
