...
//
#include <RedfishInterpreter/ManagerNetworkProtocol/v1_0_5/EfiManagerNetworkProtocolV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_0_5 
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_5 *ManagerNetworkProtocolV1_0_5;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_5_CS *ManagerNetworkProtocolV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "5") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ManagerNetworkProtocol") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_ManagerNetworkProtocol_V1_0_5_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_0_5 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_5));
  if (ManagerNetworkProtocolV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerNetworkProtocolV1_0_5;
  ManagerNetworkProtocolV1_0_5->ManagerNetworkProtocol = ManagerNetworkProtocolV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerNetworkProtocol_V1_0_5_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerNetworkProtocolV1_0_5 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_5 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_0_5_CS (ManagerNetworkProtocolV1_0_5->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerNetworkProtocol_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
