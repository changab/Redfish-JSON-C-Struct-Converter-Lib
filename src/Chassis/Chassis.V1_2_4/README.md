# Definition of Chassis.V1_2_4 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Chassis_Reset**|RedfishChassis_V1_2_4_Reset_CS| Structure points to **#Chassis.Reset** property.| No| No
|**Oem**|RedfishChassis_V1_2_4_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Chassis
    typedef struct _RedfishChassis_V1_2_4_Chassis_CS {
        ...
        RedfishChassis_V1_2_4_Actions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_char *ChassisType;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishCS_char *IndicatorLED;
        RedfishChassis_V1_2_4_Links_CS *Links;
        ...
        RedfishChassis_V1_2_4_PhysicalSecurity_CS *PhysicalSecurity;
...
|**Actions**|RedfishChassis_V1_2_4_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishChassis_V1_2_4_Links_CS| Structure points to **Links** property.| No| No
...
|**PhysicalSecurity**|RedfishChassis_V1_2_4_PhysicalSecurity_CS| Structure points to **PhysicalSecurity** property.| No| No
...
## Redfish Chassis V1_2_4 to C Structure Function
    RedfishCS_status
    Json_Chassis_V1_2_4_To_CS (RedfishCS_char *JsonRawText, RedfishChassis_V1_2_4_Chassis_CS **ReturnedCS);

## C Structure to Redfish Chassis V1_2_4 JSON Function
    RedfishCS_status
    CS_To_Chassis_V1_2_4_JSON (RedfishChassis_V1_2_4_Chassis_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Chassis V1_2_4 C Structure Function
    RedfishCS_status
