...
//
#include <RedfishInterpreter/Power/v1_0_6/EfiPowerV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_0_6 
...
{
  EFI_REDFISH_POWER_V1_0_6 *PowerV1_0_6;
  EFI_REDFISH_POWER_V1_0_6_CS *PowerV1_0_6Cs;
  ...
  Status = Json_Power_V1_0_6_To_CS (ResoruceRaw, &PowerV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_0_6 = (EFI_REDFISH_POWER_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_0_6));
  if (PowerV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_0_6;
  PowerV1_0_6->Power = PowerV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_POWER_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_0_6_JSON (*((EFI_REDFISH_POWER_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_0_6 = (EFI_REDFISH_POWER_V1_0_6 *)InterpProp;
  DestroyPower_V1_0_6_CS (PowerV1_0_6->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_0_6_Json (ResoruceRaw);
}
