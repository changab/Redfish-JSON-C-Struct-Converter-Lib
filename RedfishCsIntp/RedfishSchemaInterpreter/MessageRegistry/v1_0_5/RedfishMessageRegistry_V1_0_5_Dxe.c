...
//
#include <RedfishInterpreter/MessageRegistry/v1_0_5/EfiMessageRegistryV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_0_5 
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_5 *MessageRegistryV1_0_5;
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_5_CS *MessageRegistryV1_0_5Cs;
  ...
  Status = Json_MessageRegistry_V1_0_5_To_CS (ResoruceRaw, &MessageRegistryV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_0_5 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_5));
  if (MessageRegistryV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryV1_0_5;
  MessageRegistryV1_0_5->MessageRegistry = MessageRegistryV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistry_V1_0_5_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryV1_0_5 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_5 *)InterpProp;
  DestroyMessageRegistry_V1_0_5_CS (MessageRegistryV1_0_5->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistry_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
