...
//
#include <RedfishInterpreter/SessionService/v1_0_0/EfiSessionServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_0_0 
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_0_0 *SessionServiceV1_0_0;
  ...
  Status = Json_SessionService_V1_0_0_To_CS (ResoruceRaw, &SessionServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_0_0 = (EFI_REDFISH_SESSIONSERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_0_0));
  if (SessionServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionServiceV1_0_0;
  SessionServiceV1_0_0->SessionService = SessionServiceV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SESSIONSERVICE_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SessionService_V1_0_0_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionServiceV1_0_0 = (EFI_REDFISH_SESSIONSERVICE_V1_0_0 *)InterpProp;
  DestroySessionService_V1_0_0_CS (SessionServiceV1_0_0->SessionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySessionService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
