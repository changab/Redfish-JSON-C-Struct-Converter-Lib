...
//
#include <RedfishInterpreter/Memory/v1_0_3/EfiMemoryV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_0_3 
...
{
  EFI_REDFISH_MEMORY_V1_0_3 *MemoryV1_0_3;
  EFI_REDFISH_MEMORY_V1_0_3_CS *MemoryV1_0_3Cs;
  ...
  Status = Json_Memory_V1_0_3_To_CS (ResoruceRaw, &MemoryV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_0_3 = (EFI_REDFISH_MEMORY_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_0_3));
  if (MemoryV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryV1_0_3;
  MemoryV1_0_3->Memory = MemoryV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MEMORY_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Memory_V1_0_3_JSON (*((EFI_REDFISH_MEMORY_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryV1_0_3 = (EFI_REDFISH_MEMORY_V1_0_3 *)InterpProp;
  DestroyMemory_V1_0_3_CS (MemoryV1_0_3->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemory_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_0_3EntryPoint (
