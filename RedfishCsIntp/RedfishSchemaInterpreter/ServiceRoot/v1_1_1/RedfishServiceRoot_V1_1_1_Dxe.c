...
//
#include <RedfishInterpreter/ServiceRoot/v1_1_1/EfiServiceRootV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_1_1 
...
{
  EFI_REDFISH_SERVICEROOT_V1_1_1 *ServiceRootV1_1_1;
  EFI_REDFISH_SERVICEROOT_V1_1_1_CS *ServiceRootV1_1_1Cs;
  ...
  Status = Json_ServiceRoot_V1_1_1_To_CS (ResoruceRaw, &ServiceRootV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_1_1 = (EFI_REDFISH_SERVICEROOT_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_1_1));
  if (ServiceRootV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_1_1;
  ServiceRootV1_1_1->ServiceRoot = ServiceRootV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ServiceRoot_V1_1_1_JSON (*((EFI_REDFISH_SERVICEROOT_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ServiceRootV1_1_1 = (EFI_REDFISH_SERVICEROOT_V1_1_1 *)InterpProp;
  DestroyServiceRoot_V1_1_1_CS (ServiceRootV1_1_1->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyServiceRoot_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
