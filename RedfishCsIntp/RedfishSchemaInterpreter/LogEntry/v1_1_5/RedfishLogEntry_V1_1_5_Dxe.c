...
//
#include <RedfishInterpreter/LogEntry/v1_1_5/EfiLogEntryV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_1_5 
...
{
  EFI_REDFISH_LOGENTRY_V1_1_5 *LogEntryV1_1_5;
  EFI_REDFISH_LOGENTRY_V1_1_5_CS *LogEntryV1_1_5Cs;
  ...
  Status = Json_LogEntry_V1_1_5_To_CS (ResoruceRaw, &LogEntryV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_1_5 = (EFI_REDFISH_LOGENTRY_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_1_5));
  if (LogEntryV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_1_5;
  LogEntryV1_1_5->LogEntry = LogEntryV1_1_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_1_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("LogEntry"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "LogEntry");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("LogEntry"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "LogEntry");
...
)
{
  ...
  return CS_To_LogEntry_V1_1_5_JSON (*((EFI_REDFISH_LOGENTRY_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_1_5 = (EFI_REDFISH_LOGENTRY_V1_1_5 *)InterpProp;
  DestroyLogEntry_V1_1_5_CS (LogEntryV1_1_5->LogEntry); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from LogEntryFromEfiStruct
...
)
{
  ...
  return DestroyLogEntry_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_1_5EntryPoint (
