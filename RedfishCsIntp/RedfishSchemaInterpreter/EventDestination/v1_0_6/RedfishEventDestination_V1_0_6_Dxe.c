...
//
#include <RedfishInterpreter/EventDestination/v1_0_6/EfiEventDestinationV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_0_6 
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_0_6 *EventDestinationV1_0_6;
  EFI_REDFISH_EVENTDESTINATION_V1_0_6_CS *EventDestinationV1_0_6Cs;
  ...
  Status = Json_EventDestination_V1_0_6_To_CS (ResoruceRaw, &EventDestinationV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_0_6 = (EFI_REDFISH_EVENTDESTINATION_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_0_6));
  if (EventDestinationV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventDestinationV1_0_6;
  EventDestinationV1_0_6->EventDestination = EventDestinationV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_EVENTDESTINATION_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventDestination_V1_0_6_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventDestinationV1_0_6 = (EFI_REDFISH_EVENTDESTINATION_V1_0_6 *)InterpProp;
  DestroyEventDestination_V1_0_6_CS (EventDestinationV1_0_6->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventDestination_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
