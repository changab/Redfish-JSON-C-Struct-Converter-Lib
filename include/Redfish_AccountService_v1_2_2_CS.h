...
#ifndef _RedfishAccountservice_V1_2_2_CSTRUCT_H_
#define _RedfishAccountservice_V1_2_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAccountService_V1_2_2_AccountService_CS RedfishAccountService_V1_2_2_AccountService_CS;
typedef struct _RedfishAccountService_V1_2_2_Actions_CS RedfishAccountService_V1_2_2_Actions_CS;
typedef struct _RedfishAccountService_V1_2_2_OemActions_CS RedfishAccountService_V1_2_2_OemActions_CS;
...
//
typedef struct _RedfishAccountService_V1_2_2_Actions_CS {
    RedfishAccountService_V1_2_2_OemActions_CS    *Oem;
} RedfishAccountService_V1_2_2_Actions_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishAccountService_V1_2_2_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishAccountService_V1_2_2_OemActions_CS;
...
//
typedef struct _RedfishAccountService_V1_2_2_AccountService_CS {
    ...
    RedfishCS_Link                             Accounts;                           // A link to a collection of
                                                                                   // Manager Accounts.
    RedfishAccountService_V1_2_2_Actions_CS    *Actions;                           // The available actions for this
                                                                                   // resource.
...
} RedfishAccountService_V1_2_2_AccountService_CS;

RedfishCS_status
Json_AccountService_V1_2_2_To_CS (char *JsonRawText, RedfishAccountService_V1_2_2_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_2_2_JSON (RedfishAccountService_V1_2_2_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_2_2_CS (RedfishAccountService_V1_2_2_AccountService_CS *CSPtr);

RedfishCS_status
DestroyAccountService_V1_2_2_Json (RedfishCS_char *JsonText);
