...
//
#include <RedfishInterpreter/SecureBoot/v1_0_3/EfiSecureBootV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#SecureBoot";
BOOLEAN IsRevisonController = TRUE;

// Support SecureBoot V1_0_3 
...
{
  EFI_REDFISH_SECUREBOOT_V1_0_3 *SecureBootV1_0_3;
  EFI_REDFISH_SECUREBOOT_V1_0_3_CS *SecureBootV1_0_3Cs;
  ...
  Status = Json_SecureBoot_V1_0_3_To_CS (ResoruceRaw, &SecureBootV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootV1_0_3 = (EFI_REDFISH_SECUREBOOT_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOT_V1_0_3));
  if (SecureBootV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SecureBootV1_0_3;
  SecureBootV1_0_3->SecureBoot = SecureBootV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SECUREBOOT_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SecureBoot_V1_0_3_JSON (*((EFI_REDFISH_SECUREBOOT_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SecureBootV1_0_3 = (EFI_REDFISH_SECUREBOOT_V1_0_3 *)InterpProp;
  DestroySecureBoot_V1_0_3_CS (SecureBootV1_0_3->SecureBoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySecureBoot_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
