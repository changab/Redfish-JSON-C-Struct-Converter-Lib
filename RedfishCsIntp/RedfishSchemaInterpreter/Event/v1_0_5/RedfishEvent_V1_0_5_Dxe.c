...
//
#include <RedfishInterpreter/Event/v1_0_5/EfiEventV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_5 
...
{
  EFI_REDFISH_EVENT_V1_0_5 *EventV1_0_5;
  EFI_REDFISH_EVENT_V1_0_5_CS *EventV1_0_5Cs;
  ...
  Status = Json_Event_V1_0_5_To_CS (ResoruceRaw, &EventV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_5 = (EFI_REDFISH_EVENT_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_5));
  if (EventV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_0_5;
  EventV1_0_5->Event = EventV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_EVENT_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_0_5_JSON (*((EFI_REDFISH_EVENT_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_0_5 = (EFI_REDFISH_EVENT_V1_0_5 *)InterpProp;
  DestroyEvent_V1_0_5_CS (EventV1_0_5->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_0_5_Json (ResoruceRaw);
}
