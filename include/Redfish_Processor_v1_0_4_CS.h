...
#ifndef _RedfishProcessor_V1_0_4_CSTRUCT_H_
#define _RedfishProcessor_V1_0_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessor_V1_0_4_Processor_CS RedfishProcessor_V1_0_4_Processor_CS;
typedef struct _RedfishProcessor_V1_0_4_ProcessorId_CS RedfishProcessor_V1_0_4_ProcessorId_CS;
...
typedef struct _RedfishProcessor_V1_0_4_Processor_CS {
    ...
    RedfishCS_char                            *ProcessorArchitecture;    // The architecture of the
                                                                        // processor.
    RedfishProcessor_V1_0_4_ProcessorId_CS    *ProcessorId;             // Identification information for
                                                                        // this processor.
...
RedfishCS_status
Json_Processor_V1_0_4_To_CS (char *JsonRawText, RedfishProcessor_V1_0_4_Processor_CS **ReturnedCS);

RedfishCS_status
CS_To_Processor_V1_0_4_JSON (RedfishProcessor_V1_0_4_Processor_CS *CSPtr, char **JsonText);
