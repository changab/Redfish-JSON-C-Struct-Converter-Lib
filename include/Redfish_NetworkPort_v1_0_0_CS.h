...
#define _RedfishNetworkport_V1_0_0_CSTRUCT_H_
...
typedef struct _RedfishNetworkPort_V1_0_0_SupportedLinkCapabilities_CS RedfishNetworkPort_V1_0_0_SupportedLinkCapabilities_CS;
...
typedef struct _RedfishNetworkPort_V1_0_0_NetworkPort_CS {
    ...
    RedfishCS_char                                                  *LinkStatus;                      // The status of the link between
                                                                                                      ...
                                                                                                      // partner.
    RedfishCS_char                                                  *Name;                        
    RedfishNetworkPort_V1_0_0_NetDevFuncMaxBWAlloc_Array_CS         *NetDevFuncMaxBWAlloc;            // The array of maximum bandwidth
                                                                                                      // allocation percentages for the
                                                                                                      // Network Device Functions
                                                                                                      // associated with this port.
    RedfishNetworkPort_V1_0_0_NetDevFuncMinBWAlloc_Array_CS         *NetDevFuncMinBWAlloc;            // The array of minimum bandwidth
                                                                                                      // allocation percentages for the
                                                                                                      // Network Device Functions
                                                                                                      // associated with this port.
    ...
    RedfishCS_char_Array                                            *SupportedEthernetCapabilities;    // The set of Ethernet
                                                                                                      ...
                                                                                                      // supports.
    RedfishNetworkPort_V1_0_0_SupportedLinkCapabilities_Array_CS    *SupportedLinkCapabilities;       // The self-described link
                                                                                                      // capabilities of this port.
...
} RedfishNetworkPort_V1_0_0_NetDevFuncMaxBWAlloc_Array_CS;

typedef struct _RedfishNetworkPort_V1_0_0_NetDevFuncMinBWAlloc_Array_CS  {
...
RedfishCS_status
CS_To_NetworkPort_V1_0_0_JSON (RedfishNetworkPort_V1_0_0_NetworkPort_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkPort_V1_0_0_CS (RedfishNetworkPort_V1_0_0_NetworkPort_CS *CSPtr);

RedfishCS_status
DestroyNetworkPort_V1_0_0_Json (RedfishCS_char *JsonText);
