...
#ifndef _RedfishStorage_V1_2_0_CSTRUCT_H_
#define _RedfishStorage_V1_2_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishStorage_V1_2_0_StorageController_Array_CS RedfishStorage_V1_2_0_StorageController_Array_CS;
...
typedef struct _RedfishStorage_V1_2_0_SetEncryptionKey_CS RedfishStorage_V1_2_0_SetEncryptionKey_CS;
typedef struct _RedfishStorage_V1_2_0_Storage_CS RedfishStorage_V1_2_0_Storage_CS;
typedef struct _RedfishStorage_V1_2_0_StorageController_CS RedfishStorage_V1_2_0_StorageController_CS;
typedef struct _RedfishStorage_V1_2_0_StorageControllerActions_CS RedfishStorage_V1_2_0_StorageControllerActions_CS;
typedef struct _RedfishStorage_V1_2_0_StorageControllerOemActions_CS RedfishStorage_V1_2_0_StorageControllerOemActions_CS;
typedef struct _RedfishStorage_V1_2_0_StorageController_Links_CS RedfishStorage_V1_2_0_StorageController_Links_CS;
typedef struct _RedfishStorage_V1_2_0_Storage_Actions_CS RedfishStorage_V1_2_0_Storage_Actions_CS;
typedef struct _RedfishStorage_V1_2_0_Storage_Actions_Oem_CS RedfishStorage_V1_2_0_Storage_Actions_Oem_CS;
typedef struct _RedfishStorage_V1_2_0_Storage_Links_CS RedfishStorage_V1_2_0_Storage_Links_CS;
//
...
typedef struct _RedfishStorage_V1_2_0_StorageController_CS {
    RedfishStorage_V1_2_0_StorageControllerActions_CS    *Actions;                        // The available actions for this
                                                                                          // resource.
    ...
    RedfishResource_V1_1_0_Identifier_Array_CS           *Identifiers;                    // The Durable names for the
                                                                                          // storage controller.
    RedfishStorage_V1_2_0_StorageController_Links_CS     *Links;                          // Contains references to other
...
typedef struct _RedfishStorage_V1_2_0_Storage_Actions_CS {
    ...
    RedfishStorage_V1_2_0_Storage_Actions_Oem_CS    *Oem;                        // The available OEM specific
...
typedef struct _RedfishStorage_V1_2_0_Storage_CS {
    ...
    RedfishStorage_V1_2_0_Storage_Actions_CS            *Actions;                                  // The available actions for this
                                                                                                   // resource.
    ...
    RedfishCS_char                                      *Id;                                   
    RedfishStorage_V1_2_0_Storage_Links_CS              *Links;                                    // Contains references to other
                                                                                                   // resources that are related to
                                                                                                   // this resource.
    RedfishCS_char                                      *Name;                                 
    RedfishResource_Oem_CS                              *Oem;                                      // This is the
    ...
    RedfishResource_Status_CS                           *Status;                               
    RedfishStorage_V1_2_0_StorageController_Array_CS    *StorageControllers;                       // The set of storage controllers
                                                                                                   // represented by this resource.
...
typedef struct _RedfishStorage_V1_2_0_StorageController_Array_CS  {
    RedfishStorage_V1_2_0_StorageController_Array_CS    *Next;
    RedfishStorage_V1_2_0_StorageController_CS    *ArrayValue;
} RedfishStorage_V1_2_0_StorageController_Array_CS;

RedfishCS_status
Json_Storage_V1_2_0_To_CS (char *JsonRawText, RedfishStorage_V1_2_0_Storage_CS **ReturnedCS);

RedfishCS_status
CS_To_Storage_V1_2_0_JSON (RedfishStorage_V1_2_0_Storage_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyStorage_V1_2_0_CS (RedfishStorage_V1_2_0_Storage_CS *CSPtr);

RedfishCS_status
DestroyStorage_V1_2_0_Json (RedfishCS_char *JsonText);
