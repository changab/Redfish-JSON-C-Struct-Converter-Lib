...
#ifndef _RedfishProcessor_V1_0_3_CSTRUCT_H_
#define _RedfishProcessor_V1_0_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessor_V1_0_3_Processor_CS RedfishProcessor_V1_0_3_Processor_CS;
typedef struct _RedfishProcessor_V1_0_3_ProcessorId_CS RedfishProcessor_V1_0_3_ProcessorId_CS;
...
typedef struct _RedfishProcessor_V1_0_3_ProcessorId_CS {
    ...
    RedfishCS_char    *VendorId;                  // The Vendor Identification for
                                                  // this processor.
} RedfishProcessor_V1_0_3_ProcessorId_CS;
...
//
typedef struct _RedfishProcessor_V1_0_3_Processor_CS {
    ...
    RedfishCS_char                            *ProcessorArchitecture;    // The architecture of the
                                                                        // processor.
    RedfishProcessor_V1_0_3_ProcessorId_CS    *ProcessorId;             // Identification information for
                                                                        // this processor.
    ...
    RedfishCS_int64                           *TotalThreads;            // The total number of execution
                                                                        ...
                                                                        // processor.
} RedfishProcessor_V1_0_3_Processor_CS;

RedfishCS_status
Json_Processor_V1_0_3_To_CS (char *JsonRawText, RedfishProcessor_V1_0_3_Processor_CS **ReturnedCS);

RedfishCS_status
CS_To_Processor_V1_0_3_JSON (RedfishProcessor_V1_0_3_Processor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyProcessor_V1_0_3_CS (RedfishProcessor_V1_0_3_Processor_CS *CSPtr);

RedfishCS_status
DestroyProcessor_V1_0_3_Json (RedfishCS_char *JsonText);
