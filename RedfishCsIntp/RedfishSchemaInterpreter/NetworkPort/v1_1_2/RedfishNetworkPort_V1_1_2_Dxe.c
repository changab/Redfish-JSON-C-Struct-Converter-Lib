...
//
#include <RedfishInterpreter/NetworkPort/v1_1_2/EfiNetworkPortV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_1_2 
...
{
  EFI_REDFISH_NETWORKPORT_V1_1_2 *NetworkPortV1_1_2;
  EFI_REDFISH_NETWORKPORT_V1_1_2_CS *NetworkPortV1_1_2Cs;
  ...
  Status = Json_NetworkPort_V1_1_2_To_CS (ResoruceRaw, &NetworkPortV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_1_2 = (EFI_REDFISH_NETWORKPORT_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_1_2));
  if (NetworkPortV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkPortV1_1_2;
  NetworkPortV1_1_2->NetworkPort = NetworkPortV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_NETWORKPORT_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkPort_V1_1_2_JSON (*((EFI_REDFISH_NETWORKPORT_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkPortV1_1_2 = (EFI_REDFISH_NETWORKPORT_V1_1_2 *)InterpProp;
  DestroyNetworkPort_V1_1_2_CS (NetworkPortV1_1_2->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkPort_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
