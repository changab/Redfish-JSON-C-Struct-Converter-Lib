...
#ifndef _RedfishStorage_V1_1_3_CSTRUCT_H_
#define _RedfishStorage_V1_1_3_CSTRUCT_H_
...
typedef struct _RedfishStorage_V1_1_3_Actions_CS RedfishStorage_V1_1_3_Actions_CS;
typedef struct _RedfishStorage_V1_1_3_Links_CS RedfishStorage_V1_1_3_Links_CS;
typedef struct _RedfishStorage_V1_1_3_OemActions_CS RedfishStorage_V1_1_3_OemActions_CS;
typedef struct _RedfishStorage_V1_1_3_SetEncryptionKey_CS RedfishStorage_V1_1_3_SetEncryptionKey_CS;
typedef struct _RedfishStorage_V1_1_3_Storage_CS RedfishStorage_V1_1_3_Storage_CS;
typedef struct _RedfishStorage_V1_1_3_StorageController_CS RedfishStorage_V1_1_3_StorageController_CS;
typedef struct _RedfishStorage_V1_1_3_StorageControllerLinks_CS RedfishStorage_V1_1_3_StorageControllerLinks_CS;
//
...
typedef struct _RedfishStorage_V1_1_3_StorageController_CS {
    ...
    RedfishCS_Link                                     Identifiers;                     // The Durable names for the
                                                                                        // storage controller.
    RedfishStorage_V1_1_3_StorageControllerLinks_CS    *Links;                          // Contains references to other
...
typedef struct _RedfishStorage_V1_1_3_Storage_CS {
    ...
    RedfishStorage_V1_1_3_Actions_CS    *Actions;                         // The available actions for this
                                                                          // resource.
    ...
    RedfishCS_char                      *Id;                          
    RedfishStorage_V1_1_3_Links_CS      *Links;                           // Contains references to other
                                                                          // resources that are related to
                                                                          // this resource.
    RedfishCS_char                      *Name;                        
    RedfishResource_Oem_CS              *Oem;                             // This is the
    ...
    RedfishCS_Link                      Volumes;                          // The set of volumes produced by
                                                                          // the storage controllers
                                                                          // represented by this resource.
} RedfishStorage_V1_1_3_Storage_CS;

RedfishCS_status
Json_Storage_V1_1_3_To_CS (char *JsonRawText, RedfishStorage_V1_1_3_Storage_CS **ReturnedCS);

RedfishCS_status
CS_To_Storage_V1_1_3_JSON (RedfishStorage_V1_1_3_Storage_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyStorage_V1_1_3_CS (RedfishStorage_V1_1_3_Storage_CS *CSPtr);

RedfishCS_status
DestroyStorage_V1_1_3_Json (RedfishCS_char *JsonText);
