...
//
#include <RedfishInterpreter/Volume/v1_0_2/EfiVolumeV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Volume";
BOOLEAN IsRevisonController = TRUE;

// Support Volume V1_0_2 
...
{
  EFI_REDFISH_VOLUME_V1_0_2 *VolumeV1_0_2;
  EFI_REDFISH_VOLUME_V1_0_2_CS *VolumeV1_0_2Cs;
  ...
  Status = Json_Volume_V1_0_2_To_CS (ResoruceRaw, &VolumeV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VolumeV1_0_2 = (EFI_REDFISH_VOLUME_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VOLUME_V1_0_2));
  if (VolumeV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VolumeV1_0_2;
  VolumeV1_0_2->Volume = VolumeV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_VOLUME_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Volume_V1_0_2_JSON (*((EFI_REDFISH_VOLUME_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VolumeV1_0_2 = (EFI_REDFISH_VOLUME_V1_0_2 *)InterpProp;
  DestroyVolume_V1_0_2_CS (VolumeV1_0_2->Volume); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVolume_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVolume_V1_0_2EntryPoint (
