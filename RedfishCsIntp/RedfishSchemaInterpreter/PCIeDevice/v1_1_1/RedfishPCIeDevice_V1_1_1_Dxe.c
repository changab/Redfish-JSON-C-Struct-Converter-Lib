...
//
#include <RedfishInterpreter/PCIeDevice/v1_1_1/EfiPCIeDeviceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_1_1 
...
{
  EFI_REDFISH_PCIEDEVICE_V1_1_1 *PCIeDeviceV1_1_1;
  EFI_REDFISH_PCIEDEVICE_V1_1_1_CS *PCIeDeviceV1_1_1Cs;
  ...
  Status = Json_PCIeDevice_V1_1_1_To_CS (ResoruceRaw, &PCIeDeviceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_1_1 = (EFI_REDFISH_PCIEDEVICE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_1_1));
  if (PCIeDeviceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeDeviceV1_1_1;
  PCIeDeviceV1_1_1->PCIeDevice = PCIeDeviceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_PCIEDEVICE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeDevice_V1_1_1_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeDeviceV1_1_1 = (EFI_REDFISH_PCIEDEVICE_V1_1_1 *)InterpProp;
  DestroyPCIeDevice_V1_1_1_CS (PCIeDeviceV1_1_1->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeDevice_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
