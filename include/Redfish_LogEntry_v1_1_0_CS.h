...
#ifndef _RedfishLogentry_V1_1_0_CSTRUCT_H_
#define _RedfishLogentry_V1_1_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_1_0_LogEntry_CS RedfishLogEntry_V1_1_0_LogEntry_CS;
typedef struct _RedfishLogEntry_V1_1_0_LogEntry_Links_CS RedfishLogEntry_V1_1_0_LogEntry_Links_CS;
...
typedef struct _RedfishLogEntry_V1_1_0_LogEntry_CS {
    ...
    RedfishCS_char                              *Id;            
    RedfishLogEntry_V1_1_0_LogEntry_Links_CS    *Links;             // Contains references to other
...
RedfishCS_status
Json_LogEntry_V1_1_0_To_CS (char *JsonRawText, RedfishLogEntry_V1_1_0_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_1_0_JSON (RedfishLogEntry_V1_1_0_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_1_0_CS (RedfishLogEntry_V1_1_0_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_1_0_Json (RedfishCS_char *JsonText);
