...
//
#include <RedfishInterpreter/Task/v1_0_6/EfiTaskV1_0_6.h>
...
{
  EFI_REDFISH_TASK_V1_0_6 *TaskV1_0_6;
  EFI_REDFISH_TASK_V1_0_6_CS *TaskV1_0_6Cs;
  ...
  Status = Json_Task_V1_0_6_To_CS (ResoruceRaw, &TaskV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_0_6 = (EFI_REDFISH_TASK_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_0_6));
  if (TaskV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskV1_0_6;
  TaskV1_0_6->Task = TaskV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_TASK_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Task_V1_0_6_JSON (*((EFI_REDFISH_TASK_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskV1_0_6 = (EFI_REDFISH_TASK_V1_0_6 *)InterpProp;
  DestroyTask_V1_0_6_CS (TaskV1_0_6->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTask_V1_0_6_Json (ResoruceRaw);
}
