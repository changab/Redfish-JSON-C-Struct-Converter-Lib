# Definition of Endpoint.V1_0_2 and functions<br><br>

## ConnectedEntity
    typedef struct _RedfishEndpoint_V1_0_2_ConnectedEntity_CS {
        RedfishCS_Link EntityLink;
        RedfishEndpoint_V1_0_2_PciId_CS *EntityPciId;
...
|**EntityPciId**|RedfishEndpoint_V1_0_2_PciId_CS| Structure points to **EntityPciId** property.| No| No
...
## Endpoint
    typedef struct _RedfishEndpoint_V1_0_2_Endpoint_CS {
        ...
        RedfishEndpoint_V1_0_2_Endpoint_Actions_CS *Actions;
        RedfishEndpoint_V1_0_2_ConnectedEntity_CS *ConnectedEntities;
        ...
        RedfishEndpoint_V1_0_2_Endpoint_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishEndpoint_V1_0_2_PciId_CS *PciId;
...
|**Actions**|RedfishEndpoint_V1_0_2_Endpoint_Actions_CS| Structure points to **Actions** property.| No| No
|**ConnectedEntities**|RedfishEndpoint_V1_0_2_ConnectedEntity_CS| Structure points to **ConnectedEntities** property.| No| No
...
|**Links**|RedfishEndpoint_V1_0_2_Endpoint_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PciId**|RedfishEndpoint_V1_0_2_PciId_CS| Structure points to **PciId** property.| No| No
...
## Redfish Endpoint V1_0_2 to C Structure Function
    RedfishCS_status
    Json_Endpoint_V1_0_2_To_CS (RedfishCS_char *JsonRawText, RedfishEndpoint_V1_0_2_Endpoint_CS **ReturnedCS);

## C Structure to Redfish Endpoint V1_0_2 JSON Function
    RedfishCS_status
    CS_To_Endpoint_V1_0_2_JSON (RedfishEndpoint_V1_0_2_Endpoint_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Endpoint V1_0_2 C Structure Function
    RedfishCS_status
