...
#include"Redfish_ExternalAccountProviderCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishExternalAccountProviderCollection_ExternalAccountProviderCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ExternalAccountProviderCollection.ExternalAccountProviderCollection
//
RedfishCS_status CS_To_ExternalAccountProviderCollection_JSON(RedfishExternalAccountProviderCollection_ExternalAccountProviderCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ExternalAccountProviderCollection.ExternalAccountProviderCollection
//
RedfishCS_status DestroyExternalAccountProviderCollection_CS(RedfishExternalAccountProviderCollection_ExternalAccountProviderCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ExternalAccountProviderCollection.ExternalAccountProviderCollection
//
RedfishCS_status DestroyExternalAccountProviderCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ExternalAccountProviderCollection.NOVERSIONED.ExternalAccountProviderCollection
//
RedfishCS_status
Json_ExternalAccountProviderCollection_To_CS(RedfishCS_char *JsonRawText, RedfishExternalAccountProviderCollection_ExternalAccountProviderCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishExternalAccountProviderCollection_ExternalAccountProviderCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ExternalAccountProviderCollection", "noversioned", "ExternalAccountProviderCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishExternalAccountProviderCollection_ExternalAccountProviderCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyExternalAccountProviderCollection_CS (Cs);
  return Status;
}
