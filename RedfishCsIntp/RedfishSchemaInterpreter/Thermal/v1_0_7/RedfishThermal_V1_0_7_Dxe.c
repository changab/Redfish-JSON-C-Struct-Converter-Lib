...
//
#include <RedfishInterpreter/Thermal/v1_0_7/EfiThermalV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_0_7 
...
{
  EFI_REDFISH_THERMAL_V1_0_7 *ThermalV1_0_7;
  EFI_REDFISH_THERMAL_V1_0_7_CS *ThermalV1_0_7Cs;
  ...
  Status = Json_Thermal_V1_0_7_To_CS (ResoruceRaw, &ThermalV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_0_7 = (EFI_REDFISH_THERMAL_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_0_7));
  if (ThermalV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_0_7;
  ThermalV1_0_7->Thermal = ThermalV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_0_7_JSON (*((EFI_REDFISH_THERMAL_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_0_7 = (EFI_REDFISH_THERMAL_V1_0_7 *)InterpProp;
  DestroyThermal_V1_0_7_CS (ThermalV1_0_7->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_0_7EntryPoint (
