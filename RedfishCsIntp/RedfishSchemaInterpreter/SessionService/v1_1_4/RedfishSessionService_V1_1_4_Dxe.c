...
//
#include <RedfishInterpreter/SessionService/v1_1_4/EfiSessionServiceV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_1_4 
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_1_4 *SessionServiceV1_1_4;
  EFI_REDFISH_SESSIONSERVICE_V1_1_4_CS *SessionServiceV1_1_4Cs;
  ...
  Status = Json_SessionService_V1_1_4_To_CS (ResoruceRaw, &SessionServiceV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_1_4 = (EFI_REDFISH_SESSIONSERVICE_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_4));
  if (SessionServiceV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionServiceV1_1_4;
  SessionServiceV1_1_4->SessionService = SessionServiceV1_1_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SessionService_V1_1_4_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionServiceV1_1_4 = (EFI_REDFISH_SESSIONSERVICE_V1_1_4 *)InterpProp;
  DestroySessionService_V1_1_4_CS (SessionServiceV1_1_4->SessionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySessionService_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
