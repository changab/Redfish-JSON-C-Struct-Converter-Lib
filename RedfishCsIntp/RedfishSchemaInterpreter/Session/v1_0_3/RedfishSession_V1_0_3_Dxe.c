...
//
#include <RedfishInterpreter/Session/v1_0_3/EfiSessionV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_0_3 
...
{
  EFI_REDFISH_SESSION_V1_0_3 *SessionV1_0_3;
  EFI_REDFISH_SESSION_V1_0_3_CS *SessionV1_0_3Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Session") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Session_V1_0_3_To_CS (ResoruceRaw, &SessionV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_0_3 = (EFI_REDFISH_SESSION_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_0_3));
  if (SessionV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionV1_0_3;
  SessionV1_0_3->Session = SessionV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SESSION_V1_0_3_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Session"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Session");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Session"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Session");
...
)
{
  ...
  return CS_To_Session_V1_0_3_JSON (*((EFI_REDFISH_SESSION_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in SessionToStruct.
...
)
{
  ...
  SessionV1_0_3 = (EFI_REDFISH_SESSION_V1_0_3 *)InterpProp;
  DestroySession_V1_0_3_CS (SessionV1_0_3->Session); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SessionFromEfiStruct
...
)
{
  ...
  return DestroySession_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_0_3EntryPoint (
