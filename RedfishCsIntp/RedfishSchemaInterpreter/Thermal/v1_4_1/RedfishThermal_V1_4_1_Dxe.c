...
//
#include <RedfishInterpreter/Thermal/v1_4_1/EfiThermalV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_4_1 
...
{
  EFI_REDFISH_THERMAL_V1_4_1 *ThermalV1_4_1;
  EFI_REDFISH_THERMAL_V1_4_1_CS *ThermalV1_4_1Cs;
  ...
  Status = Json_Thermal_V1_4_1_To_CS (ResoruceRaw, &ThermalV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_4_1 = (EFI_REDFISH_THERMAL_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_4_1));
  if (ThermalV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_4_1;
  ThermalV1_4_1->Thermal = ThermalV1_4_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_4_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_4_1_JSON (*((EFI_REDFISH_THERMAL_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_4_1 = (EFI_REDFISH_THERMAL_V1_4_1 *)InterpProp;
  DestroyThermal_V1_4_1_CS (ThermalV1_4_1->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_4_1EntryPoint (
