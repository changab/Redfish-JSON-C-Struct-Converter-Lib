...
//
#include <RedfishInterpreter/Endpoint/v1_1_0/EfiEndpointV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_1_0 
...
{
  EFI_REDFISH_ENDPOINT_V1_1_0 *EndpointV1_1_0;
  EFI_REDFISH_ENDPOINT_V1_1_0_CS *EndpointV1_1_0Cs;
  ...
  Status = Json_Endpoint_V1_1_0_To_CS (ResoruceRaw, &EndpointV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_1_0 = (EFI_REDFISH_ENDPOINT_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_1_0));
  if (EndpointV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EndpointV1_1_0;
  EndpointV1_1_0->Endpoint = EndpointV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ENDPOINT_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Endpoint_V1_1_0_JSON (*((EFI_REDFISH_ENDPOINT_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EndpointV1_1_0 = (EFI_REDFISH_ENDPOINT_V1_1_0 *)InterpProp;
  DestroyEndpoint_V1_1_0_CS (EndpointV1_1_0->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEndpoint_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_1_0EntryPoint (
