...
#include"Redfish_NetworkPort_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkPort_V1_2_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkPort_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkPort_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkPort_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenNetDevFuncMaxBWAlloc_Array_ElementCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaxBWAllocPercent
...
//
//Generate C structure for RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_Array_CS
//
static RedfishCS_status GenNetDevFuncMaxBWAlloc_ArrayCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenNetDevFuncMinBWAlloc_Array_ElementCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MinBWAllocPercent
...
//
//Generate C structure for RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_Array_CS
//
static RedfishCS_status GenNetDevFuncMinBWAlloc_ArrayCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenStatusCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//Generate C structure for RedfishCS_int64_Array
//
static RedfishCS_status GenRedfishCS_int64_ArrayCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_int64_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status GenSupportedLinkCapabilities_Array_ElementCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AutoSpeedNegotiation
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "AutoSpeedNegotiation", &(*Dst)->AutoSpeedNegotiation);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // CapableLinkSpeedMbps
  Status = GenRedfishCS_int64_ArrayCs (Cs, TempJsonObj, "CapableLinkSpeedMbps", &(*Dst)->CapableLinkSpeedMbps);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_Array_CS
//
static RedfishCS_status GenSupportedLinkCapabilities_ArrayCs(RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishNetworkPort_V1_2_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishNetworkPort_V1_2_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NetDevFuncMaxBWAlloc(json_t *CsJson, char *Key, RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_Array_CS *NextArray;
  RedfishNetworkPort_V1_2_0_NetDevFuncMaxBWAlloc_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_NetDevFuncMinBWAlloc(json_t *CsJson, char *Key, RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_Array_CS *NextArray;
  RedfishNetworkPort_V1_2_0_NetDevFuncMinBWAlloc_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_SupportedLinkCapabilities(json_t *CsJson, char *Key, RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_Array_CS *NextArray;
  RedfishNetworkPort_V1_2_0_SupportedLinkCapabilities_CS *NextArrayItem;
  ...
  do {
    ...
    NextArrayItem = NextArray->ArrayValue;
    // AutoSpeedNegotiation 
    if (InsertJsonBoolObj (ArrayMember, "AutoSpeedNegotiation", NextArrayItem->AutoSpeedNegotiation) != RedfishCS_status_success) {goto Error;}

    // CapableLinkSpeedMbps 
    if (InsertJsonInt64ArrayObj (ArrayMember, "CapableLinkSpeedMbps", NextArrayItem->CapableLinkSpeedMbps) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for NetworkPort.V1_2_0.NetworkPort
//
RedfishCS_status CS_To_NetworkPort_V1_2_0_JSON(RedfishNetworkPort_V1_2_0_NetworkPort_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonInt64Obj (CsJson, "CurrentLinkSpeedMbps", CSPtr->CurrentLinkSpeedMbps) != RedfishCS_status_success) {goto Error;}
  ...
  // FCFabricName 
  if (InsertJsonStringObj (CsJson, "FCFabricName", CSPtr->FCFabricName) != RedfishCS_status_success) {goto Error;}

  // FCPortConnectionType 
  if (InsertJsonStringObj (CsJson, "FCPortConnectionType", CSPtr->FCPortConnectionType) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for NetworkPort.V1_2_0.NetworkPort
//
RedfishCS_status DestroyNetworkPort_V1_2_0_CS(RedfishNetworkPort_V1_2_0_NetworkPort_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkPort.V1_2_0.NetworkPort
//
RedfishCS_status DestroyNetworkPort_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkPort.V1_2_0.NetworkPort
//
RedfishCS_status
Json_NetworkPort_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkPort_V1_2_0_NetworkPort_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkPort_V1_2_0_NetworkPort_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkPort", "v1_2_0", "NetworkPort", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkPort_V1_2_0_NetworkPort_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // CurrentLinkSpeedMbps
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "CurrentLinkSpeedMbps", &Cs->CurrentLinkSpeedMbps);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // FCFabricName
  Status = GetRedfishPropertyStr (Cs, JsonObj, "FCFabricName", &Cs->FCFabricName);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // FCPortConnectionType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "FCPortConnectionType", &Cs->FCPortConnectionType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // NumberDiscoveredRemotePorts
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "NumberDiscoveredRemotePorts", &Cs->NumberDiscoveredRemotePorts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkPort_V1_2_0_CS (Cs);
  return Status;
}
