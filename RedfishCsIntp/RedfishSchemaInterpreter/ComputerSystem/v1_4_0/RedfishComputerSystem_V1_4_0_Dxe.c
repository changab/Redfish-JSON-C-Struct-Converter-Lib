...
//
#include <RedfishInterpreter/ComputerSystem/v1_4_0/EfiComputerSystemV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_4_0 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_4_0 *ComputerSystemV1_4_0;
  EFI_REDFISH_COMPUTERSYSTEM_V1_4_0_CS *ComputerSystemV1_4_0Cs;
  ...
  Status = Json_ComputerSystem_V1_4_0_To_CS (ResoruceRaw, &ComputerSystemV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_4_0 = (EFI_REDFISH_COMPUTERSYSTEM_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_4_0));
  if (ComputerSystemV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_4_0;
  ComputerSystemV1_4_0->ComputerSystem = ComputerSystemV1_4_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_4_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_4_0_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_4_0 = (EFI_REDFISH_COMPUTERSYSTEM_V1_4_0 *)InterpProp;
  DestroyComputerSystem_V1_4_0_CS (ComputerSystemV1_4_0->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_4_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_4_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
