...
#ifndef _RedfishVolume_V1_0_1_CSTRUCT_H_
#define _RedfishVolume_V1_0_1_CSTRUCT_H_
...
typedef struct _RedfishVolume_V1_0_1_Initialize_CS RedfishVolume_V1_0_1_Initialize_CS;
typedef struct _RedfishVolume_V1_0_1_Operations_CS RedfishVolume_V1_0_1_Operations_CS;
typedef struct _RedfishVolume_V1_0_1_Volume_CS RedfishVolume_V1_0_1_Volume_CS;
typedef struct _RedfishVolume_V1_0_1_Volume_Actions_CS RedfishVolume_V1_0_1_Volume_Actions_CS;
typedef struct _RedfishVolume_V1_0_1_Volume_Actions_Oem_CS RedfishVolume_V1_0_1_Volume_Actions_Oem_CS;
typedef struct _RedfishVolume_V1_0_1_Volume_Links_CS RedfishVolume_V1_0_1_Volume_Links_CS;
//
...
// system.
//
typedef struct _RedfishVolume_V1_0_1_Initialize_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_0_1_Initialize_CS;

typedef struct _RedfishVolume_V1_0_1_Operations_CS {
    ...
    RedfishCS_int64    *PercentageComplete;    // The percentage of the
                                              ...
                                              // completed.
} RedfishVolume_V1_0_1_Operations_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishVolume_V1_0_1_Volume_Actions_CS {
    RedfishVolume_V1_0_1_Initialize_CS            *Volume_Initialize;
    RedfishVolume_V1_0_1_Volume_Actions_Oem_CS    *Oem;             
} RedfishVolume_V1_0_1_Volume_Actions_CS;

typedef struct _RedfishVolume_V1_0_1_Volume_Actions_Oem_CS {
    RedfishCS_Link    Prop;
} RedfishVolume_V1_0_1_Volume_Actions_Oem_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishVolume_V1_0_1_Volume_Links_CS {
...
} RedfishVolume_V1_0_1_Volume_Links_CS;
...
typedef struct _RedfishVolume_V1_0_1_Volume_CS {
    ...
    RedfishVolume_V1_0_1_Volume_Actions_CS    *Actions;              // The available actions for this
                                                                     // resource.
    ...
    RedfishResource_V1_1_0_Identifier_CS      *Identifiers;          // The Durable names for the
                                                                     // volume
    RedfishVolume_V1_0_1_Volume_Links_CS      *Links;                // Contains references to other
    ...
    RedfishResource_Oem_CS                    *Oem;                  // This is the
                                                                     ...
                                                                     // sections.
    RedfishVolume_V1_0_1_Operations_CS        *Operations;           // The operations currently
...
RedfishCS_status
Json_Volume_V1_0_1_To_CS (char *JsonRawText, RedfishVolume_V1_0_1_Volume_CS **ReturnedCS);

RedfishCS_status
CS_To_Volume_V1_0_1_JSON (RedfishVolume_V1_0_1_Volume_CS *CSPtr, char **JsonText);
