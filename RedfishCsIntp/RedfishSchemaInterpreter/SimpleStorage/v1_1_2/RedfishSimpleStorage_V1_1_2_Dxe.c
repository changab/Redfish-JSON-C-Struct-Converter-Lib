...
//
#include <RedfishInterpreter/SimpleStorage/v1_1_2/EfiSimpleStorageV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_1_2 
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_1_2 *SimpleStorageV1_1_2;
  EFI_REDFISH_SIMPLESTORAGE_V1_1_2_CS *SimpleStorageV1_1_2Cs;
  ...
  Status = Json_SimpleStorage_V1_1_2_To_CS (ResoruceRaw, &SimpleStorageV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_1_2 = (EFI_REDFISH_SIMPLESTORAGE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_1_2));
  if (SimpleStorageV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SimpleStorageV1_1_2;
  SimpleStorageV1_1_2->SimpleStorage = SimpleStorageV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SimpleStorage_V1_1_2_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SimpleStorageV1_1_2 = (EFI_REDFISH_SIMPLESTORAGE_V1_1_2 *)InterpProp;
  DestroySimpleStorage_V1_1_2_CS (SimpleStorageV1_1_2->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySimpleStorage_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
