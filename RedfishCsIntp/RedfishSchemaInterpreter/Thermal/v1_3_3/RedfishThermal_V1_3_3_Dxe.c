...
//
#include <RedfishInterpreter/Thermal/v1_3_3/EfiThermalV1_3_3.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_3_3 
...
{
  EFI_REDFISH_THERMAL_V1_3_3 *ThermalV1_3_3;
  EFI_REDFISH_THERMAL_V1_3_3_CS *ThermalV1_3_3Cs;
  ...
  Status = Json_Thermal_V1_3_3_To_CS (ResoruceRaw, &ThermalV1_3_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_3_3 = (EFI_REDFISH_THERMAL_V1_3_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_3_3));
  if (ThermalV1_3_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_3_3;
  ThermalV1_3_3->Thermal = ThermalV1_3_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_3_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_3_3_JSON (*((EFI_REDFISH_THERMAL_V1_3_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_3_3 = (EFI_REDFISH_THERMAL_V1_3_3 *)InterpProp;
  DestroyThermal_V1_3_3_CS (ThermalV1_3_3->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_3_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_3_3EntryPoint (
