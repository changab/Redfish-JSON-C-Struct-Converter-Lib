# Definition of AccountService.V1_2_2 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Oem**|RedfishAccountService_V1_2_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## AccountService
    typedef struct _RedfishAccountService_V1_2_2_AccountService_CS {
        ...
        RedfishAccountService_V1_2_2_Actions_CS *Actions;
...
|**Actions**|RedfishAccountService_V1_2_2_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish AccountService V1_2_2 to C Structure Function
    RedfishCS_status
    Json_AccountService_V1_2_2_To_CS (RedfishCS_char *JsonRawText, RedfishAccountService_V1_2_2_AccountService_CS **ReturnedCS);

## C Structure to Redfish AccountService V1_2_2 JSON Function
    RedfishCS_status
    CS_To_AccountService_V1_2_2_JSON (RedfishAccountService_V1_2_2_AccountService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish AccountService V1_2_2 C Structure Function
    RedfishCS_status
