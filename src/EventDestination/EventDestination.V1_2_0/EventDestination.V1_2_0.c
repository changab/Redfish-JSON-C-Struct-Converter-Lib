...
#include"Redfish_EventDestination_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEventDestination_V1_2_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenActions_OemCs(RedfishEventDestination_V1_2_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_2_0_EventDestination_Actions_Oem_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventDestination_V1_2_0_EventDestination_Actions_Oem_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEventDestination_V1_2_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_2_0_EventDestination_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventDestination_V1_2_0_EventDestination_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenHttpHeaderProperty_Array_ElementCs(RedfishEventDestination_V1_2_0_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEventDestination_V1_2_0_HttpHeaderProperty_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEventDestination_V1_2_0_HttpHeaderProperty_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//
//Generate C structure for RedfishEventDestination_V1_2_0_HttpHeaderProperty_Array_CS
//
static RedfishCS_status GenHttpHeaderProperty_ArrayCs(RedfishEventDestination_V1_2_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_2_0_HttpHeaderProperty_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEventDestination_V1_2_0_HttpHeaderProperty_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEventDestination_V1_2_0_HttpHeaderProperty_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishEventDestination_V1_2_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishEventDestination_V1_2_0_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodata_V4_0_0_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRef_ArrayCs(RedfishEventDestination_V1_2_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, Redfishodata_V4_0_0_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEventDestination_V1_2_0_EventDestination_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEventDestination_V1_2_0_EventDestination_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HttpHeaders(json_t *CsJson, char *Key, RedfishEventDestination_V1_2_0_HttpHeaderProperty_Array_CS *CSPtr)
{
  // No JSON property for this structure.
  return RedfishCS_status_success;
}
...
static RedfishCS_status CS_To_JSON_OriginResources(json_t *CsJson, char *Key, Redfishodata_V4_0_0_idRef_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
...
//
// C structure to JSON for EventDestination.V1_2_0.EventDestination
//
RedfishCS_status CS_To_EventDestination_V1_2_0_JSON(RedfishEventDestination_V1_2_0_EventDestination_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonStringObj (CsJson, "OriginResources@odata.navigationLink", CSPtr->OriginResourcesodata_navigationLink) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for EventDestination.V1_2_0.EventDestination
//
RedfishCS_status DestroyEventDestination_V1_2_0_CS(RedfishEventDestination_V1_2_0_EventDestination_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EventDestination.V1_2_0.EventDestination
//
RedfishCS_status DestroyEventDestination_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EventDestination.V1_2_0.EventDestination
//
RedfishCS_status
Json_EventDestination_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishEventDestination_V1_2_0_EventDestination_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEventDestination_V1_2_0_EventDestination_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EventDestination", "v1_2_0", "EventDestination", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEventDestination_V1_2_0_EventDestination_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // OriginResources@odata.navigationLink
  Status = GetRedfishPropertyStr (Cs, JsonObj, "OriginResources@odata.navigationLink", &Cs->OriginResourcesodata_navigationLink);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyEventDestination_V1_2_0_CS (Cs);
  return Status;
}
