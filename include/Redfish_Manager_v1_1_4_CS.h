...
#ifndef _RedfishManager_V1_1_4_CSTRUCT_H_
#define _RedfishManager_V1_1_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManager_V1_1_4_Actions_CS RedfishManager_V1_1_4_Actions_CS;
typedef struct _RedfishManager_V1_1_4_CommandShell_CS RedfishManager_V1_1_4_CommandShell_CS;
typedef struct _RedfishManager_V1_1_4_ForceFailover_CS RedfishManager_V1_1_4_ForceFailover_CS;
typedef struct _RedfishManager_V1_1_4_GraphicalConsole_CS RedfishManager_V1_1_4_GraphicalConsole_CS;
typedef struct _RedfishManager_V1_1_4_Links_CS RedfishManager_V1_1_4_Links_CS;
typedef struct _RedfishManager_V1_1_4_Manager_CS RedfishManager_V1_1_4_Manager_CS;
typedef struct _RedfishManager_V1_1_4_ManagerService_CS RedfishManager_V1_1_4_ManagerService_CS;
typedef struct _RedfishManager_V1_1_4_ModifyRedundancySet_CS RedfishManager_V1_1_4_ModifyRedundancySet_CS;
typedef struct _RedfishManager_V1_1_4_OemActions_CS RedfishManager_V1_1_4_OemActions_CS;
typedef struct _RedfishManager_V1_1_4_Reset_CS RedfishManager_V1_1_4_Reset_CS;
typedef struct _RedfishManager_V1_1_4_SerialConsole_CS RedfishManager_V1_1_4_SerialConsole_CS;
...
typedef struct _RedfishManager_V1_1_4_Manager_CS {
    ...
    RedfishManager_V1_1_4_Actions_CS             *Actions;                 // The available actions for this
                                                                           // resource.
    RedfishManager_V1_1_4_CommandShell_CS        *CommandShell;            // Information about the Command
    ...
    RedfishCS_char                               *FirmwareVersion;         // The firmware version of this
                                                                           // Manager.
    RedfishManager_V1_1_4_GraphicalConsole_CS    *GraphicalConsole;        // The value of this property
                                                                           // shall contain the information
                                                                           // about the Graphical Console
                                                                           // (KVM-IP) service of this
                                                                           // manager.
    RedfishCS_char                               *Id;                  
    RedfishManager_V1_1_4_Links_CS               *Links;                   // Contains references to other
    ...
    RedfishManager_V1_1_4_SerialConsole_CS       *SerialConsole;           // Information about the Serial
...
RedfishCS_status
Json_Manager_V1_1_4_To_CS (char *JsonRawText, RedfishManager_V1_1_4_Manager_CS **ReturnedCS);

RedfishCS_status
CS_To_Manager_V1_1_4_JSON (RedfishManager_V1_1_4_Manager_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManager_V1_1_4_CS (RedfishManager_V1_1_4_Manager_CS *CSPtr);

RedfishCS_status
DestroyManager_V1_1_4_Json (RedfishCS_char *JsonText);
