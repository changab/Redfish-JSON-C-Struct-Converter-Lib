...
//
#include <RedfishInterpreter/Storage/v1_0_1/EfiStorageV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_0_1 
...
{
  EFI_REDFISH_STORAGE_V1_0_1 *StorageV1_0_1;
  EFI_REDFISH_STORAGE_V1_0_1_CS *StorageV1_0_1Cs;
  ...
  Status = Json_Storage_V1_0_1_To_CS (ResoruceRaw, &StorageV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_0_1 = (EFI_REDFISH_STORAGE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_0_1));
  if (StorageV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_0_1;
  StorageV1_0_1->Storage = StorageV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_0_1_JSON (*((EFI_REDFISH_STORAGE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_0_1 = (EFI_REDFISH_STORAGE_V1_0_1 *)InterpProp;
  DestroyStorage_V1_0_1_CS (StorageV1_0_1->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_0_1EntryPoint (
