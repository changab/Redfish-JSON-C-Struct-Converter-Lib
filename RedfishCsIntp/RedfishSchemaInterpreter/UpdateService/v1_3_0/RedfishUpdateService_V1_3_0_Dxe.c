...
//
#include <RedfishInterpreter/UpdateService/v1_3_0/EfiUpdateServiceV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_3_0 
...
{
  EFI_REDFISH_UPDATESERVICE_V1_3_0 *UpdateServiceV1_3_0;
  EFI_REDFISH_UPDATESERVICE_V1_3_0_CS *UpdateServiceV1_3_0Cs;
  ...
  Status = Json_UpdateService_V1_3_0_To_CS (ResoruceRaw, &UpdateServiceV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_3_0 = (EFI_REDFISH_UPDATESERVICE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_3_0));
  if (UpdateServiceV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)UpdateServiceV1_3_0;
  UpdateServiceV1_3_0->UpdateService = UpdateServiceV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_UPDATESERVICE_V1_3_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_UpdateService_V1_3_0_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  UpdateServiceV1_3_0 = (EFI_REDFISH_UPDATESERVICE_V1_3_0 *)InterpProp;
  DestroyUpdateService_V1_3_0_CS (UpdateServiceV1_3_0->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyUpdateService_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
