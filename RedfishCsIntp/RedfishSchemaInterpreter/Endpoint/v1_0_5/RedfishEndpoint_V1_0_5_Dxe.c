...
//
#include <RedfishInterpreter/Endpoint/v1_0_5/EfiEndpointV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_0_5 
...
{
  EFI_REDFISH_ENDPOINT_V1_0_5 *EndpointV1_0_5;
  EFI_REDFISH_ENDPOINT_V1_0_5_CS *EndpointV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Endpoint") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Endpoint_V1_0_5_To_CS (ResoruceRaw, &EndpointV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_0_5 = (EFI_REDFISH_ENDPOINT_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_0_5));
  if (EndpointV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EndpointV1_0_5;
  EndpointV1_0_5->Endpoint = EndpointV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_ENDPOINT_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Endpoint"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Endpoint");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Endpoint"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Endpoint");
...
)
{
  ...
  return CS_To_Endpoint_V1_0_5_JSON (*((EFI_REDFISH_ENDPOINT_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in EndpointToStruct.
...
)
{
  ...
  EndpointV1_0_5 = (EFI_REDFISH_ENDPOINT_V1_0_5 *)InterpProp;
  DestroyEndpoint_V1_0_5_CS (EndpointV1_0_5->Endpoint); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EndpointFromEfiStruct
...
)
{
  ...
  return DestroyEndpoint_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_0_5EntryPoint (
