...
//
#include <RedfishInterpreter/Power/v1_5_0/EfiPowerV1_5_0.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_5_0 
...
{
  EFI_REDFISH_POWER_V1_5_0 *PowerV1_5_0;
  EFI_REDFISH_POWER_V1_5_0_CS *PowerV1_5_0Cs;
  ...
  Status = Json_Power_V1_5_0_To_CS (ResoruceRaw, &PowerV1_5_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_5_0 = (EFI_REDFISH_POWER_V1_5_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_5_0));
  if (PowerV1_5_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_5_0;
  PowerV1_5_0->Power = PowerV1_5_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "5";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_POWER_V1_5_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_5_0_JSON (*((EFI_REDFISH_POWER_V1_5_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_5_0 = (EFI_REDFISH_POWER_V1_5_0 *)InterpProp;
  DestroyPower_V1_5_0_CS (PowerV1_5_0->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_5_0_Json (ResoruceRaw);
}
