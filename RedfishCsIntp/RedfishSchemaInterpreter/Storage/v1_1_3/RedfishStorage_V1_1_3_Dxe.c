...
//
#include <RedfishInterpreter/Storage/v1_1_3/EfiStorageV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_1_3 
...
{
  EFI_REDFISH_STORAGE_V1_1_3 *StorageV1_1_3;
  EFI_REDFISH_STORAGE_V1_1_3_CS *StorageV1_1_3Cs;
  ...
  Status = Json_Storage_V1_1_3_To_CS (ResoruceRaw, &StorageV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_1_3 = (EFI_REDFISH_STORAGE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_1_3));
  if (StorageV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_1_3;
  StorageV1_1_3->Storage = StorageV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_1_3_JSON (*((EFI_REDFISH_STORAGE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_1_3 = (EFI_REDFISH_STORAGE_V1_1_3 *)InterpProp;
  DestroyStorage_V1_1_3_CS (StorageV1_1_3->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_1_3EntryPoint (
