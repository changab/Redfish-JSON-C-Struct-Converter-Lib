...
//
#include <RedfishInterpreter/SerialInterface/v1_0_5/EfiSerialInterfaceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_0_5 
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_0_5 *SerialInterfaceV1_0_5;
  EFI_REDFISH_SERIALINTERFACE_V1_0_5_CS *SerialInterfaceV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "SerialInterface") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_SerialInterface_V1_0_5_To_CS (ResoruceRaw, &SerialInterfaceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_0_5 = (EFI_REDFISH_SERIALINTERFACE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_5));
  if (SerialInterfaceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SerialInterfaceV1_0_5;
  SerialInterfaceV1_0_5->SerialInterface = SerialInterfaceV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SerialInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "SerialInterface");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SerialInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "SerialInterface");
...
)
{
  ...
  return CS_To_SerialInterface_V1_0_5_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in SerialInterfaceToStruct.
...
EFI_STATUS
EFIAPI
SerialInterfaceDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  SerialInterfaceV1_0_5 = (EFI_REDFISH_SERIALINTERFACE_V1_0_5 *)InterpProp;
  DestroySerialInterface_V1_0_5_CS (SerialInterfaceV1_0_5->SerialInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SerialInterfaceFromEfiStruct
...
)
{
  ...
  return DestroySerialInterface_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
