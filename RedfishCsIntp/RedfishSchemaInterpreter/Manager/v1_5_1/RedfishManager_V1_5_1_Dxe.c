...
//
#include <RedfishInterpreter/Manager/v1_5_1/EfiManagerV1_5_1.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_5_1 
...
{
  EFI_REDFISH_MANAGER_V1_5_1 *ManagerV1_5_1;
  EFI_REDFISH_MANAGER_V1_5_1_CS *ManagerV1_5_1Cs;
  ...
  Status = Json_Manager_V1_5_1_To_CS (ResoruceRaw, &ManagerV1_5_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_5_1 = (EFI_REDFISH_MANAGER_V1_5_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_5_1));
  if (ManagerV1_5_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_5_1;
  ManagerV1_5_1->Manager = ManagerV1_5_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "5";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_5_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_5_1_JSON (*((EFI_REDFISH_MANAGER_V1_5_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_5_1 = (EFI_REDFISH_MANAGER_V1_5_1 *)InterpProp;
  DestroyManager_V1_5_1_CS (ManagerV1_5_1->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_5_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_5_1EntryPoint (
