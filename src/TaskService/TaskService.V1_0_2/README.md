# Definition of TaskService.V1_0_2 and functions<br><br>
...
## TaskService
    typedef struct _RedfishTaskService_V1_0_2_TaskService_CS {
    ...
    } RedfishTaskService_V1_0_2_TaskService_CS;
...
## Redfish TaskService V1_0_2 to C Structure Function
    RedfishCS_status
    Json_TaskService_V1_0_2_To_CS (RedfishCS_char *JsonRawText, RedfishTaskService_V1_0_2_TaskService_CS **ReturnedCS);

## C Structure to Redfish TaskService V1_0_2 JSON Function
    RedfishCS_status
    CS_To_TaskService_V1_0_2_JSON (RedfishTaskService_V1_0_2_TaskService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish TaskService V1_0_2 C Structure Function
    RedfishCS_status
    DestroyTaskService_V1_0_2_CS (RedfishTaskService_V1_0_2_TaskService_CS *CSPtr);
