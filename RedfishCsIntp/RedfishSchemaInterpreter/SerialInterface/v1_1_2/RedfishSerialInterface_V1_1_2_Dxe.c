...
//
#include <RedfishInterpreter/SerialInterface/v1_1_2/EfiSerialInterfaceV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_1_2 
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_1_2 *SerialInterfaceV1_1_2;
  EFI_REDFISH_SERIALINTERFACE_V1_1_2_CS *SerialInterfaceV1_1_2Cs;
  ...
  Status = Json_SerialInterface_V1_1_2_To_CS (ResoruceRaw, &SerialInterfaceV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_1_2 = (EFI_REDFISH_SERIALINTERFACE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_2));
  if (SerialInterfaceV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SerialInterfaceV1_1_2;
  SerialInterfaceV1_1_2->SerialInterface = SerialInterfaceV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SerialInterface_V1_1_2_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SerialInterfaceV1_1_2 = (EFI_REDFISH_SERIALINTERFACE_V1_1_2 *)InterpProp;
  DestroySerialInterface_V1_1_2_CS (SerialInterfaceV1_1_2->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySerialInterface_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
