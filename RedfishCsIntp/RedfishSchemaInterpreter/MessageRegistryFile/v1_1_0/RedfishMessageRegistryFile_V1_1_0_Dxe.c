...
//
#include <RedfishInterpreter/MessageRegistryFile/v1_1_0/EfiMessageRegistryFileV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_1_0 
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_0 *MessageRegistryFileV1_1_0;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_0_CS *MessageRegistryFileV1_1_0Cs;
  ...
  Status = Json_MessageRegistryFile_V1_1_0_To_CS (ResoruceRaw, &MessageRegistryFileV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_1_0 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_0));
  if (MessageRegistryFileV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryFileV1_1_0;
  MessageRegistryFileV1_1_0->MessageRegistryFile = MessageRegistryFileV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistryFile_V1_1_0_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryFileV1_1_0 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_0 *)InterpProp;
  DestroyMessageRegistryFile_V1_1_0_CS (MessageRegistryFileV1_1_0->MessageRegistryFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistryFile_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
