...
//
#include <RedfishInterpreter/LogEntry/v1_1_0/EfiLogEntryV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_1_0 
...
{
  EFI_REDFISH_LOGENTRY_V1_1_0 *LogEntryV1_1_0;
  EFI_REDFISH_LOGENTRY_V1_1_0_CS *LogEntryV1_1_0Cs;
  ...
  Status = Json_LogEntry_V1_1_0_To_CS (ResoruceRaw, &LogEntryV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_1_0 = (EFI_REDFISH_LOGENTRY_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_1_0));
  if (LogEntryV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_1_0;
  LogEntryV1_1_0->LogEntry = LogEntryV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_1_0_JSON (*((EFI_REDFISH_LOGENTRY_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_1_0 = (EFI_REDFISH_LOGENTRY_V1_1_0 *)InterpProp;
  DestroyLogEntry_V1_1_0_CS (LogEntryV1_1_0->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_1_0EntryPoint (
