# Definition of LogEntryCollection and functions<br><br>
...
## Redfish LogEntryCollection  to C Structure Function
    RedfishCS_status
    Json_LogEntryCollection_To_CS (RedfishCS_char *JsonRawText, RedfishLogEntryCollection_LogEntryCollection_CS **ReturnedCS);

## C Structure to Redfish LogEntryCollection  JSON Function
    RedfishCS_status
    CS_To_LogEntryCollection_JSON (RedfishLogEntryCollection_LogEntryCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish LogEntryCollection  C Structure Function
    RedfishCS_status
