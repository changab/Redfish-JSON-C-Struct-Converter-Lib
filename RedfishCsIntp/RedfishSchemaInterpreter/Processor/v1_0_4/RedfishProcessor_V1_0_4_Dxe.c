...
//
#include <RedfishInterpreter/Processor/v1_0_4/EfiProcessorV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_0_4 
...
{
  EFI_REDFISH_PROCESSOR_V1_0_4 *ProcessorV1_0_4;
  EFI_REDFISH_PROCESSOR_V1_0_4_CS *ProcessorV1_0_4Cs;
  ...
  Status = Json_Processor_V1_0_4_To_CS (ResoruceRaw, &ProcessorV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_0_4 = (EFI_REDFISH_PROCESSOR_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_0_4));
  if (ProcessorV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ProcessorV1_0_4;
  ProcessorV1_0_4->Processor = ProcessorV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_PROCESSOR_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Processor_V1_0_4_JSON (*((EFI_REDFISH_PROCESSOR_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ProcessorV1_0_4 = (EFI_REDFISH_PROCESSOR_V1_0_4 *)InterpProp;
  DestroyProcessor_V1_0_4_CS (ProcessorV1_0_4->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyProcessor_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_4EntryPoint (
