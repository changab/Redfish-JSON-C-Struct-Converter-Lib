...
//
#include <RedfishInterpreter/Chassis/v1_1_8/EfiChassisV1_1_8.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_1_8 
...
{
  EFI_REDFISH_CHASSIS_V1_1_8 *ChassisV1_1_8;
  EFI_REDFISH_CHASSIS_V1_1_8_CS *ChassisV1_1_8Cs;
  ...
  Status = Json_Chassis_V1_1_8_To_CS (ResoruceRaw, &ChassisV1_1_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_1_8 = (EFI_REDFISH_CHASSIS_V1_1_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_1_8));
  if (ChassisV1_1_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_1_8;
  ChassisV1_1_8->Chassis = ChassisV1_1_8Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "8";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_1_8_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_1_8_JSON (*((EFI_REDFISH_CHASSIS_V1_1_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_1_8 = (EFI_REDFISH_CHASSIS_V1_1_8 *)InterpProp;
  DestroyChassis_V1_1_8_CS (ChassisV1_1_8->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_1_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_1_8EntryPoint (
