...
//
#include <RedfishInterpreter/JsonSchemaFile/v1_1_1/EfiJsonSchemaFileV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_1_1 
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_1_1 *JsonSchemaFileV1_1_1;
  EFI_REDFISH_JSONSCHEMAFILE_V1_1_1_CS *JsonSchemaFileV1_1_1Cs;
  ...
  Status = Json_JsonSchemaFile_V1_1_1_To_CS (ResoruceRaw, &JsonSchemaFileV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_1_1 = (EFI_REDFISH_JSONSCHEMAFILE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_1_1));
  if (JsonSchemaFileV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)JsonSchemaFileV1_1_1;
  JsonSchemaFileV1_1_1->JsonSchemaFile = JsonSchemaFileV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_JsonSchemaFile_V1_1_1_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  JsonSchemaFileV1_1_1 = (EFI_REDFISH_JSONSCHEMAFILE_V1_1_1 *)InterpProp;
  DestroyJsonSchemaFile_V1_1_1_CS (JsonSchemaFileV1_1_1->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyJsonSchemaFile_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
