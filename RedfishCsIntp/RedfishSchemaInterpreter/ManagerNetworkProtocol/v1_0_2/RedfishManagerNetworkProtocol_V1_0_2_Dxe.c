...
//
#include <RedfishInterpreter/ManagerNetworkProtocol/v1_0_2/EfiManagerNetworkProtocolV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_0_2 
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_2 *ManagerNetworkProtocolV1_0_2;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_2_CS *ManagerNetworkProtocolV1_0_2Cs;
  ...
  Status = Json_ManagerNetworkProtocol_V1_0_2_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_0_2 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_2));
  if (ManagerNetworkProtocolV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerNetworkProtocolV1_0_2;
  ManagerNetworkProtocolV1_0_2->ManagerNetworkProtocol = ManagerNetworkProtocolV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerNetworkProtocol_V1_0_2_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerNetworkProtocolV1_0_2 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_2 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_0_2_CS (ManagerNetworkProtocolV1_0_2->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerNetworkProtocol_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
