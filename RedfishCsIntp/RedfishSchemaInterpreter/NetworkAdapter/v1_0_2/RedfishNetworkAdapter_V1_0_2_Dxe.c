...
//
#include <RedfishInterpreter/NetworkAdapter/v1_0_2/EfiNetworkAdapterV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_0_2 
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_0_2 *NetworkAdapterV1_0_2;
  EFI_REDFISH_NETWORKADAPTER_V1_0_2_CS *NetworkAdapterV1_0_2Cs;
  ...
  Status = Json_NetworkAdapter_V1_0_2_To_CS (ResoruceRaw, &NetworkAdapterV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_0_2 = (EFI_REDFISH_NETWORKADAPTER_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_0_2));
  if (NetworkAdapterV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkAdapterV1_0_2;
  NetworkAdapterV1_0_2->NetworkAdapter = NetworkAdapterV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_NETWORKADAPTER_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkAdapter_V1_0_2_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkAdapterV1_0_2 = (EFI_REDFISH_NETWORKADAPTER_V1_0_2 *)InterpProp;
  DestroyNetworkAdapter_V1_0_2_CS (NetworkAdapterV1_0_2->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkAdapter_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
