...
//
#include <RedfishInterpreter/EventDestination/v1_2_1/EfiEventDestinationV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_2_1 
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_2_1 *EventDestinationV1_2_1;
  EFI_REDFISH_EVENTDESTINATION_V1_2_1_CS *EventDestinationV1_2_1Cs;
  ...
  Status = Json_EventDestination_V1_2_1_To_CS (ResoruceRaw, &EventDestinationV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_2_1 = (EFI_REDFISH_EVENTDESTINATION_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_2_1));
  if (EventDestinationV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventDestinationV1_2_1;
  EventDestinationV1_2_1->EventDestination = EventDestinationV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_EVENTDESTINATION_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventDestination_V1_2_1_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventDestinationV1_2_1 = (EFI_REDFISH_EVENTDESTINATION_V1_2_1 *)InterpProp;
  DestroyEventDestination_V1_2_1_CS (EventDestinationV1_2_1->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventDestination_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
