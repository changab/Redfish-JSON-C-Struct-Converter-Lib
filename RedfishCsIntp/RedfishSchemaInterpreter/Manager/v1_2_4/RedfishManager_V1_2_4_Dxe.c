...
//
#include <RedfishInterpreter/Manager/v1_2_4/EfiManagerV1_2_4.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_2_4 
...
{
  EFI_REDFISH_MANAGER_V1_2_4 *ManagerV1_2_4;
  EFI_REDFISH_MANAGER_V1_2_4_CS *ManagerV1_2_4Cs;
  ...
  Status = Json_Manager_V1_2_4_To_CS (ResoruceRaw, &ManagerV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_2_4 = (EFI_REDFISH_MANAGER_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_2_4));
  if (ManagerV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_2_4;
  ManagerV1_2_4->Manager = ManagerV1_2_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_2_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_2_4_JSON (*((EFI_REDFISH_MANAGER_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_2_4 = (EFI_REDFISH_MANAGER_V1_2_4 *)InterpProp;
  DestroyManager_V1_2_4_CS (ManagerV1_2_4->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_2_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_2_4EntryPoint (
