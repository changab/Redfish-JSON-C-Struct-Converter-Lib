...
//
#include <RedfishInterpreter/LogService/v1_0_5/EfiLogServiceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_5 
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_5 *LogServiceV1_0_5;
  EFI_REDFISH_LOGSERVICE_V1_0_5_CS *LogServiceV1_0_5Cs;
  ...
  Status = Json_LogService_V1_0_5_To_CS (ResoruceRaw, &LogServiceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_5 = (EFI_REDFISH_LOGSERVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_5));
  if (LogServiceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogServiceV1_0_5;
  LogServiceV1_0_5->LogService = LogServiceV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_LOGSERVICE_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogService_V1_0_5_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogServiceV1_0_5 = (EFI_REDFISH_LOGSERVICE_V1_0_5 *)InterpProp;
  DestroyLogService_V1_0_5_CS (LogServiceV1_0_5->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogService_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
