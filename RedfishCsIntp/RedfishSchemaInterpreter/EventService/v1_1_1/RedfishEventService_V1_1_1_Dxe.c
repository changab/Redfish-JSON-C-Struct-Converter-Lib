...
//
#include <RedfishInterpreter/EventService/v1_1_1/EfiEventServiceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_1_1 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_1_1 *EventServiceV1_1_1;
  EFI_REDFISH_EVENTSERVICE_V1_1_1_CS *EventServiceV1_1_1Cs;
  ...
  Status = Json_EventService_V1_1_1_To_CS (ResoruceRaw, &EventServiceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_1_1 = (EFI_REDFISH_EVENTSERVICE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_1_1));
  if (EventServiceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_1_1;
  EventServiceV1_1_1->EventService = EventServiceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventService_V1_1_1_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventServiceV1_1_1 = (EFI_REDFISH_EVENTSERVICE_V1_1_1 *)InterpProp;
  DestroyEventService_V1_1_1_CS (EventServiceV1_1_1->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventService_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
