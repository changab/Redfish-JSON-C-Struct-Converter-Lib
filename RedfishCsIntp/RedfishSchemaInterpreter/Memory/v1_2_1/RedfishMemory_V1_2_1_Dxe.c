...
//
#include <RedfishInterpreter/Memory/v1_2_1/EfiMemoryV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_2_1 
...
{
  EFI_REDFISH_MEMORY_V1_2_1 *MemoryV1_2_1;
  EFI_REDFISH_MEMORY_V1_2_1_CS *MemoryV1_2_1Cs;
  ...
  Status = Json_Memory_V1_2_1_To_CS (ResoruceRaw, &MemoryV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_2_1 = (EFI_REDFISH_MEMORY_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_2_1));
  if (MemoryV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryV1_2_1;
  MemoryV1_2_1->Memory = MemoryV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MEMORY_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Memory_V1_2_1_JSON (*((EFI_REDFISH_MEMORY_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryV1_2_1 = (EFI_REDFISH_MEMORY_V1_2_1 *)InterpProp;
  DestroyMemory_V1_2_1_CS (MemoryV1_2_1->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemory_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_2_1EntryPoint (
