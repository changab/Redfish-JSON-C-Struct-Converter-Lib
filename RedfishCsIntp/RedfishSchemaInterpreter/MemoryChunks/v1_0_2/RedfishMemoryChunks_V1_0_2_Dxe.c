...
//
#include <RedfishInterpreter/MemoryChunks/v1_0_2/EfiMemoryChunksV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#MemoryChunks";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryChunks V1_0_2 
...
{
  EFI_REDFISH_MEMORYCHUNKS_V1_0_2 *MemoryChunksV1_0_2;
  EFI_REDFISH_MEMORYCHUNKS_V1_0_2_CS *MemoryChunksV1_0_2Cs;
  ...
  Status = Json_MemoryChunks_V1_0_2_To_CS (ResoruceRaw, &MemoryChunksV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryChunksV1_0_2 = (EFI_REDFISH_MEMORYCHUNKS_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_0_2));
  if (MemoryChunksV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryChunksV1_0_2;
  MemoryChunksV1_0_2->MemoryChunks = MemoryChunksV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryChunks_V1_0_2_JSON (*((EFI_REDFISH_MEMORYCHUNKS_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryChunksV1_0_2 = (EFI_REDFISH_MEMORYCHUNKS_V1_0_2 *)InterpProp;
  DestroyMemoryChunks_V1_0_2_CS (MemoryChunksV1_0_2->MemoryChunks); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryChunks_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
