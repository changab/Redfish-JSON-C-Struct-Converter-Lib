# Definition of EthernetInterface.V1_3_0 and functions<br><br>

## EthernetInterface_Actions
    typedef struct _RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_CS {
        RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_Oem_CS *Oem;
    } RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_Oem_CS| Structure points to **Oem** property.| No| No


## EthernetInterface_Actions_Oem
...
## EthernetInterface
    typedef struct _RedfishEthernetInterface_V1_3_0_EthernetInterface_CS {
        ...
        RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_CS *Actions;
        ...
        RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_CS *IPv6AddressPolicyTable;
        ...
        RedfishEthernetInterface_V1_3_0_EthernetInterface_Links_CS *Links;
...
|**Actions**|RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_CS| Structure points to **Actions** property.| No| No
...
|**IPv6AddressPolicyTable**|RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_CS| Structure points to **IPv6AddressPolicyTable** property.| No| No
...
|**Links**|RedfishEthernetInterface_V1_3_0_EthernetInterface_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish EthernetInterface V1_3_0 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EthernetInterface V1_3_0 JSON Function
    RedfishCS_status
    CS_To_EthernetInterface_V1_3_0_JSON (RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EthernetInterface V1_3_0 C Structure Function
    RedfishCS_status
