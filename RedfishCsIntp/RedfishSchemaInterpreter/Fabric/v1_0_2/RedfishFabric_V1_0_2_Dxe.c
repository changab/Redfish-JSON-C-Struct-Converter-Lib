...
//
#include <RedfishInterpreter/Fabric/v1_0_2/EfiFabricV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_0_2 
...
{
  EFI_REDFISH_FABRIC_V1_0_2 *FabricV1_0_2;
  EFI_REDFISH_FABRIC_V1_0_2_CS *FabricV1_0_2Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Fabric") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Fabric_V1_0_2_To_CS (ResoruceRaw, &FabricV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_0_2 = (EFI_REDFISH_FABRIC_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_0_2));
  if (FabricV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)FabricV1_0_2;
  FabricV1_0_2->Fabric = FabricV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_FABRIC_V1_0_2_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Fabric"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Fabric");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Fabric"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Fabric");
...
)
{
  ...
  return CS_To_Fabric_V1_0_2_JSON (*((EFI_REDFISH_FABRIC_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in FabricToStruct.
...
)
{
  ...
  FabricV1_0_2 = (EFI_REDFISH_FABRIC_V1_0_2 *)InterpProp;
  DestroyFabric_V1_0_2_CS (FabricV1_0_2->Fabric); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from FabricFromEfiStruct
...
)
{
  ...
  return DestroyFabric_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_0_2EntryPoint (
