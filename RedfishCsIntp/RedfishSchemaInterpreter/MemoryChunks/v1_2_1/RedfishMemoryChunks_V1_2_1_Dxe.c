...
//
#include <RedfishInterpreter/MemoryChunks/v1_2_1/EfiMemoryChunksV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#MemoryChunks";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryChunks V1_2_1 
...
{
  EFI_REDFISH_MEMORYCHUNKS_V1_2_1 *MemoryChunksV1_2_1;
  EFI_REDFISH_MEMORYCHUNKS_V1_2_1_CS *MemoryChunksV1_2_1Cs;
  ...
  Status = Json_MemoryChunks_V1_2_1_To_CS (ResoruceRaw, &MemoryChunksV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryChunksV1_2_1 = (EFI_REDFISH_MEMORYCHUNKS_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_2_1));
  if (MemoryChunksV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryChunksV1_2_1;
  MemoryChunksV1_2_1->MemoryChunks = MemoryChunksV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryChunks_V1_2_1_JSON (*((EFI_REDFISH_MEMORYCHUNKS_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryChunksV1_2_1 = (EFI_REDFISH_MEMORYCHUNKS_V1_2_1 *)InterpProp;
  DestroyMemoryChunks_V1_2_1_CS (MemoryChunksV1_2_1->MemoryChunks); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryChunks_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
