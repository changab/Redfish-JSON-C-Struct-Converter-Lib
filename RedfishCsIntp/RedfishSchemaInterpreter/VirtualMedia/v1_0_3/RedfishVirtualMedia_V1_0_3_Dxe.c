...
//
#include <RedfishInterpreter/VirtualMedia/v1_0_3/EfiVirtualMediaV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_0_3 
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_0_3 *VirtualMediaV1_0_3;
  EFI_REDFISH_VIRTUALMEDIA_V1_0_3_CS *VirtualMediaV1_0_3Cs;
  ...
  Status = Json_VirtualMedia_V1_0_3_To_CS (ResoruceRaw, &VirtualMediaV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_0_3 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_0_3));
  if (VirtualMediaV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VirtualMediaV1_0_3;
  VirtualMediaV1_0_3->VirtualMedia = VirtualMediaV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VirtualMedia_V1_0_3_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VirtualMediaV1_0_3 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_3 *)InterpProp;
  DestroyVirtualMedia_V1_0_3_CS (VirtualMediaV1_0_3->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVirtualMedia_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
