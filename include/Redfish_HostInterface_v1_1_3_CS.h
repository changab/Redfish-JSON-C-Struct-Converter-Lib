...
#ifndef _RedfishHostinterface_V1_1_3_CSTRUCT_H_
#define _RedfishHostinterface_V1_1_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishHostInterface_V1_1_3_Actions_CS RedfishHostInterface_V1_1_3_Actions_CS;
typedef struct _RedfishHostInterface_V1_1_3_HostInterface_CS RedfishHostInterface_V1_1_3_HostInterface_CS;
typedef struct _RedfishHostInterface_V1_1_3_Links_CS RedfishHostInterface_V1_1_3_Links_CS;
typedef struct _RedfishHostInterface_V1_1_3_OemActions_CS RedfishHostInterface_V1_1_3_OemActions_CS;
...
typedef struct _RedfishHostInterface_V1_1_3_Actions_CS {
    RedfishHostInterface_V1_1_3_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishHostInterface_V1_1_3_HostInterface_CS {
    ...
    RedfishHostInterface_V1_1_3_Actions_CS    *Actions;                   // The available actions for this
                                                                          // resource.
    ...
    RedfishCS_char                            *KernelAuthRoleId;          // The Role used for kernel
                                                                          // authentication on this
                                                                          // interface.
    RedfishHostInterface_V1_1_3_Links_CS      *Links;                     // Contains references to other
...
RedfishCS_status
Json_HostInterface_V1_1_3_To_CS (char *JsonRawText, RedfishHostInterface_V1_1_3_HostInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_HostInterface_V1_1_3_JSON (RedfishHostInterface_V1_1_3_HostInterface_CS *CSPtr, char **JsonText);
