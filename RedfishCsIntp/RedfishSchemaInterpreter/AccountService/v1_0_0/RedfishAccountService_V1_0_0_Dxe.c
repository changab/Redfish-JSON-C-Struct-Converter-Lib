...
//
#include <RedfishInterpreter/AccountService/v1_0_0/EfiAccountServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_0_0 
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_0 *AccountServiceV1_0_0;
  ...
  Status = Json_AccountService_V1_0_0_To_CS (ResoruceRaw, &AccountServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_0_0 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_0));
  if (AccountServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AccountServiceV1_0_0;
  AccountServiceV1_0_0->AccountService = AccountServiceV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AccountService_V1_0_0_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AccountServiceV1_0_0 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_0 *)InterpProp;
  DestroyAccountService_V1_0_0_CS (AccountServiceV1_0_0->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAccountService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
