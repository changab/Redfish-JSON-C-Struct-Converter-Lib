...
//
#include <RedfishInterpreter/EthernetInterface/v1_0_0/EfiEthernetInterfaceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_0 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_0 *EthernetInterfaceV1_0_0;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_0_CS *EthernetInterfaceV1_0_0Cs;
  ...
  Status = Json_EthernetInterface_V1_0_0_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_0 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_0));
  if (EthernetInterfaceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_0_0;
  EthernetInterfaceV1_0_0->EthernetInterface = EthernetInterfaceV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EthernetInterface_V1_0_0_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EthernetInterfaceV1_0_0 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_0 *)InterpProp;
  DestroyEthernetInterface_V1_0_0_CS (EthernetInterfaceV1_0_0->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEthernetInterface_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
