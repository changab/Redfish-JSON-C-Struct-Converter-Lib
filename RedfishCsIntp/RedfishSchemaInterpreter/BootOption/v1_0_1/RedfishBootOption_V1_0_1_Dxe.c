...
//
#include <RedfishInterpreter/BootOption/v1_0_1/EfiBootOptionV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#BootOption";
BOOLEAN IsRevisonController = TRUE;

// Support BootOption V1_0_1 
...
{
  EFI_REDFISH_BOOTOPTION_V1_0_1 *BootOptionV1_0_1;
  EFI_REDFISH_BOOTOPTION_V1_0_1_CS *BootOptionV1_0_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "BootOption") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_BootOption_V1_0_1_To_CS (ResoruceRaw, &BootOptionV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BootOptionV1_0_1 = (EFI_REDFISH_BOOTOPTION_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BOOTOPTION_V1_0_1));
  if (BootOptionV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)BootOptionV1_0_1;
  BootOptionV1_0_1->BootOption = BootOptionV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_BOOTOPTION_V1_0_1_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("BootOption"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "BootOption");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("BootOption"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "BootOption");
...
)
{
  ...
  return CS_To_BootOption_V1_0_1_JSON (*((EFI_REDFISH_BOOTOPTION_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in BootOptionToStruct.
...
)
{
  ...
  BootOptionV1_0_1 = (EFI_REDFISH_BOOTOPTION_V1_0_1 *)InterpProp;
  DestroyBootOption_V1_0_1_CS (BootOptionV1_0_1->BootOption); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from BootOptionFromEfiStruct
...
)
{
  ...
  return DestroyBootOption_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishBootOption_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishBootOption_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
