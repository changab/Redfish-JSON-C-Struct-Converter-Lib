...
#ifndef _RedfishEventdestination_V1_3_1_CSTRUCT_H_
#define _RedfishEventdestination_V1_3_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEventDestination_V1_3_1_HttpHeaderProperty_Array_CS RedfishEventDestination_V1_3_1_HttpHeaderProperty_Array_CS;
...
#endif
typedef struct _RedfishEventDestination_V1_3_1_Actions_CS RedfishEventDestination_V1_3_1_Actions_CS;
typedef struct _RedfishEventDestination_V1_3_1_EventDestination_CS RedfishEventDestination_V1_3_1_EventDestination_CS;
typedef struct _RedfishEventDestination_V1_3_1_HttpHeaderProperty_CS RedfishEventDestination_V1_3_1_HttpHeaderProperty_CS;
typedef struct _RedfishEventDestination_V1_3_1_OemActions_CS RedfishEventDestination_V1_3_1_OemActions_CS;
...
typedef struct _RedfishEventDestination_V1_3_1_Actions_CS {
    RedfishEventDestination_V1_3_1_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishEventDestination_V1_3_1_EventDestination_CS {
    ...
    RedfishEventDestination_V1_3_1_Actions_CS                     *Actions;                      // The available actions for this
                                                                                                 // resource.
    ...
    RedfishEventDestination_V1_3_1_HttpHeaderProperty_Array_CS    *HttpHeaders;                  // This is for setting HTTP
...
typedef struct _RedfishEventDestination_V1_3_1_HttpHeaderProperty_Array_CS  {
    RedfishEventDestination_V1_3_1_HttpHeaderProperty_Array_CS    *Next;
    RedfishEventDestination_V1_3_1_HttpHeaderProperty_CS    *ArrayValue;
} RedfishEventDestination_V1_3_1_HttpHeaderProperty_Array_CS;
...
RedfishCS_status
Json_EventDestination_V1_3_1_To_CS (char *JsonRawText, RedfishEventDestination_V1_3_1_EventDestination_CS **ReturnedCS);

RedfishCS_status
CS_To_EventDestination_V1_3_1_JSON (RedfishEventDestination_V1_3_1_EventDestination_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventDestination_V1_3_1_CS (RedfishEventDestination_V1_3_1_EventDestination_CS *CSPtr);

RedfishCS_status
DestroyEventDestination_V1_3_1_Json (RedfishCS_char *JsonText);
