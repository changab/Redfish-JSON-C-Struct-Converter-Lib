...
//
#include <RedfishInterpreter/Memory/v1_2_2/EfiMemoryV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_2_2 
...
{
  EFI_REDFISH_MEMORY_V1_2_2 *MemoryV1_2_2;
  EFI_REDFISH_MEMORY_V1_2_2_CS *MemoryV1_2_2Cs;
  ...
  Status = Json_Memory_V1_2_2_To_CS (ResoruceRaw, &MemoryV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_2_2 = (EFI_REDFISH_MEMORY_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_2_2));
  if (MemoryV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryV1_2_2;
  MemoryV1_2_2->Memory = MemoryV1_2_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MEMORY_V1_2_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Memory_V1_2_2_JSON (*((EFI_REDFISH_MEMORY_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryV1_2_2 = (EFI_REDFISH_MEMORY_V1_2_2 *)InterpProp;
  DestroyMemory_V1_2_2_CS (MemoryV1_2_2->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemory_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_2_2EntryPoint (
