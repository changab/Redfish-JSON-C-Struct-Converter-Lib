...
#ifndef _RedfishPort_V1_0_2_CSTRUCT_H_
#define _RedfishPort_V1_0_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPort_V1_0_2_Port_CS RedfishPort_V1_0_2_Port_CS;
typedef struct _RedfishPort_V1_0_2_Port_Actions_CS RedfishPort_V1_0_2_Port_Actions_CS;
typedef struct _RedfishPort_V1_0_2_Port_Actions_Oem_CS RedfishPort_V1_0_2_Port_Actions_Oem_CS;
typedef struct _RedfishPort_V1_0_2_Port_Links_CS RedfishPort_V1_0_2_Port_Links_CS;
typedef struct _RedfishPort_V1_0_2_Reset_CS RedfishPort_V1_0_2_Reset_CS;
...
typedef struct _RedfishPort_V1_0_2_Port_Actions_CS {
    ...
    RedfishPort_V1_0_2_Port_Actions_Oem_CS    *Oem;          // The available OEM specific
...
typedef struct _RedfishPort_V1_0_2_Port_CS {
    ...
    RedfishPort_V1_0_2_Port_Actions_CS    *Actions;            // The available actions for this
                                                               // resource.
    RedfishCS_int64                       *CurrentSpeedGbps;    // The current speed of this
                                                               // port.
    RedfishCS_char                        *Description;    
    RedfishCS_char                        *Id;             
    RedfishPort_V1_0_2_Port_Links_CS      *Links;              // Contains references to other
...
RedfishCS_status
Json_Port_V1_0_2_To_CS (char *JsonRawText, RedfishPort_V1_0_2_Port_CS **ReturnedCS);

RedfishCS_status
CS_To_Port_V1_0_2_JSON (RedfishPort_V1_0_2_Port_CS *CSPtr, char **JsonText);
