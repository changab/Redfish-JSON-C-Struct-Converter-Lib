...
//
#include <RedfishInterpreter/ActionInfo/v1_0_4/EfiActionInfoV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_0_4 
...
{
  EFI_REDFISH_ACTIONINFO_V1_0_4 *ActionInfoV1_0_4;
  EFI_REDFISH_ACTIONINFO_V1_0_4_CS *ActionInfoV1_0_4Cs;
  ...
  Status = Json_ActionInfo_V1_0_4_To_CS (ResoruceRaw, &ActionInfoV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_0_4 = (EFI_REDFISH_ACTIONINFO_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_0_4));
  if (ActionInfoV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ActionInfoV1_0_4;
  ActionInfoV1_0_4->ActionInfo = ActionInfoV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_ACTIONINFO_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ActionInfo_V1_0_4_JSON (*((EFI_REDFISH_ACTIONINFO_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ActionInfoV1_0_4 = (EFI_REDFISH_ACTIONINFO_V1_0_4 *)InterpProp;
  DestroyActionInfo_V1_0_4_CS (ActionInfoV1_0_4->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyActionInfo_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
