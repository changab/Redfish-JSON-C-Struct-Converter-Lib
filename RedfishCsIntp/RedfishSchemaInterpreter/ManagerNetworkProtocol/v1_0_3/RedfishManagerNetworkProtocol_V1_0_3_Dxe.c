...
//
#include <RedfishInterpreter/ManagerNetworkProtocol/v1_0_3/EfiManagerNetworkProtocolV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_0_3 
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_3 *ManagerNetworkProtocolV1_0_3;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_3_CS *ManagerNetworkProtocolV1_0_3Cs;
  ...
  Status = Json_ManagerNetworkProtocol_V1_0_3_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_0_3 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_3));
  if (ManagerNetworkProtocolV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerNetworkProtocolV1_0_3;
  ManagerNetworkProtocolV1_0_3->ManagerNetworkProtocol = ManagerNetworkProtocolV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerNetworkProtocol_V1_0_3_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerNetworkProtocolV1_0_3 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_3 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_0_3_CS (ManagerNetworkProtocolV1_0_3->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerNetworkProtocol_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
