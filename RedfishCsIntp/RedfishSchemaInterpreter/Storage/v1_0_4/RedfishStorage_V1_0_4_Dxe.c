...
//
#include <RedfishInterpreter/Storage/v1_0_4/EfiStorageV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_0_4 
...
{
  EFI_REDFISH_STORAGE_V1_0_4 *StorageV1_0_4;
  EFI_REDFISH_STORAGE_V1_0_4_CS *StorageV1_0_4Cs;
  ...
  Status = Json_Storage_V1_0_4_To_CS (ResoruceRaw, &StorageV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_0_4 = (EFI_REDFISH_STORAGE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_0_4));
  if (StorageV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_0_4;
  StorageV1_0_4->Storage = StorageV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_0_4_JSON (*((EFI_REDFISH_STORAGE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_0_4 = (EFI_REDFISH_STORAGE_V1_0_4 *)InterpProp;
  DestroyStorage_V1_0_4_CS (StorageV1_0_4->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_0_4EntryPoint (
