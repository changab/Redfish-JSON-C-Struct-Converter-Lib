...
#include"Redfish_TaskService_v1_1_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishTaskService_V1_1_2_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishTaskService_V1_1_2_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishTaskService_V1_1_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTaskService_V1_1_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishTaskService_V1_1_2_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishTaskService_V1_1_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTaskService_V1_1_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenStatusCs(RedfishTaskService_V1_1_2_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishTaskService_V1_1_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishTaskService_V1_1_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for TaskService.V1_1_2.TaskService
//
RedfishCS_status CS_To_TaskService_V1_1_2_JSON(RedfishTaskService_V1_1_2_TaskService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for TaskService.V1_1_2.TaskService
//
RedfishCS_status DestroyTaskService_V1_1_2_CS(RedfishTaskService_V1_1_2_TaskService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for TaskService.V1_1_2.TaskService
//
RedfishCS_status DestroyTaskService_V1_1_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for TaskService.V1_1_2.TaskService
//
RedfishCS_status
Json_TaskService_V1_1_2_To_CS(RedfishCS_char *JsonRawText, RedfishTaskService_V1_1_2_TaskService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTaskService_V1_1_2_TaskService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "TaskService", "v1_1_2", "TaskService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTaskService_V1_1_2_TaskService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyTaskService_V1_1_2_CS (Cs);
  return Status;
}
