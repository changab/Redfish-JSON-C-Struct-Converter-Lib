...
//
#include <RedfishInterpreter/Bios/v1_0_2/EfiBiosV1_0_2.h>
...
{
  EFI_REDFISH_BIOS_V1_0_2 *BiosV1_0_2;
  EFI_REDFISH_BIOS_V1_0_2_CS *BiosV1_0_2Cs;
  ...
  Status = Json_Bios_V1_0_2_To_CS (ResoruceRaw, &BiosV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_0_2 = (EFI_REDFISH_BIOS_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_0_2));
  if (BiosV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)BiosV1_0_2;
  BiosV1_0_2->Bios = BiosV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_BIOS_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Bios_V1_0_2_JSON (*((EFI_REDFISH_BIOS_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  BiosV1_0_2 = (EFI_REDFISH_BIOS_V1_0_2 *)InterpProp;
  DestroyBios_V1_0_2_CS (BiosV1_0_2->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyBios_V1_0_2_Json (ResoruceRaw);
}
