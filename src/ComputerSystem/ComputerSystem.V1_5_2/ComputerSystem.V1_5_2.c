...
#include"Redfish_ComputerSystem_v1_5_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenidRef_ArrayCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, Redfishodata_V4_0_3_idRef_Array_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
//
//Generate C structure for #ComputerSystem.Reset
//
static RedfishCS_status GenResetCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_Reset_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for #ComputerSystem.SetDefaultBootOrder
//
static RedfishCS_status GenSetDefaultBootOrderCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_SetDefaultBootOrder_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_SetDefaultBootOrder_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  ...
  Status = GenSetDefaultBootOrderCs (Cs, TempJsonObj, "#ComputerSystem.SetDefaultBootOrder", &(*Dst)->ComputerSystem_SetDefaultBootOrder);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenBootCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_Boot_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_Boot_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BootNext
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "BootNext", &(*Dst)->BootNext);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // BootOptions
  InitializeLinkHead (&(*Dst)->BootOptions);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "BootOptions", Cs->Header.ThisUri, &(*Dst)->BootOptions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // BootOrder
  Status = GenRedfishCS_char_ArrayCs (Cs, TempJsonObj, "BootOrder", &(*Dst)->BootOrder);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for HostWatchdogTimer
//
static RedfishCS_status GenWatchdogTimerCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_WatchdogTimer_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_WatchdogTimer_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // FunctionEnabled
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "FunctionEnabled", &(*Dst)->FunctionEnabled);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // TimeoutAction
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "TimeoutAction", &(*Dst)->TimeoutAction);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // WarningAction
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "WarningAction", &(*Dst)->WarningAction);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenHostedServicesCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_HostedServices_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_HostedServices_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodata_V4_0_3_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(Redfishodata_V4_0_3_idRef_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for Redfishodata_V4_0_3_idRef_Array_CS
//
static RedfishCS_status GenidRef_ArrayCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, Redfishodata_V4_0_3_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  ...
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  Redfishodata_V4_0_3_idRef_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (Redfishodata_V4_0_3_idRef_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenLinksCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
  ...
  InitializeLinkHead (&(*Dst)->ConsumingComputerSystems);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "ConsumingComputerSystems", Cs->Header.ThisUri, &(*Dst)->ConsumingComputerSystems);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ConsumingComputerSystems@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "ConsumingComputerSystems@odata.count", &(*Dst)->ConsumingComputerSystemsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  InitializeLinkHead (&(*Dst)->SupplyingComputerSystems);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "SupplyingComputerSystems", Cs->Header.ThisUri, &(*Dst)->SupplyingComputerSystems);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SupplyingComputerSystems@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "SupplyingComputerSystems@odata.count", &(*Dst)->SupplyingComputerSystemsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenMemorySummaryCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_MemorySummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_MemorySummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MemoryMirroring
  ...
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "TotalSystemPersistentMemoryGiB", &(*Dst)->TotalSystemPersistentMemoryGiB);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenProcessorSummaryCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_ProcessorSummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_ProcessorSummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Count
  ...
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "LogicalProcessorCount", &(*Dst)->LogicalProcessorCount);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenTrustedModules_Array_ElementCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishComputerSystem_V1_5_2_TrustedModules_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishComputerSystem_V1_5_2_TrustedModules_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // FirmwareVersion
...
//
//Generate C structure for RedfishComputerSystem_V1_5_2_TrustedModules_Array_CS
//
static RedfishCS_status GenTrustedModules_ArrayCs(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_5_2_TrustedModules_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishComputerSystem_V1_5_2_TrustedModules_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishComputerSystem_V1_5_2_TrustedModules_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsComputerSystem_Reset(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsComputerSystem_SetDefaultBootOrder(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_SetDefaultBootOrder_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #ComputerSystem.SetDefaultBootOrder
  if (CS_To_JSON_ActionsComputerSystem_SetDefaultBootOrder(CsJson, "#ComputerSystem.SetDefaultBootOrder", CSPtr->ComputerSystem_SetDefaultBootOrder) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Boot(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_Boot_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // BootNext 
  if (InsertJsonStringObj (CsJson, "BootNext", CSPtr->BootNext) != RedfishCS_status_success) {goto Error;}

  // BootOptions 
  if (InsertJsonLinkObj (CsJson, "BootOptions", &CSPtr->BootOptions) != RedfishCS_status_success) {goto Error;}

  // BootOrder 
  if (InsertJsonStringArrayObj (CsJson, "BootOrder", CSPtr->BootOrder) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_HostWatchdogTimerOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HostWatchdogTimerStatusOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HostWatchdogTimerStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // Oem
  if (CS_To_JSON_HostWatchdogTimerStatusOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_HostWatchdogTimer(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_WatchdogTimer_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // FunctionEnabled 
  if (InsertJsonBoolObj (CsJson, "FunctionEnabled", CSPtr->FunctionEnabled) != RedfishCS_status_success) {goto Error;}

  // Oem
  if (CS_To_JSON_HostWatchdogTimerOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}

  // Status
  if (CS_To_JSON_HostWatchdogTimerStatus(CsJson, "Status", CSPtr->Status) != RedfishCS_status_success) {goto Error;}

  // TimeoutAction 
  if (InsertJsonStringObj (CsJson, "TimeoutAction", CSPtr->TimeoutAction) != RedfishCS_status_success) {goto Error;}

  // WarningAction 
  if (InsertJsonStringObj (CsJson, "WarningAction", CSPtr->WarningAction) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_HostedServices(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_HostedServices_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LinksCooledBy(json_t *CsJson, char *Key, Redfishodata_V4_0_3_idRef_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  Redfishodata_V4_0_3_idRef_Array_CS *NextArray;
  Redfishodata_V4_0_3_idRef_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_LinksPoweredBy(json_t *CsJson, char *Key, Redfishodata_V4_0_3_idRef_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  Redfishodata_V4_0_3_idRef_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // ConsumingComputerSystems 
  if (InsertJsonLinkArrayObj (CsJson, "ConsumingComputerSystems", &CSPtr->ConsumingComputerSystems) != RedfishCS_status_success) {goto Error;}

  // ConsumingComputerSystems@odata.count 
  if (InsertJsonInt64Obj (CsJson, "ConsumingComputerSystems@odata.count", CSPtr->ConsumingComputerSystemsodata_count) != RedfishCS_status_success) {goto Error;}
  ...
  // SupplyingComputerSystems 
  if (InsertJsonLinkArrayObj (CsJson, "SupplyingComputerSystems", &CSPtr->SupplyingComputerSystems) != RedfishCS_status_success) {goto Error;}

  // SupplyingComputerSystems@odata.count 
  if (InsertJsonInt64Obj (CsJson, "SupplyingComputerSystems@odata.count", CSPtr->SupplyingComputerSystemsodata_count) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_MemorySummaryStatusOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_MemorySummaryStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  ...
  // Oem
  if (CS_To_JSON_MemorySummaryStatusOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_MemorySummary(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_MemorySummary_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // TotalSystemPersistentMemoryGiB 
  if (InsertJsonInt64Obj (CsJson, "TotalSystemPersistentMemoryGiB", CSPtr->TotalSystemPersistentMemoryGiB) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_ProcessorSummaryStatusOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ProcessorSummaryStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  ...
  // Oem
  if (CS_To_JSON_ProcessorSummaryStatusOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_ProcessorSummary(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_ProcessorSummary_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // LogicalProcessorCount 
  if (InsertJsonInt64Obj (CsJson, "LogicalProcessorCount", CSPtr->LogicalProcessorCount) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_TrustedModulesStatusOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_TrustedModulesStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  ...
  // Oem
  if (CS_To_JSON_TrustedModulesStatusOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_TrustedModules(json_t *CsJson, char *Key, RedfishComputerSystem_V1_5_2_TrustedModules_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishComputerSystem_V1_5_2_TrustedModules_Array_CS *NextArray;
  RedfishComputerSystem_V1_5_2_TrustedModules_CS *NextArrayItem;
...
//
// C structure to JSON for ComputerSystem.V1_5_2.ComputerSystem
//
RedfishCS_status CS_To_ComputerSystem_V1_5_2_JSON(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // HostWatchdogTimer
  if (CS_To_JSON_HostWatchdogTimer(CsJson, "HostWatchdogTimer", CSPtr->HostWatchdogTimer) != RedfishCS_status_success) {goto Error;}
  ...
  // SubModel 
  if (InsertJsonStringObj (CsJson, "SubModel", CSPtr->SubModel) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for ComputerSystem.V1_5_2.ComputerSystem
//
RedfishCS_status DestroyComputerSystem_V1_5_2_CS(RedfishComputerSystem_V1_5_2_ComputerSystem_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ComputerSystem.V1_5_2.ComputerSystem
//
RedfishCS_status DestroyComputerSystem_V1_5_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ComputerSystem.V1_5_2.ComputerSystem
//
RedfishCS_status
Json_ComputerSystem_V1_5_2_To_CS(RedfishCS_char *JsonRawText, RedfishComputerSystem_V1_5_2_ComputerSystem_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishComputerSystem_V1_5_2_ComputerSystem_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ComputerSystem", "v1_5_2", "ComputerSystem", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishComputerSystem_V1_5_2_ComputerSystem_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // HostWatchdogTimer
  Status = GenWatchdogTimerCs (Cs, JsonObj, "HostWatchdogTimer", &Cs->HostWatchdogTimer);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SubModel
  Status = GetRedfishPropertyStr (Cs, JsonObj, "SubModel", &Cs->SubModel);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyComputerSystem_V1_5_2_CS (Cs);
  return Status;
}
