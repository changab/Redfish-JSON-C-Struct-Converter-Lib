...
//
#include <RedfishInterpreter/EventDestination/v1_2_3/EfiEventDestinationV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_2_3 
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_2_3 *EventDestinationV1_2_3;
  EFI_REDFISH_EVENTDESTINATION_V1_2_3_CS *EventDestinationV1_2_3Cs;
  ...
  Status = Json_EventDestination_V1_2_3_To_CS (ResoruceRaw, &EventDestinationV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_2_3 = (EFI_REDFISH_EVENTDESTINATION_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_2_3));
  if (EventDestinationV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventDestinationV1_2_3;
  EventDestinationV1_2_3->EventDestination = EventDestinationV1_2_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_EVENTDESTINATION_V1_2_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventDestination_V1_2_3_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventDestinationV1_2_3 = (EFI_REDFISH_EVENTDESTINATION_V1_2_3 *)InterpProp;
  DestroyEventDestination_V1_2_3_CS (EventDestinationV1_2_3->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventDestination_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_2_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_2_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
