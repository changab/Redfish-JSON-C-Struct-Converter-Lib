...
#include"Redfish_Drive_v1_1_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Drive.SecureErase
//
static RedfishCS_status GenSecureEraseCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_1_1_SecureErase_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_1_1_SecureErase_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActions_OemCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_1_1_Drive_Actions_Oem_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_1_1_Drive_Actions_Oem_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_1_1_Drive_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_1_1_Drive_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Drive.SecureErase
  Status = GenSecureEraseCs (Cs, TempJsonObj, "#Drive.SecureErase", &(*Dst)->Drive_SecureErase);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenIdentifier_Array_ElementCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_V1_1_0_Identifier_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenIdentifier_ArrayCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_V1_1_0_Identifier_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenLinksCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_1_1_Drive_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_1_1_Drive_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
  ...
  // Volumes
  InitializeLinkHead (&(*Dst)->Volumes);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "Volumes", Cs->Header.ThisUri, &(*Dst)->Volumes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Volumes@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "Volumes@odata.count", &(*Dst)->Volumesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Volumes@odata.navigationLink
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "Volumes@odata.navigationLink", &(*Dst)->Volumesodata_navigationLink);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenLocation_Array_ElementCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_V1_1_0_Location_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishResource_V1_1_0_Location_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Info
...
//
//Generate C structure for RedfishResource_V1_1_0_Location_Array_CS
//
static RedfishCS_status GenLocation_ArrayCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_V1_1_0_Location_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishResource_V1_1_0_Location_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishResource_V1_1_0_Location_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenOperations_Array_ElementCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishVolume_V1_0_0_Operations_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishVolume_V1_0_0_Operations_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AssociatedTask
  InitializeLinkHead (&(*Dst)->AssociatedTask);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "AssociatedTask", Cs->Header.ThisUri, &(*Dst)->AssociatedTask);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishVolume_V1_0_0_Operations_Array_CS
//
static RedfishCS_status GenOperations_ArrayCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_0_Operations_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishVolume_V1_0_0_Operations_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishVolume_V1_0_0_Operations_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenOperations_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
//
static RedfishCS_status GenStatusCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsDrive_SecureErase(json_t *CsJson, char *Key, RedfishDrive_V1_1_1_SecureErase_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishDrive_V1_1_1_Drive_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishDrive_V1_1_1_Drive_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // #Drive.SecureErase
  if (CS_To_JSON_ActionsDrive_SecureErase(CsJson, "#Drive.SecureErase", CSPtr->Drive_SecureErase) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Identifiers(json_t *CsJson, char *Key, RedfishResource_V1_1_0_Identifier_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishResource_V1_1_0_Identifier_Array_CS *NextArray;
  RedfishResource_V1_1_0_Identifier_CS *NextArrayItem;
  ...
  do {
    ...
    // DurableName 
    if (InsertJsonStringObj (ArrayMember, "DurableName", NextArrayItem->DurableName) != RedfishCS_status_success) {goto Error;}

    // DurableNameFormat 
    if (InsertJsonStringObj (ArrayMember, "DurableNameFormat", NextArrayItem->DurableNameFormat) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishDrive_V1_1_1_Drive_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // Volumes 
  if (InsertJsonLinkArrayObj (CsJson, "Volumes", &CSPtr->Volumes) != RedfishCS_status_success) {goto Error;}

  // Volumes@odata.count 
  if (InsertJsonInt64Obj (CsJson, "Volumes@odata.count", CSPtr->Volumesodata_count) != RedfishCS_status_success) {goto Error;}

  // Volumes@odata.navigationLink 
  if (InsertJsonStringObj (CsJson, "Volumes@odata.navigationLink", CSPtr->Volumesodata_navigationLink) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_LocationOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Location(json_t *CsJson, char *Key, RedfishResource_V1_1_0_Location_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishResource_V1_1_0_Location_Array_CS *NextArray;
  RedfishResource_V1_1_0_Location_CS *NextArrayItem;
  ...
  do {
    ...
    NextArrayItem = NextArray->ArrayValue;
    // Info 
    if (InsertJsonStringObj (ArrayMember, "Info", NextArrayItem->Info) != RedfishCS_status_success) {goto Error;}

    // InfoFormat 
    if (InsertJsonStringObj (ArrayMember, "InfoFormat", NextArrayItem->InfoFormat) != RedfishCS_status_success) {goto Error;}

    // Oem
    if (CS_To_JSON_LocationOem(ArrayMember, "Oem", NextArrayItem->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Operations(json_t *CsJson, char *Key, RedfishVolume_V1_0_0_Operations_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishVolume_V1_0_0_Operations_Array_CS *NextArray;
  RedfishVolume_V1_0_0_Operations_CS *NextArrayItem;
  ...
  do {
    ...
    NextArrayItem = NextArray->ArrayValue;
    // AssociatedTask 
    if (InsertJsonLinkObj (ArrayMember, "AssociatedTask", &NextArrayItem->AssociatedTask) != RedfishCS_status_success) {goto Error;}

    // OperationName 
    if (InsertJsonStringObj (ArrayMember, "OperationName", NextArrayItem->OperationName) != RedfishCS_status_success) {goto Error;}

    // PercentageComplete 
    if (InsertJsonInt64Obj (ArrayMember, "PercentageComplete", NextArrayItem->PercentageComplete) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Drive.V1_1_1.Drive
//
RedfishCS_status CS_To_Drive_V1_1_1_JSON(RedfishDrive_V1_1_1_Drive_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // CapableSpeedGbs 
  if (InsertJsonInt64Obj (CsJson, "CapableSpeedGbs", CSPtr->CapableSpeedGbs) != RedfishCS_status_success) {goto Error;}
  ...
  // EncryptionAbility 
  if (InsertJsonStringObj (CsJson, "EncryptionAbility", CSPtr->EncryptionAbility) != RedfishCS_status_success) {goto Error;}

  // EncryptionStatus 
  if (InsertJsonStringObj (CsJson, "EncryptionStatus", CSPtr->EncryptionStatus) != RedfishCS_status_success) {goto Error;}

  // FailurePredicted 
  if (InsertJsonBoolObj (CsJson, "FailurePredicted", CSPtr->FailurePredicted) != RedfishCS_status_success) {goto Error;}

  // HotspareType 
  if (InsertJsonStringObj (CsJson, "HotspareType", CSPtr->HotspareType) != RedfishCS_status_success) {goto Error;}
  ...
  // MediaType 
  if (InsertJsonStringObj (CsJson, "MediaType", CSPtr->MediaType) != RedfishCS_status_success) {goto Error;}
  ...
  // NegotiatedSpeedGbs 
  if (InsertJsonInt64Obj (CsJson, "NegotiatedSpeedGbs", CSPtr->NegotiatedSpeedGbs) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonInt64Obj (CsJson, "PredictedMediaLifeLeftPercent", CSPtr->PredictedMediaLifeLeftPercent) != RedfishCS_status_success) {goto Error;}

  // Protocol 
  if (InsertJsonStringObj (CsJson, "Protocol", CSPtr->Protocol) != RedfishCS_status_success) {goto Error;}

  // Revision 
  if (InsertJsonStringObj (CsJson, "Revision", CSPtr->Revision) != RedfishCS_status_success) {goto Error;}

  // RotationSpeedRPM 
  if (InsertJsonInt64Obj (CsJson, "RotationSpeedRPM", CSPtr->RotationSpeedRPM) != RedfishCS_status_success) {goto Error;}
  ...
  // StatusIndicator 
  if (InsertJsonStringObj (CsJson, "StatusIndicator", CSPtr->StatusIndicator) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Drive.V1_1_1.Drive
//
RedfishCS_status DestroyDrive_V1_1_1_CS(RedfishDrive_V1_1_1_Drive_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Drive.V1_1_1.Drive
//
RedfishCS_status DestroyDrive_V1_1_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Drive.V1_1_1.Drive
//
RedfishCS_status
Json_Drive_V1_1_1_To_CS(RedfishCS_char *JsonRawText, RedfishDrive_V1_1_1_Drive_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishDrive_V1_1_1_Drive_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Drive", "v1_1_1", "Drive", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishDrive_V1_1_1_Drive_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // CapableSpeedGbs
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "CapableSpeedGbs", &Cs->CapableSpeedGbs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // EncryptionAbility
  Status = GetRedfishPropertyStr (Cs, JsonObj, "EncryptionAbility", &Cs->EncryptionAbility);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EncryptionStatus
  Status = GetRedfishPropertyStr (Cs, JsonObj, "EncryptionStatus", &Cs->EncryptionStatus);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // FailurePredicted
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "FailurePredicted", &Cs->FailurePredicted);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // HotspareType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "HotspareType", &Cs->HotspareType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MediaType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "MediaType", &Cs->MediaType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // NegotiatedSpeedGbs
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "NegotiatedSpeedGbs", &Cs->NegotiatedSpeedGbs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Operations
  Status = GenOperations_ArrayCs (Cs, JsonObj, "Operations", &Cs->Operations);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PredictedMediaLifeLeftPercent
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "PredictedMediaLifeLeftPercent", &Cs->PredictedMediaLifeLeftPercent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Protocol
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Protocol", &Cs->Protocol);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Revision
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Revision", &Cs->Revision);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RotationSpeedRPM
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "RotationSpeedRPM", &Cs->RotationSpeedRPM);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // StatusIndicator
  Status = GetRedfishPropertyStr (Cs, JsonObj, "StatusIndicator", &Cs->StatusIndicator);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
