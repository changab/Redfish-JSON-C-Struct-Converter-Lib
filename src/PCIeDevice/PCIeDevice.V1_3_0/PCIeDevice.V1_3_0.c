...
#include"Redfish_PCIeDevice_v1_3_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeDevice_V1_3_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeDevice_V1_3_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeDevice_V1_3_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeDevice_V1_3_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeDevice_V1_3_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeDevice_V1_3_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
//Generate C structure for PCIeInterface
//
static RedfishCS_status GenPCIeInterfaceCs(RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeDevice_V1_3_0_PCIeInterface_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeDevice_V1_3_0_PCIeInterface_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LanesInUse
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "LanesInUse", &(*Dst)->LanesInUse);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MaxPCIeType
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "MaxPCIeType", &(*Dst)->MaxPCIeType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenStatusCs(RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPCIeDevice_V1_3_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPCIeDevice_V1_3_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPCIeDevice_V1_3_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PCIeInterfaceOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PCIeInterface(json_t *CsJson, char *Key, RedfishPCIeDevice_V1_3_0_PCIeInterface_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // LanesInUse 
  if (InsertJsonInt64Obj (CsJson, "LanesInUse", CSPtr->LanesInUse) != RedfishCS_status_success) {goto Error;}

  // MaxLanes 
  if (InsertJsonInt64Obj (CsJson, "MaxLanes", CSPtr->MaxLanes) != RedfishCS_status_success) {goto Error;}

  // MaxPCIeType 
  if (InsertJsonStringObj (CsJson, "MaxPCIeType", CSPtr->MaxPCIeType) != RedfishCS_status_success) {goto Error;}

  // Oem
  if (CS_To_JSON_PCIeInterfaceOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}

  // PCIeType 
  if (InsertJsonStringObj (CsJson, "PCIeType", CSPtr->PCIeType) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for PCIeDevice.V1_3_0.PCIeDevice
//
RedfishCS_status CS_To_PCIeDevice_V1_3_0_JSON(RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // DeviceType 
  if (InsertJsonStringObj (CsJson, "DeviceType", CSPtr->DeviceType) != RedfishCS_status_success) {goto Error;}
  ...
  // PCIeInterface
  if (CS_To_JSON_PCIeInterface(CsJson, "PCIeInterface", CSPtr->PCIeInterface) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for PCIeDevice.V1_3_0.PCIeDevice
//
RedfishCS_status DestroyPCIeDevice_V1_3_0_CS(RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PCIeDevice.V1_3_0.PCIeDevice
//
RedfishCS_status DestroyPCIeDevice_V1_3_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PCIeDevice.V1_3_0.PCIeDevice
//
RedfishCS_status
Json_PCIeDevice_V1_3_0_To_CS(RedfishCS_char *JsonRawText, RedfishPCIeDevice_V1_3_0_PCIeDevice_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPCIeDevice_V1_3_0_PCIeDevice_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PCIeDevice", "v1_3_0", "PCIeDevice", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPCIeDevice_V1_3_0_PCIeDevice_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // DeviceType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "DeviceType", &Cs->DeviceType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PCIeInterface
  Status = GenPCIeInterfaceCs (Cs, JsonObj, "PCIeInterface", &Cs->PCIeInterface);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyPCIeDevice_V1_3_0_CS (Cs);
  return Status;
}
