...
#ifndef _RedfishBios_V1_0_5_CSTRUCT_H_
#define _RedfishBios_V1_0_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishBios_V1_0_5_Actions_CS RedfishBios_V1_0_5_Actions_CS;
typedef struct _RedfishBios_V1_0_5_Attributes_CS RedfishBios_V1_0_5_Attributes_CS;
typedef struct _RedfishBios_V1_0_5_Bios_CS RedfishBios_V1_0_5_Bios_CS;
typedef struct _RedfishBios_V1_0_5_ChangePassword_CS RedfishBios_V1_0_5_ChangePassword_CS;
typedef struct _RedfishBios_V1_0_5_OemActions_CS RedfishBios_V1_0_5_OemActions_CS;
typedef struct _RedfishBios_V1_0_5_ResetBios_CS RedfishBios_V1_0_5_ResetBios_CS;
...
typedef struct _RedfishBios_V1_0_5_Actions_CS {
    ...
    RedfishBios_V1_0_5_OemActions_CS        *Oem;                   // This property contains the
...
typedef struct _RedfishBios_V1_0_5_Bios_CS {
    ...
    RedfishBios_V1_0_5_Actions_CS       *Actions;             // The available actions for this
                                                              // resource.
    RedfishCS_char                      *AttributeRegistry;    // The Resource ID of the
                                                              ...
                                                              // resource.
    RedfishBios_V1_0_5_Attributes_CS    *Attributes;          // The list of BIOS attributes
...
RedfishCS_status
Json_Bios_V1_0_5_To_CS (char *JsonRawText, RedfishBios_V1_0_5_Bios_CS **ReturnedCS);

RedfishCS_status
CS_To_Bios_V1_0_5_JSON (RedfishBios_V1_0_5_Bios_CS *CSPtr, char **JsonText);
