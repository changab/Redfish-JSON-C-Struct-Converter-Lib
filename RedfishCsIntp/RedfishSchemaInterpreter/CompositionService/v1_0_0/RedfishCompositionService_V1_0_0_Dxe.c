...
//
#include <RedfishInterpreter/CompositionService/v1_0_0/EfiCompositionServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#CompositionService";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionService V1_0_0 
...
{
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_0 *CompositionServiceV1_0_0;
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_0_CS *CompositionServiceV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "CompositionService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_CompositionService_V1_0_0_To_CS (ResoruceRaw, &CompositionServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionServiceV1_0_0 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_0));
  if (CompositionServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)CompositionServiceV1_0_0;
  CompositionServiceV1_0_0->CompositionService = CompositionServiceV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("CompositionService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "CompositionService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("CompositionService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "CompositionService");
...
EFI_STATUS
EFIAPI
CompositionServiceFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_CompositionService_V1_0_0_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in CompositionServiceToStruct.
...
EFI_STATUS
EFIAPI
CompositionServiceDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  CompositionServiceV1_0_0 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_0 *)InterpProp;
  DestroyCompositionService_V1_0_0_CS (CompositionServiceV1_0_0->CompositionService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from CompositionServiceFromEfiStruct
...
)
{
  ...
  return DestroyCompositionService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
