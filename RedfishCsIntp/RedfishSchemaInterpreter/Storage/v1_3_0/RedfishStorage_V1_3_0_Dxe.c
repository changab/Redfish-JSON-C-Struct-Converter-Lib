...
//
#include <RedfishInterpreter/Storage/v1_3_0/EfiStorageV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_3_0 
...
{
  EFI_REDFISH_STORAGE_V1_3_0 *StorageV1_3_0;
  EFI_REDFISH_STORAGE_V1_3_0_CS *StorageV1_3_0Cs;
  ...
  Status = Json_Storage_V1_3_0_To_CS (ResoruceRaw, &StorageV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_3_0 = (EFI_REDFISH_STORAGE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_3_0));
  if (StorageV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_3_0;
  StorageV1_3_0->Storage = StorageV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_3_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_3_0_JSON (*((EFI_REDFISH_STORAGE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_3_0 = (EFI_REDFISH_STORAGE_V1_3_0 *)InterpProp;
  DestroyStorage_V1_3_0_CS (StorageV1_3_0->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_3_0EntryPoint (
