...
//
#include <RedfishInterpreter/Bios/v1_0_5/EfiBiosV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Bios";
...
{
  EFI_REDFISH_BIOS_V1_0_5 *BiosV1_0_5;
  EFI_REDFISH_BIOS_V1_0_5_CS *BiosV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Bios") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Bios_V1_0_5_To_CS (ResoruceRaw, &BiosV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_0_5 = (EFI_REDFISH_BIOS_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_0_5));
  if (BiosV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)BiosV1_0_5;
  BiosV1_0_5->Bios = BiosV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_BIOS_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Bios"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Bios");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Bios"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Bios");
...
)
{
  ...
  return CS_To_Bios_V1_0_5_JSON (*((EFI_REDFISH_BIOS_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in BiosToStruct.
...
)
{
  ...
  BiosV1_0_5 = (EFI_REDFISH_BIOS_V1_0_5 *)InterpProp;
  DestroyBios_V1_0_5_CS (BiosV1_0_5->Bios); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from BiosFromEfiStruct
...
)
{
  ...
  return DestroyBios_V1_0_5_Json (ResoruceRaw);
}
