...
//
#include <RedfishInterpreter/ManagerNetworkProtocol/v1_1_1/EfiManagerNetworkProtocolV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_1_1 
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_1 *ManagerNetworkProtocolV1_1_1;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_1_CS *ManagerNetworkProtocolV1_1_1Cs;
  ...
  Status = Json_ManagerNetworkProtocol_V1_1_1_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_1_1 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_1));
  if (ManagerNetworkProtocolV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerNetworkProtocolV1_1_1;
  ManagerNetworkProtocolV1_1_1->ManagerNetworkProtocol = ManagerNetworkProtocolV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerNetworkProtocol_V1_1_1_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerNetworkProtocolV1_1_1 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_1 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_1_1_CS (ManagerNetworkProtocolV1_1_1->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerNetworkProtocol_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
