...
//
#include <RedfishInterpreter/ActionInfo/v1_1_0/EfiActionInfoV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_1_0 
...
{
  EFI_REDFISH_ACTIONINFO_V1_1_0 *ActionInfoV1_1_0;
  EFI_REDFISH_ACTIONINFO_V1_1_0_CS *ActionInfoV1_1_0Cs;
  ...
  Status = Json_ActionInfo_V1_1_0_To_CS (ResoruceRaw, &ActionInfoV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_1_0 = (EFI_REDFISH_ACTIONINFO_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_1_0));
  if (ActionInfoV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ActionInfoV1_1_0;
  ActionInfoV1_1_0->ActionInfo = ActionInfoV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ACTIONINFO_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ActionInfo_V1_1_0_JSON (*((EFI_REDFISH_ACTIONINFO_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ActionInfoV1_1_0 = (EFI_REDFISH_ACTIONINFO_V1_1_0 *)InterpProp;
  DestroyActionInfo_V1_1_0_CS (ActionInfoV1_1_0->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyActionInfo_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
