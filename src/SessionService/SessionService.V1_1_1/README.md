# Definition of SessionService.V1_1_1 and functions<br><br>
...
## SessionService
    typedef struct _RedfishSessionService_V1_1_1_SessionService_CS {
        ...
        RedfishSessionService_V1_1_1_SessionService_Actions_CS *Actions;
...
|**Actions**|RedfishSessionService_V1_1_1_SessionService_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish SessionService V1_1_1 to C Structure Function
    RedfishCS_status
    Json_SessionService_V1_1_1_To_CS (RedfishCS_char *JsonRawText, RedfishSessionService_V1_1_1_SessionService_CS **ReturnedCS);

## C Structure to Redfish SessionService V1_1_1 JSON Function
    RedfishCS_status
    CS_To_SessionService_V1_1_1_JSON (RedfishSessionService_V1_1_1_SessionService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish SessionService V1_1_1 C Structure Function
    RedfishCS_status
