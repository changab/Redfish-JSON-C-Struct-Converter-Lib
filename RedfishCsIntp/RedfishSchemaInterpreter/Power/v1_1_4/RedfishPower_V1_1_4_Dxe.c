...
//
#include <RedfishInterpreter/Power/v1_1_4/EfiPowerV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_1_4 
...
{
  EFI_REDFISH_POWER_V1_1_4 *PowerV1_1_4;
  EFI_REDFISH_POWER_V1_1_4_CS *PowerV1_1_4Cs;
  ...
  Status = Json_Power_V1_1_4_To_CS (ResoruceRaw, &PowerV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_1_4 = (EFI_REDFISH_POWER_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_1_4));
  if (PowerV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_1_4;
  PowerV1_1_4->Power = PowerV1_1_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_POWER_V1_1_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_1_4_JSON (*((EFI_REDFISH_POWER_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_1_4 = (EFI_REDFISH_POWER_V1_1_4 *)InterpProp;
  DestroyPower_V1_1_4_CS (PowerV1_1_4->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_1_4_Json (ResoruceRaw);
}
