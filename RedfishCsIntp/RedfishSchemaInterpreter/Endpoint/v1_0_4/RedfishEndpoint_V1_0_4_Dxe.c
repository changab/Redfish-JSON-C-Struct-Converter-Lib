...
//
#include <RedfishInterpreter/Endpoint/v1_0_4/EfiEndpointV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_0_4 
...
{
  EFI_REDFISH_ENDPOINT_V1_0_4 *EndpointV1_0_4;
  EFI_REDFISH_ENDPOINT_V1_0_4_CS *EndpointV1_0_4Cs;
  ...
  Status = Json_Endpoint_V1_0_4_To_CS (ResoruceRaw, &EndpointV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_0_4 = (EFI_REDFISH_ENDPOINT_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_0_4));
  if (EndpointV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EndpointV1_0_4;
  EndpointV1_0_4->Endpoint = EndpointV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_ENDPOINT_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Endpoint_V1_0_4_JSON (*((EFI_REDFISH_ENDPOINT_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EndpointV1_0_4 = (EFI_REDFISH_ENDPOINT_V1_0_4 *)InterpProp;
  DestroyEndpoint_V1_0_4_CS (EndpointV1_0_4->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEndpoint_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_0_4EntryPoint (
