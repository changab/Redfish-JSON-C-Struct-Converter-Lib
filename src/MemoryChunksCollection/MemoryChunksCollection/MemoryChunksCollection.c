...
#include"Redfish_MemoryChunksCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishMemoryChunksCollection_MemoryChunksCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for MemoryChunksCollection.MemoryChunksCollection
//
RedfishCS_status CS_To_MemoryChunksCollection_JSON(RedfishMemoryChunksCollection_MemoryChunksCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MemoryChunksCollection.MemoryChunksCollection
//
RedfishCS_status DestroyMemoryChunksCollection_CS(RedfishMemoryChunksCollection_MemoryChunksCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MemoryChunksCollection.MemoryChunksCollection
//
RedfishCS_status DestroyMemoryChunksCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MemoryChunksCollection.NOVERSIONED.MemoryChunksCollection
//
RedfishCS_status
Json_MemoryChunksCollection_To_CS(RedfishCS_char *JsonRawText, RedfishMemoryChunksCollection_MemoryChunksCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemoryChunksCollection_MemoryChunksCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MemoryChunksCollection", "noversioned", "MemoryChunksCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemoryChunksCollection_MemoryChunksCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMemoryChunksCollection_CS (Cs);
  return Status;
}
