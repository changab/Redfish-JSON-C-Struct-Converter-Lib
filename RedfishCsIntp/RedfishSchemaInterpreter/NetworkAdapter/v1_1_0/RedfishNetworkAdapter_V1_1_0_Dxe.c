...
//
#include <RedfishInterpreter/NetworkAdapter/v1_1_0/EfiNetworkAdapterV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_1_0 
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_1_0 *NetworkAdapterV1_1_0;
  EFI_REDFISH_NETWORKADAPTER_V1_1_0_CS *NetworkAdapterV1_1_0Cs;
  ...
  Status = Json_NetworkAdapter_V1_1_0_To_CS (ResoruceRaw, &NetworkAdapterV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_1_0 = (EFI_REDFISH_NETWORKADAPTER_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_1_0));
  if (NetworkAdapterV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkAdapterV1_1_0;
  NetworkAdapterV1_1_0->NetworkAdapter = NetworkAdapterV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_NETWORKADAPTER_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkAdapter_V1_1_0_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkAdapterV1_1_0 = (EFI_REDFISH_NETWORKADAPTER_V1_1_0 *)InterpProp;
  DestroyNetworkAdapter_V1_1_0_CS (NetworkAdapterV1_1_0->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkAdapter_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
