...
#ifndef _RedfishRole_V1_2_0_CSTRUCT_H_
#define _RedfishRole_V1_2_0_CSTRUCT_H_
...
typedef struct _RedfishRole_V1_2_0_Role_CS RedfishRole_V1_2_0_Role_CS;
typedef struct _RedfishRole_V1_2_0_Role_Actions_CS RedfishRole_V1_2_0_Role_Actions_CS;
typedef struct _RedfishRole_V1_2_0_Role_Actions_Oem_CS RedfishRole_V1_2_0_Role_Actions_Oem_CS;
//
...
typedef struct _RedfishRole_V1_2_0_Role_Actions_CS {
    RedfishRole_V1_2_0_Role_Actions_Oem_CS    *Oem;    // The available OEM specific
...
typedef struct _RedfishRole_V1_2_0_Role_CS {
    ...
    RedfishRole_V1_2_0_Role_Actions_CS    *Actions;              // The available actions for this
                                                                 // resource.
...
RedfishCS_status
Json_Role_V1_2_0_To_CS (char *JsonRawText, RedfishRole_V1_2_0_Role_CS **ReturnedCS);

RedfishCS_status
CS_To_Role_V1_2_0_JSON (RedfishRole_V1_2_0_Role_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyRole_V1_2_0_CS (RedfishRole_V1_2_0_Role_CS *CSPtr);

RedfishCS_status
DestroyRole_V1_2_0_Json (RedfishCS_char *JsonText);
