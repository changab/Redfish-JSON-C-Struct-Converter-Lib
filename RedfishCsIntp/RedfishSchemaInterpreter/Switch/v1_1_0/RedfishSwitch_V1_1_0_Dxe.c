...
//
#include <RedfishInterpreter/Switch/v1_1_0/EfiSwitchV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_1_0 
...
{
  EFI_REDFISH_SWITCH_V1_1_0 *SwitchV1_1_0;
  EFI_REDFISH_SWITCH_V1_1_0_CS *SwitchV1_1_0Cs;
  ...
  Status = Json_Switch_V1_1_0_To_CS (ResoruceRaw, &SwitchV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_1_0 = (EFI_REDFISH_SWITCH_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_1_0));
  if (SwitchV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SwitchV1_1_0;
  SwitchV1_1_0->Switch = SwitchV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SWITCH_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Switch_V1_1_0_JSON (*((EFI_REDFISH_SWITCH_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SwitchV1_1_0 = (EFI_REDFISH_SWITCH_V1_1_0 *)InterpProp;
  DestroySwitch_V1_1_0_CS (SwitchV1_1_0->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySwitch_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_1_0EntryPoint (
