...
#ifndef _RedfishComputersystem_V1_0_8_CSTRUCT_H_
#define _RedfishComputersystem_V1_0_8_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_0_8_Actions_CS RedfishComputerSystem_V1_0_8_Actions_CS;
typedef struct _RedfishComputerSystem_V1_0_8_Boot_CS RedfishComputerSystem_V1_0_8_Boot_CS;
typedef struct _RedfishComputerSystem_V1_0_8_ComputerSystem_CS RedfishComputerSystem_V1_0_8_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_0_8_Links_CS RedfishComputerSystem_V1_0_8_Links_CS;
typedef struct _RedfishComputerSystem_V1_0_8_MemorySummary_CS RedfishComputerSystem_V1_0_8_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_0_8_OemActions_CS RedfishComputerSystem_V1_0_8_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_0_8_ProcessorSummary_CS RedfishComputerSystem_V1_0_8_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_0_8_Reset_CS RedfishComputerSystem_V1_0_8_Reset_CS;
typedef struct _RedfishComputerSystem_V1_0_8_SetDefaultBootOrder_CS RedfishComputerSystem_V1_0_8_SetDefaultBootOrder_CS;
...
//
typedef struct _RedfishComputerSystem_V1_0_8_Actions_CS {
    RedfishComputerSystem_V1_0_8_Reset_CS                  *ComputerSystem_Reset;             
    RedfishComputerSystem_V1_0_8_SetDefaultBootOrder_CS    *ComputerSystem_SetDefaultBootOrder;
    RedfishComputerSystem_V1_0_8_OemActions_CS             *Oem;                                  // This property contains the
                                                                                                  // available OEM specific actions
                                                                                                  // for this resource.
} RedfishComputerSystem_V1_0_8_Actions_CS;

//
// This object contains the boot information for the current resource.
//
typedef struct _RedfishComputerSystem_V1_0_8_Boot_CS {
    ...
    RedfishCS_char    *UefiTargetBootSourceOverride;    // This property is the UEFI
                                                       ...
                                                       // UefiTarget.
} RedfishComputerSystem_V1_0_8_Boot_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishComputerSystem_V1_0_8_Links_CS {
...
} RedfishComputerSystem_V1_0_8_Links_CS;
...
typedef struct _RedfishComputerSystem_V1_0_8_ComputerSystem_CS {
    ...
    RedfishComputerSystem_V1_0_8_Actions_CS             *Actions;             // The available actions for this
                                                                              // resource.
    ...
    RedfishComputerSystem_V1_0_8_Boot_CS                *Boot;                // Information about the boot
    ...
    RedfishCS_char                                      *IndicatorLED;        // The state of the indicator
                                                                              ...
                                                                              // system.
    RedfishComputerSystem_V1_0_8_Links_CS               *Links;               // Contains references to other
    ...
    RedfishCS_char                                      *Manufacturer;        // The manufacturer or OEM of
                                                                              // this system.
    RedfishComputerSystem_V1_0_8_MemorySummary_CS       *MemorySummary;       // This object describes the
    ...
    RedfishCS_char                                      *PowerState;          // This is the current power
                                                                              // state of the system.
    RedfishComputerSystem_V1_0_8_ProcessorSummary_CS    *ProcessorSummary;    // This object describes the
...
RedfishCS_status
Json_ComputerSystem_V1_0_8_To_CS (char *JsonRawText, RedfishComputerSystem_V1_0_8_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_0_8_JSON (RedfishComputerSystem_V1_0_8_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_0_8_CS (RedfishComputerSystem_V1_0_8_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_0_8_Json (RedfishCS_char *JsonText);
