...
//
#include <RedfishInterpreter/MemoryMetrics/v1_1_4/EfiMemoryMetricsV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_1_4 
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_1_4 *MemoryMetricsV1_1_4;
  EFI_REDFISH_MEMORYMETRICS_V1_1_4_CS *MemoryMetricsV1_1_4Cs;
  ...
  Status = Json_MemoryMetrics_V1_1_4_To_CS (ResoruceRaw, &MemoryMetricsV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_1_4 = (EFI_REDFISH_MEMORYMETRICS_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_1_4));
  if (MemoryMetricsV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryMetricsV1_1_4;
  MemoryMetricsV1_1_4->MemoryMetrics = MemoryMetricsV1_1_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_MEMORYMETRICS_V1_1_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryMetrics_V1_1_4_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryMetricsV1_1_4 = (EFI_REDFISH_MEMORYMETRICS_V1_1_4 *)InterpProp;
  DestroyMemoryMetrics_V1_1_4_CS (MemoryMetricsV1_1_4->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryMetrics_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
