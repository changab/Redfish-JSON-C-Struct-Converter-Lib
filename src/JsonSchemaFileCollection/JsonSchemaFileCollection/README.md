# Definition of JsonSchemaFileCollection and functions<br><br>
...
## Redfish JsonSchemaFileCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish JsonSchemaFileCollection  JSON Function
    RedfishCS_status
    CS_To_JsonSchemaFileCollection_JSON (RedfishJsonSchemaFileCollection_JsonSchemaFileCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish JsonSchemaFileCollection  C Structure Function
    RedfishCS_status
