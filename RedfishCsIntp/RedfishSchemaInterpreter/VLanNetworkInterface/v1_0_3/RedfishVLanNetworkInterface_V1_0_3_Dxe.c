...
//
#include <RedfishInterpreter/VLanNetworkInterface/v1_0_3/EfiVLanNetworkInterfaceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_0_3 
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_3 *VLanNetworkInterfaceV1_0_3;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_3_CS *VLanNetworkInterfaceV1_0_3Cs;
  ...
  Status = Json_VLanNetworkInterface_V1_0_3_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_0_3 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_3));
  if (VLanNetworkInterfaceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VLanNetworkInterfaceV1_0_3;
  VLanNetworkInterfaceV1_0_3->VLanNetworkInterface = VLanNetworkInterfaceV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VLanNetworkInterface_V1_0_3_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VLanNetworkInterfaceV1_0_3 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_3 *)InterpProp;
  DestroyVLanNetworkInterface_V1_0_3_CS (VLanNetworkInterfaceV1_0_3->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVLanNetworkInterface_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
