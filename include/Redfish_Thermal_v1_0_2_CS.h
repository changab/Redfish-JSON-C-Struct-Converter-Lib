...
#ifndef _RedfishThermal_V1_0_2_CSTRUCT_H_
#define _RedfishThermal_V1_0_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishThermal_V1_0_2_Fan_Array_CS RedfishThermal_V1_0_2_Fan_Array_CS;
typedef struct _RedfishThermal_V1_0_2_Temperature_Array_CS RedfishThermal_V1_0_2_Temperature_Array_CS;
...
typedef struct _RedfishThermal_V1_0_2_Fan_CS RedfishThermal_V1_0_2_Fan_CS;
typedef struct _RedfishThermal_V1_0_2_Temperature_CS RedfishThermal_V1_0_2_Temperature_CS;
typedef struct _RedfishThermal_V1_0_2_Thermal_CS RedfishThermal_V1_0_2_Thermal_CS;
...
//
typedef struct _RedfishThermal_V1_0_2_Fan_CS {
...
} RedfishThermal_V1_0_2_Fan_CS;

//
// This is the base type for addressable members of an array.
//
typedef struct _RedfishThermal_V1_0_2_Temperature_CS {
    RedfishCS_int64                       *LowerThresholdCritical;            // Below normal range but not yet
                                                                              // fatal.
    RedfishCS_int64                       *LowerThresholdFatal;               // Below normal range and is
                                                                              // fatal
    ...
    RedfishCS_int64                       *UpperThresholdFatal;               // Above normal range and is
                                                                              // fatal
    RedfishCS_int64                       *UpperThresholdNonCritical;         // Above normal range
} RedfishThermal_V1_0_2_Temperature_CS;
...
//
typedef struct _RedfishThermal_V1_0_2_Thermal_CS {
    RedfishCS_Header                              Header;
    RedfishCS_char                                *odata_context;                  
    RedfishCS_char                                *odata_id;                       
    RedfishCS_char                                *odata_type;                     
    RedfishCS_char                                *Description;                    
    RedfishThermal_V1_0_2_Fan_Array_CS            *Fans;                               // This is the definition for
                                                                                       // fans.
    ...
    RedfishCS_char                                *Redundancyodata_navigationLink; 
    RedfishResource_Status_CS                     *Status;                         
    RedfishThermal_V1_0_2_Temperature_Array_CS    *Temperatures;                       // This is the definition for
                                                                                       // temperature sensors.
    RedfishCS_int64                               *Temperaturesodata_count;        
    RedfishCS_char                                *Temperaturesodata_navigationLink;
} RedfishThermal_V1_0_2_Thermal_CS;
...
typedef struct _RedfishThermal_V1_0_2_Fan_Array_CS  {
    RedfishThermal_V1_0_2_Fan_Array_CS    *Next;
    RedfishThermal_V1_0_2_Fan_CS    *ArrayValue;
} RedfishThermal_V1_0_2_Fan_Array_CS;

typedef struct _RedfishThermal_V1_0_2_Temperature_Array_CS  {
    RedfishThermal_V1_0_2_Temperature_Array_CS    *Next;
    RedfishThermal_V1_0_2_Temperature_CS    *ArrayValue;
} RedfishThermal_V1_0_2_Temperature_Array_CS;

RedfishCS_status
Json_Thermal_V1_0_2_To_CS (char *JsonRawText, RedfishThermal_V1_0_2_Thermal_CS **ReturnedCS);

RedfishCS_status
CS_To_Thermal_V1_0_2_JSON (RedfishThermal_V1_0_2_Thermal_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyThermal_V1_0_2_CS (RedfishThermal_V1_0_2_Thermal_CS *CSPtr);
