...
//
#include <RedfishInterpreter/EventDestination/v1_1_5/EfiEventDestinationV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_1_5 
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_1_5 *EventDestinationV1_1_5;
  EFI_REDFISH_EVENTDESTINATION_V1_1_5_CS *EventDestinationV1_1_5Cs;
  ...
  Status = Json_EventDestination_V1_1_5_To_CS (ResoruceRaw, &EventDestinationV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_1_5 = (EFI_REDFISH_EVENTDESTINATION_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_1_5));
  if (EventDestinationV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventDestinationV1_1_5;
  EventDestinationV1_1_5->EventDestination = EventDestinationV1_1_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_EVENTDESTINATION_V1_1_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventDestination_V1_1_5_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventDestinationV1_1_5 = (EFI_REDFISH_EVENTDESTINATION_V1_1_5 *)InterpProp;
  DestroyEventDestination_V1_1_5_CS (EventDestinationV1_1_5->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventDestination_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
