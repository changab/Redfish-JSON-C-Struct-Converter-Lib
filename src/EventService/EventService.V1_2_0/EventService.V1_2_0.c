...
#include"Redfish_EventService_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEventService_V1_2_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishEventService_V1_2_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #EventService.SubmitTestEvent
//
static RedfishCS_status GenSubmitTestEventCs(RedfishEventService_V1_2_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_2_0_SubmitTestEvent_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_2_0_SubmitTestEvent_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishEventService_V1_2_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_2_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishEventService_V1_2_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #EventService.SubmitTestEvent
  Status = GenSubmitTestEventCs (Cs, TempJsonObj, "#EventService.SubmitTestEvent", &(*Dst)->EventService_SubmitTestEvent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for SSEFilterPropertiesSupported
//
static RedfishCS_status GenSSEFilterPropertiesSupportedCs(RedfishEventService_V1_2_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_2_0_SSEFilterPropertiesSupported_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_2_0_SSEFilterPropertiesSupported_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EventFormatType
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "EventFormatType", &(*Dst)->EventFormatType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EventType
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "EventType", &(*Dst)->EventType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MessageId
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "MessageId", &(*Dst)->MessageId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MetricReportDefinition
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "MetricReportDefinition", &(*Dst)->MetricReportDefinition);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OriginResource
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "OriginResource", &(*Dst)->OriginResource);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RegistryPrefix
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "RegistryPrefix", &(*Dst)->RegistryPrefix);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ResourceType
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "ResourceType", &(*Dst)->ResourceType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenStatusCs(RedfishEventService_V1_2_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsEventService_SubmitTestEvent(json_t *CsJson, char *Key, RedfishEventService_V1_2_0_SubmitTestEvent_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEventService_V1_2_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEventService_V1_2_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // #EventService.SubmitTestEvent
  if (CS_To_JSON_ActionsEventService_SubmitTestEvent(CsJson, "#EventService.SubmitTestEvent", CSPtr->EventService_SubmitTestEvent) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_SSEFilterPropertiesSupported(json_t *CsJson, char *Key, RedfishEventService_V1_2_0_SSEFilterPropertiesSupported_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // EventFormatType 
  if (InsertJsonBoolObj (CsJson, "EventFormatType", CSPtr->EventFormatType) != RedfishCS_status_success) {goto Error;}

  // EventType 
  if (InsertJsonBoolObj (CsJson, "EventType", CSPtr->EventType) != RedfishCS_status_success) {goto Error;}

  // MessageId 
  if (InsertJsonBoolObj (CsJson, "MessageId", CSPtr->MessageId) != RedfishCS_status_success) {goto Error;}

  // MetricReportDefinition 
  if (InsertJsonBoolObj (CsJson, "MetricReportDefinition", CSPtr->MetricReportDefinition) != RedfishCS_status_success) {goto Error;}

  // OriginResource 
  if (InsertJsonBoolObj (CsJson, "OriginResource", CSPtr->OriginResource) != RedfishCS_status_success) {goto Error;}

  // RegistryPrefix 
  if (InsertJsonBoolObj (CsJson, "RegistryPrefix", CSPtr->RegistryPrefix) != RedfishCS_status_success) {goto Error;}

  // ResourceType 
  if (InsertJsonBoolObj (CsJson, "ResourceType", CSPtr->ResourceType) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for EventService.V1_2_0.EventService
//
RedfishCS_status CS_To_EventService_V1_2_0_JSON(RedfishEventService_V1_2_0_EventService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonInt64Obj (CsJson, "DeliveryRetryAttempts", CSPtr->DeliveryRetryAttempts) != RedfishCS_status_success) {goto Error;}

  // DeliveryRetryIntervalSeconds 
  if (InsertJsonInt64Obj (CsJson, "DeliveryRetryIntervalSeconds", CSPtr->DeliveryRetryIntervalSeconds) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // EventFormatTypes 
  if (InsertJsonStringArrayObj (CsJson, "EventFormatTypes", CSPtr->EventFormatTypes) != RedfishCS_status_success) {goto Error;}

  // EventTypesForSubscription 
  if (InsertJsonStringArrayObj (CsJson, "EventTypesForSubscription", CSPtr->EventTypesForSubscription) != RedfishCS_status_success) {goto Error;}
  ...
  // RegistryPrefixes 
  if (InsertJsonStringArrayObj (CsJson, "RegistryPrefixes", CSPtr->RegistryPrefixes) != RedfishCS_status_success) {goto Error;}

  // ResourceTypes 
  if (InsertJsonStringArrayObj (CsJson, "ResourceTypes", CSPtr->ResourceTypes) != RedfishCS_status_success) {goto Error;}

  // SSEFilterPropertiesSupported
  if (CS_To_JSON_SSEFilterPropertiesSupported(CsJson, "SSEFilterPropertiesSupported", CSPtr->SSEFilterPropertiesSupported) != RedfishCS_status_success) {goto Error;}

  // ServerSentEventUri 
  if (InsertJsonStringObj (CsJson, "ServerSentEventUri", CSPtr->ServerSentEventUri) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonBoolObj (CsJson, "SubordinateResourcesSupported", CSPtr->SubordinateResourcesSupported) != RedfishCS_status_success) {goto Error;}

  // Subscriptions 
  if (InsertJsonLinkObj (CsJson, "Subscriptions", &CSPtr->Subscriptions) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for EventService.V1_2_0.EventService
//
RedfishCS_status DestroyEventService_V1_2_0_CS(RedfishEventService_V1_2_0_EventService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EventService.V1_2_0.EventService
//
RedfishCS_status DestroyEventService_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EventService.V1_2_0.EventService
//
RedfishCS_status
Json_EventService_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishEventService_V1_2_0_EventService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEventService_V1_2_0_EventService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EventService", "v1_2_0", "EventService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEventService_V1_2_0_EventService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // DeliveryRetryAttempts
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "DeliveryRetryAttempts", &Cs->DeliveryRetryAttempts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // DeliveryRetryIntervalSeconds
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "DeliveryRetryIntervalSeconds", &Cs->DeliveryRetryIntervalSeconds);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // EventFormatTypes
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "EventFormatTypes", &Cs->EventFormatTypes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EventTypesForSubscription
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "EventTypesForSubscription", &Cs->EventTypesForSubscription);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // RegistryPrefixes
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "RegistryPrefixes", &Cs->RegistryPrefixes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ResourceTypes
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "ResourceTypes", &Cs->ResourceTypes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SSEFilterPropertiesSupported
  Status = GenSSEFilterPropertiesSupportedCs (Cs, JsonObj, "SSEFilterPropertiesSupported", &Cs->SSEFilterPropertiesSupported);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ServerSentEventUri
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ServerSentEventUri", &Cs->ServerSentEventUri);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SubordinateResourcesSupported
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "SubordinateResourcesSupported", &Cs->SubordinateResourcesSupported);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Subscriptions
  InitializeLinkHead (&Cs->Subscriptions);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Subscriptions", Cs->Header.ThisUri, &Cs->Subscriptions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyEventService_V1_2_0_CS (Cs);
  return Status;
}
