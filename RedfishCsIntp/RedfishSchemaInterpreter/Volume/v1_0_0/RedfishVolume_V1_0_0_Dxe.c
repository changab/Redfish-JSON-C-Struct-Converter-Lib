...
//
#include <RedfishInterpreter/Volume/v1_0_0/EfiVolumeV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Volume";
BOOLEAN IsRevisonController = TRUE;

// Support Volume V1_0_0 
...
{
  EFI_REDFISH_VOLUME_V1_0_0 *VolumeV1_0_0;
  EFI_REDFISH_VOLUME_V1_0_0_CS *VolumeV1_0_0Cs;
  ...
  Status = Json_Volume_V1_0_0_To_CS (ResoruceRaw, &VolumeV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VolumeV1_0_0 = (EFI_REDFISH_VOLUME_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VOLUME_V1_0_0));
  if (VolumeV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VolumeV1_0_0;
  VolumeV1_0_0->Volume = VolumeV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_VOLUME_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Volume_V1_0_0_JSON (*((EFI_REDFISH_VOLUME_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VolumeV1_0_0 = (EFI_REDFISH_VOLUME_V1_0_0 *)InterpProp;
  DestroyVolume_V1_0_0_CS (VolumeV1_0_0->Volume); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVolume_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVolume_V1_0_0EntryPoint (
