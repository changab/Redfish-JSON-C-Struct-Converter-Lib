...
//
#include <RedfishInterpreter/PCIeDevice/v1_3_0/EfiPCIeDeviceV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_3_0 
...
{
  EFI_REDFISH_PCIEDEVICE_V1_3_0 *PCIeDeviceV1_3_0;
  EFI_REDFISH_PCIEDEVICE_V1_3_0_CS *PCIeDeviceV1_3_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "PCIeDevice") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_PCIeDevice_V1_3_0_To_CS (ResoruceRaw, &PCIeDeviceV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_3_0 = (EFI_REDFISH_PCIEDEVICE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_3_0));
  if (PCIeDeviceV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeDeviceV1_3_0;
  PCIeDeviceV1_3_0->PCIeDevice = PCIeDeviceV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_PCIEDEVICE_V1_3_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeDevice"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "PCIeDevice");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeDevice"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "PCIeDevice");
...
)
{
  ...
  return CS_To_PCIeDevice_V1_3_0_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in PCIeDeviceToStruct.
...
)
{
  ...
  PCIeDeviceV1_3_0 = (EFI_REDFISH_PCIEDEVICE_V1_3_0 *)InterpProp;
  DestroyPCIeDevice_V1_3_0_CS (PCIeDeviceV1_3_0->PCIeDevice); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PCIeDeviceFromEfiStruct
...
)
{
  ...
  return DestroyPCIeDevice_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
