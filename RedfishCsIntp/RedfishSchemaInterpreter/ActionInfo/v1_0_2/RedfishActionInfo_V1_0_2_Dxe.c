...
//
#include <RedfishInterpreter/ActionInfo/v1_0_2/EfiActionInfoV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_0_2 
...
{
  EFI_REDFISH_ACTIONINFO_V1_0_2 *ActionInfoV1_0_2;
  EFI_REDFISH_ACTIONINFO_V1_0_2_CS *ActionInfoV1_0_2Cs;
  ...
  Status = Json_ActionInfo_V1_0_2_To_CS (ResoruceRaw, &ActionInfoV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_0_2 = (EFI_REDFISH_ACTIONINFO_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_0_2));
  if (ActionInfoV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ActionInfoV1_0_2;
  ...
  Length = sizeof (EFI_REDFISH_ACTIONINFO_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ActionInfo_V1_0_2_JSON (*((EFI_REDFISH_ACTIONINFO_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ActionInfoV1_0_2 = (EFI_REDFISH_ACTIONINFO_V1_0_2 *)InterpProp;
  DestroyActionInfo_V1_0_2_CS (ActionInfoV1_0_2->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyActionInfo_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
