...
#ifndef _RedfishHostinterface_V1_0_1_CSTRUCT_H_
#define _RedfishHostinterface_V1_0_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishHostInterface_V1_0_1_HostInterface_CS RedfishHostInterface_V1_0_1_HostInterface_CS;
typedef struct _RedfishHostInterface_V1_0_1_HostInterface_Links_CS RedfishHostInterface_V1_0_1_HostInterface_Links_CS;
...
//
typedef struct _RedfishHostInterface_V1_0_1_HostInterface_Links_CS {
...
} RedfishHostInterface_V1_0_1_HostInterface_Links_CS;
...
//
typedef struct _RedfishHostInterface_V1_0_1_HostInterface_CS {
    ...
    RedfishCS_char                                        *KernelAuthRoleId;          // This property contains the
                                                                                      ...
                                                                                      // on this interface.
    RedfishHostInterface_V1_0_1_HostInterface_Links_CS    *Links;                     // Contains references to other
...
} RedfishHostInterface_V1_0_1_HostInterface_CS;

RedfishCS_status
Json_HostInterface_V1_0_1_To_CS (char *JsonRawText, RedfishHostInterface_V1_0_1_HostInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_HostInterface_V1_0_1_JSON (RedfishHostInterface_V1_0_1_HostInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyHostInterface_V1_0_1_CS (RedfishHostInterface_V1_0_1_HostInterface_CS *CSPtr);
