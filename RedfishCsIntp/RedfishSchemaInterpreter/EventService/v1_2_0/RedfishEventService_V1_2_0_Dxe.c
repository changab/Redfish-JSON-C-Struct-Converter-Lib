...
//
#include <RedfishInterpreter/EventService/v1_2_0/EfiEventServiceV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_2_0 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_2_0 *EventServiceV1_2_0;
  EFI_REDFISH_EVENTSERVICE_V1_2_0_CS *EventServiceV1_2_0Cs;
  ...
  Status = Json_EventService_V1_2_0_To_CS (ResoruceRaw, &EventServiceV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_2_0 = (EFI_REDFISH_EVENTSERVICE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_2_0));
  if (EventServiceV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_2_0;
  EventServiceV1_2_0->EventService = EventServiceV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_2_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventService_V1_2_0_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventServiceV1_2_0 = (EFI_REDFISH_EVENTSERVICE_V1_2_0 *)InterpProp;
  DestroyEventService_V1_2_0_CS (EventServiceV1_2_0->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventService_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
