# Definition of PCIeDevice.V1_0_0 and functions<br><br>
...
## PCIeDevice
    typedef struct _RedfishPCIeDevice_V1_0_0_PCIeDevice_CS {
        ...
        RedfishCS_char *Id;
        RedfishPCIeDevice_V1_0_0_PCIeDevice_Links_CS *Links;
...
|**Links**|RedfishPCIeDevice_V1_0_0_PCIeDevice_Links_CS| Structure points to **Links** property.| No| Yes
...
## Redfish PCIeDevice V1_0_0 to C Structure Function
    RedfishCS_status
    Json_PCIeDevice_V1_0_0_To_CS (RedfishCS_char *JsonRawText, RedfishPCIeDevice_V1_0_0_PCIeDevice_CS **ReturnedCS);

## C Structure to Redfish PCIeDevice V1_0_0 JSON Function
    RedfishCS_status
    CS_To_PCIeDevice_V1_0_0_JSON (RedfishPCIeDevice_V1_0_0_PCIeDevice_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish PCIeDevice V1_0_0 C Structure Function
    RedfishCS_status
