...
//
#include <RedfishInterpreter/MemoryMetrics/v1_0_2/EfiMemoryMetricsV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_0_2 
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_0_2 *MemoryMetricsV1_0_2;
  EFI_REDFISH_MEMORYMETRICS_V1_0_2_CS *MemoryMetricsV1_0_2Cs;
  ...
  Status = Json_MemoryMetrics_V1_0_2_To_CS (ResoruceRaw, &MemoryMetricsV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_0_2 = (EFI_REDFISH_MEMORYMETRICS_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_0_2));
  if (MemoryMetricsV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryMetricsV1_0_2;
  MemoryMetricsV1_0_2->MemoryMetrics = MemoryMetricsV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MEMORYMETRICS_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryMetrics_V1_0_2_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryMetricsV1_0_2 = (EFI_REDFISH_MEMORYMETRICS_V1_0_2 *)InterpProp;
  DestroyMemoryMetrics_V1_0_2_CS (MemoryMetricsV1_0_2->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryMetrics_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
