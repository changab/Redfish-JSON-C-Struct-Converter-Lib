...
//
#include <RedfishInterpreter/EventService/v1_0_7/EfiEventServiceV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_7 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_7 *EventServiceV1_0_7;
  EFI_REDFISH_EVENTSERVICE_V1_0_7_CS *EventServiceV1_0_7Cs;
  ...
  Status = Json_EventService_V1_0_7_To_CS (ResoruceRaw, &EventServiceV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_7 = (EFI_REDFISH_EVENTSERVICE_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_7));
  if (EventServiceV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_0_7;
  EventServiceV1_0_7->EventService = EventServiceV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventService_V1_0_7_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventServiceV1_0_7 = (EFI_REDFISH_EVENTSERVICE_V1_0_7 *)InterpProp;
  DestroyEventService_V1_0_7_CS (EventServiceV1_0_7->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventService_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
