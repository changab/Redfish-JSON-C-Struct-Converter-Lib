# Definition of ManagerNetworkProtocol.V1_2_0 and functions<br><br>
...
|**SSH**|RedfishManagerNetworkProtocol_V1_2_0_Protocol_CS| Structure points to **SSH** property.| No| No
