...
//
#include <RedfishInterpreter/LogService/v1_0_3/EfiLogServiceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_3 
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_3 *LogServiceV1_0_3;
  ...
  Status = Json_LogService_V1_0_3_To_CS (ResoruceRaw, &LogServiceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_3 = (EFI_REDFISH_LOGSERVICE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_3));
  if (LogServiceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogServiceV1_0_3;
  LogServiceV1_0_3->LogService = LogServiceV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_LOGSERVICE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogService_V1_0_3_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogServiceV1_0_3 = (EFI_REDFISH_LOGSERVICE_V1_0_3 *)InterpProp;
  DestroyLogService_V1_0_3_CS (LogServiceV1_0_3->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogService_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
