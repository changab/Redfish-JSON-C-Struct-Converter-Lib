# Definition of Port.V1_1_0 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Port_Reset**|RedfishPort_V1_1_0_Reset_CS| Structure points to **#Port.Reset** property.| No| No
|**Oem**|RedfishPort_V1_1_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Port
    typedef struct _RedfishPort_V1_1_0_Port_CS {
        ...
        RedfishPort_V1_1_0_Actions_CS *Actions;
        RedfishCS_int64 *CurrentSpeedGbps;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishPort_V1_1_0_Links_CS *Links;
...
|**Actions**|RedfishPort_V1_1_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishPort_V1_1_0_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Port V1_1_0 to C Structure Function
    RedfishCS_status
    Json_Port_V1_1_0_To_CS (RedfishCS_char *JsonRawText, RedfishPort_V1_1_0_Port_CS **ReturnedCS);

## C Structure to Redfish Port V1_1_0 JSON Function
    RedfishCS_status
    CS_To_Port_V1_1_0_JSON (RedfishPort_V1_1_0_Port_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Port V1_1_0 C Structure Function
    RedfishCS_status
