...
//
#include <RedfishInterpreter/Processor/v1_0_6/EfiProcessorV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_0_6 
...
{
  EFI_REDFISH_PROCESSOR_V1_0_6 *ProcessorV1_0_6;
  EFI_REDFISH_PROCESSOR_V1_0_6_CS *ProcessorV1_0_6Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Processor") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Processor_V1_0_6_To_CS (ResoruceRaw, &ProcessorV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_0_6 = (EFI_REDFISH_PROCESSOR_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_0_6));
  if (ProcessorV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ProcessorV1_0_6;
  ProcessorV1_0_6->Processor = ProcessorV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_PROCESSOR_V1_0_6_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Processor"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Processor");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Processor"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Processor");
...
)
{
  ...
  return CS_To_Processor_V1_0_6_JSON (*((EFI_REDFISH_PROCESSOR_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ProcessorToStruct.
...
)
{
  ...
  ProcessorV1_0_6 = (EFI_REDFISH_PROCESSOR_V1_0_6 *)InterpProp;
  DestroyProcessor_V1_0_6_CS (ProcessorV1_0_6->Processor); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ProcessorFromEfiStruct
...
)
{
  ...
  return DestroyProcessor_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_6EntryPoint (
