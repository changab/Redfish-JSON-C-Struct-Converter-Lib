...
#ifndef _RedfishPciefunction_V1_0_2_CSTRUCT_H_
#define _RedfishPciefunction_V1_0_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPCIeFunction_V1_0_2_PCIeFunction_CS RedfishPCIeFunction_V1_0_2_PCIeFunction_CS;
typedef struct _RedfishPCIeFunction_V1_0_2_PCIeFunction_Links_CS RedfishPCIeFunction_V1_0_2_PCIeFunction_Links_CS;
...
typedef struct _RedfishPCIeFunction_V1_0_2_PCIeFunction_CS {
    ...
    RedfishCS_char                                      *Id;              
    RedfishPCIeFunction_V1_0_2_PCIeFunction_Links_CS    *Links;               // The links object contains the
...
RedfishCS_status
Json_PCIeFunction_V1_0_2_To_CS (char *JsonRawText, RedfishPCIeFunction_V1_0_2_PCIeFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeFunction_V1_0_2_JSON (RedfishPCIeFunction_V1_0_2_PCIeFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPCIeFunction_V1_0_2_CS (RedfishPCIeFunction_V1_0_2_PCIeFunction_CS *CSPtr);

RedfishCS_status
DestroyPCIeFunction_V1_0_2_Json (RedfishCS_char *JsonText);
