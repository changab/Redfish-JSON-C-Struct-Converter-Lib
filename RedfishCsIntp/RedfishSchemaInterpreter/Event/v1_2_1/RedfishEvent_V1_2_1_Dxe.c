...
//
#include <RedfishInterpreter/Event/v1_2_1/EfiEventV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_2_1 
...
{
  EFI_REDFISH_EVENT_V1_2_1 *EventV1_2_1;
  EFI_REDFISH_EVENT_V1_2_1_CS *EventV1_2_1Cs;
  ...
  Status = Json_Event_V1_2_1_To_CS (ResoruceRaw, &EventV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_2_1 = (EFI_REDFISH_EVENT_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_2_1));
  if (EventV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_2_1;
  EventV1_2_1->Event = EventV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_EVENT_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_2_1_JSON (*((EFI_REDFISH_EVENT_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_2_1 = (EFI_REDFISH_EVENT_V1_2_1 *)InterpProp;
  DestroyEvent_V1_2_1_CS (EventV1_2_1->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_2_1_Json (ResoruceRaw);
}
