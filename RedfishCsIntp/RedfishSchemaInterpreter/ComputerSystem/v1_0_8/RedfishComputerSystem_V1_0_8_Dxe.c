...
//
#include <RedfishInterpreter/ComputerSystem/v1_0_8/EfiComputerSystemV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_0_8 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_8 *ComputerSystemV1_0_8;
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_8_CS *ComputerSystemV1_0_8Cs;
  ...
  Status = Json_ComputerSystem_V1_0_8_To_CS (ResoruceRaw, &ComputerSystemV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_0_8 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_8));
  if (ComputerSystemV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_0_8;
  ComputerSystemV1_0_8->ComputerSystem = ComputerSystemV1_0_8Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "8";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_8_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_0_8_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_0_8 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_8 *)InterpProp;
  DestroyComputerSystem_V1_0_8_CS (ComputerSystemV1_0_8->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
