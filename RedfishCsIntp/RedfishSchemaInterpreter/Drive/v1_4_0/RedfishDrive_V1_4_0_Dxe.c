...
//
#include <RedfishInterpreter/Drive/v1_4_0/EfiDriveV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_4_0 
...
{
  EFI_REDFISH_DRIVE_V1_4_0 *DriveV1_4_0;
  EFI_REDFISH_DRIVE_V1_4_0_CS *DriveV1_4_0Cs;
  ...
  Status = Json_Drive_V1_4_0_To_CS (ResoruceRaw, &DriveV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_4_0 = (EFI_REDFISH_DRIVE_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_4_0));
  if (DriveV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_4_0;
  DriveV1_4_0->Drive = DriveV1_4_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_4_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_4_0_JSON (*((EFI_REDFISH_DRIVE_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_4_0 = (EFI_REDFISH_DRIVE_V1_4_0 *)InterpProp;
  DestroyDrive_V1_4_0_CS (DriveV1_4_0->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_4_0_Json (ResoruceRaw);
}
