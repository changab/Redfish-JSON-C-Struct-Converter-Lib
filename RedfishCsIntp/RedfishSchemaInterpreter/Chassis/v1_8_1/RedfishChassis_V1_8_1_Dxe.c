...
//
#include <RedfishInterpreter/Chassis/v1_8_1/EfiChassisV1_8_1.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_8_1 
...
{
  EFI_REDFISH_CHASSIS_V1_8_1 *ChassisV1_8_1;
  EFI_REDFISH_CHASSIS_V1_8_1_CS *ChassisV1_8_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.MinorVersion, "8") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "1") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Chassis") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Chassis_V1_8_1_To_CS (ResoruceRaw, &ChassisV1_8_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_8_1 = (EFI_REDFISH_CHASSIS_V1_8_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_8_1));
  if (ChassisV1_8_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_8_1;
  ChassisV1_8_1->Chassis = ChassisV1_8_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "8";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_8_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_8_1_JSON (*((EFI_REDFISH_CHASSIS_V1_8_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_8_1 = (EFI_REDFISH_CHASSIS_V1_8_1 *)InterpProp;
  DestroyChassis_V1_8_1_CS (ChassisV1_8_1->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_8_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_8_1EntryPoint (
