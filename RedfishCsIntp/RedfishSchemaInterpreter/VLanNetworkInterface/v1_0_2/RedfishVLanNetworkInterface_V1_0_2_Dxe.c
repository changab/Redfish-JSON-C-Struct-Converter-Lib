...
//
#include <RedfishInterpreter/VLanNetworkInterface/v1_0_2/EfiVLanNetworkInterfaceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_0_2 
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_2 *VLanNetworkInterfaceV1_0_2;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_2_CS *VLanNetworkInterfaceV1_0_2Cs;
  ...
  Status = Json_VLanNetworkInterface_V1_0_2_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_0_2 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_2));
  if (VLanNetworkInterfaceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VLanNetworkInterfaceV1_0_2;
  VLanNetworkInterfaceV1_0_2->VLanNetworkInterface = VLanNetworkInterfaceV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VLanNetworkInterface_V1_0_2_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VLanNetworkInterfaceV1_0_2 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_2 *)InterpProp;
  DestroyVLanNetworkInterface_V1_0_2_CS (VLanNetworkInterfaceV1_0_2->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVLanNetworkInterface_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
