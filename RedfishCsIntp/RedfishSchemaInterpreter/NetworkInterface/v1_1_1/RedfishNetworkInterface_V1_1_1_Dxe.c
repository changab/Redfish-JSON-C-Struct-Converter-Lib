...
//
#include <RedfishInterpreter/NetworkInterface/v1_1_1/EfiNetworkInterfaceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkInterface V1_1_1 
...
{
  EFI_REDFISH_NETWORKINTERFACE_V1_1_1 *NetworkInterfaceV1_1_1;
  EFI_REDFISH_NETWORKINTERFACE_V1_1_1_CS *NetworkInterfaceV1_1_1Cs;
  ...
  Status = Json_NetworkInterface_V1_1_1_To_CS (ResoruceRaw, &NetworkInterfaceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkInterfaceV1_1_1 = (EFI_REDFISH_NETWORKINTERFACE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_1_1));
  if (NetworkInterfaceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkInterfaceV1_1_1;
  NetworkInterfaceV1_1_1->NetworkInterface = NetworkInterfaceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkInterface_V1_1_1_JSON (*((EFI_REDFISH_NETWORKINTERFACE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkInterfaceV1_1_1 = (EFI_REDFISH_NETWORKINTERFACE_V1_1_1 *)InterpProp;
  DestroyNetworkInterface_V1_1_1_CS (NetworkInterfaceV1_1_1->NetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkInterface_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
