...
#include"Redfish_EthernetInterface_v1_3_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenActions_OemCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_Oem_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_Oem_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenIPv4Address_Array_ElementCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishIPAddresses_V1_0_0_IPv4Address_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishIPAddresses_V1_0_0_IPv4Address_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AddressOrigin
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "AddressOrigin", &(*Dst)->Origin);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // AddressOrigin
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "AddressOrigin", &(*Dst)->AddressOrigin);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Gateway
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "Gateway", &(*Dst)->Gateway);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SubnetMask
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "SubnetMask", &(*Dst)->SubnetMask);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishIPAddresses_V1_0_0_IPv4Address_Array_CS
//
static RedfishCS_status GenIPv4Address_ArrayCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishIPAddresses_V1_0_0_IPv4Address_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishIPAddresses_V1_0_0_IPv4Address_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishIPAddresses_V1_0_0_IPv4Address_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenIPv4Address_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
...
static RedfishCS_status GenIPv6AddressPolicyEntry_Array_ElementCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Label
...
//
//Generate C structure for RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_Array_CS
//
static RedfishCS_status GenIPv6AddressPolicyEntry_ArrayCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenIPv6Address_Array_ElementCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishIPAddresses_V1_0_0_IPv6Address_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishIPAddresses_V1_0_0_IPv6Address_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AddressOrigin
  ...
  // AddressState
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "AddressState", &(*Dst)->AddressState);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PrefixLength
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "PrefixLength", &(*Dst)->PrefixLength);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishIPAddresses_V1_0_0_IPv6Address_Array_CS
//
static RedfishCS_status GenIPv6Address_ArrayCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishIPAddresses_V1_0_0_IPv6Address_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishIPAddresses_V1_0_0_IPv6Address_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishIPAddresses_V1_0_0_IPv6Address_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenIPv6Address_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
static RedfishCS_status GenIPv6StaticAddress_Array_ElementCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishIPAddresses_V1_0_0_IPv6StaticAddress_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishIPAddresses_V1_0_0_IPv6StaticAddress_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Address
...
//
//Generate C structure for RedfishIPAddresses_V1_0_0_IPv6StaticAddress_Array_CS
//
static RedfishCS_status GenIPv6StaticAddress_ArrayCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishIPAddresses_V1_0_0_IPv6StaticAddress_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishIPAddresses_V1_0_0_IPv6StaticAddress_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishIPAddresses_V1_0_0_IPv6StaticAddress_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenIPv6StaticAddress_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
//
static RedfishCS_status GenLinksCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_3_0_EthernetInterface_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEthernetInterface_V1_3_0_EthernetInterface_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
//Generate C structure for VLAN
//
static RedfishCS_status GenVLANCs(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishVLanNetworkInterface_V1_0_0_VLAN_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVLanNetworkInterface_V1_0_0_VLAN_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // VLANId
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "VLANId", &(*Dst)->Id);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // VLANEnable
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "VLANEnable", &(*Dst)->VLANEnable);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // VLANId
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "VLANId", &(*Dst)->VLANId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_3_0_EthernetInterface_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_IPv4AddressesOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_IPv4Addresses(json_t *CsJson, char *Key, RedfishIPAddresses_V1_0_0_IPv4Address_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishIPAddresses_V1_0_0_IPv4Address_Array_CS *NextArray;
  RedfishIPAddresses_V1_0_0_IPv4Address_CS *NextArrayItem;
  ...
  do {
    ...
    // Address 
    if (InsertJsonStringObj (ArrayMember, "Address", NextArrayItem->Address) != RedfishCS_status_success) {goto Error;}

    // AddressOrigin 
    if (InsertJsonStringObj (ArrayMember, "AddressOrigin", NextArrayItem->AddressOrigin) != RedfishCS_status_success) {goto Error;}

    // Gateway 
    if (InsertJsonStringObj (ArrayMember, "Gateway", NextArrayItem->Gateway) != RedfishCS_status_success) {goto Error;}

    // Oem
    if (CS_To_JSON_IPv4AddressesOem(ArrayMember, "Oem", NextArrayItem->Oem) != RedfishCS_status_success) {goto Error;}

    // Origin 
    if (InsertJsonStringObj (ArrayMember, "Origin", NextArrayItem->Origin) != RedfishCS_status_success) {goto Error;}

    // SubnetMask 
    if (InsertJsonStringObj (ArrayMember, "SubnetMask", NextArrayItem->SubnetMask) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_IPv6AddressPolicyTable(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_Array_CS *NextArray;
  RedfishEthernetInterface_V1_3_0_IPv6AddressPolicyEntry_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_IPv6AddressesOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_IPv6Addresses(json_t *CsJson, char *Key, RedfishIPAddresses_V1_0_0_IPv6Address_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishIPAddresses_V1_0_0_IPv6Address_Array_CS *NextArray;
  RedfishIPAddresses_V1_0_0_IPv6Address_CS *NextArrayItem;
  ...
  do {
    ...
    // AddressState 
    if (InsertJsonStringObj (ArrayMember, "AddressState", NextArrayItem->AddressState) != RedfishCS_status_success) {goto Error;}

    // Oem
    if (CS_To_JSON_IPv6AddressesOem(ArrayMember, "Oem", NextArrayItem->Oem) != RedfishCS_status_success) {goto Error;}

    // Origin 
    if (InsertJsonStringObj (ArrayMember, "Origin", NextArrayItem->Origin) != RedfishCS_status_success) {goto Error;}

    // PrefixLength 
    if (InsertJsonInt64Obj (ArrayMember, "PrefixLength", NextArrayItem->PrefixLength) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_IPv6StaticAddressesOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_IPv6StaticAddresses(json_t *CsJson, char *Key, RedfishIPAddresses_V1_0_0_IPv6StaticAddress_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishIPAddresses_V1_0_0_IPv6StaticAddress_Array_CS *NextArray;
  RedfishIPAddresses_V1_0_0_IPv6StaticAddress_CS *NextArrayItem;
  ...
  do {
    ...
    // Oem
    if (CS_To_JSON_IPv6StaticAddressesOem(ArrayMember, "Oem", NextArrayItem->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_3_0_EthernetInterface_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_VLAN(json_t *CsJson, char *Key, RedfishVLanNetworkInterface_V1_0_0_VLAN_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Id 
  if (InsertJsonInt64Obj (CsJson, "Id", CSPtr->Id) != RedfishCS_status_success) {goto Error;}

  // VLANEnable 
  if (InsertJsonBoolObj (CsJson, "VLANEnable", CSPtr->VLANEnable) != RedfishCS_status_success) {goto Error;}

  // VLANId 
  if (InsertJsonInt64Obj (CsJson, "VLANId", CSPtr->VLANId) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for EthernetInterface.V1_3_0.EthernetInterface
//
RedfishCS_status CS_To_EthernetInterface_V1_3_0_JSON(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // IPv4Addresses
  if (CS_To_JSON_IPv4Addresses(CsJson, "IPv4Addresses", CSPtr->IPv4Addresses) != RedfishCS_status_success) {goto Error;}
  ...
  // IPv6Addresses
  if (CS_To_JSON_IPv6Addresses(CsJson, "IPv6Addresses", CSPtr->IPv6Addresses) != RedfishCS_status_success) {goto Error;}

  // IPv6DefaultGateway 
  if (InsertJsonStringObj (CsJson, "IPv6DefaultGateway", CSPtr->IPv6DefaultGateway) != RedfishCS_status_success) {goto Error;}

  // IPv6StaticAddresses
  if (CS_To_JSON_IPv6StaticAddresses(CsJson, "IPv6StaticAddresses", CSPtr->IPv6StaticAddresses) != RedfishCS_status_success) {goto Error;}
  ...
  // VLAN
  if (CS_To_JSON_VLAN(CsJson, "VLAN", CSPtr->VLAN) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for EthernetInterface.V1_3_0.EthernetInterface
//
RedfishCS_status DestroyEthernetInterface_V1_3_0_CS(RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EthernetInterface.V1_3_0.EthernetInterface
//
RedfishCS_status DestroyEthernetInterface_V1_3_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EthernetInterface.V1_3_0.EthernetInterface
//
RedfishCS_status
Json_EthernetInterface_V1_3_0_To_CS(RedfishCS_char *JsonRawText, RedfishEthernetInterface_V1_3_0_EthernetInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEthernetInterface_V1_3_0_EthernetInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EthernetInterface", "v1_3_0", "EthernetInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEthernetInterface_V1_3_0_EthernetInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // IPv4Addresses
  Status = GenIPv4Address_ArrayCs (Cs, JsonObj, "IPv4Addresses", &Cs->IPv4Addresses);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // IPv6Addresses
  Status = GenIPv6Address_ArrayCs (Cs, JsonObj, "IPv6Addresses", &Cs->IPv6Addresses);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // IPv6StaticAddresses
  Status = GenIPv6StaticAddress_ArrayCs (Cs, JsonObj, "IPv6StaticAddresses", &Cs->IPv6StaticAddresses);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // VLAN
  Status = GenVLANCs (Cs, JsonObj, "VLAN", &Cs->VLAN);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyEthernetInterface_V1_3_0_CS (Cs);
  return Status;
}
