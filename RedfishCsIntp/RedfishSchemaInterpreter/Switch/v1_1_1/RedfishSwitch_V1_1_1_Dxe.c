...
//
#include <RedfishInterpreter/Switch/v1_1_1/EfiSwitchV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_1_1 
...
{
  EFI_REDFISH_SWITCH_V1_1_1 *SwitchV1_1_1;
  EFI_REDFISH_SWITCH_V1_1_1_CS *SwitchV1_1_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Switch") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Switch_V1_1_1_To_CS (ResoruceRaw, &SwitchV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_1_1 = (EFI_REDFISH_SWITCH_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_1_1));
  if (SwitchV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SwitchV1_1_1;
  SwitchV1_1_1->Switch = SwitchV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SWITCH_V1_1_1_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Switch"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Switch");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Switch"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Switch");
...
)
{
  ...
  return CS_To_Switch_V1_1_1_JSON (*((EFI_REDFISH_SWITCH_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in SwitchToStruct.
...
)
{
  ...
  SwitchV1_1_1 = (EFI_REDFISH_SWITCH_V1_1_1 *)InterpProp;
  DestroySwitch_V1_1_1_CS (SwitchV1_1_1->Switch); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SwitchFromEfiStruct
...
)
{
  ...
  return DestroySwitch_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_1_1EntryPoint (
