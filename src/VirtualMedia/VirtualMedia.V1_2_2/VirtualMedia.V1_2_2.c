...
#include"Redfish_VirtualMedia_v1_2_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
//Generate C structure for #VirtualMedia.EjectMedia
//
static RedfishCS_status GenEjectMediaCs(RedfishVirtualMedia_V1_2_2_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_2_2_EjectMedia_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_2_2_EjectMedia_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for #VirtualMedia.InsertMedia
//
static RedfishCS_status GenInsertMediaCs(RedfishVirtualMedia_V1_2_2_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_2_2_InsertMedia_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_2_2_InsertMedia_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishVirtualMedia_V1_2_2_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_2_2_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_2_2_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishVirtualMedia_V1_2_2_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_2_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_2_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #VirtualMedia.EjectMedia
  Status = GenEjectMediaCs (Cs, TempJsonObj, "#VirtualMedia.EjectMedia", &(*Dst)->VirtualMedia_EjectMedia);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // #VirtualMedia.InsertMedia
  Status = GenInsertMediaCs (Cs, TempJsonObj, "#VirtualMedia.InsertMedia", &(*Dst)->VirtualMedia_InsertMedia);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishVirtualMedia_V1_2_2_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_2_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsVirtualMedia_EjectMedia(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_2_2_EjectMedia_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsVirtualMedia_InsertMedia(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_2_2_InsertMedia_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_2_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #VirtualMedia.EjectMedia
  if (CS_To_JSON_ActionsVirtualMedia_EjectMedia(CsJson, "#VirtualMedia.EjectMedia", CSPtr->VirtualMedia_EjectMedia) != RedfishCS_status_success) {goto Error;}

  // #VirtualMedia.InsertMedia
  if (CS_To_JSON_ActionsVirtualMedia_InsertMedia(CsJson, "#VirtualMedia.InsertMedia", CSPtr->VirtualMedia_InsertMedia) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for VirtualMedia.V1_2_2.VirtualMedia
//
RedfishCS_status CS_To_VirtualMedia_V1_2_2_JSON(RedfishVirtualMedia_V1_2_2_VirtualMedia_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // ConnectedVia 
  if (InsertJsonStringObj (CsJson, "ConnectedVia", CSPtr->ConnectedVia) != RedfishCS_status_success) {goto Error;}
  ...
  // Image 
  if (InsertJsonStringObj (CsJson, "Image", CSPtr->Image) != RedfishCS_status_success) {goto Error;}

  // ImageName 
  if (InsertJsonStringObj (CsJson, "ImageName", CSPtr->ImageName) != RedfishCS_status_success) {goto Error;}

  // Inserted 
  if (InsertJsonBoolObj (CsJson, "Inserted", CSPtr->Inserted) != RedfishCS_status_success) {goto Error;}

  // MediaTypes 
  if (InsertJsonStringObj (CsJson, "MediaTypes", CSPtr->MediaTypes) != RedfishCS_status_success) {goto Error;}
  ...
  // WriteProtected 
  if (InsertJsonBoolObj (CsJson, "WriteProtected", CSPtr->WriteProtected) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for VirtualMedia.V1_2_2.VirtualMedia
//
RedfishCS_status DestroyVirtualMedia_V1_2_2_CS(RedfishVirtualMedia_V1_2_2_VirtualMedia_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VirtualMedia.V1_2_2.VirtualMedia
//
RedfishCS_status DestroyVirtualMedia_V1_2_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VirtualMedia.V1_2_2.VirtualMedia
//
RedfishCS_status
Json_VirtualMedia_V1_2_2_To_CS(RedfishCS_char *JsonRawText, RedfishVirtualMedia_V1_2_2_VirtualMedia_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVirtualMedia_V1_2_2_VirtualMedia_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VirtualMedia", "v1_2_2", "VirtualMedia", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVirtualMedia_V1_2_2_VirtualMedia_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ConnectedVia
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ConnectedVia", &Cs->ConnectedVia);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Image
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Image", &Cs->Image);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ImageName
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ImageName", &Cs->ImageName);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Inserted
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "Inserted", &Cs->Inserted);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MediaTypes
  Status = GetRedfishPropertyStr (Cs, JsonObj, "MediaTypes", &Cs->MediaTypes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // WriteProtected
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "WriteProtected", &Cs->WriteProtected);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyVirtualMedia_V1_2_2_CS (Cs);
  return Status;
}
