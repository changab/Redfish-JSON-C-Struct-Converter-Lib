...
//
#include <RedfishInterpreter/Bios/v1_0_4/EfiBiosV1_0_4.h>
...
{
  EFI_REDFISH_BIOS_V1_0_4 *BiosV1_0_4;
  EFI_REDFISH_BIOS_V1_0_4_CS *BiosV1_0_4Cs;
  ...
  Status = Json_Bios_V1_0_4_To_CS (ResoruceRaw, &BiosV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_0_4 = (EFI_REDFISH_BIOS_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_0_4));
  if (BiosV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)BiosV1_0_4;
  BiosV1_0_4->Bios = BiosV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_BIOS_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Bios_V1_0_4_JSON (*((EFI_REDFISH_BIOS_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  BiosV1_0_4 = (EFI_REDFISH_BIOS_V1_0_4 *)InterpProp;
  DestroyBios_V1_0_4_CS (BiosV1_0_4->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyBios_V1_0_4_Json (ResoruceRaw);
}
