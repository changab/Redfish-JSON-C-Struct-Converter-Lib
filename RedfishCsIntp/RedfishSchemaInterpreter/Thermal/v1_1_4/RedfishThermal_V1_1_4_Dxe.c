...
//
#include <RedfishInterpreter/Thermal/v1_1_4/EfiThermalV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_1_4 
...
{
  EFI_REDFISH_THERMAL_V1_1_4 *ThermalV1_1_4;
  EFI_REDFISH_THERMAL_V1_1_4_CS *ThermalV1_1_4Cs;
  ...
  Status = Json_Thermal_V1_1_4_To_CS (ResoruceRaw, &ThermalV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_1_4 = (EFI_REDFISH_THERMAL_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_1_4));
  if (ThermalV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_1_4;
  ThermalV1_1_4->Thermal = ThermalV1_1_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_1_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_1_4_JSON (*((EFI_REDFISH_THERMAL_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_1_4 = (EFI_REDFISH_THERMAL_V1_1_4 *)InterpProp;
  DestroyThermal_V1_1_4_CS (ThermalV1_1_4->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_1_4EntryPoint (
