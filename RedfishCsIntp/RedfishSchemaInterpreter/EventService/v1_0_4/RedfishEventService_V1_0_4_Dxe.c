...
//
#include <RedfishInterpreter/EventService/v1_0_4/EfiEventServiceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_4 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_4 *EventServiceV1_0_4;
  EFI_REDFISH_EVENTSERVICE_V1_0_4_CS *EventServiceV1_0_4Cs;
  ...
  Status = Json_EventService_V1_0_4_To_CS (ResoruceRaw, &EventServiceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_4 = (EFI_REDFISH_EVENTSERVICE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_4));
  if (EventServiceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_0_4;
  EventServiceV1_0_4->EventService = EventServiceV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventService_V1_0_4_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventServiceV1_0_4 = (EFI_REDFISH_EVENTSERVICE_V1_0_4 *)InterpProp;
  DestroyEventService_V1_0_4_CS (EventServiceV1_0_4->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventService_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
