# Definition of TriggersCollection and functions<br><br>
...
## Redfish TriggersCollection  to C Structure Function
    RedfishCS_status
    Json_TriggersCollection_To_CS (RedfishCS_char *JsonRawText, RedfishTriggersCollection_TriggersCollection_CS **ReturnedCS);

## C Structure to Redfish TriggersCollection  JSON Function
    RedfishCS_status
    CS_To_TriggersCollection_JSON (RedfishTriggersCollection_TriggersCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish TriggersCollection  C Structure Function
    RedfishCS_status
