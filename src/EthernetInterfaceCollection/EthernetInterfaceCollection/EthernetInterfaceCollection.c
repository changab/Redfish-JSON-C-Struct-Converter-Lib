...
#include"Redfish_EthernetInterfaceCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishEthernetInterfaceCollection_EthernetInterfaceCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for EthernetInterfaceCollection.EthernetInterfaceCollection
//
RedfishCS_status CS_To_EthernetInterfaceCollection_JSON(RedfishEthernetInterfaceCollection_EthernetInterfaceCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EthernetInterfaceCollection.EthernetInterfaceCollection
//
RedfishCS_status DestroyEthernetInterfaceCollection_CS(RedfishEthernetInterfaceCollection_EthernetInterfaceCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EthernetInterfaceCollection.EthernetInterfaceCollection
//
RedfishCS_status DestroyEthernetInterfaceCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EthernetInterfaceCollection.NOVERSIONED.EthernetInterfaceCollection
//
RedfishCS_status
Json_EthernetInterfaceCollection_To_CS(RedfishCS_char *JsonRawText, RedfishEthernetInterfaceCollection_EthernetInterfaceCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEthernetInterfaceCollection_EthernetInterfaceCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EthernetInterfaceCollection", "noversioned", "EthernetInterfaceCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEthernetInterfaceCollection_EthernetInterfaceCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEthernetInterfaceCollection_CS (Cs);
  return Status;
}
