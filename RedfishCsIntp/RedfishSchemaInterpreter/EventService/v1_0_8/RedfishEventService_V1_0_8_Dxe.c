...
//
#include <RedfishInterpreter/EventService/v1_0_8/EfiEventServiceV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_8 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_8 *EventServiceV1_0_8;
  EFI_REDFISH_EVENTSERVICE_V1_0_8_CS *EventServiceV1_0_8Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "8") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "EventService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_EventService_V1_0_8_To_CS (ResoruceRaw, &EventServiceV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_8 = (EFI_REDFISH_EVENTSERVICE_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_8));
  if (EventServiceV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_0_8;
  EventServiceV1_0_8->EventService = EventServiceV1_0_8Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "8";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_8_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventService_V1_0_8_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventServiceV1_0_8 = (EFI_REDFISH_EVENTSERVICE_V1_0_8 *)InterpProp;
  DestroyEventService_V1_0_8_CS (EventServiceV1_0_8->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventService_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
