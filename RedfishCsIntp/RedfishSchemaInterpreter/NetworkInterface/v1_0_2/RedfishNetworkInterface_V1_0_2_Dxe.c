...
//
#include <RedfishInterpreter/NetworkInterface/v1_0_2/EfiNetworkInterfaceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#NetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkInterface V1_0_2 
...
{
  EFI_REDFISH_NETWORKINTERFACE_V1_0_2 *NetworkInterfaceV1_0_2;
  EFI_REDFISH_NETWORKINTERFACE_V1_0_2_CS *NetworkInterfaceV1_0_2Cs;
  ...
  Status = Json_NetworkInterface_V1_0_2_To_CS (ResoruceRaw, &NetworkInterfaceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkInterfaceV1_0_2 = (EFI_REDFISH_NETWORKINTERFACE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_0_2));
  if (NetworkInterfaceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkInterfaceV1_0_2;
  NetworkInterfaceV1_0_2->NetworkInterface = NetworkInterfaceV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkInterface_V1_0_2_JSON (*((EFI_REDFISH_NETWORKINTERFACE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkInterfaceV1_0_2 = (EFI_REDFISH_NETWORKINTERFACE_V1_0_2 *)InterpProp;
  DestroyNetworkInterface_V1_0_2_CS (NetworkInterfaceV1_0_2->NetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkInterface_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
