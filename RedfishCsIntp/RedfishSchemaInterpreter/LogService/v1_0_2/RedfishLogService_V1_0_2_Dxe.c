...
//
#include <RedfishInterpreter/LogService/v1_0_2/EfiLogServiceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_2 
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_2 *LogServiceV1_0_2;
  EFI_REDFISH_LOGSERVICE_V1_0_2_CS *LogServiceV1_0_2Cs;
  ...
  Status = Json_LogService_V1_0_2_To_CS (ResoruceRaw, &LogServiceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_2 = (EFI_REDFISH_LOGSERVICE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_2));
  if (LogServiceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogServiceV1_0_2;
  LogServiceV1_0_2->LogService = LogServiceV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_LOGSERVICE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogService_V1_0_2_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogServiceV1_0_2 = (EFI_REDFISH_LOGSERVICE_V1_0_2 *)InterpProp;
  DestroyLogService_V1_0_2_CS (LogServiceV1_0_2->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogService_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
