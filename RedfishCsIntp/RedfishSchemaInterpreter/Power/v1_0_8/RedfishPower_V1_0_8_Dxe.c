...
//
#include <RedfishInterpreter/Power/v1_0_8/EfiPowerV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_0_8 
...
{
  EFI_REDFISH_POWER_V1_0_8 *PowerV1_0_8;
  EFI_REDFISH_POWER_V1_0_8_CS *PowerV1_0_8Cs;
  ...
  Status = Json_Power_V1_0_8_To_CS (ResoruceRaw, &PowerV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_0_8 = (EFI_REDFISH_POWER_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_0_8));
  if (PowerV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_0_8;
  PowerV1_0_8->Power = PowerV1_0_8Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "8";
  Length = sizeof (EFI_REDFISH_POWER_V1_0_8_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_0_8_JSON (*((EFI_REDFISH_POWER_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_0_8 = (EFI_REDFISH_POWER_V1_0_8 *)InterpProp;
  DestroyPower_V1_0_8_CS (PowerV1_0_8->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_0_8_Json (ResoruceRaw);
}
