...
//
#include <RedfishInterpreter/Storage/v1_1_1/EfiStorageV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_1_1 
...
{
  EFI_REDFISH_STORAGE_V1_1_1 *StorageV1_1_1;
  EFI_REDFISH_STORAGE_V1_1_1_CS *StorageV1_1_1Cs;
  ...
  Status = Json_Storage_V1_1_1_To_CS (ResoruceRaw, &StorageV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_1_1 = (EFI_REDFISH_STORAGE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_1_1));
  if (StorageV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_1_1;
  StorageV1_1_1->Storage = StorageV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_1_1_JSON (*((EFI_REDFISH_STORAGE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_1_1 = (EFI_REDFISH_STORAGE_V1_1_1 *)InterpProp;
  DestroyStorage_V1_1_1_CS (StorageV1_1_1->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_1_1EntryPoint (
