...
//
#include <RedfishInterpreter/MemoryDomain/v1_1_0/EfiMemoryDomainV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_1_0 
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_1_0 *MemoryDomainV1_1_0;
  EFI_REDFISH_MEMORYDOMAIN_V1_1_0_CS *MemoryDomainV1_1_0Cs;
  ...
  Status = Json_MemoryDomain_V1_1_0_To_CS (ResoruceRaw, &MemoryDomainV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_1_0 = (EFI_REDFISH_MEMORYDOMAIN_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_1_0));
  if (MemoryDomainV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryDomainV1_1_0;
  MemoryDomainV1_1_0->MemoryDomain = MemoryDomainV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryDomain_V1_1_0_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryDomainV1_1_0 = (EFI_REDFISH_MEMORYDOMAIN_V1_1_0 *)InterpProp;
  DestroyMemoryDomain_V1_1_0_CS (MemoryDomainV1_1_0->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryDomain_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
