...
#ifndef _RedfishFabric_V1_0_3_CSTRUCT_H_
#define _RedfishFabric_V1_0_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishFabric_V1_0_3_Actions_CS RedfishFabric_V1_0_3_Actions_CS;
typedef struct _RedfishFabric_V1_0_3_Fabric_CS RedfishFabric_V1_0_3_Fabric_CS;
typedef struct _RedfishFabric_V1_0_3_Links_CS RedfishFabric_V1_0_3_Links_CS;
typedef struct _RedfishFabric_V1_0_3_OemActions_CS RedfishFabric_V1_0_3_OemActions_CS;
...
typedef struct _RedfishFabric_V1_0_3_Fabric_CS {
    ...
    RedfishFabric_V1_0_3_Actions_CS    *Actions;         // The available actions for this
                                                         // resource.
    ...
    RedfishCS_char                     *FabricType;      // The protocol being sent over
                                                         // this fabric.
    RedfishCS_char                     *Id;          
    RedfishFabric_V1_0_3_Links_CS      *Links;           // Contains references to other
...
RedfishCS_status
Json_Fabric_V1_0_3_To_CS (char *JsonRawText, RedfishFabric_V1_0_3_Fabric_CS **ReturnedCS);

RedfishCS_status
CS_To_Fabric_V1_0_3_JSON (RedfishFabric_V1_0_3_Fabric_CS *CSPtr, char **JsonText);
