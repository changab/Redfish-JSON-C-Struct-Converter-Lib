...
//
#include <RedfishInterpreter/SerialInterface/v1_1_0/EfiSerialInterfaceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_1_0 
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_1_0 *SerialInterfaceV1_1_0;
  EFI_REDFISH_SERIALINTERFACE_V1_1_0_CS *SerialInterfaceV1_1_0Cs;
  ...
  Status = Json_SerialInterface_V1_1_0_To_CS (ResoruceRaw, &SerialInterfaceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_1_0 = (EFI_REDFISH_SERIALINTERFACE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_0));
  if (SerialInterfaceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SerialInterfaceV1_1_0;
  SerialInterfaceV1_1_0->SerialInterface = SerialInterfaceV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SerialInterface_V1_1_0_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SerialInterfaceV1_1_0 = (EFI_REDFISH_SERIALINTERFACE_V1_1_0 *)InterpProp;
  DestroySerialInterface_V1_1_0_CS (SerialInterfaceV1_1_0->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySerialInterface_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
