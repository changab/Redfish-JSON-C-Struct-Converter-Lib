# Definition of ResourceBlockCollection and functions<br><br>
...
## Redfish ResourceBlockCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish ResourceBlockCollection  JSON Function
    RedfishCS_status
    CS_To_ResourceBlockCollection_JSON (RedfishResourceBlockCollection_ResourceBlockCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ResourceBlockCollection  C Structure Function
    RedfishCS_status
