...
//
#include <RedfishInterpreter/Task/v1_0_4/EfiTaskV1_0_4.h>
...
{
  EFI_REDFISH_TASK_V1_0_4 *TaskV1_0_4;
  EFI_REDFISH_TASK_V1_0_4_CS *TaskV1_0_4Cs;
  ...
  Status = Json_Task_V1_0_4_To_CS (ResoruceRaw, &TaskV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_0_4 = (EFI_REDFISH_TASK_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_0_4));
  if (TaskV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskV1_0_4;
  TaskV1_0_4->Task = TaskV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_TASK_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Task_V1_0_4_JSON (*((EFI_REDFISH_TASK_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskV1_0_4 = (EFI_REDFISH_TASK_V1_0_4 *)InterpProp;
  DestroyTask_V1_0_4_CS (TaskV1_0_4->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTask_V1_0_4_Json (ResoruceRaw);
}
