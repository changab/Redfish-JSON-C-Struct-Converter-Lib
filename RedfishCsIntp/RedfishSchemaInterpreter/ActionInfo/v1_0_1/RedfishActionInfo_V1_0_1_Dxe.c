...
//
#include <RedfishInterpreter/ActionInfo/v1_0_1/EfiActionInfoV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_0_1 
...
{
  EFI_REDFISH_ACTIONINFO_V1_0_1 *ActionInfoV1_0_1;
  EFI_REDFISH_ACTIONINFO_V1_0_1_CS *ActionInfoV1_0_1Cs;
  ...
  Status = Json_ActionInfo_V1_0_1_To_CS (ResoruceRaw, &ActionInfoV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_0_1 = (EFI_REDFISH_ACTIONINFO_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_0_1));
  if (ActionInfoV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ActionInfoV1_0_1;
  ActionInfoV1_0_1->ActionInfo = ActionInfoV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ACTIONINFO_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ActionInfo_V1_0_1_JSON (*((EFI_REDFISH_ACTIONINFO_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ActionInfoV1_0_1 = (EFI_REDFISH_ACTIONINFO_V1_0_1 *)InterpProp;
  DestroyActionInfo_V1_0_1_CS (ActionInfoV1_0_1->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyActionInfo_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
