...
#ifndef _RedfishStorage_V1_1_5_CSTRUCT_H_
#define _RedfishStorage_V1_1_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

#ifndef __RedfishResource_Oem_CS__
typedef struct _RedfishStorage_V1_1_5_StorageController_Array_CS RedfishStorage_V1_1_5_StorageController_Array_CS;
...
typedef struct _RedfishStorage_V1_1_5_Actions_CS RedfishStorage_V1_1_5_Actions_CS;
typedef struct _RedfishStorage_V1_1_5_Links_CS RedfishStorage_V1_1_5_Links_CS;
typedef struct _RedfishStorage_V1_1_5_OemActions_CS RedfishStorage_V1_1_5_OemActions_CS;
typedef struct _RedfishStorage_V1_1_5_SetEncryptionKey_CS RedfishStorage_V1_1_5_SetEncryptionKey_CS;
typedef struct _RedfishStorage_V1_1_5_Storage_CS RedfishStorage_V1_1_5_Storage_CS;
typedef struct _RedfishStorage_V1_1_5_StorageController_CS RedfishStorage_V1_1_5_StorageController_CS;
typedef struct _RedfishStorage_V1_1_5_StorageControllerLinks_CS RedfishStorage_V1_1_5_StorageControllerLinks_CS;
//
...
typedef struct _RedfishStorage_V1_1_5_Actions_CS {
    ...
    RedfishStorage_V1_1_5_OemActions_CS          *Oem;                        // This property contains the
...
typedef struct _RedfishStorage_V1_1_5_StorageController_CS {
    ...
    RedfishCS_Link                                     Identifiers;                     // The Durable names for the
                                                                                        // storage controller.
    RedfishStorage_V1_1_5_StorageControllerLinks_CS    *Links;                          // Contains references to other
...
typedef struct _RedfishStorage_V1_1_5_Storage_CS {
    ...
    RedfishStorage_V1_1_5_Actions_CS                    *Actions;                         // The available actions for this
                                                                                          // resource.
    ...
    RedfishCS_char                                      *Id;                          
    RedfishStorage_V1_1_5_Links_CS                      *Links;                           // Contains references to other
                                                                                          // resources that are related to
                                                                                          // this resource.
    RedfishCS_char                                      *Name;                        
    RedfishResource_Oem_CS                              *Oem;                             // This is the
    ...
    RedfishResource_Status_CS                           *Status;                          // This property describes the
                                                                                          // status and health of the
                                                                                          // resource and its children.
    RedfishStorage_V1_1_5_StorageController_Array_CS    *StorageControllers;              // The set of storage controllers
                                                                                          // represented by this resource.
...
typedef struct _RedfishStorage_V1_1_5_StorageController_Array_CS  {
    RedfishStorage_V1_1_5_StorageController_Array_CS    *Next;
    RedfishStorage_V1_1_5_StorageController_CS    *ArrayValue;
} RedfishStorage_V1_1_5_StorageController_Array_CS;

RedfishCS_status
Json_Storage_V1_1_5_To_CS (char *JsonRawText, RedfishStorage_V1_1_5_Storage_CS **ReturnedCS);

RedfishCS_status
CS_To_Storage_V1_1_5_JSON (RedfishStorage_V1_1_5_Storage_CS *CSPtr, char **JsonText);
