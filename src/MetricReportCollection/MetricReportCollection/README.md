# Definition of MetricReportCollection and functions<br><br>
...
## Redfish MetricReportCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish MetricReportCollection  JSON Function
    RedfishCS_status
    CS_To_MetricReportCollection_JSON (RedfishMetricReportCollection_MetricReportCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MetricReportCollection  C Structure Function
    RedfishCS_status
