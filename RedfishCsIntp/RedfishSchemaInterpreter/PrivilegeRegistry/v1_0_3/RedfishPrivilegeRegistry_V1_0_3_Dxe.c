...
//
#include <RedfishInterpreter/PrivilegeRegistry/v1_0_3/EfiPrivilegeRegistryV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_0_3 
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_3 *PrivilegeRegistryV1_0_3;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_3_CS *PrivilegeRegistryV1_0_3Cs;
  ...
  Status = Json_PrivilegeRegistry_V1_0_3_To_CS (ResoruceRaw, &PrivilegeRegistryV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_0_3 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_3));
  if (PrivilegeRegistryV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PrivilegeRegistryV1_0_3;
  PrivilegeRegistryV1_0_3->PrivilegeRegistry = PrivilegeRegistryV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PrivilegeRegistry_V1_0_3_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PrivilegeRegistryV1_0_3 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_3 *)InterpProp;
  DestroyPrivilegeRegistry_V1_0_3_CS (PrivilegeRegistryV1_0_3->PrivilegeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPrivilegeRegistry_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
