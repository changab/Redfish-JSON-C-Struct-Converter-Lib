...
//
#include <RedfishInterpreter/Role/v1_1_1/EfiRoleV1_1_1.h>
...
{
  EFI_REDFISH_ROLE_V1_1_1 *RoleV1_1_1;
  EFI_REDFISH_ROLE_V1_1_1_CS *RoleV1_1_1Cs;
  ...
  Status = Json_Role_V1_1_1_To_CS (ResoruceRaw, &RoleV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_1_1 = (EFI_REDFISH_ROLE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_1_1));
  if (RoleV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)RoleV1_1_1;
  RoleV1_1_1->Role = RoleV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ROLE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Role_V1_1_1_JSON (*((EFI_REDFISH_ROLE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  RoleV1_1_1 = (EFI_REDFISH_ROLE_V1_1_1 *)InterpProp;
  DestroyRole_V1_1_1_CS (RoleV1_1_1->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyRole_V1_1_1_Json (ResoruceRaw);
}
