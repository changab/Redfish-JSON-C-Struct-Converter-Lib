...
//
#include <RedfishInterpreter/SimpleStorage/v1_0_5/EfiSimpleStorageV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_0_5 
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_0_5 *SimpleStorageV1_0_5;
  EFI_REDFISH_SIMPLESTORAGE_V1_0_5_CS *SimpleStorageV1_0_5Cs;
  ...
  Status = Json_SimpleStorage_V1_0_5_To_CS (ResoruceRaw, &SimpleStorageV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_0_5 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_5));
  if (SimpleStorageV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SimpleStorageV1_0_5;
  SimpleStorageV1_0_5->SimpleStorage = SimpleStorageV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SimpleStorage_V1_0_5_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SimpleStorageV1_0_5 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_5 *)InterpProp;
  DestroySimpleStorage_V1_0_5_CS (SimpleStorageV1_0_5->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySimpleStorage_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
