...
//
#include <RedfishInterpreter/Zone/v1_0_2/EfiZoneV1_0_2.h>
...
{
  EFI_REDFISH_ZONE_V1_0_2 *ZoneV1_0_2;
  EFI_REDFISH_ZONE_V1_0_2_CS *ZoneV1_0_2Cs;
  ...
  Status = Json_Zone_V1_0_2_To_CS (ResoruceRaw, &ZoneV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_0_2 = (EFI_REDFISH_ZONE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_0_2));
  if (ZoneV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ZoneV1_0_2;
  ZoneV1_0_2->Zone = ZoneV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_ZONE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Zone_V1_0_2_JSON (*((EFI_REDFISH_ZONE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ZoneV1_0_2 = (EFI_REDFISH_ZONE_V1_0_2 *)InterpProp;
  DestroyZone_V1_0_2_CS (ZoneV1_0_2->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyZone_V1_0_2_Json (ResoruceRaw);
}
