...
#ifndef _RedfishMessageregistry_V1_0_0_CSTRUCT_H_
#define _RedfishMessageregistry_V1_0_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMessageRegistry_V1_0_0_Message_CS RedfishMessageRegistry_V1_0_0_Message_CS;
typedef struct _RedfishMessageRegistry_V1_0_0_MessageProperty_CS RedfishMessageRegistry_V1_0_0_MessageProperty_CS;
typedef struct _RedfishMessageRegistry_V1_0_0_MessageRegistry_CS RedfishMessageRegistry_V1_0_0_MessageRegistry_CS;
...
typedef struct _RedfishMessageRegistry_V1_0_0_MessageRegistry_CS {
    ...
    RedfishCS_char                                      *Language;          // This is the RFC 5646 compliant
                                                                            ...
                                                                            // registry.
    RedfishMessageRegistry_V1_0_0_MessageProperty_CS    *Messages;          // The pattern property indicates
...
RedfishCS_status
Json_MessageRegistry_V1_0_0_To_CS (char *JsonRawText, RedfishMessageRegistry_V1_0_0_MessageRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_MessageRegistry_V1_0_0_JSON (RedfishMessageRegistry_V1_0_0_MessageRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMessageRegistry_V1_0_0_CS (RedfishMessageRegistry_V1_0_0_MessageRegistry_CS *CSPtr);

RedfishCS_status
DestroyMessageRegistry_V1_0_0_Json (RedfishCS_char *JsonText);
