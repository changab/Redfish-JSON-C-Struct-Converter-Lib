...
#include"Redfish_ProcessorCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishProcessorCollection_ProcessorCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ProcessorCollection.ProcessorCollection
//
RedfishCS_status CS_To_ProcessorCollection_JSON(RedfishProcessorCollection_ProcessorCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ProcessorCollection.ProcessorCollection
//
RedfishCS_status DestroyProcessorCollection_CS(RedfishProcessorCollection_ProcessorCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ProcessorCollection.ProcessorCollection
//
RedfishCS_status DestroyProcessorCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ProcessorCollection.NOVERSIONED.ProcessorCollection
//
RedfishCS_status
Json_ProcessorCollection_To_CS(RedfishCS_char *JsonRawText, RedfishProcessorCollection_ProcessorCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishProcessorCollection_ProcessorCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ProcessorCollection", "noversioned", "ProcessorCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishProcessorCollection_ProcessorCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyProcessorCollection_CS (Cs);
  return Status;
}
