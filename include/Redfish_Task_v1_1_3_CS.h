...
#ifndef _RedfishTask_V1_1_3_CSTRUCT_H_
#define _RedfishTask_V1_1_3_CSTRUCT_H_
...
typedef struct _RedfishTask_V1_1_3_Actions_CS RedfishTask_V1_1_3_Actions_CS;
typedef struct _RedfishTask_V1_1_3_OemActions_CS RedfishTask_V1_1_3_OemActions_CS;
typedef struct _RedfishTask_V1_1_3_Task_CS RedfishTask_V1_1_3_Task_CS;
//
...
typedef struct _RedfishTask_V1_1_3_Actions_CS {
    RedfishTask_V1_1_3_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishTask_V1_1_3_Task_CS {
    ...
    RedfishTask_V1_1_3_Actions_CS    *Actions;         // The available actions for this
                                                       // resource.
...
RedfishCS_status
Json_Task_V1_1_3_To_CS (char *JsonRawText, RedfishTask_V1_1_3_Task_CS **ReturnedCS);

RedfishCS_status
CS_To_Task_V1_1_3_JSON (RedfishTask_V1_1_3_Task_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyTask_V1_1_3_CS (RedfishTask_V1_1_3_Task_CS *CSPtr);

RedfishCS_status
DestroyTask_V1_1_3_Json (RedfishCS_char *JsonText);
