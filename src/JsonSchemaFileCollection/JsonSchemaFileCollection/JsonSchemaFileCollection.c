...
#include"Redfish_JsonSchemaFileCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishJsonSchemaFileCollection_JsonSchemaFileCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for JsonSchemaFileCollection.JsonSchemaFileCollection
//
RedfishCS_status CS_To_JsonSchemaFileCollection_JSON(RedfishJsonSchemaFileCollection_JsonSchemaFileCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for JsonSchemaFileCollection.JsonSchemaFileCollection
//
RedfishCS_status DestroyJsonSchemaFileCollection_CS(RedfishJsonSchemaFileCollection_JsonSchemaFileCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for JsonSchemaFileCollection.JsonSchemaFileCollection
//
RedfishCS_status DestroyJsonSchemaFileCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for JsonSchemaFileCollection.NOVERSIONED.JsonSchemaFileCollection
//
RedfishCS_status
Json_JsonSchemaFileCollection_To_CS(RedfishCS_char *JsonRawText, RedfishJsonSchemaFileCollection_JsonSchemaFileCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishJsonSchemaFileCollection_JsonSchemaFileCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "JsonSchemaFileCollection", "noversioned", "JsonSchemaFileCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishJsonSchemaFileCollection_JsonSchemaFileCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyJsonSchemaFileCollection_CS (Cs);
  return Status;
}
