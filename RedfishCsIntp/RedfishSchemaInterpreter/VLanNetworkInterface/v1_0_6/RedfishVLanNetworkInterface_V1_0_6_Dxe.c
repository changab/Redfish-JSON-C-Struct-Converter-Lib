...
//
#include <RedfishInterpreter/VLanNetworkInterface/v1_0_6/EfiVLanNetworkInterfaceV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_0_6 
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_6 *VLanNetworkInterfaceV1_0_6;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_6_CS *VLanNetworkInterfaceV1_0_6Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "6") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "VLanNetworkInterface") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_VLanNetworkInterface_V1_0_6_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_0_6 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_6));
  if (VLanNetworkInterfaceV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VLanNetworkInterfaceV1_0_6;
  VLanNetworkInterfaceV1_0_6->VLanNetworkInterface = VLanNetworkInterfaceV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VLanNetworkInterface_V1_0_6_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VLanNetworkInterfaceV1_0_6 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_6 *)InterpProp;
  DestroyVLanNetworkInterface_V1_0_6_CS (VLanNetworkInterfaceV1_0_6->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVLanNetworkInterface_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
