...
//
#include <RedfishInterpreter/SimpleStorage/v1_0_3/EfiSimpleStorageV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_0_3 
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_0_3 *SimpleStorageV1_0_3;
  EFI_REDFISH_SIMPLESTORAGE_V1_0_3_CS *SimpleStorageV1_0_3Cs;
  ...
  Status = Json_SimpleStorage_V1_0_3_To_CS (ResoruceRaw, &SimpleStorageV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_0_3 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_3));
  if (SimpleStorageV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SimpleStorageV1_0_3;
  SimpleStorageV1_0_3->SimpleStorage = SimpleStorageV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SimpleStorage_V1_0_3_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SimpleStorageV1_0_3 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_3 *)InterpProp;
  DestroySimpleStorage_V1_0_3_CS (SimpleStorageV1_0_3->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySimpleStorage_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
