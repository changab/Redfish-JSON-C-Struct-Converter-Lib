...
#include"Redfish_ResourceBlockCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishResourceBlockCollection_ResourceBlockCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ResourceBlockCollection.ResourceBlockCollection
//
RedfishCS_status CS_To_ResourceBlockCollection_JSON(RedfishResourceBlockCollection_ResourceBlockCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ResourceBlockCollection.ResourceBlockCollection
//
RedfishCS_status DestroyResourceBlockCollection_CS(RedfishResourceBlockCollection_ResourceBlockCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ResourceBlockCollection.ResourceBlockCollection
//
RedfishCS_status DestroyResourceBlockCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ResourceBlockCollection.NOVERSIONED.ResourceBlockCollection
//
RedfishCS_status
Json_ResourceBlockCollection_To_CS(RedfishCS_char *JsonRawText, RedfishResourceBlockCollection_ResourceBlockCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishResourceBlockCollection_ResourceBlockCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ResourceBlockCollection", "noversioned", "ResourceBlockCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishResourceBlockCollection_ResourceBlockCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyResourceBlockCollection_CS (Cs);
  return Status;
}
