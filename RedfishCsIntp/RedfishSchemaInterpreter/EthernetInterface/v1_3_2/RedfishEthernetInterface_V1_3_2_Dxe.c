...
//
#include <RedfishInterpreter/EthernetInterface/v1_3_2/EfiEthernetInterfaceV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_3_2 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_3_2 *EthernetInterfaceV1_3_2;
  EFI_REDFISH_ETHERNETINTERFACE_V1_3_2_CS *EthernetInterfaceV1_3_2Cs;
  ...
  Status = Json_EthernetInterface_V1_3_2_To_CS (ResoruceRaw, &EthernetInterfaceV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_3_2 = (EFI_REDFISH_ETHERNETINTERFACE_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_3_2));
  if (EthernetInterfaceV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_3_2;
  EthernetInterfaceV1_3_2->EthernetInterface = EthernetInterfaceV1_3_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_3_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EthernetInterface_V1_3_2_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EthernetInterfaceV1_3_2 = (EFI_REDFISH_ETHERNETINTERFACE_V1_3_2 *)InterpProp;
  DestroyEthernetInterface_V1_3_2_CS (EthernetInterfaceV1_3_2->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEthernetInterface_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_3_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_3_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
