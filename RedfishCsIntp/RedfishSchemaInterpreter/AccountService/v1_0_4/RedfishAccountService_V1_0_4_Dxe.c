...
//
#include <RedfishInterpreter/AccountService/v1_0_4/EfiAccountServiceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_0_4 
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_4 *AccountServiceV1_0_4;
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_4_CS *AccountServiceV1_0_4Cs;
  ...
  Status = Json_AccountService_V1_0_4_To_CS (ResoruceRaw, &AccountServiceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_0_4 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_4));
  if (AccountServiceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AccountServiceV1_0_4;
  AccountServiceV1_0_4->AccountService = AccountServiceV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AccountService_V1_0_4_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AccountServiceV1_0_4 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_4 *)InterpProp;
  DestroyAccountService_V1_0_4_CS (AccountServiceV1_0_4->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAccountService_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
