...
//
#include <RedfishInterpreter/SerialInterface/v1_0_6/EfiSerialInterfaceV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_0_6 
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_0_6 *SerialInterfaceV1_0_6;
  EFI_REDFISH_SERIALINTERFACE_V1_0_6_CS *SerialInterfaceV1_0_6Cs;
  ...
  Status = Json_SerialInterface_V1_0_6_To_CS (ResoruceRaw, &SerialInterfaceV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_0_6 = (EFI_REDFISH_SERIALINTERFACE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_6));
  if (SerialInterfaceV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SerialInterfaceV1_0_6;
  SerialInterfaceV1_0_6->SerialInterface = SerialInterfaceV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SerialInterface_V1_0_6_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SerialInterfaceV1_0_6 = (EFI_REDFISH_SERIALINTERFACE_V1_0_6 *)InterpProp;
  DestroySerialInterface_V1_0_6_CS (SerialInterfaceV1_0_6->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySerialInterface_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
