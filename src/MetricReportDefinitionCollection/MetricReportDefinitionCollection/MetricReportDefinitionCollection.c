...
#include"Redfish_MetricReportDefinitionCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishMetricReportDefinitionCollection_MetricReportDefinitionCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for MetricReportDefinitionCollection.MetricReportDefinitionCollection
//
RedfishCS_status CS_To_MetricReportDefinitionCollection_JSON(RedfishMetricReportDefinitionCollection_MetricReportDefinitionCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MetricReportDefinitionCollection.MetricReportDefinitionCollection
//
RedfishCS_status DestroyMetricReportDefinitionCollection_CS(RedfishMetricReportDefinitionCollection_MetricReportDefinitionCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MetricReportDefinitionCollection.MetricReportDefinitionCollection
//
RedfishCS_status DestroyMetricReportDefinitionCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MetricReportDefinitionCollection.NOVERSIONED.MetricReportDefinitionCollection
//
RedfishCS_status
Json_MetricReportDefinitionCollection_To_CS(RedfishCS_char *JsonRawText, RedfishMetricReportDefinitionCollection_MetricReportDefinitionCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMetricReportDefinitionCollection_MetricReportDefinitionCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MetricReportDefinitionCollection", "noversioned", "MetricReportDefinitionCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMetricReportDefinitionCollection_MetricReportDefinitionCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMetricReportDefinitionCollection_CS (Cs);
  return Status;
}
