...
#include"Redfish_SessionService_v1_1_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishSessionService_V1_1_4_SessionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishSessionService_V1_1_4_SessionService_CS *Cs, json_t *JsonObj, char *Key, RedfishSessionService_V1_1_4_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSessionService_V1_1_4_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishSessionService_V1_1_4_SessionService_CS *Cs, json_t *JsonObj, char *Key, RedfishSessionService_V1_1_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSessionService_V1_1_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenStatusCs(RedfishSessionService_V1_1_4_SessionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSessionService_V1_1_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSessionService_V1_1_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for SessionService.V1_1_4.SessionService
//
RedfishCS_status CS_To_SessionService_V1_1_4_JSON(RedfishSessionService_V1_1_4_SessionService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // SessionTimeout 
  if (InsertJsonInt64Obj (CsJson, "SessionTimeout", CSPtr->SessionTimeout) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for SessionService.V1_1_4.SessionService
//
RedfishCS_status DestroySessionService_V1_1_4_CS(RedfishSessionService_V1_1_4_SessionService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SessionService.V1_1_4.SessionService
//
RedfishCS_status DestroySessionService_V1_1_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SessionService.V1_1_4.SessionService
//
RedfishCS_status
Json_SessionService_V1_1_4_To_CS(RedfishCS_char *JsonRawText, RedfishSessionService_V1_1_4_SessionService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSessionService_V1_1_4_SessionService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SessionService", "v1_1_4", "SessionService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSessionService_V1_1_4_SessionService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // SessionTimeout
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "SessionTimeout", &Cs->SessionTimeout);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Sessions
  InitializeLinkHead (&Cs->Sessions);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Sessions", Cs->Header.ThisUri, &Cs->Sessions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroySessionService_V1_1_4_CS (Cs);
  return Status;
}
