# Definition of ComputerSystem.V1_0_0 and functions<br><br>
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ComputerSystem_Reset**|RedfishComputerSystem_V1_0_0_Reset_CS| Structure points to **#ComputerSystem.Reset** property.| No| No
|**Oem**|RedfishComputerSystem_V1_0_0_ComputerSystem_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## ComputerSystem
    typedef struct _RedfishComputerSystem_V1_0_0_ComputerSystem_CS {
        ...
        RedfishComputerSystem_V1_0_0_ComputerSystem_Actions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_char *BiosVersion;
        RedfishComputerSystem_V1_0_0_Boot_CS *Boot;
        RedfishCS_char *Description;
        RedfishCS_Link EthernetInterfaces;
        RedfishCS_char *HostName;
        RedfishCS_char *Id;
        RedfishCS_char *IndicatorLED;
        RedfishComputerSystem_V1_0_0_ComputerSystem_Links_CS *Links;
        RedfishCS_Link LogServices;
        RedfishCS_char *Manufacturer;
        RedfishComputerSystem_V1_0_0_MemorySummary_CS *MemorySummary;
        RedfishCS_char *Model;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_char *PartNumber;
        RedfishCS_char *PowerState;
        RedfishComputerSystem_V1_0_0_ProcessorSummary_CS *ProcessorSummary;
...
|**Actions**|RedfishComputerSystem_V1_0_0_ComputerSystem_Actions_CS| Structure points to **Actions** property.| No| Yes
|**AssetTag**|RedfishCS_char| String pointer to **AssetTag** property.| No| No
|**BiosVersion**|RedfishCS_char| String pointer to **BiosVersion** property.| No| No
|**Boot**|RedfishComputerSystem_V1_0_0_Boot_CS| Structure points to **Boot** property.| No| No
...
|**Links**|RedfishComputerSystem_V1_0_0_ComputerSystem_Links_CS| Structure points to **Links** property.| No| Yes
|**LogServices**|RedfishCS_Link| Structure link list to **LogServices** property.| No| Yes
|**Manufacturer**|RedfishCS_char| String pointer to **Manufacturer** property.| No| Yes
|**MemorySummary**|RedfishComputerSystem_V1_0_0_MemorySummary_CS| Structure points to **MemorySummary** property.| No| No
|**Model**|RedfishCS_char| String pointer to **Model** property.| No| Yes
...
|**ProcessorSummary**|RedfishComputerSystem_V1_0_0_ProcessorSummary_CS| Structure points to **ProcessorSummary** property.| No| No
...
## Redfish ComputerSystem V1_0_0 to C Structure Function
    RedfishCS_status
    Json_ComputerSystem_V1_0_0_To_CS (RedfishCS_char *JsonRawText, RedfishComputerSystem_V1_0_0_ComputerSystem_CS **ReturnedCS);

## C Structure to Redfish ComputerSystem V1_0_0 JSON Function
    RedfishCS_status
    CS_To_ComputerSystem_V1_0_0_JSON (RedfishComputerSystem_V1_0_0_ComputerSystem_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ComputerSystem V1_0_0 C Structure Function
    RedfishCS_status
