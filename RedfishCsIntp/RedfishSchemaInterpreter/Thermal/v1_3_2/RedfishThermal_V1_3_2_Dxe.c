...
//
#include <RedfishInterpreter/Thermal/v1_3_2/EfiThermalV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_3_2 
...
{
  EFI_REDFISH_THERMAL_V1_3_2 *ThermalV1_3_2;
  EFI_REDFISH_THERMAL_V1_3_2_CS *ThermalV1_3_2Cs;
  ...
  Status = Json_Thermal_V1_3_2_To_CS (ResoruceRaw, &ThermalV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_3_2 = (EFI_REDFISH_THERMAL_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_3_2));
  if (ThermalV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_3_2;
  ThermalV1_3_2->Thermal = ThermalV1_3_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_3_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_3_2_JSON (*((EFI_REDFISH_THERMAL_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_3_2 = (EFI_REDFISH_THERMAL_V1_3_2 *)InterpProp;
  DestroyThermal_V1_3_2_CS (ThermalV1_3_2->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_3_2EntryPoint (
