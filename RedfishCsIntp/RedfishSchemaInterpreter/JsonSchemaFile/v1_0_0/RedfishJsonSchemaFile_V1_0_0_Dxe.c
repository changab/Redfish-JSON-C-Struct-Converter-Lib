...
//
#include <RedfishInterpreter/JsonSchemaFile/v1_0_0/EfiJsonSchemaFileV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_0_0 
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_0 *JsonSchemaFileV1_0_0;
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_0_CS *JsonSchemaFileV1_0_0Cs;
  ...
  Status = Json_JsonSchemaFile_V1_0_0_To_CS (ResoruceRaw, &JsonSchemaFileV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_0_0 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_0));
  if (JsonSchemaFileV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)JsonSchemaFileV1_0_0;
  JsonSchemaFileV1_0_0->JsonSchemaFile = JsonSchemaFileV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_JsonSchemaFile_V1_0_0_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  JsonSchemaFileV1_0_0 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_0 *)InterpProp;
  DestroyJsonSchemaFile_V1_0_0_CS (JsonSchemaFileV1_0_0->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyJsonSchemaFile_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
