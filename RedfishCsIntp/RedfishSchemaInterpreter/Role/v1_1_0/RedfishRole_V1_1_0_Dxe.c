...
//
#include <RedfishInterpreter/Role/v1_1_0/EfiRoleV1_1_0.h>
...
{
  EFI_REDFISH_ROLE_V1_1_0 *RoleV1_1_0;
  EFI_REDFISH_ROLE_V1_1_0_CS *RoleV1_1_0Cs;
  ...
  Status = Json_Role_V1_1_0_To_CS (ResoruceRaw, &RoleV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_1_0 = (EFI_REDFISH_ROLE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_1_0));
  if (RoleV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)RoleV1_1_0;
  RoleV1_1_0->Role = RoleV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ROLE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Role_V1_1_0_JSON (*((EFI_REDFISH_ROLE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  RoleV1_1_0 = (EFI_REDFISH_ROLE_V1_1_0 *)InterpProp;
  DestroyRole_V1_1_0_CS (RoleV1_1_0->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyRole_V1_1_0_Json (ResoruceRaw);
}
