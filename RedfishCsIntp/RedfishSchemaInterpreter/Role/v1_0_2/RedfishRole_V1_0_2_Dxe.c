...
//
#include <RedfishInterpreter/Role/v1_0_2/EfiRoleV1_0_2.h>
...
{
  EFI_REDFISH_ROLE_V1_0_2 *RoleV1_0_2;
  EFI_REDFISH_ROLE_V1_0_2_CS *RoleV1_0_2Cs;
  ...
  Status = Json_Role_V1_0_2_To_CS (ResoruceRaw, &RoleV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_0_2 = (EFI_REDFISH_ROLE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_0_2));
  if (RoleV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)RoleV1_0_2;
  RoleV1_0_2->Role = RoleV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_ROLE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Role_V1_0_2_JSON (*((EFI_REDFISH_ROLE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  RoleV1_0_2 = (EFI_REDFISH_ROLE_V1_0_2 *)InterpProp;
  DestroyRole_V1_0_2_CS (RoleV1_0_2->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyRole_V1_0_2_Json (ResoruceRaw);
}
