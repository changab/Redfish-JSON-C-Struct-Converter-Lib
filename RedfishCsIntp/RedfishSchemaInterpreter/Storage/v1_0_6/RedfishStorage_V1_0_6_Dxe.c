...
//
#include <RedfishInterpreter/Storage/v1_0_6/EfiStorageV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_0_6 
...
{
  EFI_REDFISH_STORAGE_V1_0_6 *StorageV1_0_6;
  EFI_REDFISH_STORAGE_V1_0_6_CS *StorageV1_0_6Cs;
  ...
  Status = Json_Storage_V1_0_6_To_CS (ResoruceRaw, &StorageV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_0_6 = (EFI_REDFISH_STORAGE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_0_6));
  if (StorageV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_0_6;
  StorageV1_0_6->Storage = StorageV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_0_6_JSON (*((EFI_REDFISH_STORAGE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_0_6 = (EFI_REDFISH_STORAGE_V1_0_6 *)InterpProp;
  DestroyStorage_V1_0_6_CS (StorageV1_0_6->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_0_6EntryPoint (
