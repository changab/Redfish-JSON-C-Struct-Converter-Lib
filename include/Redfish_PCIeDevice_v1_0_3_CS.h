...
#ifndef _RedfishPciedevice_V1_0_3_CSTRUCT_H_
#define _RedfishPciedevice_V1_0_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPCIeDevice_V1_0_3_Links_CS RedfishPCIeDevice_V1_0_3_Links_CS;
typedef struct _RedfishPCIeDevice_V1_0_3_PCIeDevice_CS RedfishPCIeDevice_V1_0_3_PCIeDevice_CS;
...
typedef struct _RedfishPCIeDevice_V1_0_3_PCIeDevice_CS {
    ...
    RedfishCS_char                       *FirmwareVersion;    // The version of firmware for
                                                             // this PCIe device.
    RedfishCS_char                       *Id;            
    RedfishPCIeDevice_V1_0_3_Links_CS    *Links;             // The links object contains the
...
RedfishCS_status
Json_PCIeDevice_V1_0_3_To_CS (char *JsonRawText, RedfishPCIeDevice_V1_0_3_PCIeDevice_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeDevice_V1_0_3_JSON (RedfishPCIeDevice_V1_0_3_PCIeDevice_CS *CSPtr, char **JsonText);
