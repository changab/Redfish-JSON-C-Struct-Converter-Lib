...
//
#include <RedfishInterpreter/PrivilegeRegistry/v1_0_2/EfiPrivilegeRegistryV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_0_2 
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_2 *PrivilegeRegistryV1_0_2;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_2_CS *PrivilegeRegistryV1_0_2Cs;
  ...
  Status = Json_PrivilegeRegistry_V1_0_2_To_CS (ResoruceRaw, &PrivilegeRegistryV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_0_2 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_2));
  if (PrivilegeRegistryV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PrivilegeRegistryV1_0_2;
  PrivilegeRegistryV1_0_2->PrivilegeRegistry = PrivilegeRegistryV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PrivilegeRegistry_V1_0_2_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PrivilegeRegistryV1_0_2 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_2 *)InterpProp;
  DestroyPrivilegeRegistry_V1_0_2_CS (PrivilegeRegistryV1_0_2->PrivilegeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPrivilegeRegistry_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
