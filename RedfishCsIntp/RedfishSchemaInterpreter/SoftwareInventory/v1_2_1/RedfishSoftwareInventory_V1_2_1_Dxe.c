...
//
#include <RedfishInterpreter/SoftwareInventory/v1_2_1/EfiSoftwareInventoryV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_2_1 
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_2_1 *SoftwareInventoryV1_2_1;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_2_1_CS *SoftwareInventoryV1_2_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "SoftwareInventory") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_SoftwareInventory_V1_2_1_To_CS (ResoruceRaw, &SoftwareInventoryV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_2_1 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_2_1));
  if (SoftwareInventoryV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SoftwareInventoryV1_2_1;
  SoftwareInventoryV1_2_1->SoftwareInventory = SoftwareInventoryV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_2_1_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SoftwareInventory"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "SoftwareInventory");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SoftwareInventory"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "SoftwareInventory");
...
EFI_STATUS
EFIAPI
SoftwareInventoryFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_SoftwareInventory_V1_2_1_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in SoftwareInventoryToStruct.
...
EFI_STATUS
EFIAPI
SoftwareInventoryDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  SoftwareInventoryV1_2_1 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_2_1 *)InterpProp;
  DestroySoftwareInventory_V1_2_1_CS (SoftwareInventoryV1_2_1->SoftwareInventory); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SoftwareInventoryFromEfiStruct
...
)
{
  ...
  return DestroySoftwareInventory_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
