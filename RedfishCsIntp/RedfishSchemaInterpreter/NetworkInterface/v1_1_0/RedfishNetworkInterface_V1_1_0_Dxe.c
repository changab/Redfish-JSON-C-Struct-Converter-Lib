...
//
#include <RedfishInterpreter/NetworkInterface/v1_1_0/EfiNetworkInterfaceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkInterface V1_1_0 
...
{
  EFI_REDFISH_NETWORKINTERFACE_V1_1_0 *NetworkInterfaceV1_1_0;
  EFI_REDFISH_NETWORKINTERFACE_V1_1_0_CS *NetworkInterfaceV1_1_0Cs;
  ...
  Status = Json_NetworkInterface_V1_1_0_To_CS (ResoruceRaw, &NetworkInterfaceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkInterfaceV1_1_0 = (EFI_REDFISH_NETWORKINTERFACE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_1_0));
  if (NetworkInterfaceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkInterfaceV1_1_0;
  NetworkInterfaceV1_1_0->NetworkInterface = NetworkInterfaceV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkInterface_V1_1_0_JSON (*((EFI_REDFISH_NETWORKINTERFACE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkInterfaceV1_1_0 = (EFI_REDFISH_NETWORKINTERFACE_V1_1_0 *)InterpProp;
  DestroyNetworkInterface_V1_1_0_CS (NetworkInterfaceV1_1_0->NetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkInterface_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
