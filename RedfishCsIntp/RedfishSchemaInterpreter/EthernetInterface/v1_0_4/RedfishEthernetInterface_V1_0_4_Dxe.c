...
//
#include <RedfishInterpreter/EthernetInterface/v1_0_4/EfiEthernetInterfaceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_4 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_4 *EthernetInterfaceV1_0_4;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_4_CS *EthernetInterfaceV1_0_4Cs;
  ...
  Status = Json_EthernetInterface_V1_0_4_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_4 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_4));
  if (EthernetInterfaceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_0_4;
  EthernetInterfaceV1_0_4->EthernetInterface = EthernetInterfaceV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EthernetInterface_V1_0_4_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EthernetInterfaceV1_0_4 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_4 *)InterpProp;
  DestroyEthernetInterface_V1_0_4_CS (EthernetInterfaceV1_0_4->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEthernetInterface_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
