# Definition of Assembly.V1_1_1 and functions<br><br>

## Actions
    typedef struct _RedfishAssembly_V1_1_1_Actions_CS {
        RedfishAssembly_V1_1_1_OemActions_CS *Oem;
    } RedfishAssembly_V1_1_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishAssembly_V1_1_1_OemActions_CS| Structure points to **Oem** property.| No| No


## AssemblyData
    typedef struct _RedfishAssembly_V1_1_1_AssemblyData_CS {
        RedfishCS_char *odata_id;
        RedfishAssembly_V1_1_1_AssemblyDataActions_CS *Actions;
...
|**Actions**|RedfishAssembly_V1_1_1_AssemblyDataActions_CS| Structure points to **Actions** property.| No| No
...
## AssemblyDataActions
    typedef struct _RedfishAssembly_V1_1_1_AssemblyDataActions_CS {
        RedfishAssembly_V1_1_1_AssemblyDataOemActions_CS *Oem;
    } RedfishAssembly_V1_1_1_AssemblyDataActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishAssembly_V1_1_1_AssemblyDataOemActions_CS| Structure points to **Oem** property.| No| No
...
## Assembly
    typedef struct _RedfishAssembly_V1_1_1_Assembly_CS {
        ...
        RedfishAssembly_V1_1_1_Actions_CS *Actions;
        RedfishAssembly_V1_1_1_AssemblyData_CS *Assemblies;
...
|**Actions**|RedfishAssembly_V1_1_1_Actions_CS| Structure points to **Actions** property.| No| No
|**Assemblies**|RedfishAssembly_V1_1_1_AssemblyData_CS| Structure points to **Assemblies** property.| No| No
...
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
## Redfish Assembly V1_1_1 to C Structure Function
    RedfishCS_status
    Json_Assembly_V1_1_1_To_CS (RedfishCS_char *JsonRawText, RedfishAssembly_V1_1_1_Assembly_CS **ReturnedCS);

## C Structure to Redfish Assembly V1_1_1 JSON Function
    RedfishCS_status
    CS_To_Assembly_V1_1_1_JSON (RedfishAssembly_V1_1_1_Assembly_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Assembly V1_1_1 C Structure Function
    RedfishCS_status
