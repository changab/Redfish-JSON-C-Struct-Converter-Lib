...
//
#include <RedfishInterpreter/ComputerSystem/v1_0_7/EfiComputerSystemV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_0_7 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_7 *ComputerSystemV1_0_7;
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_7_CS *ComputerSystemV1_0_7Cs;
  ...
  Status = Json_ComputerSystem_V1_0_7_To_CS (ResoruceRaw, &ComputerSystemV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_0_7 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_7));
  if (ComputerSystemV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_0_7;
  ComputerSystemV1_0_7->ComputerSystem = ComputerSystemV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_0_7_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_0_7 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_7 *)InterpProp;
  DestroyComputerSystem_V1_0_7_CS (ComputerSystemV1_0_7->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
