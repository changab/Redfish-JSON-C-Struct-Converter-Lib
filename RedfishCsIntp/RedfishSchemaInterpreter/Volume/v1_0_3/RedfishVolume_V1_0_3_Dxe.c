...
//
#include <RedfishInterpreter/Volume/v1_0_3/EfiVolumeV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Volume";
BOOLEAN IsRevisonController = TRUE;

// Support Volume V1_0_3 
...
{
  EFI_REDFISH_VOLUME_V1_0_3 *VolumeV1_0_3;
  EFI_REDFISH_VOLUME_V1_0_3_CS *VolumeV1_0_3Cs;
  ...
  Status = Json_Volume_V1_0_3_To_CS (ResoruceRaw, &VolumeV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VolumeV1_0_3 = (EFI_REDFISH_VOLUME_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VOLUME_V1_0_3));
  if (VolumeV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VolumeV1_0_3;
  VolumeV1_0_3->Volume = VolumeV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_VOLUME_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Volume_V1_0_3_JSON (*((EFI_REDFISH_VOLUME_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VolumeV1_0_3 = (EFI_REDFISH_VOLUME_V1_0_3 *)InterpProp;
  DestroyVolume_V1_0_3_CS (VolumeV1_0_3->Volume); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVolume_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVolume_V1_0_3EntryPoint (
