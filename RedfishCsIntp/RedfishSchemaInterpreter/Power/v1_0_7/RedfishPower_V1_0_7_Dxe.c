...
//
#include <RedfishInterpreter/Power/v1_0_7/EfiPowerV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_0_7 
...
{
  EFI_REDFISH_POWER_V1_0_7 *PowerV1_0_7;
  EFI_REDFISH_POWER_V1_0_7_CS *PowerV1_0_7Cs;
  ...
  Status = Json_Power_V1_0_7_To_CS (ResoruceRaw, &PowerV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_0_7 = (EFI_REDFISH_POWER_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_0_7));
  if (PowerV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_0_7;
  PowerV1_0_7->Power = PowerV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_POWER_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_0_7_JSON (*((EFI_REDFISH_POWER_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_0_7 = (EFI_REDFISH_POWER_V1_0_7 *)InterpProp;
  DestroyPower_V1_0_7_CS (PowerV1_0_7->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_0_7_Json (ResoruceRaw);
}
