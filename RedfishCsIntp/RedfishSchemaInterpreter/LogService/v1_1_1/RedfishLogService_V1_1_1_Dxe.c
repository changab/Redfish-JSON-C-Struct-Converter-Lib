...
//
#include <RedfishInterpreter/LogService/v1_1_1/EfiLogServiceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_1_1 
...
{
  EFI_REDFISH_LOGSERVICE_V1_1_1 *LogServiceV1_1_1;
  EFI_REDFISH_LOGSERVICE_V1_1_1_CS *LogServiceV1_1_1Cs;
  ...
  Status = Json_LogService_V1_1_1_To_CS (ResoruceRaw, &LogServiceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_1_1 = (EFI_REDFISH_LOGSERVICE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_1_1));
  if (LogServiceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogServiceV1_1_1;
  LogServiceV1_1_1->LogService = LogServiceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_LOGSERVICE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogService_V1_1_1_JSON (*((EFI_REDFISH_LOGSERVICE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogServiceV1_1_1 = (EFI_REDFISH_LOGSERVICE_V1_1_1 *)InterpProp;
  DestroyLogService_V1_1_1_CS (LogServiceV1_1_1->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogService_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
