...
//
#include <RedfishInterpreter/ManagerNetworkProtocol/v1_0_4/EfiManagerNetworkProtocolV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_0_4 
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_4 *ManagerNetworkProtocolV1_0_4;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_4_CS *ManagerNetworkProtocolV1_0_4Cs;
  ...
  Status = Json_ManagerNetworkProtocol_V1_0_4_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_0_4 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_4));
  if (ManagerNetworkProtocolV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerNetworkProtocolV1_0_4;
  ManagerNetworkProtocolV1_0_4->ManagerNetworkProtocol = ManagerNetworkProtocolV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerNetworkProtocol_V1_0_4_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerNetworkProtocolV1_0_4 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_4 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_0_4_CS (ManagerNetworkProtocolV1_0_4->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerNetworkProtocol_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
