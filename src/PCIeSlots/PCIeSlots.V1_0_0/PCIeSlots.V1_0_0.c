...
#include"Redfish_PCIeSlots_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeSlots_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeSlots_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeSlots_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeSlots_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenPCIeLinksCs(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeSlots_V1_0_0_PCIeLinks_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeSlots_V1_0_0_PCIeLinks_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
  ...
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "PCIeDevice", Cs->Header.ThisUri, &(*Dst)->PCIeDevice);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PCIeDevice@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "PCIeDevice@odata.count", &(*Dst)->PCIeDeviceodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenStatusCs(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenPCIeSlot_Array_ElementCs(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPCIeSlots_V1_0_0_PCIeSlot_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPCIeSlots_V1_0_0_PCIeSlot_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Lanes
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "Lanes", &(*Dst)->Lanes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Links
  Status = GenPCIeLinksCs (Cs, TempJsonObj, "Links", &(*Dst)->Links);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PCIeType
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "PCIeType", &(*Dst)->PCIeType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SlotType
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "SlotType", &(*Dst)->SlotType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishPCIeSlots_V1_0_0_PCIeSlot_Array_CS
//
static RedfishCS_status GenPCIeSlot_ArrayCs(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeSlots_V1_0_0_PCIeSlot_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPCIeSlots_V1_0_0_PCIeSlot_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPCIeSlots_V1_0_0_PCIeSlot_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenPCIeSlot_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPCIeSlots_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPCIeSlots_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SlotsLinks(json_t *CsJson, char *Key, RedfishPCIeSlots_V1_0_0_PCIeLinks_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Oem
  if (CS_To_JSON_SlotsLinksOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}

  // PCIeDevice 
  if (InsertJsonLinkArrayObj (CsJson, "PCIeDevice", &CSPtr->PCIeDevice) != RedfishCS_status_success) {goto Error;}

  // PCIeDevice@odata.count 
  if (InsertJsonInt64Obj (CsJson, "PCIeDevice@odata.count", CSPtr->PCIeDeviceodata_count) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_SlotsStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // Oem
  if (CS_To_JSON_SlotsStatusOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Slots(json_t *CsJson, char *Key, RedfishPCIeSlots_V1_0_0_PCIeSlot_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPCIeSlots_V1_0_0_PCIeSlot_Array_CS *NextArray;
  RedfishPCIeSlots_V1_0_0_PCIeSlot_CS *NextArrayItem;
  ...
  do {
    ...
    // Lanes 
    if (InsertJsonInt64Obj (ArrayMember, "Lanes", NextArrayItem->Lanes) != RedfishCS_status_success) {goto Error;}

    // Links
    if (CS_To_JSON_SlotsLinks(ArrayMember, "Links", NextArrayItem->Links) != RedfishCS_status_success) {goto Error;}

    // Location 
    if (InsertJsonLinkObj (ArrayMember, "Location", &NextArrayItem->Location) != RedfishCS_status_success) {goto Error;}

    // Oem
    if (CS_To_JSON_SlotsOem(ArrayMember, "Oem", NextArrayItem->Oem) != RedfishCS_status_success) {goto Error;}

    // PCIeType 
    if (InsertJsonStringObj (ArrayMember, "PCIeType", NextArrayItem->PCIeType) != RedfishCS_status_success) {goto Error;}

    // SlotType 
    if (InsertJsonStringObj (ArrayMember, "SlotType", NextArrayItem->SlotType) != RedfishCS_status_success) {goto Error;}

    // Status
    if (CS_To_JSON_SlotsStatus(ArrayMember, "Status", NextArrayItem->Status) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for PCIeSlots.V1_0_0.PCIeSlots
//
RedfishCS_status CS_To_PCIeSlots_V1_0_0_JSON(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Slots
  if (CS_To_JSON_Slots(CsJson, "Slots", CSPtr->Slots) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for PCIeSlots.V1_0_0.PCIeSlots
//
RedfishCS_status DestroyPCIeSlots_V1_0_0_CS(RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PCIeSlots.V1_0_0.PCIeSlots
//
RedfishCS_status DestroyPCIeSlots_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PCIeSlots.V1_0_0.PCIeSlots
//
RedfishCS_status
Json_PCIeSlots_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishPCIeSlots_V1_0_0_PCIeSlots_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPCIeSlots_V1_0_0_PCIeSlots_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PCIeSlots", "v1_0_0", "PCIeSlots", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPCIeSlots_V1_0_0_PCIeSlots_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Slots
  Status = GenPCIeSlot_ArrayCs (Cs, JsonObj, "Slots", &Cs->Slots);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
