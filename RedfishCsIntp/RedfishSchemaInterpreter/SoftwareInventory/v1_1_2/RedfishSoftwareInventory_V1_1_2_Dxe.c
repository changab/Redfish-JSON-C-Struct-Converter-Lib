...
//
#include <RedfishInterpreter/SoftwareInventory/v1_1_2/EfiSoftwareInventoryV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_1_2 
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_1_2 *SoftwareInventoryV1_1_2;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_1_2_CS *SoftwareInventoryV1_1_2Cs;
  ...
  Status = Json_SoftwareInventory_V1_1_2_To_CS (ResoruceRaw, &SoftwareInventoryV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_1_2 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_2));
  if (SoftwareInventoryV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SoftwareInventoryV1_1_2;
  SoftwareInventoryV1_1_2->SoftwareInventory = SoftwareInventoryV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SoftwareInventory_V1_1_2_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SoftwareInventoryV1_1_2 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_2 *)InterpProp;
  DestroySoftwareInventory_V1_1_2_CS (SoftwareInventoryV1_1_2->SoftwareInventory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySoftwareInventory_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
