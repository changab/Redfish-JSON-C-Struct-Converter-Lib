...
//
#include <RedfishInterpreter/LogEntry/v1_4_1/EfiLogEntryV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_4_1 
...
{
  EFI_REDFISH_LOGENTRY_V1_4_1 *LogEntryV1_4_1;
  EFI_REDFISH_LOGENTRY_V1_4_1_CS *LogEntryV1_4_1Cs;
  ...
  Status = Json_LogEntry_V1_4_1_To_CS (ResoruceRaw, &LogEntryV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_4_1 = (EFI_REDFISH_LOGENTRY_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_4_1));
  if (LogEntryV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_4_1;
  LogEntryV1_4_1->LogEntry = LogEntryV1_4_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_4_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_4_1_JSON (*((EFI_REDFISH_LOGENTRY_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_4_1 = (EFI_REDFISH_LOGENTRY_V1_4_1 *)InterpProp;
  DestroyLogEntry_V1_4_1_CS (LogEntryV1_4_1->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_4_1EntryPoint (
