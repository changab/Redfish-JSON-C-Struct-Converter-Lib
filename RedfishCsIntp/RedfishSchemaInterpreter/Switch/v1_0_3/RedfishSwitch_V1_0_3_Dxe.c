...
//
#include <RedfishInterpreter/Switch/v1_0_3/EfiSwitchV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_0_3 
...
{
  EFI_REDFISH_SWITCH_V1_0_3 *SwitchV1_0_3;
  EFI_REDFISH_SWITCH_V1_0_3_CS *SwitchV1_0_3Cs;
  ...
  Status = Json_Switch_V1_0_3_To_CS (ResoruceRaw, &SwitchV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_0_3 = (EFI_REDFISH_SWITCH_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_0_3));
  if (SwitchV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SwitchV1_0_3;
  SwitchV1_0_3->Switch = SwitchV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SWITCH_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Switch_V1_0_3_JSON (*((EFI_REDFISH_SWITCH_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SwitchV1_0_3 = (EFI_REDFISH_SWITCH_V1_0_3 *)InterpProp;
  DestroySwitch_V1_0_3_CS (SwitchV1_0_3->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySwitch_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_0_3EntryPoint (
