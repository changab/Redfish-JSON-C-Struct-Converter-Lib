...
//
#include <RedfishInterpreter/EthernetInterface/v1_4_0/EfiEthernetInterfaceV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_4_0 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_0 *EthernetInterfaceV1_4_0;
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_0_CS *EthernetInterfaceV1_4_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.MinorVersion, "4") != 0) ||
  ...
  Status = Json_EthernetInterface_V1_4_0_To_CS (ResoruceRaw, &EthernetInterfaceV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_4_0 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_4_0));
  if (EthernetInterfaceV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_4_0;
  EthernetInterfaceV1_4_0->EthernetInterface = EthernetInterfaceV1_4_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_4_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EthernetInterface_V1_4_0_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EthernetInterfaceV1_4_0 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_0 *)InterpProp;
  DestroyEthernetInterface_V1_4_0_CS (EthernetInterfaceV1_4_0->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEthernetInterface_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
