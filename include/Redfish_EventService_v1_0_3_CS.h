...
#ifndef _RedfishEventservice_V1_0_3_CSTRUCT_H_
#define _RedfishEventservice_V1_0_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEventService_V1_0_3_EventService_CS RedfishEventService_V1_0_3_EventService_CS;
typedef struct _RedfishEventService_V1_0_3_EventService_Actions_CS RedfishEventService_V1_0_3_EventService_Actions_CS;
typedef struct _RedfishEventService_V1_0_3_EventService_Actions_Oem_CS RedfishEventService_V1_0_3_EventService_Actions_Oem_CS;
typedef struct _RedfishEventService_V1_0_3_SubmitTestEvent_CS RedfishEventService_V1_0_3_SubmitTestEvent_CS;
...
typedef struct _RedfishEventService_V1_0_3_EventService_CS {
    ...
    RedfishEventService_V1_0_3_EventService_Actions_CS    *Actions;                        // The available actions for this
                                                                                           // resource.
...
RedfishCS_status
Json_EventService_V1_0_3_To_CS (char *JsonRawText, RedfishEventService_V1_0_3_EventService_CS **ReturnedCS);

RedfishCS_status
CS_To_EventService_V1_0_3_JSON (RedfishEventService_V1_0_3_EventService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventService_V1_0_3_CS (RedfishEventService_V1_0_3_EventService_CS *CSPtr);

RedfishCS_status
DestroyEventService_V1_0_3_Json (RedfishCS_char *JsonText);
