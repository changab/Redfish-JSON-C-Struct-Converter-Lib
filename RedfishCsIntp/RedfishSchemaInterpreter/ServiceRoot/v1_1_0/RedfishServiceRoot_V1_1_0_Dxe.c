...
//
#include <RedfishInterpreter/ServiceRoot/v1_1_0/EfiServiceRootV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_1_0 
...
{
  EFI_REDFISH_SERVICEROOT_V1_1_0 *ServiceRootV1_1_0;
  EFI_REDFISH_SERVICEROOT_V1_1_0_CS *ServiceRootV1_1_0Cs;
  ...
  Status = Json_ServiceRoot_V1_1_0_To_CS (ResoruceRaw, &ServiceRootV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_1_0 = (EFI_REDFISH_SERVICEROOT_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_1_0));
  if (ServiceRootV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_1_0;
  ServiceRootV1_1_0->ServiceRoot = ServiceRootV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ServiceRoot_V1_1_0_JSON (*((EFI_REDFISH_SERVICEROOT_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ServiceRootV1_1_0 = (EFI_REDFISH_SERVICEROOT_V1_1_0 *)InterpProp;
  DestroyServiceRoot_V1_1_0_CS (ServiceRootV1_1_0->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyServiceRoot_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
