...
//
#include <RedfishInterpreter/Drive/v1_0_6/EfiDriveV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_6 
...
{
  EFI_REDFISH_DRIVE_V1_0_6 *DriveV1_0_6;
  EFI_REDFISH_DRIVE_V1_0_6_CS *DriveV1_0_6Cs;
  ...
  Status = Json_Drive_V1_0_6_To_CS (ResoruceRaw, &DriveV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_6 = (EFI_REDFISH_DRIVE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_6));
  if (DriveV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_0_6;
  DriveV1_0_6->Drive = DriveV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_0_6_JSON (*((EFI_REDFISH_DRIVE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_0_6 = (EFI_REDFISH_DRIVE_V1_0_6 *)InterpProp;
  DestroyDrive_V1_0_6_CS (DriveV1_0_6->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_0_6_Json (ResoruceRaw);
}
