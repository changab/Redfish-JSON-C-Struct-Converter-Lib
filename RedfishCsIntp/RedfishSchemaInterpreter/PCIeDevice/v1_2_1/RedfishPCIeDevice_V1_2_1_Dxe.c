...
//
#include <RedfishInterpreter/PCIeDevice/v1_2_1/EfiPCIeDeviceV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_2_1 
...
{
  EFI_REDFISH_PCIEDEVICE_V1_2_1 *PCIeDeviceV1_2_1;
  EFI_REDFISH_PCIEDEVICE_V1_2_1_CS *PCIeDeviceV1_2_1Cs;
  ...
  Status = Json_PCIeDevice_V1_2_1_To_CS (ResoruceRaw, &PCIeDeviceV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_2_1 = (EFI_REDFISH_PCIEDEVICE_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_2_1));
  if (PCIeDeviceV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeDeviceV1_2_1;
  PCIeDeviceV1_2_1->PCIeDevice = PCIeDeviceV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_PCIEDEVICE_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeDevice_V1_2_1_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeDeviceV1_2_1 = (EFI_REDFISH_PCIEDEVICE_V1_2_1 *)InterpProp;
  DestroyPCIeDevice_V1_2_1_CS (PCIeDeviceV1_2_1->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeDevice_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
