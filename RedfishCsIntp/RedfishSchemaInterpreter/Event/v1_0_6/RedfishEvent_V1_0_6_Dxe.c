...
//
#include <RedfishInterpreter/Event/v1_0_6/EfiEventV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_6 
...
{
  EFI_REDFISH_EVENT_V1_0_6 *EventV1_0_6;
  EFI_REDFISH_EVENT_V1_0_6_CS *EventV1_0_6Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Event") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Event_V1_0_6_To_CS (ResoruceRaw, &EventV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_6 = (EFI_REDFISH_EVENT_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_6));
  if (EventV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_0_6;
  EventV1_0_6->Event = EventV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_EVENT_V1_0_6_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Event"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Event");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Event"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Event");
...
)
{
  ...
  return CS_To_Event_V1_0_6_JSON (*((EFI_REDFISH_EVENT_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in EventToStruct.
...
)
{
  ...
  EventV1_0_6 = (EFI_REDFISH_EVENT_V1_0_6 *)InterpProp;
  DestroyEvent_V1_0_6_CS (EventV1_0_6->Event); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EventFromEfiStruct
...
)
{
  ...
  return DestroyEvent_V1_0_6_Json (ResoruceRaw);
}
