...
//
#include <RedfishInterpreter/ComputerSystem/v1_3_5/EfiComputerSystemV1_3_5.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_3_5 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_3_5 *ComputerSystemV1_3_5;
  EFI_REDFISH_COMPUTERSYSTEM_V1_3_5_CS *ComputerSystemV1_3_5Cs;
  ...
  Status = Json_ComputerSystem_V1_3_5_To_CS (ResoruceRaw, &ComputerSystemV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_3_5 = (EFI_REDFISH_COMPUTERSYSTEM_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_3_5));
  if (ComputerSystemV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_3_5;
  ComputerSystemV1_3_5->ComputerSystem = ComputerSystemV1_3_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_3_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_3_5_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_3_5 = (EFI_REDFISH_COMPUTERSYSTEM_V1_3_5 *)InterpProp;
  DestroyComputerSystem_V1_3_5_CS (ComputerSystemV1_3_5->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_3_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_3_5EntryPoint (
