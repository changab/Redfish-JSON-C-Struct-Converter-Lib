...
#ifndef _RedfishEvent_V1_1_3_CSTRUCT_H_
#define _RedfishEvent_V1_1_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEvent_V1_1_3_EventRecord_Array_CS RedfishEvent_V1_1_3_EventRecord_Array_CS;
typedef struct _RedfishEvent_V1_1_3_Event_CS RedfishEvent_V1_1_3_Event_CS;
typedef struct _RedfishEvent_V1_1_3_EventRecord_CS RedfishEvent_V1_1_3_EventRecord_CS;
...
typedef struct _RedfishEvent_V1_1_3_Event_CS {
    ...
    RedfishEvent_V1_1_3_EventRecord_Array_CS    *Events;                       // Each event in this array has a
...
typedef struct _RedfishEvent_V1_1_3_EventRecord_Array_CS  {
    RedfishEvent_V1_1_3_EventRecord_Array_CS    *Next;
    RedfishEvent_V1_1_3_EventRecord_CS    *ArrayValue;
} RedfishEvent_V1_1_3_EventRecord_Array_CS;

RedfishCS_status
Json_Event_V1_1_3_To_CS (char *JsonRawText, RedfishEvent_V1_1_3_Event_CS **ReturnedCS);

RedfishCS_status
CS_To_Event_V1_1_3_JSON (RedfishEvent_V1_1_3_Event_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEvent_V1_1_3_CS (RedfishEvent_V1_1_3_Event_CS *CSPtr);

RedfishCS_status
DestroyEvent_V1_1_3_Json (RedfishCS_char *JsonText);
