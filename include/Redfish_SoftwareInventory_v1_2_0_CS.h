...
#ifndef _RedfishSoftwareinventory_V1_2_0_CSTRUCT_H_
#define _RedfishSoftwareinventory_V1_2_0_CSTRUCT_H_
...
typedef struct _RedfishSoftwareInventory_V1_2_0_Actions_CS RedfishSoftwareInventory_V1_2_0_Actions_CS;
typedef struct _RedfishSoftwareInventory_V1_2_0_OemActions_CS RedfishSoftwareInventory_V1_2_0_OemActions_CS;
typedef struct _RedfishSoftwareInventory_V1_2_0_SoftwareInventory_CS RedfishSoftwareInventory_V1_2_0_SoftwareInventory_CS;
...
typedef struct _RedfishSoftwareInventory_V1_2_0_SoftwareInventory_CS {
    ...
    RedfishSoftwareInventory_V1_2_0_Actions_CS    *Actions;                  // The Actions object contains
    ...
    RedfishResource_Oem_CS                        *Oem;                      // This is the
                                                                             ...
                                                                             // sections.
    Redfishodata_V4_0_2_idRef_Array_CS            *RelatedItem;              // The ID(s) of the resources
...
RedfishCS_status
Json_SoftwareInventory_V1_2_0_To_CS (char *JsonRawText, RedfishSoftwareInventory_V1_2_0_SoftwareInventory_CS **ReturnedCS);

RedfishCS_status
CS_To_SoftwareInventory_V1_2_0_JSON (RedfishSoftwareInventory_V1_2_0_SoftwareInventory_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySoftwareInventory_V1_2_0_CS (RedfishSoftwareInventory_V1_2_0_SoftwareInventory_CS *CSPtr);

RedfishCS_status
DestroySoftwareInventory_V1_2_0_Json (RedfishCS_char *JsonText);
