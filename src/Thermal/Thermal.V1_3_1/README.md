# Definition of Thermal.V1_3_1 and functions<br><br>
...
## Fan
    typedef struct _RedfishThermal_V1_3_1_Fan_CS {
        RedfishThermal_V1_3_1_FanActions_CS *Actions;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Actions**|RedfishThermal_V1_3_1_FanActions_CS| Structure points to **Actions** property.| No| No
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_3_1_FanOemActions_CS| Structure points to **Oem** property.| No| No
...
## Temperature
    typedef struct _RedfishThermal_V1_3_1_Temperature_CS {
        RedfishThermal_V1_3_1_TemperatureActions_CS *Actions;
        RedfishCS_int64 *LowerThresholdCritical;
        RedfishCS_int64 *LowerThresholdFatal;
        RedfishCS_int64 *LowerThresholdNonCritical;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Actions**|RedfishThermal_V1_3_1_TemperatureActions_CS| Structure points to **Actions** property.| No| No
|**LowerThresholdCritical**|RedfishCS_int64| 64-bit long long interger pointer to **LowerThresholdCritical** property.| No| Yes
|**LowerThresholdFatal**|RedfishCS_int64| 64-bit long long interger pointer to **LowerThresholdFatal** property.| No| Yes
|**LowerThresholdNonCritical**|RedfishCS_int64| 64-bit long long interger pointer to **LowerThresholdNonCritical** property.| No| Yes
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_3_1_TemperatureOemActions_CS| Structure points to **Oem** property.| No| No
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_3_1_ThermalOemActions_CS| Structure points to **Oem** property.| No| No
...
## Thermal
    typedef struct _RedfishThermal_V1_3_1_Thermal_CS {
        ...
        RedfishThermal_V1_3_1_ThermalActions_CS *Actions;
        RedfishCS_char *Description;
        RedfishThermal_V1_3_1_Fan_CS *Fans;
        ...
        RedfishCS_char *Redundancyodata_navigationLink;
        RedfishResource_Status_CS *Status;
        RedfishThermal_V1_3_1_Temperature_CS *Temperatures;
...
|**Actions**|RedfishThermal_V1_3_1_ThermalActions_CS| Structure points to **Actions** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Fans**|RedfishThermal_V1_3_1_Fan_CS| Structure points to **Fans** property.| No| No
...
|**Redundancyodata_navigationLink**|RedfishCS_char| String pointer to **Redundancy@odata.navigationLink** property.| No| No
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**Temperatures**|RedfishThermal_V1_3_1_Temperature_CS| Structure points to **Temperatures** property.| No| No
...
## Redfish Thermal V1_3_1 to C Structure Function
    RedfishCS_status
    Json_Thermal_V1_3_1_To_CS (RedfishCS_char *JsonRawText, RedfishThermal_V1_3_1_Thermal_CS **ReturnedCS);

## C Structure to Redfish Thermal V1_3_1 JSON Function
    RedfishCS_status
    CS_To_Thermal_V1_3_1_JSON (RedfishThermal_V1_3_1_Thermal_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Thermal V1_3_1 C Structure Function
    RedfishCS_status
