# Definition of Storage.V1_1_1 and functions<br><br>
...
## StorageController
    typedef struct _RedfishStorage_V1_1_1_StorageController_CS {
        ...
        RedfishStorage_V1_1_1_StorageController_Links_CS *Links;
...
|**Links**|RedfishStorage_V1_1_1_StorageController_Links_CS| Structure points to **Links** property.| No| No
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Storage_SetEncryptionKey**|RedfishStorage_V1_1_1_SetEncryptionKey_CS| Structure points to **#Storage.SetEncryptionKey** property.| No| No
|**Oem**|RedfishStorage_V1_1_1_Storage_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## Storage
    typedef struct _RedfishStorage_V1_1_1_Storage_CS {
        ...
        RedfishStorage_V1_1_1_Storage_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_Link Drives;
        RedfishCS_int64 *Drivesodata_count;
        RedfishCS_char *Drivesodata_navigationLink;
        RedfishCS_char *Id;
        RedfishStorage_V1_1_1_Storage_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        ...
        RedfishResource_Status_CS *Status;
        RedfishStorage_V1_1_1_StorageController_CS *StorageControllers;
...
|**Actions**|RedfishStorage_V1_1_1_Storage_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishStorage_V1_1_1_Storage_Links_CS| Structure points to **Links** property.| No| No
...
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**StorageControllers**|RedfishStorage_V1_1_1_StorageController_CS| Structure points to **StorageControllers** property.| No| Yes
...
## Redfish Storage V1_1_1 to C Structure Function
    RedfishCS_status
    Json_Storage_V1_1_1_To_CS (RedfishCS_char *JsonRawText, RedfishStorage_V1_1_1_Storage_CS **ReturnedCS);

## C Structure to Redfish Storage V1_1_1 JSON Function
    RedfishCS_status
    CS_To_Storage_V1_1_1_JSON (RedfishStorage_V1_1_1_Storage_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Storage V1_1_1 C Structure Function
    RedfishCS_status
