...
#ifndef _RedfishThermal_V1_1_4_CSTRUCT_H_
#define _RedfishThermal_V1_1_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishThermal_V1_1_4_Fan_Array_CS RedfishThermal_V1_1_4_Fan_Array_CS;
typedef struct _RedfishThermal_V1_1_4_Temperature_Array_CS RedfishThermal_V1_1_4_Temperature_Array_CS;
...
typedef struct _RedfishThermal_V1_1_4_Fan_CS RedfishThermal_V1_1_4_Fan_CS;
typedef struct _RedfishThermal_V1_1_4_Temperature_CS RedfishThermal_V1_1_4_Temperature_CS;
typedef struct _RedfishThermal_V1_1_4_Thermal_CS RedfishThermal_V1_1_4_Thermal_CS;
...
typedef struct _RedfishThermal_V1_1_4_Fan_CS {
...
} RedfishThermal_V1_1_4_Fan_CS;

typedef struct _RedfishThermal_V1_1_4_Temperature_CS {
    RedfishCS_int64                       *LowerThresholdCritical;      // Below normal range but not yet
                                                                        // fatal.
    RedfishCS_int64                       *LowerThresholdFatal;         // Below normal range and is
                                                                        // fatal.
    ...
    RedfishCS_int64                       *UpperThresholdFatal;         // Above normal range and is
                                                                        // fatal.
    RedfishCS_int64                       *UpperThresholdNonCritical;    // Above normal range.
} RedfishThermal_V1_1_4_Temperature_CS;
...
//
typedef struct _RedfishThermal_V1_1_4_Thermal_CS {
    RedfishCS_Header                              Header;
    RedfishCS_char                                *odata_context;         
    RedfishCS_char                                *odata_id;              
    RedfishCS_char                                *odata_type;            
    RedfishCS_char                                *Description;           
    RedfishThermal_V1_1_4_Fan_Array_CS            *Fans;                      // This is the definition for
                                                                              // fans.
    ...
    RedfishCS_int64                               *Redundancyodata_count; 
    RedfishResource_Status_CS                     *Status;                
    RedfishThermal_V1_1_4_Temperature_Array_CS    *Temperatures;              // This is the definition for
                                                                              // temperature sensors.
    RedfishCS_int64                               *Temperaturesodata_count;
} RedfishThermal_V1_1_4_Thermal_CS;
...
typedef struct _RedfishThermal_V1_1_4_Fan_Array_CS  {
    RedfishThermal_V1_1_4_Fan_Array_CS    *Next;
    RedfishThermal_V1_1_4_Fan_CS    *ArrayValue;
} RedfishThermal_V1_1_4_Fan_Array_CS;

typedef struct _RedfishThermal_V1_1_4_Temperature_Array_CS  {
    RedfishThermal_V1_1_4_Temperature_Array_CS    *Next;
    RedfishThermal_V1_1_4_Temperature_CS    *ArrayValue;
} RedfishThermal_V1_1_4_Temperature_Array_CS;

RedfishCS_status
Json_Thermal_V1_1_4_To_CS (char *JsonRawText, RedfishThermal_V1_1_4_Thermal_CS **ReturnedCS);

RedfishCS_status
CS_To_Thermal_V1_1_4_JSON (RedfishThermal_V1_1_4_Thermal_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyThermal_V1_1_4_CS (RedfishThermal_V1_1_4_Thermal_CS *CSPtr);

RedfishCS_status
DestroyThermal_V1_1_4_Json (RedfishCS_char *JsonText);
