...
#ifndef _RedfishNetworkdevicefunction_V1_2_1_CSTRUCT_H_
#define _RedfishNetworkdevicefunction_V1_2_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishNetworkDeviceFunction_V1_2_1_BootTargets_Array_CS RedfishNetworkDeviceFunction_V1_2_1_BootTargets_Array_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_Actions_CS RedfishNetworkDeviceFunction_V1_2_1_Actions_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_BootTargets_CS RedfishNetworkDeviceFunction_V1_2_1_BootTargets_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_Ethernet_CS RedfishNetworkDeviceFunction_V1_2_1_Ethernet_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_FibreChannel_CS RedfishNetworkDeviceFunction_V1_2_1_FibreChannel_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_Links_CS RedfishNetworkDeviceFunction_V1_2_1_Links_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_NetworkDeviceFunction_CS RedfishNetworkDeviceFunction_V1_2_1_NetworkDeviceFunction_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_OemActions_CS RedfishNetworkDeviceFunction_V1_2_1_OemActions_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_iSCSIBoot_CS RedfishNetworkDeviceFunction_V1_2_1_iSCSIBoot_CS;
...
//
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_Actions_CS {
    RedfishNetworkDeviceFunction_V1_2_1_OemActions_CS    *Oem;
} RedfishNetworkDeviceFunction_V1_2_1_Actions_CS;

//
// A Fibre Channel boot target configured for a network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_BootTargets_CS {
    ...
    RedfishCS_char     *WWPN;           // The World-Wide Port Name to
                                        // boot from.
} RedfishNetworkDeviceFunction_V1_2_1_BootTargets_CS;

//
// This type describes Ethernet capabilities, status, and configuration of a
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_Ethernet_CS {
    ...
    RedfishCS_char     *PermanentMACAddress;    // This is the permanent MAC
                                               ...
                                               // network device function
                                               // (physical function).
} RedfishNetworkDeviceFunction_V1_2_1_Ethernet_CS;

//
// This type describes Fibre Channel capabilities, status, and configuration of a
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_FibreChannel_CS {
    RedfishCS_bool                                              *AllowFIPVLANDiscovery;    // Whether the FCoE
                                                                                          // Initialization Protocol (FIP)
                                                                                          // is used for populating the
                                                                                          // FCoE VLAN Id.
    RedfishNetworkDeviceFunction_V1_2_1_BootTargets_Array_CS    *BootTargets;             // An array of Fibre Channel boot
    ...
    RedfishCS_char                                              *WWPN;                    // This is the currently
                                                                                          ...
                                                                                          // network device function
                                                                                          // (physical function).
} RedfishNetworkDeviceFunction_V1_2_1_FibreChannel_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_Links_CS {
    ...
    RedfishCS_Link     PCIeFunction;            // Contains the members of this
                                                // collection.
} RedfishNetworkDeviceFunction_V1_2_1_Links_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishNetworkDeviceFunction_V1_2_1_OemActions_CS;

//
// This type describes iSCSI boot capabilities, status, and configuration of a
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_iSCSIBoot_CS {
    ...
    RedfishCS_bool     *TargetInfoViaDHCP;            // Whether the iSCSI boot target
                                                      ...
                                                      // from DHCP.
} RedfishNetworkDeviceFunction_V1_2_1_iSCSIBoot_CS;
...
// adapter.
//
typedef struct _RedfishNetworkDeviceFunction_V1_2_1_NetworkDeviceFunction_CS {
    RedfishCS_Header                                       Header;
    RedfishCS_char                                         *odata_context;                    
    RedfishCS_char                                         *odata_etag;                       
    RedfishCS_char                                         *odata_id;                         
    RedfishCS_char                                         *odata_type;                       
    RedfishNetworkDeviceFunction_V1_2_1_Actions_CS         *Actions;                              // The available actions for this
                                                                                                  // resource.
    ...
    RedfishCS_bool                                         *DeviceEnabled;                        // Whether the network device
                                                                                                  // function is enabled.
    RedfishNetworkDeviceFunction_V1_2_1_Ethernet_CS        *Ethernet;                             // Ethernet.
    RedfishNetworkDeviceFunction_V1_2_1_FibreChannel_CS    *FibreChannel;                         // Fibre Channel.
    RedfishCS_char                                         *Id;                               
    RedfishNetworkDeviceFunction_V1_2_1_Links_CS           *Links;                                // Links.
    ...
    RedfishCS_bool                                         *VirtualFunctionsEnabled;              // Whether Single Root I/O
                                                                                                  ...
                                                                                                  // Function.
    RedfishNetworkDeviceFunction_V1_2_1_iSCSIBoot_CS       *iSCSIBoot;                            // iSCSI Boot.
} RedfishNetworkDeviceFunction_V1_2_1_NetworkDeviceFunction_CS;

typedef struct _RedfishNetworkDeviceFunction_V1_2_1_BootTargets_Array_CS  {
    RedfishNetworkDeviceFunction_V1_2_1_BootTargets_Array_CS    *Next;
    RedfishNetworkDeviceFunction_V1_2_1_BootTargets_CS    *ArrayValue;
} RedfishNetworkDeviceFunction_V1_2_1_BootTargets_Array_CS;

RedfishCS_status
Json_NetworkDeviceFunction_V1_2_1_To_CS (char *JsonRawText, RedfishNetworkDeviceFunction_V1_2_1_NetworkDeviceFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkDeviceFunction_V1_2_1_JSON (RedfishNetworkDeviceFunction_V1_2_1_NetworkDeviceFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_2_1_CS (RedfishNetworkDeviceFunction_V1_2_1_NetworkDeviceFunction_CS *CSPtr);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_2_1_Json (RedfishCS_char *JsonText);
