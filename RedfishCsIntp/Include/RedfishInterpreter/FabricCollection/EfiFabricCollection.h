...
#ifndef __EFI_REDFISH_INTERP_FABRICCOLLECTION_H__
#define __EFI_REDFISH_INTERP_FABRICCOLLECTION_H__

#include <Uefi.h>
#include <Protocol/RestResourceInterpreter.h>
#include "Library/RfishCS/edk2/FabricCollection/Redfish_FabricCollection_CS.h"
//
