...
//
#include <RedfishInterpreter/Power/v1_0_5/EfiPowerV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_0_5 
...
{
  EFI_REDFISH_POWER_V1_0_5 *PowerV1_0_5;
  EFI_REDFISH_POWER_V1_0_5_CS *PowerV1_0_5Cs;
  ...
  Status = Json_Power_V1_0_5_To_CS (ResoruceRaw, &PowerV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_0_5 = (EFI_REDFISH_POWER_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_0_5));
  if (PowerV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_0_5;
  PowerV1_0_5->Power = PowerV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_POWER_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_0_5_JSON (*((EFI_REDFISH_POWER_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_0_5 = (EFI_REDFISH_POWER_V1_0_5 *)InterpProp;
  DestroyPower_V1_0_5_CS (PowerV1_0_5->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_0_5_Json (ResoruceRaw);
}
