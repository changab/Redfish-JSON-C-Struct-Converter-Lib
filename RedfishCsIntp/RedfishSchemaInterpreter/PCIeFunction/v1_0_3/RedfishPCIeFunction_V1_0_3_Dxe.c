...
//
#include <RedfishInterpreter/PCIeFunction/v1_0_3/EfiPCIeFunctionV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_0_3 
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_0_3 *PCIeFunctionV1_0_3;
  EFI_REDFISH_PCIEFUNCTION_V1_0_3_CS *PCIeFunctionV1_0_3Cs;
  ...
  Status = Json_PCIeFunction_V1_0_3_To_CS (ResoruceRaw, &PCIeFunctionV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_0_3 = (EFI_REDFISH_PCIEFUNCTION_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_0_3));
  if (PCIeFunctionV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeFunctionV1_0_3;
  PCIeFunctionV1_0_3->PCIeFunction = PCIeFunctionV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_PCIEFUNCTION_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeFunction_V1_0_3_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeFunctionV1_0_3 = (EFI_REDFISH_PCIEFUNCTION_V1_0_3 *)InterpProp;
  DestroyPCIeFunction_V1_0_3_CS (PCIeFunctionV1_0_3->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeFunction_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
