/** @file
  ...
  Redfish schema.
   - ExternalAccountProvider.v1_0_0 
...
//
#include <RedfishInterpreter/ExternalAccountProvider/v1_0_0/EfiExternalAccountProviderV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#ExternalAccountProvider";
BOOLEAN IsRevisonController = TRUE;

// Support ExternalAccountProvider V1_0_0 
...
EFI_STATUS
EFIAPI
ExternalAccountProviderToEfiStruct (
...
{
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_0 *ExternalAccountProviderV1_0_0;
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_0_CS *ExternalAccountProviderV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ExternalAccountProvider") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_ExternalAccountProvider_V1_0_0_To_CS (ResoruceRaw, &ExternalAccountProviderV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ExternalAccountProviderV1_0_0 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_0));
  if (ExternalAccountProviderV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ExternalAccountProviderV1_0_0;
  ExternalAccountProviderV1_0_0->ExternalAccountProvider = ExternalAccountProviderV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ExternalAccountProvider"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "ExternalAccountProvider");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ExternalAccountProvider"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "ExternalAccountProvider");
...
EFI_STATUS
EFIAPI
ExternalAccountProviderFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_ExternalAccountProvider_V1_0_0_JSON (*((EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ExternalAccountProviderToStruct.
...
EFI_STATUS
EFIAPI
ExternalAccountProviderDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  ExternalAccountProviderV1_0_0 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_0 *)InterpProp;
  DestroyExternalAccountProvider_V1_0_0_CS (ExternalAccountProviderV1_0_0->ExternalAccountProvider); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ExternalAccountProviderFromEfiStruct
...
EFI_STATUS
EFIAPI
ExternalAccountProviderDestoryJson(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
  IN EFI_REST_RESOURCE_TYPE_IDENTIFIER *RsrcIdentifier,  
  IN CHAR8 *ResoruceRaw
)
{
  ...
  return DestroyExternalAccountProvider_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
