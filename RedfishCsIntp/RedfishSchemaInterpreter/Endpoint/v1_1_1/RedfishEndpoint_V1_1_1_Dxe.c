...
//
#include <RedfishInterpreter/Endpoint/v1_1_1/EfiEndpointV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_1_1 
...
{
  EFI_REDFISH_ENDPOINT_V1_1_1 *EndpointV1_1_1;
  EFI_REDFISH_ENDPOINT_V1_1_1_CS *EndpointV1_1_1Cs;
  ...
  Status = Json_Endpoint_V1_1_1_To_CS (ResoruceRaw, &EndpointV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_1_1 = (EFI_REDFISH_ENDPOINT_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_1_1));
  if (EndpointV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EndpointV1_1_1;
  EndpointV1_1_1->Endpoint = EndpointV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ENDPOINT_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Endpoint_V1_1_1_JSON (*((EFI_REDFISH_ENDPOINT_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EndpointV1_1_1 = (EFI_REDFISH_ENDPOINT_V1_1_1 *)InterpProp;
  DestroyEndpoint_V1_1_1_CS (EndpointV1_1_1->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEndpoint_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_1_1EntryPoint (
