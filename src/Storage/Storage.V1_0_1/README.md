# Definition of Storage.V1_0_1 and functions<br><br>
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Storage_SetEncryptionKey**|RedfishStorage_V1_0_1_SetEncryptionKey_CS| Structure points to **#Storage.SetEncryptionKey** property.| No| No
|**Oem**|RedfishStorage_V1_0_1_Storage_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## Storage
    typedef struct _RedfishStorage_V1_0_1_Storage_CS {
        ...
        RedfishStorage_V1_0_1_Storage_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_Link Drives;
        RedfishCS_int64 *Drivesodata_count;
        RedfishCS_char *Drivesodata_navigationLink;
        RedfishCS_char *Id;
        RedfishStorage_V1_0_1_Storage_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        ...
        RedfishResource_Status_CS *Status;
        RedfishStorage_V1_0_1_StorageController_CS *StorageControllers;
...
|**Actions**|RedfishStorage_V1_0_1_Storage_Actions_CS| Structure points to **Actions** property.| No| Yes
...
|**Links**|RedfishStorage_V1_0_1_Storage_Links_CS| Structure points to **Links** property.| No| Yes
...
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**StorageControllers**|RedfishStorage_V1_0_1_StorageController_CS| Structure points to **StorageControllers** property.| No| Yes
...
## Redfish Storage V1_0_1 to C Structure Function
    RedfishCS_status
    Json_Storage_V1_0_1_To_CS (RedfishCS_char *JsonRawText, RedfishStorage_V1_0_1_Storage_CS **ReturnedCS);

## C Structure to Redfish Storage V1_0_1 JSON Function
    RedfishCS_status
    CS_To_Storage_V1_0_1_JSON (RedfishStorage_V1_0_1_Storage_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Storage V1_0_1 C Structure Function
    RedfishCS_status
