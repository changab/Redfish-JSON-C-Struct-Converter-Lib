...
//
#include <RedfishInterpreter/VLanNetworkInterface/v1_0_4/EfiVLanNetworkInterfaceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_0_4 
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_4 *VLanNetworkInterfaceV1_0_4;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_4_CS *VLanNetworkInterfaceV1_0_4Cs;
  ...
  Status = Json_VLanNetworkInterface_V1_0_4_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_0_4 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_4));
  if (VLanNetworkInterfaceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VLanNetworkInterfaceV1_0_4;
  VLanNetworkInterfaceV1_0_4->VLanNetworkInterface = VLanNetworkInterfaceV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VLanNetworkInterface_V1_0_4_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VLanNetworkInterfaceV1_0_4 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_4 *)InterpProp;
  DestroyVLanNetworkInterface_V1_0_4_CS (VLanNetworkInterfaceV1_0_4->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVLanNetworkInterface_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
