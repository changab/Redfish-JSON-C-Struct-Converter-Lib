...
//
#include <RedfishInterpreter/MessageRegistry/v1_0_0/EfiMessageRegistryV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_0_0 
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_0 *MessageRegistryV1_0_0;
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_0_CS *MessageRegistryV1_0_0Cs;
  ...
  Status = Json_MessageRegistry_V1_0_0_To_CS (ResoruceRaw, &MessageRegistryV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_0_0 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_0));
  if (MessageRegistryV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryV1_0_0;
  MessageRegistryV1_0_0->MessageRegistry = MessageRegistryV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistry_V1_0_0_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryV1_0_0 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_0 *)InterpProp;
  DestroyMessageRegistry_V1_0_0_CS (MessageRegistryV1_0_0->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistry_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
