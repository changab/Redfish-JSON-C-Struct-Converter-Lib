...
//
#include <RedfishInterpreter/VirtualMedia/v1_1_3/EfiVirtualMediaV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_1_3 
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_1_3 *VirtualMediaV1_1_3;
  EFI_REDFISH_VIRTUALMEDIA_V1_1_3_CS *VirtualMediaV1_1_3Cs;
  ...
  Status = Json_VirtualMedia_V1_1_3_To_CS (ResoruceRaw, &VirtualMediaV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_1_3 = (EFI_REDFISH_VIRTUALMEDIA_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_1_3));
  if (VirtualMediaV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VirtualMediaV1_1_3;
  VirtualMediaV1_1_3->VirtualMedia = VirtualMediaV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VirtualMedia_V1_1_3_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VirtualMediaV1_1_3 = (EFI_REDFISH_VIRTUALMEDIA_V1_1_3 *)InterpProp;
  DestroyVirtualMedia_V1_1_3_CS (VirtualMediaV1_1_3->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVirtualMedia_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
