...
//
#include <RedfishInterpreter/SimpleStorage/v1_2_1/EfiSimpleStorageV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_2_1 
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_2_1 *SimpleStorageV1_2_1;
  EFI_REDFISH_SIMPLESTORAGE_V1_2_1_CS *SimpleStorageV1_2_1Cs;
  ...
  Status = Json_SimpleStorage_V1_2_1_To_CS (ResoruceRaw, &SimpleStorageV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_2_1 = (EFI_REDFISH_SIMPLESTORAGE_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_2_1));
  if (SimpleStorageV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SimpleStorageV1_2_1;
  SimpleStorageV1_2_1->SimpleStorage = SimpleStorageV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SimpleStorage_V1_2_1_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SimpleStorageV1_2_1 = (EFI_REDFISH_SIMPLESTORAGE_V1_2_1 *)InterpProp;
  DestroySimpleStorage_V1_2_1_CS (SimpleStorageV1_2_1->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySimpleStorage_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
