...
#include"Redfish_ZoneCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishZoneCollection_ZoneCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ZoneCollection.ZoneCollection
//
RedfishCS_status CS_To_ZoneCollection_JSON(RedfishZoneCollection_ZoneCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ZoneCollection.ZoneCollection
//
RedfishCS_status DestroyZoneCollection_CS(RedfishZoneCollection_ZoneCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ZoneCollection.ZoneCollection
//
RedfishCS_status DestroyZoneCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ZoneCollection.NOVERSIONED.ZoneCollection
//
RedfishCS_status
Json_ZoneCollection_To_CS(RedfishCS_char *JsonRawText, RedfishZoneCollection_ZoneCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishZoneCollection_ZoneCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ZoneCollection", "noversioned", "ZoneCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishZoneCollection_ZoneCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
