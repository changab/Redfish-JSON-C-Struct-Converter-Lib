...
//
#include <RedfishInterpreter/Event/v1_0_4/EfiEventV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_4 
...
{
  EFI_REDFISH_EVENT_V1_0_4 *EventV1_0_4;
  EFI_REDFISH_EVENT_V1_0_4_CS *EventV1_0_4Cs;
  ...
  Status = Json_Event_V1_0_4_To_CS (ResoruceRaw, &EventV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_4 = (EFI_REDFISH_EVENT_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_4));
  if (EventV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_0_4;
  EventV1_0_4->Event = EventV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_EVENT_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_0_4_JSON (*((EFI_REDFISH_EVENT_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_0_4 = (EFI_REDFISH_EVENT_V1_0_4 *)InterpProp;
  DestroyEvent_V1_0_4_CS (EventV1_0_4->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_0_4_Json (ResoruceRaw);
}
