...
//
#include <RedfishInterpreter/Manager/v1_4_0/EfiManagerV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_4_0 
...
{
  EFI_REDFISH_MANAGER_V1_4_0 *ManagerV1_4_0;
  EFI_REDFISH_MANAGER_V1_4_0_CS *ManagerV1_4_0Cs;
  ...
  Status = Json_Manager_V1_4_0_To_CS (ResoruceRaw, &ManagerV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_4_0 = (EFI_REDFISH_MANAGER_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_4_0));
  if (ManagerV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_4_0;
  ManagerV1_4_0->Manager = ManagerV1_4_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_4_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_4_0_JSON (*((EFI_REDFISH_MANAGER_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_4_0 = (EFI_REDFISH_MANAGER_V1_4_0 *)InterpProp;
  DestroyManager_V1_4_0_CS (ManagerV1_4_0->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_4_0EntryPoint (
