...
//
#include <RedfishInterpreter/Fabric/v1_0_3/EfiFabricV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_0_3 
...
{
  EFI_REDFISH_FABRIC_V1_0_3 *FabricV1_0_3;
  EFI_REDFISH_FABRIC_V1_0_3_CS *FabricV1_0_3Cs;
  ...
  Status = Json_Fabric_V1_0_3_To_CS (ResoruceRaw, &FabricV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_0_3 = (EFI_REDFISH_FABRIC_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_0_3));
  if (FabricV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)FabricV1_0_3;
  FabricV1_0_3->Fabric = FabricV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_FABRIC_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Fabric_V1_0_3_JSON (*((EFI_REDFISH_FABRIC_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  FabricV1_0_3 = (EFI_REDFISH_FABRIC_V1_0_3 *)InterpProp;
  DestroyFabric_V1_0_3_CS (FabricV1_0_3->Fabric); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyFabric_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_0_3EntryPoint (
