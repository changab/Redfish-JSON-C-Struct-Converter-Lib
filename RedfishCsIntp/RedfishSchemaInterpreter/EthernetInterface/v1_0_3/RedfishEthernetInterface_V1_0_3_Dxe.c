...
//
#include <RedfishInterpreter/EthernetInterface/v1_0_3/EfiEthernetInterfaceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_3 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_3 *EthernetInterfaceV1_0_3;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_3_CS *EthernetInterfaceV1_0_3Cs;
  ...
  Status = Json_EthernetInterface_V1_0_3_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_3 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_3));
  if (EthernetInterfaceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_0_3;
  EthernetInterfaceV1_0_3->EthernetInterface = EthernetInterfaceV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EthernetInterface_V1_0_3_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EthernetInterfaceV1_0_3 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_3 *)InterpProp;
  DestroyEthernetInterface_V1_0_3_CS (EthernetInterfaceV1_0_3->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEthernetInterface_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
