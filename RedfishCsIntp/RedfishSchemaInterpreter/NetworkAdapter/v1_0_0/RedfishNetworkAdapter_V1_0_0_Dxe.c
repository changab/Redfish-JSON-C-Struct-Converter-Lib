...
//
#include <RedfishInterpreter/NetworkAdapter/v1_0_0/EfiNetworkAdapterV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_0_0 
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_0_0 *NetworkAdapterV1_0_0;
  EFI_REDFISH_NETWORKADAPTER_V1_0_0_CS *NetworkAdapterV1_0_0Cs;
  ...
  Status = Json_NetworkAdapter_V1_0_0_To_CS (ResoruceRaw, &NetworkAdapterV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_0_0 = (EFI_REDFISH_NETWORKADAPTER_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_0_0));
  if (NetworkAdapterV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkAdapterV1_0_0;
  NetworkAdapterV1_0_0->NetworkAdapter = NetworkAdapterV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_NETWORKADAPTER_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkAdapter_V1_0_0_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkAdapterV1_0_0 = (EFI_REDFISH_NETWORKADAPTER_V1_0_0 *)InterpProp;
  DestroyNetworkAdapter_V1_0_0_CS (NetworkAdapterV1_0_0->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkAdapter_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
