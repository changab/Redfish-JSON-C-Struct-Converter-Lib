...
//
#include <RedfishInterpreter/NetworkPort/v1_1_1/EfiNetworkPortV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_1_1 
...
{
  EFI_REDFISH_NETWORKPORT_V1_1_1 *NetworkPortV1_1_1;
  EFI_REDFISH_NETWORKPORT_V1_1_1_CS *NetworkPortV1_1_1Cs;
  ...
  Status = Json_NetworkPort_V1_1_1_To_CS (ResoruceRaw, &NetworkPortV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_1_1 = (EFI_REDFISH_NETWORKPORT_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_1_1));
  if (NetworkPortV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkPortV1_1_1;
  NetworkPortV1_1_1->NetworkPort = NetworkPortV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_NETWORKPORT_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkPort_V1_1_1_JSON (*((EFI_REDFISH_NETWORKPORT_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkPortV1_1_1 = (EFI_REDFISH_NETWORKPORT_V1_1_1 *)InterpProp;
  DestroyNetworkPort_V1_1_1_CS (NetworkPortV1_1_1->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkPort_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
