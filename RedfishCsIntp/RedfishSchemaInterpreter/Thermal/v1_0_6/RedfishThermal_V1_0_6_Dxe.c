...
//
#include <RedfishInterpreter/Thermal/v1_0_6/EfiThermalV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_0_6 
...
{
  EFI_REDFISH_THERMAL_V1_0_6 *ThermalV1_0_6;
  EFI_REDFISH_THERMAL_V1_0_6_CS *ThermalV1_0_6Cs;
  ...
  Status = Json_Thermal_V1_0_6_To_CS (ResoruceRaw, &ThermalV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_0_6 = (EFI_REDFISH_THERMAL_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_0_6));
  if (ThermalV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_0_6;
  ThermalV1_0_6->Thermal = ThermalV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_0_6_JSON (*((EFI_REDFISH_THERMAL_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_0_6 = (EFI_REDFISH_THERMAL_V1_0_6 *)InterpProp;
  DestroyThermal_V1_0_6_CS (ThermalV1_0_6->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_0_6EntryPoint (
