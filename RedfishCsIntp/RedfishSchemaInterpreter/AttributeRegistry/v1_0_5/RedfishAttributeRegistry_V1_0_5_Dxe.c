...
//
#include <RedfishInterpreter/AttributeRegistry/v1_0_5/EfiAttributeRegistryV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_0_5 
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_5 *AttributeRegistryV1_0_5;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_5_CS *AttributeRegistryV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "AttributeRegistry") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_AttributeRegistry_V1_0_5_To_CS (ResoruceRaw, &AttributeRegistryV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_0_5 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_5));
  if (AttributeRegistryV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AttributeRegistryV1_0_5;
  AttributeRegistryV1_0_5->AttributeRegistry = AttributeRegistryV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("AttributeRegistry"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "AttributeRegistry");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("AttributeRegistry"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "AttributeRegistry");
...
EFI_STATUS
EFIAPI
AttributeRegistryFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_AttributeRegistry_V1_0_5_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in AttributeRegistryToStruct.
...
EFI_STATUS
EFIAPI
AttributeRegistryDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  AttributeRegistryV1_0_5 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_5 *)InterpProp;
  DestroyAttributeRegistry_V1_0_5_CS (AttributeRegistryV1_0_5->AttributeRegistry); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from AttributeRegistryFromEfiStruct
...
)
{
  ...
  return DestroyAttributeRegistry_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
