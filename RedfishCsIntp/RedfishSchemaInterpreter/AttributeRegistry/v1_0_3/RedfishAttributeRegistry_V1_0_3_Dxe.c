...
//
#include <RedfishInterpreter/AttributeRegistry/v1_0_3/EfiAttributeRegistryV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_0_3 
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_3 *AttributeRegistryV1_0_3;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_3_CS *AttributeRegistryV1_0_3Cs;
  ...
  Status = Json_AttributeRegistry_V1_0_3_To_CS (ResoruceRaw, &AttributeRegistryV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_0_3 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_3));
  if (AttributeRegistryV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AttributeRegistryV1_0_3;
  AttributeRegistryV1_0_3->AttributeRegistry = AttributeRegistryV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AttributeRegistry_V1_0_3_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AttributeRegistryV1_0_3 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_3 *)InterpProp;
  DestroyAttributeRegistry_V1_0_3_CS (AttributeRegistryV1_0_3->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAttributeRegistry_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
