...
//
#include <RedfishInterpreter/ActionInfo/v1_0_0/EfiActionInfoV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_0_0 
...
{
  EFI_REDFISH_ACTIONINFO_V1_0_0 *ActionInfoV1_0_0;
  EFI_REDFISH_ACTIONINFO_V1_0_0_CS *ActionInfoV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ActionInfo") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_ActionInfo_V1_0_0_To_CS (ResoruceRaw, &ActionInfoV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_0_0 = (EFI_REDFISH_ACTIONINFO_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_0_0));
  if (ActionInfoV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ActionInfoV1_0_0;
  ActionInfoV1_0_0->ActionInfo = ActionInfoV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ACTIONINFO_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ActionInfo"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "ActionInfo");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ActionInfo"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "ActionInfo");
...
)
{
  ...
  return CS_To_ActionInfo_V1_0_0_JSON (*((EFI_REDFISH_ACTIONINFO_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ActionInfoToStruct.
...
)
{
  ...
  ActionInfoV1_0_0 = (EFI_REDFISH_ACTIONINFO_V1_0_0 *)InterpProp;
  DestroyActionInfo_V1_0_0_CS (ActionInfoV1_0_0->ActionInfo); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ActionInfoFromEfiStruct
...
)
{
  ...
  return DestroyActionInfo_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
