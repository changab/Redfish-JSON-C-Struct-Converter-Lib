...
#include"Redfish_JobService_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishJobService_V1_0_0_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishJobService_V1_0_0_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishJobService_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJobService_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishJobService_V1_0_0_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishJobService_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJobService_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
//Generate C structure for ServiceCapabilities
//
static RedfishCS_status GenJobServiceCapabilitiesCs(RedfishJobService_V1_0_0_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishJobService_V1_0_0_JobServiceCapabilities_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJobService_V1_0_0_JobServiceCapabilities_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaxJobs
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "MaxJobs", &(*Dst)->MaxJobs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MaxSteps
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "MaxSteps", &(*Dst)->MaxSteps);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Scheduling
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "Scheduling", &(*Dst)->Scheduling);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenStatusCs(RedfishJobService_V1_0_0_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishJobService_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishJobService_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ServiceCapabilities(json_t *CsJson, char *Key, RedfishJobService_V1_0_0_JobServiceCapabilities_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // MaxJobs 
  if (InsertJsonInt64Obj (CsJson, "MaxJobs", CSPtr->MaxJobs) != RedfishCS_status_success) {goto Error;}

  // MaxSteps 
  if (InsertJsonInt64Obj (CsJson, "MaxSteps", CSPtr->MaxSteps) != RedfishCS_status_success) {goto Error;}

  // Scheduling 
  if (InsertJsonBoolObj (CsJson, "Scheduling", CSPtr->Scheduling) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for JobService.V1_0_0.JobService
//
RedfishCS_status CS_To_JobService_V1_0_0_JSON(RedfishJobService_V1_0_0_JobService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Jobs 
  if (InsertJsonLinkObj (CsJson, "Jobs", &CSPtr->Jobs) != RedfishCS_status_success) {goto Error;}

  // Log 
  if (InsertJsonLinkObj (CsJson, "Log", &CSPtr->Log) != RedfishCS_status_success) {goto Error;}
  ...
  // ServiceCapabilities
  if (CS_To_JSON_ServiceCapabilities(CsJson, "ServiceCapabilities", CSPtr->ServiceCapabilities) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for JobService.V1_0_0.JobService
//
RedfishCS_status DestroyJobService_V1_0_0_CS(RedfishJobService_V1_0_0_JobService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for JobService.V1_0_0.JobService
//
RedfishCS_status DestroyJobService_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for JobService.V1_0_0.JobService
//
RedfishCS_status
Json_JobService_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishJobService_V1_0_0_JobService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishJobService_V1_0_0_JobService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "JobService", "v1_0_0", "JobService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishJobService_V1_0_0_JobService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Jobs
  InitializeLinkHead (&Cs->Jobs);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Jobs", Cs->Header.ThisUri, &Cs->Jobs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Log
  InitializeLinkHead (&Cs->Log);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Log", Cs->Header.ThisUri, &Cs->Log);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ServiceCapabilities
  Status = GenJobServiceCapabilitiesCs (Cs, JsonObj, "ServiceCapabilities", &Cs->ServiceCapabilities);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyJobService_V1_0_0_CS (Cs);
  return Status;
}
