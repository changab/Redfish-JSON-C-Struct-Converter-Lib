...
//
#include <RedfishInterpreter/Power/v1_5_2/EfiPowerV1_5_2.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_5_2 
...
{
  EFI_REDFISH_POWER_V1_5_2 *PowerV1_5_2;
  EFI_REDFISH_POWER_V1_5_2_CS *PowerV1_5_2Cs;
  ...
  Status = Json_Power_V1_5_2_To_CS (ResoruceRaw, &PowerV1_5_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_5_2 = (EFI_REDFISH_POWER_V1_5_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_5_2));
  if (PowerV1_5_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_5_2;
  PowerV1_5_2->Power = PowerV1_5_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "5";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_POWER_V1_5_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_5_2_JSON (*((EFI_REDFISH_POWER_V1_5_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_5_2 = (EFI_REDFISH_POWER_V1_5_2 *)InterpProp;
  DestroyPower_V1_5_2_CS (PowerV1_5_2->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_5_2_Json (ResoruceRaw);
}
