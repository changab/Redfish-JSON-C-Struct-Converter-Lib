...
//
#include <RedfishInterpreter/LogService/v1_0_0/EfiLogServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_0 
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_0 *LogServiceV1_0_0;
  EFI_REDFISH_LOGSERVICE_V1_0_0_CS *LogServiceV1_0_0Cs;
  ...
  Status = Json_LogService_V1_0_0_To_CS (ResoruceRaw, &LogServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_0 = (EFI_REDFISH_LOGSERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_0));
  if (LogServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogServiceV1_0_0;
  LogServiceV1_0_0->LogService = LogServiceV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_LOGSERVICE_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogService_V1_0_0_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogServiceV1_0_0 = (EFI_REDFISH_LOGSERVICE_V1_0_0 *)InterpProp;
  DestroyLogService_V1_0_0_CS (LogServiceV1_0_0->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
