# Definition of EthernetInterface.V1_2_3 and functions<br><br>
...
## EthernetInterface
    typedef struct _RedfishEthernetInterface_V1_2_3_EthernetInterface_CS {
        ...
        RedfishEthernetInterface_V1_2_3_IPv6AddressPolicyEntry_CS *IPv6AddressPolicyTable;
        ...
        RedfishEthernetInterface_V1_2_3_Links_CS *Links;
...
|**IPv6AddressPolicyTable**|RedfishEthernetInterface_V1_2_3_IPv6AddressPolicyEntry_CS| Structure points to **IPv6AddressPolicyTable** property.| No| No
...
|**Links**|RedfishEthernetInterface_V1_2_3_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish EthernetInterface V1_2_3 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EthernetInterface V1_2_3 JSON Function
    RedfishCS_status
    CS_To_EthernetInterface_V1_2_3_JSON (RedfishEthernetInterface_V1_2_3_EthernetInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EthernetInterface V1_2_3 C Structure Function
    RedfishCS_status
