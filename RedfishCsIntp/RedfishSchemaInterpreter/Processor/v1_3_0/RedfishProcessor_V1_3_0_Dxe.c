...
//
#include <RedfishInterpreter/Processor/v1_3_0/EfiProcessorV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_3_0 
...
{
  EFI_REDFISH_PROCESSOR_V1_3_0 *ProcessorV1_3_0;
  EFI_REDFISH_PROCESSOR_V1_3_0_CS *ProcessorV1_3_0Cs;
  ...
  Status = Json_Processor_V1_3_0_To_CS (ResoruceRaw, &ProcessorV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_3_0 = (EFI_REDFISH_PROCESSOR_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_3_0));
  if (ProcessorV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ProcessorV1_3_0;
  ProcessorV1_3_0->Processor = ProcessorV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_PROCESSOR_V1_3_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Processor_V1_3_0_JSON (*((EFI_REDFISH_PROCESSOR_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ProcessorV1_3_0 = (EFI_REDFISH_PROCESSOR_V1_3_0 *)InterpProp;
  DestroyProcessor_V1_3_0_CS (ProcessorV1_3_0->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyProcessor_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_3_0EntryPoint (
