...
#include"Redfish_HostInterfaceCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishHostInterfaceCollection_HostInterfaceCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for HostInterfaceCollection.HostInterfaceCollection
//
RedfishCS_status CS_To_HostInterfaceCollection_JSON(RedfishHostInterfaceCollection_HostInterfaceCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for HostInterfaceCollection.HostInterfaceCollection
//
RedfishCS_status DestroyHostInterfaceCollection_CS(RedfishHostInterfaceCollection_HostInterfaceCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for HostInterfaceCollection.HostInterfaceCollection
//
RedfishCS_status DestroyHostInterfaceCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for HostInterfaceCollection.NOVERSIONED.HostInterfaceCollection
//
RedfishCS_status
Json_HostInterfaceCollection_To_CS(RedfishCS_char *JsonRawText, RedfishHostInterfaceCollection_HostInterfaceCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishHostInterfaceCollection_HostInterfaceCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "HostInterfaceCollection", "noversioned", "HostInterfaceCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishHostInterfaceCollection_HostInterfaceCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyHostInterfaceCollection_CS (Cs);
  return Status;
}
