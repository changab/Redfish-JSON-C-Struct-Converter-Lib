# Definition of Storage.V1_3_2 and functions<br><br>
...
## Actions
    typedef struct _RedfishStorage_V1_3_2_Actions_CS {
        ...
        RedfishStorage_V1_3_2_OemActions_CS *Oem;
    } RedfishStorage_V1_3_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Storage_SetEncryptionKey**|RedfishStorage_V1_3_2_SetEncryptionKey_CS| Structure points to **#Storage.SetEncryptionKey** property.| No| No
|**Oem**|RedfishStorage_V1_3_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## StorageController
    typedef struct _RedfishStorage_V1_3_2_StorageController_CS {
        ...
        RedfishStorage_V1_3_2_StorageControllerActions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_char *FirmwareVersion;
        RedfishCS_Link Identifiers;
        RedfishStorage_V1_3_2_StorageControllerLinks_CS *Links;
...
|**Actions**|RedfishStorage_V1_3_2_StorageControllerActions_CS| Structure points to **Actions** property.| No| No
|**AssetTag**|RedfishCS_char| String pointer to **AssetTag** property.| No| No
|**FirmwareVersion**|RedfishCS_char| String pointer to **FirmwareVersion** property.| No| Yes
|**Identifiers**|RedfishCS_Link| Structure link list to **Identifiers** property.| No| No
|**Links**|RedfishStorage_V1_3_2_StorageControllerLinks_CS| Structure points to **Links** property.| No| No
...
## StorageControllerActions
    typedef struct _RedfishStorage_V1_3_2_StorageControllerActions_CS {
        RedfishStorage_V1_3_2_StorageControllerOemActions_CS *Oem;
    } RedfishStorage_V1_3_2_StorageControllerActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishStorage_V1_3_2_StorageControllerOemActions_CS| Structure points to **Oem** property.| No| No
...
## Storage
    typedef struct _RedfishStorage_V1_3_2_Storage_CS {
        ...
        RedfishStorage_V1_3_2_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_Link Drives;
        RedfishCS_int64 *Drivesodata_count;
        RedfishCS_char *Id;
        RedfishStorage_V1_3_2_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_Link Redundancy;
        RedfishCS_int64 *Redundancyodata_count;
        RedfishResource_Status_CS *Status;
        RedfishStorage_V1_3_2_StorageController_CS *StorageControllers;
...
|**Actions**|RedfishStorage_V1_3_2_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishStorage_V1_3_2_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
...
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**StorageControllers**|RedfishStorage_V1_3_2_StorageController_CS| Structure points to **StorageControllers** property.| No| Yes
...
## Redfish Storage V1_3_2 to C Structure Function
    RedfishCS_status
    Json_Storage_V1_3_2_To_CS (RedfishCS_char *JsonRawText, RedfishStorage_V1_3_2_Storage_CS **ReturnedCS);

## C Structure to Redfish Storage V1_3_2 JSON Function
    RedfishCS_status
    CS_To_Storage_V1_3_2_JSON (RedfishStorage_V1_3_2_Storage_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Storage V1_3_2 C Structure Function
    RedfishCS_status
