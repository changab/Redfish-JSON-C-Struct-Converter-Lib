...
#ifndef _RedfishSecureboot_V1_0_2_CSTRUCT_H_
#define _RedfishSecureboot_V1_0_2_CSTRUCT_H_
...
typedef struct _RedfishSecureBoot_V1_0_2_ResetKeys_CS RedfishSecureBoot_V1_0_2_ResetKeys_CS;
typedef struct _RedfishSecureBoot_V1_0_2_SecureBoot_CS RedfishSecureBoot_V1_0_2_SecureBoot_CS;
typedef struct _RedfishSecureBoot_V1_0_2_SecureBoot_Actions_CS RedfishSecureBoot_V1_0_2_SecureBoot_Actions_CS;
typedef struct _RedfishSecureBoot_V1_0_2_SecureBoot_Actions_Oem_CS RedfishSecureBoot_V1_0_2_SecureBoot_Actions_Oem_CS;
//
...
typedef struct _RedfishSecureBoot_V1_0_2_SecureBoot_Actions_CS {
    ...
    RedfishSecureBoot_V1_0_2_SecureBoot_Actions_Oem_CS    *Oem;                    // The available OEM specific
...
typedef struct _RedfishSecureBoot_V1_0_2_SecureBoot_CS {
    ...
    RedfishSecureBoot_V1_0_2_SecureBoot_Actions_CS    *Actions;                 // The available actions for this
                                                                                // resource.
...
RedfishCS_status
Json_SecureBoot_V1_0_2_To_CS (char *JsonRawText, RedfishSecureBoot_V1_0_2_SecureBoot_CS **ReturnedCS);

RedfishCS_status
CS_To_SecureBoot_V1_0_2_JSON (RedfishSecureBoot_V1_0_2_SecureBoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySecureBoot_V1_0_2_CS (RedfishSecureBoot_V1_0_2_SecureBoot_CS *CSPtr);

RedfishCS_status
DestroySecureBoot_V1_0_2_Json (RedfishCS_char *JsonText);
