...
//
#include <RedfishInterpreter/NetworkDeviceFunction/v1_0_1/EfiNetworkDeviceFunctionV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_0_1 
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_1 *NetworkDeviceFunctionV1_0_1;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_1_CS *NetworkDeviceFunctionV1_0_1Cs;
  ...
  Status = Json_NetworkDeviceFunction_V1_0_1_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_0_1 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_1));
  if (NetworkDeviceFunctionV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkDeviceFunctionV1_0_1;
  NetworkDeviceFunctionV1_0_1->NetworkDeviceFunction = NetworkDeviceFunctionV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkDeviceFunction_V1_0_1_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkDeviceFunctionV1_0_1 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_1 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_0_1_CS (NetworkDeviceFunctionV1_0_1->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkDeviceFunction_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
