...
//
#include <RedfishInterpreter/HostInterface/v1_1_1/EfiHostInterfaceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_1_1 
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_1_1 *HostInterfaceV1_1_1;
  EFI_REDFISH_HOSTINTERFACE_V1_1_1_CS *HostInterfaceV1_1_1Cs;
  ...
  Status = Json_HostInterface_V1_1_1_To_CS (ResoruceRaw, &HostInterfaceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_1_1 = (EFI_REDFISH_HOSTINTERFACE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_1_1));
  if (HostInterfaceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)HostInterfaceV1_1_1;
  HostInterfaceV1_1_1->HostInterface = HostInterfaceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_HOSTINTERFACE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_HostInterface_V1_1_1_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  HostInterfaceV1_1_1 = (EFI_REDFISH_HOSTINTERFACE_V1_1_1 *)InterpProp;
  DestroyHostInterface_V1_1_1_CS (HostInterfaceV1_1_1->HostInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyHostInterface_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
