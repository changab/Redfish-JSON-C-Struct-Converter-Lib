...
//
#include <RedfishInterpreter/VirtualMedia/v1_0_4/EfiVirtualMediaV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_0_4 
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_0_4 *VirtualMediaV1_0_4;
  EFI_REDFISH_VIRTUALMEDIA_V1_0_4_CS *VirtualMediaV1_0_4Cs;
  ...
  Status = Json_VirtualMedia_V1_0_4_To_CS (ResoruceRaw, &VirtualMediaV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_0_4 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_0_4));
  if (VirtualMediaV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VirtualMediaV1_0_4;
  VirtualMediaV1_0_4->VirtualMedia = VirtualMediaV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VirtualMedia_V1_0_4_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VirtualMediaV1_0_4 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_4 *)InterpProp;
  DestroyVirtualMedia_V1_0_4_CS (VirtualMediaV1_0_4->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVirtualMedia_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
