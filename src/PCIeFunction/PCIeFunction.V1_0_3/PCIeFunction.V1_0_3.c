...
#include"Redfish_PCIeFunction_v1_0_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPCIeFunction_V1_0_3_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenLinksCs(RedfishPCIeFunction_V1_0_3_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeFunction_V1_0_3_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeFunction_V1_0_3_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Drives
...
//
static RedfishCS_status GenStatusCs(RedfishPCIeFunction_V1_0_3_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPCIeFunction_V1_0_3_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PCIeFunction.V1_0_3.PCIeFunction
//
RedfishCS_status CS_To_PCIeFunction_V1_0_3_JSON(RedfishPCIeFunction_V1_0_3_PCIeFunction_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PCIeFunction.V1_0_3.PCIeFunction
//
RedfishCS_status DestroyPCIeFunction_V1_0_3_CS(RedfishPCIeFunction_V1_0_3_PCIeFunction_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PCIeFunction.V1_0_3.PCIeFunction
//
RedfishCS_status DestroyPCIeFunction_V1_0_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PCIeFunction.V1_0_3.PCIeFunction
//
RedfishCS_status
Json_PCIeFunction_V1_0_3_To_CS(RedfishCS_char *JsonRawText, RedfishPCIeFunction_V1_0_3_PCIeFunction_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPCIeFunction_V1_0_3_PCIeFunction_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PCIeFunction", "v1_0_3", "PCIeFunction", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPCIeFunction_V1_0_3_PCIeFunction_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPCIeFunction_V1_0_3_CS (Cs);
  return Status;
}
