...
//
#include <RedfishInterpreter/VLanNetworkInterface/v1_0_5/EfiVLanNetworkInterfaceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_0_5 
...
EFI_STATUS
EFIAPI
VLanNetworkInterfaceToEfiStruct (
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_5 *VLanNetworkInterfaceV1_0_5;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_5_CS *VLanNetworkInterfaceV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "VLanNetworkInterface") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_VLanNetworkInterface_V1_0_5_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_0_5 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_5));
  if (VLanNetworkInterfaceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VLanNetworkInterfaceV1_0_5;
  VLanNetworkInterfaceV1_0_5->VLanNetworkInterface = VLanNetworkInterfaceV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("VLanNetworkInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "VLanNetworkInterface");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("VLanNetworkInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "VLanNetworkInterface");
...
EFI_STATUS
EFIAPI
VLanNetworkInterfaceFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_VLanNetworkInterface_V1_0_5_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in VLanNetworkInterfaceToStruct.
...
EFI_STATUS
EFIAPI
VLanNetworkInterfaceDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  VLanNetworkInterfaceV1_0_5 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_5 *)InterpProp;
  DestroyVLanNetworkInterface_V1_0_5_CS (VLanNetworkInterfaceV1_0_5->VLanNetworkInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from VLanNetworkInterfaceFromEfiStruct
...
EFI_STATUS
EFIAPI
VLanNetworkInterfaceDestoryJson(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
  IN EFI_REST_RESOURCE_TYPE_IDENTIFIER *RsrcIdentifier,  
  IN CHAR8 *ResoruceRaw
)
{
  ...
  return DestroyVLanNetworkInterface_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
