...
//
#include <RedfishInterpreter/Task/v1_1_2/EfiTaskV1_1_2.h>
...
{
  EFI_REDFISH_TASK_V1_1_2 *TaskV1_1_2;
  EFI_REDFISH_TASK_V1_1_2_CS *TaskV1_1_2Cs;
  ...
  Status = Json_Task_V1_1_2_To_CS (ResoruceRaw, &TaskV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_1_2 = (EFI_REDFISH_TASK_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_1_2));
  if (TaskV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskV1_1_2;
  TaskV1_1_2->Task = TaskV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_TASK_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Task_V1_1_2_JSON (*((EFI_REDFISH_TASK_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskV1_1_2 = (EFI_REDFISH_TASK_V1_1_2 *)InterpProp;
  DestroyTask_V1_1_2_CS (TaskV1_1_2->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTask_V1_1_2_Json (ResoruceRaw);
}
