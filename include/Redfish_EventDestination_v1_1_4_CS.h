...
#ifndef _RedfishEventdestination_V1_1_4_CSTRUCT_H_
#define _RedfishEventdestination_V1_1_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEventDestination_V1_1_4_HttpHeaderProperty_Array_CS RedfishEventDestination_V1_1_4_HttpHeaderProperty_Array_CS;
...
#endif
typedef struct _RedfishEventDestination_V1_1_4_EventDestination_CS RedfishEventDestination_V1_1_4_EventDestination_CS;
typedef struct _RedfishEventDestination_V1_1_4_HttpHeaderProperty_CS RedfishEventDestination_V1_1_4_HttpHeaderProperty_CS;
...
typedef struct _RedfishEventDestination_V1_1_4_EventDestination_CS {
    ...
    RedfishEventDestination_V1_1_4_HttpHeaderProperty_Array_CS    *HttpHeaders;                  // This is for setting HTTP
...
typedef struct _RedfishEventDestination_V1_1_4_HttpHeaderProperty_Array_CS  {
    RedfishEventDestination_V1_1_4_HttpHeaderProperty_Array_CS    *Next;
    RedfishEventDestination_V1_1_4_HttpHeaderProperty_CS    *ArrayValue;
} RedfishEventDestination_V1_1_4_HttpHeaderProperty_Array_CS;
...
RedfishCS_status
Json_EventDestination_V1_1_4_To_CS (char *JsonRawText, RedfishEventDestination_V1_1_4_EventDestination_CS **ReturnedCS);

RedfishCS_status
CS_To_EventDestination_V1_1_4_JSON (RedfishEventDestination_V1_1_4_EventDestination_CS *CSPtr, char **JsonText);
