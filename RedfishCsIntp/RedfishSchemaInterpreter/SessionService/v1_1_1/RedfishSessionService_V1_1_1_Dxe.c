...
//
#include <RedfishInterpreter/SessionService/v1_1_1/EfiSessionServiceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_1_1 
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_1_1 *SessionServiceV1_1_1;
  EFI_REDFISH_SESSIONSERVICE_V1_1_1_CS *SessionServiceV1_1_1Cs;
  ...
  Status = Json_SessionService_V1_1_1_To_CS (ResoruceRaw, &SessionServiceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_1_1 = (EFI_REDFISH_SESSIONSERVICE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_1));
  if (SessionServiceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionServiceV1_1_1;
  SessionServiceV1_1_1->SessionService = SessionServiceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SessionService_V1_1_1_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionServiceV1_1_1 = (EFI_REDFISH_SESSIONSERVICE_V1_1_1 *)InterpProp;
  DestroySessionService_V1_1_1_CS (SessionServiceV1_1_1->SessionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySessionService_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
