...
#include"Redfish_MemoryDomainCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishMemoryDomainCollection_MemoryDomainCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for MemoryDomainCollection.MemoryDomainCollection
//
RedfishCS_status CS_To_MemoryDomainCollection_JSON(RedfishMemoryDomainCollection_MemoryDomainCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MemoryDomainCollection.MemoryDomainCollection
//
RedfishCS_status DestroyMemoryDomainCollection_CS(RedfishMemoryDomainCollection_MemoryDomainCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MemoryDomainCollection.MemoryDomainCollection
//
RedfishCS_status DestroyMemoryDomainCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MemoryDomainCollection.NOVERSIONED.MemoryDomainCollection
//
RedfishCS_status
Json_MemoryDomainCollection_To_CS(RedfishCS_char *JsonRawText, RedfishMemoryDomainCollection_MemoryDomainCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemoryDomainCollection_MemoryDomainCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MemoryDomainCollection", "noversioned", "MemoryDomainCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemoryDomainCollection_MemoryDomainCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMemoryDomainCollection_CS (Cs);
  return Status;
}
