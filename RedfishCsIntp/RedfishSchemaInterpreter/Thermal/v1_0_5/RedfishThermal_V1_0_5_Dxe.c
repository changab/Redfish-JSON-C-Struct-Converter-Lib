...
//
#include <RedfishInterpreter/Thermal/v1_0_5/EfiThermalV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_0_5 
...
{
  EFI_REDFISH_THERMAL_V1_0_5 *ThermalV1_0_5;
  EFI_REDFISH_THERMAL_V1_0_5_CS *ThermalV1_0_5Cs;
  ...
  Status = Json_Thermal_V1_0_5_To_CS (ResoruceRaw, &ThermalV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_0_5 = (EFI_REDFISH_THERMAL_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_0_5));
  if (ThermalV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_0_5;
  ThermalV1_0_5->Thermal = ThermalV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_0_5_JSON (*((EFI_REDFISH_THERMAL_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_0_5 = (EFI_REDFISH_THERMAL_V1_0_5 *)InterpProp;
  DestroyThermal_V1_0_5_CS (ThermalV1_0_5->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_0_5EntryPoint (
