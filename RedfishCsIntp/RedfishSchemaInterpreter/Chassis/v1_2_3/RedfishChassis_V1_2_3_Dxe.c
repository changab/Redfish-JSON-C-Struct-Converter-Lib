...
//
#include <RedfishInterpreter/Chassis/v1_2_3/EfiChassisV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_2_3 
...
{
  EFI_REDFISH_CHASSIS_V1_2_3 *ChassisV1_2_3;
  EFI_REDFISH_CHASSIS_V1_2_3_CS *ChassisV1_2_3Cs;
  ...
  Status = Json_Chassis_V1_2_3_To_CS (ResoruceRaw, &ChassisV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_2_3 = (EFI_REDFISH_CHASSIS_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_2_3));
  if (ChassisV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_2_3;
  ChassisV1_2_3->Chassis = ChassisV1_2_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_2_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_2_3_JSON (*((EFI_REDFISH_CHASSIS_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_2_3 = (EFI_REDFISH_CHASSIS_V1_2_3 *)InterpProp;
  DestroyChassis_V1_2_3_CS (ChassisV1_2_3->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_2_3EntryPoint (
