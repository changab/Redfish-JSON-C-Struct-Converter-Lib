# Definition of PCIeFunction.V1_0_1 and functions<br><br>
...
## PCIeFunction
    typedef struct _RedfishPCIeFunction_V1_0_1_PCIeFunction_CS {
        ...
        RedfishCS_char *Id;
        RedfishPCIeFunction_V1_0_1_PCIeFunction_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Links**|RedfishPCIeFunction_V1_0_1_PCIeFunction_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish PCIeFunction V1_0_1 to C Structure Function
    RedfishCS_status
    Json_PCIeFunction_V1_0_1_To_CS (RedfishCS_char *JsonRawText, RedfishPCIeFunction_V1_0_1_PCIeFunction_CS **ReturnedCS);

## C Structure to Redfish PCIeFunction V1_0_1 JSON Function
    RedfishCS_status
    CS_To_PCIeFunction_V1_0_1_JSON (RedfishPCIeFunction_V1_0_1_PCIeFunction_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish PCIeFunction V1_0_1 C Structure Function
    RedfishCS_status
