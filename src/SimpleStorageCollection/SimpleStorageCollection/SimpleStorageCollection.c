...
#include"Redfish_SimpleStorageCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishSimpleStorageCollection_SimpleStorageCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for SimpleStorageCollection.SimpleStorageCollection
//
RedfishCS_status CS_To_SimpleStorageCollection_JSON(RedfishSimpleStorageCollection_SimpleStorageCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SimpleStorageCollection.SimpleStorageCollection
//
RedfishCS_status DestroySimpleStorageCollection_CS(RedfishSimpleStorageCollection_SimpleStorageCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SimpleStorageCollection.SimpleStorageCollection
//
RedfishCS_status DestroySimpleStorageCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SimpleStorageCollection.NOVERSIONED.SimpleStorageCollection
//
RedfishCS_status
Json_SimpleStorageCollection_To_CS(RedfishCS_char *JsonRawText, RedfishSimpleStorageCollection_SimpleStorageCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSimpleStorageCollection_SimpleStorageCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SimpleStorageCollection", "noversioned", "SimpleStorageCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSimpleStorageCollection_SimpleStorageCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySimpleStorageCollection_CS (Cs);
  return Status;
}
