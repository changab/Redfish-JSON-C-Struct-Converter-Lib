...
//
#include <RedfishInterpreter/ServiceRoot/v1_0_4/EfiServiceRootV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_0_4 
...
{
  EFI_REDFISH_SERVICEROOT_V1_0_4 *ServiceRootV1_0_4;
  EFI_REDFISH_SERVICEROOT_V1_0_4_CS *ServiceRootV1_0_4Cs;
  ...
  Status = Json_ServiceRoot_V1_0_4_To_CS (ResoruceRaw, &ServiceRootV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_0_4 = (EFI_REDFISH_SERVICEROOT_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_0_4));
  if (ServiceRootV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_0_4;
  ServiceRootV1_0_4->ServiceRoot = ServiceRootV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ServiceRoot_V1_0_4_JSON (*((EFI_REDFISH_SERVICEROOT_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ServiceRootV1_0_4 = (EFI_REDFISH_SERVICEROOT_V1_0_4 *)InterpProp;
  DestroyServiceRoot_V1_0_4_CS (ServiceRootV1_0_4->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyServiceRoot_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
