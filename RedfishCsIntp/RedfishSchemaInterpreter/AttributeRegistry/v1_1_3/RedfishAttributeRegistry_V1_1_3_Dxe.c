...
//
#include <RedfishInterpreter/AttributeRegistry/v1_1_3/EfiAttributeRegistryV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_1_3 
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_3 *AttributeRegistryV1_1_3;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_3_CS *AttributeRegistryV1_1_3Cs;
  ...
  Status = Json_AttributeRegistry_V1_1_3_To_CS (ResoruceRaw, &AttributeRegistryV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_1_3 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_3));
  if (AttributeRegistryV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AttributeRegistryV1_1_3;
  AttributeRegistryV1_1_3->AttributeRegistry = AttributeRegistryV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AttributeRegistry_V1_1_3_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AttributeRegistryV1_1_3 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_3 *)InterpProp;
  DestroyAttributeRegistry_V1_1_3_CS (AttributeRegistryV1_1_3->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAttributeRegistry_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
