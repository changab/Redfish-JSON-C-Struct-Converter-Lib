...
//
#include <RedfishInterpreter/AccountService/v1_3_0/EfiAccountServiceV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_3_0 
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_3_0 *AccountServiceV1_3_0;
  EFI_REDFISH_ACCOUNTSERVICE_V1_3_0_CS *AccountServiceV1_3_0Cs;
  ...
  Status = Json_AccountService_V1_3_0_To_CS (ResoruceRaw, &AccountServiceV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_3_0 = (EFI_REDFISH_ACCOUNTSERVICE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_3_0));
  if (AccountServiceV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AccountServiceV1_3_0;
  AccountServiceV1_3_0->AccountService = AccountServiceV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_3_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AccountService_V1_3_0_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AccountServiceV1_3_0 = (EFI_REDFISH_ACCOUNTSERVICE_V1_3_0 *)InterpProp;
  DestroyAccountService_V1_3_0_CS (AccountServiceV1_3_0->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAccountService_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
