...
//
#include <RedfishInterpreter/SecureBoot/v1_0_2/EfiSecureBootV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#SecureBoot";
BOOLEAN IsRevisonController = TRUE;

// Support SecureBoot V1_0_2 
...
{
  EFI_REDFISH_SECUREBOOT_V1_0_2 *SecureBootV1_0_2;
  EFI_REDFISH_SECUREBOOT_V1_0_2_CS *SecureBootV1_0_2Cs;
  ...
  Status = Json_SecureBoot_V1_0_2_To_CS (ResoruceRaw, &SecureBootV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootV1_0_2 = (EFI_REDFISH_SECUREBOOT_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOT_V1_0_2));
  if (SecureBootV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SecureBootV1_0_2;
  SecureBootV1_0_2->SecureBoot = SecureBootV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SECUREBOOT_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SecureBoot_V1_0_2_JSON (*((EFI_REDFISH_SECUREBOOT_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SecureBootV1_0_2 = (EFI_REDFISH_SECUREBOOT_V1_0_2 *)InterpProp;
  DestroySecureBoot_V1_0_2_CS (SecureBootV1_0_2->SecureBoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySecureBoot_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
