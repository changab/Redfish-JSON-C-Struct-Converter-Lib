...
//
#include <RedfishInterpreter/SecureBoot/v1_0_0/EfiSecureBootV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#SecureBoot";
BOOLEAN IsRevisonController = TRUE;

// Support SecureBoot V1_0_0 
...
{
  EFI_REDFISH_SECUREBOOT_V1_0_0 *SecureBootV1_0_0;
  EFI_REDFISH_SECUREBOOT_V1_0_0_CS *SecureBootV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "SecureBoot") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_SecureBoot_V1_0_0_To_CS (ResoruceRaw, &SecureBootV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootV1_0_0 = (EFI_REDFISH_SECUREBOOT_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOT_V1_0_0));
  if (SecureBootV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SecureBootV1_0_0;
  SecureBootV1_0_0->SecureBoot = SecureBootV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SECUREBOOT_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SecureBoot"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "SecureBoot");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SecureBoot"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "SecureBoot");
...
)
{
  ...
  return CS_To_SecureBoot_V1_0_0_JSON (*((EFI_REDFISH_SECUREBOOT_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in SecureBootToStruct.
...
)
{
  ...
  SecureBootV1_0_0 = (EFI_REDFISH_SECUREBOOT_V1_0_0 *)InterpProp;
  DestroySecureBoot_V1_0_0_CS (SecureBootV1_0_0->SecureBoot); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SecureBootFromEfiStruct
...
)
{
  ...
  return DestroySecureBoot_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
