...
#include"Redfish_Volume_v1_0_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishVolume_V1_0_2_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Volume.Initialize
//
static RedfishCS_status GenInitializeCs(RedfishVolume_V1_0_2_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_2_Initialize_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_2_Initialize_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActions_OemCs(RedfishVolume_V1_0_2_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_2_Volume_Actions_Oem_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_2_Volume_Actions_Oem_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishVolume_V1_0_2_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_2_Volume_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_2_Volume_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Volume.Initialize
...
//
//Generate C structure for Identifiers
//
static RedfishCS_status GenIdentifierCs(RedfishVolume_V1_0_2_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_V1_1_0_Identifier_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishResource_V1_1_0_Identifier_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DurableName
...
//
static RedfishCS_status GenLinksCs(RedfishVolume_V1_0_2_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_2_Volume_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_2_Volume_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Drives
  InitializeLinkHead (&(*Dst)->Drives);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "Drives", Cs->Header.ThisUri, &(*Dst)->Drives);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenOperationsCs(RedfishVolume_V1_0_2_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_2_Operations_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_2_Operations_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AssociatedTask
...
//
static RedfishCS_status GenStatusCs(RedfishVolume_V1_0_2_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishVolume_V1_0_2_Volume_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsVolume_Initialize(json_t *CsJson, char *Key, RedfishVolume_V1_0_2_Initialize_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishVolume_V1_0_2_Volume_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Identifiers(json_t *CsJson, char *Key, RedfishResource_V1_1_0_Identifier_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // DurableName 
  if (InsertJsonStringObj (CsJson, "DurableName", CSPtr->DurableName) != RedfishCS_status_success) {goto Error;}

  // DurableNameFormat 
  if (InsertJsonStringObj (CsJson, "DurableNameFormat", CSPtr->DurableNameFormat) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishVolume_V1_0_2_Volume_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Drives 
  if (InsertJsonLinkObj (CsJson, "Drives", &CSPtr->Drives) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Operations(json_t *CsJson, char *Key, RedfishVolume_V1_0_2_Operations_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // AssociatedTask 
  if (InsertJsonLinkObj (CsJson, "AssociatedTask", &CSPtr->AssociatedTask) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Volume.V1_0_2.Volume
//
RedfishCS_status CS_To_Volume_V1_0_2_JSON(RedfishVolume_V1_0_2_Volume_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Volume.V1_0_2.Volume
//
RedfishCS_status DestroyVolume_V1_0_2_CS(RedfishVolume_V1_0_2_Volume_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Volume.V1_0_2.Volume
//
RedfishCS_status DestroyVolume_V1_0_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Volume.V1_0_2.Volume
//
RedfishCS_status
Json_Volume_V1_0_2_To_CS(RedfishCS_char *JsonRawText, RedfishVolume_V1_0_2_Volume_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVolume_V1_0_2_Volume_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Volume", "v1_0_2", "Volume", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVolume_V1_0_2_Volume_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Identifiers
  Status = GenIdentifierCs (Cs, JsonObj, "Identifiers", &Cs->Identifiers);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Operations
  Status = GenOperationsCs (Cs, JsonObj, "Operations", &Cs->Operations);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
