...
//
#include <RedfishInterpreter/Port/v1_0_1/EfiPortV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Port";
...
{
  EFI_REDFISH_PORT_V1_0_1 *PortV1_0_1;
  EFI_REDFISH_PORT_V1_0_1_CS *PortV1_0_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Port") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Port_V1_0_1_To_CS (ResoruceRaw, &PortV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_0_1 = (EFI_REDFISH_PORT_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_0_1));
  if (PortV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PortV1_0_1;
  PortV1_0_1->Port = PortV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_PORT_V1_0_1_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Port"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Port");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Port"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Port");
...
)
{
  ...
  return CS_To_Port_V1_0_1_JSON (*((EFI_REDFISH_PORT_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in PortToStruct.
...
)
{
  ...
  PortV1_0_1 = (EFI_REDFISH_PORT_V1_0_1 *)InterpProp;
  DestroyPort_V1_0_1_CS (PortV1_0_1->Port); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PortFromEfiStruct
...
)
{
  ...
  return DestroyPort_V1_0_1_Json (ResoruceRaw);
}
