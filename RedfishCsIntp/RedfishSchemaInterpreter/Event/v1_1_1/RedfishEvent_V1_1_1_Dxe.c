...
//
#include <RedfishInterpreter/Event/v1_1_1/EfiEventV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_1_1 
...
{
  EFI_REDFISH_EVENT_V1_1_1 *EventV1_1_1;
  EFI_REDFISH_EVENT_V1_1_1_CS *EventV1_1_1Cs;
  ...
  Status = Json_Event_V1_1_1_To_CS (ResoruceRaw, &EventV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_1_1 = (EFI_REDFISH_EVENT_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_1_1));
  if (EventV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_1_1;
  EventV1_1_1->Event = EventV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_EVENT_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_1_1_JSON (*((EFI_REDFISH_EVENT_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_1_1 = (EFI_REDFISH_EVENT_V1_1_1 *)InterpProp;
  DestroyEvent_V1_1_1_CS (EventV1_1_1->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_1_1_Json (ResoruceRaw);
}
