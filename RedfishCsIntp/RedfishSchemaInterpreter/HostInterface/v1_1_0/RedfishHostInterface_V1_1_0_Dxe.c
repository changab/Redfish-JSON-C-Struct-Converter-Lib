...
//
#include <RedfishInterpreter/HostInterface/v1_1_0/EfiHostInterfaceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_1_0 
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_1_0 *HostInterfaceV1_1_0;
  EFI_REDFISH_HOSTINTERFACE_V1_1_0_CS *HostInterfaceV1_1_0Cs;
  ...
  Status = Json_HostInterface_V1_1_0_To_CS (ResoruceRaw, &HostInterfaceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_1_0 = (EFI_REDFISH_HOSTINTERFACE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_1_0));
  if (HostInterfaceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)HostInterfaceV1_1_0;
  HostInterfaceV1_1_0->HostInterface = HostInterfaceV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_HOSTINTERFACE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_HostInterface_V1_1_0_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  HostInterfaceV1_1_0 = (EFI_REDFISH_HOSTINTERFACE_V1_1_0 *)InterpProp;
  DestroyHostInterface_V1_1_0_CS (HostInterfaceV1_1_0->HostInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyHostInterface_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
