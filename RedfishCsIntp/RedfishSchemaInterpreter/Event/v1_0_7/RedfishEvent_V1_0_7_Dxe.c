...
//
#include <RedfishInterpreter/Event/v1_0_7/EfiEventV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_7 
...
{
  EFI_REDFISH_EVENT_V1_0_7 *EventV1_0_7;
  EFI_REDFISH_EVENT_V1_0_7_CS *EventV1_0_7Cs;
  ...
  Status = Json_Event_V1_0_7_To_CS (ResoruceRaw, &EventV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_7 = (EFI_REDFISH_EVENT_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_7));
  if (EventV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_0_7;
  EventV1_0_7->Event = EventV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_EVENT_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_0_7_JSON (*((EFI_REDFISH_EVENT_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_0_7 = (EFI_REDFISH_EVENT_V1_0_7 *)InterpProp;
  DestroyEvent_V1_0_7_CS (EventV1_0_7->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_0_7_Json (ResoruceRaw);
}
