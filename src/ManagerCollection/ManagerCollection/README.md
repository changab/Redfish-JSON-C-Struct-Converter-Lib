# Definition of ManagerCollection and functions<br><br>
...
## Redfish ManagerCollection  to C Structure Function
    RedfishCS_status
    Json_ManagerCollection_To_CS (RedfishCS_char *JsonRawText, RedfishManagerCollection_ManagerCollection_CS **ReturnedCS);

## C Structure to Redfish ManagerCollection  JSON Function
    RedfishCS_status
    CS_To_ManagerCollection_JSON (RedfishManagerCollection_ManagerCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ManagerCollection  C Structure Function
    RedfishCS_status
