...
#include"Redfish_Thermal_v1_5_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
static RedfishCS_status GenidRef_ArrayCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, Redfishodata_V4_0_3_idRef_Array_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenThermalOemActionsCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_0_ThermalOemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_0_ThermalOemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenThermalActionsCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_0_ThermalActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_0_ThermalActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
  Status = GenThermalOemActionsCs (Cs, TempJsonObj, "Oem", &(*Dst)->Oem);
...
//Generate C structure for Oem
//
static RedfishCS_status GenFanOemActionsCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_0_FanOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_0_FanOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenFanActionsCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_0_FanActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_0_FanActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
  Status = GenFanOemActionsCs (Cs, TempJsonObj, "Oem", &(*Dst)->Oem);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodata_V4_0_3_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenFan_Array_ElementCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishThermal_V1_5_0_Fan_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishThermal_V1_5_0_Fan_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
  ...
  // Actions
  Status = GenFanActionsCs (Cs, TempJsonObj, "Actions", &(*Dst)->Actions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishThermal_V1_5_0_Fan_Array_CS
//
static RedfishCS_status GenFan_ArrayCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_0_Fan_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishThermal_V1_5_0_Fan_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishThermal_V1_5_0_Fan_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//Generate C structure for Oem
//
static RedfishCS_status GenTemperatureOemActionsCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_0_TemperatureOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_0_TemperatureOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenTemperatureActionsCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_0_TemperatureActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_0_TemperatureActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
  Status = GenTemperatureOemActionsCs (Cs, TempJsonObj, "Oem", &(*Dst)->Oem);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenTemperature_Array_ElementCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishThermal_V1_5_0_Temperature_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishThermal_V1_5_0_Temperature_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
  ...
  // Actions
  Status = GenTemperatureActionsCs (Cs, TempJsonObj, "Actions", &(*Dst)->Actions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AdjustedMaxAllowableOperatingValue
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "AdjustedMaxAllowableOperatingValue", &(*Dst)->AdjustedMaxAllowableOperatingValue);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AdjustedMinAllowableOperatingValue
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "AdjustedMinAllowableOperatingValue", &(*Dst)->AdjustedMinAllowableOperatingValue);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // DeltaPhysicalContext
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "DeltaPhysicalContext", &(*Dst)->DeltaPhysicalContext);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // DeltaReadingCelsius
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "DeltaReadingCelsius", &(*Dst)->DeltaReadingCelsius);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "MaxAllowableOperatingValue", &(*Dst)->MaxAllowableOperatingValue);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "MinAllowableOperatingValue", &(*Dst)->MinAllowableOperatingValue);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishThermal_V1_5_0_Temperature_Array_CS
//
static RedfishCS_status GenTemperature_ArrayCs(RedfishThermal_V1_5_0_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_0_Temperature_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishThermal_V1_5_0_Temperature_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishThermal_V1_5_0_Temperature_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishThermal_V1_5_0_ThermalOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishThermal_V1_5_0_ThermalActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FansActionsOem(json_t *CsJson, char *Key, RedfishThermal_V1_5_0_FanOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FansActions(json_t *CsJson, char *Key, RedfishThermal_V1_5_0_FanActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Oem
  if (CS_To_JSON_FansActionsOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_FansRelatedItem(json_t *CsJson, char *Key, Redfishodata_V4_0_3_idRef_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
...
static RedfishCS_status CS_To_JSON_Fans(json_t *CsJson, char *Key, RedfishThermal_V1_5_0_Fan_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishThermal_V1_5_0_Fan_Array_CS *NextArray;
  RedfishThermal_V1_5_0_Fan_CS *NextArrayItem;
  ...
  do {
    ...
    NextArrayItem = NextArray->ArrayValue;
    // Actions
    if (CS_To_JSON_FansActions(ArrayMember, "Actions", NextArrayItem->Actions) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_TemperaturesActionsOem(json_t *CsJson, char *Key, RedfishThermal_V1_5_0_TemperatureOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_TemperaturesActions(json_t *CsJson, char *Key, RedfishThermal_V1_5_0_TemperatureActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Oem
  if (CS_To_JSON_TemperaturesActionsOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_TemperaturesRelatedItem(json_t *CsJson, char *Key, Redfishodata_V4_0_3_idRef_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  Redfishodata_V4_0_3_idRef_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_Temperatures(json_t *CsJson, char *Key, RedfishThermal_V1_5_0_Temperature_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishThermal_V1_5_0_Temperature_Array_CS *NextArray;
  RedfishThermal_V1_5_0_Temperature_CS *NextArrayItem;
  ...
  do {
    ...
    NextArrayItem = NextArray->ArrayValue;
    // Actions
    if (CS_To_JSON_TemperaturesActions(ArrayMember, "Actions", NextArrayItem->Actions) != RedfishCS_status_success) {goto Error;}

    // AdjustedMaxAllowableOperatingValue 
    if (InsertJsonInt64Obj (ArrayMember, "AdjustedMaxAllowableOperatingValue", NextArrayItem->AdjustedMaxAllowableOperatingValue) != RedfishCS_status_success) {goto Error;}

    // AdjustedMinAllowableOperatingValue 
    if (InsertJsonInt64Obj (ArrayMember, "AdjustedMinAllowableOperatingValue", NextArrayItem->AdjustedMinAllowableOperatingValue) != RedfishCS_status_success) {goto Error;}

    // DeltaPhysicalContext 
    if (InsertJsonStringObj (ArrayMember, "DeltaPhysicalContext", NextArrayItem->DeltaPhysicalContext) != RedfishCS_status_success) {goto Error;}

    // DeltaReadingCelsius 
    if (InsertJsonInt64Obj (ArrayMember, "DeltaReadingCelsius", NextArrayItem->DeltaReadingCelsius) != RedfishCS_status_success) {goto Error;}
    ...
    // MaxAllowableOperatingValue 
    if (InsertJsonInt64Obj (ArrayMember, "MaxAllowableOperatingValue", NextArrayItem->MaxAllowableOperatingValue) != RedfishCS_status_success) {goto Error;}
    ...
    // MinAllowableOperatingValue 
    if (InsertJsonInt64Obj (ArrayMember, "MinAllowableOperatingValue", NextArrayItem->MinAllowableOperatingValue) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Thermal.V1_5_0.Thermal
//
RedfishCS_status CS_To_Thermal_V1_5_0_JSON(RedfishThermal_V1_5_0_Thermal_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Thermal.V1_5_0.Thermal
//
RedfishCS_status DestroyThermal_V1_5_0_CS(RedfishThermal_V1_5_0_Thermal_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Thermal.V1_5_0.Thermal
//
RedfishCS_status DestroyThermal_V1_5_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Thermal.V1_5_0.Thermal
//
RedfishCS_status
Json_Thermal_V1_5_0_To_CS(RedfishCS_char *JsonRawText, RedfishThermal_V1_5_0_Thermal_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishThermal_V1_5_0_Thermal_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Thermal", "v1_5_0", "Thermal", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishThermal_V1_5_0_Thermal_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Actions
  Status = GenThermalActionsCs (Cs, JsonObj, "Actions", &Cs->Actions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
