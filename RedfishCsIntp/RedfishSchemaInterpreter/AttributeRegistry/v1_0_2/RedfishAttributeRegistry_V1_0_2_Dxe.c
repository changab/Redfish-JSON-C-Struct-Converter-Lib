...
//
#include <RedfishInterpreter/AttributeRegistry/v1_0_2/EfiAttributeRegistryV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_0_2 
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_2 *AttributeRegistryV1_0_2;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_2_CS *AttributeRegistryV1_0_2Cs;
  ...
  Status = Json_AttributeRegistry_V1_0_2_To_CS (ResoruceRaw, &AttributeRegistryV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_0_2 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_2));
  if (AttributeRegistryV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AttributeRegistryV1_0_2;
  AttributeRegistryV1_0_2->AttributeRegistry = AttributeRegistryV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AttributeRegistry_V1_0_2_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AttributeRegistryV1_0_2 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_2 *)InterpProp;
  DestroyAttributeRegistry_V1_0_2_CS (AttributeRegistryV1_0_2->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAttributeRegistry_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
