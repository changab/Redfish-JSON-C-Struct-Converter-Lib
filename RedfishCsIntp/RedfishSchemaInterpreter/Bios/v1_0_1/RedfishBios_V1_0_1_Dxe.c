...
//
#include <RedfishInterpreter/Bios/v1_0_1/EfiBiosV1_0_1.h>
...
{
  EFI_REDFISH_BIOS_V1_0_1 *BiosV1_0_1;
  EFI_REDFISH_BIOS_V1_0_1_CS *BiosV1_0_1Cs;
  ...
  Status = Json_Bios_V1_0_1_To_CS (ResoruceRaw, &BiosV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_0_1 = (EFI_REDFISH_BIOS_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_0_1));
  if (BiosV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)BiosV1_0_1;
  BiosV1_0_1->Bios = BiosV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_BIOS_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Bios_V1_0_1_JSON (*((EFI_REDFISH_BIOS_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  BiosV1_0_1 = (EFI_REDFISH_BIOS_V1_0_1 *)InterpProp;
  DestroyBios_V1_0_1_CS (BiosV1_0_1->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyBios_V1_0_1_Json (ResoruceRaw);
}
