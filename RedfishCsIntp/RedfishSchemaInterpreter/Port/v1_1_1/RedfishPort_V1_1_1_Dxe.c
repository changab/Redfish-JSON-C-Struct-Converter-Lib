...
//
#include <RedfishInterpreter/Port/v1_1_1/EfiPortV1_1_1.h>
...
{
  EFI_REDFISH_PORT_V1_1_1 *PortV1_1_1;
  EFI_REDFISH_PORT_V1_1_1_CS *PortV1_1_1Cs;
  ...
  Status = Json_Port_V1_1_1_To_CS (ResoruceRaw, &PortV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_1_1 = (EFI_REDFISH_PORT_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_1_1));
  if (PortV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PortV1_1_1;
  PortV1_1_1->Port = PortV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_PORT_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Port_V1_1_1_JSON (*((EFI_REDFISH_PORT_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PortV1_1_1 = (EFI_REDFISH_PORT_V1_1_1 *)InterpProp;
  DestroyPort_V1_1_1_CS (PortV1_1_1->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPort_V1_1_1_Json (ResoruceRaw);
}
