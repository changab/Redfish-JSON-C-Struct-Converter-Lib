...
//
#include <RedfishInterpreter/SecureBoot/v1_0_4/EfiSecureBootV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#SecureBoot";
BOOLEAN IsRevisonController = TRUE;

// Support SecureBoot V1_0_4 
...
{
  EFI_REDFISH_SECUREBOOT_V1_0_4 *SecureBootV1_0_4;
  EFI_REDFISH_SECUREBOOT_V1_0_4_CS *SecureBootV1_0_4Cs;
  ...
  Status = Json_SecureBoot_V1_0_4_To_CS (ResoruceRaw, &SecureBootV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootV1_0_4 = (EFI_REDFISH_SECUREBOOT_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOT_V1_0_4));
  if (SecureBootV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SecureBootV1_0_4;
  SecureBootV1_0_4->SecureBoot = SecureBootV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_SECUREBOOT_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SecureBoot_V1_0_4_JSON (*((EFI_REDFISH_SECUREBOOT_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SecureBootV1_0_4 = (EFI_REDFISH_SECUREBOOT_V1_0_4 *)InterpProp;
  DestroySecureBoot_V1_0_4_CS (SecureBootV1_0_4->SecureBoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySecureBoot_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
