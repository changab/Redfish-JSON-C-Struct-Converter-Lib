...
//
#include <RedfishInterpreter/SessionService/v1_0_5/EfiSessionServiceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_0_5 
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_0_5 *SessionServiceV1_0_5;
  EFI_REDFISH_SESSIONSERVICE_V1_0_5_CS *SessionServiceV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "SessionService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_SessionService_V1_0_5_To_CS (ResoruceRaw, &SessionServiceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_0_5 = (EFI_REDFISH_SESSIONSERVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_0_5));
  if (SessionServiceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionServiceV1_0_5;
  SessionServiceV1_0_5->SessionService = SessionServiceV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_SESSIONSERVICE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SessionService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "SessionService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SessionService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "SessionService");
...
)
{
  ...
  return CS_To_SessionService_V1_0_5_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in SessionServiceToStruct.
...
EFI_STATUS
EFIAPI
SessionServiceDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  SessionServiceV1_0_5 = (EFI_REDFISH_SESSIONSERVICE_V1_0_5 *)InterpProp;
  DestroySessionService_V1_0_5_CS (SessionServiceV1_0_5->SessionService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SessionServiceFromEfiStruct
...
)
{
  ...
  return DestroySessionService_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
