...
//
#include <RedfishInterpreter/Memory/v1_1_4/EfiMemoryV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_1_4 
...
{
  EFI_REDFISH_MEMORY_V1_1_4 *MemoryV1_1_4;
  EFI_REDFISH_MEMORY_V1_1_4_CS *MemoryV1_1_4Cs;
  ...
  Status = Json_Memory_V1_1_4_To_CS (ResoruceRaw, &MemoryV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_1_4 = (EFI_REDFISH_MEMORY_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_1_4));
  if (MemoryV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryV1_1_4;
  MemoryV1_1_4->Memory = MemoryV1_1_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_MEMORY_V1_1_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Memory_V1_1_4_JSON (*((EFI_REDFISH_MEMORY_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryV1_1_4 = (EFI_REDFISH_MEMORY_V1_1_4 *)InterpProp;
  DestroyMemory_V1_1_4_CS (MemoryV1_1_4->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemory_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_1_4EntryPoint (
