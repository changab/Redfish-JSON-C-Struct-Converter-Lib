...
//
#include <RedfishInterpreter/VLanNetworkInterface/v1_1_0/EfiVLanNetworkInterfaceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_1_0 
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_0 *VLanNetworkInterfaceV1_1_0;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_0_CS *VLanNetworkInterfaceV1_1_0Cs;
  ...
  Status = Json_VLanNetworkInterface_V1_1_0_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_1_0 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_0));
  if (VLanNetworkInterfaceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VLanNetworkInterfaceV1_1_0;
  VLanNetworkInterfaceV1_1_0->VLanNetworkInterface = VLanNetworkInterfaceV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VLanNetworkInterface_V1_1_0_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VLanNetworkInterfaceV1_1_0 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_0 *)InterpProp;
  DestroyVLanNetworkInterface_V1_1_0_CS (VLanNetworkInterfaceV1_1_0->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVLanNetworkInterface_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
