# Definition of SoftwareInventoryCollection and functions<br><br>
...
## Redfish SoftwareInventoryCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish SoftwareInventoryCollection  JSON Function
    RedfishCS_status
    CS_To_SoftwareInventoryCollection_JSON (RedfishSoftwareInventoryCollection_SoftwareInventoryCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish SoftwareInventoryCollection  C Structure Function
    RedfishCS_status
