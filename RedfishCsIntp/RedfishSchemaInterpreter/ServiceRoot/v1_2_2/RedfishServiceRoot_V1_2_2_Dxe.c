...
//
#include <RedfishInterpreter/ServiceRoot/v1_2_2/EfiServiceRootV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_2_2 
...
{
  EFI_REDFISH_SERVICEROOT_V1_2_2 *ServiceRootV1_2_2;
  EFI_REDFISH_SERVICEROOT_V1_2_2_CS *ServiceRootV1_2_2Cs;
  ...
  Status = Json_ServiceRoot_V1_2_2_To_CS (ResoruceRaw, &ServiceRootV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_2_2 = (EFI_REDFISH_SERVICEROOT_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_2_2));
  if (ServiceRootV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_2_2;
  ServiceRootV1_2_2->ServiceRoot = ServiceRootV1_2_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_2_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ServiceRoot_V1_2_2_JSON (*((EFI_REDFISH_SERVICEROOT_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ServiceRootV1_2_2 = (EFI_REDFISH_SERVICEROOT_V1_2_2 *)InterpProp;
  DestroyServiceRoot_V1_2_2_CS (ServiceRootV1_2_2->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyServiceRoot_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
