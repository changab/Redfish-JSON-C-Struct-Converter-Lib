...
//
#include <RedfishInterpreter/PCIeDevice/v1_0_3/EfiPCIeDeviceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_0_3 
...
{
  EFI_REDFISH_PCIEDEVICE_V1_0_3 *PCIeDeviceV1_0_3;
  EFI_REDFISH_PCIEDEVICE_V1_0_3_CS *PCIeDeviceV1_0_3Cs;
  ...
  Status = Json_PCIeDevice_V1_0_3_To_CS (ResoruceRaw, &PCIeDeviceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_0_3 = (EFI_REDFISH_PCIEDEVICE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_0_3));
  if (PCIeDeviceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeDeviceV1_0_3;
  PCIeDeviceV1_0_3->PCIeDevice = PCIeDeviceV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_PCIEDEVICE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeDevice_V1_0_3_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeDeviceV1_0_3 = (EFI_REDFISH_PCIEDEVICE_V1_0_3 *)InterpProp;
  DestroyPCIeDevice_V1_0_3_CS (PCIeDeviceV1_0_3->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeDevice_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
