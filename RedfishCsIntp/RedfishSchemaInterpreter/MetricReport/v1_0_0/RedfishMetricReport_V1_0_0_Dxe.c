...
//
#include <RedfishInterpreter/MetricReport/v1_0_0/EfiMetricReportV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#MetricReport";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReport V1_0_0 
...
{
  EFI_REDFISH_METRICREPORT_V1_0_0 *MetricReportV1_0_0;
  EFI_REDFISH_METRICREPORT_V1_0_0_CS *MetricReportV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "MetricReport") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_MetricReport_V1_0_0_To_CS (ResoruceRaw, &MetricReportV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportV1_0_0 = (EFI_REDFISH_METRICREPORT_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORT_V1_0_0));
  if (MetricReportV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MetricReportV1_0_0;
  MetricReportV1_0_0->MetricReport = MetricReportV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_METRICREPORT_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricReport"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "MetricReport");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricReport"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "MetricReport");
...
)
{
  ...
  return CS_To_MetricReport_V1_0_0_JSON (*((EFI_REDFISH_METRICREPORT_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in MetricReportToStruct.
...
)
{
  ...
  MetricReportV1_0_0 = (EFI_REDFISH_METRICREPORT_V1_0_0 *)InterpProp;
  DestroyMetricReport_V1_0_0_CS (MetricReportV1_0_0->MetricReport); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MetricReportFromEfiStruct
...
)
{
  ...
  return DestroyMetricReport_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
