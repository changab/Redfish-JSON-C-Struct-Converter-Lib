...
#include"Redfish_NetworkInterfaceCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishNetworkInterfaceCollection_NetworkInterfaceCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for NetworkInterfaceCollection.NetworkInterfaceCollection
//
RedfishCS_status CS_To_NetworkInterfaceCollection_JSON(RedfishNetworkInterfaceCollection_NetworkInterfaceCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for NetworkInterfaceCollection.NetworkInterfaceCollection
//
RedfishCS_status DestroyNetworkInterfaceCollection_CS(RedfishNetworkInterfaceCollection_NetworkInterfaceCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkInterfaceCollection.NetworkInterfaceCollection
//
RedfishCS_status DestroyNetworkInterfaceCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkInterfaceCollection.NOVERSIONED.NetworkInterfaceCollection
//
RedfishCS_status
Json_NetworkInterfaceCollection_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkInterfaceCollection_NetworkInterfaceCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkInterfaceCollection_NetworkInterfaceCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkInterfaceCollection", "noversioned", "NetworkInterfaceCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkInterfaceCollection_NetworkInterfaceCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkInterfaceCollection_CS (Cs);
  return Status;
}
