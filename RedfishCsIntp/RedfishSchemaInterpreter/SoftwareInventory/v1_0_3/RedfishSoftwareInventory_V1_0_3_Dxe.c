...
//
#include <RedfishInterpreter/SoftwareInventory/v1_0_3/EfiSoftwareInventoryV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_0_3 
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_0_3 *SoftwareInventoryV1_0_3;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_0_3_CS *SoftwareInventoryV1_0_3Cs;
  ...
  Status = Json_SoftwareInventory_V1_0_3_To_CS (ResoruceRaw, &SoftwareInventoryV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_0_3 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_3));
  if (SoftwareInventoryV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SoftwareInventoryV1_0_3;
  SoftwareInventoryV1_0_3->SoftwareInventory = SoftwareInventoryV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SoftwareInventory_V1_0_3_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SoftwareInventoryV1_0_3 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_3 *)InterpProp;
  DestroySoftwareInventory_V1_0_3_CS (SoftwareInventoryV1_0_3->SoftwareInventory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySoftwareInventory_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
