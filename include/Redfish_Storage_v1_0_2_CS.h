...
#ifndef _RedfishStorage_V1_0_2_CSTRUCT_H_
#define _RedfishStorage_V1_0_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishStorage_V1_0_2_StorageController_Array_CS RedfishStorage_V1_0_2_StorageController_Array_CS;
...
typedef struct _RedfishStorage_V1_0_2_SetEncryptionKey_CS RedfishStorage_V1_0_2_SetEncryptionKey_CS;
typedef struct _RedfishStorage_V1_0_2_Storage_CS RedfishStorage_V1_0_2_Storage_CS;
typedef struct _RedfishStorage_V1_0_2_StorageController_CS RedfishStorage_V1_0_2_StorageController_CS;
typedef struct _RedfishStorage_V1_0_2_Storage_Actions_CS RedfishStorage_V1_0_2_Storage_Actions_CS;
typedef struct _RedfishStorage_V1_0_2_Storage_Actions_Oem_CS RedfishStorage_V1_0_2_Storage_Actions_Oem_CS;
typedef struct _RedfishStorage_V1_0_2_Storage_Links_CS RedfishStorage_V1_0_2_Storage_Links_CS;
//
...
//
typedef struct _RedfishStorage_V1_0_2_SetEncryptionKey_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishStorage_V1_0_2_SetEncryptionKey_CS;
...
// produces Volumes.
//
typedef struct _RedfishStorage_V1_0_2_StorageController_CS {
    ...
    RedfishCS_char_Array                          *SupportedDeviceProtocols;       // This represents the protocols
                                                                                   ...
                                                                                   // attached devices.
} RedfishStorage_V1_0_2_StorageController_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishStorage_V1_0_2_Storage_Actions_CS {
    RedfishStorage_V1_0_2_SetEncryptionKey_CS       *Storage_SetEncryptionKey;
    RedfishStorage_V1_0_2_Storage_Actions_Oem_CS    *Oem;                    
} RedfishStorage_V1_0_2_Storage_Actions_CS;

typedef struct _RedfishStorage_V1_0_2_Storage_Actions_Oem_CS {
    RedfishCS_Link    Prop;
} RedfishStorage_V1_0_2_Storage_Actions_Oem_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishStorage_V1_0_2_Storage_Links_CS {
...
} RedfishStorage_V1_0_2_Storage_Links_CS;
...
//
typedef struct _RedfishStorage_V1_0_2_Storage_CS {
    RedfishCS_Header                                    Header;
    RedfishCS_char                                      *odata_context;                        
    RedfishCS_char                                      *odata_id;                             
    RedfishCS_char                                      *odata_type;                           
    RedfishStorage_V1_0_2_Storage_Actions_CS            *Actions;                                  // The available actions for this
                                                                                                   // resource.
    ...
    RedfishCS_char                                      *Id;                                   
    RedfishStorage_V1_0_2_Storage_Links_CS              *Links;                                    // Contains references to other
    ...
    RedfishResource_Status_CS                           *Status;                               
    RedfishStorage_V1_0_2_StorageController_Array_CS    *StorageControllers;                       // The set of storage controllers
                                                                                                   // represented by this resource.
    ...
    RedfishCS_Link                                      Volumes;                                   // The set of volumes produced by
                                                                                                   // the storage controllers
                                                                                                   // represented by this resource.
} RedfishStorage_V1_0_2_Storage_CS;
...
typedef struct _RedfishStorage_V1_0_2_StorageController_Array_CS  {
    RedfishStorage_V1_0_2_StorageController_Array_CS    *Next;
    RedfishStorage_V1_0_2_StorageController_CS    *ArrayValue;
} RedfishStorage_V1_0_2_StorageController_Array_CS;

RedfishCS_status
Json_Storage_V1_0_2_To_CS (char *JsonRawText, RedfishStorage_V1_0_2_Storage_CS **ReturnedCS);

RedfishCS_status
CS_To_Storage_V1_0_2_JSON (RedfishStorage_V1_0_2_Storage_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyStorage_V1_0_2_CS (RedfishStorage_V1_0_2_Storage_CS *CSPtr);

RedfishCS_status
DestroyStorage_V1_0_2_Json (RedfishCS_char *JsonText);
