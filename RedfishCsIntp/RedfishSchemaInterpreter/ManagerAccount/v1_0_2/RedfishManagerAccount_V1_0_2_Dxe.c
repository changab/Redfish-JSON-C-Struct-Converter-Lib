...
//
#include <RedfishInterpreter/ManagerAccount/v1_0_2/EfiManagerAccountV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_2 
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_2 *ManagerAccountV1_0_2;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_2_CS *ManagerAccountV1_0_2Cs;
  ...
  Status = Json_ManagerAccount_V1_0_2_To_CS (ResoruceRaw, &ManagerAccountV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_2 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_2));
  if (ManagerAccountV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerAccountV1_0_2;
  ManagerAccountV1_0_2->ManagerAccount = ManagerAccountV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerAccount_V1_0_2_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerAccountV1_0_2 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_2 *)InterpProp;
  DestroyManagerAccount_V1_0_2_CS (ManagerAccountV1_0_2->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerAccount_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
