...
#ifndef _RedfishMemorychunks_V1_2_2_CSTRUCT_H_
#define _RedfishMemorychunks_V1_2_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemoryChunks_V1_2_2_InterleaveSet_Array_CS RedfishMemoryChunks_V1_2_2_InterleaveSet_Array_CS;
typedef struct _RedfishMemoryChunks_V1_2_2_Actions_CS RedfishMemoryChunks_V1_2_2_Actions_CS;
typedef struct _RedfishMemoryChunks_V1_2_2_InterleaveSet_CS RedfishMemoryChunks_V1_2_2_InterleaveSet_CS;
typedef struct _RedfishMemoryChunks_V1_2_2_MemoryChunks_CS RedfishMemoryChunks_V1_2_2_MemoryChunks_CS;
typedef struct _RedfishMemoryChunks_V1_2_2_OemActions_CS RedfishMemoryChunks_V1_2_2_OemActions_CS;
...
typedef struct _RedfishMemoryChunks_V1_2_2_Actions_CS {
    RedfishMemoryChunks_V1_2_2_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishMemoryChunks_V1_2_2_MemoryChunks_CS {
    ...
    RedfishMemoryChunks_V1_2_2_Actions_CS                *Actions;              // The available actions for this
                                                                                // resource.
    RedfishCS_char                                       *AddressRangeType;     // Memory type of this memory
                                                                                // chunk.
    RedfishCS_char                                       *Description;      
    RedfishCS_char                                       *Id;               
    RedfishMemoryChunks_V1_2_2_InterleaveSet_Array_CS    *InterleaveSets;       // This is the interleave sets
...
typedef struct _RedfishMemoryChunks_V1_2_2_InterleaveSet_Array_CS  {
    RedfishMemoryChunks_V1_2_2_InterleaveSet_Array_CS    *Next;
    RedfishMemoryChunks_V1_2_2_InterleaveSet_CS    *ArrayValue;
} RedfishMemoryChunks_V1_2_2_InterleaveSet_Array_CS;

RedfishCS_status
Json_MemoryChunks_V1_2_2_To_CS (char *JsonRawText, RedfishMemoryChunks_V1_2_2_MemoryChunks_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryChunks_V1_2_2_JSON (RedfishMemoryChunks_V1_2_2_MemoryChunks_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryChunks_V1_2_2_CS (RedfishMemoryChunks_V1_2_2_MemoryChunks_CS *CSPtr);

RedfishCS_status
DestroyMemoryChunks_V1_2_2_Json (RedfishCS_char *JsonText);
