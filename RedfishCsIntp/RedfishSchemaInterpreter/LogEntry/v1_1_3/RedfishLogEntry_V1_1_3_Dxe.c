...
//
#include <RedfishInterpreter/LogEntry/v1_1_3/EfiLogEntryV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_1_3 
...
{
  EFI_REDFISH_LOGENTRY_V1_1_3 *LogEntryV1_1_3;
  EFI_REDFISH_LOGENTRY_V1_1_3_CS *LogEntryV1_1_3Cs;
  ...
  Status = Json_LogEntry_V1_1_3_To_CS (ResoruceRaw, &LogEntryV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_1_3 = (EFI_REDFISH_LOGENTRY_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_1_3));
  if (LogEntryV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_1_3;
  LogEntryV1_1_3->LogEntry = LogEntryV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_1_3_JSON (*((EFI_REDFISH_LOGENTRY_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_1_3 = (EFI_REDFISH_LOGENTRY_V1_1_3 *)InterpProp;
  DestroyLogEntry_V1_1_3_CS (LogEntryV1_1_3->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_1_3EntryPoint (
