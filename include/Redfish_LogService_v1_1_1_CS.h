...
#ifndef _RedfishLogservice_V1_1_1_CSTRUCT_H_
#define _RedfishLogservice_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogService_V1_1_1_Actions_CS RedfishLogService_V1_1_1_Actions_CS;
typedef struct _RedfishLogService_V1_1_1_ClearLog_CS RedfishLogService_V1_1_1_ClearLog_CS;
typedef struct _RedfishLogService_V1_1_1_LogService_CS RedfishLogService_V1_1_1_LogService_CS;
typedef struct _RedfishLogService_V1_1_1_OemActions_CS RedfishLogService_V1_1_1_OemActions_CS;
...
typedef struct _RedfishLogService_V1_1_1_Actions_CS {
    ...
    RedfishLogService_V1_1_1_OemActions_CS    *Oem;                   // This property contains the
...
typedef struct _RedfishLogService_V1_1_1_LogService_CS {
    ...
    RedfishLogService_V1_1_1_Actions_CS    *Actions;               // The available actions for this
                                                                   // resource.
...
RedfishCS_status
Json_LogService_V1_1_1_To_CS (char *JsonRawText, RedfishLogService_V1_1_1_LogService_CS **ReturnedCS);

RedfishCS_status
CS_To_LogService_V1_1_1_JSON (RedfishLogService_V1_1_1_LogService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogService_V1_1_1_CS (RedfishLogService_V1_1_1_LogService_CS *CSPtr);

RedfishCS_status
DestroyLogService_V1_1_1_Json (RedfishCS_char *JsonText);
