# Definition of JobCollection and functions<br><br>
...
## Redfish JobCollection  to C Structure Function
    RedfishCS_status
    Json_JobCollection_To_CS (RedfishCS_char *JsonRawText, RedfishJobCollection_JobCollection_CS **ReturnedCS);

## C Structure to Redfish JobCollection  JSON Function
    RedfishCS_status
    CS_To_JobCollection_JSON (RedfishJobCollection_JobCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish JobCollection  C Structure Function
    RedfishCS_status
