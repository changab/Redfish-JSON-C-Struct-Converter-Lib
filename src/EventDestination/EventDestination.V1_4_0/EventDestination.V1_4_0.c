...
#include"Redfish_EventDestination_v1_4_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEventDestination_V1_4_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishEventDestination_V1_4_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_4_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventDestination_V1_4_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEventDestination_V1_4_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_4_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventDestination_V1_4_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenHttpHeaderProperty_Array_ElementCs(RedfishEventDestination_V1_4_0_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEventDestination_V1_4_0_HttpHeaderProperty_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEventDestination_V1_4_0_HttpHeaderProperty_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);

  Status = CreateCsJsonByNode (Cs, TempJsonObj, NULL, Cs->Header.ThisUri, &CsTypeJson);
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  InsertTailLink(&(*Dst)->Prop, &CsTypeJson->Header.LinkEntry);
...
//
//Generate C structure for RedfishEventDestination_V1_4_0_HttpHeaderProperty_Array_CS
//
static RedfishCS_status GenHttpHeaderProperty_ArrayCs(RedfishEventDestination_V1_4_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_4_0_HttpHeaderProperty_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEventDestination_V1_4_0_HttpHeaderProperty_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEventDestination_V1_4_0_HttpHeaderProperty_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenHttpHeaderProperty_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishEventDestination_V1_4_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishEventDestination_V1_4_0_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodata_V4_0_3_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRef_ArrayCs(RedfishEventDestination_V1_4_0_EventDestination_CS *Cs, json_t *JsonObj, char *Key, Redfishodata_V4_0_3_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEventDestination_V1_4_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEventDestination_V1_4_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HttpHeaders(json_t *CsJson, char *Key, RedfishEventDestination_V1_4_0_HttpHeaderProperty_Array_CS *CSPtr)
{
  // No JSON property for this structure.
  return RedfishCS_status_success;
}
...
static RedfishCS_status CS_To_JSON_OriginResources(json_t *CsJson, char *Key, Redfishodata_V4_0_3_idRef_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
...
//
// C structure to JSON for EventDestination.V1_4_0.EventDestination
//
RedfishCS_status CS_To_EventDestination_V1_4_0_JSON(RedfishEventDestination_V1_4_0_EventDestination_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Context 
  if (InsertJsonStringObj (CsJson, "Context", CSPtr->Context) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // Destination 
  if (InsertJsonStringObj (CsJson, "Destination", CSPtr->Destination) != RedfishCS_status_success) {goto Error;}

  // EventFormatType 
  if (InsertJsonStringObj (CsJson, "EventFormatType", CSPtr->EventFormatType) != RedfishCS_status_success) {goto Error;}

  // EventTypes 
  if (InsertJsonStringArrayObj (CsJson, "EventTypes", CSPtr->EventTypes) != RedfishCS_status_success) {goto Error;}

  // HttpHeaders
  if (CS_To_JSON_HttpHeaders(CsJson, "HttpHeaders", CSPtr->HttpHeaders) != RedfishCS_status_success) {goto Error;}

  // Id 
  if (InsertJsonStringObj (CsJson, "Id", CSPtr->Id) != RedfishCS_status_success) {goto Error;}

  // MessageIds 
  if (InsertJsonStringArrayObj (CsJson, "MessageIds", CSPtr->MessageIds) != RedfishCS_status_success) {goto Error;}
  ...
  // OriginResources
  if (CS_To_JSON_OriginResources(CsJson, "OriginResources", CSPtr->OriginResources) != RedfishCS_status_success) {goto Error;}

  // OriginResources@odata.count 
  if (InsertJsonInt64Obj (CsJson, "OriginResources@odata.count", CSPtr->OriginResourcesodata_count) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonBoolObj (CsJson, "SubordinateResources", CSPtr->SubordinateResources) != RedfishCS_status_success) {goto Error;}

  // SubscriptionType 
  if (InsertJsonStringObj (CsJson, "SubscriptionType", CSPtr->SubscriptionType) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for EventDestination.V1_4_0.EventDestination
//
RedfishCS_status DestroyEventDestination_V1_4_0_CS(RedfishEventDestination_V1_4_0_EventDestination_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EventDestination.V1_4_0.EventDestination
//
RedfishCS_status DestroyEventDestination_V1_4_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EventDestination.V1_4_0.EventDestination
//
RedfishCS_status
Json_EventDestination_V1_4_0_To_CS(RedfishCS_char *JsonRawText, RedfishEventDestination_V1_4_0_EventDestination_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEventDestination_V1_4_0_EventDestination_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EventDestination", "v1_4_0", "EventDestination", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEventDestination_V1_4_0_EventDestination_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Context
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Context", &Cs->Context);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){goto Error;}}
  ...
  // Destination
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Destination", &Cs->Destination);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EventFormatType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "EventFormatType", &Cs->EventFormatType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EventTypes
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "EventTypes", &Cs->EventTypes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // HttpHeaders
  Status = GenHttpHeaderProperty_ArrayCs (Cs, JsonObj, "HttpHeaders", &Cs->HttpHeaders);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MessageIds
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "MessageIds", &Cs->MessageIds);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // OriginResources
  Status = GenidRef_ArrayCs (Cs, JsonObj, "OriginResources", &Cs->OriginResources);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OriginResources@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "OriginResources@odata.count", &Cs->OriginResourcesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SubordinateResources
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "SubordinateResources", &Cs->SubordinateResources);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SubscriptionType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "SubscriptionType", &Cs->SubscriptionType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){goto Error;}}
...
Error:;
  json_decref(JsonObj);
  DestroyEventDestination_V1_4_0_CS (Cs);
  return Status;
}
