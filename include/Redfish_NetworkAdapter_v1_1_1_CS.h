...
#ifndef _RedfishNetworkadapter_V1_1_1_CSTRUCT_H_
#define _RedfishNetworkadapter_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishNetworkAdapter_V1_1_1_Controllers_Array_CS RedfishNetworkAdapter_V1_1_1_Controllers_Array_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_Actions_CS RedfishNetworkAdapter_V1_1_1_Actions_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_ControllerCapabilities_CS RedfishNetworkAdapter_V1_1_1_ControllerCapabilities_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_ControllerLinks_CS RedfishNetworkAdapter_V1_1_1_ControllerLinks_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_Controllers_CS RedfishNetworkAdapter_V1_1_1_Controllers_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_DataCenterBridging_CS RedfishNetworkAdapter_V1_1_1_DataCenterBridging_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_NPIV_CS RedfishNetworkAdapter_V1_1_1_NPIV_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_NetworkAdapter_CS RedfishNetworkAdapter_V1_1_1_NetworkAdapter_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_OemActions_CS RedfishNetworkAdapter_V1_1_1_OemActions_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_ResetSettingsToDefault_CS RedfishNetworkAdapter_V1_1_1_ResetSettingsToDefault_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_SRIOV_CS RedfishNetworkAdapter_V1_1_1_SRIOV_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_VirtualFunction_CS RedfishNetworkAdapter_V1_1_1_VirtualFunction_CS;
typedef struct _RedfishNetworkAdapter_V1_1_1_VirtualizationOffload_CS RedfishNetworkAdapter_V1_1_1_VirtualizationOffload_CS;
...
//
typedef struct _RedfishNetworkAdapter_V1_1_1_Actions_CS {
    RedfishNetworkAdapter_V1_1_1_ResetSettingsToDefault_CS    *NetworkAdapter_ResetSettingsToDefault;
    RedfishNetworkAdapter_V1_1_1_OemActions_CS                *Oem;                                     // This property contains the
                                                                                                        // available OEM specific actions
                                                                                                        // for this resource.
} RedfishNetworkAdapter_V1_1_1_Actions_CS;

//
// The capabilities of a controller.
//
typedef struct _RedfishNetworkAdapter_V1_1_1_ControllerCapabilities_CS {
    RedfishNetworkAdapter_V1_1_1_DataCenterBridging_CS       *DataCenterBridging;           // Data Center Bridging (DCB) for
                                                                                            // this controller.
    RedfishNetworkAdapter_V1_1_1_NPIV_CS                     *NPIV;                         // N_Port ID Virtualization
    ...
    RedfishCS_int64                                          *NetworkPortCount;             // The number of physical ports
                                                                                            // on this controller.
    RedfishNetworkAdapter_V1_1_1_VirtualizationOffload_CS    *VirtualizationOffload;        // Virtualization offload for
                                                                                            // this controller.
} RedfishNetworkAdapter_V1_1_1_ControllerCapabilities_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishNetworkAdapter_V1_1_1_ControllerLinks_CS {
...
} RedfishNetworkAdapter_V1_1_1_ControllerLinks_CS;
...
typedef struct _RedfishNetworkAdapter_V1_1_1_Controllers_CS {
    RedfishNetworkAdapter_V1_1_1_ControllerCapabilities_CS    *ControllerCapabilities;    // The capabilities of this
                                                                                         // controller.
    RedfishCS_char                                            *FirmwarePackageVersion;    // The version of the user-facing
                                                                                         // firmware package.
    RedfishNetworkAdapter_V1_1_1_ControllerLinks_CS           *Links;                    // Links.
...
typedef struct _RedfishNetworkAdapter_V1_1_1_VirtualizationOffload_CS {
    RedfishNetworkAdapter_V1_1_1_SRIOV_CS              *SRIOV;             // Single-Root Input/Output
                                                                           // Virtualization (SR-IOV)
                                                                           // capabilities.
    RedfishNetworkAdapter_V1_1_1_VirtualFunction_CS    *VirtualFunction;    // The virtual function of the
                                                                           // controller.
...
typedef struct _RedfishNetworkAdapter_V1_1_1_NetworkAdapter_CS {
    ...
    RedfishNetworkAdapter_V1_1_1_Actions_CS              *Actions;                 // The available actions for this
                                                                                   // resource.
    RedfishCS_Link                                       Assembly;                 // A reference to the Assembly
                                                                                   // resource associated with this
                                                                                   // adapter.
    RedfishNetworkAdapter_V1_1_1_Controllers_Array_CS    *Controllers;             // The set of network controllers
...
typedef struct _RedfishNetworkAdapter_V1_1_1_Controllers_Array_CS  {
    RedfishNetworkAdapter_V1_1_1_Controllers_Array_CS    *Next;
    RedfishNetworkAdapter_V1_1_1_Controllers_CS    *ArrayValue;
} RedfishNetworkAdapter_V1_1_1_Controllers_Array_CS;

RedfishCS_status
Json_NetworkAdapter_V1_1_1_To_CS (char *JsonRawText, RedfishNetworkAdapter_V1_1_1_NetworkAdapter_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkAdapter_V1_1_1_JSON (RedfishNetworkAdapter_V1_1_1_NetworkAdapter_CS *CSPtr, char **JsonText);
