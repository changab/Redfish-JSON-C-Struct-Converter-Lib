...
//
#include <RedfishInterpreter/Manager/v1_3_5/EfiManagerV1_3_5.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_3_5 
...
{
  EFI_REDFISH_MANAGER_V1_3_5 *ManagerV1_3_5;
  EFI_REDFISH_MANAGER_V1_3_5_CS *ManagerV1_3_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Manager") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Manager_V1_3_5_To_CS (ResoruceRaw, &ManagerV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_3_5 = (EFI_REDFISH_MANAGER_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_3_5));
  if (ManagerV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_3_5;
  ManagerV1_3_5->Manager = ManagerV1_3_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_3_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Manager"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Manager");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Manager"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Manager");
...
)
{
  ...
  return CS_To_Manager_V1_3_5_JSON (*((EFI_REDFISH_MANAGER_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ManagerToStruct.
...
)
{
  ...
  ManagerV1_3_5 = (EFI_REDFISH_MANAGER_V1_3_5 *)InterpProp;
  DestroyManager_V1_3_5_CS (ManagerV1_3_5->Manager); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ManagerFromEfiStruct
...
)
{
  ...
  return DestroyManager_V1_3_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_3_5EntryPoint (
