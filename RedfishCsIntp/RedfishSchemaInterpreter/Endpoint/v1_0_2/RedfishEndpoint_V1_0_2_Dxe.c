...
//
#include <RedfishInterpreter/Endpoint/v1_0_2/EfiEndpointV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_0_2 
...
{
  EFI_REDFISH_ENDPOINT_V1_0_2 *EndpointV1_0_2;
  EFI_REDFISH_ENDPOINT_V1_0_2_CS *EndpointV1_0_2Cs;
  ...
  Status = Json_Endpoint_V1_0_2_To_CS (ResoruceRaw, &EndpointV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_0_2 = (EFI_REDFISH_ENDPOINT_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_0_2));
  if (EndpointV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EndpointV1_0_2;
  EndpointV1_0_2->Endpoint = EndpointV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_ENDPOINT_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Endpoint_V1_0_2_JSON (*((EFI_REDFISH_ENDPOINT_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EndpointV1_0_2 = (EFI_REDFISH_ENDPOINT_V1_0_2 *)InterpProp;
  DestroyEndpoint_V1_0_2_CS (EndpointV1_0_2->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEndpoint_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_0_2EntryPoint (
