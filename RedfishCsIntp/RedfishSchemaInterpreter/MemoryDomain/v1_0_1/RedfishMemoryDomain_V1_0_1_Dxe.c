...
//
#include <RedfishInterpreter/MemoryDomain/v1_0_1/EfiMemoryDomainV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_0_1 
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_0_1 *MemoryDomainV1_0_1;
  EFI_REDFISH_MEMORYDOMAIN_V1_0_1_CS *MemoryDomainV1_0_1Cs;
  ...
  Status = Json_MemoryDomain_V1_0_1_To_CS (ResoruceRaw, &MemoryDomainV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_0_1 = (EFI_REDFISH_MEMORYDOMAIN_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_0_1));
  if (MemoryDomainV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryDomainV1_0_1;
  MemoryDomainV1_0_1->MemoryDomain = MemoryDomainV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryDomain_V1_0_1_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryDomainV1_0_1 = (EFI_REDFISH_MEMORYDOMAIN_V1_0_1 *)InterpProp;
  DestroyMemoryDomain_V1_0_1_CS (MemoryDomainV1_0_1->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryDomain_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
