...
//
#include <RedfishInterpreter/Thermal/v1_2_5/EfiThermalV1_2_5.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_2_5 
...
{
  EFI_REDFISH_THERMAL_V1_2_5 *ThermalV1_2_5;
  EFI_REDFISH_THERMAL_V1_2_5_CS *ThermalV1_2_5Cs;
  ...
  Status = Json_Thermal_V1_2_5_To_CS (ResoruceRaw, &ThermalV1_2_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_2_5 = (EFI_REDFISH_THERMAL_V1_2_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_2_5));
  if (ThermalV1_2_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_2_5;
  ThermalV1_2_5->Thermal = ThermalV1_2_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_2_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Thermal"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Thermal");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Thermal"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Thermal");
...
)
{
  ...
  return CS_To_Thermal_V1_2_5_JSON (*((EFI_REDFISH_THERMAL_V1_2_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_2_5 = (EFI_REDFISH_THERMAL_V1_2_5 *)InterpProp;
  DestroyThermal_V1_2_5_CS (ThermalV1_2_5->Thermal); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ThermalFromEfiStruct
...
)
{
  ...
  return DestroyThermal_V1_2_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_2_5EntryPoint (
