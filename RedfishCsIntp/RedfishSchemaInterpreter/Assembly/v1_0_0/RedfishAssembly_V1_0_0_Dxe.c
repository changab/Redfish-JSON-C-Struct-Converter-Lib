...
//
#include <RedfishInterpreter/Assembly/v1_0_0/EfiAssemblyV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Assembly";
BOOLEAN IsRevisonController = TRUE;

// Support Assembly V1_0_0 
...
{
  EFI_REDFISH_ASSEMBLY_V1_0_0 *AssemblyV1_0_0;
  EFI_REDFISH_ASSEMBLY_V1_0_0_CS *AssemblyV1_0_0Cs;
  ...
  Status = Json_Assembly_V1_0_0_To_CS (ResoruceRaw, &AssemblyV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AssemblyV1_0_0 = (EFI_REDFISH_ASSEMBLY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ASSEMBLY_V1_0_0));
  if (AssemblyV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AssemblyV1_0_0;
  AssemblyV1_0_0->Assembly = AssemblyV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ASSEMBLY_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Assembly_V1_0_0_JSON (*((EFI_REDFISH_ASSEMBLY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AssemblyV1_0_0 = (EFI_REDFISH_ASSEMBLY_V1_0_0 *)InterpProp;
  DestroyAssembly_V1_0_0_CS (AssemblyV1_0_0->Assembly); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAssembly_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAssembly_V1_0_0EntryPoint (
