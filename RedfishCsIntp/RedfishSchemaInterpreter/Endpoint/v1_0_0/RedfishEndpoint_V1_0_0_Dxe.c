...
//
#include <RedfishInterpreter/Endpoint/v1_0_0/EfiEndpointV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_0_0 
...
{
  EFI_REDFISH_ENDPOINT_V1_0_0 *EndpointV1_0_0;
  EFI_REDFISH_ENDPOINT_V1_0_0_CS *EndpointV1_0_0Cs;
  ...
  Status = Json_Endpoint_V1_0_0_To_CS (ResoruceRaw, &EndpointV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_0_0 = (EFI_REDFISH_ENDPOINT_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_0_0));
  if (EndpointV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EndpointV1_0_0;
  EndpointV1_0_0->Endpoint = EndpointV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ENDPOINT_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Endpoint_V1_0_0_JSON (*((EFI_REDFISH_ENDPOINT_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EndpointV1_0_0 = (EFI_REDFISH_ENDPOINT_V1_0_0 *)InterpProp;
  DestroyEndpoint_V1_0_0_CS (EndpointV1_0_0->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEndpoint_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_0_0EntryPoint (
