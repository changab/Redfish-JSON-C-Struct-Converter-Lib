...
//
#include <RedfishInterpreter/NetworkInterface/v1_0_1/EfiNetworkInterfaceV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkInterface V1_0_1 
...
{
  EFI_REDFISH_NETWORKINTERFACE_V1_0_1 *NetworkInterfaceV1_0_1;
  EFI_REDFISH_NETWORKINTERFACE_V1_0_1_CS *NetworkInterfaceV1_0_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "NetworkInterface") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_NetworkInterface_V1_0_1_To_CS (ResoruceRaw, &NetworkInterfaceV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkInterfaceV1_0_1 = (EFI_REDFISH_NETWORKINTERFACE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_0_1));
  if (NetworkInterfaceV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkInterfaceV1_0_1;
  NetworkInterfaceV1_0_1->NetworkInterface = NetworkInterfaceV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_0_1_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "NetworkInterface");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "NetworkInterface");
...
)
{
  ...
  return CS_To_NetworkInterface_V1_0_1_JSON (*((EFI_REDFISH_NETWORKINTERFACE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in NetworkInterfaceToStruct.
...
EFI_STATUS
EFIAPI
NetworkInterfaceDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  NetworkInterfaceV1_0_1 = (EFI_REDFISH_NETWORKINTERFACE_V1_0_1 *)InterpProp;
  DestroyNetworkInterface_V1_0_1_CS (NetworkInterfaceV1_0_1->NetworkInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from NetworkInterfaceFromEfiStruct
...
)
{
  ...
  return DestroyNetworkInterface_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
