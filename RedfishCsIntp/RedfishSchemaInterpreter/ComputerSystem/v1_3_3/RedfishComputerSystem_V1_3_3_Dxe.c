...
//
#include <RedfishInterpreter/ComputerSystem/v1_3_3/EfiComputerSystemV1_3_3.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_3_3 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_3_3 *ComputerSystemV1_3_3;
  EFI_REDFISH_COMPUTERSYSTEM_V1_3_3_CS *ComputerSystemV1_3_3Cs;
  ...
  Status = Json_ComputerSystem_V1_3_3_To_CS (ResoruceRaw, &ComputerSystemV1_3_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_3_3 = (EFI_REDFISH_COMPUTERSYSTEM_V1_3_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_3_3));
  if (ComputerSystemV1_3_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_3_3;
  ComputerSystemV1_3_3->ComputerSystem = ComputerSystemV1_3_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_3_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_3_3_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_3_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_3_3 = (EFI_REDFISH_COMPUTERSYSTEM_V1_3_3 *)InterpProp;
  DestroyComputerSystem_V1_3_3_CS (ComputerSystemV1_3_3->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_3_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_3_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_3_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
