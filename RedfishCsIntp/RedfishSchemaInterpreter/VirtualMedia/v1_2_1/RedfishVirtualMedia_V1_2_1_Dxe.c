...
//
#include <RedfishInterpreter/VirtualMedia/v1_2_1/EfiVirtualMediaV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_2_1 
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_2_1 *VirtualMediaV1_2_1;
  EFI_REDFISH_VIRTUALMEDIA_V1_2_1_CS *VirtualMediaV1_2_1Cs;
  ...
  Status = Json_VirtualMedia_V1_2_1_To_CS (ResoruceRaw, &VirtualMediaV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_2_1 = (EFI_REDFISH_VIRTUALMEDIA_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_2_1));
  if (VirtualMediaV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VirtualMediaV1_2_1;
  VirtualMediaV1_2_1->VirtualMedia = VirtualMediaV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VirtualMedia_V1_2_1_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VirtualMediaV1_2_1 = (EFI_REDFISH_VIRTUALMEDIA_V1_2_1 *)InterpProp;
  DestroyVirtualMedia_V1_2_1_CS (VirtualMediaV1_2_1->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVirtualMedia_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
