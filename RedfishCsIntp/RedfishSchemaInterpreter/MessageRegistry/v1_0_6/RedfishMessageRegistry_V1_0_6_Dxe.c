...
//
#include <RedfishInterpreter/MessageRegistry/v1_0_6/EfiMessageRegistryV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_0_6 
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_6 *MessageRegistryV1_0_6;
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_6_CS *MessageRegistryV1_0_6Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "MessageRegistry") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_MessageRegistry_V1_0_6_To_CS (ResoruceRaw, &MessageRegistryV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_0_6 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_6));
  if (MessageRegistryV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryV1_0_6;
  MessageRegistryV1_0_6->MessageRegistry = MessageRegistryV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_6_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MessageRegistry"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "MessageRegistry");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MessageRegistry"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "MessageRegistry");
...
)
{
  ...
  return CS_To_MessageRegistry_V1_0_6_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in MessageRegistryToStruct.
...
EFI_STATUS
EFIAPI
MessageRegistryDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  MessageRegistryV1_0_6 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_6 *)InterpProp;
  DestroyMessageRegistry_V1_0_6_CS (MessageRegistryV1_0_6->MessageRegistry); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MessageRegistryFromEfiStruct
...
)
{
  ...
  return DestroyMessageRegistry_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
