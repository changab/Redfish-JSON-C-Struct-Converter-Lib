...
//
#include <RedfishInterpreter/Processor/v1_1_2/EfiProcessorV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_1_2 
...
{
  EFI_REDFISH_PROCESSOR_V1_1_2 *ProcessorV1_1_2;
  EFI_REDFISH_PROCESSOR_V1_1_2_CS *ProcessorV1_1_2Cs;
  ...
  Status = Json_Processor_V1_1_2_To_CS (ResoruceRaw, &ProcessorV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_1_2 = (EFI_REDFISH_PROCESSOR_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_1_2));
  if (ProcessorV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ProcessorV1_1_2;
  ProcessorV1_1_2->Processor = ProcessorV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_PROCESSOR_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Processor_V1_1_2_JSON (*((EFI_REDFISH_PROCESSOR_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ProcessorV1_1_2 = (EFI_REDFISH_PROCESSOR_V1_1_2 *)InterpProp;
  DestroyProcessor_V1_1_2_CS (ProcessorV1_1_2->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyProcessor_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_1_2EntryPoint (
