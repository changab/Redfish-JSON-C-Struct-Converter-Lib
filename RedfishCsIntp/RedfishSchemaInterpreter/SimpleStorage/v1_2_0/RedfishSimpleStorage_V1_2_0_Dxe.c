...
//
#include <RedfishInterpreter/SimpleStorage/v1_2_0/EfiSimpleStorageV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_2_0 
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_2_0 *SimpleStorageV1_2_0;
  EFI_REDFISH_SIMPLESTORAGE_V1_2_0_CS *SimpleStorageV1_2_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "SimpleStorage") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_SimpleStorage_V1_2_0_To_CS (ResoruceRaw, &SimpleStorageV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_2_0 = (EFI_REDFISH_SIMPLESTORAGE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_2_0));
  if (SimpleStorageV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SimpleStorageV1_2_0;
  SimpleStorageV1_2_0->SimpleStorage = SimpleStorageV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_2_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SimpleStorage"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "SimpleStorage");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SimpleStorage"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "SimpleStorage");
...
)
{
  ...
  return CS_To_SimpleStorage_V1_2_0_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in SimpleStorageToStruct.
...
)
{
  ...
  SimpleStorageV1_2_0 = (EFI_REDFISH_SIMPLESTORAGE_V1_2_0 *)InterpProp;
  DestroySimpleStorage_V1_2_0_CS (SimpleStorageV1_2_0->SimpleStorage); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SimpleStorageFromEfiStruct
...
)
{
  ...
  return DestroySimpleStorage_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
