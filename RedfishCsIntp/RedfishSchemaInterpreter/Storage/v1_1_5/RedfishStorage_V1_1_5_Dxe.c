...
//
#include <RedfishInterpreter/Storage/v1_1_5/EfiStorageV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_1_5 
...
{
  EFI_REDFISH_STORAGE_V1_1_5 *StorageV1_1_5;
  EFI_REDFISH_STORAGE_V1_1_5_CS *StorageV1_1_5Cs;
  ...
  Status = Json_Storage_V1_1_5_To_CS (ResoruceRaw, &StorageV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_1_5 = (EFI_REDFISH_STORAGE_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_1_5));
  if (StorageV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_1_5;
  StorageV1_1_5->Storage = StorageV1_1_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_1_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_1_5_JSON (*((EFI_REDFISH_STORAGE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_1_5 = (EFI_REDFISH_STORAGE_V1_1_5 *)InterpProp;
  DestroyStorage_V1_1_5_CS (StorageV1_1_5->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_1_5EntryPoint (
