...
#ifndef _RedfishChassis_V1_0_1_CSTRUCT_H_
#define _RedfishChassis_V1_0_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishChassis_V1_0_1_Chassis_CS RedfishChassis_V1_0_1_Chassis_CS;
typedef struct _RedfishChassis_V1_0_1_Chassis_Actions_CS RedfishChassis_V1_0_1_Chassis_Actions_CS;
typedef struct _RedfishChassis_V1_0_1_Chassis_Actions_Oem_CS RedfishChassis_V1_0_1_Chassis_Actions_Oem_CS;
typedef struct _RedfishChassis_V1_0_1_Chassis_Links_CS RedfishChassis_V1_0_1_Chassis_Links_CS;
typedef struct _RedfishChassis_V1_0_1_Reset_CS RedfishChassis_V1_0_1_Reset_CS;
...
//
typedef struct _RedfishChassis_V1_0_1_Chassis_Actions_CS {
    RedfishChassis_V1_0_1_Reset_CS                  *Chassis_Reset;
    RedfishChassis_V1_0_1_Chassis_Actions_Oem_CS    *Oem;         
} RedfishChassis_V1_0_1_Chassis_Actions_CS;

typedef struct _RedfishChassis_V1_0_1_Chassis_Actions_Oem_CS {
    RedfishCS_Link    Prop;
} RedfishChassis_V1_0_1_Chassis_Actions_Oem_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishChassis_V1_0_1_Chassis_Links_CS {
...
} RedfishChassis_V1_0_1_Chassis_Links_CS;
...
//
typedef struct _RedfishChassis_V1_0_1_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishChassis_V1_0_1_Reset_CS;
...
//
typedef struct _RedfishChassis_V1_0_1_Chassis_CS {
    RedfishCS_Header                            Header;
    RedfishCS_char                              *odata_context;
    RedfishCS_char                              *odata_id;    
    RedfishCS_char                              *odata_type;  
    RedfishChassis_V1_0_1_Chassis_Actions_CS    *Actions;         // The available actions for this
                                                                  // resource.
    ...
    RedfishCS_char                              *IndicatorLED;    // The state of the indicator
                                                                  ...
                                                                  // chassis.
    RedfishChassis_V1_0_1_Chassis_Links_CS      *Links;           // Contains references to other
...
} RedfishChassis_V1_0_1_Chassis_CS;
...
RedfishCS_status
Json_Chassis_V1_0_1_To_CS (char *JsonRawText, RedfishChassis_V1_0_1_Chassis_CS **ReturnedCS);

RedfishCS_status
CS_To_Chassis_V1_0_1_JSON (RedfishChassis_V1_0_1_Chassis_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyChassis_V1_0_1_CS (RedfishChassis_V1_0_1_Chassis_CS *CSPtr);

RedfishCS_status
DestroyChassis_V1_0_1_Json (RedfishCS_char *JsonText);
