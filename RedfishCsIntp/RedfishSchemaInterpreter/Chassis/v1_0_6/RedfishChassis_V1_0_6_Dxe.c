...
//
#include <RedfishInterpreter/Chassis/v1_0_6/EfiChassisV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_0_6 
...
{
  EFI_REDFISH_CHASSIS_V1_0_6 *ChassisV1_0_6;
  EFI_REDFISH_CHASSIS_V1_0_6_CS *ChassisV1_0_6Cs;
  ...
  Status = Json_Chassis_V1_0_6_To_CS (ResoruceRaw, &ChassisV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_0_6 = (EFI_REDFISH_CHASSIS_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_0_6));
  if (ChassisV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_0_6;
  ChassisV1_0_6->Chassis = ChassisV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_0_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_0_6_JSON (*((EFI_REDFISH_CHASSIS_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_0_6 = (EFI_REDFISH_CHASSIS_V1_0_6 *)InterpProp;
  DestroyChassis_V1_0_6_CS (ChassisV1_0_6->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_0_6EntryPoint (
