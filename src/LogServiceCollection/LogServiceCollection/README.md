# Definition of LogServiceCollection and functions<br><br>
...
## Redfish LogServiceCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish LogServiceCollection  JSON Function
    RedfishCS_status
    CS_To_LogServiceCollection_JSON (RedfishLogServiceCollection_LogServiceCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish LogServiceCollection  C Structure Function
    RedfishCS_status
