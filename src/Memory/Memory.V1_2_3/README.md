# Definition of Memory.V1_2_3 and functions<br><br>
...
|**Memory_OverwriteUnit**|RedfishMemory_V1_2_3_OverwriteUnit_CS| Structure points to **#Memory.OverwriteUnit** property.| No| No
...
## C Structure to Redfish Memory V1_2_3 JSON Function
    RedfishCS_status
