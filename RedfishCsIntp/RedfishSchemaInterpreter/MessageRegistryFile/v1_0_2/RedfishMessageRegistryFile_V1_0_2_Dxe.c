...
//
#include <RedfishInterpreter/MessageRegistryFile/v1_0_2/EfiMessageRegistryFileV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_0_2 
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_2 *MessageRegistryFileV1_0_2;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_2_CS *MessageRegistryFileV1_0_2Cs;
  ...
  Status = Json_MessageRegistryFile_V1_0_2_To_CS (ResoruceRaw, &MessageRegistryFileV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_0_2 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_2));
  if (MessageRegistryFileV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryFileV1_0_2;
  MessageRegistryFileV1_0_2->MessageRegistryFile = MessageRegistryFileV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistryFile_V1_0_2_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryFileV1_0_2 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_2 *)InterpProp;
  DestroyMessageRegistryFile_V1_0_2_CS (MessageRegistryFileV1_0_2->MessageRegistryFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistryFile_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
