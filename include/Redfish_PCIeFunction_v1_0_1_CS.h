...
#ifndef _RedfishPciefunction_V1_0_1_CSTRUCT_H_
#define _RedfishPciefunction_V1_0_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPCIeFunction_V1_0_1_PCIeFunction_CS RedfishPCIeFunction_V1_0_1_PCIeFunction_CS;
typedef struct _RedfishPCIeFunction_V1_0_1_PCIeFunction_Links_CS RedfishPCIeFunction_V1_0_1_PCIeFunction_Links_CS;
...
// resource.
//
typedef struct _RedfishPCIeFunction_V1_0_1_PCIeFunction_Links_CS {
...
} RedfishPCIeFunction_V1_0_1_PCIeFunction_Links_CS;
...
//
typedef struct _RedfishPCIeFunction_V1_0_1_PCIeFunction_CS {
    ...
    RedfishCS_char                                      *Id;              
    RedfishPCIeFunction_V1_0_1_PCIeFunction_Links_CS    *Links;               // The links object contains the
    ...
    RedfishCS_char                                      *VendorId;            // The Vendor ID of this PCIe
                                                                              // function.
} RedfishPCIeFunction_V1_0_1_PCIeFunction_CS;

RedfishCS_status
Json_PCIeFunction_V1_0_1_To_CS (char *JsonRawText, RedfishPCIeFunction_V1_0_1_PCIeFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeFunction_V1_0_1_JSON (RedfishPCIeFunction_V1_0_1_PCIeFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPCIeFunction_V1_0_1_CS (RedfishPCIeFunction_V1_0_1_PCIeFunction_CS *CSPtr);

RedfishCS_status
DestroyPCIeFunction_V1_0_1_Json (RedfishCS_char *JsonText);
