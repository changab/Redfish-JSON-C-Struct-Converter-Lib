...
//
#include <RedfishInterpreter/Event/v1_1_3/EfiEventV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_1_3 
...
{
  EFI_REDFISH_EVENT_V1_1_3 *EventV1_1_3;
  EFI_REDFISH_EVENT_V1_1_3_CS *EventV1_1_3Cs;
  ...
  Status = Json_Event_V1_1_3_To_CS (ResoruceRaw, &EventV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_1_3 = (EFI_REDFISH_EVENT_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_1_3));
  if (EventV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_1_3;
  EventV1_1_3->Event = EventV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_EVENT_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_1_3_JSON (*((EFI_REDFISH_EVENT_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DestroyEvent_V1_1_3_CS (EventV1_1_3->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_1_3_Json (ResoruceRaw);
}
