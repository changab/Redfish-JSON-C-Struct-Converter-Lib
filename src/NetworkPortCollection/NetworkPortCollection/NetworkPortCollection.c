...
#include"Redfish_NetworkPortCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishNetworkPortCollection_NetworkPortCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for NetworkPortCollection.NetworkPortCollection
//
RedfishCS_status CS_To_NetworkPortCollection_JSON(RedfishNetworkPortCollection_NetworkPortCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for NetworkPortCollection.NetworkPortCollection
//
RedfishCS_status DestroyNetworkPortCollection_CS(RedfishNetworkPortCollection_NetworkPortCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkPortCollection.NetworkPortCollection
//
RedfishCS_status DestroyNetworkPortCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkPortCollection.NOVERSIONED.NetworkPortCollection
//
RedfishCS_status
Json_NetworkPortCollection_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkPortCollection_NetworkPortCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkPortCollection_NetworkPortCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkPortCollection", "noversioned", "NetworkPortCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkPortCollection_NetworkPortCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkPortCollection_CS (Cs);
  return Status;
}
