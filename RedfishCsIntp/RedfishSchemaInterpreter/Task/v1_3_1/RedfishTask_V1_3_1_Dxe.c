...
//
#include <RedfishInterpreter/Task/v1_3_1/EfiTaskV1_3_1.h>
...
{
  EFI_REDFISH_TASK_V1_3_1 *TaskV1_3_1;
  EFI_REDFISH_TASK_V1_3_1_CS *TaskV1_3_1Cs;
  ...
  Status = Json_Task_V1_3_1_To_CS (ResoruceRaw, &TaskV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_3_1 = (EFI_REDFISH_TASK_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_3_1));
  if (TaskV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskV1_3_1;
  TaskV1_3_1->Task = TaskV1_3_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_TASK_V1_3_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Task_V1_3_1_JSON (*((EFI_REDFISH_TASK_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskV1_3_1 = (EFI_REDFISH_TASK_V1_3_1 *)InterpProp;
  DestroyTask_V1_3_1_CS (TaskV1_3_1->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTask_V1_3_1_Json (ResoruceRaw);
}
