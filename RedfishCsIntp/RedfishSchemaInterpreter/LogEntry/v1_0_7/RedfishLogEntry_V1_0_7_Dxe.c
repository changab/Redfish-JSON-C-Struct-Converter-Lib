...
//
#include <RedfishInterpreter/LogEntry/v1_0_7/EfiLogEntryV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_0_7 
...
{
  EFI_REDFISH_LOGENTRY_V1_0_7 *LogEntryV1_0_7;
  EFI_REDFISH_LOGENTRY_V1_0_7_CS *LogEntryV1_0_7Cs;
  ...
  Status = Json_LogEntry_V1_0_7_To_CS (ResoruceRaw, &LogEntryV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_0_7 = (EFI_REDFISH_LOGENTRY_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_0_7));
  if (LogEntryV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_0_7;
  LogEntryV1_0_7->LogEntry = LogEntryV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_0_7_JSON (*((EFI_REDFISH_LOGENTRY_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_0_7 = (EFI_REDFISH_LOGENTRY_V1_0_7 *)InterpProp;
  DestroyLogEntry_V1_0_7_CS (LogEntryV1_0_7->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_0_7EntryPoint (
