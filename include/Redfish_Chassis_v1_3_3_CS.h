...
#ifndef _RedfishChassis_V1_3_3_CSTRUCT_H_
#define _RedfishChassis_V1_3_3_CSTRUCT_H_
...
#endif
typedef struct _RedfishChassis_V1_3_3_Chassis_CS RedfishChassis_V1_3_3_Chassis_CS;
typedef struct _RedfishChassis_V1_3_3_Chassis_Actions_CS RedfishChassis_V1_3_3_Chassis_Actions_CS;
typedef struct _RedfishChassis_V1_3_3_Chassis_Actions_Oem_CS RedfishChassis_V1_3_3_Chassis_Actions_Oem_CS;
typedef struct _RedfishChassis_V1_3_3_Chassis_Links_CS RedfishChassis_V1_3_3_Chassis_Links_CS;
typedef struct _RedfishChassis_V1_3_3_PhysicalSecurity_CS RedfishChassis_V1_3_3_PhysicalSecurity_CS;
typedef struct _RedfishChassis_V1_3_3_Reset_CS RedfishChassis_V1_3_3_Reset_CS;
...
typedef struct _RedfishChassis_V1_3_3_Chassis_Actions_CS {
    ...
    RedfishChassis_V1_3_3_Chassis_Actions_Oem_CS    *Oem;             // The available OEM specific
...
typedef struct _RedfishChassis_V1_3_3_Chassis_CS {
    ...
    RedfishChassis_V1_3_3_Chassis_Actions_CS     *Actions;            // The available actions for this
                                                                      // resource.
    ...
    RedfishCS_char                               *IndicatorLED;       // The state of the indicator
                                                                      ...
                                                                      // chassis.
    RedfishChassis_V1_3_3_Chassis_Links_CS       *Links;              // Contains references to other
    ...
    RedfishCS_char                               *PartNumber;         // The part number for this
                                                                      // chassis.
    RedfishChassis_V1_3_3_PhysicalSecurity_CS    *PhysicalSecurity;    // The state of the physical
                                                                      // security sensor.
...
RedfishCS_status
Json_Chassis_V1_3_3_To_CS (char *JsonRawText, RedfishChassis_V1_3_3_Chassis_CS **ReturnedCS);

RedfishCS_status
CS_To_Chassis_V1_3_3_JSON (RedfishChassis_V1_3_3_Chassis_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyChassis_V1_3_3_CS (RedfishChassis_V1_3_3_Chassis_CS *CSPtr);

RedfishCS_status
DestroyChassis_V1_3_3_Json (RedfishCS_char *JsonText);
