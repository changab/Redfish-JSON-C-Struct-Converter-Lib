...
//
#include <RedfishInterpreter/SimpleStorage/v1_0_4/EfiSimpleStorageV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_0_4 
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_0_4 *SimpleStorageV1_0_4;
  EFI_REDFISH_SIMPLESTORAGE_V1_0_4_CS *SimpleStorageV1_0_4Cs;
  ...
  Status = Json_SimpleStorage_V1_0_4_To_CS (ResoruceRaw, &SimpleStorageV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_0_4 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_4));
  if (SimpleStorageV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SimpleStorageV1_0_4;
  SimpleStorageV1_0_4->SimpleStorage = SimpleStorageV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SimpleStorage_V1_0_4_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SimpleStorageV1_0_4 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_4 *)InterpProp;
  DestroySimpleStorage_V1_0_4_CS (SimpleStorageV1_0_4->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySimpleStorage_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
