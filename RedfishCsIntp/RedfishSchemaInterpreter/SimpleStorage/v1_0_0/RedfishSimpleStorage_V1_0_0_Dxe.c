...
//
#include <RedfishInterpreter/SimpleStorage/v1_0_0/EfiSimpleStorageV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_0_0 
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_0_0 *SimpleStorageV1_0_0;
  EFI_REDFISH_SIMPLESTORAGE_V1_0_0_CS *SimpleStorageV1_0_0Cs;
  ...
  Status = Json_SimpleStorage_V1_0_0_To_CS (ResoruceRaw, &SimpleStorageV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_0_0 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_0));
  if (SimpleStorageV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SimpleStorageV1_0_0;
  SimpleStorageV1_0_0->SimpleStorage = SimpleStorageV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SimpleStorage_V1_0_0_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SimpleStorageV1_0_0 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_0 *)InterpProp;
  DestroySimpleStorage_V1_0_0_CS (SimpleStorageV1_0_0->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySimpleStorage_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
