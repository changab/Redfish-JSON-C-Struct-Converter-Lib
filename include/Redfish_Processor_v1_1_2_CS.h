...
#ifndef _RedfishProcessor_V1_1_2_CSTRUCT_H_
#define _RedfishProcessor_V1_1_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessor_V1_1_2_Actions_CS RedfishProcessor_V1_1_2_Actions_CS;
typedef struct _RedfishProcessor_V1_1_2_Links_CS RedfishProcessor_V1_1_2_Links_CS;
typedef struct _RedfishProcessor_V1_1_2_OemActions_CS RedfishProcessor_V1_1_2_OemActions_CS;
typedef struct _RedfishProcessor_V1_1_2_Processor_CS RedfishProcessor_V1_1_2_Processor_CS;
typedef struct _RedfishProcessor_V1_1_2_ProcessorId_CS RedfishProcessor_V1_1_2_ProcessorId_CS;
...
typedef struct _RedfishProcessor_V1_1_2_Actions_CS {
    RedfishProcessor_V1_1_2_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishProcessor_V1_1_2_Processor_CS {
    ...
    RedfishProcessor_V1_1_2_Actions_CS        *Actions;                 // The available actions for this
                                                                        // resource.
    RedfishCS_char                            *Description;         
    RedfishCS_char                            *Id;                  
    RedfishCS_char                            *InstructionSet;          // The instruction set of the
                                                                        // processor.
    RedfishProcessor_V1_1_2_Links_CS          *Links;                   // Contains references to other
    ...
    RedfishCS_char                            *ProcessorArchitecture;    // The architecture of the
                                                                        // processor.
    RedfishProcessor_V1_1_2_ProcessorId_CS    *ProcessorId;             // Identification information for
                                                                        // this processor.
...
RedfishCS_status
Json_Processor_V1_1_2_To_CS (char *JsonRawText, RedfishProcessor_V1_1_2_Processor_CS **ReturnedCS);

RedfishCS_status
CS_To_Processor_V1_1_2_JSON (RedfishProcessor_V1_1_2_Processor_CS *CSPtr, char **JsonText);
