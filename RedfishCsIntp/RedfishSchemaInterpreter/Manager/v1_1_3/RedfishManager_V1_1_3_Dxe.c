...
//
#include <RedfishInterpreter/Manager/v1_1_3/EfiManagerV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_1_3 
...
{
  EFI_REDFISH_MANAGER_V1_1_3 *ManagerV1_1_3;
  EFI_REDFISH_MANAGER_V1_1_3_CS *ManagerV1_1_3Cs;
  ...
  Status = Json_Manager_V1_1_3_To_CS (ResoruceRaw, &ManagerV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_1_3 = (EFI_REDFISH_MANAGER_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_1_3));
  if (ManagerV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_1_3;
  ManagerV1_1_3->Manager = ManagerV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_1_3_JSON (*((EFI_REDFISH_MANAGER_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_1_3 = (EFI_REDFISH_MANAGER_V1_1_3 *)InterpProp;
  DestroyManager_V1_1_3_CS (ManagerV1_1_3->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_1_3EntryPoint (
