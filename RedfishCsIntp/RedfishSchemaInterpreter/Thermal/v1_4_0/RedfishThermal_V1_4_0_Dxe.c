...
//
#include <RedfishInterpreter/Thermal/v1_4_0/EfiThermalV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_4_0 
...
{
  EFI_REDFISH_THERMAL_V1_4_0 *ThermalV1_4_0;
  EFI_REDFISH_THERMAL_V1_4_0_CS *ThermalV1_4_0Cs;
  ...
  Status = Json_Thermal_V1_4_0_To_CS (ResoruceRaw, &ThermalV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_4_0 = (EFI_REDFISH_THERMAL_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_4_0));
  if (ThermalV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_4_0;
  ThermalV1_4_0->Thermal = ThermalV1_4_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_4_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_4_0_JSON (*((EFI_REDFISH_THERMAL_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_4_0 = (EFI_REDFISH_THERMAL_V1_4_0 *)InterpProp;
  DestroyThermal_V1_4_0_CS (ThermalV1_4_0->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_4_0EntryPoint (
