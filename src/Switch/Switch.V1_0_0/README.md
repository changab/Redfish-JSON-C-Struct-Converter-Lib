# Definition of Switch.V1_0_0 and functions<br><br>
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Switch_Reset**|RedfishSwitch_V1_0_0_Reset_CS| Structure points to **#Switch.Reset** property.| No| No
|**Oem**|RedfishSwitch_V1_0_0_Switch_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## Switch
    typedef struct _RedfishSwitch_V1_0_0_Switch_CS {
        ...
        RedfishSwitch_V1_0_0_Switch_Actions_CS *Actions;
        ...
        RedfishSwitch_V1_0_0_Switch_Links_CS *Links;
...
|**Actions**|RedfishSwitch_V1_0_0_Switch_Actions_CS| Structure points to **Actions** property.| No| Yes
...
|**Links**|RedfishSwitch_V1_0_0_Switch_Links_CS| Structure points to **Links** property.| No| Yes
...
|**SwitchType**|RedfishCS_char| String pointer to **SwitchType** property.| No| No
|**TotalSwitchWidth**|RedfishCS_int64| 64-bit long long interger pointer to **TotalSwitchWidth** property.| No| Yes
## Redfish Switch V1_0_0 to C Structure Function
    RedfishCS_status
    Json_Switch_V1_0_0_To_CS (RedfishCS_char *JsonRawText, RedfishSwitch_V1_0_0_Switch_CS **ReturnedCS);

## C Structure to Redfish Switch V1_0_0 JSON Function
    RedfishCS_status
    CS_To_Switch_V1_0_0_JSON (RedfishSwitch_V1_0_0_Switch_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Switch V1_0_0 C Structure Function
    RedfishCS_status
