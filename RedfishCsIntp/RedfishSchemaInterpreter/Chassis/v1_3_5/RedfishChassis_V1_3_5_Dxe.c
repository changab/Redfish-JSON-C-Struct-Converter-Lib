...
//
#include <RedfishInterpreter/Chassis/v1_3_5/EfiChassisV1_3_5.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_3_5 
...
{
  EFI_REDFISH_CHASSIS_V1_3_5 *ChassisV1_3_5;
  EFI_REDFISH_CHASSIS_V1_3_5_CS *ChassisV1_3_5Cs;
  ...
  Status = Json_Chassis_V1_3_5_To_CS (ResoruceRaw, &ChassisV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_3_5 = (EFI_REDFISH_CHASSIS_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_3_5));
  if (ChassisV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_3_5;
  ChassisV1_3_5->Chassis = ChassisV1_3_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_3_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_3_5_JSON (*((EFI_REDFISH_CHASSIS_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_3_5 = (EFI_REDFISH_CHASSIS_V1_3_5 *)InterpProp;
  DestroyChassis_V1_3_5_CS (ChassisV1_3_5->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_3_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_3_5EntryPoint (
