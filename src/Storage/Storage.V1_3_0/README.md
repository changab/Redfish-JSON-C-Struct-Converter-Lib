# Definition of Storage.V1_3_0 and functions<br><br>
...
## StorageController
    typedef struct _RedfishStorage_V1_3_0_StorageController_CS {
        RedfishStorage_V1_3_0_StorageControllerActions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_char *FirmwareVersion;
        RedfishResource_V1_1_0_Identifier_Array_CS *Identifiers;
        RedfishStorage_V1_3_0_StorageController_Links_CS *Links;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Actions**|RedfishStorage_V1_3_0_StorageControllerActions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishStorage_V1_3_0_StorageController_Links_CS| Structure points to **Links** property.| No| No
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishStorage_V1_3_0_StorageControllerOemActions_CS| Structure points to **Oem** property.| No| No
...
## Storage_Actions
    typedef struct _RedfishStorage_V1_3_0_Storage_Actions_CS {
        ...
        RedfishStorage_V1_3_0_Storage_Actions_Oem_CS *Oem;
    } RedfishStorage_V1_3_0_Storage_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Storage_SetEncryptionKey**|RedfishStorage_V1_3_0_SetEncryptionKey_CS| Structure points to **#Storage.SetEncryptionKey** property.| No| No
|**Oem**|RedfishStorage_V1_3_0_Storage_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## Storage
    typedef struct _RedfishStorage_V1_3_0_Storage_CS {
        ...
        RedfishStorage_V1_3_0_Storage_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_Link Drives;
        RedfishCS_int64 *Drivesodata_count;
        RedfishCS_char *Drivesodata_navigationLink;
        RedfishCS_char *Id;
        RedfishStorage_V1_3_0_Storage_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        ...
        RedfishResource_Status_CS *Status;
        RedfishStorage_V1_3_0_StorageController_CS *StorageControllers;
...
|**Actions**|RedfishStorage_V1_3_0_Storage_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishStorage_V1_3_0_Storage_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
...
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**StorageControllers**|RedfishStorage_V1_3_0_StorageController_CS| Structure points to **StorageControllers** property.| No| Yes
...
## Redfish Storage V1_3_0 to C Structure Function
    RedfishCS_status
    Json_Storage_V1_3_0_To_CS (RedfishCS_char *JsonRawText, RedfishStorage_V1_3_0_Storage_CS **ReturnedCS);

## C Structure to Redfish Storage V1_3_0 JSON Function
    RedfishCS_status
    CS_To_Storage_V1_3_0_JSON (RedfishStorage_V1_3_0_Storage_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Storage V1_3_0 C Structure Function
    RedfishCS_status
