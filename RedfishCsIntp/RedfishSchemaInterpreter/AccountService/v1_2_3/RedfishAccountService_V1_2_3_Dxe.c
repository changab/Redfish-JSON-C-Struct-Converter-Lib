...
//
#include <RedfishInterpreter/AccountService/v1_2_3/EfiAccountServiceV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_2_3 
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_2_3 *AccountServiceV1_2_3;
  EFI_REDFISH_ACCOUNTSERVICE_V1_2_3_CS *AccountServiceV1_2_3Cs;
  ...
  Status = Json_AccountService_V1_2_3_To_CS (ResoruceRaw, &AccountServiceV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_2_3 = (EFI_REDFISH_ACCOUNTSERVICE_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_2_3));
  if (AccountServiceV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AccountServiceV1_2_3;
  AccountServiceV1_2_3->AccountService = AccountServiceV1_2_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_2_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AccountService_V1_2_3_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AccountServiceV1_2_3 = (EFI_REDFISH_ACCOUNTSERVICE_V1_2_3 *)InterpProp;
  DestroyAccountService_V1_2_3_CS (AccountServiceV1_2_3->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAccountService_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_2_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_2_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
