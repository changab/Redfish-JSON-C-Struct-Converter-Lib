...
//
#include <RedfishInterpreter/Power/v1_5_1/EfiPowerV1_5_1.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_5_1 
...
{
  EFI_REDFISH_POWER_V1_5_1 *PowerV1_5_1;
  EFI_REDFISH_POWER_V1_5_1_CS *PowerV1_5_1Cs;
  ...
  Status = Json_Power_V1_5_1_To_CS (ResoruceRaw, &PowerV1_5_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_5_1 = (EFI_REDFISH_POWER_V1_5_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_5_1));
  if (PowerV1_5_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_5_1;
  PowerV1_5_1->Power = PowerV1_5_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "5";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_POWER_V1_5_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_5_1_JSON (*((EFI_REDFISH_POWER_V1_5_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_5_1 = (EFI_REDFISH_POWER_V1_5_1 *)InterpProp;
  DestroyPower_V1_5_1_CS (PowerV1_5_1->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_5_1_Json (ResoruceRaw);
}
