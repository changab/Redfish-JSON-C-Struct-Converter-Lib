...
#include"Redfish_NetworkAdapterCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishNetworkAdapterCollection_NetworkAdapterCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for NetworkAdapterCollection.NetworkAdapterCollection
//
RedfishCS_status CS_To_NetworkAdapterCollection_JSON(RedfishNetworkAdapterCollection_NetworkAdapterCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for NetworkAdapterCollection.NetworkAdapterCollection
//
RedfishCS_status DestroyNetworkAdapterCollection_CS(RedfishNetworkAdapterCollection_NetworkAdapterCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkAdapterCollection.NetworkAdapterCollection
//
RedfishCS_status DestroyNetworkAdapterCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkAdapterCollection.NOVERSIONED.NetworkAdapterCollection
//
RedfishCS_status
Json_NetworkAdapterCollection_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkAdapterCollection_NetworkAdapterCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkAdapterCollection_NetworkAdapterCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkAdapterCollection", "noversioned", "NetworkAdapterCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkAdapterCollection_NetworkAdapterCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkAdapterCollection_CS (Cs);
  return Status;
}
