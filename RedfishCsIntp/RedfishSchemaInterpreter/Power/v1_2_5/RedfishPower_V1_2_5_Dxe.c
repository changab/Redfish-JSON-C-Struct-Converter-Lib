...
//
#include <RedfishInterpreter/Power/v1_2_5/EfiPowerV1_2_5.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_2_5 
...
{
  EFI_REDFISH_POWER_V1_2_5 *PowerV1_2_5;
  EFI_REDFISH_POWER_V1_2_5_CS *PowerV1_2_5Cs;
  ...
  Status = Json_Power_V1_2_5_To_CS (ResoruceRaw, &PowerV1_2_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_2_5 = (EFI_REDFISH_POWER_V1_2_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_2_5));
  if (PowerV1_2_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_2_5;
  PowerV1_2_5->Power = PowerV1_2_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_POWER_V1_2_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_2_5_JSON (*((EFI_REDFISH_POWER_V1_2_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_2_5 = (EFI_REDFISH_POWER_V1_2_5 *)InterpProp;
  DestroyPower_V1_2_5_CS (PowerV1_2_5->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_2_5_Json (ResoruceRaw);
}
