...
#ifndef _RedfishComputersystem_V1_1_6_CSTRUCT_H_
#define _RedfishComputersystem_V1_1_6_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_1_6_TrustedModules_Array_CS RedfishComputerSystem_V1_1_6_TrustedModules_Array_CS;
typedef struct _RedfishComputerSystem_V1_1_6_Actions_CS RedfishComputerSystem_V1_1_6_Actions_CS;
typedef struct _RedfishComputerSystem_V1_1_6_Boot_CS RedfishComputerSystem_V1_1_6_Boot_CS;
typedef struct _RedfishComputerSystem_V1_1_6_ComputerSystem_CS RedfishComputerSystem_V1_1_6_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_1_6_Links_CS RedfishComputerSystem_V1_1_6_Links_CS;
typedef struct _RedfishComputerSystem_V1_1_6_MemorySummary_CS RedfishComputerSystem_V1_1_6_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_1_6_OemActions_CS RedfishComputerSystem_V1_1_6_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_1_6_ProcessorSummary_CS RedfishComputerSystem_V1_1_6_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_1_6_Reset_CS RedfishComputerSystem_V1_1_6_Reset_CS;
typedef struct _RedfishComputerSystem_V1_1_6_SetDefaultBootOrder_CS RedfishComputerSystem_V1_1_6_SetDefaultBootOrder_CS;
typedef struct _RedfishComputerSystem_V1_1_6_TrustedModules_CS RedfishComputerSystem_V1_1_6_TrustedModules_CS;
...
typedef struct _RedfishComputerSystem_V1_1_6_Actions_CS {
    ...
    RedfishComputerSystem_V1_1_6_OemActions_CS             *Oem;                                  // This property contains the
...
typedef struct _RedfishComputerSystem_V1_1_6_ComputerSystem_CS {
    ...
    RedfishComputerSystem_V1_1_6_Actions_CS                 *Actions;             // The available actions for this
                                                                                  // resource.
    ...
    RedfishComputerSystem_V1_1_6_Boot_CS                    *Boot;                // Information about the boot
    ...
    RedfishCS_char                                          *IndicatorLED;        // The state of the indicator
                                                                                  ...
                                                                                  // system.
    RedfishComputerSystem_V1_1_6_Links_CS                   *Links;               // Contains references to other
    ...
    RedfishCS_Link                                          Memory;               // A reference to the collection
                                                                                  ...
                                                                                  // system.
    RedfishComputerSystem_V1_1_6_MemorySummary_CS           *MemorySummary;       // This object describes the
    ...
    RedfishCS_char                                          *PowerState;          // This is the current power
                                                                                  // state of the system.
    RedfishComputerSystem_V1_1_6_ProcessorSummary_CS        *ProcessorSummary;    // This object describes the
    ...
    RedfishComputerSystem_V1_1_6_TrustedModules_Array_CS    *TrustedModules;      // This object describes the
...
typedef struct _RedfishComputerSystem_V1_1_6_TrustedModules_Array_CS  {
    RedfishComputerSystem_V1_1_6_TrustedModules_Array_CS    *Next;
    RedfishComputerSystem_V1_1_6_TrustedModules_CS    *ArrayValue;
} RedfishComputerSystem_V1_1_6_TrustedModules_Array_CS;

RedfishCS_status
Json_ComputerSystem_V1_1_6_To_CS (char *JsonRawText, RedfishComputerSystem_V1_1_6_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_1_6_JSON (RedfishComputerSystem_V1_1_6_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_1_6_CS (RedfishComputerSystem_V1_1_6_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_1_6_Json (RedfishCS_char *JsonText);
