...
//
#include <RedfishInterpreter/ComputerSystem/v1_5_2/EfiComputerSystemV1_5_2.h>
...
)
{
  ...
  Status = Json_ComputerSystem_V1_5_2_To_CS (ResoruceRaw, &ComputerSystemV1_5_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ...
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_5_2;
  ...
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_5_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_5_2_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_5_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  return DestroyComputerSystem_V1_5_2_Json (ResoruceRaw);
}
