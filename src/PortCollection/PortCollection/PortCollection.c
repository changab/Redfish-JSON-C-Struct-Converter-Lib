...
#include"Redfish_PortCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishPortCollection_PortCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for PortCollection.PortCollection
//
RedfishCS_status CS_To_PortCollection_JSON(RedfishPortCollection_PortCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PortCollection.PortCollection
//
RedfishCS_status DestroyPortCollection_CS(RedfishPortCollection_PortCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PortCollection.PortCollection
//
RedfishCS_status DestroyPortCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PortCollection.NOVERSIONED.PortCollection
//
RedfishCS_status
Json_PortCollection_To_CS(RedfishCS_char *JsonRawText, RedfishPortCollection_PortCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPortCollection_PortCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PortCollection", "noversioned", "PortCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPortCollection_PortCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
