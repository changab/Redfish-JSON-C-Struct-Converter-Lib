...
//
#include <RedfishInterpreter/ResourceBlock/v1_1_1/EfiResourceBlockV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_1_1 
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_1_1 *ResourceBlockV1_1_1;
  EFI_REDFISH_RESOURCEBLOCK_V1_1_1_CS *ResourceBlockV1_1_1Cs;
  ...
  Status = Json_ResourceBlock_V1_1_1_To_CS (ResoruceRaw, &ResourceBlockV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_1_1 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_1_1));
  if (ResourceBlockV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ResourceBlockV1_1_1;
  ResourceBlockV1_1_1->ResourceBlock = ResourceBlockV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ResourceBlock_V1_1_1_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ResourceBlockV1_1_1 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_1 *)InterpProp;
  DestroyResourceBlock_V1_1_1_CS (ResourceBlockV1_1_1->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyResourceBlock_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
