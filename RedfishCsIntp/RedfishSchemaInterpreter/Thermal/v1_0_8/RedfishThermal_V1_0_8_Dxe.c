...
//
#include <RedfishInterpreter/Thermal/v1_0_8/EfiThermalV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_0_8 
...
{
  EFI_REDFISH_THERMAL_V1_0_8 *ThermalV1_0_8;
  EFI_REDFISH_THERMAL_V1_0_8_CS *ThermalV1_0_8Cs;
  ...
  Status = Json_Thermal_V1_0_8_To_CS (ResoruceRaw, &ThermalV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_0_8 = (EFI_REDFISH_THERMAL_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_0_8));
  if (ThermalV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_0_8;
  ThermalV1_0_8->Thermal = ThermalV1_0_8Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "8";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_0_8_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_0_8_JSON (*((EFI_REDFISH_THERMAL_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_0_8 = (EFI_REDFISH_THERMAL_V1_0_8 *)InterpProp;
  DestroyThermal_V1_0_8_CS (ThermalV1_0_8->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_0_8EntryPoint (
