...
//
#include <RedfishInterpreter/SoftwareInventory/v1_1_0/EfiSoftwareInventoryV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_1_0 
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_1_0 *SoftwareInventoryV1_1_0;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_1_0_CS *SoftwareInventoryV1_1_0Cs;
  ...
  Status = Json_SoftwareInventory_V1_1_0_To_CS (ResoruceRaw, &SoftwareInventoryV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_1_0 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_0));
  if (SoftwareInventoryV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SoftwareInventoryV1_1_0;
  SoftwareInventoryV1_1_0->SoftwareInventory = SoftwareInventoryV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SoftwareInventory_V1_1_0_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SoftwareInventoryV1_1_0 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_0 *)InterpProp;
  DestroySoftwareInventory_V1_1_0_CS (SoftwareInventoryV1_1_0->SoftwareInventory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySoftwareInventory_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
