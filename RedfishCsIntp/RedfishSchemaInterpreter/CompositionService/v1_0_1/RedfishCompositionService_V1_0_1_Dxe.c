...
//
#include <RedfishInterpreter/CompositionService/v1_0_1/EfiCompositionServiceV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#CompositionService";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionService V1_0_1 
...
{
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_1 *CompositionServiceV1_0_1;
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_1_CS *CompositionServiceV1_0_1Cs;
  ...
  Status = Json_CompositionService_V1_0_1_To_CS (ResoruceRaw, &CompositionServiceV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionServiceV1_0_1 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_1));
  if (CompositionServiceV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)CompositionServiceV1_0_1;
  CompositionServiceV1_0_1->CompositionService = CompositionServiceV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_CompositionService_V1_0_1_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  CompositionServiceV1_0_1 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_1 *)InterpProp;
  DestroyCompositionService_V1_0_1_CS (CompositionServiceV1_0_1->CompositionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyCompositionService_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
