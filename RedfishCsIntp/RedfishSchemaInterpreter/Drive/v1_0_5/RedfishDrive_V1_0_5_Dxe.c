...
//
#include <RedfishInterpreter/Drive/v1_0_5/EfiDriveV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_5 
...
{
  EFI_REDFISH_DRIVE_V1_0_5 *DriveV1_0_5;
  EFI_REDFISH_DRIVE_V1_0_5_CS *DriveV1_0_5Cs;
  ...
  Status = Json_Drive_V1_0_5_To_CS (ResoruceRaw, &DriveV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_5 = (EFI_REDFISH_DRIVE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_5));
  if (DriveV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_0_5;
  DriveV1_0_5->Drive = DriveV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_0_5_JSON (*((EFI_REDFISH_DRIVE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_0_5 = (EFI_REDFISH_DRIVE_V1_0_5 *)InterpProp;
  DestroyDrive_V1_0_5_CS (DriveV1_0_5->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_0_5_Json (ResoruceRaw);
}
