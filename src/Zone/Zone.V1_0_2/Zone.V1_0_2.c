...
#include"Redfish_Zone_v1_0_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishZone_V1_0_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenLinksCs(RedfishZone_V1_0_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_0_2_Zone_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_0_2_Zone_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
//
static RedfishCS_status GenStatusCs(RedfishZone_V1_0_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishZone_V1_0_2_Zone_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Zone.V1_0_2.Zone
//
RedfishCS_status CS_To_Zone_V1_0_2_JSON(RedfishZone_V1_0_2_Zone_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Zone.V1_0_2.Zone
//
RedfishCS_status DestroyZone_V1_0_2_CS(RedfishZone_V1_0_2_Zone_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Zone.V1_0_2.Zone
//
RedfishCS_status DestroyZone_V1_0_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Zone.V1_0_2.Zone
//
RedfishCS_status
Json_Zone_V1_0_2_To_CS(RedfishCS_char *JsonRawText, RedfishZone_V1_0_2_Zone_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishZone_V1_0_2_Zone_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Zone", "v1_0_2", "Zone", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishZone_V1_0_2_Zone_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
