...
//
#include <RedfishInterpreter/CompositionService/v1_1_0/EfiCompositionServiceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#CompositionService";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionService V1_1_0 
...
{
  EFI_REDFISH_COMPOSITIONSERVICE_V1_1_0 *CompositionServiceV1_1_0;
  EFI_REDFISH_COMPOSITIONSERVICE_V1_1_0_CS *CompositionServiceV1_1_0Cs;
  ...
  Status = Json_CompositionService_V1_1_0_To_CS (ResoruceRaw, &CompositionServiceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionServiceV1_1_0 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_1_0));
  if (CompositionServiceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)CompositionServiceV1_1_0;
  CompositionServiceV1_1_0->CompositionService = CompositionServiceV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_CompositionService_V1_1_0_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  CompositionServiceV1_1_0 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_1_0 *)InterpProp;
  DestroyCompositionService_V1_1_0_CS (CompositionServiceV1_1_0->CompositionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyCompositionService_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
