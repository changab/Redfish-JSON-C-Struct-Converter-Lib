...
//
#include <RedfishInterpreter/UpdateService/v1_1_4/EfiUpdateServiceV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_1_4 
...
{
  EFI_REDFISH_UPDATESERVICE_V1_1_4 *UpdateServiceV1_1_4;
  EFI_REDFISH_UPDATESERVICE_V1_1_4_CS *UpdateServiceV1_1_4Cs;
  ...
  Status = Json_UpdateService_V1_1_4_To_CS (ResoruceRaw, &UpdateServiceV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_1_4 = (EFI_REDFISH_UPDATESERVICE_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_1_4));
  if (UpdateServiceV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)UpdateServiceV1_1_4;
  UpdateServiceV1_1_4->UpdateService = UpdateServiceV1_1_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_UPDATESERVICE_V1_1_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_UpdateService_V1_1_4_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  UpdateServiceV1_1_4 = (EFI_REDFISH_UPDATESERVICE_V1_1_4 *)InterpProp;
  DestroyUpdateService_V1_1_4_CS (UpdateServiceV1_1_4->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyUpdateService_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
