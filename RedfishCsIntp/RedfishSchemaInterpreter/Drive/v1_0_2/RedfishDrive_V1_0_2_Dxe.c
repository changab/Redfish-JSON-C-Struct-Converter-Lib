...
//
#include <RedfishInterpreter/Drive/v1_0_2/EfiDriveV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_2 
...
{
  EFI_REDFISH_DRIVE_V1_0_2 *DriveV1_0_2;
  EFI_REDFISH_DRIVE_V1_0_2_CS *DriveV1_0_2Cs;
  ...
  Status = Json_Drive_V1_0_2_To_CS (ResoruceRaw, &DriveV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_2 = (EFI_REDFISH_DRIVE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_2));
  if (DriveV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_0_2;
  DriveV1_0_2->Drive = DriveV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_0_2_JSON (*((EFI_REDFISH_DRIVE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_0_2 = (EFI_REDFISH_DRIVE_V1_0_2 *)InterpProp;
  DestroyDrive_V1_0_2_CS (DriveV1_0_2->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_0_2_Json (ResoruceRaw);
}
