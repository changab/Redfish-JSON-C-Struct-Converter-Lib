...
#ifndef _RedfishZone_V1_2_0_CSTRUCT_H_
#define _RedfishZone_V1_2_0_CSTRUCT_H_
...
typedef struct _RedfishZone_V1_2_0_Actions_CS RedfishZone_V1_2_0_Actions_CS;
typedef struct _RedfishZone_V1_2_0_Links_CS RedfishZone_V1_2_0_Links_CS;
typedef struct _RedfishZone_V1_2_0_OemActions_CS RedfishZone_V1_2_0_OemActions_CS;
typedef struct _RedfishZone_V1_2_0_Zone_CS RedfishZone_V1_2_0_Zone_CS;
//
...
typedef struct _RedfishZone_V1_2_0_Zone_CS {
    ...
    RedfishZone_V1_2_0_Actions_CS    *Actions;         // The available actions for this
                                                       // resource.
    RedfishCS_char                   *Description; 
    RedfishCS_char                   *Id;          
    RedfishCS_Link                   Identifiers;      // Identifiers for this zone.
    RedfishZone_V1_2_0_Links_CS      *Links;           // Contains references to other
...
RedfishCS_status
Json_Zone_V1_2_0_To_CS (char *JsonRawText, RedfishZone_V1_2_0_Zone_CS **ReturnedCS);

RedfishCS_status
CS_To_Zone_V1_2_0_JSON (RedfishZone_V1_2_0_Zone_CS *CSPtr, char **JsonText);
