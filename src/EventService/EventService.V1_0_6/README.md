# Definition of EventService.V1_0_6 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**EventService_SubmitTestEvent**|RedfishEventService_V1_0_6_SubmitTestEvent_CS| Structure points to **#EventService.SubmitTestEvent** property.| No| No
|**Oem**|RedfishEventService_V1_0_6_OemActions_CS| Structure points to **Oem** property.| No| No
...
## EventService
    typedef struct _RedfishEventService_V1_0_6_EventService_CS {
        ...
        RedfishEventService_V1_0_6_Actions_CS *Actions;
...
|**Actions**|RedfishEventService_V1_0_6_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish EventService V1_0_6 to C Structure Function
    RedfishCS_status
    Json_EventService_V1_0_6_To_CS (RedfishCS_char *JsonRawText, RedfishEventService_V1_0_6_EventService_CS **ReturnedCS);

## C Structure to Redfish EventService V1_0_6 JSON Function
    RedfishCS_status
    CS_To_EventService_V1_0_6_JSON (RedfishEventService_V1_0_6_EventService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EventService V1_0_6 C Structure Function
    RedfishCS_status
