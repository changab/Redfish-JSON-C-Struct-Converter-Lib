...
//
#include <RedfishInterpreter/Memory/v1_1_0/EfiMemoryV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_1_0 
...
{
  EFI_REDFISH_MEMORY_V1_1_0 *MemoryV1_1_0;
  EFI_REDFISH_MEMORY_V1_1_0_CS *MemoryV1_1_0Cs;
  ...
  Status = Json_Memory_V1_1_0_To_CS (ResoruceRaw, &MemoryV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_1_0 = (EFI_REDFISH_MEMORY_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_1_0));
  if (MemoryV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryV1_1_0;
  MemoryV1_1_0->Memory = MemoryV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MEMORY_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Memory_V1_1_0_JSON (*((EFI_REDFISH_MEMORY_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryV1_1_0 = (EFI_REDFISH_MEMORY_V1_1_0 *)InterpProp;
  DestroyMemory_V1_1_0_CS (MemoryV1_1_0->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemory_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_1_0EntryPoint (
