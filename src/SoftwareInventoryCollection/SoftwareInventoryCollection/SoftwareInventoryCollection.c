...
#include"Redfish_SoftwareInventoryCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishSoftwareInventoryCollection_SoftwareInventoryCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for SoftwareInventoryCollection.SoftwareInventoryCollection
//
RedfishCS_status CS_To_SoftwareInventoryCollection_JSON(RedfishSoftwareInventoryCollection_SoftwareInventoryCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SoftwareInventoryCollection.SoftwareInventoryCollection
//
RedfishCS_status DestroySoftwareInventoryCollection_CS(RedfishSoftwareInventoryCollection_SoftwareInventoryCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SoftwareInventoryCollection.SoftwareInventoryCollection
//
RedfishCS_status DestroySoftwareInventoryCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SoftwareInventoryCollection.NOVERSIONED.SoftwareInventoryCollection
//
RedfishCS_status
Json_SoftwareInventoryCollection_To_CS(RedfishCS_char *JsonRawText, RedfishSoftwareInventoryCollection_SoftwareInventoryCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSoftwareInventoryCollection_SoftwareInventoryCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SoftwareInventoryCollection", "noversioned", "SoftwareInventoryCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSoftwareInventoryCollection_SoftwareInventoryCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySoftwareInventoryCollection_CS (Cs);
  return Status;
}
