...
//
#include <RedfishInterpreter/ManagerAccount/v1_0_3/EfiManagerAccountV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_3 
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_3 *ManagerAccountV1_0_3;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_3_CS *ManagerAccountV1_0_3Cs;
  ...
  Status = Json_ManagerAccount_V1_0_3_To_CS (ResoruceRaw, &ManagerAccountV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_3 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_3));
  if (ManagerAccountV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerAccountV1_0_3;
  ManagerAccountV1_0_3->ManagerAccount = ManagerAccountV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerAccount_V1_0_3_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerAccountV1_0_3 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_3 *)InterpProp;
  DestroyManagerAccount_V1_0_3_CS (ManagerAccountV1_0_3->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerAccount_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
