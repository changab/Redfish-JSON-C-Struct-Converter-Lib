...
#ifndef _RedfishServiceroot_V1_1_2_CSTRUCT_H_
#define _RedfishServiceroot_V1_1_2_CSTRUCT_H_
...
typedef struct _RedfishServiceRoot_V1_1_2_ServiceRoot_CS RedfishServiceRoot_V1_1_2_ServiceRoot_CS;
typedef struct _RedfishServiceRoot_V1_1_2_ServiceRoot_Links_CS RedfishServiceRoot_V1_1_2_ServiceRoot_Links_CS;
//
...
//
typedef struct _RedfishServiceRoot_V1_1_2_ServiceRoot_Links_CS {
    RedfishResource_Oem_CS    *Oem;       // Oem extension object.
    RedfishCS_Link            Sessions;    // Link to a collection of
                                          // Sessions.
} RedfishServiceRoot_V1_1_2_ServiceRoot_Links_CS;

//
// This object represents the root Redfish service.
//
typedef struct _RedfishServiceRoot_V1_1_2_ServiceRoot_CS {
    ...
    RedfishServiceRoot_V1_1_2_ServiceRoot_Links_CS    *Links;            // Contains references to other
    ...
    RedfishCS_Link                                    UpdateService;     // This is a link to the
                                                                         // UpdateService.
} RedfishServiceRoot_V1_1_2_ServiceRoot_CS;

RedfishCS_status
Json_ServiceRoot_V1_1_2_To_CS (char *JsonRawText, RedfishServiceRoot_V1_1_2_ServiceRoot_CS **ReturnedCS);

RedfishCS_status
CS_To_ServiceRoot_V1_1_2_JSON (RedfishServiceRoot_V1_1_2_ServiceRoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyServiceRoot_V1_1_2_CS (RedfishServiceRoot_V1_1_2_ServiceRoot_CS *CSPtr);
