...
#define _RedfishEventdestination_V1_2_1_CSTRUCT_H_
...
typedef struct _RedfishEventDestination_V1_2_1_HttpHeaderProperty_CS RedfishEventDestination_V1_2_1_HttpHeaderProperty_CS;
...
typedef struct _RedfishEventDestination_V1_2_1_EventDestination_Actions_CS {
    RedfishEventDestination_V1_2_1_EventDestination_Actions_Oem_CS    *Oem;    // The available OEM specific
...
typedef struct _RedfishEventDestination_V1_2_1_EventDestination_CS {
    ...
    RedfishEventDestination_V1_2_1_EventDestination_Actions_CS    *Actions;                               // The available actions for this
                                                                                                          // resource.
    ...
    RedfishEventDestination_V1_2_1_HttpHeaderProperty_Array_CS    *HttpHeaders;                           // This is for setting HTTP
...
RedfishCS_status
CS_To_EventDestination_V1_2_1_JSON (RedfishEventDestination_V1_2_1_EventDestination_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventDestination_V1_2_1_CS (RedfishEventDestination_V1_2_1_EventDestination_CS *CSPtr);

RedfishCS_status
DestroyEventDestination_V1_2_1_Json (RedfishCS_char *JsonText);
