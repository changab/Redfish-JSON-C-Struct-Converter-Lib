...
#include"Redfish_ManagerAccountCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishManagerAccountCollection_ManagerAccountCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ManagerAccountCollection.ManagerAccountCollection
//
RedfishCS_status CS_To_ManagerAccountCollection_JSON(RedfishManagerAccountCollection_ManagerAccountCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ManagerAccountCollection.ManagerAccountCollection
//
RedfishCS_status DestroyManagerAccountCollection_CS(RedfishManagerAccountCollection_ManagerAccountCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ManagerAccountCollection.ManagerAccountCollection
//
RedfishCS_status DestroyManagerAccountCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ManagerAccountCollection.NOVERSIONED.ManagerAccountCollection
//
RedfishCS_status
Json_ManagerAccountCollection_To_CS(RedfishCS_char *JsonRawText, RedfishManagerAccountCollection_ManagerAccountCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManagerAccountCollection_ManagerAccountCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ManagerAccountCollection", "noversioned", "ManagerAccountCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManagerAccountCollection_ManagerAccountCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyManagerAccountCollection_CS (Cs);
  return Status;
}
