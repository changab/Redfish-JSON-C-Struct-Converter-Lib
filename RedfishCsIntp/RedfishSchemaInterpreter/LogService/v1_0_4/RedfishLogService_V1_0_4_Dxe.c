...
//
#include <RedfishInterpreter/LogService/v1_0_4/EfiLogServiceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_4 
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_4 *LogServiceV1_0_4;
  EFI_REDFISH_LOGSERVICE_V1_0_4_CS *LogServiceV1_0_4Cs;
  ...
  Status = Json_LogService_V1_0_4_To_CS (ResoruceRaw, &LogServiceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_4 = (EFI_REDFISH_LOGSERVICE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_4));
  if (LogServiceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogServiceV1_0_4;
  ...
  Length = sizeof (EFI_REDFISH_LOGSERVICE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogService_V1_0_4_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogServiceV1_0_4 = (EFI_REDFISH_LOGSERVICE_V1_0_4 *)InterpProp;
  DestroyLogService_V1_0_4_CS (LogServiceV1_0_4->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogService_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
