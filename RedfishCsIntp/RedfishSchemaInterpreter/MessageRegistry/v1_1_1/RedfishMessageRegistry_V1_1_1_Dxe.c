...
//
#include <RedfishInterpreter/MessageRegistry/v1_1_1/EfiMessageRegistryV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_1_1 
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_1_1 *MessageRegistryV1_1_1;
  EFI_REDFISH_MESSAGEREGISTRY_V1_1_1_CS *MessageRegistryV1_1_1Cs;
  ...
  Status = Json_MessageRegistry_V1_1_1_To_CS (ResoruceRaw, &MessageRegistryV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_1_1 = (EFI_REDFISH_MESSAGEREGISTRY_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_1_1));
  if (MessageRegistryV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryV1_1_1;
  MessageRegistryV1_1_1->MessageRegistry = MessageRegistryV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistry_V1_1_1_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryV1_1_1 = (EFI_REDFISH_MESSAGEREGISTRY_V1_1_1 *)InterpProp;
  DestroyMessageRegistry_V1_1_1_CS (MessageRegistryV1_1_1->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistry_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
