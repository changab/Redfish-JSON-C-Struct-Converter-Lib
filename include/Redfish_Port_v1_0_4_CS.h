...
#ifndef _RedfishPort_V1_0_4_CSTRUCT_H_
#define _RedfishPort_V1_0_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPort_V1_0_4_Actions_CS RedfishPort_V1_0_4_Actions_CS;
typedef struct _RedfishPort_V1_0_4_Links_CS RedfishPort_V1_0_4_Links_CS;
typedef struct _RedfishPort_V1_0_4_OemActions_CS RedfishPort_V1_0_4_OemActions_CS;
typedef struct _RedfishPort_V1_0_4_Port_CS RedfishPort_V1_0_4_Port_CS;
typedef struct _RedfishPort_V1_0_4_Reset_CS RedfishPort_V1_0_4_Reset_CS;
...
typedef struct _RedfishPort_V1_0_4_Actions_CS {
    ...
    RedfishPort_V1_0_4_OemActions_CS    *Oem;          // This property contains the
...
typedef struct _RedfishPort_V1_0_4_Port_CS {
    ...
    RedfishPort_V1_0_4_Actions_CS    *Actions;            // The available actions for this
                                                          // resource.
    RedfishCS_int64                  *CurrentSpeedGbps;    // The current speed of this
                                                          // port.
    RedfishCS_char                   *Description;    
    RedfishCS_char                   *Id;             
    RedfishPort_V1_0_4_Links_CS      *Links;              // Contains references to other
...
RedfishCS_status
Json_Port_V1_0_4_To_CS (char *JsonRawText, RedfishPort_V1_0_4_Port_CS **ReturnedCS);

RedfishCS_status
CS_To_Port_V1_0_4_JSON (RedfishPort_V1_0_4_Port_CS *CSPtr, char **JsonText);
