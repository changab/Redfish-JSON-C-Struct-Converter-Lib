...
//
#include <RedfishInterpreter/ManagerAccount/v1_0_5/EfiManagerAccountV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_5 
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_5 *ManagerAccountV1_0_5;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_5_CS *ManagerAccountV1_0_5Cs;
  ...
  Status = Json_ManagerAccount_V1_0_5_To_CS (ResoruceRaw, &ManagerAccountV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_5 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_5));
  if (ManagerAccountV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerAccountV1_0_5;
  ManagerAccountV1_0_5->ManagerAccount = ManagerAccountV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerAccount_V1_0_5_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerAccountV1_0_5 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_5 *)InterpProp;
  DestroyManagerAccount_V1_0_5_CS (ManagerAccountV1_0_5->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerAccount_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
