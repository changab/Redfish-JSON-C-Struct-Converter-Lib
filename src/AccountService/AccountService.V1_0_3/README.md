# Definition of AccountService.V1_0_3 and functions<br><br>
...
## AccountService
    typedef struct _RedfishAccountService_V1_0_3_AccountService_CS {
    ...
    } RedfishAccountService_V1_0_3_AccountService_CS;
...
## Redfish AccountService V1_0_3 to C Structure Function
    RedfishCS_status
    Json_AccountService_V1_0_3_To_CS (RedfishCS_char *JsonRawText, RedfishAccountService_V1_0_3_AccountService_CS **ReturnedCS);

## C Structure to Redfish AccountService V1_0_3 JSON Function
    RedfishCS_status
    CS_To_AccountService_V1_0_3_JSON (RedfishAccountService_V1_0_3_AccountService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish AccountService V1_0_3 C Structure Function
    RedfishCS_status
    DestroyAccountService_V1_0_3_CS (RedfishAccountService_V1_0_3_AccountService_CS *CSPtr);
