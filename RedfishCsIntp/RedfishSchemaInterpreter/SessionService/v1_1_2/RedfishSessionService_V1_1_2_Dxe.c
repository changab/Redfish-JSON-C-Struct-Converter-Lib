...
//
#include <RedfishInterpreter/SessionService/v1_1_2/EfiSessionServiceV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_1_2 
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_1_2 *SessionServiceV1_1_2;
  EFI_REDFISH_SESSIONSERVICE_V1_1_2_CS *SessionServiceV1_1_2Cs;
  ...
  Status = Json_SessionService_V1_1_2_To_CS (ResoruceRaw, &SessionServiceV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_1_2 = (EFI_REDFISH_SESSIONSERVICE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_2));
  if (SessionServiceV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionServiceV1_1_2;
  SessionServiceV1_1_2->SessionService = SessionServiceV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SessionService_V1_1_2_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionServiceV1_1_2 = (EFI_REDFISH_SESSIONSERVICE_V1_1_2 *)InterpProp;
  DestroySessionService_V1_1_2_CS (SessionServiceV1_1_2->SessionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySessionService_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
