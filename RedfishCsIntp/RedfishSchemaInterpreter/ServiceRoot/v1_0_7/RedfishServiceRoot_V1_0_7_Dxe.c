...
//
#include <RedfishInterpreter/ServiceRoot/v1_0_7/EfiServiceRootV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_0_7 
...
{
  EFI_REDFISH_SERVICEROOT_V1_0_7 *ServiceRootV1_0_7;
  EFI_REDFISH_SERVICEROOT_V1_0_7_CS *ServiceRootV1_0_7Cs;
  ...
  Status = Json_ServiceRoot_V1_0_7_To_CS (ResoruceRaw, &ServiceRootV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_0_7 = (EFI_REDFISH_SERVICEROOT_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_0_7));
  if (ServiceRootV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_0_7;
  ServiceRootV1_0_7->ServiceRoot = ServiceRootV1_0_7Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "7";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_0_7_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ServiceRoot_V1_0_7_JSON (*((EFI_REDFISH_SERVICEROOT_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ServiceRootV1_0_7 = (EFI_REDFISH_SERVICEROOT_V1_0_7 *)InterpProp;
  DestroyServiceRoot_V1_0_7_CS (ServiceRootV1_0_7->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyServiceRoot_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
