...
//
#include <RedfishInterpreter/Assembly/v1_2_0/EfiAssemblyV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#Assembly";
BOOLEAN IsRevisonController = TRUE;

// Support Assembly V1_2_0 
...
{
  EFI_REDFISH_ASSEMBLY_V1_2_0 *AssemblyV1_2_0;
  EFI_REDFISH_ASSEMBLY_V1_2_0_CS *AssemblyV1_2_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Assembly") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Assembly_V1_2_0_To_CS (ResoruceRaw, &AssemblyV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AssemblyV1_2_0 = (EFI_REDFISH_ASSEMBLY_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ASSEMBLY_V1_2_0));
  if (AssemblyV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AssemblyV1_2_0;
  AssemblyV1_2_0->Assembly = AssemblyV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_ASSEMBLY_V1_2_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Assembly"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Assembly");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Assembly"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Assembly");
...
)
{
  ...
  return CS_To_Assembly_V1_2_0_JSON (*((EFI_REDFISH_ASSEMBLY_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in AssemblyToStruct.
...
)
{
  ...
  AssemblyV1_2_0 = (EFI_REDFISH_ASSEMBLY_V1_2_0 *)InterpProp;
  DestroyAssembly_V1_2_0_CS (AssemblyV1_2_0->Assembly); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from AssemblyFromEfiStruct
...
)
{
  ...
  return DestroyAssembly_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAssembly_V1_2_0EntryPoint (
