...
//
#include <RedfishInterpreter/Session/v1_1_1/EfiSessionV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_1_1 
...
{
  EFI_REDFISH_SESSION_V1_1_1 *SessionV1_1_1;
  EFI_REDFISH_SESSION_V1_1_1_CS *SessionV1_1_1Cs;
  ...
  Status = Json_Session_V1_1_1_To_CS (ResoruceRaw, &SessionV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_1_1 = (EFI_REDFISH_SESSION_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_1_1));
  if (SessionV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionV1_1_1;
  SessionV1_1_1->Session = SessionV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_SESSION_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Session_V1_1_1_JSON (*((EFI_REDFISH_SESSION_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionV1_1_1 = (EFI_REDFISH_SESSION_V1_1_1 *)InterpProp;
  DestroySession_V1_1_1_CS (SessionV1_1_1->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySession_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_1_1EntryPoint (
