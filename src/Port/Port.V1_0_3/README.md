# Definition of Port.V1_0_3 and functions<br><br>

## Actions
    typedef struct _RedfishPort_V1_0_3_Actions_CS {
        RedfishPort_V1_0_3_Reset_CS *Port_Reset;
        RedfishPort_V1_0_3_OemActions_CS *Oem;
    } RedfishPort_V1_0_3_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Port_Reset**|RedfishPort_V1_0_3_Reset_CS| Structure points to **#Port.Reset** property.| No| No
|**Oem**|RedfishPort_V1_0_3_OemActions_CS| Structure points to **Oem** property.| No| No


## Links
    typedef struct _RedfishPort_V1_0_3_Links_CS {
...
## OemActions
    typedef struct _RedfishPort_V1_0_3_OemActions_CS {
        RedfishCS_Link Prop;
    } RedfishPort_V1_0_3_OemActions_CS;
...
## Reset
    typedef struct _RedfishPort_V1_0_3_Reset_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishPort_V1_0_3_Reset_CS;
...
## Port
    typedef struct _RedfishPort_V1_0_3_Port_CS {
        RedfishCS_Header     Header;
        RedfishCS_char *odata_context;
        RedfishCS_char *odata_id;
        RedfishCS_char *odata_type;
        RedfishPort_V1_0_3_Actions_CS *Actions;
        RedfishCS_int64 *CurrentSpeedGbps;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishPort_V1_0_3_Links_CS *Links;
...
|**Actions**|RedfishPort_V1_0_3_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishPort_V1_0_3_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Port V1_0_3 to C Structure Function
    RedfishCS_status
    Json_Port_V1_0_3_To_CS (RedfishCS_char *JsonRawText, RedfishPort_V1_0_3_Port_CS **ReturnedCS);

## C Structure to Redfish Port V1_0_3 JSON Function
    RedfishCS_status
    CS_To_Port_V1_0_3_JSON (RedfishPort_V1_0_3_Port_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Port V1_0_3 C Structure Function
    RedfishCS_status
    DestroyPort_V1_0_3_CS (RedfishPort_V1_0_3_Port_CS *CSPtr);
