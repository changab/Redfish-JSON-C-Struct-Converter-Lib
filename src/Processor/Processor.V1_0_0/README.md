# Definition of Processor.V1_0_0 and functions<br><br>

## ProcessorId
    typedef struct _RedfishProcessor_V1_0_0_ProcessorId_CS {
    ...
    } RedfishProcessor_V1_0_0_ProcessorId_CS;
...
## Processor
    typedef struct _RedfishProcessor_V1_0_0_Processor_CS {
...
|**ProcessorId**|RedfishProcessor_V1_0_0_ProcessorId_CS| Structure points to **ProcessorId** property.| No| No
...
## Redfish Processor V1_0_0 to C Structure Function
    RedfishCS_status
    Json_Processor_V1_0_0_To_CS (RedfishCS_char *JsonRawText, RedfishProcessor_V1_0_0_Processor_CS **ReturnedCS);

## C Structure to Redfish Processor V1_0_0 JSON Function
    RedfishCS_status
    CS_To_Processor_V1_0_0_JSON (RedfishProcessor_V1_0_0_Processor_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Processor V1_0_0 C Structure Function
    RedfishCS_status
    DestroyProcessor_V1_0_0_CS (RedfishProcessor_V1_0_0_Processor_CS *CSPtr);
