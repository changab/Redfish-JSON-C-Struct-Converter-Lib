...
//
#include <RedfishInterpreter/PCIeDevice/v1_1_0/EfiPCIeDeviceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_1_0 
...
{
  EFI_REDFISH_PCIEDEVICE_V1_1_0 *PCIeDeviceV1_1_0;
  EFI_REDFISH_PCIEDEVICE_V1_1_0_CS *PCIeDeviceV1_1_0Cs;
  ...
  Status = Json_PCIeDevice_V1_1_0_To_CS (ResoruceRaw, &PCIeDeviceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_1_0 = (EFI_REDFISH_PCIEDEVICE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_1_0));
  if (PCIeDeviceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeDeviceV1_1_0;
  PCIeDeviceV1_1_0->PCIeDevice = PCIeDeviceV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_PCIEDEVICE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeDevice_V1_1_0_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeDeviceV1_1_0 = (EFI_REDFISH_PCIEDEVICE_V1_1_0 *)InterpProp;
  DestroyPCIeDevice_V1_1_0_CS (PCIeDeviceV1_1_0->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeDevice_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
