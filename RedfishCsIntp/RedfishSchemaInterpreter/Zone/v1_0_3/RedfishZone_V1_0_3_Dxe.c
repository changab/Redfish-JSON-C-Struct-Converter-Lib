...
//
#include <RedfishInterpreter/Zone/v1_0_3/EfiZoneV1_0_3.h>
...
{
  EFI_REDFISH_ZONE_V1_0_3 *ZoneV1_0_3;
  EFI_REDFISH_ZONE_V1_0_3_CS *ZoneV1_0_3Cs;
  ...
  Status = Json_Zone_V1_0_3_To_CS (ResoruceRaw, &ZoneV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_0_3 = (EFI_REDFISH_ZONE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_0_3));
  if (ZoneV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ZoneV1_0_3;
  ZoneV1_0_3->Zone = ZoneV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_ZONE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Zone_V1_0_3_JSON (*((EFI_REDFISH_ZONE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ZoneV1_0_3 = (EFI_REDFISH_ZONE_V1_0_3 *)InterpProp;
  DestroyZone_V1_0_3_CS (ZoneV1_0_3->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyZone_V1_0_3_Json (ResoruceRaw);
}
