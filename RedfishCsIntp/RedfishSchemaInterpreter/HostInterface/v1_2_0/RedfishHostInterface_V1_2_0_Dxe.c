...
//
#include <RedfishInterpreter/HostInterface/v1_2_0/EfiHostInterfaceV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_2_0 
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_2_0 *HostInterfaceV1_2_0;
  EFI_REDFISH_HOSTINTERFACE_V1_2_0_CS *HostInterfaceV1_2_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "HostInterface") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_HostInterface_V1_2_0_To_CS (ResoruceRaw, &HostInterfaceV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_2_0 = (EFI_REDFISH_HOSTINTERFACE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_2_0));
  if (HostInterfaceV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)HostInterfaceV1_2_0;
  HostInterfaceV1_2_0->HostInterface = HostInterfaceV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_HOSTINTERFACE_V1_2_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("HostInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "HostInterface");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("HostInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "HostInterface");
...
)
{
  ...
  return CS_To_HostInterface_V1_2_0_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in HostInterfaceToStruct.
...
)
{
  ...
  HostInterfaceV1_2_0 = (EFI_REDFISH_HOSTINTERFACE_V1_2_0 *)InterpProp;
  DestroyHostInterface_V1_2_0_CS (HostInterfaceV1_2_0->HostInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from HostInterfaceFromEfiStruct
...
)
{
  ...
  return DestroyHostInterface_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
