...
//
#include <RedfishInterpreter/HostInterface/v1_0_2/EfiHostInterfaceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_0_2 
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_0_2 *HostInterfaceV1_0_2;
  EFI_REDFISH_HOSTINTERFACE_V1_0_2_CS *HostInterfaceV1_0_2Cs;
  ...
  Status = Json_HostInterface_V1_0_2_To_CS (ResoruceRaw, &HostInterfaceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_0_2 = (EFI_REDFISH_HOSTINTERFACE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_0_2));
  if (HostInterfaceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)HostInterfaceV1_0_2;
  HostInterfaceV1_0_2->HostInterface = HostInterfaceV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_HOSTINTERFACE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_HostInterface_V1_0_2_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  HostInterfaceV1_0_2 = (EFI_REDFISH_HOSTINTERFACE_V1_0_2 *)InterpProp;
  DestroyHostInterface_V1_0_2_CS (HostInterfaceV1_0_2->HostInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyHostInterface_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
