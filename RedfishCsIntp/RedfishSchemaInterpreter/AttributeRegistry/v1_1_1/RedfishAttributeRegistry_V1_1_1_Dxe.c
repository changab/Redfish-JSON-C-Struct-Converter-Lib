...
//
#include <RedfishInterpreter/AttributeRegistry/v1_1_1/EfiAttributeRegistryV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_1_1 
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_1 *AttributeRegistryV1_1_1;
  ...
  Status = Json_AttributeRegistry_V1_1_1_To_CS (ResoruceRaw, &AttributeRegistryV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_1_1 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_1));
  if (AttributeRegistryV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AttributeRegistryV1_1_1;
  ...
  Length = sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AttributeRegistry_V1_1_1_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AttributeRegistryV1_1_1 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_1 *)InterpProp;
  DestroyAttributeRegistry_V1_1_1_CS (AttributeRegistryV1_1_1->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAttributeRegistry_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
