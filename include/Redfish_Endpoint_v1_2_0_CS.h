...
#ifndef _RedfishEndpoint_V1_2_0_CSTRUCT_H_
#define _RedfishEndpoint_V1_2_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEndpoint_V1_2_0_ConnectedEntity_Array_CS RedfishEndpoint_V1_2_0_ConnectedEntity_Array_CS;
typedef struct _RedfishEndpoint_V1_2_0_IPTransportDetails_Array_CS RedfishEndpoint_V1_2_0_IPTransportDetails_Array_CS;
typedef struct _RedfishEndpoint_V1_2_0_Actions_CS RedfishEndpoint_V1_2_0_Actions_CS;
typedef struct _RedfishEndpoint_V1_2_0_ConnectedEntity_CS RedfishEndpoint_V1_2_0_ConnectedEntity_CS;
typedef struct _RedfishEndpoint_V1_2_0_Endpoint_CS RedfishEndpoint_V1_2_0_Endpoint_CS;
typedef struct _RedfishEndpoint_V1_2_0_IPTransportDetails_CS RedfishEndpoint_V1_2_0_IPTransportDetails_CS;
typedef struct _RedfishEndpoint_V1_2_0_Links_CS RedfishEndpoint_V1_2_0_Links_CS;
typedef struct _RedfishEndpoint_V1_2_0_OemActions_CS RedfishEndpoint_V1_2_0_OemActions_CS;
typedef struct _RedfishEndpoint_V1_2_0_PciId_CS RedfishEndpoint_V1_2_0_PciId_CS;
...
typedef struct _RedfishEndpoint_V1_2_0_Actions_CS {
    RedfishEndpoint_V1_2_0_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishEndpoint_V1_2_0_ConnectedEntity_CS {
    RedfishCS_Link                     EntityLink;           // A link to the associated
                                                             // entity.
    RedfishEndpoint_V1_2_0_PciId_CS    *EntityPciId;         // The PCI ID of the connected
                                                             // entity.
...
typedef struct _RedfishEndpoint_V1_2_0_Endpoint_CS {
    ...
    RedfishEndpoint_V1_2_0_Actions_CS                     *Actions;                      // The available actions for this
                                                                                         // resource.
    RedfishEndpoint_V1_2_0_ConnectedEntity_Array_CS       *ConnectedEntities;            // All the entities connected to
                                                                                         // this endpoint.
    ...
    RedfishEndpoint_V1_2_0_IPTransportDetails_Array_CS    *IPTransportDetails;           // This array contains details
    ...
    RedfishEndpoint_V1_2_0_Links_CS                       *Links;                        // The links object contains the
    ...
    RedfishResource_Oem_CS                                *Oem;                          // This is the
                                                                                         ...
                                                                                         // sections.
    RedfishEndpoint_V1_2_0_PciId_CS                       *PciId;                        // The PCI ID of the endpoint.
...
typedef struct _RedfishEndpoint_V1_2_0_ConnectedEntity_Array_CS  {
    RedfishEndpoint_V1_2_0_ConnectedEntity_Array_CS    *Next;
    RedfishEndpoint_V1_2_0_ConnectedEntity_CS    *ArrayValue;
} RedfishEndpoint_V1_2_0_ConnectedEntity_Array_CS;

typedef struct _RedfishEndpoint_V1_2_0_IPTransportDetails_Array_CS  {
    RedfishEndpoint_V1_2_0_IPTransportDetails_Array_CS    *Next;
    RedfishEndpoint_V1_2_0_IPTransportDetails_CS    *ArrayValue;
} RedfishEndpoint_V1_2_0_IPTransportDetails_Array_CS;

RedfishCS_status
Json_Endpoint_V1_2_0_To_CS (char *JsonRawText, RedfishEndpoint_V1_2_0_Endpoint_CS **ReturnedCS);

RedfishCS_status
CS_To_Endpoint_V1_2_0_JSON (RedfishEndpoint_V1_2_0_Endpoint_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEndpoint_V1_2_0_CS (RedfishEndpoint_V1_2_0_Endpoint_CS *CSPtr);

RedfishCS_status
DestroyEndpoint_V1_2_0_Json (RedfishCS_char *JsonText);
