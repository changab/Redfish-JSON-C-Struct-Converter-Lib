# Definition of PCIeFunction.V1_1_2 and functions<br><br>

## Actions
    typedef struct _RedfishPCIeFunction_V1_1_2_Actions_CS {
        RedfishPCIeFunction_V1_1_2_OemActions_CS *Oem;
    } RedfishPCIeFunction_V1_1_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishPCIeFunction_V1_1_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## PCIeFunction
    typedef struct _RedfishPCIeFunction_V1_1_2_PCIeFunction_CS {
        ...
        RedfishPCIeFunction_V1_1_2_Actions_CS *Actions;
        ...
        RedfishCS_char *Id;
        RedfishPCIeFunction_V1_1_2_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Actions**|RedfishPCIeFunction_V1_1_2_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishPCIeFunction_V1_1_2_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish PCIeFunction V1_1_2 to C Structure Function
    RedfishCS_status
    Json_PCIeFunction_V1_1_2_To_CS (RedfishCS_char *JsonRawText, RedfishPCIeFunction_V1_1_2_PCIeFunction_CS **ReturnedCS);

## C Structure to Redfish PCIeFunction V1_1_2 JSON Function
    RedfishCS_status
    CS_To_PCIeFunction_V1_1_2_JSON (RedfishPCIeFunction_V1_1_2_PCIeFunction_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish PCIeFunction V1_1_2 C Structure Function
    RedfishCS_status
