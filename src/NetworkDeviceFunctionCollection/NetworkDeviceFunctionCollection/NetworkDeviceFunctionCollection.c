...
#include"Redfish_NetworkDeviceFunctionCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishNetworkDeviceFunctionCollection_NetworkDeviceFunctionCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for NetworkDeviceFunctionCollection.NetworkDeviceFunctionCollection
//
RedfishCS_status CS_To_NetworkDeviceFunctionCollection_JSON(RedfishNetworkDeviceFunctionCollection_NetworkDeviceFunctionCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Members 
  if (InsertJsonLinkObj (CsJson, "Members", &CSPtr->Members) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for NetworkDeviceFunctionCollection.NetworkDeviceFunctionCollection
//
RedfishCS_status DestroyNetworkDeviceFunctionCollection_CS(RedfishNetworkDeviceFunctionCollection_NetworkDeviceFunctionCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkDeviceFunctionCollection.NetworkDeviceFunctionCollection
//
RedfishCS_status DestroyNetworkDeviceFunctionCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkDeviceFunctionCollection.NOVERSIONED.NetworkDeviceFunctionCollection
//
RedfishCS_status
Json_NetworkDeviceFunctionCollection_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkDeviceFunctionCollection_NetworkDeviceFunctionCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkDeviceFunctionCollection_NetworkDeviceFunctionCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkDeviceFunctionCollection", "noversioned", "NetworkDeviceFunctionCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkDeviceFunctionCollection_NetworkDeviceFunctionCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Members", Cs->Header.ThisUri, &Cs->Members);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){goto Error;}}
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkDeviceFunctionCollection_CS (Cs);
  return Status;
}
