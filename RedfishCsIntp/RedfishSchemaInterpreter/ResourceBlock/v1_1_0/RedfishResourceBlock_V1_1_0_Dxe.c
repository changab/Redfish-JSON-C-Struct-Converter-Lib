...
//
#include <RedfishInterpreter/ResourceBlock/v1_1_0/EfiResourceBlockV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_1_0 
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_1_0 *ResourceBlockV1_1_0;
  EFI_REDFISH_RESOURCEBLOCK_V1_1_0_CS *ResourceBlockV1_1_0Cs;
  ...
  Status = Json_ResourceBlock_V1_1_0_To_CS (ResoruceRaw, &ResourceBlockV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_1_0 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_1_0));
  if (ResourceBlockV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ResourceBlockV1_1_0;
  ResourceBlockV1_1_0->ResourceBlock = ResourceBlockV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ResourceBlock_V1_1_0_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ResourceBlockV1_1_0 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_0 *)InterpProp;
  DestroyResourceBlock_V1_1_0_CS (ResourceBlockV1_1_0->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyResourceBlock_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
