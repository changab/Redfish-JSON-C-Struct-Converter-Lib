...
//
#include <RedfishInterpreter/Assembly/v1_0_1/EfiAssemblyV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Assembly";
BOOLEAN IsRevisonController = TRUE;

// Support Assembly V1_0_1 
...
{
  EFI_REDFISH_ASSEMBLY_V1_0_1 *AssemblyV1_0_1;
  EFI_REDFISH_ASSEMBLY_V1_0_1_CS *AssemblyV1_0_1Cs;
  ...
  Status = Json_Assembly_V1_0_1_To_CS (ResoruceRaw, &AssemblyV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AssemblyV1_0_1 = (EFI_REDFISH_ASSEMBLY_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ASSEMBLY_V1_0_1));
  if (AssemblyV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AssemblyV1_0_1;
  AssemblyV1_0_1->Assembly = AssemblyV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ASSEMBLY_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Assembly_V1_0_1_JSON (*((EFI_REDFISH_ASSEMBLY_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AssemblyV1_0_1 = (EFI_REDFISH_ASSEMBLY_V1_0_1 *)InterpProp;
  DestroyAssembly_V1_0_1_CS (AssemblyV1_0_1->Assembly); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAssembly_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAssembly_V1_0_1EntryPoint (
