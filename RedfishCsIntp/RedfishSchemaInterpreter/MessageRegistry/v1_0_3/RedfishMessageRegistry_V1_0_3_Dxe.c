...
//
#include <RedfishInterpreter/MessageRegistry/v1_0_3/EfiMessageRegistryV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_0_3 
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_3 *MessageRegistryV1_0_3;
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_3_CS *MessageRegistryV1_0_3Cs;
  ...
  Status = Json_MessageRegistry_V1_0_3_To_CS (ResoruceRaw, &MessageRegistryV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_0_3 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_3));
  if (MessageRegistryV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryV1_0_3;
  MessageRegistryV1_0_3->MessageRegistry = MessageRegistryV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistry_V1_0_3_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryV1_0_3 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_3 *)InterpProp;
  DestroyMessageRegistry_V1_0_3_CS (MessageRegistryV1_0_3->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistry_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
