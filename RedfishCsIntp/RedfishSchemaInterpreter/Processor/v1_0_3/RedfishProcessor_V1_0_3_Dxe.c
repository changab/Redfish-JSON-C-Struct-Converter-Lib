...
//
#include <RedfishInterpreter/Processor/v1_0_3/EfiProcessorV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_0_3 
...
{
  EFI_REDFISH_PROCESSOR_V1_0_3 *ProcessorV1_0_3;
  EFI_REDFISH_PROCESSOR_V1_0_3_CS *ProcessorV1_0_3Cs;
  ...
  Status = Json_Processor_V1_0_3_To_CS (ResoruceRaw, &ProcessorV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_0_3 = (EFI_REDFISH_PROCESSOR_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_0_3));
  if (ProcessorV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ProcessorV1_0_3;
  ProcessorV1_0_3->Processor = ProcessorV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_PROCESSOR_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Processor_V1_0_3_JSON (*((EFI_REDFISH_PROCESSOR_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ProcessorV1_0_3 = (EFI_REDFISH_PROCESSOR_V1_0_3 *)InterpProp;
  DestroyProcessor_V1_0_3_CS (ProcessorV1_0_3->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyProcessor_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_3EntryPoint (
