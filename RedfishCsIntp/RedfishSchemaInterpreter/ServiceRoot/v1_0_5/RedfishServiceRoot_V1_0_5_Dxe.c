...
//
#include <RedfishInterpreter/ServiceRoot/v1_0_5/EfiServiceRootV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_0_5 
...
{
  EFI_REDFISH_SERVICEROOT_V1_0_5 *ServiceRootV1_0_5;
  EFI_REDFISH_SERVICEROOT_V1_0_5_CS *ServiceRootV1_0_5Cs;
  ...
  Status = Json_ServiceRoot_V1_0_5_To_CS (ResoruceRaw, &ServiceRootV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_0_5 = (EFI_REDFISH_SERVICEROOT_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_0_5));
  if (ServiceRootV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ServiceRootV1_0_5;
  ServiceRootV1_0_5->ServiceRoot = ServiceRootV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_SERVICEROOT_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ServiceRoot_V1_0_5_JSON (*((EFI_REDFISH_SERVICEROOT_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ServiceRootV1_0_5 = (EFI_REDFISH_SERVICEROOT_V1_0_5 *)InterpProp;
  DestroyServiceRoot_V1_0_5_CS (ServiceRootV1_0_5->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyServiceRoot_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
