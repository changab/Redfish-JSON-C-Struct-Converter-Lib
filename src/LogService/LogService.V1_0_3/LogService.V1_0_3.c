...
#include"Redfish_LogService_v1_0_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishLogService_V1_0_3_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #LogService.ClearLog
//
static RedfishCS_status GenClearLogCs(RedfishLogService_V1_0_3_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_0_3_ClearLog_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_0_3_ClearLog_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActions_OemCs(RedfishLogService_V1_0_3_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_0_3_LogService_Actions_Oem_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_0_3_LogService_Actions_Oem_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishLogService_V1_0_3_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_0_3_LogService_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_0_3_LogService_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #LogService.ClearLog
...
//
static RedfishCS_status GenStatusCs(RedfishLogService_V1_0_3_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsLogService_ClearLog(json_t *CsJson, char *Key, RedfishLogService_V1_0_3_ClearLog_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishLogService_V1_0_3_LogService_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishLogService_V1_0_3_LogService_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for LogService.V1_0_3.LogService
//
RedfishCS_status CS_To_LogService_V1_0_3_JSON(RedfishLogService_V1_0_3_LogService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for LogService.V1_0_3.LogService
//
RedfishCS_status DestroyLogService_V1_0_3_CS(RedfishLogService_V1_0_3_LogService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for LogService.V1_0_3.LogService
//
RedfishCS_status DestroyLogService_V1_0_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for LogService.V1_0_3.LogService
//
RedfishCS_status
Json_LogService_V1_0_3_To_CS(RedfishCS_char *JsonRawText, RedfishLogService_V1_0_3_LogService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishLogService_V1_0_3_LogService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "LogService", "v1_0_3", "LogService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishLogService_V1_0_3_LogService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyLogService_V1_0_3_CS (Cs);
  return Status;
}
