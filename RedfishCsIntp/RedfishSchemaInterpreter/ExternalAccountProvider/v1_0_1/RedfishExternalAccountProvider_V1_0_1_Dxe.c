/** @file
  ...
  Redfish schema.
   - ExternalAccountProvider.v1_0_1 
...
//
#include <RedfishInterpreter/ExternalAccountProvider/v1_0_1/EfiExternalAccountProviderV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#ExternalAccountProvider";
BOOLEAN IsRevisonController = TRUE;

// Support ExternalAccountProvider V1_0_1 
...
{
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_1 *ExternalAccountProviderV1_0_1;
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_1_CS *ExternalAccountProviderV1_0_1Cs;
  ...
  Status = Json_ExternalAccountProvider_V1_0_1_To_CS (ResoruceRaw, &ExternalAccountProviderV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ExternalAccountProviderV1_0_1 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_1));
  if (ExternalAccountProviderV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ExternalAccountProviderV1_0_1;
  ExternalAccountProviderV1_0_1->ExternalAccountProvider = ExternalAccountProviderV1_0_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ExternalAccountProvider_V1_0_1_JSON (*((EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ExternalAccountProviderV1_0_1 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_1 *)InterpProp;
  DestroyExternalAccountProvider_V1_0_1_CS (ExternalAccountProviderV1_0_1->ExternalAccountProvider); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyExternalAccountProvider_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
