...
#ifndef _RedfishVolume_V1_0_0_CSTRUCT_H_
#define _RedfishVolume_V1_0_0_CSTRUCT_H_
...
typedef struct _RedfishVolume_V1_0_0_Initialize_CS RedfishVolume_V1_0_0_Initialize_CS;
typedef struct _RedfishVolume_V1_0_0_Operations_CS RedfishVolume_V1_0_0_Operations_CS;
typedef struct _RedfishVolume_V1_0_0_Volume_CS RedfishVolume_V1_0_0_Volume_CS;
typedef struct _RedfishVolume_V1_0_0_Volume_Actions_CS RedfishVolume_V1_0_0_Volume_Actions_CS;
typedef struct _RedfishVolume_V1_0_0_Volume_Actions_Oem_CS RedfishVolume_V1_0_0_Volume_Actions_Oem_CS;
typedef struct _RedfishVolume_V1_0_0_Volume_Links_CS RedfishVolume_V1_0_0_Volume_Links_CS;
//
...
typedef struct _RedfishVolume_V1_0_0_Volume_CS {
    ...
    RedfishVolume_V1_0_0_Volume_Actions_CS    *Actions;              // The available actions for this
                                                                     // resource.
    ...
    RedfishResource_V1_1_0_Identifier_CS      *Identifiers;          // The Durable names for the
                                                                     // volume
    RedfishVolume_V1_0_0_Volume_Links_CS      *Links;                // Contains references to other
    ...
    RedfishResource_Oem_CS                    *Oem;                  // This is the
                                                                     ...
                                                                     // sections.
    RedfishVolume_V1_0_0_Operations_CS        *Operations;           // The operations currently
                                                                     // running on the Volume
    RedfishCS_int64                           *OptimumIOSizeBytes;    // The size in bytes of this
                                                                     // Volume's optimum IO size.
    RedfishResource_Status_CS                 *Status;           
    RedfishCS_char                            *VolumeType;           // Is this drive currently
                                                                     // predicting a failure in the
                                                                     // near future
} RedfishVolume_V1_0_0_Volume_CS;

RedfishCS_status
Json_Volume_V1_0_0_To_CS (char *JsonRawText, RedfishVolume_V1_0_0_Volume_CS **ReturnedCS);

RedfishCS_status
CS_To_Volume_V1_0_0_JSON (RedfishVolume_V1_0_0_Volume_CS *CSPtr, char **JsonText);
