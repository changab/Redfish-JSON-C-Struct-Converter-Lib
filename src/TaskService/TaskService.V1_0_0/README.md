# Definition of TaskService.V1_0_0 and functions<br><br>
...
## Redfish TaskService V1_0_0 to C Structure Function
    RedfishCS_status
    Json_TaskService_V1_0_0_To_CS (RedfishCS_char *JsonRawText, RedfishTaskService_V1_0_0_TaskService_CS **ReturnedCS);

## C Structure to Redfish TaskService V1_0_0 JSON Function
    RedfishCS_status
    CS_To_TaskService_V1_0_0_JSON (RedfishTaskService_V1_0_0_TaskService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish TaskService V1_0_0 C Structure Function
    RedfishCS_status
