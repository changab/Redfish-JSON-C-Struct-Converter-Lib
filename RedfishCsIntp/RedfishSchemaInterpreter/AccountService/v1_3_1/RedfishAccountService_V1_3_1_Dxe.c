...
//
#include <RedfishInterpreter/AccountService/v1_3_1/EfiAccountServiceV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_3_1 
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_3_1 *AccountServiceV1_3_1;
  EFI_REDFISH_ACCOUNTSERVICE_V1_3_1_CS *AccountServiceV1_3_1Cs;
  ...
  Status = Json_AccountService_V1_3_1_To_CS (ResoruceRaw, &AccountServiceV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_3_1 = (EFI_REDFISH_ACCOUNTSERVICE_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_3_1));
  if (AccountServiceV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AccountServiceV1_3_1;
  AccountServiceV1_3_1->AccountService = AccountServiceV1_3_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_3_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AccountService_V1_3_1_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AccountServiceV1_3_1 = (EFI_REDFISH_ACCOUNTSERVICE_V1_3_1 *)InterpProp;
  DestroyAccountService_V1_3_1_CS (AccountServiceV1_3_1->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAccountService_V1_3_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_3_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_3_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
