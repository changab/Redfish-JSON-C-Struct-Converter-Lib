...
//
#include <RedfishInterpreter/SessionService/v1_1_3/EfiSessionServiceV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_1_3 
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_1_3 *SessionServiceV1_1_3;
  EFI_REDFISH_SESSIONSERVICE_V1_1_3_CS *SessionServiceV1_1_3Cs;
  ...
  Status = Json_SessionService_V1_1_3_To_CS (ResoruceRaw, &SessionServiceV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_1_3 = (EFI_REDFISH_SESSIONSERVICE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_3));
  if (SessionServiceV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionServiceV1_1_3;
  SessionServiceV1_1_3->SessionService = SessionServiceV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SessionService_V1_1_3_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionServiceV1_1_3 = (EFI_REDFISH_SESSIONSERVICE_V1_1_3 *)InterpProp;
  DestroySessionService_V1_1_3_CS (SessionServiceV1_1_3->SessionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySessionService_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
