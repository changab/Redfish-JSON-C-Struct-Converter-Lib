...
#ifndef _RedfishEndpoint_V1_0_2_CSTRUCT_H_
#define _RedfishEndpoint_V1_0_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishEndpoint_V1_0_2_ConnectedEntity_Array_CS RedfishEndpoint_V1_0_2_ConnectedEntity_Array_CS;
typedef struct _RedfishEndpoint_V1_0_2_ConnectedEntity_CS RedfishEndpoint_V1_0_2_ConnectedEntity_CS;
typedef struct _RedfishEndpoint_V1_0_2_Endpoint_CS RedfishEndpoint_V1_0_2_Endpoint_CS;
typedef struct _RedfishEndpoint_V1_0_2_Endpoint_Actions_CS RedfishEndpoint_V1_0_2_Endpoint_Actions_CS;
typedef struct _RedfishEndpoint_V1_0_2_Endpoint_Links_CS RedfishEndpoint_V1_0_2_Endpoint_Links_CS;
typedef struct _RedfishEndpoint_V1_0_2_PciId_CS RedfishEndpoint_V1_0_2_PciId_CS;
...
// this endpoint.
//
typedef struct _RedfishEndpoint_V1_0_2_ConnectedEntity_CS {
    RedfishCS_Link                                EntityLink;           // A link to the associated
                                                                        // entity.
    RedfishEndpoint_V1_0_2_PciId_CS               *EntityPciId;         // The PCI ID of the connected
                                                                        // entity.
    ...
    RedfishCS_int64                               *PciFunctionNumber;    // The PCI ID of the connected
                                                                        // entity.
} RedfishEndpoint_V1_0_2_ConnectedEntity_CS;

//
// The Actions object contains the available custom actions on this resource.
//
typedef struct _RedfishEndpoint_V1_0_2_Endpoint_Actions_CS {
    RedfishCS_Link    Oem;    // The available OEM specific
                             // actions for this resource.
} RedfishEndpoint_V1_0_2_Endpoint_Actions_CS;

//
// The links object contains the links to other resources that are related to this
// resource.
//
typedef struct _RedfishEndpoint_V1_0_2_Endpoint_Links_CS {
...
} RedfishEndpoint_V1_0_2_Endpoint_Links_CS;

//
// A PCI ID.
//
typedef struct _RedfishEndpoint_V1_0_2_PciId_CS {
    ...
    RedfishCS_char    *VendorId;            // The Vendor ID of this PCIe
                                            // function.
} RedfishEndpoint_V1_0_2_PciId_CS;
...
// transport.
//
typedef struct _RedfishEndpoint_V1_0_2_Endpoint_CS {
    RedfishCS_Header                                   Header;
    RedfishCS_char                                     *odata_context;                
    RedfishCS_char                                     *odata_id;                     
    RedfishCS_char                                     *odata_type;                   
    RedfishEndpoint_V1_0_2_Endpoint_Actions_CS         *Actions;                          // The Actions object contains
                                                                                          // the available custom actions
                                                                                          // on this resource.
    RedfishEndpoint_V1_0_2_ConnectedEntity_Array_CS    *ConnectedEntities;                // All the entities connected to
                                                                                          // this endpoint.
    ...
    RedfishEndpoint_V1_0_2_Endpoint_Links_CS           *Links;                            // The links object contains the
    ...
    RedfishResource_Oem_CS                             *Oem;                              // This is the
                                                                                          ...
                                                                                          // sections.
    RedfishEndpoint_V1_0_2_PciId_CS                    *PciId;                            // The PCI ID of the endpoint.
...
} RedfishEndpoint_V1_0_2_Endpoint_CS;
...
typedef struct _RedfishEndpoint_V1_0_2_ConnectedEntity_Array_CS  {
    RedfishEndpoint_V1_0_2_ConnectedEntity_Array_CS    *Next;
    RedfishEndpoint_V1_0_2_ConnectedEntity_CS    *ArrayValue;
} RedfishEndpoint_V1_0_2_ConnectedEntity_Array_CS;

RedfishCS_status
Json_Endpoint_V1_0_2_To_CS (char *JsonRawText, RedfishEndpoint_V1_0_2_Endpoint_CS **ReturnedCS);

RedfishCS_status
CS_To_Endpoint_V1_0_2_JSON (RedfishEndpoint_V1_0_2_Endpoint_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEndpoint_V1_0_2_CS (RedfishEndpoint_V1_0_2_Endpoint_CS *CSPtr);
