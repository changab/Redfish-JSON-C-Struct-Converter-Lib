...
//
#include <RedfishInterpreter/ManagerAccount/v1_1_1/EfiManagerAccountV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_1_1 
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_1_1 *ManagerAccountV1_1_1;
  EFI_REDFISH_MANAGERACCOUNT_V1_1_1_CS *ManagerAccountV1_1_1Cs;
  ...
  Status = Json_ManagerAccount_V1_1_1_To_CS (ResoruceRaw, &ManagerAccountV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_1_1 = (EFI_REDFISH_MANAGERACCOUNT_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_1_1));
  if (ManagerAccountV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerAccountV1_1_1;
  ManagerAccountV1_1_1->ManagerAccount = ManagerAccountV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerAccount_V1_1_1_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerAccountV1_1_1 = (EFI_REDFISH_MANAGERACCOUNT_V1_1_1 *)InterpProp;
  DestroyManagerAccount_V1_1_1_CS (ManagerAccountV1_1_1->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerAccount_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
