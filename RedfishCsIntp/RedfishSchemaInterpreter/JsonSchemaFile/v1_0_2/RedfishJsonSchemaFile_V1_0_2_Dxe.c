...
//
#include <RedfishInterpreter/JsonSchemaFile/v1_0_2/EfiJsonSchemaFileV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_0_2 
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_2 *JsonSchemaFileV1_0_2;
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_2_CS *JsonSchemaFileV1_0_2Cs;
  ...
  Status = Json_JsonSchemaFile_V1_0_2_To_CS (ResoruceRaw, &JsonSchemaFileV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_0_2 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_2));
  if (JsonSchemaFileV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)JsonSchemaFileV1_0_2;
  JsonSchemaFileV1_0_2->JsonSchemaFile = JsonSchemaFileV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_JsonSchemaFile_V1_0_2_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  JsonSchemaFileV1_0_2 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_2 *)InterpProp;
  DestroyJsonSchemaFile_V1_0_2_CS (JsonSchemaFileV1_0_2->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyJsonSchemaFile_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
