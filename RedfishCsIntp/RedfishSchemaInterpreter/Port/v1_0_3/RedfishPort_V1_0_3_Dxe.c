...
//
#include <RedfishInterpreter/Port/v1_0_3/EfiPortV1_0_3.h>
...
{
  EFI_REDFISH_PORT_V1_0_3 *PortV1_0_3;
  EFI_REDFISH_PORT_V1_0_3_CS *PortV1_0_3Cs;
  ...
  Status = Json_Port_V1_0_3_To_CS (ResoruceRaw, &PortV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_0_3 = (EFI_REDFISH_PORT_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_0_3));
  if (PortV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PortV1_0_3;
  PortV1_0_3->Port = PortV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_PORT_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Port_V1_0_3_JSON (*((EFI_REDFISH_PORT_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PortV1_0_3 = (EFI_REDFISH_PORT_V1_0_3 *)InterpProp;
  DestroyPort_V1_0_3_CS (PortV1_0_3->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPort_V1_0_3_Json (ResoruceRaw);
}
