...
//
#include <RedfishInterpreter/EventDestination/v1_1_2/EfiEventDestinationV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_1_2 
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_1_2 *EventDestinationV1_1_2;
  EFI_REDFISH_EVENTDESTINATION_V1_1_2_CS *EventDestinationV1_1_2Cs;
  ...
  Status = Json_EventDestination_V1_1_2_To_CS (ResoruceRaw, &EventDestinationV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_1_2 = (EFI_REDFISH_EVENTDESTINATION_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_1_2));
  if (EventDestinationV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventDestinationV1_1_2;
  EventDestinationV1_1_2->EventDestination = EventDestinationV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_EVENTDESTINATION_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventDestination_V1_1_2_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventDestinationV1_1_2 = (EFI_REDFISH_EVENTDESTINATION_V1_1_2 *)InterpProp;
  DestroyEventDestination_V1_1_2_CS (EventDestinationV1_1_2->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventDestination_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
