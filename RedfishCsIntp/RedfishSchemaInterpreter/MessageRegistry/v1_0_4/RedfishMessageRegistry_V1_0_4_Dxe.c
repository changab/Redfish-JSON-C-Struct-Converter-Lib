...
//
#include <RedfishInterpreter/MessageRegistry/v1_0_4/EfiMessageRegistryV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_0_4 
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_4 *MessageRegistryV1_0_4;
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_4_CS *MessageRegistryV1_0_4Cs;
  ...
  Status = Json_MessageRegistry_V1_0_4_To_CS (ResoruceRaw, &MessageRegistryV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_0_4 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_4));
  if (MessageRegistryV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryV1_0_4;
  MessageRegistryV1_0_4->MessageRegistry = MessageRegistryV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistry_V1_0_4_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryV1_0_4 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_4 *)InterpProp;
  DestroyMessageRegistry_V1_0_4_CS (MessageRegistryV1_0_4->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistry_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
