...
//
#include <RedfishInterpreter/Port/v1_0_2/EfiPortV1_0_2.h>
...
{
  EFI_REDFISH_PORT_V1_0_2 *PortV1_0_2;
  EFI_REDFISH_PORT_V1_0_2_CS *PortV1_0_2Cs;
  ...
  Status = Json_Port_V1_0_2_To_CS (ResoruceRaw, &PortV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_0_2 = (EFI_REDFISH_PORT_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_0_2));
  if (PortV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PortV1_0_2;
  PortV1_0_2->Port = PortV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_PORT_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Port_V1_0_2_JSON (*((EFI_REDFISH_PORT_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PortV1_0_2 = (EFI_REDFISH_PORT_V1_0_2 *)InterpProp;
  DestroyPort_V1_0_2_CS (PortV1_0_2->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPort_V1_0_2_Json (ResoruceRaw);
}
