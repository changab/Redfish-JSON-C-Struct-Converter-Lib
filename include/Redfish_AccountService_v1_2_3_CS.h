...
#ifndef _RedfishAccountservice_V1_2_3_CSTRUCT_H_
#define _RedfishAccountservice_V1_2_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAccountService_V1_2_3_AccountService_CS RedfishAccountService_V1_2_3_AccountService_CS;
typedef struct _RedfishAccountService_V1_2_3_Actions_CS RedfishAccountService_V1_2_3_Actions_CS;
typedef struct _RedfishAccountService_V1_2_3_OemActions_CS RedfishAccountService_V1_2_3_OemActions_CS;
...
typedef struct _RedfishAccountService_V1_2_3_Actions_CS {
    RedfishAccountService_V1_2_3_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishAccountService_V1_2_3_AccountService_CS {
    ...
    RedfishCS_Link                             Accounts;                           // A link to a collection of
                                                                                   // Manager Accounts.
    RedfishAccountService_V1_2_3_Actions_CS    *Actions;                           // The available actions for this
                                                                                   // resource.
...
RedfishCS_status
Json_AccountService_V1_2_3_To_CS (char *JsonRawText, RedfishAccountService_V1_2_3_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_2_3_JSON (RedfishAccountService_V1_2_3_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_2_3_CS (RedfishAccountService_V1_2_3_AccountService_CS *CSPtr);

RedfishCS_status
DestroyAccountService_V1_2_3_Json (RedfishCS_char *JsonText);
