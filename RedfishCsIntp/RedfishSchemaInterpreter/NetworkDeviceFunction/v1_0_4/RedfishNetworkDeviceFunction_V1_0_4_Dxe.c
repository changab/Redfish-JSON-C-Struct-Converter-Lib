...
//
#include <RedfishInterpreter/NetworkDeviceFunction/v1_0_4/EfiNetworkDeviceFunctionV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_0_4 
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_4 *NetworkDeviceFunctionV1_0_4;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_4_CS *NetworkDeviceFunctionV1_0_4Cs;
  ...
  Status = Json_NetworkDeviceFunction_V1_0_4_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_0_4 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_4));
  if (NetworkDeviceFunctionV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkDeviceFunctionV1_0_4;
  NetworkDeviceFunctionV1_0_4->NetworkDeviceFunction = NetworkDeviceFunctionV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkDeviceFunction_V1_0_4_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkDeviceFunctionV1_0_4 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_4 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_0_4_CS (NetworkDeviceFunctionV1_0_4->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkDeviceFunction_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
