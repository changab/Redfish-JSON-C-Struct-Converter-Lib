...
//
#include <RedfishInterpreter/Power/v1_2_0/EfiPowerV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_2_0 
...
{
  EFI_REDFISH_POWER_V1_2_0 *PowerV1_2_0;
  EFI_REDFISH_POWER_V1_2_0_CS *PowerV1_2_0Cs;
  ...
  Status = Json_Power_V1_2_0_To_CS (ResoruceRaw, &PowerV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_2_0 = (EFI_REDFISH_POWER_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_2_0));
  if (PowerV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_2_0;
  PowerV1_2_0->Power = PowerV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_POWER_V1_2_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_2_0_JSON (*((EFI_REDFISH_POWER_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_2_0 = (EFI_REDFISH_POWER_V1_2_0 *)InterpProp;
  DestroyPower_V1_2_0_CS (PowerV1_2_0->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_2_0_Json (ResoruceRaw);
}
