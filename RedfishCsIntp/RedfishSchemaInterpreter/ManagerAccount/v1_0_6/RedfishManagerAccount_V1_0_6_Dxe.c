...
//
#include <RedfishInterpreter/ManagerAccount/v1_0_6/EfiManagerAccountV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_6 
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_6 *ManagerAccountV1_0_6;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_6_CS *ManagerAccountV1_0_6Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ManagerAccount") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_ManagerAccount_V1_0_6_To_CS (ResoruceRaw, &ManagerAccountV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_6 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_6));
  if (ManagerAccountV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerAccountV1_0_6;
  ManagerAccountV1_0_6->ManagerAccount = ManagerAccountV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_6_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerAccount"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "ManagerAccount");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerAccount"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "ManagerAccount");
...
)
{
  ...
  return CS_To_ManagerAccount_V1_0_6_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ManagerAccountToStruct.
...
EFI_STATUS
EFIAPI
ManagerAccountDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  ManagerAccountV1_0_6 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_6 *)InterpProp;
  DestroyManagerAccount_V1_0_6_CS (ManagerAccountV1_0_6->ManagerAccount); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ManagerAccountFromEfiStruct
...
)
{
  ...
  return DestroyManagerAccount_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
