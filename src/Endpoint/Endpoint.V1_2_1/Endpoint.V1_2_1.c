...
#include"Redfish_Endpoint_v1_2_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenPciIdCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_1_PciId_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpoint_V1_2_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpoint_V1_2_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenPciIdCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_1_PciId_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpoint_V1_2_1_PciId_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ClassCode
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "ClassCode", &(*Dst)->ClassCode);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // FunctionNumber
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "FunctionNumber", &(*Dst)->FunctionNumber);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenConnectedEntity_Array_ElementCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEndpoint_V1_2_1_ConnectedEntity_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEndpoint_V1_2_1_ConnectedEntity_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EntityLink
...
//
//Generate C structure for RedfishEndpoint_V1_2_1_ConnectedEntity_Array_CS
//
static RedfishCS_status GenConnectedEntity_ArrayCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_1_ConnectedEntity_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEndpoint_V1_2_1_ConnectedEntity_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEndpoint_V1_2_1_ConnectedEntity_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenIPTransportDetails_Array_ElementCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEndpoint_V1_2_1_IPTransportDetails_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEndpoint_V1_2_1_IPTransportDetails_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // IPv4Address
  InitializeLinkHead (&(*Dst)->IPv4Address);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "IPv4Address", Cs->Header.ThisUri, &(*Dst)->IPv4Address);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // IPv6Address
  InitializeLinkHead (&(*Dst)->IPv6Address);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "IPv6Address", Cs->Header.ThisUri, &(*Dst)->IPv6Address);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // TransportProtocol
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "TransportProtocol", &(*Dst)->TransportProtocol);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishEndpoint_V1_2_1_IPTransportDetails_Array_CS
//
static RedfishCS_status GenIPTransportDetails_ArrayCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_1_IPTransportDetails_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEndpoint_V1_2_1_IPTransportDetails_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEndpoint_V1_2_1_IPTransportDetails_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenIPTransportDetails_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
//
static RedfishCS_status GenLinksCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpoint_V1_2_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  ...
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "NetworkDeviceFunction", Cs->Header.ThisUri, &(*Dst)->NetworkDeviceFunction);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // NetworkDeviceFunction@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "NetworkDeviceFunction@odata.count", &(*Dst)->NetworkDeviceFunctionodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenStatusCs(RedfishEndpoint_V1_2_1_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ConnectedEntitiesEntityPciId(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_1_PciId_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // ClassCode 
  if (InsertJsonStringObj (CsJson, "ClassCode", CSPtr->ClassCode) != RedfishCS_status_success) {goto Error;}

  // DeviceId 
  if (InsertJsonStringObj (CsJson, "DeviceId", CSPtr->DeviceId) != RedfishCS_status_success) {goto Error;}

  // FunctionNumber 
  if (InsertJsonInt64Obj (CsJson, "FunctionNumber", CSPtr->FunctionNumber) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_ConnectedEntities(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_1_ConnectedEntity_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEndpoint_V1_2_1_ConnectedEntity_Array_CS *NextArray;
  RedfishEndpoint_V1_2_1_ConnectedEntity_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_IPTransportDetails(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_1_IPTransportDetails_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEndpoint_V1_2_1_IPTransportDetails_Array_CS *NextArray;
  RedfishEndpoint_V1_2_1_IPTransportDetails_CS *NextArrayItem;
  ...
  do {
    ...
    NextArrayItem = NextArray->ArrayValue;
    // IPv4Address 
    if (InsertJsonLinkObj (ArrayMember, "IPv4Address", &NextArrayItem->IPv4Address) != RedfishCS_status_success) {goto Error;}

    // IPv6Address 
    if (InsertJsonLinkObj (ArrayMember, "IPv6Address", &NextArrayItem->IPv6Address) != RedfishCS_status_success) {goto Error;}

    // Port 
    if (InsertJsonInt64Obj (ArrayMember, "Port", NextArrayItem->Port) != RedfishCS_status_success) {goto Error;}

    // TransportProtocol 
    if (InsertJsonStringObj (ArrayMember, "TransportProtocol", NextArrayItem->TransportProtocol) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_1_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // NetworkDeviceFunction 
  if (InsertJsonLinkArrayObj (CsJson, "NetworkDeviceFunction", &CSPtr->NetworkDeviceFunction) != RedfishCS_status_success) {goto Error;}

  // NetworkDeviceFunction@odata.count 
  if (InsertJsonInt64Obj (CsJson, "NetworkDeviceFunction@odata.count", CSPtr->NetworkDeviceFunctionodata_count) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_PciId(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_1_PciId_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Endpoint.V1_2_1.Endpoint
//
RedfishCS_status CS_To_Endpoint_V1_2_1_JSON(RedfishEndpoint_V1_2_1_Endpoint_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // IPTransportDetails
  if (CS_To_JSON_IPTransportDetails(CsJson, "IPTransportDetails", CSPtr->IPTransportDetails) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Endpoint.V1_2_1.Endpoint
//
RedfishCS_status DestroyEndpoint_V1_2_1_CS(RedfishEndpoint_V1_2_1_Endpoint_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Endpoint.V1_2_1.Endpoint
//
RedfishCS_status DestroyEndpoint_V1_2_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Endpoint.V1_2_1.Endpoint
//
RedfishCS_status
Json_Endpoint_V1_2_1_To_CS(RedfishCS_char *JsonRawText, RedfishEndpoint_V1_2_1_Endpoint_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEndpoint_V1_2_1_Endpoint_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Endpoint", "v1_2_1", "Endpoint", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEndpoint_V1_2_1_Endpoint_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // IPTransportDetails
  Status = GenIPTransportDetails_ArrayCs (Cs, JsonObj, "IPTransportDetails", &Cs->IPTransportDetails);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
