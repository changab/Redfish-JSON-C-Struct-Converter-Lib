...
#ifndef _RedfishLogentry_V1_3_2_CSTRUCT_H_
#define _RedfishLogentry_V1_3_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_3_2_Actions_CS RedfishLogEntry_V1_3_2_Actions_CS;
typedef struct _RedfishLogEntry_V1_3_2_Links_CS RedfishLogEntry_V1_3_2_Links_CS;
typedef struct _RedfishLogEntry_V1_3_2_LogEntry_CS RedfishLogEntry_V1_3_2_LogEntry_CS;
typedef struct _RedfishLogEntry_V1_3_2_OemActions_CS RedfishLogEntry_V1_3_2_OemActions_CS;
...
typedef struct _RedfishLogEntry_V1_3_2_Actions_CS {
    RedfishLogEntry_V1_3_2_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishLogEntry_V1_3_2_LogEntry_CS {
    ...
    RedfishLogEntry_V1_3_2_Actions_CS    *Actions;           // The available actions for this
                                                             // resource.
    ...
    RedfishCS_char                       *Id;            
    RedfishLogEntry_V1_3_2_Links_CS      *Links;             // Contains references to other
...
RedfishCS_status
Json_LogEntry_V1_3_2_To_CS (char *JsonRawText, RedfishLogEntry_V1_3_2_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_3_2_JSON (RedfishLogEntry_V1_3_2_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_3_2_CS (RedfishLogEntry_V1_3_2_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_3_2_Json (RedfishCS_char *JsonText);
