...
//
#include <RedfishInterpreter/Power/v1_4_2/EfiPowerV1_4_2.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_4_2 
...
{
  EFI_REDFISH_POWER_V1_4_2 *PowerV1_4_2;
  EFI_REDFISH_POWER_V1_4_2_CS *PowerV1_4_2Cs;
  ...
  Status = Json_Power_V1_4_2_To_CS (ResoruceRaw, &PowerV1_4_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_4_2 = (EFI_REDFISH_POWER_V1_4_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_4_2));
  if (PowerV1_4_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_4_2;
  PowerV1_4_2->Power = PowerV1_4_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "4";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_POWER_V1_4_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_4_2_JSON (*((EFI_REDFISH_POWER_V1_4_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_4_2 = (EFI_REDFISH_POWER_V1_4_2 *)InterpProp;
  DestroyPower_V1_4_2_CS (PowerV1_4_2->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_4_2_Json (ResoruceRaw);
}
