...
//
#include <RedfishInterpreter/EventDestination/v1_3_0/EfiEventDestinationV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_3_0 
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_3_0 *EventDestinationV1_3_0;
  EFI_REDFISH_EVENTDESTINATION_V1_3_0_CS *EventDestinationV1_3_0Cs;
  ...
  Status = Json_EventDestination_V1_3_0_To_CS (ResoruceRaw, &EventDestinationV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_3_0 = (EFI_REDFISH_EVENTDESTINATION_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_3_0));
  if (EventDestinationV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventDestinationV1_3_0;
  EventDestinationV1_3_0->EventDestination = EventDestinationV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_EVENTDESTINATION_V1_3_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventDestination_V1_3_0_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventDestinationV1_3_0 = (EFI_REDFISH_EVENTDESTINATION_V1_3_0 *)InterpProp;
  DestroyEventDestination_V1_3_0_CS (EventDestinationV1_3_0->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventDestination_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
