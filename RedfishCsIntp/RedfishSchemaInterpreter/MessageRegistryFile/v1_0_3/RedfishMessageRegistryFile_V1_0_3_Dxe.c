...
//
#include <RedfishInterpreter/MessageRegistryFile/v1_0_3/EfiMessageRegistryFileV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_0_3 
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_3 *MessageRegistryFileV1_0_3;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_3_CS *MessageRegistryFileV1_0_3Cs;
  ...
  Status = Json_MessageRegistryFile_V1_0_3_To_CS (ResoruceRaw, &MessageRegistryFileV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_0_3 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_3));
  if (MessageRegistryFileV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryFileV1_0_3;
  MessageRegistryFileV1_0_3->MessageRegistryFile = MessageRegistryFileV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MessageRegistryFile_V1_0_3_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MessageRegistryFileV1_0_3 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_3 *)InterpProp;
  DestroyMessageRegistryFile_V1_0_3_CS (MessageRegistryFileV1_0_3->MessageRegistryFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMessageRegistryFile_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
