...
//
#include <RedfishInterpreter/SoftwareInventory/v1_0_2/EfiSoftwareInventoryV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_0_2 
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_0_2 *SoftwareInventoryV1_0_2;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_0_2_CS *SoftwareInventoryV1_0_2Cs;
  ...
  Status = Json_SoftwareInventory_V1_0_2_To_CS (ResoruceRaw, &SoftwareInventoryV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_0_2 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_2));
  if (SoftwareInventoryV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SoftwareInventoryV1_0_2;
  SoftwareInventoryV1_0_2->SoftwareInventory = SoftwareInventoryV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SoftwareInventory_V1_0_2_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SoftwareInventoryV1_0_2 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_0_2 *)InterpProp;
  DestroySoftwareInventory_V1_0_2_CS (SoftwareInventoryV1_0_2->SoftwareInventory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySoftwareInventory_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
