...
//
#include <RedfishInterpreter/MessageRegistryFile/v1_0_5/EfiMessageRegistryFileV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_0_5 
...
EFI_STATUS
EFIAPI
MessageRegistryFileToEfiStruct (
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_5 *MessageRegistryFileV1_0_5;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_5_CS *MessageRegistryFileV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "MessageRegistryFile") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_MessageRegistryFile_V1_0_5_To_CS (ResoruceRaw, &MessageRegistryFileV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_0_5 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_5));
  if (MessageRegistryFileV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MessageRegistryFileV1_0_5;
  MessageRegistryFileV1_0_5->MessageRegistryFile = MessageRegistryFileV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MessageRegistryFile"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "MessageRegistryFile");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MessageRegistryFile"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "MessageRegistryFile");
...
EFI_STATUS
EFIAPI
MessageRegistryFileFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_MessageRegistryFile_V1_0_5_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in MessageRegistryFileToStruct.
...
EFI_STATUS
EFIAPI
MessageRegistryFileDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  MessageRegistryFileV1_0_5 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_5 *)InterpProp;
  DestroyMessageRegistryFile_V1_0_5_CS (MessageRegistryFileV1_0_5->MessageRegistryFile); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MessageRegistryFileFromEfiStruct
...
EFI_STATUS
EFIAPI
MessageRegistryFileDestoryJson(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
  IN EFI_REST_RESOURCE_TYPE_IDENTIFIER *RsrcIdentifier,  
  IN CHAR8 *ResoruceRaw
)
{
  ...
  return DestroyMessageRegistryFile_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
