...
//
#include <RedfishInterpreter/TaskService/v1_0_3/EfiTaskServiceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_0_3 
...
{
  EFI_REDFISH_TASKSERVICE_V1_0_3 *TaskServiceV1_0_3;
  EFI_REDFISH_TASKSERVICE_V1_0_3_CS *TaskServiceV1_0_3Cs;
  ...
  Status = Json_TaskService_V1_0_3_To_CS (ResoruceRaw, &TaskServiceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_0_3 = (EFI_REDFISH_TASKSERVICE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_0_3));
  if (TaskServiceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskServiceV1_0_3;
  TaskServiceV1_0_3->TaskService = TaskServiceV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_TASKSERVICE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_TaskService_V1_0_3_JSON (*((EFI_REDFISH_TASKSERVICE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskServiceV1_0_3 = (EFI_REDFISH_TASKSERVICE_V1_0_3 *)InterpProp;
  DestroyTaskService_V1_0_3_CS (TaskServiceV1_0_3->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTaskService_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
