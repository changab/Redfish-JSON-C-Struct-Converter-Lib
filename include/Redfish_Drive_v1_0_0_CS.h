...
#ifndef _RedfishDrive_V1_0_0_CSTRUCT_H_
#define _RedfishDrive_V1_0_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishDrive_V1_0_0_Drive_CS RedfishDrive_V1_0_0_Drive_CS;
typedef struct _RedfishDrive_V1_0_0_Drive_Actions_CS RedfishDrive_V1_0_0_Drive_Actions_CS;
typedef struct _RedfishDrive_V1_0_0_Drive_Actions_Oem_CS RedfishDrive_V1_0_0_Drive_Actions_Oem_CS;
typedef struct _RedfishDrive_V1_0_0_Drive_Links_CS RedfishDrive_V1_0_0_Drive_Links_CS;
typedef struct _RedfishDrive_V1_0_0_SecureErase_CS RedfishDrive_V1_0_0_SecureErase_CS;
...
typedef struct _RedfishDrive_V1_0_0_Drive_CS {
    ...
    RedfishDrive_V1_0_0_Drive_Actions_CS          *Actions;                         // The available actions for this
                                                                                    // resource.
    ...
    RedfishCS_char                                *IndicatorLED;                    // The state of the indicator
                                                                                    ...
                                                                                    // drive.
    RedfishDrive_V1_0_0_Drive_Links_CS            *Links;                           // Contains references to other
...
RedfishCS_status
Json_Drive_V1_0_0_To_CS (char *JsonRawText, RedfishDrive_V1_0_0_Drive_CS **ReturnedCS);

RedfishCS_status
CS_To_Drive_V1_0_0_JSON (RedfishDrive_V1_0_0_Drive_CS *CSPtr, char **JsonText);
