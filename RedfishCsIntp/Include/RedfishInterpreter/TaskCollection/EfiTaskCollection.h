...
#ifndef __EFI_REDFISH_INTERP_TASKCOLLECTION_H__
#define __EFI_REDFISH_INTERP_TASKCOLLECTION_H__

#include <Uefi.h>
#include <Protocol/RestResourceInterpreter.h>
#include "Library/RfishCS/edk2/TaskCollection/Redfish_TaskCollection_CS.h"
//
