...
//
#include <RedfishInterpreter/VirtualMedia/v1_1_0/EfiVirtualMediaV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_1_0 
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_1_0 *VirtualMediaV1_1_0;
  EFI_REDFISH_VIRTUALMEDIA_V1_1_0_CS *VirtualMediaV1_1_0Cs;
  ...
  Status = Json_VirtualMedia_V1_1_0_To_CS (ResoruceRaw, &VirtualMediaV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_1_0 = (EFI_REDFISH_VIRTUALMEDIA_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_1_0));
  if (VirtualMediaV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VirtualMediaV1_1_0;
  VirtualMediaV1_1_0->VirtualMedia = VirtualMediaV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VirtualMedia_V1_1_0_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VirtualMediaV1_1_0 = (EFI_REDFISH_VIRTUALMEDIA_V1_1_0 *)InterpProp;
  DestroyVirtualMedia_V1_1_0_CS (VirtualMediaV1_1_0->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVirtualMedia_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
