...
#ifndef _RedfishEventdestination_V1_1_2_CSTRUCT_H_
#define _RedfishEventdestination_V1_1_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishEventDestination_V1_1_2_HttpHeaderProperty_Array_CS RedfishEventDestination_V1_1_2_HttpHeaderProperty_Array_CS;
typedef struct _RedfishEventDestination_V1_1_2_EventDestination_CS RedfishEventDestination_V1_1_2_EventDestination_CS;
typedef struct _RedfishEventDestination_V1_1_2_HttpHeaderProperty_CS RedfishEventDestination_V1_1_2_HttpHeaderProperty_CS;
...
typedef struct _RedfishEventDestination_V1_1_2_EventDestination_CS {
    ...
    RedfishEventDestination_V1_1_2_HttpHeaderProperty_Array_CS    *HttpHeaders;                           // This is for setting HTTP
...
typedef struct _RedfishEventDestination_V1_1_2_HttpHeaderProperty_Array_CS  {
    RedfishEventDestination_V1_1_2_HttpHeaderProperty_Array_CS    *Next;
    RedfishEventDestination_V1_1_2_HttpHeaderProperty_CS    *ArrayValue;
} RedfishEventDestination_V1_1_2_HttpHeaderProperty_Array_CS;

RedfishCS_status
Json_EventDestination_V1_1_2_To_CS (char *JsonRawText, RedfishEventDestination_V1_1_2_EventDestination_CS **ReturnedCS);

RedfishCS_status
CS_To_EventDestination_V1_1_2_JSON (RedfishEventDestination_V1_1_2_EventDestination_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventDestination_V1_1_2_CS (RedfishEventDestination_V1_1_2_EventDestination_CS *CSPtr);

RedfishCS_status
DestroyEventDestination_V1_1_2_Json (RedfishCS_char *JsonText);
