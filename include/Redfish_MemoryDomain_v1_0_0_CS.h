...
#ifndef _RedfishMemorydomain_V1_0_0_CSTRUCT_H_
#define _RedfishMemorydomain_V1_0_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemoryDomain_V1_0_0_MemorySet_Array_CS RedfishMemoryDomain_V1_0_0_MemorySet_Array_CS;
typedef struct _RedfishMemoryDomain_V1_0_0_MemoryDomain_CS RedfishMemoryDomain_V1_0_0_MemoryDomain_CS;
typedef struct _RedfishMemoryDomain_V1_0_0_MemorySet_CS RedfishMemoryDomain_V1_0_0_MemorySet_CS;
...
typedef struct _RedfishMemoryDomain_V1_0_0_MemoryDomain_CS {
    ...
    RedfishCS_char                                   *Id;                      
    RedfishMemoryDomain_V1_0_0_MemorySet_Array_CS    *InterleavableMemorySets;     // This is the interleave sets
...
typedef struct _RedfishMemoryDomain_V1_0_0_MemorySet_Array_CS  {
    RedfishMemoryDomain_V1_0_0_MemorySet_Array_CS    *Next;
    RedfishMemoryDomain_V1_0_0_MemorySet_CS    *ArrayValue;
} RedfishMemoryDomain_V1_0_0_MemorySet_Array_CS;

RedfishCS_status
Json_MemoryDomain_V1_0_0_To_CS (char *JsonRawText, RedfishMemoryDomain_V1_0_0_MemoryDomain_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryDomain_V1_0_0_JSON (RedfishMemoryDomain_V1_0_0_MemoryDomain_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryDomain_V1_0_0_CS (RedfishMemoryDomain_V1_0_0_MemoryDomain_CS *CSPtr);

RedfishCS_status
DestroyMemoryDomain_V1_0_0_Json (RedfishCS_char *JsonText);
