...
#include"Redfish_RoleCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishRoleCollection_RoleCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for RoleCollection.RoleCollection
//
RedfishCS_status CS_To_RoleCollection_JSON(RedfishRoleCollection_RoleCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for RoleCollection.RoleCollection
//
RedfishCS_status DestroyRoleCollection_CS(RedfishRoleCollection_RoleCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for RoleCollection.RoleCollection
//
RedfishCS_status DestroyRoleCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for RoleCollection.NOVERSIONED.RoleCollection
//
RedfishCS_status
Json_RoleCollection_To_CS(RedfishCS_char *JsonRawText, RedfishRoleCollection_RoleCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRoleCollection_RoleCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "RoleCollection", "noversioned", "RoleCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRoleCollection_RoleCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
