...
//
#include <RedfishInterpreter/CompositionService/v1_0_2/EfiCompositionServiceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#CompositionService";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionService V1_0_2 
...
{
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_2 *CompositionServiceV1_0_2;
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_2_CS *CompositionServiceV1_0_2Cs;
  ...
  Status = Json_CompositionService_V1_0_2_To_CS (ResoruceRaw, &CompositionServiceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionServiceV1_0_2 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_2));
  if (CompositionServiceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)CompositionServiceV1_0_2;
  CompositionServiceV1_0_2->CompositionService = CompositionServiceV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_CompositionService_V1_0_2_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  CompositionServiceV1_0_2 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_2 *)InterpProp;
  DestroyCompositionService_V1_0_2_CS (CompositionServiceV1_0_2->CompositionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyCompositionService_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
