...
//
#include <RedfishInterpreter/Port/v1_1_0/EfiPortV1_1_0.h>
...
{
  EFI_REDFISH_PORT_V1_1_0 *PortV1_1_0;
  EFI_REDFISH_PORT_V1_1_0_CS *PortV1_1_0Cs;
  ...
  Status = Json_Port_V1_1_0_To_CS (ResoruceRaw, &PortV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_1_0 = (EFI_REDFISH_PORT_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_1_0));
  if (PortV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PortV1_1_0;
  PortV1_1_0->Port = PortV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_PORT_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Port_V1_1_0_JSON (*((EFI_REDFISH_PORT_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PortV1_1_0 = (EFI_REDFISH_PORT_V1_1_0 *)InterpProp;
  DestroyPort_V1_1_0_CS (PortV1_1_0->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPort_V1_1_0_Json (ResoruceRaw);
}
