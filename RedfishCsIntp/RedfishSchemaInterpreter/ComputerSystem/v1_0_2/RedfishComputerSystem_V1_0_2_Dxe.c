...
//
#include <RedfishInterpreter/ComputerSystem/v1_0_2/EfiComputerSystemV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_0_2 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_2 *ComputerSystemV1_0_2;
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_2_CS *ComputerSystemV1_0_2Cs;
  ...
  Status = Json_ComputerSystem_V1_0_2_To_CS (ResoruceRaw, &ComputerSystemV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_0_2 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_2));
  if (ComputerSystemV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_0_2;
  ComputerSystemV1_0_2->ComputerSystem = ComputerSystemV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_0_2_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_0_2 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_2 *)InterpProp;
  DestroyComputerSystem_V1_0_2_CS (ComputerSystemV1_0_2->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
