...
//
#include <RedfishInterpreter/PrivilegeRegistry/v1_0_0/EfiPrivilegeRegistryV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_0_0 
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_0 *PrivilegeRegistryV1_0_0;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_0_CS *PrivilegeRegistryV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "PrivilegeRegistry") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_PrivilegeRegistry_V1_0_0_To_CS (ResoruceRaw, &PrivilegeRegistryV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_0_0 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_0));
  if (PrivilegeRegistryV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PrivilegeRegistryV1_0_0;
  PrivilegeRegistryV1_0_0->PrivilegeRegistry = PrivilegeRegistryV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PrivilegeRegistry"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "PrivilegeRegistry");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PrivilegeRegistry"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "PrivilegeRegistry");
...
EFI_STATUS
EFIAPI
PrivilegeRegistryFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_PrivilegeRegistry_V1_0_0_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in PrivilegeRegistryToStruct.
...
EFI_STATUS
EFIAPI
PrivilegeRegistryDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  PrivilegeRegistryV1_0_0 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_0 *)InterpProp;
  DestroyPrivilegeRegistry_V1_0_0_CS (PrivilegeRegistryV1_0_0->PrivilegeRegistry); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PrivilegeRegistryFromEfiStruct
...
)
{
  ...
  return DestroyPrivilegeRegistry_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
