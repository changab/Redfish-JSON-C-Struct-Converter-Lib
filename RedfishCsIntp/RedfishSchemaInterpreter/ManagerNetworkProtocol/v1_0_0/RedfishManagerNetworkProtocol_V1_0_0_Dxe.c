...
//
#include <RedfishInterpreter/ManagerNetworkProtocol/v1_0_0/EfiManagerNetworkProtocolV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_0_0 
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_0 *ManagerNetworkProtocolV1_0_0;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_0_CS *ManagerNetworkProtocolV1_0_0Cs;
  ...
  Status = Json_ManagerNetworkProtocol_V1_0_0_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_0_0 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_0));
  if (ManagerNetworkProtocolV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerNetworkProtocolV1_0_0;
  ManagerNetworkProtocolV1_0_0->ManagerNetworkProtocol = ManagerNetworkProtocolV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerNetworkProtocol_V1_0_0_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerNetworkProtocolV1_0_0 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_0 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_0_0_CS (ManagerNetworkProtocolV1_0_0->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerNetworkProtocol_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
