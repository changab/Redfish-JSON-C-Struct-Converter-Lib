...
//
#include <RedfishInterpreter/MemoryMetrics/v1_1_1/EfiMemoryMetricsV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_1_1 
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_1_1 *MemoryMetricsV1_1_1;
  EFI_REDFISH_MEMORYMETRICS_V1_1_1_CS *MemoryMetricsV1_1_1Cs;
  ...
  Status = Json_MemoryMetrics_V1_1_1_To_CS (ResoruceRaw, &MemoryMetricsV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_1_1 = (EFI_REDFISH_MEMORYMETRICS_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_1_1));
  if (MemoryMetricsV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryMetricsV1_1_1;
  MemoryMetricsV1_1_1->MemoryMetrics = MemoryMetricsV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MEMORYMETRICS_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryMetrics_V1_1_1_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryMetricsV1_1_1 = (EFI_REDFISH_MEMORYMETRICS_V1_1_1 *)InterpProp;
  DestroyMemoryMetrics_V1_1_1_CS (MemoryMetricsV1_1_1->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryMetrics_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
