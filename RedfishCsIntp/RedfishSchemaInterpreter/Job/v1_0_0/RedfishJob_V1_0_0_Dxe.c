...
//
#include <RedfishInterpreter/Job/v1_0_0/EfiJobV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Job";
...
{
  EFI_REDFISH_JOB_V1_0_0 *JobV1_0_0;
  EFI_REDFISH_JOB_V1_0_0_CS *JobV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Job") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Job_V1_0_0_To_CS (ResoruceRaw, &JobV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobV1_0_0 = (EFI_REDFISH_JOB_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOB_V1_0_0));
  if (JobV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)JobV1_0_0;
  JobV1_0_0->Job = JobV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_JOB_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Job"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Job");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Job"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Job");
...
)
{
  ...
  return CS_To_Job_V1_0_0_JSON (*((EFI_REDFISH_JOB_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in JobToStruct.
...
)
{
  ...
  JobV1_0_0 = (EFI_REDFISH_JOB_V1_0_0 *)InterpProp;
  DestroyJob_V1_0_0_CS (JobV1_0_0->Job); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from JobFromEfiStruct
...
)
{
  ...
  return DestroyJob_V1_0_0_Json (ResoruceRaw);
}
