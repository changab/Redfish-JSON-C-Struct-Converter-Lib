...
#ifndef _RedfishEthernetinterface_V1_1_1_CSTRUCT_H_
#define _RedfishEthernetinterface_V1_1_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_Array_CS;
...
#endif
typedef struct _RedfishEthernetInterface_V1_1_1_EthernetInterface_CS RedfishEthernetInterface_V1_1_1_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_1_1_EthernetInterface_Links_CS RedfishEthernetInterface_V1_1_1_EthernetInterface_Links_CS;
typedef struct _RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_1_1_EthernetInterface_Links_CS {
...
} RedfishEthernetInterface_V1_1_1_EthernetInterface_Links_CS;

typedef struct _RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_CS {
    ...
    RedfishCS_char     *Prefix;       // The IPv6 Address Prefix (as
                                      // defined in RFC 6724 section
                                      // 2.1).
} RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_1_1_EthernetInterface_CS {
    ...
    RedfishIPAddresses_V1_0_0_IPv4Address_Array_CS                     *IPv4Addresses;            // The IPv4 addresses assigned to
                                                                                                  // this interface.
    RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_Array_CS    *IPv6AddressPolicyTable;    // An array representing the RFC
    ...
    RedfishCS_char                                                     *LinkStatus;               // The link status of this
                                                                                                  // interface (port).
    RedfishEthernetInterface_V1_1_1_EthernetInterface_Links_CS         *Links;                    // Contains references to other
...
} RedfishEthernetInterface_V1_1_1_EthernetInterface_CS;
...
typedef struct _RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_1_1_IPv6AddressPolicyEntry_Array_CS;
...
RedfishCS_status
Json_EthernetInterface_V1_1_1_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_1_1_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_1_1_JSON (RedfishEthernetInterface_V1_1_1_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_1_1_CS (RedfishEthernetInterface_V1_1_1_EthernetInterface_CS *CSPtr);

RedfishCS_status
DestroyEthernetInterface_V1_1_1_Json (RedfishCS_char *JsonText);
