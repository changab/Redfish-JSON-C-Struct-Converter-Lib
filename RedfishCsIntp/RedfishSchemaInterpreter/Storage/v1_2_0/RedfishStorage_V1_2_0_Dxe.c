...
//
#include <RedfishInterpreter/Storage/v1_2_0/EfiStorageV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_2_0 
...
{
  EFI_REDFISH_STORAGE_V1_2_0 *StorageV1_2_0;
  EFI_REDFISH_STORAGE_V1_2_0_CS *StorageV1_2_0Cs;
  ...
  Status = Json_Storage_V1_2_0_To_CS (ResoruceRaw, &StorageV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_2_0 = (EFI_REDFISH_STORAGE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_2_0));
  if (StorageV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_2_0;
  StorageV1_2_0->Storage = StorageV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_2_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_2_0_JSON (*((EFI_REDFISH_STORAGE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_2_0 = (EFI_REDFISH_STORAGE_V1_2_0 *)InterpProp;
  DestroyStorage_V1_2_0_CS (StorageV1_2_0->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_2_0EntryPoint (
