...
//
#include <RedfishInterpreter/TaskService/v1_1_0/EfiTaskServiceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_1_0 
...
{
  EFI_REDFISH_TASKSERVICE_V1_1_0 *TaskServiceV1_1_0;
  ...
  Status = Json_TaskService_V1_1_0_To_CS (ResoruceRaw, &TaskServiceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_1_0 = (EFI_REDFISH_TASKSERVICE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_1_0));
  if (TaskServiceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskServiceV1_1_0;
  TaskServiceV1_1_0->TaskService = TaskServiceV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_TASKSERVICE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_TaskService_V1_1_0_JSON (*((EFI_REDFISH_TASKSERVICE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskServiceV1_1_0 = (EFI_REDFISH_TASKSERVICE_V1_1_0 *)InterpProp;
  DestroyTaskService_V1_1_0_CS (TaskServiceV1_1_0->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTaskService_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
