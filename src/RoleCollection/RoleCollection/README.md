# Definition of RoleCollection and functions<br><br>
...
## Redfish RoleCollection  to C Structure Function
    RedfishCS_status
    Json_RoleCollection_To_CS (RedfishCS_char *JsonRawText, RedfishRoleCollection_RoleCollection_CS **ReturnedCS);

## C Structure to Redfish RoleCollection  JSON Function
    RedfishCS_status
    CS_To_RoleCollection_JSON (RedfishRoleCollection_RoleCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish RoleCollection  C Structure Function
    RedfishCS_status
