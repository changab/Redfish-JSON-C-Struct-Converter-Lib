...
#ifndef _RedfishProcessor_V1_4_0_CSTRUCT_H_
#define _RedfishProcessor_V1_4_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessor_V1_4_0_Actions_CS RedfishProcessor_V1_4_0_Actions_CS;
typedef struct _RedfishProcessor_V1_4_0_Links_CS RedfishProcessor_V1_4_0_Links_CS;
typedef struct _RedfishProcessor_V1_4_0_OemActions_CS RedfishProcessor_V1_4_0_OemActions_CS;
typedef struct _RedfishProcessor_V1_4_0_Processor_CS RedfishProcessor_V1_4_0_Processor_CS;
typedef struct _RedfishProcessor_V1_4_0_ProcessorId_CS RedfishProcessor_V1_4_0_ProcessorId_CS;
...
//
typedef struct _RedfishProcessor_V1_4_0_Actions_CS {
    RedfishProcessor_V1_4_0_OemActions_CS    *Oem;    // This property contains the
                                                     // available OEM specific actions
                                                     // for this resource.
} RedfishProcessor_V1_4_0_Actions_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishProcessor_V1_4_0_Links_CS {
    RedfishCS_Link            Chassis;    // A reference to the Chassis
                                         // which contains this Processor.
    RedfishResource_Oem_CS    *Oem;      // Oem extension object.
} RedfishProcessor_V1_4_0_Links_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishProcessor_V1_4_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishProcessor_V1_4_0_OemActions_CS;

//
// This type describes the Identification information for a processor.
//
typedef struct _RedfishProcessor_V1_4_0_ProcessorId_CS {
    ...
    RedfishCS_char    *VendorId;                  // The Vendor Identification for
                                                  // this processor.
} RedfishProcessor_V1_4_0_ProcessorId_CS;
...
//
typedef struct _RedfishProcessor_V1_4_0_Processor_CS {
    RedfishCS_Header                          Header;
    RedfishCS_char                            *odata_context;       
    RedfishCS_char                            *odata_etag;          
    RedfishCS_char                            *odata_id;            
    RedfishCS_char                            *odata_type;          
    RedfishProcessor_V1_4_0_Actions_CS        *Actions;                 // The available actions for this
                                                                        // resource.
    ...
    RedfishCS_char                            *InstructionSet;          // The instruction set of the
                                                                        // processor.
    RedfishProcessor_V1_4_0_Links_CS          *Links;                   // Contains references to other
    ...
    RedfishCS_char                            *ProcessorArchitecture;    // The architecture of the
                                                                        // processor.
    RedfishProcessor_V1_4_0_ProcessorId_CS    *ProcessorId;             // Identification information for
                                                                        // this processor.
    ...
    RedfishCS_int64                           *TotalThreads;            // The total number of execution
                                                                        ...
                                                                        // processor.
} RedfishProcessor_V1_4_0_Processor_CS;

RedfishCS_status
Json_Processor_V1_4_0_To_CS (char *JsonRawText, RedfishProcessor_V1_4_0_Processor_CS **ReturnedCS);

RedfishCS_status
CS_To_Processor_V1_4_0_JSON (RedfishProcessor_V1_4_0_Processor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyProcessor_V1_4_0_CS (RedfishProcessor_V1_4_0_Processor_CS *CSPtr);

RedfishCS_status
DestroyProcessor_V1_4_0_Json (RedfishCS_char *JsonText);
