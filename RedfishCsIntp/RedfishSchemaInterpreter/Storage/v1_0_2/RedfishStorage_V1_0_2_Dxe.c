...
//
#include <RedfishInterpreter/Storage/v1_0_2/EfiStorageV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_0_2 
...
{
  EFI_REDFISH_STORAGE_V1_0_2 *StorageV1_0_2;
  EFI_REDFISH_STORAGE_V1_0_2_CS *StorageV1_0_2Cs;
  ...
  Status = Json_Storage_V1_0_2_To_CS (ResoruceRaw, &StorageV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_0_2 = (EFI_REDFISH_STORAGE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_0_2));
  if (StorageV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)StorageV1_0_2;
  StorageV1_0_2->Storage = StorageV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_STORAGE_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Storage_V1_0_2_JSON (*((EFI_REDFISH_STORAGE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  StorageV1_0_2 = (EFI_REDFISH_STORAGE_V1_0_2 *)InterpProp;
  DestroyStorage_V1_0_2_CS (StorageV1_0_2->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyStorage_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_0_2EntryPoint (
