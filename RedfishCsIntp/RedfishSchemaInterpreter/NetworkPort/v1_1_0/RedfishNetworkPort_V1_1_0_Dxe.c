...
//
#include <RedfishInterpreter/NetworkPort/v1_1_0/EfiNetworkPortV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_1_0 
...
{
  EFI_REDFISH_NETWORKPORT_V1_1_0 *NetworkPortV1_1_0;
  EFI_REDFISH_NETWORKPORT_V1_1_0_CS *NetworkPortV1_1_0Cs;
  ...
  Status = Json_NetworkPort_V1_1_0_To_CS (ResoruceRaw, &NetworkPortV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_1_0 = (EFI_REDFISH_NETWORKPORT_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_1_0));
  if (NetworkPortV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkPortV1_1_0;
  NetworkPortV1_1_0->NetworkPort = NetworkPortV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_NETWORKPORT_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkPort_V1_1_0_JSON (*((EFI_REDFISH_NETWORKPORT_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkPortV1_1_0 = (EFI_REDFISH_NETWORKPORT_V1_1_0 *)InterpProp;
  DestroyNetworkPort_V1_1_0_CS (NetworkPortV1_1_0->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkPort_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
