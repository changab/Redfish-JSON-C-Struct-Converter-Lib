...
//
#include <RedfishInterpreter/Thermal/v1_1_3/EfiThermalV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_1_3 
...
{
  EFI_REDFISH_THERMAL_V1_1_3 *ThermalV1_1_3;
  EFI_REDFISH_THERMAL_V1_1_3_CS *ThermalV1_1_3Cs;
  ...
  Status = Json_Thermal_V1_1_3_To_CS (ResoruceRaw, &ThermalV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_1_3 = (EFI_REDFISH_THERMAL_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_1_3));
  if (ThermalV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ThermalV1_1_3;
  ThermalV1_1_3->Thermal = ThermalV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_THERMAL_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Thermal_V1_1_3_JSON (*((EFI_REDFISH_THERMAL_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ThermalV1_1_3 = (EFI_REDFISH_THERMAL_V1_1_3 *)InterpProp;
  DestroyThermal_V1_1_3_CS (ThermalV1_1_3->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyThermal_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_1_3EntryPoint (
