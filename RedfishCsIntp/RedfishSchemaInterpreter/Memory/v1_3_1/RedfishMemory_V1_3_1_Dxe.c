...
//
#include <RedfishInterpreter/Memory/v1_3_1/EfiMemoryV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_3_1 
...
{
  EFI_REDFISH_MEMORY_V1_3_1 *MemoryV1_3_1;
  EFI_REDFISH_MEMORY_V1_3_1_CS *MemoryV1_3_1Cs;
  ...
  Status = Json_Memory_V1_3_1_To_CS (ResoruceRaw, &MemoryV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_3_1 = (EFI_REDFISH_MEMORY_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_3_1));
  if (MemoryV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryV1_3_1;
  MemoryV1_3_1->Memory = MemoryV1_3_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_MEMORY_V1_3_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Memory_V1_3_1_JSON (*((EFI_REDFISH_MEMORY_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryV1_3_1 = (EFI_REDFISH_MEMORY_V1_3_1 *)InterpProp;
  DestroyMemory_V1_3_1_CS (MemoryV1_3_1->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemory_V1_3_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_3_1EntryPoint (
