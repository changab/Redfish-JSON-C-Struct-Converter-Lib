...
//
#include <RedfishInterpreter/Triggers/v1_0_0/EfiTriggersV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Triggers";
BOOLEAN IsRevisonController = TRUE;

// Support Triggers V1_0_0 
...
{
  EFI_REDFISH_TRIGGERS_V1_0_0 *TriggersV1_0_0;
  EFI_REDFISH_TRIGGERS_V1_0_0_CS *TriggersV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Triggers") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Triggers_V1_0_0_To_CS (ResoruceRaw, &TriggersV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TriggersV1_0_0 = (EFI_REDFISH_TRIGGERS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TRIGGERS_V1_0_0));
  if (TriggersV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TriggersV1_0_0;
  TriggersV1_0_0->Triggers = TriggersV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_TRIGGERS_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Triggers"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Triggers");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Triggers"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Triggers");
...
)
{
  ...
  return CS_To_Triggers_V1_0_0_JSON (*((EFI_REDFISH_TRIGGERS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in TriggersToStruct.
...
)
{
  ...
  TriggersV1_0_0 = (EFI_REDFISH_TRIGGERS_V1_0_0 *)InterpProp;
  DestroyTriggers_V1_0_0_CS (TriggersV1_0_0->Triggers); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from TriggersFromEfiStruct
...
)
{
  ...
  return DestroyTriggers_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTriggers_V1_0_0EntryPoint (
