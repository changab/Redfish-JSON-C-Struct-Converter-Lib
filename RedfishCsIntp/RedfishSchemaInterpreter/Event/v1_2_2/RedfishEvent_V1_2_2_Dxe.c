...
//
#include <RedfishInterpreter/Event/v1_2_2/EfiEventV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_2_2 
...
{
  EFI_REDFISH_EVENT_V1_2_2 *EventV1_2_2;
  EFI_REDFISH_EVENT_V1_2_2_CS *EventV1_2_2Cs;
  ...
  Status = Json_Event_V1_2_2_To_CS (ResoruceRaw, &EventV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_2_2 = (EFI_REDFISH_EVENT_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_2_2));
  if (EventV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_2_2;
  EventV1_2_2->Event = EventV1_2_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_EVENT_V1_2_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_2_2_JSON (*((EFI_REDFISH_EVENT_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_2_2 = (EFI_REDFISH_EVENT_V1_2_2 *)InterpProp;
  DestroyEvent_V1_2_2_CS (EventV1_2_2->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_2_2_Json (ResoruceRaw);
}
