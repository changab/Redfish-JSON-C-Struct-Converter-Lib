...
#include"Redfish_VLanNetworkInterfaceCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishVLanNetworkInterfaceCollection_VLanNetworkInterfaceCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for VLanNetworkInterfaceCollection.VLanNetworkInterfaceCollection
//
RedfishCS_status CS_To_VLanNetworkInterfaceCollection_JSON(RedfishVLanNetworkInterfaceCollection_VLanNetworkInterfaceCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for VLanNetworkInterfaceCollection.VLanNetworkInterfaceCollection
//
RedfishCS_status DestroyVLanNetworkInterfaceCollection_CS(RedfishVLanNetworkInterfaceCollection_VLanNetworkInterfaceCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VLanNetworkInterfaceCollection.VLanNetworkInterfaceCollection
//
RedfishCS_status DestroyVLanNetworkInterfaceCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VLanNetworkInterfaceCollection.NOVERSIONED.VLanNetworkInterfaceCollection
//
RedfishCS_status
Json_VLanNetworkInterfaceCollection_To_CS(RedfishCS_char *JsonRawText, RedfishVLanNetworkInterfaceCollection_VLanNetworkInterfaceCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVLanNetworkInterfaceCollection_VLanNetworkInterfaceCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VLanNetworkInterfaceCollection", "noversioned", "VLanNetworkInterfaceCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVLanNetworkInterfaceCollection_VLanNetworkInterfaceCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyVLanNetworkInterfaceCollection_CS (Cs);
  return Status;
}
