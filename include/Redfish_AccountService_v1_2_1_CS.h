...
#ifndef _RedfishAccountservice_V1_2_1_CSTRUCT_H_
#define _RedfishAccountservice_V1_2_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAccountService_V1_2_1_AccountService_CS RedfishAccountService_V1_2_1_AccountService_CS;
typedef struct _RedfishAccountService_V1_2_1_AccountService_Actions_CS RedfishAccountService_V1_2_1_AccountService_Actions_CS;
typedef struct _RedfishAccountService_V1_2_1_AccountService_Actions_Oem_CS RedfishAccountService_V1_2_1_AccountService_Actions_Oem_CS;
...
//
typedef struct _RedfishAccountService_V1_2_1_AccountService_Actions_CS {
    RedfishAccountService_V1_2_1_AccountService_Actions_Oem_CS    *Oem;    // The available OEM specific
                                                                          // actions for this resource.
} RedfishAccountService_V1_2_1_AccountService_Actions_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishAccountService_V1_2_1_AccountService_Actions_Oem_CS {
    RedfishCS_Link    Prop;
} RedfishAccountService_V1_2_1_AccountService_Actions_Oem_CS;
...
//
typedef struct _RedfishAccountService_V1_2_1_AccountService_CS {
    ...
    RedfishCS_Link                                            Accounts;                           // Link to a collection of
                                                                                                  // Manager Accounts.
    RedfishAccountService_V1_2_1_AccountService_Actions_CS    *Actions;                           // The available actions for this
                                                                                                  // resource.
...
} RedfishAccountService_V1_2_1_AccountService_CS;

RedfishCS_status
Json_AccountService_V1_2_1_To_CS (char *JsonRawText, RedfishAccountService_V1_2_1_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_2_1_JSON (RedfishAccountService_V1_2_1_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_2_1_CS (RedfishAccountService_V1_2_1_AccountService_CS *CSPtr);
