...
//
#include <RedfishInterpreter/VLanNetworkInterface/v1_1_1/EfiVLanNetworkInterfaceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_1_1 
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_1 *VLanNetworkInterfaceV1_1_1;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_1_CS *VLanNetworkInterfaceV1_1_1Cs;
  ...
  Status = Json_VLanNetworkInterface_V1_1_1_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_1_1 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_1));
  if (VLanNetworkInterfaceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VLanNetworkInterfaceV1_1_1;
  VLanNetworkInterfaceV1_1_1->VLanNetworkInterface = VLanNetworkInterfaceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VLanNetworkInterface_V1_1_1_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VLanNetworkInterfaceV1_1_1 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_1 *)InterpProp;
  DestroyVLanNetworkInterface_V1_1_1_CS (VLanNetworkInterfaceV1_1_1->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVLanNetworkInterface_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
