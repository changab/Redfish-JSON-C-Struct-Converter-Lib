...
//
#include <RedfishInterpreter/Chassis/v1_1_2/EfiChassisV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_1_2 
...
{
  EFI_REDFISH_CHASSIS_V1_1_2 *ChassisV1_1_2;
  EFI_REDFISH_CHASSIS_V1_1_2_CS *ChassisV1_1_2Cs;
  ...
  Status = Json_Chassis_V1_1_2_To_CS (ResoruceRaw, &ChassisV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_1_2 = (EFI_REDFISH_CHASSIS_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_1_2));
  if (ChassisV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_1_2;
  ChassisV1_1_2->Chassis = ChassisV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Chassis_V1_1_2_JSON (*((EFI_REDFISH_CHASSIS_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ChassisV1_1_2 = (EFI_REDFISH_CHASSIS_V1_1_2 *)InterpProp;
  DestroyChassis_V1_1_2_CS (ChassisV1_1_2->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyChassis_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_1_2EntryPoint (
