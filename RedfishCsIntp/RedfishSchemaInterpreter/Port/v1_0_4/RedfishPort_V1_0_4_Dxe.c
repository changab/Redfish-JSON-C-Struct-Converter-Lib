...
//
#include <RedfishInterpreter/Port/v1_0_4/EfiPortV1_0_4.h>
...
{
  EFI_REDFISH_PORT_V1_0_4 *PortV1_0_4;
  EFI_REDFISH_PORT_V1_0_4_CS *PortV1_0_4Cs;
  ...
  Status = Json_Port_V1_0_4_To_CS (ResoruceRaw, &PortV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_0_4 = (EFI_REDFISH_PORT_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_0_4));
  if (PortV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PortV1_0_4;
  PortV1_0_4->Port = PortV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_PORT_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Port_V1_0_4_JSON (*((EFI_REDFISH_PORT_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PortV1_0_4 = (EFI_REDFISH_PORT_V1_0_4 *)InterpProp;
  DestroyPort_V1_0_4_CS (PortV1_0_4->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPort_V1_0_4_Json (ResoruceRaw);
}
