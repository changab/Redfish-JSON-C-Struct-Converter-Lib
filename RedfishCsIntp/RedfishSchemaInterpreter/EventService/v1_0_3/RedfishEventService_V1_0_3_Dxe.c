...
//
#include <RedfishInterpreter/EventService/v1_0_3/EfiEventServiceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_3 
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_3 *EventServiceV1_0_3;
  EFI_REDFISH_EVENTSERVICE_V1_0_3_CS *EventServiceV1_0_3Cs;
  ...
  Status = Json_EventService_V1_0_3_To_CS (ResoruceRaw, &EventServiceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_3 = (EFI_REDFISH_EVENTSERVICE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_3));
  if (EventServiceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventServiceV1_0_3;
  EventServiceV1_0_3->EventService = EventServiceV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_EventService_V1_0_3_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventServiceV1_0_3 = (EFI_REDFISH_EVENTSERVICE_V1_0_3 *)InterpProp;
  DestroyEventService_V1_0_3_CS (EventServiceV1_0_3->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEventService_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
