...
//
#include <RedfishInterpreter/NetworkDeviceFunction/v1_1_2/EfiNetworkDeviceFunctionV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_1_2 
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_2 *NetworkDeviceFunctionV1_1_2;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_2_CS *NetworkDeviceFunctionV1_1_2Cs;
  ...
  Status = Json_NetworkDeviceFunction_V1_1_2_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_1_2 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_2));
  if (NetworkDeviceFunctionV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkDeviceFunctionV1_1_2;
  NetworkDeviceFunctionV1_1_2->NetworkDeviceFunction = NetworkDeviceFunctionV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkDeviceFunction_V1_1_2_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkDeviceFunctionV1_1_2 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_2 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_1_2_CS (NetworkDeviceFunctionV1_1_2->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkDeviceFunction_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
