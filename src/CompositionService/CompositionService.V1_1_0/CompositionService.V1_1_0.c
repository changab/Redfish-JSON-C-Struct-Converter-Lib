...
#include"Redfish_CompositionService_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishCompositionService_V1_1_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishCompositionService_V1_1_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionService_V1_1_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionService_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishCompositionService_V1_1_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionService_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionService_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenStatusCs(RedfishCompositionService_V1_1_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishCompositionService_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishCompositionService_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for CompositionService.V1_1_0.CompositionService
//
RedfishCS_status CS_To_CompositionService_V1_1_0_JSON(RedfishCompositionService_V1_1_0_CompositionService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonBoolObj (CsJson, "AllowOverprovisioning", CSPtr->AllowOverprovisioning) != RedfishCS_status_success) {goto Error;}

  // AllowZoneAffinity 
  if (InsertJsonBoolObj (CsJson, "AllowZoneAffinity", CSPtr->AllowZoneAffinity) != RedfishCS_status_success) {goto Error;}
  ...
  // ResourceZones 
  if (InsertJsonLinkObj (CsJson, "ResourceZones", &CSPtr->ResourceZones) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for CompositionService.V1_1_0.CompositionService
//
RedfishCS_status DestroyCompositionService_V1_1_0_CS(RedfishCompositionService_V1_1_0_CompositionService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for CompositionService.V1_1_0.CompositionService
//
RedfishCS_status DestroyCompositionService_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for CompositionService.V1_1_0.CompositionService
//
RedfishCS_status
Json_CompositionService_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishCompositionService_V1_1_0_CompositionService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCompositionService_V1_1_0_CompositionService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "CompositionService", "v1_1_0", "CompositionService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCompositionService_V1_1_0_CompositionService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AllowOverprovisioning
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "AllowOverprovisioning", &Cs->AllowOverprovisioning);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AllowZoneAffinity
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "AllowZoneAffinity", &Cs->AllowZoneAffinity);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ResourceZones
  InitializeLinkHead (&Cs->ResourceZones);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "ResourceZones", Cs->Header.ThisUri, &Cs->ResourceZones);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyCompositionService_V1_1_0_CS (Cs);
  return Status;
}
