# Definition of Manager.V1_4_2 and functions<br><br>
...
## Actions
    typedef struct _RedfishManager_V1_4_2_Actions_CS {
        ...
        RedfishManager_V1_4_2_OemActions_CS *Oem;
    } RedfishManager_V1_4_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Manager_ForceFailover**|RedfishManager_V1_4_2_ForceFailover_CS| Structure points to **#Manager.ForceFailover** property.| No| No
|**Manager_ModifyRedundancySet**|RedfishManager_V1_4_2_ModifyRedundancySet_CS| Structure points to **#Manager.ModifyRedundancySet** property.| No| No
|**Manager_Reset**|RedfishManager_V1_4_2_Reset_CS| Structure points to **#Manager.Reset** property.| No| No
|**Oem**|RedfishManager_V1_4_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Manager
    typedef struct _RedfishManager_V1_4_2_Manager_CS {
        ...
        RedfishManager_V1_4_2_Actions_CS *Actions;
        RedfishCS_bool *AutoDSTEnabled;
        RedfishManager_V1_4_2_CommandShell_CS *CommandShell;
        RedfishCS_char *DateTime;
        RedfishCS_char *DateTimeLocalOffset;
        RedfishCS_char *Description;
        RedfishCS_Link EthernetInterfaces;
        RedfishCS_char *FirmwareVersion;
        RedfishManager_V1_4_2_GraphicalConsole_CS *GraphicalConsole;
        RedfishCS_Link HostInterfaces;
        RedfishCS_char *Id;
        RedfishManager_V1_4_2_Links_CS *Links;
        ...
        RedfishManager_V1_4_2_SerialConsole_CS *SerialConsole;
...
|**Actions**|RedfishManager_V1_4_2_Actions_CS| Structure points to **Actions** property.| No| No
|**AutoDSTEnabled**|RedfishCS_bool| Boolean pointer to **AutoDSTEnabled** property.| No| No
|**CommandShell**|RedfishManager_V1_4_2_CommandShell_CS| Structure points to **CommandShell** property.| No| No
...
|**GraphicalConsole**|RedfishManager_V1_4_2_GraphicalConsole_CS| Structure points to **GraphicalConsole** property.| No| No
|**HostInterfaces**|RedfishCS_Link| Structure link list to **HostInterfaces** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Links**|RedfishManager_V1_4_2_Links_CS| Structure points to **Links** property.| No| No
...
|**SerialConsole**|RedfishManager_V1_4_2_SerialConsole_CS| Structure points to **SerialConsole** property.| No| No
...
## Redfish Manager V1_4_2 to C Structure Function
    RedfishCS_status
    Json_Manager_V1_4_2_To_CS (RedfishCS_char *JsonRawText, RedfishManager_V1_4_2_Manager_CS **ReturnedCS);

## C Structure to Redfish Manager V1_4_2 JSON Function
    RedfishCS_status
    CS_To_Manager_V1_4_2_JSON (RedfishManager_V1_4_2_Manager_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Manager V1_4_2 C Structure Function
    RedfishCS_status
