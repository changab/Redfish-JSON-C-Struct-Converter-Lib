...
//
#include <RedfishInterpreter/Power/v1_0_3/EfiPowerV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_0_3 
...
{
  EFI_REDFISH_POWER_V1_0_3 *PowerV1_0_3;
  EFI_REDFISH_POWER_V1_0_3_CS *PowerV1_0_3Cs;
  ...
  Status = Json_Power_V1_0_3_To_CS (ResoruceRaw, &PowerV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_0_3 = (EFI_REDFISH_POWER_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_0_3));
  if (PowerV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PowerV1_0_3;
  PowerV1_0_3->Power = PowerV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_POWER_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Power_V1_0_3_JSON (*((EFI_REDFISH_POWER_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PowerV1_0_3 = (EFI_REDFISH_POWER_V1_0_3 *)InterpProp;
  DestroyPower_V1_0_3_CS (PowerV1_0_3->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPower_V1_0_3_Json (ResoruceRaw);
}
