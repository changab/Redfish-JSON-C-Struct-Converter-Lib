# Definition of ComputerSystem.V1_1_5 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**ComputerSystem_Reset**|RedfishComputerSystem_V1_1_5_Reset_CS| Structure points to **#ComputerSystem.Reset** property.| No| No
|**ComputerSystem_SetDefaultBootOrder**|RedfishComputerSystem_V1_1_5_SetDefaultBootOrder_CS| Structure points to **#ComputerSystem.SetDefaultBootOrder** property.| No| No
|**Oem**|RedfishComputerSystem_V1_1_5_OemActions_CS| Structure points to **Oem** property.| No| No
...
## ComputerSystem
    typedef struct _RedfishComputerSystem_V1_1_5_ComputerSystem_CS {
        ...
        RedfishComputerSystem_V1_1_5_Actions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_Link Bios;
        RedfishCS_char *BiosVersion;
        RedfishComputerSystem_V1_1_5_Boot_CS *Boot;
        RedfishCS_char *Description;
        RedfishCS_Link EthernetInterfaces;
        RedfishCS_char *HostName;
        RedfishCS_char *Id;
        RedfishCS_char *IndicatorLED;
        RedfishComputerSystem_V1_1_5_Links_CS *Links;
        RedfishCS_Link LogServices;
        RedfishCS_char *Manufacturer;
        RedfishCS_Link Memory;
        RedfishComputerSystem_V1_1_5_MemorySummary_CS *MemorySummary;
        RedfishCS_char *Model;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_char *PartNumber;
        RedfishCS_char *PowerState;
        RedfishComputerSystem_V1_1_5_ProcessorSummary_CS *ProcessorSummary;
        ...
        RedfishComputerSystem_V1_1_5_TrustedModules_CS *TrustedModules;
        RedfishCS_char *UUID;
...
|**Actions**|RedfishComputerSystem_V1_1_5_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Boot**|RedfishComputerSystem_V1_1_5_Boot_CS| Structure points to **Boot** property.| No| No
...
|**Links**|RedfishComputerSystem_V1_1_5_Links_CS| Structure points to **Links** property.| No| No
...
|**MemorySummary**|RedfishComputerSystem_V1_1_5_MemorySummary_CS| Structure points to **MemorySummary** property.| No| No
|**Model**|RedfishCS_char| String pointer to **Model** property.| No| Yes
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PartNumber**|RedfishCS_char| String pointer to **PartNumber** property.| No| Yes
|**PowerState**|RedfishCS_char| String pointer to **PowerState** property.| No| Yes
|**ProcessorSummary**|RedfishComputerSystem_V1_1_5_ProcessorSummary_CS| Structure points to **ProcessorSummary** property.| No| No
...
|**TrustedModules**|RedfishComputerSystem_V1_1_5_TrustedModules_CS| Structure points to **TrustedModules** property.| No| No
|**UUID**|RedfishCS_char| String pointer to **UUID** property.| No| Yes
## Redfish ComputerSystem V1_1_5 to C Structure Function
    RedfishCS_status
    Json_ComputerSystem_V1_1_5_To_CS (RedfishCS_char *JsonRawText, RedfishComputerSystem_V1_1_5_ComputerSystem_CS **ReturnedCS);

## C Structure to Redfish ComputerSystem V1_1_5 JSON Function
    RedfishCS_status
    CS_To_ComputerSystem_V1_1_5_JSON (RedfishComputerSystem_V1_1_5_ComputerSystem_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ComputerSystem V1_1_5 C Structure Function
    RedfishCS_status
