...
#ifndef _RedfishStorage_V1_0_3_CSTRUCT_H_
#define _RedfishStorage_V1_0_3_CSTRUCT_H_
...
#endif
typedef struct _RedfishStorage_V1_0_3_StorageController_Array_CS RedfishStorage_V1_0_3_StorageController_Array_CS;
...
typedef struct _RedfishStorage_V1_0_3_SetEncryptionKey_CS RedfishStorage_V1_0_3_SetEncryptionKey_CS;
typedef struct _RedfishStorage_V1_0_3_Storage_CS RedfishStorage_V1_0_3_Storage_CS;
typedef struct _RedfishStorage_V1_0_3_StorageController_CS RedfishStorage_V1_0_3_StorageController_CS;
typedef struct _RedfishStorage_V1_0_3_Storage_Actions_CS RedfishStorage_V1_0_3_Storage_Actions_CS;
typedef struct _RedfishStorage_V1_0_3_Storage_Actions_Oem_CS RedfishStorage_V1_0_3_Storage_Actions_Oem_CS;
typedef struct _RedfishStorage_V1_0_3_Storage_Links_CS RedfishStorage_V1_0_3_Storage_Links_CS;
//
...
typedef struct _RedfishStorage_V1_0_3_Storage_Actions_CS {
    ...
    RedfishStorage_V1_0_3_Storage_Actions_Oem_CS    *Oem;                        // The available OEM specific
...
typedef struct _RedfishStorage_V1_0_3_Storage_CS {
    ...
    RedfishStorage_V1_0_3_Storage_Actions_CS            *Actions;                                  // The available actions for this
                                                                                                   // resource.
    ...
    RedfishCS_char                                      *Id;                                   
    RedfishStorage_V1_0_3_Storage_Links_CS              *Links;                                    // Contains references to other
    ...
    RedfishResource_Status_CS                           *Status;                               
    RedfishStorage_V1_0_3_StorageController_Array_CS    *StorageControllers;                       // The set of storage controllers
                                                                                                   // represented by this resource.
...
typedef struct _RedfishStorage_V1_0_3_StorageController_Array_CS  {
    RedfishStorage_V1_0_3_StorageController_Array_CS    *Next;
    RedfishStorage_V1_0_3_StorageController_CS    *ArrayValue;
} RedfishStorage_V1_0_3_StorageController_Array_CS;

RedfishCS_status
Json_Storage_V1_0_3_To_CS (char *JsonRawText, RedfishStorage_V1_0_3_Storage_CS **ReturnedCS);

RedfishCS_status
CS_To_Storage_V1_0_3_JSON (RedfishStorage_V1_0_3_Storage_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyStorage_V1_0_3_CS (RedfishStorage_V1_0_3_Storage_CS *CSPtr);

RedfishCS_status
DestroyStorage_V1_0_3_Json (RedfishCS_char *JsonText);
