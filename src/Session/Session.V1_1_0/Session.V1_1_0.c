...
#include"Redfish_Session_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenActions_OemCs(RedfishSession_V1_1_0_Session_CS *Cs, json_t *JsonObj, char *Key, RedfishSession_V1_1_0_Session_Actions_Oem_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSession_V1_1_0_Session_Actions_Oem_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishSession_V1_1_0_Session_CS *Cs, json_t *JsonObj, char *Key, RedfishSession_V1_1_0_Session_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSession_V1_1_0_Session_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishSession_V1_1_0_Session_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSession_V1_1_0_Session_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSession_V1_1_0_Session_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Session.V1_1_0.Session
//
RedfishCS_status CS_To_Session_V1_1_0_JSON(RedfishSession_V1_1_0_Session_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Session.V1_1_0.Session
//
RedfishCS_status DestroySession_V1_1_0_CS(RedfishSession_V1_1_0_Session_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Session.V1_1_0.Session
//
RedfishCS_status DestroySession_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Session.V1_1_0.Session
//
RedfishCS_status
Json_Session_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishSession_V1_1_0_Session_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSession_V1_1_0_Session_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Session", "v1_1_0", "Session", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSession_V1_1_0_Session_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
