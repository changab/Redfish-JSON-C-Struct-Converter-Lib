...
//
#include <RedfishInterpreter/Task/v1_1_3/EfiTaskV1_1_3.h>
...
{
  EFI_REDFISH_TASK_V1_1_3 *TaskV1_1_3;
  EFI_REDFISH_TASK_V1_1_3_CS *TaskV1_1_3Cs;
  ...
  Status = Json_Task_V1_1_3_To_CS (ResoruceRaw, &TaskV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_1_3 = (EFI_REDFISH_TASK_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_1_3));
  if (TaskV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskV1_1_3;
  TaskV1_1_3->Task = TaskV1_1_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_TASK_V1_1_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Task_V1_1_3_JSON (*((EFI_REDFISH_TASK_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskV1_1_3 = (EFI_REDFISH_TASK_V1_1_3 *)InterpProp;
  DestroyTask_V1_1_3_CS (TaskV1_1_3->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTask_V1_1_3_Json (ResoruceRaw);
}
