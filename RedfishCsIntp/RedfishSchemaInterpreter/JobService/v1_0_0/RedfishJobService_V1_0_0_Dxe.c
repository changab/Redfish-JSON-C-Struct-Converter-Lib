...
//
#include <RedfishInterpreter/JobService/v1_0_0/EfiJobServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#JobService";
BOOLEAN IsRevisonController = TRUE;

// Support JobService V1_0_0 
...
{
  EFI_REDFISH_JOBSERVICE_V1_0_0 *JobServiceV1_0_0;
  EFI_REDFISH_JOBSERVICE_V1_0_0_CS *JobServiceV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "JobService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_JobService_V1_0_0_To_CS (ResoruceRaw, &JobServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobServiceV1_0_0 = (EFI_REDFISH_JOBSERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOBSERVICE_V1_0_0));
  if (JobServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)JobServiceV1_0_0;
  JobServiceV1_0_0->JobService = JobServiceV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_JOBSERVICE_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("JobService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "JobService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("JobService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "JobService");
...
)
{
  ...
  return CS_To_JobService_V1_0_0_JSON (*((EFI_REDFISH_JOBSERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in JobServiceToStruct.
...
)
{
  ...
  JobServiceV1_0_0 = (EFI_REDFISH_JOBSERVICE_V1_0_0 *)InterpProp;
  DestroyJobService_V1_0_0_CS (JobServiceV1_0_0->JobService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from JobServiceFromEfiStruct
...
)
{
  ...
  return DestroyJobService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
