...
//
#include <RedfishInterpreter/TelemetryService/v1_0_0/EfiTelemetryServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#TelemetryService";
BOOLEAN IsRevisonController = TRUE;

// Support TelemetryService V1_0_0 
...
{
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_0 *TelemetryServiceV1_0_0;
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_0_CS *TelemetryServiceV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "TelemetryService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_TelemetryService_V1_0_0_To_CS (ResoruceRaw, &TelemetryServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TelemetryServiceV1_0_0 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TELEMETRYSERVICE_V1_0_0));
  if (TelemetryServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TelemetryServiceV1_0_0;
  TelemetryServiceV1_0_0->TelemetryService = TelemetryServiceV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_TELEMETRYSERVICE_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("TelemetryService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "TelemetryService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("TelemetryService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "TelemetryService");
...
)
{
  ...
  return CS_To_TelemetryService_V1_0_0_JSON (*((EFI_REDFISH_TELEMETRYSERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in TelemetryServiceToStruct.
...
EFI_STATUS
EFIAPI
TelemetryServiceDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  TelemetryServiceV1_0_0 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_0 *)InterpProp;
  DestroyTelemetryService_V1_0_0_CS (TelemetryServiceV1_0_0->TelemetryService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from TelemetryServiceFromEfiStruct
...
)
{
  ...
  return DestroyTelemetryService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
