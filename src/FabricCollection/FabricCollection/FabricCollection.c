...
#include"Redfish_FabricCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishFabricCollection_FabricCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for FabricCollection.FabricCollection
//
RedfishCS_status CS_To_FabricCollection_JSON(RedfishFabricCollection_FabricCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for FabricCollection.FabricCollection
//
RedfishCS_status DestroyFabricCollection_CS(RedfishFabricCollection_FabricCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for FabricCollection.FabricCollection
//
RedfishCS_status DestroyFabricCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for FabricCollection.NOVERSIONED.FabricCollection
//
RedfishCS_status
Json_FabricCollection_To_CS(RedfishCS_char *JsonRawText, RedfishFabricCollection_FabricCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishFabricCollection_FabricCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "FabricCollection", "noversioned", "FabricCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishFabricCollection_FabricCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
