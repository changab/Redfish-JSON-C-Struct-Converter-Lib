...
#include"Redfish_StorageCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishStorageCollection_StorageCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for StorageCollection.StorageCollection
//
RedfishCS_status CS_To_StorageCollection_JSON(RedfishStorageCollection_StorageCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for StorageCollection.StorageCollection
//
RedfishCS_status DestroyStorageCollection_CS(RedfishStorageCollection_StorageCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for StorageCollection.StorageCollection
//
RedfishCS_status DestroyStorageCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for StorageCollection.NOVERSIONED.StorageCollection
//
RedfishCS_status
Json_StorageCollection_To_CS(RedfishCS_char *JsonRawText, RedfishStorageCollection_StorageCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishStorageCollection_StorageCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "StorageCollection", "noversioned", "StorageCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishStorageCollection_StorageCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyStorageCollection_CS (Cs);
  return Status;
}
