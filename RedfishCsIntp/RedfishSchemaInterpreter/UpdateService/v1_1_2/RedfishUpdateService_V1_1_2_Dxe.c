...
//
#include <RedfishInterpreter/UpdateService/v1_1_2/EfiUpdateServiceV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_1_2 
...
{
  EFI_REDFISH_UPDATESERVICE_V1_1_2 *UpdateServiceV1_1_2;
  EFI_REDFISH_UPDATESERVICE_V1_1_2_CS *UpdateServiceV1_1_2Cs;
  ...
  Status = Json_UpdateService_V1_1_2_To_CS (ResoruceRaw, &UpdateServiceV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_1_2 = (EFI_REDFISH_UPDATESERVICE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_1_2));
  if (UpdateServiceV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)UpdateServiceV1_1_2;
  UpdateServiceV1_1_2->UpdateService = UpdateServiceV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_UPDATESERVICE_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_UpdateService_V1_1_2_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  UpdateServiceV1_1_2 = (EFI_REDFISH_UPDATESERVICE_V1_1_2 *)InterpProp;
  DestroyUpdateService_V1_1_2_CS (UpdateServiceV1_1_2->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyUpdateService_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
