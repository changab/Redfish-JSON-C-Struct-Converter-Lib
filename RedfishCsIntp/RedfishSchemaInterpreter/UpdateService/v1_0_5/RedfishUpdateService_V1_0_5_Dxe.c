...
//
#include <RedfishInterpreter/UpdateService/v1_0_5/EfiUpdateServiceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_0_5 
...
{
  EFI_REDFISH_UPDATESERVICE_V1_0_5 *UpdateServiceV1_0_5;
  EFI_REDFISH_UPDATESERVICE_V1_0_5_CS *UpdateServiceV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "UpdateService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_UpdateService_V1_0_5_To_CS (ResoruceRaw, &UpdateServiceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_0_5 = (EFI_REDFISH_UPDATESERVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_0_5));
  if (UpdateServiceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)UpdateServiceV1_0_5;
  UpdateServiceV1_0_5->UpdateService = UpdateServiceV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_UPDATESERVICE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("UpdateService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "UpdateService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("UpdateService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "UpdateService");
...
)
{
  ...
  return CS_To_UpdateService_V1_0_5_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in UpdateServiceToStruct.
...
)
{
  ...
  UpdateServiceV1_0_5 = (EFI_REDFISH_UPDATESERVICE_V1_0_5 *)InterpProp;
  DestroyUpdateService_V1_0_5_CS (UpdateServiceV1_0_5->UpdateService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from UpdateServiceFromEfiStruct
...
)
{
  ...
  return DestroyUpdateService_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
