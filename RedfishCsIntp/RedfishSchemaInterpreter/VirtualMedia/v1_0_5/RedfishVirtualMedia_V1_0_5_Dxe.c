...
//
#include <RedfishInterpreter/VirtualMedia/v1_0_5/EfiVirtualMediaV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_0_5 
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_0_5 *VirtualMediaV1_0_5;
  EFI_REDFISH_VIRTUALMEDIA_V1_0_5_CS *VirtualMediaV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "VirtualMedia") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_VirtualMedia_V1_0_5_To_CS (ResoruceRaw, &VirtualMediaV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_0_5 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_0_5));
  if (VirtualMediaV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VirtualMediaV1_0_5;
  VirtualMediaV1_0_5->VirtualMedia = VirtualMediaV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("VirtualMedia"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "VirtualMedia");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("VirtualMedia"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "VirtualMedia");
...
)
{
  ...
  return CS_To_VirtualMedia_V1_0_5_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in VirtualMediaToStruct.
...
)
{
  ...
  VirtualMediaV1_0_5 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_5 *)InterpProp;
  DestroyVirtualMedia_V1_0_5_CS (VirtualMediaV1_0_5->VirtualMedia); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from VirtualMediaFromEfiStruct
...
)
{
  ...
  return DestroyVirtualMedia_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
