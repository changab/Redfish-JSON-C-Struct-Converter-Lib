...
//
#include <RedfishInterpreter/Processor/v1_0_5/EfiProcessorV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_0_5 
...
{
  EFI_REDFISH_PROCESSOR_V1_0_5 *ProcessorV1_0_5;
  EFI_REDFISH_PROCESSOR_V1_0_5_CS *ProcessorV1_0_5Cs;
  ...
  Status = Json_Processor_V1_0_5_To_CS (ResoruceRaw, &ProcessorV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_0_5 = (EFI_REDFISH_PROCESSOR_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_0_5));
  if (ProcessorV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ProcessorV1_0_5;
  ProcessorV1_0_5->Processor = ProcessorV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_PROCESSOR_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Processor_V1_0_5_JSON (*((EFI_REDFISH_PROCESSOR_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ProcessorV1_0_5 = (EFI_REDFISH_PROCESSOR_V1_0_5 *)InterpProp;
  DestroyProcessor_V1_0_5_CS (ProcessorV1_0_5->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyProcessor_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_5EntryPoint (
