...
//
#include <RedfishInterpreter/TaskService/v1_0_5/EfiTaskServiceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_0_5 
...
{
  EFI_REDFISH_TASKSERVICE_V1_0_5 *TaskServiceV1_0_5;
  EFI_REDFISH_TASKSERVICE_V1_0_5_CS *TaskServiceV1_0_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "TaskService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_TaskService_V1_0_5_To_CS (ResoruceRaw, &TaskServiceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_0_5 = (EFI_REDFISH_TASKSERVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_0_5));
  if (TaskServiceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskServiceV1_0_5;
  TaskServiceV1_0_5->TaskService = TaskServiceV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_TASKSERVICE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("TaskService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "TaskService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("TaskService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "TaskService");
...
)
{
  ...
  return CS_To_TaskService_V1_0_5_JSON (*((EFI_REDFISH_TASKSERVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in TaskServiceToStruct.
...
)
{
  ...
  TaskServiceV1_0_5 = (EFI_REDFISH_TASKSERVICE_V1_0_5 *)InterpProp;
  DestroyTaskService_V1_0_5_CS (TaskServiceV1_0_5->TaskService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from TaskServiceFromEfiStruct
...
)
{
  ...
  return DestroyTaskService_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
