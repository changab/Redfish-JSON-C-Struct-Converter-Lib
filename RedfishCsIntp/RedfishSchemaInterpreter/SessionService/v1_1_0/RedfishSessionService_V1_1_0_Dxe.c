...
//
#include <RedfishInterpreter/SessionService/v1_1_0/EfiSessionServiceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_1_0 
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_1_0 *SessionServiceV1_1_0;
  EFI_REDFISH_SESSIONSERVICE_V1_1_0_CS *SessionServiceV1_1_0Cs;
  ...
  Status = Json_SessionService_V1_1_0_To_CS (ResoruceRaw, &SessionServiceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_1_0 = (EFI_REDFISH_SESSIONSERVICE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_0));
  if (SessionServiceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SessionServiceV1_1_0;
  SessionServiceV1_1_0->SessionService = SessionServiceV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SessionService_V1_1_0_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SessionServiceV1_1_0 = (EFI_REDFISH_SESSIONSERVICE_V1_1_0 *)InterpProp;
  DestroySessionService_V1_1_0_CS (SessionServiceV1_1_0->SessionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySessionService_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
