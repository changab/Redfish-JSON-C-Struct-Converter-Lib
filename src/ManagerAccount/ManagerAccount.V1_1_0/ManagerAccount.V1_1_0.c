...
#include"Redfish_ManagerAccount_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishManagerAccount_V1_1_0_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenActions_OemCs(RedfishManagerAccount_V1_1_0_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_1_0_ManagerAccount_Actions_Oem_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_1_0_ManagerAccount_Actions_Oem_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishManagerAccount_V1_1_0_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_1_0_ManagerAccount_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_1_0_ManagerAccount_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishManagerAccount_V1_1_0_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_1_0_ManagerAccount_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_1_0_ManagerAccount_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
  ...
  // Role
  InitializeLinkHead (&(*Dst)->Role);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "Role", Cs->Header.ThisUri, &(*Dst)->Role);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishManagerAccount_V1_1_0_ManagerAccount_Actions_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishManagerAccount_V1_1_0_ManagerAccount_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishManagerAccount_V1_1_0_ManagerAccount_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // Role 
  if (InsertJsonLinkObj (CsJson, "Role", &CSPtr->Role) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for ManagerAccount.V1_1_0.ManagerAccount
//
RedfishCS_status CS_To_ManagerAccount_V1_1_0_JSON(RedfishManagerAccount_V1_1_0_ManagerAccount_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Locked 
  if (InsertJsonBoolObj (CsJson, "Locked", CSPtr->Locked) != RedfishCS_status_success) {goto Error;}
  ...
  // RoleId 
  if (InsertJsonStringObj (CsJson, "RoleId", CSPtr->RoleId) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for ManagerAccount.V1_1_0.ManagerAccount
//
RedfishCS_status DestroyManagerAccount_V1_1_0_CS(RedfishManagerAccount_V1_1_0_ManagerAccount_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ManagerAccount.V1_1_0.ManagerAccount
//
RedfishCS_status DestroyManagerAccount_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ManagerAccount.V1_1_0.ManagerAccount
//
RedfishCS_status
Json_ManagerAccount_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishManagerAccount_V1_1_0_ManagerAccount_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManagerAccount_V1_1_0_ManagerAccount_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ManagerAccount", "v1_1_0", "ManagerAccount", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManagerAccount_V1_1_0_ManagerAccount_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Locked
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "Locked", &Cs->Locked);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // RoleId
  Status = GetRedfishPropertyStr (Cs, JsonObj, "RoleId", &Cs->RoleId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyManagerAccount_V1_1_0_CS (Cs);
  return Status;
}
