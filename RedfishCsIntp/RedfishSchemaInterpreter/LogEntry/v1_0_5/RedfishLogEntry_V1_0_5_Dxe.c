...
//
#include <RedfishInterpreter/LogEntry/v1_0_5/EfiLogEntryV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_0_5 
...
{
  EFI_REDFISH_LOGENTRY_V1_0_5 *LogEntryV1_0_5;
  EFI_REDFISH_LOGENTRY_V1_0_5_CS *LogEntryV1_0_5Cs;
  ...
  Status = Json_LogEntry_V1_0_5_To_CS (ResoruceRaw, &LogEntryV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_0_5 = (EFI_REDFISH_LOGENTRY_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_0_5));
  if (LogEntryV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_0_5;
  LogEntryV1_0_5->LogEntry = LogEntryV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_0_5_JSON (*((EFI_REDFISH_LOGENTRY_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_0_5 = (EFI_REDFISH_LOGENTRY_V1_0_5 *)InterpProp;
  DestroyLogEntry_V1_0_5_CS (LogEntryV1_0_5->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_0_5EntryPoint (
