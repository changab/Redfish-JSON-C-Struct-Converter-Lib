...
//
#include <RedfishInterpreter/ManagerNetworkProtocol/v1_3_0/EfiManagerNetworkProtocolV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_3_0 
...
EFI_STATUS
EFIAPI
ManagerNetworkProtocolToEfiStruct (
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_0 *ManagerNetworkProtocolV1_3_0;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_0_CS *ManagerNetworkProtocolV1_3_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.MinorVersion, "3") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "0") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ManagerNetworkProtocol") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_ManagerNetworkProtocol_V1_3_0_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_3_0 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_0));
  if (ManagerNetworkProtocolV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerNetworkProtocolV1_3_0;
  ManagerNetworkProtocolV1_3_0->ManagerNetworkProtocol = ManagerNetworkProtocolV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerNetworkProtocol"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "ManagerNetworkProtocol");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerNetworkProtocol"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "ManagerNetworkProtocol");
...
EFI_STATUS
EFIAPI
ManagerNetworkProtocolFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_ManagerNetworkProtocol_V1_3_0_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ManagerNetworkProtocolToStruct.
...
EFI_STATUS
EFIAPI
ManagerNetworkProtocolDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  ManagerNetworkProtocolV1_3_0 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_0 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_3_0_CS (ManagerNetworkProtocolV1_3_0->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ManagerNetworkProtocolFromEfiStruct
...
EFI_STATUS
EFIAPI
ManagerNetworkProtocolDestoryJson(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
  IN EFI_REST_RESOURCE_TYPE_IDENTIFIER *RsrcIdentifier,  
  IN CHAR8 *ResoruceRaw
)
{
  ...
  return DestroyManagerNetworkProtocol_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
