...
#ifndef _RedfishMemory_V1_4_0_CSTRUCT_H_
#define _RedfishMemory_V1_4_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemory_V1_4_0_RegionSet_Array_CS RedfishMemory_V1_4_0_RegionSet_Array_CS;
typedef struct _RedfishMemory_V1_4_0_Actions_CS RedfishMemory_V1_4_0_Actions_CS;
typedef struct _RedfishMemory_V1_4_0_DisablePassphrase_CS RedfishMemory_V1_4_0_DisablePassphrase_CS;
typedef struct _RedfishMemory_V1_4_0_Links_CS RedfishMemory_V1_4_0_Links_CS;
typedef struct _RedfishMemory_V1_4_0_Memory_CS RedfishMemory_V1_4_0_Memory_CS;
typedef struct _RedfishMemory_V1_4_0_MemoryLocation_CS RedfishMemory_V1_4_0_MemoryLocation_CS;
typedef struct _RedfishMemory_V1_4_0_OemActions_CS RedfishMemory_V1_4_0_OemActions_CS;
typedef struct _RedfishMemory_V1_4_0_PowerManagementPolicy_CS RedfishMemory_V1_4_0_PowerManagementPolicy_CS;
typedef struct _RedfishMemory_V1_4_0_RegionSet_CS RedfishMemory_V1_4_0_RegionSet_CS;
typedef struct _RedfishMemory_V1_4_0_SecureEraseUnit_CS RedfishMemory_V1_4_0_SecureEraseUnit_CS;
typedef struct _RedfishMemory_V1_4_0_SecurityCapabilities_CS RedfishMemory_V1_4_0_SecurityCapabilities_CS;
typedef struct _RedfishMemory_V1_4_0_SetPassphrase_CS RedfishMemory_V1_4_0_SetPassphrase_CS;
typedef struct _RedfishMemory_V1_4_0_UnlockUnit_CS RedfishMemory_V1_4_0_UnlockUnit_CS;
...
typedef struct _RedfishMemory_V1_4_0_Memory_CS {
    ...
    RedfishMemory_V1_4_0_Actions_CS                  *Actions;                                   // The available actions for this
                                                                                                 // resource.
    ...
    RedfishMemory_V1_4_0_Links_CS                    *Links;                                     // Contains references to other
    ...
    RedfishMemory_V1_4_0_MemoryLocation_CS           *MemoryLocation;                            // Memory connection information
    ...
    RedfishMemory_V1_4_0_PowerManagementPolicy_CS    *PowerManagementPolicy;                     // Power management policy
                                                                                                 // information.
    RedfishCS_int64                                  *RankCount;                                 // Number of ranks available in
                                                                                                 // the Memory.
    RedfishMemory_V1_4_0_RegionSet_Array_CS          *Regions;                                   // Memory regions information
                                                                                                 // within the Memory.
    RedfishMemory_V1_4_0_SecurityCapabilities_CS     *SecurityCapabilities;                      // This object contains security
...
typedef struct _RedfishMemory_V1_4_0_RegionSet_Array_CS  {
    RedfishMemory_V1_4_0_RegionSet_Array_CS    *Next;
    RedfishMemory_V1_4_0_RegionSet_CS    *ArrayValue;
} RedfishMemory_V1_4_0_RegionSet_Array_CS;

RedfishCS_status
Json_Memory_V1_4_0_To_CS (char *JsonRawText, RedfishMemory_V1_4_0_Memory_CS **ReturnedCS);

RedfishCS_status
CS_To_Memory_V1_4_0_JSON (RedfishMemory_V1_4_0_Memory_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemory_V1_4_0_CS (RedfishMemory_V1_4_0_Memory_CS *CSPtr);

RedfishCS_status
DestroyMemory_V1_4_0_Json (RedfishCS_char *JsonText);
