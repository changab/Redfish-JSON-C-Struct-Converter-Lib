...
//
#include <RedfishInterpreter/NetworkAdapter/v1_1_1/EfiNetworkAdapterV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_1_1 
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_1_1 *NetworkAdapterV1_1_1;
  EFI_REDFISH_NETWORKADAPTER_V1_1_1_CS *NetworkAdapterV1_1_1Cs;
  ...
  Status = Json_NetworkAdapter_V1_1_1_To_CS (ResoruceRaw, &NetworkAdapterV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_1_1 = (EFI_REDFISH_NETWORKADAPTER_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_1_1));
  if (NetworkAdapterV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkAdapterV1_1_1;
  NetworkAdapterV1_1_1->NetworkAdapter = NetworkAdapterV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_NETWORKADAPTER_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkAdapter_V1_1_1_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkAdapterV1_1_1 = (EFI_REDFISH_NETWORKADAPTER_V1_1_1 *)InterpProp;
  DestroyNetworkAdapter_V1_1_1_CS (NetworkAdapterV1_1_1->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkAdapter_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
