...
//
#include <RedfishInterpreter/ComputerSystem/v1_1_4/EfiComputerSystemV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_1_4 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_4 *ComputerSystemV1_1_4;
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_4_CS *ComputerSystemV1_1_4Cs;
  ...
  Status = Json_ComputerSystem_V1_1_4_To_CS (ResoruceRaw, &ComputerSystemV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_1_4 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_1_4));
  if (ComputerSystemV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_1_4;
  ComputerSystemV1_1_4->ComputerSystem = ComputerSystemV1_1_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_1_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_1_4_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_1_4 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_4 *)InterpProp;
  DestroyComputerSystem_V1_1_4_CS (ComputerSystemV1_1_4->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
