...
//
#include <RedfishInterpreter/EthernetInterface/v1_0_6/EfiEthernetInterfaceV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_6 
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_6 *EthernetInterfaceV1_0_6;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_6_CS *EthernetInterfaceV1_0_6Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "EthernetInterface") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_EthernetInterface_V1_0_6_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_6 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_6));
  if (EthernetInterfaceV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EthernetInterfaceV1_0_6;
  EthernetInterfaceV1_0_6->EthernetInterface = EthernetInterfaceV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_6_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("EthernetInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "EthernetInterface");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("EthernetInterface"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "EthernetInterface");
...
EFI_STATUS
EFIAPI
EthernetInterfaceFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_EthernetInterface_V1_0_6_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in EthernetInterfaceToStruct.
...
EFI_STATUS
EFIAPI
EthernetInterfaceDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  EthernetInterfaceV1_0_6 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_6 *)InterpProp;
  DestroyEthernetInterface_V1_0_6_CS (EthernetInterfaceV1_0_6->EthernetInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EthernetInterfaceFromEfiStruct
...
)
{
  ...
  return DestroyEthernetInterface_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
