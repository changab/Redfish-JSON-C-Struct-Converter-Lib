...
//
#include <RedfishInterpreter/Manager/v1_0_5/EfiManagerV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_0_5 
...
{
  EFI_REDFISH_MANAGER_V1_0_5 *ManagerV1_0_5;
  EFI_REDFISH_MANAGER_V1_0_5_CS *ManagerV1_0_5Cs;
  ...
  Status = Json_Manager_V1_0_5_To_CS (ResoruceRaw, &ManagerV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_0_5 = (EFI_REDFISH_MANAGER_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_0_5));
  if (ManagerV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_0_5;
  ManagerV1_0_5->Manager = ManagerV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_0_5_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_0_5_JSON (*((EFI_REDFISH_MANAGER_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_0_5 = (EFI_REDFISH_MANAGER_V1_0_5 *)InterpProp;
  DestroyManager_V1_0_5_CS (ManagerV1_0_5->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_0_5EntryPoint (
