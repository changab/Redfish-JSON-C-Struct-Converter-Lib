...
//
#include <RedfishInterpreter/ManagerAccount/v1_1_0/EfiManagerAccountV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_1_0 
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_1_0 *ManagerAccountV1_1_0;
  EFI_REDFISH_MANAGERACCOUNT_V1_1_0_CS *ManagerAccountV1_1_0Cs;
  ...
  Status = Json_ManagerAccount_V1_1_0_To_CS (ResoruceRaw, &ManagerAccountV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_1_0 = (EFI_REDFISH_MANAGERACCOUNT_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_1_0));
  if (ManagerAccountV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerAccountV1_1_0;
  ManagerAccountV1_1_0->ManagerAccount = ManagerAccountV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ManagerAccount_V1_1_0_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerAccountV1_1_0 = (EFI_REDFISH_MANAGERACCOUNT_V1_1_0 *)InterpProp;
  DestroyManagerAccount_V1_1_0_CS (ManagerAccountV1_1_0->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManagerAccount_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
