# Definition of EthernetInterface.V1_2_2 and functions<br><br>
...
## EthernetInterface
    typedef struct _RedfishEthernetInterface_V1_2_2_EthernetInterface_CS {
        ...
        RedfishEthernetInterface_V1_2_2_IPv6AddressPolicyEntry_CS *IPv6AddressPolicyTable;
        ...
        RedfishEthernetInterface_V1_2_2_Links_CS *Links;
...
|**IPv6AddressPolicyTable**|RedfishEthernetInterface_V1_2_2_IPv6AddressPolicyEntry_CS| Structure points to **IPv6AddressPolicyTable** property.| No| No
...
|**Links**|RedfishEthernetInterface_V1_2_2_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish EthernetInterface V1_2_2 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EthernetInterface V1_2_2 JSON Function
    RedfishCS_status
    CS_To_EthernetInterface_V1_2_2_JSON (RedfishEthernetInterface_V1_2_2_EthernetInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EthernetInterface V1_2_2 C Structure Function
    RedfishCS_status
