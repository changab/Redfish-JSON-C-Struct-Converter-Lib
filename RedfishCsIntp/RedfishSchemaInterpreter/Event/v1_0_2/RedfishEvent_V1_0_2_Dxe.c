...
//
#include <RedfishInterpreter/Event/v1_0_2/EfiEventV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_2 
...
{
  EFI_REDFISH_EVENT_V1_0_2 *EventV1_0_2;
  EFI_REDFISH_EVENT_V1_0_2_CS *EventV1_0_2Cs;
  ...
  Status = Json_Event_V1_0_2_To_CS (ResoruceRaw, &EventV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_2 = (EFI_REDFISH_EVENT_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_2));
  if (EventV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_0_2;
  EventV1_0_2->Event = EventV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_EVENT_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_0_2_JSON (*((EFI_REDFISH_EVENT_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_0_2 = (EFI_REDFISH_EVENT_V1_0_2 *)InterpProp;
  DestroyEvent_V1_0_2_CS (EventV1_0_2->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_0_2_Json (ResoruceRaw);
}
