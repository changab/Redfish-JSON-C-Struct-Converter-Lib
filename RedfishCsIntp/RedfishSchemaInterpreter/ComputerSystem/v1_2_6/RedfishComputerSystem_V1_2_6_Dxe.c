...
//
#include <RedfishInterpreter/ComputerSystem/v1_2_6/EfiComputerSystemV1_2_6.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_2_6 
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_2_6 *ComputerSystemV1_2_6;
  EFI_REDFISH_COMPUTERSYSTEM_V1_2_6_CS *ComputerSystemV1_2_6Cs;
  ...
  Status = Json_ComputerSystem_V1_2_6_To_CS (ResoruceRaw, &ComputerSystemV1_2_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_2_6 = (EFI_REDFISH_COMPUTERSYSTEM_V1_2_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_2_6));
  if (ComputerSystemV1_2_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ComputerSystemV1_2_6;
  ComputerSystemV1_2_6->ComputerSystem = ComputerSystemV1_2_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_2_6_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_ComputerSystem_V1_2_6_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_2_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ComputerSystemV1_2_6 = (EFI_REDFISH_COMPUTERSYSTEM_V1_2_6 *)InterpProp;
  DestroyComputerSystem_V1_2_6_CS (ComputerSystemV1_2_6->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyComputerSystem_V1_2_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_2_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_2_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
