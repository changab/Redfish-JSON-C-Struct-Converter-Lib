...
#ifndef _RedfishComputersystem_V1_2_2_CSTRUCT_H_
#define _RedfishComputersystem_V1_2_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_2_2_TrustedModules_Array_CS RedfishComputerSystem_V1_2_2_TrustedModules_Array_CS;
typedef struct _RedfishComputerSystem_V1_2_2_Boot_CS RedfishComputerSystem_V1_2_2_Boot_CS;
typedef struct _RedfishComputerSystem_V1_2_2_ComputerSystem_CS RedfishComputerSystem_V1_2_2_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_CS RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_CS;
typedef struct _RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_Oem_CS RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_Oem_CS;
typedef struct _RedfishComputerSystem_V1_2_2_ComputerSystem_Links_CS RedfishComputerSystem_V1_2_2_ComputerSystem_Links_CS;
typedef struct _RedfishComputerSystem_V1_2_2_HostedServices_CS RedfishComputerSystem_V1_2_2_HostedServices_CS;
typedef struct _RedfishComputerSystem_V1_2_2_MemorySummary_CS RedfishComputerSystem_V1_2_2_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_2_2_ProcessorSummary_CS RedfishComputerSystem_V1_2_2_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_2_2_Reset_CS RedfishComputerSystem_V1_2_2_Reset_CS;
typedef struct _RedfishComputerSystem_V1_2_2_TrustedModules_CS RedfishComputerSystem_V1_2_2_TrustedModules_CS;
...
//
typedef struct _RedfishComputerSystem_V1_2_2_Boot_CS {
    ...
    RedfishCS_char    *UefiTargetBootSourceOverride;    // This property is the UEFI
                                                       ...
                                                       // UefiTarget.
} RedfishComputerSystem_V1_2_2_Boot_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_CS {
    RedfishComputerSystem_V1_2_2_Reset_CS                         *ComputerSystem_Reset;
    RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_Oem_CS    *Oem;                    // The available OEM specific
                                                                                           // actions for this resource.
} RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_Oem_CS {
    RedfishCS_Link    Prop;
} RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_Oem_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishComputerSystem_V1_2_2_ComputerSystem_Links_CS {
...
typedef struct _RedfishComputerSystem_V1_2_2_MemorySummary_CS {
    ...
    RedfishCS_int64              *TotalSystemMemoryGiB;    // The total configured operating
                                                          ...
                                                          // (RAM), measured in GiB.
} RedfishComputerSystem_V1_2_2_MemorySummary_CS;

//
// This object describes the central processors of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_2_2_ProcessorSummary_CS {
    ...
    RedfishResource_Status_CS    *Status;
} RedfishComputerSystem_V1_2_2_ProcessorSummary_CS;

//
// This action is used to reset the system.
//
typedef struct _RedfishComputerSystem_V1_2_2_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_2_2_Reset_CS;

//
// This object describes the inventory of a Trusted Modules installed in the
// system.
//
typedef struct _RedfishComputerSystem_V1_2_2_TrustedModules_CS {
    ...
    RedfishResource_Oem_CS       *Oem;           
    RedfishResource_Status_CS    *Status;        
} RedfishComputerSystem_V1_2_2_TrustedModules_CS;
...
// machine.
//
typedef struct _RedfishComputerSystem_V1_2_2_ComputerSystem_CS {
    RedfishCS_Header                                          Header;
    RedfishCS_char                                            *odata_context;                   
    RedfishCS_char                                            *odata_id;                        
    RedfishCS_char                                            *odata_type;                      
    RedfishComputerSystem_V1_2_2_ComputerSystem_Actions_CS    *Actions;                             // The available actions for this
                                                                                                    // resource.
    ...
    RedfishComputerSystem_V1_2_2_Boot_CS                      *Boot;                                // Information about the boot
    ...
    RedfishCS_char                                            *HostName;                            // The DNS Host Name, without any
                                                                                                    // domain information.
    RedfishComputerSystem_V1_2_2_HostedServices_CS            *HostedServices;                      // The services that this
    ...
    RedfishCS_char                                            *IndicatorLED;                        // The state of the indicator
                                                                                                    ...
                                                                                                    // system.
    RedfishComputerSystem_V1_2_2_ComputerSystem_Links_CS      *Links;                               // Contains references to other
    ...
    RedfishCS_Link                                            MemoryDomains;                        // A reference to the collection
                                                                                                    ...
                                                                                                    // with this system.
    RedfishComputerSystem_V1_2_2_MemorySummary_CS             *MemorySummary;                       // This object describes the
    ...
    RedfishCS_char                                            *PowerState;                          // This is the current power
                                                                                                    // state of the system.
    RedfishComputerSystem_V1_2_2_ProcessorSummary_CS          *ProcessorSummary;                    // This object describes the
    ...
    RedfishComputerSystem_V1_2_2_TrustedModules_Array_CS      *TrustedModules;                      // This object describes the
                                                                                                    // array of Trusted Modules in
                                                                                                    // the system.
    RedfishCS_char                                            *UUID;                                // The universal unique
                                                                                                    // identifier (UUID) for this
                                                                                                    // system.
} RedfishComputerSystem_V1_2_2_ComputerSystem_CS;
...
typedef struct _RedfishComputerSystem_V1_2_2_TrustedModules_Array_CS  {
    RedfishComputerSystem_V1_2_2_TrustedModules_Array_CS    *Next;
    RedfishComputerSystem_V1_2_2_TrustedModules_CS    *ArrayValue;
} RedfishComputerSystem_V1_2_2_TrustedModules_Array_CS;

RedfishCS_status
Json_ComputerSystem_V1_2_2_To_CS (char *JsonRawText, RedfishComputerSystem_V1_2_2_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_2_2_JSON (RedfishComputerSystem_V1_2_2_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_2_2_CS (RedfishComputerSystem_V1_2_2_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_2_2_Json (RedfishCS_char *JsonText);
