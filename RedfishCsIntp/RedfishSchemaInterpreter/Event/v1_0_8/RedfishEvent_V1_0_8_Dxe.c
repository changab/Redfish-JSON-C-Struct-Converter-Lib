...
//
#include <RedfishInterpreter/Event/v1_0_8/EfiEventV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_8 
...
{
  EFI_REDFISH_EVENT_V1_0_8 *EventV1_0_8;
  EFI_REDFISH_EVENT_V1_0_8_CS *EventV1_0_8Cs;
  ...
  Status = Json_Event_V1_0_8_To_CS (ResoruceRaw, &EventV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_8 = (EFI_REDFISH_EVENT_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_8));
  if (EventV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_0_8;
  EventV1_0_8->Event = EventV1_0_8Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "8";
  Length = sizeof (EFI_REDFISH_EVENT_V1_0_8_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_0_8_JSON (*((EFI_REDFISH_EVENT_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_0_8 = (EFI_REDFISH_EVENT_V1_0_8 *)InterpProp;
  DestroyEvent_V1_0_8_CS (EventV1_0_8->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_0_8_Json (ResoruceRaw);
}
