...
//
#include <RedfishInterpreter/PrivilegeRegistry/v1_1_0/EfiPrivilegeRegistryV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_1_0 
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_0 *PrivilegeRegistryV1_1_0;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_0_CS *PrivilegeRegistryV1_1_0Cs;
  ...
  Status = Json_PrivilegeRegistry_V1_1_0_To_CS (ResoruceRaw, &PrivilegeRegistryV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_1_0 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_0));
  if (PrivilegeRegistryV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PrivilegeRegistryV1_1_0;
  PrivilegeRegistryV1_1_0->PrivilegeRegistry = PrivilegeRegistryV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PrivilegeRegistry_V1_1_0_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PrivilegeRegistryV1_1_0 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_0 *)InterpProp;
  DestroyPrivilegeRegistry_V1_1_0_CS (PrivilegeRegistryV1_1_0->PrivilegeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPrivilegeRegistry_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
