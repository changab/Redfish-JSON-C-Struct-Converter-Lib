# Definition of ChassisCollection and functions<br><br>
...
## Redfish ChassisCollection  to C Structure Function
    RedfishCS_status
    Json_ChassisCollection_To_CS (RedfishCS_char *JsonRawText, RedfishChassisCollection_ChassisCollection_CS **ReturnedCS);

## C Structure to Redfish ChassisCollection  JSON Function
    RedfishCS_status
    CS_To_ChassisCollection_JSON (RedfishChassisCollection_ChassisCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ChassisCollection  C Structure Function
    RedfishCS_status
