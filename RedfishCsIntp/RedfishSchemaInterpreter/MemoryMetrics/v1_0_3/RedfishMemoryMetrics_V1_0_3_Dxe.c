...
//
#include <RedfishInterpreter/MemoryMetrics/v1_0_3/EfiMemoryMetricsV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_0_3 
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_0_3 *MemoryMetricsV1_0_3;
  EFI_REDFISH_MEMORYMETRICS_V1_0_3_CS *MemoryMetricsV1_0_3Cs;
  ...
  Status = Json_MemoryMetrics_V1_0_3_To_CS (ResoruceRaw, &MemoryMetricsV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_0_3 = (EFI_REDFISH_MEMORYMETRICS_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_0_3));
  if (MemoryMetricsV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryMetricsV1_0_3;
  MemoryMetricsV1_0_3->MemoryMetrics = MemoryMetricsV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MEMORYMETRICS_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryMetrics_V1_0_3_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryMetricsV1_0_3 = (EFI_REDFISH_MEMORYMETRICS_V1_0_3 *)InterpProp;
  DestroyMemoryMetrics_V1_0_3_CS (MemoryMetricsV1_0_3->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryMetrics_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
