...
#include"Redfish_EndpointCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishEndpointCollection_EndpointCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for EndpointCollection.EndpointCollection
//
RedfishCS_status CS_To_EndpointCollection_JSON(RedfishEndpointCollection_EndpointCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EndpointCollection.EndpointCollection
//
RedfishCS_status DestroyEndpointCollection_CS(RedfishEndpointCollection_EndpointCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EndpointCollection.EndpointCollection
//
RedfishCS_status DestroyEndpointCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EndpointCollection.NOVERSIONED.EndpointCollection
//
RedfishCS_status
Json_EndpointCollection_To_CS(RedfishCS_char *JsonRawText, RedfishEndpointCollection_EndpointCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEndpointCollection_EndpointCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EndpointCollection", "noversioned", "EndpointCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEndpointCollection_EndpointCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEndpointCollection_CS (Cs);
  return Status;
}
