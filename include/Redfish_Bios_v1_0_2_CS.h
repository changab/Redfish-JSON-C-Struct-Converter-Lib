...
#ifndef _RedfishBios_V1_0_2_CSTRUCT_H_
#define _RedfishBios_V1_0_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishBios_V1_0_2_Attributes_CS RedfishBios_V1_0_2_Attributes_CS;
typedef struct _RedfishBios_V1_0_2_Bios_CS RedfishBios_V1_0_2_Bios_CS;
typedef struct _RedfishBios_V1_0_2_Bios_Actions_CS RedfishBios_V1_0_2_Bios_Actions_CS;
typedef struct _RedfishBios_V1_0_2_Bios_Actions_Oem_CS RedfishBios_V1_0_2_Bios_Actions_Oem_CS;
typedef struct _RedfishBios_V1_0_2_ChangePassword_CS RedfishBios_V1_0_2_ChangePassword_CS;
typedef struct _RedfishBios_V1_0_2_ResetBios_CS RedfishBios_V1_0_2_ResetBios_CS;
...
typedef struct _RedfishBios_V1_0_2_Bios_Actions_CS {
    ...
    RedfishBios_V1_0_2_Bios_Actions_Oem_CS    *Oem;                   // The available OEM specific
...
typedef struct _RedfishBios_V1_0_2_Bios_CS {
    ...
    RedfishBios_V1_0_2_Bios_Actions_CS    *Actions;             // The available actions for this
                                                                // resource.
    RedfishCS_char                        *AttributeRegistry;    // The Resource ID of the
                                                                // Attribute Registry for the
                                                                // BIOS Attributes resource.
    RedfishBios_V1_0_2_Attributes_CS      *Attributes;          // This is the
...
RedfishCS_status
Json_Bios_V1_0_2_To_CS (char *JsonRawText, RedfishBios_V1_0_2_Bios_CS **ReturnedCS);

RedfishCS_status
CS_To_Bios_V1_0_2_JSON (RedfishBios_V1_0_2_Bios_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyBios_V1_0_2_CS (RedfishBios_V1_0_2_Bios_CS *CSPtr);

RedfishCS_status
DestroyBios_V1_0_2_Json (RedfishCS_char *JsonText);
