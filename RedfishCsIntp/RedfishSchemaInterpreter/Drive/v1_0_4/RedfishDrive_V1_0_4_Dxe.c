...
//
#include <RedfishInterpreter/Drive/v1_0_4/EfiDriveV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_4 
...
{
  EFI_REDFISH_DRIVE_V1_0_4 *DriveV1_0_4;
  EFI_REDFISH_DRIVE_V1_0_4_CS *DriveV1_0_4Cs;
  ...
  Status = Json_Drive_V1_0_4_To_CS (ResoruceRaw, &DriveV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_4 = (EFI_REDFISH_DRIVE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_4));
  if (DriveV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)DriveV1_0_4;
  DriveV1_0_4->Drive = DriveV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_DRIVE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Drive_V1_0_4_JSON (*((EFI_REDFISH_DRIVE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  DriveV1_0_4 = (EFI_REDFISH_DRIVE_V1_0_4 *)InterpProp;
  DestroyDrive_V1_0_4_CS (DriveV1_0_4->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyDrive_V1_0_4_Json (ResoruceRaw);
}
