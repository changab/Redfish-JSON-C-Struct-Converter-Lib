...
#ifndef _RedfishTask_V1_1_0_CSTRUCT_H_
#define _RedfishTask_V1_1_0_CSTRUCT_H_
...
typedef struct _RedfishTask_V1_1_0_Task_CS RedfishTask_V1_1_0_Task_CS;
typedef struct _RedfishTask_V1_1_0_Task_Actions_CS RedfishTask_V1_1_0_Task_Actions_CS;
typedef struct _RedfishTask_V1_1_0_Task_Actions_Oem_CS RedfishTask_V1_1_0_Task_Actions_Oem_CS;
//
...
typedef struct _RedfishTask_V1_1_0_Task_Actions_CS {
    RedfishTask_V1_1_0_Task_Actions_Oem_CS    *Oem;    // The available OEM specific
...
typedef struct _RedfishTask_V1_1_0_Task_CS {
    ...
    RedfishTask_V1_1_0_Task_Actions_CS    *Actions;         // The available actions for this
                                                            // resource.
...
RedfishCS_status
Json_Task_V1_1_0_To_CS (char *JsonRawText, RedfishTask_V1_1_0_Task_CS **ReturnedCS);

RedfishCS_status
CS_To_Task_V1_1_0_JSON (RedfishTask_V1_1_0_Task_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyTask_V1_1_0_CS (RedfishTask_V1_1_0_Task_CS *CSPtr);

RedfishCS_status
DestroyTask_V1_1_0_Json (RedfishCS_char *JsonText);
