...
//
#include <RedfishInterpreter/Fabric/v1_0_0/EfiFabricV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_0_0 
...
{
  EFI_REDFISH_FABRIC_V1_0_0 *FabricV1_0_0;
  EFI_REDFISH_FABRIC_V1_0_0_CS *FabricV1_0_0Cs;
  ...
  Status = Json_Fabric_V1_0_0_To_CS (ResoruceRaw, &FabricV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_0_0 = (EFI_REDFISH_FABRIC_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_0_0));
  if (FabricV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)FabricV1_0_0;
  FabricV1_0_0->Fabric = FabricV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_FABRIC_V1_0_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Fabric_V1_0_0_JSON (*((EFI_REDFISH_FABRIC_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  FabricV1_0_0 = (EFI_REDFISH_FABRIC_V1_0_0 *)InterpProp;
  DestroyFabric_V1_0_0_CS (FabricV1_0_0->Fabric); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyFabric_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_0_0EntryPoint (
