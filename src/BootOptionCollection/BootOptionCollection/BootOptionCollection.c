...
//
static RedfishCS_status GenOemCs(RedfishBootOptionCollection_BootOptionCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
RedfishCS_status CS_To_BootOptionCollection_JSON(RedfishBootOptionCollection_BootOptionCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
RedfishCS_status DestroyBootOptionCollection_CS(RedfishBootOptionCollection_BootOptionCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
RedfishCS_status DestroyBootOptionCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for BootOptionCollection.NOVERSIONED.BootOptionCollection
//
RedfishCS_status
Json_BootOptionCollection_To_CS(RedfishCS_char *JsonRawText, RedfishBootOptionCollection_BootOptionCollection_CS **ReturnedCs)
{
  ...
  Status = CreateJsonPayloadAndCs (JsonRawText, "BootOptionCollection", "noversioned", "BootOptionCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishBootOptionCollection_BootOptionCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
