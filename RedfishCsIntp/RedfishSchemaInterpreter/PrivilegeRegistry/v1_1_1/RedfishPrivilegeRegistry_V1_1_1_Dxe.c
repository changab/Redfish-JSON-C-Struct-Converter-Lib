...
//
#include <RedfishInterpreter/PrivilegeRegistry/v1_1_1/EfiPrivilegeRegistryV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_1_1 
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_1 *PrivilegeRegistryV1_1_1;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_1_CS *PrivilegeRegistryV1_1_1Cs;
  ...
  Status = Json_PrivilegeRegistry_V1_1_1_To_CS (ResoruceRaw, &PrivilegeRegistryV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_1_1 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_1));
  if (PrivilegeRegistryV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PrivilegeRegistryV1_1_1;
  ...
  Length = sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PrivilegeRegistry_V1_1_1_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PrivilegeRegistryV1_1_1 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_1 *)InterpProp;
  DestroyPrivilegeRegistry_V1_1_1_CS (PrivilegeRegistryV1_1_1->PrivilegeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPrivilegeRegistry_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
