...
//
#include <RedfishInterpreter/SerialInterface/v1_0_4/EfiSerialInterfaceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_0_4 
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_0_4 *SerialInterfaceV1_0_4;
  EFI_REDFISH_SERIALINTERFACE_V1_0_4_CS *SerialInterfaceV1_0_4Cs;
  ...
  Status = Json_SerialInterface_V1_0_4_To_CS (ResoruceRaw, &SerialInterfaceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_0_4 = (EFI_REDFISH_SERIALINTERFACE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_4));
  if (SerialInterfaceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SerialInterfaceV1_0_4;
  SerialInterfaceV1_0_4->SerialInterface = SerialInterfaceV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_SerialInterface_V1_0_4_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SerialInterfaceV1_0_4 = (EFI_REDFISH_SERIALINTERFACE_V1_0_4 *)InterpProp;
  DestroySerialInterface_V1_0_4_CS (SerialInterfaceV1_0_4->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySerialInterface_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
