...
//
#include <RedfishInterpreter/LogEntry/v1_0_2/EfiLogEntryV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_0_2 
...
{
  EFI_REDFISH_LOGENTRY_V1_0_2 *LogEntryV1_0_2;
  EFI_REDFISH_LOGENTRY_V1_0_2_CS *LogEntryV1_0_2Cs;
  ...
  Status = Json_LogEntry_V1_0_2_To_CS (ResoruceRaw, &LogEntryV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_0_2 = (EFI_REDFISH_LOGENTRY_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_0_2));
  if (LogEntryV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_0_2;
  LogEntryV1_0_2->LogEntry = LogEntryV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_0_2_JSON (*((EFI_REDFISH_LOGENTRY_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_0_2 = (EFI_REDFISH_LOGENTRY_V1_0_2 *)InterpProp;
  DestroyLogEntry_V1_0_2_CS (LogEntryV1_0_2->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_0_2EntryPoint (
