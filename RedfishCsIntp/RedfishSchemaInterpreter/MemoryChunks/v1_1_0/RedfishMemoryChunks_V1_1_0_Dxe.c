...
//
#include <RedfishInterpreter/MemoryChunks/v1_1_0/EfiMemoryChunksV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#MemoryChunks";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryChunks V1_1_0 
...
{
  EFI_REDFISH_MEMORYCHUNKS_V1_1_0 *MemoryChunksV1_1_0;
  EFI_REDFISH_MEMORYCHUNKS_V1_1_0_CS *MemoryChunksV1_1_0Cs;
  ...
  Status = Json_MemoryChunks_V1_1_0_To_CS (ResoruceRaw, &MemoryChunksV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryChunksV1_1_0 = (EFI_REDFISH_MEMORYCHUNKS_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_1_0));
  if (MemoryChunksV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryChunksV1_1_0;
  MemoryChunksV1_1_0->MemoryChunks = MemoryChunksV1_1_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_1_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryChunks_V1_1_0_JSON (*((EFI_REDFISH_MEMORYCHUNKS_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryChunksV1_1_0 = (EFI_REDFISH_MEMORYCHUNKS_V1_1_0 *)InterpProp;
  DestroyMemoryChunks_V1_1_0_CS (MemoryChunksV1_1_0->MemoryChunks); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryChunks_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
