...
//
#include <RedfishInterpreter/PCIeSlots/v1_0_0/EfiPCIeSlotsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#PCIeSlots";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeSlots V1_0_0 
...
{
  EFI_REDFISH_PCIESLOTS_V1_0_0 *PCIeSlotsV1_0_0;
  EFI_REDFISH_PCIESLOTS_V1_0_0_CS *PCIeSlotsV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "PCIeSlots") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_PCIeSlots_V1_0_0_To_CS (ResoruceRaw, &PCIeSlotsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeSlotsV1_0_0 = (EFI_REDFISH_PCIESLOTS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIESLOTS_V1_0_0));
  if (PCIeSlotsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeSlotsV1_0_0;
  PCIeSlotsV1_0_0->PCIeSlots = PCIeSlotsV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_PCIESLOTS_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeSlots"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "PCIeSlots");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeSlots"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "PCIeSlots");
...
)
{
  ...
  return CS_To_PCIeSlots_V1_0_0_JSON (*((EFI_REDFISH_PCIESLOTS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in PCIeSlotsToStruct.
...
)
{
  ...
  PCIeSlotsV1_0_0 = (EFI_REDFISH_PCIESLOTS_V1_0_0 *)InterpProp;
  DestroyPCIeSlots_V1_0_0_CS (PCIeSlotsV1_0_0->PCIeSlots); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PCIeSlotsFromEfiStruct
...
)
{
  ...
  return DestroyPCIeSlots_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeSlots_V1_0_0EntryPoint (
