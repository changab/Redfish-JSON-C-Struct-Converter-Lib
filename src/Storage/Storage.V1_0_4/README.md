# Definition of Storage.V1_0_4 and functions<br><br>
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Storage_SetEncryptionKey**|RedfishStorage_V1_0_4_SetEncryptionKey_CS| Structure points to **#Storage.SetEncryptionKey** property.| No| No
|**Oem**|RedfishStorage_V1_0_4_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Storage
    typedef struct _RedfishStorage_V1_0_4_Storage_CS {
        ...
        RedfishStorage_V1_0_4_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_Link Drives;
        RedfishCS_int64 *Drivesodata_count;
        RedfishCS_char *Id;
        RedfishStorage_V1_0_4_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Actions**|RedfishStorage_V1_0_4_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishStorage_V1_0_4_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Storage V1_0_4 to C Structure Function
    RedfishCS_status
    Json_Storage_V1_0_4_To_CS (RedfishCS_char *JsonRawText, RedfishStorage_V1_0_4_Storage_CS **ReturnedCS);

## C Structure to Redfish Storage V1_0_4 JSON Function
    RedfishCS_status
    CS_To_Storage_V1_0_4_JSON (RedfishStorage_V1_0_4_Storage_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Storage V1_0_4 C Structure Function
    RedfishCS_status
