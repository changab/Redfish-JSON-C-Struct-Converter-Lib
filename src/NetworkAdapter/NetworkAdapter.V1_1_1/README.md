# Definition of NetworkAdapter.V1_1_1 and functions<br><br>
...
## Actions
    typedef struct _RedfishNetworkAdapter_V1_1_1_Actions_CS {
        ...
        RedfishNetworkAdapter_V1_1_1_OemActions_CS *Oem;
    } RedfishNetworkAdapter_V1_1_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**NetworkAdapter_ResetSettingsToDefault**|RedfishNetworkAdapter_V1_1_1_ResetSettingsToDefault_CS| Structure points to **#NetworkAdapter.ResetSettingsToDefault** property.| No| No
|**Oem**|RedfishNetworkAdapter_V1_1_1_OemActions_CS| Structure points to **Oem** property.| No| No


## ControllerCapabilities
    typedef struct _RedfishNetworkAdapter_V1_1_1_ControllerCapabilities_CS {
        RedfishNetworkAdapter_V1_1_1_DataCenterBridging_CS *DataCenterBridging;
        RedfishNetworkAdapter_V1_1_1_NPIV_CS *NPIV;
        RedfishCS_int64 *NetworkDeviceFunctionCount;
        RedfishCS_int64 *NetworkPortCount;
        RedfishNetworkAdapter_V1_1_1_VirtualizationOffload_CS *VirtualizationOffload;
    } RedfishNetworkAdapter_V1_1_1_ControllerCapabilities_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**DataCenterBridging**|RedfishNetworkAdapter_V1_1_1_DataCenterBridging_CS| Structure points to **DataCenterBridging** property.| No| No
|**NPIV**|RedfishNetworkAdapter_V1_1_1_NPIV_CS| Structure points to **NPIV** property.| No| No
...
|**VirtualizationOffload**|RedfishNetworkAdapter_V1_1_1_VirtualizationOffload_CS| Structure points to **VirtualizationOffload** property.| No| No
