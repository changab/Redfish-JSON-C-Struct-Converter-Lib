...
//
#include <RedfishInterpreter/Event/v1_3_0/EfiEventV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_3_0 
...
{
  EFI_REDFISH_EVENT_V1_3_0 *EventV1_3_0;
  EFI_REDFISH_EVENT_V1_3_0_CS *EventV1_3_0Cs;
  ...
  Status = Json_Event_V1_3_0_To_CS (ResoruceRaw, &EventV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_3_0 = (EFI_REDFISH_EVENT_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_3_0));
  if (EventV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EventV1_3_0;
  EventV1_3_0->Event = EventV1_3_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "3";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_EVENT_V1_3_0_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Event_V1_3_0_JSON (*((EFI_REDFISH_EVENT_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EventV1_3_0 = (EFI_REDFISH_EVENT_V1_3_0 *)InterpProp;
  DestroyEvent_V1_3_0_CS (EventV1_3_0->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEvent_V1_3_0_Json (ResoruceRaw);
}
