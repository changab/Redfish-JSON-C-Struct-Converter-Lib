...
#include"Redfish_TaskCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishTaskCollection_TaskCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for TaskCollection.TaskCollection
//
RedfishCS_status CS_To_TaskCollection_JSON(RedfishTaskCollection_TaskCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for TaskCollection.TaskCollection
//
RedfishCS_status DestroyTaskCollection_CS(RedfishTaskCollection_TaskCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for TaskCollection.TaskCollection
//
RedfishCS_status DestroyTaskCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for TaskCollection.NOVERSIONED.TaskCollection
//
RedfishCS_status
Json_TaskCollection_To_CS(RedfishCS_char *JsonRawText, RedfishTaskCollection_TaskCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTaskCollection_TaskCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "TaskCollection", "noversioned", "TaskCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTaskCollection_TaskCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
