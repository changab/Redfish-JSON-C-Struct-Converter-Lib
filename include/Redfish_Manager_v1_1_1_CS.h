...
#ifndef _RedfishManager_V1_1_1_CSTRUCT_H_
#define _RedfishManager_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManager_V1_1_1_CommandShell_CS RedfishManager_V1_1_1_CommandShell_CS;
typedef struct _RedfishManager_V1_1_1_ForceFailover_CS RedfishManager_V1_1_1_ForceFailover_CS;
typedef struct _RedfishManager_V1_1_1_GraphicalConsole_CS RedfishManager_V1_1_1_GraphicalConsole_CS;
typedef struct _RedfishManager_V1_1_1_Manager_CS RedfishManager_V1_1_1_Manager_CS;
typedef struct _RedfishManager_V1_1_1_Manager_Actions_CS RedfishManager_V1_1_1_Manager_Actions_CS;
typedef struct _RedfishManager_V1_1_1_Manager_Actions_Oem_CS RedfishManager_V1_1_1_Manager_Actions_Oem_CS;
typedef struct _RedfishManager_V1_1_1_Manager_Links_CS RedfishManager_V1_1_1_Manager_Links_CS;
typedef struct _RedfishManager_V1_1_1_ModifyRedundancySet_CS RedfishManager_V1_1_1_ModifyRedundancySet_CS;
typedef struct _RedfishManager_V1_1_1_Reset_CS RedfishManager_V1_1_1_Reset_CS;
typedef struct _RedfishManager_V1_1_1_SerialConsole_CS RedfishManager_V1_1_1_SerialConsole_CS;
...
// Console.
//
typedef struct _RedfishManager_V1_1_1_CommandShell_CS {
...
} RedfishManager_V1_1_1_CommandShell_CS;

//
// The ForceFailover action forces a failover of this manager to the manager used
// in the parameter.
//
typedef struct _RedfishManager_V1_1_1_ForceFailover_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_1_1_ForceFailover_CS;

//
// Used for describing services like Serial Console, Command Shell or Graphical
// Console.
//
typedef struct _RedfishManager_V1_1_1_GraphicalConsole_CS {
    RedfishCS_char_Array    *ConnectTypesSupported;    // This object is used to
    ...
    RedfishCS_bool          *ServiceEnabled;          // Indicates if the service is
                                                      // enabled for this manager.
} RedfishManager_V1_1_1_GraphicalConsole_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishManager_V1_1_1_Manager_Actions_CS {
    RedfishManager_V1_1_1_ForceFailover_CS          *Manager_ForceFailover;     
    RedfishManager_V1_1_1_ModifyRedundancySet_CS    *Manager_ModifyRedundancySet;
    RedfishManager_V1_1_1_Reset_CS                  *Manager_Reset;             
    RedfishManager_V1_1_1_Manager_Actions_Oem_CS    *Oem;                       
} RedfishManager_V1_1_1_Manager_Actions_CS;

typedef struct _RedfishManager_V1_1_1_Manager_Actions_Oem_CS {
    RedfishCS_Link    Prop;
} RedfishManager_V1_1_1_Manager_Actions_Oem_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishManager_V1_1_1_Manager_Links_CS {
...
} RedfishManager_V1_1_1_Manager_Links_CS;

//
// The ModifyRedundancySet operation is used to add or remove members to a
// redundant group of manager.
//
typedef struct _RedfishManager_V1_1_1_ModifyRedundancySet_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_1_1_ModifyRedundancySet_CS;

//
// The reset action resets/reboots the manager.
//
typedef struct _RedfishManager_V1_1_1_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_1_1_Reset_CS;

//
// Used for describing services like Serial Console, Command Shell or Graphical
// Console.
//
typedef struct _RedfishManager_V1_1_1_SerialConsole_CS {
    RedfishCS_char_Array    *ConnectTypesSupported;    // This object is used to
    ...
    RedfishCS_bool          *ServiceEnabled;          // Indicates if the service is
                                                      // enabled for this manager.
} RedfishManager_V1_1_1_SerialConsole_CS;
...
//
typedef struct _RedfishManager_V1_1_1_Manager_CS {
    RedfishCS_Header                             Header;
    RedfishCS_char                               *odata_context;                
    RedfishCS_char                               *odata_id;                     
    RedfishCS_char                               *odata_type;                   
    RedfishManager_V1_1_1_Manager_Actions_CS     *Actions;                          // The available actions for this
                                                                                    // resource.
    RedfishManager_V1_1_1_CommandShell_CS        *CommandShell;                     // Information about the Command
    ...
    RedfishCS_char                               *FirmwareVersion;                  // The firmware version of this
                                                                                    // Manager.
    RedfishManager_V1_1_1_GraphicalConsole_CS    *GraphicalConsole;                 // The value of this property
                                                                                    // shall contain the information
                                                                                    // about the Graphical Console
                                                                                    // (KVM-IP) service of this
                                                                                    // manager.
    RedfishCS_char                               *Id;                           
    RedfishManager_V1_1_1_Manager_Links_CS       *Links;                            // Contains references to other
    ...
    RedfishManager_V1_1_1_SerialConsole_CS       *SerialConsole;                    // Information about the Serial
...
} RedfishManager_V1_1_1_Manager_CS;

RedfishCS_status
Json_Manager_V1_1_1_To_CS (char *JsonRawText, RedfishManager_V1_1_1_Manager_CS **ReturnedCS);

RedfishCS_status
CS_To_Manager_V1_1_1_JSON (RedfishManager_V1_1_1_Manager_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManager_V1_1_1_CS (RedfishManager_V1_1_1_Manager_CS *CSPtr);

RedfishCS_status
DestroyManager_V1_1_1_Json (RedfishCS_char *JsonText);
