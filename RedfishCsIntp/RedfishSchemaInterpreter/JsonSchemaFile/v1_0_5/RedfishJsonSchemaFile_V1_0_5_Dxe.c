...
//
#include <RedfishInterpreter/JsonSchemaFile/v1_0_5/EfiJsonSchemaFileV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_0_5 
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_5 *JsonSchemaFileV1_0_5;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "JsonSchemaFile") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_JsonSchemaFile_V1_0_5_To_CS (ResoruceRaw, &JsonSchemaFileV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_0_5 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_5));
  if (JsonSchemaFileV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)JsonSchemaFileV1_0_5;
  JsonSchemaFileV1_0_5->JsonSchemaFile = JsonSchemaFileV1_0_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("JsonSchemaFile"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "JsonSchemaFile");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("JsonSchemaFile"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "JsonSchemaFile");
...
)
{
  ...
  return CS_To_JsonSchemaFile_V1_0_5_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in JsonSchemaFileToStruct.
...
EFI_STATUS
EFIAPI
JsonSchemaFileDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  JsonSchemaFileV1_0_5 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_5 *)InterpProp;
  DestroyJsonSchemaFile_V1_0_5_CS (JsonSchemaFileV1_0_5->JsonSchemaFile); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from JsonSchemaFileFromEfiStruct
...
)
{
  ...
  return DestroyJsonSchemaFile_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
