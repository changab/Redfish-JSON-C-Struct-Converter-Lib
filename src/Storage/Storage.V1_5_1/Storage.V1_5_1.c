...
#include"Redfish_Storage_v1_5_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for #Storage.SetEncryptionKey
//
static RedfishCS_status GenSetEncryptionKeyCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_SetEncryptionKey_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_5_1_SetEncryptionKey_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_5_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_5_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLinksCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_5_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Enclosures
...
//Generate C structure for Oem
//
static RedfishCS_status GenStorageControllerOemActionsCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_StorageControllerOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_5_1_StorageControllerOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenStorageControllerActionsCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_StorageControllerActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_5_1_StorageControllerActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenCacheSummaryCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_CacheSummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_5_1_CacheSummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Links
//
static RedfishCS_status GenStorageControllerLinksCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_StorageControllerLinks_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_5_1_StorageControllerLinks_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
  ...
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "StorageServices", Cs->Header.ThisUri, &(*Dst)->StorageServices);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // StorageServices@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "StorageServices@odata.count", &(*Dst)->StorageServicesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenStorageController_Array_ElementCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishStorage_V1_5_1_StorageController_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishStorage_V1_5_1_StorageController_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
  ...
  // CacheSummary
  Status = GenCacheSummaryCs (Cs, TempJsonObj, "CacheSummary", &(*Dst)->CacheSummary);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Identifiers
  InitializeLinkHead (&(*Dst)->Identifiers);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "Identifiers", Cs->Header.ThisUri, &(*Dst)->Identifiers);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Links
  Status = GenStorageControllerLinksCs (Cs, TempJsonObj, "Links", &(*Dst)->Links);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishStorage_V1_5_1_StorageController_Array_CS
//
static RedfishCS_status GenStorageController_ArrayCs(RedfishStorage_V1_5_1_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_5_1_StorageController_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishStorage_V1_5_1_StorageController_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishStorage_V1_5_1_StorageController_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsStorage_SetEncryptionKey(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_SetEncryptionKey_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersActionsOem(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_StorageControllerOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersActions(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_StorageControllerActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersCacheSummaryStatusOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersCacheSummaryStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // Oem
  if (CS_To_JSON_StorageControllersCacheSummaryStatusOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_StorageControllersCacheSummary(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_CacheSummary_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // Status
  if (CS_To_JSON_StorageControllersCacheSummaryStatus(CsJson, "Status", CSPtr->Status) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_StorageControllersLinks(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_StorageControllerLinks_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // StorageServices 
  if (InsertJsonLinkArrayObj (CsJson, "StorageServices", &CSPtr->StorageServices) != RedfishCS_status_success) {goto Error;}

  // StorageServices@odata.count 
  if (InsertJsonInt64Obj (CsJson, "StorageServices@odata.count", CSPtr->StorageServicesodata_count) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_StorageControllersStatusOem(json_t *CsJson, char *Key, RedfishResource_Oem_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  ...
  // Oem
  if (CS_To_JSON_StorageControllersStatusOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_StorageControllers(json_t *CsJson, char *Key, RedfishStorage_V1_5_1_StorageController_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishStorage_V1_5_1_StorageController_Array_CS *NextArray;
  RedfishStorage_V1_5_1_StorageController_CS *NextArrayItem;
  ...
  do {
    ...
    // CacheSummary
    if (CS_To_JSON_StorageControllersCacheSummary(ArrayMember, "CacheSummary", NextArrayItem->CacheSummary) != RedfishCS_status_success) {goto Error;}

    // FirmwareVersion 
    if (InsertJsonStringObj (ArrayMember, "FirmwareVersion", NextArrayItem->FirmwareVersion) != RedfishCS_status_success) {goto Error;}

    // Identifiers 
    if (InsertJsonLinkArrayObj (ArrayMember, "Identifiers", &NextArrayItem->Identifiers) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Storage.V1_5_1.Storage
//
RedfishCS_status CS_To_Storage_V1_5_1_JSON(RedfishStorage_V1_5_1_Storage_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Storage.V1_5_1.Storage
//
RedfishCS_status DestroyStorage_V1_5_1_CS(RedfishStorage_V1_5_1_Storage_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Storage.V1_5_1.Storage
//
RedfishCS_status DestroyStorage_V1_5_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Storage.V1_5_1.Storage
//
RedfishCS_status
Json_Storage_V1_5_1_To_CS(RedfishCS_char *JsonRawText, RedfishStorage_V1_5_1_Storage_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishStorage_V1_5_1_Storage_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Storage", "v1_5_1", "Storage", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishStorage_V1_5_1_Storage_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
