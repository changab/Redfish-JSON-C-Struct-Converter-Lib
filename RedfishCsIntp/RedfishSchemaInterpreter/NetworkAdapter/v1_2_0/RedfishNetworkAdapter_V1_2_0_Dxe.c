...
//
#include <RedfishInterpreter/NetworkAdapter/v1_2_0/EfiNetworkAdapterV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_2_0 
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_2_0 *NetworkAdapterV1_2_0;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "NetworkAdapter") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_NetworkAdapter_V1_2_0_To_CS (ResoruceRaw, &NetworkAdapterV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_2_0 = (EFI_REDFISH_NETWORKADAPTER_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_2_0));
  if (NetworkAdapterV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkAdapterV1_2_0;
  NetworkAdapterV1_2_0->NetworkAdapter = NetworkAdapterV1_2_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_NETWORKADAPTER_V1_2_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkAdapter"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "NetworkAdapter");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkAdapter"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "NetworkAdapter");
...
)
{
  ...
  return CS_To_NetworkAdapter_V1_2_0_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in NetworkAdapterToStruct.
...
EFI_STATUS
EFIAPI
NetworkAdapterDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  NetworkAdapterV1_2_0 = (EFI_REDFISH_NETWORKADAPTER_V1_2_0 *)InterpProp;
  DestroyNetworkAdapter_V1_2_0_CS (NetworkAdapterV1_2_0->NetworkAdapter); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from NetworkAdapterFromEfiStruct
...
)
{
  ...
  return DestroyNetworkAdapter_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
