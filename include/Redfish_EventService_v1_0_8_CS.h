...
#ifndef _RedfishEventservice_V1_0_8_CSTRUCT_H_
#define _RedfishEventservice_V1_0_8_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEventService_V1_0_8_Actions_CS RedfishEventService_V1_0_8_Actions_CS;
typedef struct _RedfishEventService_V1_0_8_EventService_CS RedfishEventService_V1_0_8_EventService_CS;
typedef struct _RedfishEventService_V1_0_8_OemActions_CS RedfishEventService_V1_0_8_OemActions_CS;
typedef struct _RedfishEventService_V1_0_8_SubmitTestEvent_CS RedfishEventService_V1_0_8_SubmitTestEvent_CS;
...
typedef struct _RedfishEventService_V1_0_8_Actions_CS {
    ...
    RedfishEventService_V1_0_8_OemActions_CS         *Oem;                            // This property contains the
...
typedef struct _RedfishEventService_V1_0_8_EventService_CS {
    ...
    RedfishEventService_V1_0_8_Actions_CS    *Actions;                        // The available actions for this
                                                                              // resource.
...
RedfishCS_status
Json_EventService_V1_0_8_To_CS (char *JsonRawText, RedfishEventService_V1_0_8_EventService_CS **ReturnedCS);

RedfishCS_status
CS_To_EventService_V1_0_8_JSON (RedfishEventService_V1_0_8_EventService_CS *CSPtr, char **JsonText);
