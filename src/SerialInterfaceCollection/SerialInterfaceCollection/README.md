# Definition of SerialInterfaceCollection and functions<br><br>
...
## Redfish SerialInterfaceCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish SerialInterfaceCollection  JSON Function
    RedfishCS_status
    CS_To_SerialInterfaceCollection_JSON (RedfishSerialInterfaceCollection_SerialInterfaceCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish SerialInterfaceCollection  C Structure Function
    RedfishCS_status
