...
//
#include <RedfishInterpreter/AccountService/v1_2_2/EfiAccountServiceV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_2_2 
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_2_2 *AccountServiceV1_2_2;
  EFI_REDFISH_ACCOUNTSERVICE_V1_2_2_CS *AccountServiceV1_2_2Cs;
  ...
  Status = Json_AccountService_V1_2_2_To_CS (ResoruceRaw, &AccountServiceV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_2_2 = (EFI_REDFISH_ACCOUNTSERVICE_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_2_2));
  if (AccountServiceV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)AccountServiceV1_2_2;
  AccountServiceV1_2_2->AccountService = AccountServiceV1_2_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_2_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_AccountService_V1_2_2_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  AccountServiceV1_2_2 = (EFI_REDFISH_ACCOUNTSERVICE_V1_2_2 *)InterpProp;
  DestroyAccountService_V1_2_2_CS (AccountServiceV1_2_2->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyAccountService_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_2_2EntryPoint (
