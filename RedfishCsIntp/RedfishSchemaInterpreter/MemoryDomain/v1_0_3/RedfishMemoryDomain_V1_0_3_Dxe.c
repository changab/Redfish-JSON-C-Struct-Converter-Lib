...
//
#include <RedfishInterpreter/MemoryDomain/v1_0_3/EfiMemoryDomainV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_0_3 
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_0_3 *MemoryDomainV1_0_3;
  EFI_REDFISH_MEMORYDOMAIN_V1_0_3_CS *MemoryDomainV1_0_3Cs;
  ...
  Status = Json_MemoryDomain_V1_0_3_To_CS (ResoruceRaw, &MemoryDomainV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_0_3 = (EFI_REDFISH_MEMORYDOMAIN_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_0_3));
  if (MemoryDomainV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryDomainV1_0_3;
  MemoryDomainV1_0_3->MemoryDomain = MemoryDomainV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryDomain_V1_0_3_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryDomainV1_0_3 = (EFI_REDFISH_MEMORYDOMAIN_V1_0_3 *)InterpProp;
  DestroyMemoryDomain_V1_0_3_CS (MemoryDomainV1_0_3->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryDomain_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
