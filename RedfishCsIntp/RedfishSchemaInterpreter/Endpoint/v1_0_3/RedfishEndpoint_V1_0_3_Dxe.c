...
//
#include <RedfishInterpreter/Endpoint/v1_0_3/EfiEndpointV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_0_3 
...
{
  EFI_REDFISH_ENDPOINT_V1_0_3 *EndpointV1_0_3;
  EFI_REDFISH_ENDPOINT_V1_0_3_CS *EndpointV1_0_3Cs;
  ...
  Status = Json_Endpoint_V1_0_3_To_CS (ResoruceRaw, &EndpointV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_0_3 = (EFI_REDFISH_ENDPOINT_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_0_3));
  if (EndpointV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)EndpointV1_0_3;
  EndpointV1_0_3->Endpoint = EndpointV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_ENDPOINT_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Endpoint_V1_0_3_JSON (*((EFI_REDFISH_ENDPOINT_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  EndpointV1_0_3 = (EFI_REDFISH_ENDPOINT_V1_0_3 *)InterpProp;
  DestroyEndpoint_V1_0_3_CS (EndpointV1_0_3->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyEndpoint_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_0_3EntryPoint (
