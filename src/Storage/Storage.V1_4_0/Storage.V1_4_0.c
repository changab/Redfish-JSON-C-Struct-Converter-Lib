...
#include"Redfish_Storage_v1_4_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishStorage_V1_4_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Storage.SetEncryptionKey
//
static RedfishCS_status GenSetEncryptionKeyCs(RedfishStorage_V1_4_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_4_0_SetEncryptionKey_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_4_0_SetEncryptionKey_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishStorage_V1_4_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_4_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_4_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishStorage_V1_4_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_4_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_4_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLinksCs(RedfishStorage_V1_4_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_4_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_4_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Enclosures
...
//
static RedfishCS_status GenStatusCs(RedfishStorage_V1_4_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishStorage_V1_4_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsStorage_SetEncryptionKey(json_t *CsJson, char *Key, RedfishStorage_V1_4_0_SetEncryptionKey_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishStorage_V1_4_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishStorage_V1_4_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Storage.V1_4_0.Storage
//
RedfishCS_status CS_To_Storage_V1_4_0_JSON(RedfishStorage_V1_4_0_Storage_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Storage.V1_4_0.Storage
//
RedfishCS_status DestroyStorage_V1_4_0_CS(RedfishStorage_V1_4_0_Storage_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Storage.V1_4_0.Storage
//
RedfishCS_status DestroyStorage_V1_4_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Storage.V1_4_0.Storage
//
RedfishCS_status
Json_Storage_V1_4_0_To_CS(RedfishCS_char *JsonRawText, RedfishStorage_V1_4_0_Storage_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishStorage_V1_4_0_Storage_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Storage", "v1_4_0", "Storage", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishStorage_V1_4_0_Storage_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
