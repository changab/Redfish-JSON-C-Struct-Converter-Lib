...
//
#include <RedfishInterpreter/MemoryMetrics/v1_0_0/EfiMemoryMetricsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_0_0 
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_0_0 *MemoryMetricsV1_0_0;
  EFI_REDFISH_MEMORYMETRICS_V1_0_0_CS *MemoryMetricsV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "MemoryMetrics") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_MemoryMetrics_V1_0_0_To_CS (ResoruceRaw, &MemoryMetricsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_0_0 = (EFI_REDFISH_MEMORYMETRICS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_0_0));
  if (MemoryMetricsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryMetricsV1_0_0;
  MemoryMetricsV1_0_0->MemoryMetrics = MemoryMetricsV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_MEMORYMETRICS_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MemoryMetrics"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "MemoryMetrics");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MemoryMetrics"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "MemoryMetrics");
...
)
{
  ...
  return CS_To_MemoryMetrics_V1_0_0_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in MemoryMetricsToStruct.
...
)
{
  ...
  MemoryMetricsV1_0_0 = (EFI_REDFISH_MEMORYMETRICS_V1_0_0 *)InterpProp;
  DestroyMemoryMetrics_V1_0_0_CS (MemoryMetricsV1_0_0->MemoryMetrics); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MemoryMetricsFromEfiStruct
...
)
{
  ...
  return DestroyMemoryMetrics_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
