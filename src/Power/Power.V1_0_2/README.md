# Definition of Power.V1_0_2 and functions<br><br>
...
## PowerControl
    typedef struct _RedfishPower_V1_0_2_PowerControl_CS {
        ...
        RedfishPower_V1_0_2_PowerLimit_CS *PowerLimit;
        RedfishPower_V1_0_2_PowerMetric_CS *PowerMetrics;
...
|**PowerLimit**|RedfishPower_V1_0_2_PowerLimit_CS| Structure points to **PowerLimit** property.| No| No
|**PowerMetrics**|RedfishPower_V1_0_2_PowerMetric_CS| Structure points to **PowerMetrics** property.| No| No
...
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PowerControl**|RedfishPower_V1_0_2_PowerControl_CS| Structure points to **PowerControl** property.| No| No
...
|**PowerSupplies**|RedfishPower_V1_0_2_PowerSupply_CS| Structure points to **PowerSupplies** property.| No| No
...
|**Redundancyodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Redundancy@odata.count** property.| No| No
|**Redundancyodata_navigationLink**|RedfishCS_char| String pointer to **Redundancy@odata.navigationLink** property.| No| No
|**Voltages**|RedfishPower_V1_0_2_Voltage_CS| Structure points to **Voltages** property.| No| No
...
## Redfish Power V1_0_2 to C Structure Function
    RedfishCS_status
    Json_Power_V1_0_2_To_CS (RedfishCS_char *JsonRawText, RedfishPower_V1_0_2_Power_CS **ReturnedCS);

## C Structure to Redfish Power V1_0_2 JSON Function
    RedfishCS_status
    CS_To_Power_V1_0_2_JSON (RedfishPower_V1_0_2_Power_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Power V1_0_2 C Structure Function
    RedfishCS_status
