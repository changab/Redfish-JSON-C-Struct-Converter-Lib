...
#ifndef _RedfishDrive_V1_4_1_CSTRUCT_H_
#define _RedfishDrive_V1_4_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishDrive_V1_4_1_Operations_Array_CS RedfishDrive_V1_4_1_Operations_Array_CS;
typedef struct _RedfishDrive_V1_4_1_Actions_CS RedfishDrive_V1_4_1_Actions_CS;
typedef struct _RedfishDrive_V1_4_1_Drive_CS RedfishDrive_V1_4_1_Drive_CS;
typedef struct _RedfishDrive_V1_4_1_Links_CS RedfishDrive_V1_4_1_Links_CS;
typedef struct _RedfishDrive_V1_4_1_OemActions_CS RedfishDrive_V1_4_1_OemActions_CS;
typedef struct _RedfishDrive_V1_4_1_Operations_CS RedfishDrive_V1_4_1_Operations_CS;
typedef struct _RedfishDrive_V1_4_1_SecureErase_CS RedfishDrive_V1_4_1_SecureErase_CS;
...
typedef struct _RedfishDrive_V1_4_1_Actions_CS {
    ...
    RedfishDrive_V1_4_1_OemActions_CS     *Oem;                 // This property contains the
...
typedef struct _RedfishDrive_V1_4_1_Drive_CS {
    ...
    RedfishDrive_V1_4_1_Actions_CS             *Actions;                         // The available actions for this
                                                                                 // resource.
    ...
    RedfishCS_char                             *IndicatorLED;                    // The state of the indicator
                                                                                 ...
                                                                                 // drive.
    RedfishDrive_V1_4_1_Links_CS               *Links;                           // Contains references to other
    ...
    RedfishResource_Oem_CS                     *Oem;                             // This is the
                                                                                 ...
                                                                                 // sections.
    RedfishDrive_V1_4_1_Operations_Array_CS    *Operations;                      // The operations currently
...
typedef struct _RedfishDrive_V1_4_1_Operations_Array_CS  {
    RedfishDrive_V1_4_1_Operations_Array_CS    *Next;
    RedfishDrive_V1_4_1_Operations_CS    *ArrayValue;
} RedfishDrive_V1_4_1_Operations_Array_CS;

RedfishCS_status
Json_Drive_V1_4_1_To_CS (char *JsonRawText, RedfishDrive_V1_4_1_Drive_CS **ReturnedCS);

RedfishCS_status
CS_To_Drive_V1_4_1_JSON (RedfishDrive_V1_4_1_Drive_CS *CSPtr, char **JsonText);
