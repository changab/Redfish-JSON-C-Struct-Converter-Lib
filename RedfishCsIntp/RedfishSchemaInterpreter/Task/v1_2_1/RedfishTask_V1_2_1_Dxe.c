...
//
#include <RedfishInterpreter/Task/v1_2_1/EfiTaskV1_2_1.h>
...
{
  EFI_REDFISH_TASK_V1_2_1 *TaskV1_2_1;
  EFI_REDFISH_TASK_V1_2_1_CS *TaskV1_2_1Cs;
  ...
  Status = Json_Task_V1_2_1_To_CS (ResoruceRaw, &TaskV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_2_1 = (EFI_REDFISH_TASK_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_2_1));
  if (TaskV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskV1_2_1;
  TaskV1_2_1->Task = TaskV1_2_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_TASK_V1_2_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Task_V1_2_1_JSON (*((EFI_REDFISH_TASK_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskV1_2_1 = (EFI_REDFISH_TASK_V1_2_1 *)InterpProp;
  DestroyTask_V1_2_1_CS (TaskV1_2_1->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTask_V1_2_1_Json (ResoruceRaw);
}
