...
//
#include <RedfishInterpreter/PCIeFunction/v1_1_2/EfiPCIeFunctionV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_1_2 
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_1_2 *PCIeFunctionV1_1_2;
  EFI_REDFISH_PCIEFUNCTION_V1_1_2_CS *PCIeFunctionV1_1_2Cs;
  ...
  Status = Json_PCIeFunction_V1_1_2_To_CS (ResoruceRaw, &PCIeFunctionV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_1_2 = (EFI_REDFISH_PCIEFUNCTION_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_1_2));
  if (PCIeFunctionV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)PCIeFunctionV1_1_2;
  PCIeFunctionV1_1_2->PCIeFunction = PCIeFunctionV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_PCIEFUNCTION_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_PCIeFunction_V1_1_2_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  PCIeFunctionV1_1_2 = (EFI_REDFISH_PCIEFUNCTION_V1_1_2 *)InterpProp;
  DestroyPCIeFunction_V1_1_2_CS (PCIeFunctionV1_1_2->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyPCIeFunction_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
