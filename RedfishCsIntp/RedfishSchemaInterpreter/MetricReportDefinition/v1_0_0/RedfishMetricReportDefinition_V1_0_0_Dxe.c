...
//
#include <RedfishInterpreter/MetricReportDefinition/v1_0_0/EfiMetricReportDefinitionV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#MetricReportDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReportDefinition V1_0_0 
...
EFI_STATUS
EFIAPI
MetricReportDefinitionToEfiStruct (
...
{
  EFI_REDFISH_METRICREPORTDEFINITION_V1_0_0 *MetricReportDefinitionV1_0_0;
  EFI_REDFISH_METRICREPORTDEFINITION_V1_0_0_CS *MetricReportDefinitionV1_0_0Cs;
  ...
  Status = Json_MetricReportDefinition_V1_0_0_To_CS (ResoruceRaw, &MetricReportDefinitionV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportDefinitionV1_0_0 = (EFI_REDFISH_METRICREPORTDEFINITION_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORTDEFINITION_V1_0_0));
  if (MetricReportDefinitionV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MetricReportDefinitionV1_0_0;
  MetricReportDefinitionV1_0_0->MetricReportDefinition = MetricReportDefinitionV1_0_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "0";
  Length = sizeof (EFI_REDFISH_METRICREPORTDEFINITION_V1_0_0_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricReportDefinition"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "MetricReportDefinition");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricReportDefinition"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "MetricReportDefinition");
...
EFI_STATUS
EFIAPI
MetricReportDefinitionFromEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL *This,
...
)
{
  ...
  return CS_To_MetricReportDefinition_V1_0_0_JSON (*((EFI_REDFISH_METRICREPORTDEFINITION_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
EFI_STATUS
EFIAPI
MetricReportDefinitionDestoryEfiStruct(
  IN EFI_REST_RESOURCE_INTERPRETER_PROTOCOL   *This,
...
)
{
  ...
  MetricReportDefinitionV1_0_0 = (EFI_REDFISH_METRICREPORTDEFINITION_V1_0_0 *)InterpProp;
  DestroyMetricReportDefinition_V1_0_0_CS (MetricReportDefinitionV1_0_0->MetricReportDefinition); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MetricReportDefinitionFromEfiStruct
...
)
{
  ...
  return DestroyMetricReportDefinition_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReportDefinition_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReportDefinition_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
