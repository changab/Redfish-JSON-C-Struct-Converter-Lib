...
//
#include <RedfishInterpreter/MemoryDomain/v1_1_2/EfiMemoryDomainV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_1_2 
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_1_2 *MemoryDomainV1_1_2;
  EFI_REDFISH_MEMORYDOMAIN_V1_1_2_CS *MemoryDomainV1_1_2Cs;
  ...
  Status = Json_MemoryDomain_V1_1_2_To_CS (ResoruceRaw, &MemoryDomainV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_1_2 = (EFI_REDFISH_MEMORYDOMAIN_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_1_2));
  if (MemoryDomainV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)MemoryDomainV1_1_2;
  MemoryDomainV1_1_2->MemoryDomain = MemoryDomainV1_1_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_1_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_MemoryDomain_V1_1_2_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  MemoryDomainV1_1_2 = (EFI_REDFISH_MEMORYDOMAIN_V1_1_2 *)InterpProp;
  DestroyMemoryDomain_V1_1_2_CS (MemoryDomainV1_1_2->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyMemoryDomain_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
