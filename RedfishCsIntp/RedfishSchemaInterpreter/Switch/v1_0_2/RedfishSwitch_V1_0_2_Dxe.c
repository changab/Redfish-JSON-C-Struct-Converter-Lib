...
//
#include <RedfishInterpreter/Switch/v1_0_2/EfiSwitchV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_0_2 
...
{
  EFI_REDFISH_SWITCH_V1_0_2 *SwitchV1_0_2;
  EFI_REDFISH_SWITCH_V1_0_2_CS *SwitchV1_0_2Cs;
  ...
  Status = Json_Switch_V1_0_2_To_CS (ResoruceRaw, &SwitchV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_0_2 = (EFI_REDFISH_SWITCH_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_0_2));
  if (SwitchV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)SwitchV1_0_2;
  SwitchV1_0_2->Switch = SwitchV1_0_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_SWITCH_V1_0_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Switch_V1_0_2_JSON (*((EFI_REDFISH_SWITCH_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  SwitchV1_0_2 = (EFI_REDFISH_SWITCH_V1_0_2 *)InterpProp;
  DestroySwitch_V1_0_2_CS (SwitchV1_0_2->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroySwitch_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_0_2EntryPoint (
