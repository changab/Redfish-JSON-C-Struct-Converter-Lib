...
#include"Redfish_Triggers_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenThresholdCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_0_0_Threshold_CS **Dst);
static RedfishCS_status GenOemCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenDiscreteTrigger_Array_ElementCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishTriggers_V1_0_0_DiscreteTrigger_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishTriggers_V1_0_0_DiscreteTrigger_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DwellTime
  ...
  // Value
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "Value", &(*Dst)->Value);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishTriggers_V1_0_0_DiscreteTrigger_Array_CS
//
static RedfishCS_status GenDiscreteTrigger_ArrayCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_0_0_DiscreteTrigger_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishTriggers_V1_0_0_DiscreteTrigger_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishTriggers_V1_0_0_DiscreteTrigger_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenDiscreteTrigger_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
...
//
//Generate C structure for LowerCritical
//
static RedfishCS_status GenThresholdCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_0_0_Threshold_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_0_0_Threshold_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Activation
...
//
//Generate C structure for NumericThresholds
//
static RedfishCS_status GenThresholdsCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_0_0_Thresholds_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_0_0_Thresholds_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LowerCritical
  ...
  // LowerWarning
  Status = GenThresholdCs (Cs, TempJsonObj, "LowerWarning", &(*Dst)->LowerWarning);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // UpperWarning
  Status = GenThresholdCs (Cs, TempJsonObj, "UpperWarning", &(*Dst)->UpperWarning);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenStatusCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenWildcard_Array_ElementCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishTriggers_V1_0_0_Wildcard_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishTriggers_V1_0_0_Wildcard_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Name
...
//
//Generate C structure for RedfishTriggers_V1_0_0_Wildcard_Array_CS
//
static RedfishCS_status GenWildcard_ArrayCs(RedfishTriggers_V1_0_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_0_0_Wildcard_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishTriggers_V1_0_0_Wildcard_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishTriggers_V1_0_0_Wildcard_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_DiscreteTriggers(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_DiscreteTrigger_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishTriggers_V1_0_0_DiscreteTrigger_Array_CS *NextArray;
  RedfishTriggers_V1_0_0_DiscreteTrigger_CS *NextArrayItem;
  ...
  do {
    ...
    // DwellTime 
    if (InsertJsonStringObj (ArrayMember, "DwellTime", NextArrayItem->DwellTime) != RedfishCS_status_success) {goto Error;}
    ...
    // Value 
    if (InsertJsonStringObj (ArrayMember, "Value", NextArrayItem->Value) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_NumericThresholdsLowerCritical(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholdsLowerWarning(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholdsUpperCritical(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholdsUpperWarning(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholds(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_Thresholds_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // LowerCritical
  if (CS_To_JSON_NumericThresholdsLowerCritical(CsJson, "LowerCritical", CSPtr->LowerCritical) != RedfishCS_status_success) {goto Error;}

  // LowerWarning
  if (CS_To_JSON_NumericThresholdsLowerWarning(CsJson, "LowerWarning", CSPtr->LowerWarning) != RedfishCS_status_success) {goto Error;}

  // UpperCritical
  if (CS_To_JSON_NumericThresholdsUpperCritical(CsJson, "UpperCritical", CSPtr->UpperCritical) != RedfishCS_status_success) {goto Error;}

  // UpperWarning
  if (CS_To_JSON_NumericThresholdsUpperWarning(CsJson, "UpperWarning", CSPtr->UpperWarning) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Wildcards(json_t *CsJson, char *Key, RedfishTriggers_V1_0_0_Wildcard_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishTriggers_V1_0_0_Wildcard_Array_CS *NextArray;
  RedfishTriggers_V1_0_0_Wildcard_CS *NextArrayItem;
...
//
// C structure to JSON for Triggers.V1_0_0.Triggers
//
RedfishCS_status CS_To_Triggers_V1_0_0_JSON(RedfishTriggers_V1_0_0_Triggers_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonStringObj (CsJson, "DiscreteTriggerCondition", CSPtr->DiscreteTriggerCondition) != RedfishCS_status_success) {goto Error;}

  // DiscreteTriggers
  if (CS_To_JSON_DiscreteTriggers(CsJson, "DiscreteTriggers", CSPtr->DiscreteTriggers) != RedfishCS_status_success) {goto Error;}
  ...
  // NumericThresholds
  if (CS_To_JSON_NumericThresholds(CsJson, "NumericThresholds", CSPtr->NumericThresholds) != RedfishCS_status_success) {goto Error;}
  ...
  // TriggerActions 
  if (InsertJsonStringArrayObj (CsJson, "TriggerActions", CSPtr->TriggerActions) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Triggers.V1_0_0.Triggers
//
RedfishCS_status DestroyTriggers_V1_0_0_CS(RedfishTriggers_V1_0_0_Triggers_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Triggers.V1_0_0.Triggers
//
RedfishCS_status DestroyTriggers_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Triggers.V1_0_0.Triggers
//
RedfishCS_status
Json_Triggers_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishTriggers_V1_0_0_Triggers_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTriggers_V1_0_0_Triggers_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Triggers", "v1_0_0", "Triggers", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTriggers_V1_0_0_Triggers_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // DiscreteTriggerCondition
  Status = GetRedfishPropertyStr (Cs, JsonObj, "DiscreteTriggerCondition", &Cs->DiscreteTriggerCondition);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // DiscreteTriggers
  Status = GenDiscreteTrigger_ArrayCs (Cs, JsonObj, "DiscreteTriggers", &Cs->DiscreteTriggers);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // NumericThresholds
  Status = GenThresholdsCs (Cs, JsonObj, "NumericThresholds", &Cs->NumericThresholds);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // TriggerActions
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "TriggerActions", &Cs->TriggerActions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
