...
#ifndef _RedfishLogentry_V1_4_0_CSTRUCT_H_
#define _RedfishLogentry_V1_4_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_4_0_Actions_CS RedfishLogEntry_V1_4_0_Actions_CS;
typedef struct _RedfishLogEntry_V1_4_0_Links_CS RedfishLogEntry_V1_4_0_Links_CS;
typedef struct _RedfishLogEntry_V1_4_0_LogEntry_CS RedfishLogEntry_V1_4_0_LogEntry_CS;
typedef struct _RedfishLogEntry_V1_4_0_OemActions_CS RedfishLogEntry_V1_4_0_OemActions_CS;
...
//
typedef struct _RedfishLogEntry_V1_4_0_Actions_CS {
    RedfishLogEntry_V1_4_0_OemActions_CS    *Oem;    // This property contains the
                                                    // available OEM specific actions
                                                    // for this resource.
} RedfishLogEntry_V1_4_0_Actions_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishLogEntry_V1_4_0_Links_CS {
    RedfishResource_Oem_CS          *Oem;                 // Oem extension object.
    Redfishodata_V4_0_3_idRef_CS    *OriginOfCondition;    // This is the URI of the
                                                          // resource that caused the log
                                                          // entry.
} RedfishLogEntry_V1_4_0_Links_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishLogEntry_V1_4_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishLogEntry_V1_4_0_OemActions_CS;
...
//
typedef struct _RedfishLogEntry_V1_4_0_LogEntry_CS {
    RedfishCS_Header                     Header;
    RedfishCS_char                       *odata_context; 
    RedfishCS_char                       *odata_etag;    
    RedfishCS_char                       *odata_id;      
    RedfishCS_char                       *odata_type;    
    RedfishLogEntry_V1_4_0_Actions_CS    *Actions;           // The available actions for this
                                                             // resource.
    ...
    RedfishCS_char                       *Id;            
    RedfishLogEntry_V1_4_0_Links_CS      *Links;             // Contains references to other
    ...
    RedfishCS_char                       *Severity;          // This is the severity of the
                                                             // log entry.
} RedfishLogEntry_V1_4_0_LogEntry_CS;

RedfishCS_status
Json_LogEntry_V1_4_0_To_CS (char *JsonRawText, RedfishLogEntry_V1_4_0_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_4_0_JSON (RedfishLogEntry_V1_4_0_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_4_0_CS (RedfishLogEntry_V1_4_0_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_4_0_Json (RedfishCS_char *JsonText);
