...
//
#include <RedfishInterpreter/LogService/v1_0_6/EfiLogServiceV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_6 
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_6 *LogServiceV1_0_6;
  EFI_REDFISH_LOGSERVICE_V1_0_6_CS *LogServiceV1_0_6Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "LogService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_LogService_V1_0_6_To_CS (ResoruceRaw, &LogServiceV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_6 = (EFI_REDFISH_LOGSERVICE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_6));
  if (LogServiceV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogServiceV1_0_6;
  LogServiceV1_0_6->LogService = LogServiceV1_0_6Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "6";
  Length = sizeof (EFI_REDFISH_LOGSERVICE_V1_0_6_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("LogService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "LogService");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("LogService"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "LogService");
...
)
{
  ...
  return CS_To_LogService_V1_0_6_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in LogServiceToStruct.
...
)
{
  ...
  LogServiceV1_0_6 = (EFI_REDFISH_LOGSERVICE_V1_0_6 *)InterpProp;
  DestroyLogService_V1_0_6_CS (LogServiceV1_0_6->LogService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from LogServiceFromEfiStruct
...
)
{
  ...
  return DestroyLogService_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
