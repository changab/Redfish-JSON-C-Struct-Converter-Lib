...
//
#include <RedfishInterpreter/Chassis/v1_2_5/EfiChassisV1_2_5.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_2_5 
...
{
  EFI_REDFISH_CHASSIS_V1_2_5 *ChassisV1_2_5;
  EFI_REDFISH_CHASSIS_V1_2_5_CS *ChassisV1_2_5Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Chassis") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = Json_Chassis_V1_2_5_To_CS (ResoruceRaw, &ChassisV1_2_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_2_5 = (EFI_REDFISH_CHASSIS_V1_2_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_2_5));
  if (ChassisV1_2_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ChassisV1_2_5;
  ChassisV1_2_5->Chassis = ChassisV1_2_5Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "5";
  Length = sizeof (EFI_REDFISH_CHASSIS_V1_2_5_CS);
  //
  // Set header.
  //
  RestIntrpHeader->Signature = REST_RESOURCE_INTERP_SIGNATURE; 
  RestIntrpHeader->Length = Length;
  RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Chassis"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.NameSpace.ResourceTypeName, "Chassis");
  ...
  RestIntrpHeader->RsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Chassis"));
  AsciiStrCpy (RestIntrpHeader->RsrcIdentifier.DataType, "Chassis");
...
)
{
  ...
  return CS_To_Chassis_V1_2_5_JSON (*((EFI_REDFISH_CHASSIS_V1_2_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}

/**
  This function destory structure retunred in ChassisToStruct.
...
)
{
  ...
  ChassisV1_2_5 = (EFI_REDFISH_CHASSIS_V1_2_5 *)InterpProp;
  DestroyChassis_V1_2_5_CS (ChassisV1_2_5->Chassis); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ChassisFromEfiStruct
...
)
{
  ...
  return DestroyChassis_V1_2_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_2_5EntryPoint (
