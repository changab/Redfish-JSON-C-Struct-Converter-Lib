# Definition of Processor.V1_0_4 and functions<br><br>

## ProcessorId
    typedef struct _RedfishProcessor_V1_0_4_ProcessorId_CS {
    ...
    } RedfishProcessor_V1_0_4_ProcessorId_CS;
...
## Processor
    typedef struct _RedfishProcessor_V1_0_4_Processor_CS {
...
|**ProcessorId**|RedfishProcessor_V1_0_4_ProcessorId_CS| Structure points to **ProcessorId** property.| No| No
...
## Redfish Processor V1_0_4 to C Structure Function
    RedfishCS_status
    Json_Processor_V1_0_4_To_CS (RedfishCS_char *JsonRawText, RedfishProcessor_V1_0_4_Processor_CS **ReturnedCS);

## C Structure to Redfish Processor V1_0_4 JSON Function
    RedfishCS_status
    CS_To_Processor_V1_0_4_JSON (RedfishProcessor_V1_0_4_Processor_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Processor V1_0_4 C Structure Function
    RedfishCS_status
    DestroyProcessor_V1_0_4_CS (RedfishProcessor_V1_0_4_Processor_CS *CSPtr);
