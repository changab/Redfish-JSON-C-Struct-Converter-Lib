...
//
#include <RedfishInterpreter/NetworkPort/v1_0_3/EfiNetworkPortV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_0_3 
...
{
  EFI_REDFISH_NETWORKPORT_V1_0_3 *NetworkPortV1_0_3;
  EFI_REDFISH_NETWORKPORT_V1_0_3_CS *NetworkPortV1_0_3Cs;
  ...
  Status = Json_NetworkPort_V1_0_3_To_CS (ResoruceRaw, &NetworkPortV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_0_3 = (EFI_REDFISH_NETWORKPORT_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_0_3));
  if (NetworkPortV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)NetworkPortV1_0_3;
  NetworkPortV1_0_3->NetworkPort = NetworkPortV1_0_3Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "3";
  Length = sizeof (EFI_REDFISH_NETWORKPORT_V1_0_3_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_NetworkPort_V1_0_3_JSON (*((EFI_REDFISH_NETWORKPORT_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  NetworkPortV1_0_3 = (EFI_REDFISH_NETWORKPORT_V1_0_3 *)InterpProp;
  DestroyNetworkPort_V1_0_3_CS (NetworkPortV1_0_3->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyNetworkPort_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
