...
//
#include <RedfishInterpreter/LogEntry/v1_0_4/EfiLogEntryV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_0_4 
...
{
  EFI_REDFISH_LOGENTRY_V1_0_4 *LogEntryV1_0_4;
  ...
  Status = Json_LogEntry_V1_0_4_To_CS (ResoruceRaw, &LogEntryV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_0_4 = (EFI_REDFISH_LOGENTRY_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_0_4));
  if (LogEntryV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)LogEntryV1_0_4;
  LogEntryV1_0_4->LogEntry = LogEntryV1_0_4Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "4";
  Length = sizeof (EFI_REDFISH_LOGENTRY_V1_0_4_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_LogEntry_V1_0_4_JSON (*((EFI_REDFISH_LOGENTRY_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  LogEntryV1_0_4 = (EFI_REDFISH_LOGENTRY_V1_0_4 *)InterpProp;
  DestroyLogEntry_V1_0_4_CS (LogEntryV1_0_4->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyLogEntry_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_0_4EntryPoint (
