...
//
#include <RedfishInterpreter/TaskService/v1_1_1/EfiTaskServiceV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_1_1 
...
{
  EFI_REDFISH_TASKSERVICE_V1_1_1 *TaskServiceV1_1_1;
  EFI_REDFISH_TASKSERVICE_V1_1_1_CS *TaskServiceV1_1_1Cs;
  ...
  Status = Json_TaskService_V1_1_1_To_CS (ResoruceRaw, &TaskServiceV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_1_1 = (EFI_REDFISH_TASKSERVICE_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_1_1));
  if (TaskServiceV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)TaskServiceV1_1_1;
  TaskServiceV1_1_1->TaskService = TaskServiceV1_1_1Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "1";
  ResourceTypeErrataVersion = "1";
  Length = sizeof (EFI_REDFISH_TASKSERVICE_V1_1_1_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_TaskService_V1_1_1_JSON (*((EFI_REDFISH_TASKSERVICE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  TaskServiceV1_1_1 = (EFI_REDFISH_TASKSERVICE_V1_1_1 *)InterpProp;
  DestroyTaskService_V1_1_1_CS (TaskServiceV1_1_1->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyTaskService_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
