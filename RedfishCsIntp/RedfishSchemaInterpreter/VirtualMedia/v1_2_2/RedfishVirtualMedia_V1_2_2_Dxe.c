...
//
#include <RedfishInterpreter/VirtualMedia/v1_2_2/EfiVirtualMediaV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_2_2 
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_2_2 *VirtualMediaV1_2_2;
  EFI_REDFISH_VIRTUALMEDIA_V1_2_2_CS *VirtualMediaV1_2_2Cs;
  ...
  Status = Json_VirtualMedia_V1_2_2_To_CS (ResoruceRaw, &VirtualMediaV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_2_2 = (EFI_REDFISH_VIRTUALMEDIA_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_2_2));
  if (VirtualMediaV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)VirtualMediaV1_2_2;
  VirtualMediaV1_2_2->VirtualMedia = VirtualMediaV1_2_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_2_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_VirtualMedia_V1_2_2_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  VirtualMediaV1_2_2 = (EFI_REDFISH_VIRTUALMEDIA_V1_2_2 *)InterpProp;
  DestroyVirtualMedia_V1_2_2_CS (VirtualMediaV1_2_2->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyVirtualMedia_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
