...
//
#include <RedfishInterpreter/Manager/v1_2_2/EfiManagerV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_2_2 
...
{
  EFI_REDFISH_MANAGER_V1_2_2 *ManagerV1_2_2;
  EFI_REDFISH_MANAGER_V1_2_2_CS *ManagerV1_2_2Cs;
  ...
  Status = Json_Manager_V1_2_2_To_CS (ResoruceRaw, &ManagerV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_2_2 = (EFI_REDFISH_MANAGER_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_2_2));
  if (ManagerV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER *)ManagerV1_2_2;
  ManagerV1_2_2->Manager = ManagerV1_2_2Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "2";
  ResourceTypeErrataVersion = "2";
  Length = sizeof (EFI_REDFISH_MANAGER_V1_2_2_CS);
  //
  // Set header.
  //
...
)
{
  ...
  return CS_To_Manager_V1_2_2_JSON (*((EFI_REDFISH_MANAGER_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_RESOURCE_INTERPED_PROPERTY_HEADER))), ResoruceRaw);  
}
...
)
{
  ...
  ManagerV1_2_2 = (EFI_REDFISH_MANAGER_V1_2_2 *)InterpProp;
  DestroyManager_V1_2_2_CS (ManagerV1_2_2->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return DestroyManager_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_2_2EntryPoint (
