...
#include"Redfish_LogService_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishLogService_V1_1_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #LogService.ClearLog
//
static RedfishCS_status GenClearLogCs(RedfishLogService_V1_1_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_1_0_ClearLog_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_1_0_ClearLog_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishLogService_V1_1_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_1_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishLogService_V1_1_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #LogService.ClearLog
  Status = GenClearLogCs (Cs, TempJsonObj, "#LogService.ClearLog", &(*Dst)->LogService_ClearLog);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenStatusCs(RedfishLogService_V1_1_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsLogService_ClearLog(json_t *CsJson, char *Key, RedfishLogService_V1_1_0_ClearLog_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishLogService_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishLogService_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // #LogService.ClearLog
  if (CS_To_JSON_ActionsLogService_ClearLog(CsJson, "#LogService.ClearLog", CSPtr->LogService_ClearLog) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for LogService.V1_1_0.LogService
//
RedfishCS_status CS_To_LogService_V1_1_0_JSON(RedfishLogService_V1_1_0_LogService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Entries 
  if (InsertJsonLinkObj (CsJson, "Entries", &CSPtr->Entries) != RedfishCS_status_success) {goto Error;}

  // Id 
  if (InsertJsonStringObj (CsJson, "Id", CSPtr->Id) != RedfishCS_status_success) {goto Error;}

  // LogEntryType 
  if (InsertJsonStringObj (CsJson, "LogEntryType", CSPtr->LogEntryType) != RedfishCS_status_success) {goto Error;}

  // MaxNumberOfRecords 
  if (InsertJsonInt64Obj (CsJson, "MaxNumberOfRecords", CSPtr->MaxNumberOfRecords) != RedfishCS_status_success) {goto Error;}
  ...
  // OverWritePolicy 
  if (InsertJsonStringObj (CsJson, "OverWritePolicy", CSPtr->OverWritePolicy) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for LogService.V1_1_0.LogService
//
RedfishCS_status DestroyLogService_V1_1_0_CS(RedfishLogService_V1_1_0_LogService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for LogService.V1_1_0.LogService
//
RedfishCS_status DestroyLogService_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for LogService.V1_1_0.LogService
//
RedfishCS_status
Json_LogService_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishLogService_V1_1_0_LogService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishLogService_V1_1_0_LogService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "LogService", "v1_1_0", "LogService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishLogService_V1_1_0_LogService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Entries
  InitializeLinkHead (&Cs->Entries);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Entries", Cs->Header.ThisUri, &Cs->Entries);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // LogEntryType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "LogEntryType", &Cs->LogEntryType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MaxNumberOfRecords
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "MaxNumberOfRecords", &Cs->MaxNumberOfRecords);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // OverWritePolicy
  Status = GetRedfishPropertyStr (Cs, JsonObj, "OverWritePolicy", &Cs->OverWritePolicy);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyLogService_V1_1_0_CS (Cs);
  return Status;
}
